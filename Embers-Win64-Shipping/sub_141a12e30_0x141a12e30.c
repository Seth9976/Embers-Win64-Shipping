...
while (true)
    void* r9_4 = sx.q(r10_2) * 0x68 + *rbx
    int32_t rcx_13 = (((*(r9_4 + 0x1c) << 8 ^ *(r9_4 + 0x18)) << 3 ^ *(r9_4 + 0x24)) << 0xa
        ^ *(r9_4 + 0x20)) << 3 ^ *(r9_4 + 0xc) ^ *(r9_4 + 0x14)
    int32_t rcx_18 = (rcx_13 ^ *(r9_4 + 0x10) ^ *(r9_4 + 4) ^ *(r9_4 + 8) ^ *r9_4) & (*rsi - 1)
    void* rax_15 = arg1 + 0x38
    *(r9_4 + 0x64) = rcx_18
    void* rdx_6 = *(arg1 + 0x40)
    int64_t r8_7 = sx.q(rcx_18)
    
    if (rdx_6 != 0)
        rax_15 = rdx_6
    
    *(r9_4 + 0x60) = *(rax_15 + (((sx.q(*rsi) - 1) & r8_7) << 2))
    void* rax_17 = arg1 + 0x38
    void* rcx_22 = *(arg1 + 0x40)
    
    if (rcx_22 != 0)
        rax_17 = rcx_22
    
    *(rax_17 + (((sx.q(*rsi) - 1) & r8_7) << 2)) = r10_2
