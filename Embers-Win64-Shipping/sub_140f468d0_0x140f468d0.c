...
if (data_143e2ada0 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e2ada0)
    
    if (data_143e2ada0 == 0xffffffff)
        sub_140b58170(&data_143e2ad98, "GenericWhiteBox", 1)
        _Init_thread_footer(&data_143e2ada0)

int64_t* rcx_6 = data_143e243c8
(*(*rcx_6 + 0x48))(rcx_6, data_143e2ad98, 0)
