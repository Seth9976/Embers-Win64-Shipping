...
if (data_143e8d388 s> *rdi_1)
    _Init_thread_header(&data_143e8d388)
    
    if (data_143e8d388 == 0xffffffff)
        ...
        data_143e8d380 = rax_12
        _Init_thread_footer(&data_143e8d388)

if (data_143e8d3a8 s> *rdi_1)
    _Init_thread_header(&data_143e8d3a8)
    
    if (data_143e8d3a8 == 0xffffffff)
        ...
        data_143e8d3a0 = rax_15
        _Init_thread_footer(&data_143e8d3a8)

if (data_143e8d3c8 s> *rdi_1)
    _Init_thread_header(&data_143e8d3c8)
    
    if (data_143e8d3c8 == 0xffffffff)
        ...
        data_143e8d3c0 = rax_18
        _Init_thread_footer(&data_143e8d3c8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d380
int64_t rcx
...
label_14129d5b8:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_14129d5b3
    
    rbx.b = 1
    goto label_14129d5b8
