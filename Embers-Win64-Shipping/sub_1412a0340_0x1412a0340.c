...
if (data_143e8de80 s> *rdi_1)
    _Init_thread_header(&data_143e8de80)
    
    if (data_143e8de80 == 0xffffffff)
        ...
        data_143e8de78 = rax_9
        _Init_thread_footer(&data_143e8de80)

if (data_143e8dea0 s> *rdi_1)
    _Init_thread_header(&data_143e8dea0)
    
    if (data_143e8dea0 == 0xffffffff)
        ...
        data_143e8de98 = rax_12
        _Init_thread_footer(&data_143e8dea0)

if (data_143e8dec0 s> *rdi_1)
    _Init_thread_header(&data_143e8dec0)
    
    if (data_143e8dec0 == 0xffffffff)
        ...
        data_143e8deb8 = rax_15
        _Init_thread_footer(&data_143e8dec0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8de78
int64_t rcx
...
label_1412a0440:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412a043e
        
        rbx.b = 1
        goto label_1412a0440
