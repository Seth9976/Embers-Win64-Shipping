...
label_140d9e698:
    ...
    if (r8_4 s> 0 && (rax_17 == 0 || rax_17 s< rbp))
        ...
        *(arg4 + 0x80) = *(rax_21 + (((sx.q(arg1[9].d) - 1) & r8_5) << 2))
        void* rax_23 = *(r9_3 + 8)
    ...
    if (rbx_1 == 0xffffffff)
        ...
        void* rdi_1 = sx.q(rbx_1) * 0x88 + *arg1
        sub_140d95810(rdi_1 + 8)
        memmove(rdi_1, arg4, 0x80)
        int64_t rcx_4 = sx.q(arg5)
        void* r10_1 = &arg1[2]
        
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0x88 + *arg1) = rcx_4.d
        
        int32_t* rax_7 = rcx_4 * 0x88 + *arg1
        *rax_7 = 0xffffffff
