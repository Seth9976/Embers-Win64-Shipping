...
if (data_143e8d318 s> *rdi_1)
    _Init_thread_header(&data_143e8d318)
    
    if (data_143e8d318 == 0xffffffff)
        ...
        data_143e8d310 = rax_9
        _Init_thread_footer(&data_143e8d318)

if (data_143e8d338 s> *rdi_1)
    _Init_thread_header(&data_143e8d338)
    
    if (data_143e8d338 == 0xffffffff)
        ...
        data_143e8d330 = rax_12
        _Init_thread_footer(&data_143e8d338)

if (data_143e8d358 s> *rdi_1)
    _Init_thread_header(&data_143e8d358)
    
    if (data_143e8d358 == 0xffffffff)
        ...
        data_143e8d350 = rax_15
        _Init_thread_footer(&data_143e8d358)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d310
int64_t rcx
...
label_1412b04a3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412b049e
        
        rbx.b = 1
        goto label_1412b04a3
