...
if (data_143e2ce50 s> *rdi_1)
    _Init_thread_header(&data_143e2ce50)
    
    if (data_143e2ce50 == 0xffffffff)
        ...
        data_143e2ce48 = rax_6
        _Init_thread_footer(&data_143e2ce50)

if (data_143e2ce60 s> *rdi_1)
    _Init_thread_header(&data_143e2ce60)
    
    if (data_143e2ce60 == 0xffffffff)
        ...
        data_143e2ce58 = rbx
        _Init_thread_footer(&data_143e2ce60)

if (data_143e2ce58 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()

if (data_143e2ce48 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()
