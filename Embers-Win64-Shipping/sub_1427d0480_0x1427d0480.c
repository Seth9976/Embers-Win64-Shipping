...
labelid_4:
    ...
    int32_t rax_14 =
        *(*(arg1 + 0x60) + (((zx.q(rax_12.d) u>> 0x10 ^ rax_12) & zx.q(*(arg1 + 0x6c) - 1)) << 2))
    ...
    label_1427d050a:
        ...
        while (*(r9_1 + zx.q(rax_14) * 0x10) != arg2)
            rax_14 = *(*(arg1 + 0x58) + (zx.q(rax_14) << 2))
            
            if (rax_14 == 0xffffffff)
                goto label_1427d050a_2
...
if (sub_1427d0e80(arg1 + 0x48, &arg_10) == 0)
    ...
    "erialization\SnSerializationRegistry.cpp", 
        0x10b, 
        "PxSerializationRegistry::unregisterRepXSerializer: failed to find PxRepXSerializer instance for "
    "type %d")
