...
if (arg4 != 0)
    ...
    do
        ...
        *(rbx_1 + 8) = *(rdi_1 + rbx_1 + 8)
        sub_1405af700(rbx_1 + 0x10, &rdi_1[2] + rbx_1)
        sub_1405af700(rbx_1 + 0xb0, &rdi_1[0x16] + rbx_1)
        sub_1405af700(rbx_1 + 0x150, &rdi_1[0x2a] + rbx_1)
        sub_1405af700(rbx_1 + 0x1f0, &rdi_1[0x3e] + rbx_1)
        *(rbx_1 + 0x290) = *(rdi_1 + rbx_1 + 0x290)
        rbx_1 += 0x2d0
        i = i_1
        i_1 -= 1
    while (i != 1)
