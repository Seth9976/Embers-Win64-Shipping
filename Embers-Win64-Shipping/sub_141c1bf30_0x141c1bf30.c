...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_3[4]
    sub_140d30490(arg2, &var_1b0, r8_3)
else
    sub_140d30460(arg2, *(arg2 + 0x18), &var_1b0)
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_5[4]
    sub_140d30490(arg2, &var_1b8, r8_5)
else
    sub_140d30460(arg2, *(arg2 + 0x18), &var_1b8)

bool cond:1 = var_1b8 != 0
int64_t rax_6 = *(arg2 + 0x20)
void* r8_6 = var_1b0
int64_t rdi
rdi.b = rax_6 != 0
*(arg2 + 0x20) = rdi + rax_6
sub_1405979f0(arg3, sub_141b97e00(&var_1a8, rsi, r8_6, cond:1))
sub_140597700(&var_1a8)
