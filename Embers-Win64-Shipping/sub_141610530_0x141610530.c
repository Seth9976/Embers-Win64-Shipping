...
while (true)
    ...
    zmm4 = *arg3
    zmm7 = var_268_1
    float temp0_8[0x4] = _mm_unpacklo_ps(var_2b0.d, var_2a8[0].q)
    ...
    float temp0_23[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_19, temp0_19, 0xc9), temp0_10)
    float temp0_24[0x4] = _mm_mul_ps(temp0_21, temp0_9)
    float temp0_25[0x4] = _mm_add_ps(temp0_20, temp0_12)
    zmm5 = var_2e8_1
    zmm1 = var_2e4
    float temp0_28[0x4] =
    ...
    *(&var_178 + (rcx_5 << 2)) = (_mm_unpacklo_ps(zmm5, zmm7[0].q)).q
    (&var_170)[rcx_5] = var_1f0_1
    *(&var_148 + (rcx_5 << 2)) = (_mm_unpacklo_ps(temp0_28, temp0_30[0].q)).q
    (&var_140)[rcx_5] = var_1e0_1
    int64_t var_118
    *(&var_118 + (rcx_5 << 2)) = (_mm_unpacklo_ps(zmm5, zmm7[0].q)).q
    int32_t var_110
    (&var_110)[rcx_5] = zmm1[0]
    var_1a8.d = rdx_1.d + 1
    int32_t var_2c8_1
    ...
    if (rdx_1.d == 0)
        ...
        var_2c8_1 = (&var_110)[rcx_13]
    else
        uint64_t* rax_19
        
        if (rdx_1.d == 1)
            rax_19 = sub_1416e69d0(&var_2c0, &var_118, &var_1a8:4, &var_1a8, &var_188)
        label_141610aad:
            zmm0 = zx.o(*rax_19)
            ...
            if (rdx_1.d == 2)
                rax_19, zmm11, zmm15 = sub_1416fa750(&var_2a0, &var_118, &var_1a8, &var_188)
                goto label_141610aad
...
if (zmm1[0] <= zmm8[0])
    ...
    if (i_6 s> 0)
        ...
        do
            ...
            *(rcx_20 + (rdx_11 << 2) + 8) = rax_30
            ...
            if (rax_31 s> var_2b8_1:4.d)
                sub_14083a7e0(&var_2c0)
            
            uint64_t rcx_22 = var_2c0
    ...
    float zmm11_1[0x4]
    float zmm15_1[0x4]
    rax_33, zmm8_1, zmm11_1, zmm15_1 = sub_1415862f0(&var_2a0, &var_2c0, &var_240, &var_228, 
    ...
    *arg7 = temp0_37.q
    float temp0_38[0x4] = __sqrtss_xmmss_memss(temp0_37[0], var_2d4)
