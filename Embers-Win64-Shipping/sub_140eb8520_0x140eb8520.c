...
label_140eb8682:
    ...
    if (r8_1 s> 0 && (rax_18 == 0 || rax_18 s< rbp))
        arg1[9].d = rbp
        sub_140ed4cc0(arg1)
    else
        void* r9_3 = &arg1[7]
        ...
        *(r9_3 + (((sx.q(arg1[9].d) - 1) & r8_2) << 2)) = rdi_3
else
    int32_t r15_1 = -1
    int32_t rbx_1
    ...
    label_140eb85b9:
        ...
        while (true)
            ...
            if (*(arg2 + (rcx_2 << 3)) == arg3)
                break
            
            rbx_1 = arg2[rcx_2 * 2 + 0xa]
            
            if (rbx_1 == 0xffffffff)
                goto label_140eb85b9
