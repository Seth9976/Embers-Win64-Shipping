...
if (rdx.b == 0)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            ...
            rcx_6 += 0x10
            float zmm2[0x4] =
                _mm_and_ps(data_143f87770 ^ zmm0, _mm_cmpeq_ps(zmm0, zmm3, 2)) ^ data_143f87770
            *rax = _mm_sub_ps(_mm_cvtepi32_ps(_mm_cvttps_epi32(zmm3)), zmm2)
            i = i_3
            i_3 -= 1
        while (i != 1)
else if (rax.d == 1)
    ...
    *(arg1 + 0x10) = &rax_8[3]
    ...
    zmm3 = *(sx.q(rcx_1) + *(*(arg1 + 0x18) + (sx.q(r8_1) << 3)))
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            ...
            rax_6 = rdx_5
            rdx_5 = &rdx_5[1]
            *rax_6 = _mm_sub_ps(temp0_3, 
                _mm_and_ps(data_143f87770 ^ zmm0, _mm_cmpeq_ps(zmm0, temp0_1, 2)) ^ data_143f87770)
            i_1 = i_2
            i_2 -= 1
        while (i_1 != 1)
        return rax_6
