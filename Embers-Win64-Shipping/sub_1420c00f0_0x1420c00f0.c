...
int64_t zmm3 = 0x3e1ca213d840baf8
...
if (zmm2 f>= zmm0[0])
    ...
    if (zmm2 f<= zmm0[0])
        zmm0 = zx.o(0)
        zmm0[0] = fconvert.d(arg2 * 600000000f + 0.5f)
        ...
        *arg1 = int.q(zmm0[0])
        ...
        UnDecorator::getReferenceType(var_178, u"MinutesValue", 0x1a)
    ...
    UnDecorator::getReferenceType(var_188, u"MinutesValue", 0x1a)
