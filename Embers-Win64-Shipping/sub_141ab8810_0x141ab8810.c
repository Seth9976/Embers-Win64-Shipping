...
int64_t arg_8 = *(sub_141ae7c90() + 0x18)
int16_t* var_48
...
int64_t var_38
int64_t* rax_2 = sub_140b63b70(arg1 + 0xd8, &var_38)

if (rax_2[1].d != 0)
    rdi = *rax_2

float var_68_1[0x2] = _mm_cvtps_pd(*(arg1 + 0xe8))
sub_140a2e390(&var_48, u" Src: %s Dst: %s Multiplier: %.2f)", rdi)
int32_t r8_6
