...
int32_t r15_1 = *(arg1 + 0x78) - *(arg1 + 0xa4)
...
if (0 s< r9)
    ...
    do
        ...
        void* rbx_3 = *(rcx_5 + (rdx_6 << 3) + 0x18)
        int64_t r14 = *(rcx_5 + (rdx_6 << 3) + 0x10)
