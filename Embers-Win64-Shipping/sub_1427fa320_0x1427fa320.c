...
float var_98 = *rax_1
float var_94 = rax_1[1]
float var_90 = rax_1[2]
float var_8c = rax_1[3]
float var_88 = zmm11_1
float var_84 = zmm6_1
...
int32_t zmm6_2
int32_t zmm11_2
rax_2, zmm6_2, zmm11_2 = sub_1417c7990(arg4, &var_c8, arg2 + 0x2c)
float var_b8 = *rax_2
int32_t var_b4 = rax_2[1]
float var_b0 = rax_2[2]
int32_t var_ac = rax_2[3]
int32_t var_a8 = zmm11_2
int32_t var_a4 = zmm6_2
int32_t var_a0 = zmm12.d
return (*(*arg1 + 8))(arg1, &var_98, &var_b8)
