...
int32_t rbp_1 = int.d(zmm1.q)
zmm1 = zx.o(arg1[1])
int32_t rbp_3 = (rbp_1 + 1) * rdx
uint128_t zmm6
...
if (r9_2 s> 0)
    ...
    do
        if (mods.dp.d(sx.q(rcx - r8_1 + *(rbx + 0x3c)), rcx) s<= rbp_3)
            int32_t result = sub_141c2a3a0(rbx, arg2, rbp_3)
            arg1[2].d = result
            ...
            *(rbx + 0x44)
            ...
            if (mods.dp.d(sx.q(*(rbx + 0x44) - r8_1 + *(rbx + 0x3c)), *(rbx + 0x44)) s<= rbp_3)
                break
