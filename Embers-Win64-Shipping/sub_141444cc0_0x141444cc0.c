...
if (rbx_1 s< result.d)
    ...
    while (r9_2 s< rcx_1)
        ...
        while (r14_1 s< rcx_1)
            void* rdx_1 = *(arg1 + 8)
            char* rsi_1 = r8_2 + r13_1
            void* rbx_2 = rsi_1 * 5
            int32_t arg_18 = 0xffffffff
            int64_t rdi_1 = *(rdx_1 + 0xde8)
            int64_t rax_3 = *(rdx_1 + 0xe18)
            float zmm1[0x4] = *(rdi_1 + (rbx_2 << 3))
            zmm8.d = (*(rdi_1 + (rbx_2 << 3) + 4)).d f- var_150:4.d
            zmm1[0] = zmm1[0] f- var_150.d
            uint128_t zmm0
            zmm0.d = (*(rdi_1 + (rbx_2 << 3) + 8)).d f- rax_1
            zmm8.d = zmm8.d f* zmm8.d
            char rcx_2 = rsi_1[rax_3] & 9
            ...
            result = *(arg1 + 0x10)
            zmm6 = *(rdi_1 + (rbx_2 << 3) + 0x1c)
            
            if ((*(*result + 0x2c) & 0x40000) != 0)
                int64_t* rcx_5 = *(*(*(rdx_1 + 0xdb8) + (rsi_1 << 3)) + 8)
            ...
            if (r9_3 != 0)
                ...
                void* r8_3 = r9_3 + 0x40
                int32_t rax_8 = r14_1
                int32_t rdx_2 = 1 << (r14_1.b & 0x1f)
                
                if (r14_1 s< 0)
                    rax_8 = r14_1 + 0x1f
                
                result = zx.q(rax_8 s>> 5)
            ...
            if (zmm8.d f> zmm0.d || zmm8.d f< zmm6.d)
                ...
                int32_t var_130_1 = *(rdi_1 + (rbx_2 << 3) + 8)
                int32_t rax_10 = *(rdi_1 + (rbx_2 << 3) + 0x14)
                uint64_t var_138 = *(rdi_1 + (rbx_2 << 3))
                int32_t var_124_1 = rax_10
                uint64_t var_12c_1 = *(rdi_1 + (rbx_2 << 3) + 0xc)
                int32_t var_120_1 = (*(rdi_1 + (rbx_2 << 3) + 0x18)).d
                int64_t* rcx_8 = *(*(arg1 + 0x10) + 0x5160)
                result = (*(*rcx_8 + 0x28))(rcx_8, zx.q(arg_18), &var_138)
                ...
                if (result.b == 0)
                    ...
                    zmm11 = *(rdi_1 + (rbx_2 << 3))
                    float zmm3[0x4] = *(rdi_1 + (rbx_2 << 3) + 0xc)
                    zmm14 = *(rcx + 0x40)
                    zmm15 = *(rcx + 0x50)
                    float temp0_1[0x4] = _mm_unpacklo_ps(*(rdi_1 + (rbx_2 << 3) + 4), 0)
                    float temp0_2[0x4] = _mm_unpacklo_ps(zmm11, zmm0.q)
                    float temp0_3[0x4] = _mm_unpacklo_ps(zmm3, (*(rdi_1 + (rbx_2 << 3) + 0x14)).q)
                    float temp0_4[0x4] = _mm_unpacklo_ps(temp0_2, temp0_1[0].q)
                    float temp0_6[0x4] = _mm_unpacklo_ps(temp0_3, 
                        _mm_unpacklo_ps(*(rdi_1 + (rbx_2 << 3) + 0x10), 0)[0].q)
                    ...
                    if (result.d != 0)
                        ...
                        if (result.d != 0)
                            ...
                            if (zmm8.d f<= zmm0.d)
                                ...
                                int64_t* rcx_10 = *(*(*(*(arg1 + 8) + 0xdb8) + (rsi_1 << 3)) + 8)
