...
while (true)
    void* rbx_2 = sx.q(r15_1) * 0xa0 + *rdi
    int32_t rax_13 = *(rbx_2 + 0x20)
    int16_t* rdx_8
    ...
    int32_t rcx_5 = rax_13 - 1
    
    if (rax_13 == 0)
        rcx_5 = 0
    
    int32_t rax_15 = sub_1405969c0(rcx_5, rdx_8) & (*r14 - 1)
    *(rbx_2 + 0x94) = rax_15
    ...
    *(rbx_2 + 0x90) = *(rax_16 + (((sx.q(*r14) - 1) & r8_5) << 2))
    ...
    *(rax_18 + (((sx.q(*r14) - 1) & r8_5) << 2)) = r15_1
