...
if (data_143e8af70 s> *rdi_1)
    _Init_thread_header(&data_143e8af70)
    
    if (data_143e8af70 == 0xffffffff)
        ...
        data_143e8af68 = rax_9
        _Init_thread_footer(&data_143e8af70)

if (data_143e8af80 s> *rdi_1)
    _Init_thread_header(&data_143e8af80)
    
    if (data_143e8af80 == 0xffffffff)
        ...
        data_143e8af78 = rax_12
        _Init_thread_footer(&data_143e8af80)

if (data_143e8af90 s> *rdi_1)
    _Init_thread_header(&data_143e8af90)
    
    if (data_143e8af90 == 0xffffffff)
        ...
        data_143e8af88 = rax_15
        _Init_thread_footer(&data_143e8af90)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8af68
int64_t rcx
...
label_1412c41b3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412c41ae
        
        rbx.b = 1
        goto label_1412c41b3
