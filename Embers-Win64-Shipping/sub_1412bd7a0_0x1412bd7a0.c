...
if (data_143e8bfd8 s> *rdi_1)
    _Init_thread_header(&data_143e8bfd8)
    
    if (data_143e8bfd8 == 0xffffffff)
        ...
        data_143e8bfd0 = rax_12
        _Init_thread_footer(&data_143e8bfd8)

if (data_143e8bfe8 s> *rdi_1)
    _Init_thread_header(&data_143e8bfe8)
    
    if (data_143e8bfe8 == 0xffffffff)
        ...
        data_143e8bfe0 = rax_15
        _Init_thread_footer(&data_143e8bfe8)

if (data_143e8bff8 s> *rdi_1)
    _Init_thread_header(&data_143e8bff8)
    
    if (data_143e8bff8 == 0xffffffff)
        ...
        data_143e8bff0 = rax_18
        _Init_thread_footer(&data_143e8bff8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8bfd0
int64_t rcx
