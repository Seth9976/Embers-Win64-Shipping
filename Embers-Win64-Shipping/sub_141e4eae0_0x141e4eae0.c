    ...
    label_141e4ecc9:
        ...
        while (true)
            ...
            if (rax_8 s<= 8)
                for (; i u> r10_1; i -= 8)
                    ...
                    if (&r10_1[1] u<= i)
                        do
                            int32_t rcx_11 = *r8_2
                            int32_t rcx_12 = rcx_11 - *rdx_2
                            
                            if (rcx_11 == *rdx_2)
                                rcx_12 = *(r8_2 + 4) - *(rdx_2 + 4)
                            
                            uint64_t* rax_25 = rdx_2
            ...
            while (true)
                ...
                if (rdx u<= i)
                    int32_t rax_11 = *r10_1
                    int32_t rax_12 = rax_11 - *rdx
                    
                    if (rax_11 == *rdx)
                        rax_12 = *(r10_1 + 4) - *(rdx + 4)
