...
if (i.b u< 4)
    if (rcx u>= 8)
        ...
        do
            ...
            zmm1.q = zmm1.q f+ *rcx_33
            uint64_t rcx_35 = zx.q(rsi_2 + 2)
            zmm6.q = var_58:8.q f+ *r8_6
            zmm0 = _mm_unpacklo_pd(zmm1, zmm6.q)
            var_58 = zmm0
            var_48 = zmm0
            ...
            zmm2.q = var_38.q f+ *rcx_43
            uint128_t zmm0_2
            zmm0_2.q = var_58:8.q f+ *r8_8
            zmm1 = _mm_unpacklo_pd(zmm2, zmm0_2.q)
            var_58 = zmm1
            var_48 = zmm1
...
zmm2.q = zmm2.q f+ *rcx_2
zmm1.q = var_38:8.q f+ *rdx
...
if (*(arg1 + 0x24) u>= 0xc)
    ...
    do
        ...
        zmm6.q = var_58.q f+ *rcx_11
        uint64_t rcx_13 = zx.q(rsi_1 + 2)
        zmm0_1.q = var_38:8.q f+ *r8_2
        zmm1 = _mm_unpacklo_pd(zmm6, zmm0_1.q)
        var_38 = zmm1
        var_48 = zmm1
        ...
        zmm6.q = zmm6.q f+ *rcx_21
        zmm1.q = var_38:8.q f+ *r8_4
        zmm0 = _mm_unpacklo_pd(zmm6, zmm1.q)
        var_38 = zmm0
        var_48 = zmm0
