    ...
    if (result[1].b != 0)
        ...
        if (zmm8.d f> zmm7.d || arg3 == 0)
            ...
            label_140f2af19:
                ...
                if (&var_70 != arg1 + 0x528)
                    *(arg1 + 0x528) = zmm6.d
                    *(arg1 + 0x52c) = 1
                
                *(arg1 + 0x530) = 1
                sub_1407473e0(arg1 + 0x538, &var_60)
                sub_140f63650(arg1)
                result = sub_140745b20(&var_60)
            else
                int64_t* rcx_3 = *(arg1 + 0x538)
                
                if (rcx_3 == 0)
                    goto label_140f2af19
