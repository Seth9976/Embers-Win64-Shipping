...
while (true)
    ...
    if (rcx_13.d == (var_88_2.q u>> 0x20).d && var_68.q == arg2 + 0x10 && result == arg2)
        return result
    
    void arg_8
    sub_140946410(arg1, &arg_8, (rcx_13 << 4) + *result, nullptr)
