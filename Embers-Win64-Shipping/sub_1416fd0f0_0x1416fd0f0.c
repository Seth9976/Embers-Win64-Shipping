...
float temp0[0x4] = _mm_min_ps(zmm14, zmm8)
float var_148 = arg4[0]
float var_188[0x4]
...
if (_mm_movemask_ps(_mm_cmpeq_ps(temp0, zmm13, 1)) == 0)
    zmm4 = *arg2
    zmm2 = *arg1
    arg4 = arg1[1]
    ...
    float temp0_39[0x4] = _mm_shuffle_ps(temp0_35, temp0_35, 0x1a)
    float temp0_41[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_31, temp0_31, 0x12), temp0_38)
    float temp0_43[0x4] = _mm_add_ps(temp0_39, _mm_shuffle_ps(temp0_35, temp0_35, 1))
    float temp0_44[0x4] = _mm_add_ps(temp0_41, temp0_37)
    float temp0_45[0x4] = _mm_sub_ps(temp0_37, temp0_41)
    ...
    zmm10, zmm12, zmm13, zmm15 = sub_1407740e0(&var_188, 0x322bcc77)
...
if (_mm_movemask_ps(_mm_cmpeq_ps(_mm_min_ps(zmm14, zmm6), zmm13, 1)) == 0)
    ...
    float temp0_306[0x4] = _mm_mul_ps(temp0_302, zmm15)
    ...
    float temp0_203[0x4] = _mm_shuffle_ps(zmm14, zmm14, 0xc9)
    ...
    int128_t zmm10_1
    float zmm13_1[0x4]
    zmm10_1, zmm12, zmm13_1 = sub_1407740e0(&var_188, 0x322bcc77)
    float zmm2_2[0x4] = var_188[0]
    float zmm1_2 = var_188[1]
    zmm13_1 = _mm_and_ps(_mm_cmpeq_ps(zmm13_1, zmm12, 2), data_143ef7520 ^ zmm10_1) ^ data_143ef7520
    zmm2_2[0] = zmm2_2[0] * zmm13_1[0]
    uint32_t zmm0_2[0x4] = var_188[2]
    zmm0_2[0] = zmm0_2[0] f* zmm13_1[0]
    zmm1_2 = zmm1_2 * zmm13_1[0]
    var_188[0] = zmm2_2[0]
...
float var_128[0x4] = zmm6
float var_118[0x4] = zmm7
float var_108[0x4] = zmm12
int64_t result
int512_t zmm11
result, zmm11 = sub_1416fdb20(arg1, &var_f8, &var_128, var_148)
