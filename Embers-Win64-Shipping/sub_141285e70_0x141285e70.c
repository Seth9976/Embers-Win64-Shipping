...
if (data_143e8c19c s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8c19c)
    
    if (data_143e8c19c == 0xffffffff)
        ...
        data_143e8c190 = rax_6
        _Init_thread_footer(&data_143e8c19c)

int64_t rbx = data_143e8c190
int64_t rcx
