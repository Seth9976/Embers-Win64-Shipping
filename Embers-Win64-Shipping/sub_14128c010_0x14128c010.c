...
if (data_143e8b428 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8b428)
    
    if (data_143e8b428 == 0xffffffff)
        ...
        data_143e8b420 = rax_4
        _Init_thread_footer(&data_143e8b428)

if (data_143e8b420 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()

sub_1410b3fe0(arg2, u"MAX_NUM_LIGHTMAP_COEF", 2)
sub_14122cc80(arg1, arg2)
