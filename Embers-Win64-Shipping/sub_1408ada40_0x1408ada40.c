...
if (r10 == 0)
    ...
    uint32_t zmm0_2[0x4]
    zmm0_2, zmm6, zmm7 = sub_1408b3d60(&arg7, arg6, &var_b8)
    zmm9 = zmm0_2
    zmm10 = 0x3f800000
    zmm8 = *arg4
    zmm11 = 0x3f800000
    ...
    if (result.d s> 1)
        ...
        do
            ...
            zmm0_2, result, zmm6, zmm7 = sub_1408b3d60(&arg7, arg6, &var_b8)
    ...
    zmm6 = __andps_xmmxud_memxud(sub_1408b3d60(&arg7, arg6, &var_b8), data_142d3f770)
    zmm10 = 0x3f800000
    ...
    if (result.d s> 1)
        ...
        do
            ...
            uint32_t zmm0_1[0x4]
            zmm0_1, result, zmm6, zmm7 = sub_1408b3d60(&arg7, arg6, &var_b8)
    ...
    return sub_1408b4340(rcx, arg3, arg4, arg5, arg6, (_mm_unpacklo_ps(zmm1, zmm1[0].q)).d)
return result
