...
if (rax_3 == 0)
    sub_1405947f0(rcx_2, 8)
    int32_t rax_20 = var_60 + 8
    var_60 = rax_20
    
    if (rax_20 s> var_5c)
        sub_140594770(&var_68)
    
    sub_1405a7220(var_68, 8, "replays", 8, 0x3f)
    ...
    for (; i s>= 0; i += 1)
        ...
        int64_t* rcx_31 = sx.q(i) * 0x58 + *(arg1 + 8)
        (*(*rcx_31 + 0x38))(rcx_31, arg2, 0)
    
    result = (*(*arg2 + 0x38))(arg2)
else
    sub_1405947f0(rcx_2, 8)
    int32_t rax_4 = var_60 + 8
    var_60 = rax_4
    ...
    sub_1405a7220(r14_1, 8, "replays", 8, 0x3f)
    int64_t var_58
    ...
    if (rsi.b != 0)
        ...
        for (; i_1 s>= 0; i_1 += 1)
            ...
            *(arg1 + 0x10) = rax_15
            ...
            int64_t rdi_5 = rdi_4 * 0x58
            void*** rdi_6 = rdi_5 + *(arg1 + 8)
            
            if (rdi_5 == neg.q(*(arg1 + 8)))
                rdi_6 = nullptr
            else
                *rdi_6 = &data_143239fc8
