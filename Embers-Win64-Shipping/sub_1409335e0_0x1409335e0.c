...
if (rdi_3.b != 0)
    ...
    void* rbx_4 = r12
    void* rsi_3 = (sx.q(i_2) << 4) + r12
    
    if (r12 != rsi_3)
        do
            int64_t* rax_6 = sub_140b74df0(*rbx_4, &var_48)
            int64_t r15_1 = sx.q(arg3[1].d)
            int32_t rcx_16 = (r15_1 + 1).d
            arg3[1].d = rcx_16
            
            if (rcx_16 s> *(arg3 + 0xc))
                sub_1405a4f90(arg3)
            
            int64_t* rcx_20 = (r15_1 << 4) + *arg3
            *rcx_20 = 0
            *rcx_20 = *rax_6
            *rax_6 = 0
            rcx_20[1].d = rax_6[1].d
            result = zx.q(*(rax_6 + 0xc))
            *(rcx_20 + 0xc) = result.d
            rax_6[1] = 0
