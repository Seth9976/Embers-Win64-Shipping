...
if (data_143e2d190 s> *rdi_1)
    _Init_thread_header(&data_143e2d190)
    
    if (data_143e2d190 == 0xffffffff)
        ...
        data_143e2d188 = rax_8
        _Init_thread_footer(&data_143e2d190)

if (data_143e2d1a0 s> *rdi_1)
    _Init_thread_header(&data_143e2d1a0)
    
    if (data_143e2d1a0 == 0xffffffff)
        ...
        data_143e2d198 = rax_11
        _Init_thread_footer(&data_143e2d1a0)

int64_t rdi_2 = data_143e2d198
int64_t rcx
