...
float zmm18[0x4] = _mm_mask_div_ps(arg5, zmm0[0].o, zmm1[0].o)
zmm0[0].o = __vmovsd_xmmdq_memq(arg1[0xc].q)
zmm0[0].o = __vinsertps_xmmdq_xmmdq_memd_immb(zmm0[0].o, *(arg1 + 0xc8), 0x20)
float zmm20[0x4] = _mm_mask_sub_ps(arg5, arg3[0].o, zmm0[0].o)
...
float zmm4[0x4] = _mm_mask_permute_ps(arg5, zmm20, 0xd2)
...
zmm1[0].o = _mm_mask_permute_ps(arg5, zmm20, 0xc9)
...
zmm5[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm5[0].o, zmm4, 0x20)
...
zmm1[0].o = _mm_fmsub_ps(zmm1[0].o, zmm5[0].o, zmm6)
...
zmm0[0].o = _mm_mask_mul_ps(arg5, zmm18, zmm0[0].o)
...
zmm5[0].o = __vmulps_xmmf32_maskmskw_xmmf32_memf32_avx512(arg5, arg3[0].o, *(arg1 + 0xec))
...
zmm0[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm5[0].o, zmm6)
zmm5[0].o = __vsubps_xmmdq_xmmdq_xmmdq(zmm6, zmm5[0].o)
...
float zmm17[0x4] = __vbroadcastss_xmmf32_maskmskw_memf32_avx512(arg5, 1f)
arg4 = _mm_mask_sub_ps(arg5, zmm17, arg3[0].o)
...
zmm1[0].o = _mm_permute_ps(zmm5[0].o, 0xea)
...
float zmm19[0x4] = _mm_mask_permute_ps(arg5, zmm0[0].o, 0xea)
zmm1[0].o = _mm_permute_ps(arg4, 0xd5)
zmm1[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm7, zmm1[0].o)
zmm1[0].o = _mm_mask3_fmadd_ps(zmm1[0].o, arg5, zmm6, zmm19)
zmm4 = _mm_fmadd_ps(_mm_broadcastss_ps(zmm5[0].o), zmm11, zmm1[0].o)
zmm19 = _mm_mask_permute_ps(arg5, zmm5[0].o, 0xd5)
...
zmm1[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm5[0].o, 0x60)
zmm6 = __vinsertps_xmmdq_xmmdq_xmmdq_immb(
    __vinsertps_xmmdq_xmmdq_xmmdq_immb(arg4, zmm5[0].o, 0x8c), zmm0[0].o, 0x20)
zmm0[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zmm0[0].o, 0x4e)
zmm0[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zmm5[0].o, 0x14)
...
zmm5[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm6, zmm5[0].o)
zmm5[0].o = _mm_fmadd_ps(zmm5[0].o, zmm1[0].o, arg4)
zmm11 = _mm_fmadd_ps(_mm_permute_ps(arg3[0].o, 0xea), zmm0[0].o, zmm5[0].o)
...
int32_t temp0_111 = __vextractps_gpr32_xmmdq_immb(zmm11, 0)
int32_t temp0_112 = __vextractps_gpr32_xmmdq_immb(zmm12, 0)
int32_t temp0_113 = __vextractps_gpr32_xmmdq_immb(zmm12, 1)
int32_t temp0_114 = __vextractps_gpr32_xmmdq_immb(zmm1[0].o, 0)
int32_t temp0_115 = __vextractps_gpr32_xmmdq_immb(zmm1[0].o, 1)
int32_t temp0_116 = __vextractps_gpr32_xmmdq_immb(zmm1[0].o, 2)
zmm0[0].o = arg1[0xf]
zmm19 = _mm_mask_broadcastss_ps(arg5, zmm16)
...
zmm5[0].o = __vaddps_xmmdq_xmmdq_xmmdq(arg4, zmm4)
...
zmm0[0].o = _mm_mask_sub_ps(arg5, zmm17, zmm0[0].o)
zmm1[0].o = *(arg1 + 0x6c)
arg3[0].o = __vinsertps_xmmdq_xmmdq_memd_immb(arg7, arg1[7].d, 0x10)
zmm17 = __vinsertps_xmmf32_xmmf32_memf32_imm8_avx512(arg7, *(arg1 + 0x74), 0x20)
...
zmm7 = _mm_mask3_fmadd_ps(_mm_permute_ps(zmm5[0].o, 0xd5), arg5, zmm17, zmm6)
zmm16 = _mm_mask_permute_ps(arg5, zmm5[0].o, 0xea)
zmm6 = _mm_permute_ps(zmm0[0].o, 0xd5)
zmm6 = _mm_mask3_fmadd_ps(__vmulps_xmmdq_xmmdq_xmmdq(arg3[0].o, zmm6), arg5, zmm1[0].o, zmm16)
zmm4 = _mm_mask3_fmadd_ps(_mm_broadcastss_ps(arg4), arg5, zmm17, zmm6)
zmm16 = _mm_mask_permute_ps(arg5, arg4, 0xd5)
zmm6 = _mm_broadcastss_ps(zmm5[0].o)
...
zmm1[0].o = _mm_mask3_fmadd_ps(zmm1[0].o, arg5, zmm17, arg3[0].o)
arg3[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zmm5[0].o, 0x9c)
arg3[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(arg3[0].o, arg4, 0x60)
zmm6 = __vinsertps_xmmdq_xmmdq_xmmdq_immb(
    __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, arg4, 0x8c), zmm5[0].o, 0x20)
zmm5[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zmm5[0].o, 0x4e)
zmm0[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(
    __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm5[0].o, arg4, 0x14), zmm0[0].o, 4)
arg4 = _mm_broadcastss_ps(zmm7)
zmm5[0].o = _mm_permute_ps(zmm7, 0xd5)
zmm5[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm6, zmm5[0].o)
zmm5[0].o = _mm_fmadd_ps(zmm5[0].o, arg3[0].o, arg4)
zmm17 = _mm_mask3_fmadd_ps(_mm_mask_permute_ps(arg5, zmm7, 0xea), arg5, zmm0[0].o, zmm5[0].o)
arg4 = _mm_broadcastss_ps(zmm4)
zmm5[0].o = _mm_permute_ps(zmm4, 0xd5)
zmm5[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm6, zmm5[0].o)
zmm5[0].o = _mm_fmadd_ps(zmm5[0].o, arg3[0].o, arg4)
float zmm24[0x4] =
    _mm_mask3_fmadd_ps(_mm_mask_permute_ps(arg5, zmm4, 0xea), arg5, zmm0[0].o, zmm5[0].o)
...
if (not(zmm9 f<= arg12))
    zmm0[0].o = _mm_mask_permute_pd(arg5, zmm20, 1)
    arg8 = _mm_mask_movehdup_ps(arg5, zmm20)
    arg3[0].o = _mm_broadcast_ss(-0f)
    arg4 = __vxorpd_xmmdq_xmmdq_xmmdq(zmm0[0].o, arg3[0].o)
    zmm4 = _mm_mask_xor_ps(arg5, arg8, arg3[0].o)
    zmm16 = _mm_mask_xor_ps(arg5, zmm20, arg3[0].o)
    ...
    zmm1[0].o = _mm_mask_permute_ps(arg5, zmm20, 0xd5)
    zmm7 = zx.o(temp0_115)
    arg3[0].o = zx.o(temp0_114)
    zmm5[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm7, arg3[0].o, 0x10)
    zmm5[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm5[0].o, arg3[0].o, 0x20)
    zmm5[0].o = _mm_mask3_fmadd_ps(zmm5[0].o, arg5, zmm1[0].o, arg10)
    arg10 = _mm_mask_mul_ps(arg5, 
        __vinsertps_xmmdq_xmmdq_xmmdq_immb(__vunpcklps_xmmdq_xmmdq_xmmdq(arg4, zmm0[0].o), zmm4, 
            0x20), 
        zmm5[0].o)
    zmm5[0].o = _mm_permute_ps(zmm7, 0xe0)
    zmm5[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm5[0].o, arg9, 0x20)
    arg12 = zx.o(temp0_116)
    ...
    zmm1[0].o = _mm_mask3_fmadd_ps(zmm1[0].o, arg5, arg11, zmm5[0].o)
    arg4 = _mm_mask3_fmadd_ps(
        __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(arg8, zmm16, 0x10)[0].q | zmm20[0].q << 0x40, 
        arg5, zmm1[0].o, arg10)
    ...
    zmm1[0].o = _mm_mask_shuffle_ps(arg5, zmm16, zmm20, 0)
    zmm1[0].o = _mm_mask_shuffle_ps(arg5, zmm1[0].o, zmm20, 0xc8)
...
zmm18 = _mm_mask_mul_ps(arg5, zmm18, zmm19)
zmm0[0].o = __vsubps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm1[0].o)
zmm1[0].o = _mm_broadcast_ss(-0f)
zmm19 = _mm_mask_permute_pd(arg5, zmm0[0].o, 1)
arg4 = _mm_mask_xor_pd(arg5, zmm19, zmm1[0].o)
zmm6 = __vmovshdup_xmmdq_xmmdq(zmm0[0].o)
zmm5[0].o = __vxorps_xmmdq_xmmdq_xmmdq(zmm6, zmm1[0].o)
zmm20 = _mm_mask_xor_ps(arg5, zmm0[0].o, zmm1[0].o)
...
float zmm29[0x4] = _mm_mask_movehdup_ps(arg5, zmm26)
...
arg4 = __vmulps_xmmdq_xmmdq_xmmdq(__vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm29, zmm24, 0x68), 
    zmm4)
zmm4 = _mm_fmadd_ps(_mm_mask_permute_ps(arg5, zmm26, 0xda), zmm7, arg4)
arg4 = _mm_fmadd_ps(
    __vmulps_xmmdq_xmmdq_xmmdq(
        __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm6, zmm20, 0x10)[0].q | zmm0[0].q << 0x40, 
        zmm4), 
    zmm1[0].o, arg3[0].o)
zmm1[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(arg6, zmm8, 1)
arg3[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm1[0].o, arg4)
arg4 = __vinsertps_xmmdq_xmmdq_xmmdq_immb(_mm_permute_ps(zmm0[0].o, 0x4a), zmm5[0].o, 0x20)
zmm4 = _mm_mask_permute_ps(arg5, zmm17, 0xc0)
zmm7 = _mm_mask_permute_ps(arg5, zmm20, 0xa0)[0].q | zmm0[0].q << 0x40
zmm4 = _mm_fmadd_ps(zmm4, arg4, 
    __vmulps_xmmdq_xmmdq_xmmdq(
        _mm_mask_shuffle_ps(arg5, zmm26, _mm_mask_shuffle_ps(arg5, zmm24, zmm26, 0x30), 0x80), 
        zmm7))
zmm19 = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(
    __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm19, zmm5[0].o, 0x10), zmm5[0].o, 0x20)
zmm6 = _mm_permute_ps(_mm_mask_shuffle_ps(arg5, zmm26, zmm24, 0xc), 0x78)
zmm5[0].o = _mm_mask_permute_ps(arg5, zmm26, 0x46)
zmm5[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm5[0].o, zmm24, 0x68)
zmm5[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm5[0].o, zmm7)
zmm5[0].o = _mm_fmadd_ps(zmm5[0].o, arg4, zmm6)
zmm0[0].o = __vshufps_xmmdq_xmmdq_xmmdq_immb(_mm_mask_shuffle_ps(arg5, zmm20, zmm0[0].o, 0), 
    zmm0[0].o, 0xc8)
zmm0[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm5[0].o)
zmm0[0].o = _mm_mask3_fmadd_ps(zmm0[0].o, arg5, zmm4, zmm19)
zmm1[0].o = __vmovddup_xmmdq_xmmq(zmm1[0].q)
zmm0[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm1[0].o, zmm0[0].o)
zmm1[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(arg8, arg11, 0x10)
arg4 = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm1[0].o, arg10, 0x20)
zmm1[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(arg11, arg9, 0x10)
zmm1[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm1[0].o, arg13, 0x20)
...
zmm5[0].o = __vaddps_xmmdq_xmmdq_xmmdq(arg4, arg3[0].o)
zmm0[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm4, zmm0[0].o)
int32_t temp0_305 = __vextractps_gpr32_xmmdq_immb(zmm0[0].o, 0)
int32_t temp0_306 = __vextractps_gpr32_xmmdq_immb(zmm0[0].o, 1)
int32_t temp0_307 = __vextractps_gpr32_xmmdq_immb(zmm0[0].o, 2)
zmm0 = __vandps_ymmu32_maskmskw_ymmu32_memu32_avx512(arg5, 
    _mm256_blend_ps(_mm256_broadcast_ss(1.17549435e-38f), zmm5, 7), 0x7fffffff)
...
label_1400096cc:
    ...
    arg4 = _mm_permute_pd(zmm5[0].o, 1)
    zmm19 = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm1[0].o, zmm5[0].o, 0x8a)
    arg13 = zx.o(temp0_305)
    zmm6 = zx.o(temp0_306)
    zmm20 = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(arg13, zmm6, 0x1c)
    zmm4 = zx.o(temp0_307)
    arg10 = _mm_mask_load_ps(k0, data_142d3f660)
    arg4 = __vinsertps_xmmdq_xmmdq_xmmdq_immb(
        __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(
            __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm5[0].o, arg4, 0x10), arg13, 0x20), 
        zmm4, 0x30)
    zmm7 = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(arg10, zmm1[0].o, 0x46)
    arg3[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(arg3[0].o, zmm6, 0x2a)
    zmm0[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm1[0].o, 0x9c)
    zmm0[0].o = __vmulps_xmmdq_xmmdq_xmmdq(arg3[0].o, zmm0[0].o)
    zmm0[0].o = _mm_fmsub_ps(zmm0[0].o, arg4, zmm7)
    arg8 = _mm_mask_broadcastss_ps(k0, zmm0[0].o)
    arg12 = _mm_mask_permute_ps(k0, zmm0[0].o, 0x55)
    arg9 = _mm_mask_permute_ps(k0, zmm0[0].o, 0xaa)
    zmm29 = _mm_mask_permute_ps(k0, zmm0[0].o, 0xff)
    zmm30 = _mm_mask_load_ss(k0, 1f)
    arg4 = _mm_mask_shuffle_ps(k0, zmm30, zmm4, 0)
    zmm0[0].o = _mm_mask_unpacklo_ps(k0, arg13, zmm6)
    ...
    zmm0[0].o = __vshufps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm5[0].o, 5)
    zmm6 = __vshufps_xmmdq_xmmdq_xmmdq_immb(zmm5[0].o, zmm1[0].o, 5)
    arg3[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm5[0].o, zmm1[0].o, 0x8a)
    zmm6 = _mm_mask3_fmsub_ps(__vmulps_xmmdq_xmmdq_xmmdq(zmm6, arg3[0].o), k0, zmm19, zmm0[0].o)
    zmm0[0].o = _mm_mask_mul_ps(k0, arg12, arg9)
    zmm0[0].o = _mm_mask3_fmadd_ps(zmm0[0].o, k0, arg8, zmm29)
    ...
    arg3[0].o = __vaddps_xmmdq_xmmdq_xmmdq(arg3[0].o, zmm7)
    arg11 = _mm_mask_sub_ps(k0, zmm0[0].o, arg3[0].o)
    zmm0[0].o = __vxorps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm0[0].o)
    arg11 f- zmm0[0].o
    
    if (arg11 f!= zmm0[0].o || not(is_ordered.d(arg11, zmm0[0].o)))
        zmm30 = zmm5[0].q | zmm1[0].q << 0x40
        arg10 = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm4, arg10, 0xf6)
        zmm7 = _mm_broadcastss_ps(arg4)
        zmm0[0].o = __vshufps_xmmdq_xmmdq_xmmdq_immb(zmm5[0].o, zmm1[0].o, 0x20)
        ...
        arg9 = _mm_mask3_fmsub_ps(arg9, k0, zmm19, zmm0[0].o)
        zmm0[0].o = _mm_permute_ps(zmm6, 0x33)
        arg3[0].o = data_142d4cc30
        arg3[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(arg3[0].o, zmm4, 0x10)
        zmm4 = _mm_permute_ps(zmm6, 0x66)
        arg3[0].o = __vmulps_xmmdq_xmmdq_xmmdq(arg3[0].o, zmm4)
        arg3[0].o = _mm_mask3_fmsub_ps(arg3[0].o, k0, arg10, zmm0[0].o)
        arg12 = _mm_mask3_fmsub_ps(arg12, k0, zmm20, arg3[0].o)
        zmm0[0].o = _mm_permute_pd(zmm6, 3)
        arg3[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm0[0].o, arg13, 0x1d)
        zmm4 = __vmovddup_xmmdq_xmmq(zmm6[0].q)
        arg3[0].o = __vmulps_xmmdq_xmmdq_xmmdq(arg3[0].o, zmm4)
        arg3[0].o = _mm_mask3_fmadd_ps(arg3[0].o, k0, zmm20, zmm0[0].o)
        arg8 = _mm_mask3_fmsub_ps(arg8, k0, arg10, arg3[0].o)
        zmm0[0].o = _mm_permute_ps(arg4, 0xcc)
        arg3[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zmm5[0].o, 0x9d)
        zmm1[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(arg3[0].o, zmm1[0].o, 0xb0)
        ...
        zmm0[0].o = _mm_mask_div_ps(k0, zmm0[0].o, arg11)
        arg3[0].o = _mm_mask_mul_ps(k0, zmm29, zmm0[0].o)
        arg4 = _mm_mask_mul_ps(k0, arg12, zmm0[0].o)
        zmm1[0].o = _mm_mask_mul_ps(k0, arg9, zmm0[0].o)
        zmm0[0].o = _mm_mask_mul_ps(k0, arg8, zmm0[0].o)
    ...
    zmm19 = _mm_mask_movehdup_ps(k0, zmm30)
    zmm20 = _mm_mask_permute_pd(k0, zmm30, 1)
    arg8 = _mm_mask_permute_ps(k0, zmm30, 0xe7)
    arg9 = _mm_mask_movehdup_ps(k0, arg3[0].o)
    ...
    zmm0[0].o = 0x800000
    arg3[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, 0x800000, 0x30)
    ...
    if (cond:2)
        goto label_1400096cc
    
    zmm0[0].o = zx.o(temp0_305)
    arg3[0].o = zx.o(temp0_306)
    zmm0[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, arg3[0].o, 0x10)
    arg3[0].o = zx.o(temp0_307)
    ...
    zmm0[0].o = __vxorps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm0[0].o)
    zmm6 = __vxorps_xmmdq_xmmdq_xmmdq(zmm6, zmm6)
    arg9 = _mm_mask_mov_pd(k0, 0x3f800000)
    arg3[0].o = __vxorps_xmmdq_xmmdq_xmmdq(arg3[0].o, arg3[0].o)
    arg8 = _mm_mask_xor_ps(k0, arg8, arg8)
...
zmm1[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(arg3[0].o, arg9, 0x10)
zmm1[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm6, 0x20)
zmm0[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm0[0].o, 0x30)
zmm1[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm30, zmm19, 0x10)
zmm1[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm1[0].o, zmm20, 0x20)
zmm1[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm1[0].o, arg8, 0x30)
zmm7 = __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(
    __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(
        ...
        *arg2), 
    k0, arg4, arg2[1].d)
arg3[0].o = _mm_mask_broadcastss_ps(k0, zmm18)
zmm1[0].o = __vmulps_xmmdq_xmmdq_xmmdq(arg3[0].o, zmm1[0].o)
arg3[0].o = _mm_mask_permute_ps(k0, zmm18, 0x55)
arg3[0].o = _mm_fmadd_ps(arg3[0].o, zmm0[0].o, zmm1[0].o)
zmm1[0].o = _mm_mask_permute_ps(k0, zmm18, 0xaa)
...
arg8 = _mm_mask_broadcastss_ps(k0, zmm0[0].o)
arg6 = _mm_mask_mul_ps(k0, arg8, zmm7)
...
zmm18 = __vinsertps_xmmf32_xmmf32_memf32_imm8_avx512(__vmovsd_xmmdq_memq(arg1[0xc].q), 
    *(arg1 + 0xc8), 0x20)
zmm0[0].o = _mm_mask_sub_ps(k0, zmm0[0].o, zmm18)
arg10 = _mm_mask_permute_ps(k0, zmm0[0].o, 0xc9)
arg3[0].o = _mm_permute_ps(zmm7, 0xd2)
arg11 = _mm_mask_permute_ps(k0, zmm0[0].o, 0xd2)
zmm0[0].o = _mm_permute_ps(zmm7, 0xc9)
zmm0[0].o = _mm_mask_mul_ps(k0, zmm0[0].o, arg11)
arg3[0].o = _mm_mask3_fmsub_ps(arg3[0].o, k0, arg10, zmm0[0].o)
zmm0[0].o = zx.o(temp0_111)
zmm8 = _mm_blend_epi32(zmm11, zmm0[0].o, 1)
zmm0[0].o = zx.o(temp0_112)
zmm0[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zx.o(temp0_113), 0x10)
zmm9 = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm12, zmm0[0].o, 3)
zmm0[0].o = zx.o(temp0_114)
zmm0[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zx.o(temp0_115), 0x10)
arg13 = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm0[0].o, zx.o(temp0_116), 0x20)
...
zmm30 = _mm_mask3_fmadd_ps(_mm_mask_permute_ps(k0, arg3[0].o, 0xea), k0, arg13, arg4)
arg3[0].o = __vinsertps_xmmf32_xmmf32_memf32_imm8_avx512(zmm20, *(arg1 + 0x94), 0x20)
zmm29 = __vinsertps_xmmf32_xmmf32_memf32_imm8_avx512(__vmovsd_xmmdq_memq(*(arg1 + 0xcc)), 
    *(arg1 + 0xd4), 0x20)
arg3[0].o = _mm_mask_sub_ps(k0, arg3[0].o, zmm29)
...
arg4 = _mm_mask3_fmadd_ps(_mm_mask_mul_ps(k0, zmm24, _mm_permute_ps(zmm4, 0xd5)), k0, zmm17, zmm7)
zmm4 = _mm_mask3_fmadd_ps(_mm_permute_ps(zmm4, 0xea), k0, zmm26, arg4)
arg9 = _mm_mask_mul_ps(k0, zmm19, zmm1[0].o)
zmm20 = _mm_mask_mul_ps(k0, arg8, zmm1[0].o)
arg4 = _mm_permute_ps(zmm1[0].o, 0xd2)
zmm7 =
    _mm_mask3_fmsub_ps(_mm_mask_mul_ps(k0, _mm_permute_ps(zmm1[0].o, 0xc9), arg11), k0, arg10, arg4)
arg4 = _mm_broadcastss_ps(zmm7)
zmm5[0].o = _mm_permute_ps(zmm7, 0xd5)
zmm5[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm9, zmm5[0].o)
zmm5[0].o = _mm_fmadd_ps(zmm5[0].o, zmm8, arg4)
arg12 = _mm_mask3_fmadd_ps(_mm_mask_permute_ps(k0, zmm7, 0xea), k0, arg13, zmm5[0].o)
...
arg10 = _mm_mask_broadcastss_ps(k0, zmm8)
arg11 = _mm_mask_permute_ps(k0, zmm8, 0xd5)
zmm7 = _mm_mask_broadcastss_ps(k0, zmm16)
zmm6 = _mm_mask3_fmadd_ps(zmm6, k0, zmm7, zmm18)
arg1[0xc].d = zmm6[0]
*(arg1 + 0xc4) = __vextractps_memd_xmmdq_immb(zmm6, 1)
*(arg1 + 0xc8) = __vextractps_memd_xmmdq_immb(zmm6, 2)
arg6 = _mm_mask3_fmadd_ps(arg6, k0, zmm7, zmm29)
*(arg1 + 0xcc) = arg6[0]
...
zmm4 = _mm_permute_ps(arg3[0].o, 0x1b)
zmm4 = __vmulps_xmmdq_xmmdq_xmmdq(zmm5[0].o, zmm4)
arg13 = __vpbroadcastq_xmmu64_maskmskw_memu64_avx512(k0, -0x407fffffc0800000)
zmm4 = _mm_mask3_fmadd_ps(_mm_mask_mul_ps(k0, zmm4, arg13), k0, arg3[0].o, zmm16)
zmm5[0].o = _mm_permute_ps(zmm1[0].o, 0x55)
zmm0[0].o = _mm_permute_pd(arg3[0].o, 1)
zmm18 = _mm_mask_load_ps(k0, data_142d3f7d0)
zmm0[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm5[0].o, zmm0[0].o)
zmm0[0].o = _mm_mask3_fmadd_ps(zmm0[0].o, k0, zmm18, zmm4)
...
zmm29 = _mm_mask_broadcastss_ps(k0, zmm30)
zmm5[0].o = _mm_broadcastss_ps(arg4)
zmm0[0].o = _mm_permute_ps(zmm6, 0x1b)
zmm0[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm5[0].o, zmm0[0].o)
zmm0[0].o = _mm_mask_mul_ps(k0, zmm0[0].o, arg13)
zmm0[0].o = _mm_mask3_fmadd_ps(zmm0[0].o, k0, zmm6, zmm16)
zmm5[0].o = _mm_permute_ps(arg4, 0x55)
zmm1[0].o = _mm_permute_pd(zmm6, 1)
zmm1[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm5[0].o, zmm1[0].o)
zmm1[0].o = _mm_mask3_fmadd_ps(zmm1[0].o, k0, zmm18, zmm0[0].o)
...
zmm4 = _mm_mask3_fmadd_ps(zmm4, k0, zmm29, arg3[0].o)
...
int64_t k1 = _mm_cmp_round_ss_mask(k0, zmm16, zmm1[0].o, 6)
zmm5[0].o = 0xffffffff
...
arg3[0].o = 0xffffffff
arg3[0].o = _mm_mask_move_ss(k1, zmm0[0].o, arg8)
zmm1[0].o = _mm_broadcastss_ps(zmm1[0].o)
...
zmm0[0].o = _mm_mask3_fmadd_ps(zmm0[0].o, k0, zmm29, zmm6)
...
zmm5[0].o = _mm_mask_move_ss(_mm_cmp_round_ss_mask(k0, zmm16, zmm1[0].o, 6), zmm0[0].o, arg8)
...
int64_t k1_2 = _mm_cmp_round_ss_mask(k0, arg8, zmm1[0].o, 2)
zmm1[0].o = 0xbf800000
zmm1[0].o = _mm_mask_move_ss(k1_2, zmm0[0].o, zmm16)
zmm1[0].o = _mm_broadcastss_ps(zmm1[0].o)
zmm0[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm1[0].o)
arg1[0xe] = arg3[0].o
arg1[0xf] = zmm0[0].o
...
zmm0[0].o = _mm_mask3_fmadd_ps(zmm0[0].o, k0, zmm7, arg9)
arg1[0x10].d = zmm0[0]
*(arg1 + 0x104) = __vextractps_memd_xmmdq_immb(zmm0[0].o, 1)
zmm1[0].o = _mm_mask_mul_ps(k0, zmm24, arg11)
*(arg1 + 0x108) = __vextractps_memd_xmmdq_immb(zmm0[0].o, 2)
zmm0[0].o = __vmovsd_xmmdq_memq(*(arg1 + 0x10c))
zmm1[0].o = _mm_mask3_fmadd_ps(zmm1[0].o, k0, zmm17, arg10)
...
double rdx = arg3[0]
zmm0[0].o = zx.o(rdx.d)
zmm1[0].o = zx.o(rax_1.d)
uint32_t result = (rax_1 u>> 0x20).d
arg3[0].o = zx.o((rdx u>> 0x20).d)
arg4 = *(arg1 + 0x18)
zmm4 = arg1[1].d
zmm5[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(arg3[0].o, zmm1[0].o, 0x10)
...
arg3[0].o = _mm_fmsub_ps(arg3[0].o, zmm5[0].o, zmm7)
...
zmm0[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm0[0].o, arg3[0].o)
zmm0[0].o = _mm_fmsub_ps(zmm0[0].o, zmm5[0].o, zmm1[0].o)
...
zmm5[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(arg3[0].o, arg4, 0x10)
zmm5[0].o = __vinsertps_xmmdq_xmmdq_memd_immb(zmm5[0].o, *(arg1 + 0x44), 0x20)
zmm0[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm0[0].o, 0x10)
...
arg4 = _mm_fmsub_ps(__vmulps_xmmdq_xmmdq_xmmdq(zmm0[0].o, arg4), zmm4, zmm5[0].o)
...
zmm1[0].o = _mm_fmadd_ps(zmm1[0].o, zmm5[0].o, arg4)
...
arg3[0].o = *(arg1 + 8)
arg4 = *(arg1 + 4)
int64_t temp0_651 = __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(
    _mm_mask_mul_ps(k0, 
...
zmm4 = *(arg1 + 0x34)
int64_t temp0_667 = _mm_fmadd_ps(
    _mm_mask_mul_ps(k0, 
        __vmulps_xmmf32_maskmskw_xmmf32_memf32_avx512(k0, 
            __vinsertps_xmmdq_xmmdq_xmmdq_immb(
                __vinsertps_xmmdq_xmmdq_xmmdq_immb(
        ...
        arg13), 
    zmm1[0].o, zmm5[0].o)
zmm5[0].o = __vmovsd_xmmdq_memq(*(arg1 + 0x38))
zmm5[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm5[0].o, zmm1[0].o, 0x20)
zmm5[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm5[0].o, zmm4, 0x30)
zmm5[0].o = __vmulps_xmmf32_maskmskw_xmmf32_memf32_avx512(k0, zmm5[0].o, *(arg1 + 0xf4))
zmm5[0].o = _mm_mask3_fmadd_ps(zmm5[0].o, k0, zmm18, temp0_667)
...
zmm1[0].o = _mm_mask3_fmadd_ps(zmm1[0].o, k0, zmm19, zmm5[0].o)
...
arg3[0].o = _mm_broadcastss_ps(_mm_mask_move_ss(_mm_cmp_round_ss_mask(k0, arg8, arg3[0].o, 2), 
    zmm0[0].o, zmm16))
zmm1[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm1[0].o, arg3[0].o)
arg1[0xa] = zmm0[0].o
arg1[0xb] = zmm1[0].o
