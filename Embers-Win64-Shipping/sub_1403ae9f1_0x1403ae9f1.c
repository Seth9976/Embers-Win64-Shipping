...
do
    ...
    uint16_t zmm2[0x8] = zx.o(*(rsi_1 + result))
    uint16_t zmm3[0x8] = zx.o(*(rsi_1 + (result << 1)))
    uint16_t zmm4[0x8] = zx.o(*(rsi_1 + rdx_1))
    uint16_t zmm5[0x8] = zx.o(*(rsi_1 + (result << 2)))
    int32_t temp0_17[0x4] = __punpcklbw_xmmdq_memdq(zmm0, zx.o(0))
