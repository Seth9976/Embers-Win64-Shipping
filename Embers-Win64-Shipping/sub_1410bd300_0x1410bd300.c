...
if (data_143e2ce90 s> *rdi_1)
    _Init_thread_header(&data_143e2ce90)
    
    if (data_143e2ce90 == 0xffffffff)
        ...
        data_143e2ce88 = rax_8
        _Init_thread_footer(&data_143e2ce90)

if (data_143e2cea0 s> *rdi_1)
    _Init_thread_header(&data_143e2cea0)
    
    if (data_143e2cea0 == 0xffffffff)
        ...
        data_143e2ce98 = rax_11
        _Init_thread_footer(&data_143e2cea0)

int64_t rdi_2 = data_143e2ce98
int64_t rcx
