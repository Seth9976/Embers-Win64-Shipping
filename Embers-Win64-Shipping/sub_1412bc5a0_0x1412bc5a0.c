...
if (data_143e8c890 s> *rdi_1)
    _Init_thread_header(&data_143e8c890)
    
    if (data_143e8c890 == 0xffffffff)
        ...
        data_143e8c888 = rax_9
        _Init_thread_footer(&data_143e8c890)

if (data_143e8c8b0 s> *rdi_1)
    _Init_thread_header(&data_143e8c8b0)
    
    if (data_143e8c8b0 == 0xffffffff)
        ...
        data_143e8c8a8 = rax_12
        _Init_thread_footer(&data_143e8c8b0)

if (data_143e8c8d0 s> *rdi_1)
    _Init_thread_header(&data_143e8c8d0)
    
    if (data_143e8c8d0 == 0xffffffff)
        ...
        data_143e8c8c8 = rax_15
        _Init_thread_footer(&data_143e8c8d0)
