...
int128_t var_e8
sub_1419a2ec0(rcx_1, &var_e8, &data_143eba990, 0)
...
*(rdi + 0x10) = (*arg4).o
int64_t var_f8
var_f8.o = sub_141359030(rcx_4)
sub_141998c50(var_e8.q, &data_143ebe300, rdi)
...
if (rax_19 == 0)
    ...
    var_e8.q = rdi
    int128_t zmm6_2 = sub_141359030(rcx_6)
    var_e8:8.q = &data_143ebe330
    var_e8 = var_e8
    void arg_8
    sub_141992bd0(rbx_1, &arg_8, &var_e8, 1)
    *rbx_1 = &data_142f64c50
    *(rbx_1 + 0x38) = arg2.o
    *(rbx_1 + 0x48) = var_88
    *(rbx_1 + 0x58) = zmm6_2
    *(rbx_1 + 0x68) = var_60.o
