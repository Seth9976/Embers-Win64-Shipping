...
if (*(arg2 + 0x520) s<= 0)
    ...
    if (rdx_6 != r11_1)
        ...
        int32_t rdx_10 = *(r10_1 + (sx.q(r8_4) << 2)) & rbx_2
    ...
    if (rdx_18 != r11_2)
        ...
        label_1409e6323:
            ...
            while (true)
                ...
                if (rdx_22 != 0)
                    goto label_1409e6323
            
            var_110_1:0xc.d = r11_2
    
    while (true)
        rax = zx.q(var_e0_2:0xc.d)
        int64_t rcx_21 = var_e0_2.q
        
        if (rax.d == (var_110_1:8.q u>> 0x20).d && rcx_21 == r13_1 + 0x10 && var_f0.q == r13_1)
            break
        
        int32_t rdi_2 = data_143a1c6b4
        
        if (rax.d s< *(rcx_21 + 0x18))
            rdi_2 = rax.d
        
        if (sub_141cdff60(*(arg2 + 0x28), rdi_2) == 0)
            int64_t rdx_24 = sx.q(rdi_2) * 3
            int64_t rcx_23 = **(rbx_3 + 0x18)
    ...
    rax = sub_1409b2cf0(arg2, &var_138)
    zmm0 = *rax
    rcx_1 = rax[3].d
    zmm1 = zx.o(rax[2])
*(rbx_1 + 0xb8) = zmm0
