...
while (true)
    ...
    if (var_358_1 == 0)
    label_14185da71:
        sub_14185cc80(r15_1, rax_10, arg3)
    else
        while (true)
            uint128_t zmm1
            ...
            if (rax_10 s<= 8)
                if (r13_1 u> r15_1)
                    do
                        ...
                        if (&r15_1[1] u<= r13_1)
                            do
                                if (sub_1418874f0(arg3, r14_2) s< sub_1418874f0(arg3, rbp_2))
                                    rbp_2 = r14_2
            ...
            while (true)
                ...
                if (rbp_1 u<= r13_1 && sub_1418874f0(arg3, rbp_1) s>= sub_1418874f0(arg3, r15_1))
                    continue
