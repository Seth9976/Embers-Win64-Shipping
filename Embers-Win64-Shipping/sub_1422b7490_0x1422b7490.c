...
if (rax_6 != 0)
    ...
    if ((arg1[5].b & 1) != 0)
        ...
        do
            ...
            int32_t* rdx_8 = rdx_7 + rcx_7
            
            if (rdx_7 == neg.q(rcx_7))
                rdx_8 = nullptr
            else
                *rdx_8 = 0
                rdx_8[2] = 0
    ...
    if (rax_6 s> 0)
        do
            ...
            if ((rax_11.b & 1) != 0)
                rax_11 = (rax_11 s>> 1) + arg2
            
            sub_1422b6350(arg1, (sx.q(i) << 6) + rax_11, arg3)
            i += 1
        while (i s< arg2[1].d)
