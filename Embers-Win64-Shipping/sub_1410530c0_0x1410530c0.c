...
if (rax == 0)
    ...
    *rbx = &data_142f00990
    __builtin_memset(&rbx[0xa], 0, 0x34)
    __builtin_memset(&rbx[0x11], 0, 0x50)
...
if (&rdx_1[1] u> var_100[1])
    int64_t* rcx_5 = &var_108
    char var_df
    
    if ((var_df & 0x20) != 0)
        sub_140b54070(rcx_5, &rbx[0x10], arg4)
    else
        var_108[0x2a](rcx_5, &rbx[0x10], 4)
else
    rbx[0x10].d = *rdx_1
    *var_100 += 4
...
sub_140fdadf0(&var_108, &rbx[0x19], arg4)
int32_t rcx_11 = 0
...
if (sub_14103be80(&var_130, rbx, arg4) != 0)
    ...
    if (rsi.d != 0 || r8 != 0)
        sub_1405da9e0(&rbx[0xe], rsi.d, r8)
        memcpy(rbx[0xe], r15, rsi.d)
    else
        *(rbx + 0x7c) = 0
    
    int32_t rdx_12 = rbx[0x18].d
    
    if (rdx_12 s> *(rbx + 0x4c))
        sub_1405c5510(&rbx[8], rdx_12)
    
    int32_t* r15_1 = rbx[0x17]
    uint64_t r12_2 = sx.q(rbx[0x18].d) << 2 u>> 2
    
    if (r15_1 u> &r15_1[rbx[0x18]])
        r12_2 = 0
    ...
    *(rbx + 0x60) = (sx.q(var_78) + rbx[0xe]).o
    void* rax_18 = rbx[0xc]
