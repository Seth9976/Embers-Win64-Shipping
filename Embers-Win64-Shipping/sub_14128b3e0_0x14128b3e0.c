...
if (data_143e8da10 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8da10)
    
    if (data_143e8da10 == 0xffffffff)
        ...
        data_143e8da08 = rax_4
        _Init_thread_footer(&data_143e8da10)

if (data_143e8da08 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()

sub_1410b3fe0(arg2, u"MAX_NUM_LIGHTMAP_COEF", 2)
sub_1412727e0(arg1, arg2)
