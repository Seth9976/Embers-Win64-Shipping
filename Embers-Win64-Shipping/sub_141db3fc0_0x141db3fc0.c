...
while (true)
    ...
    if (rcx_7.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0x1b0 && result == arg1 + 0x1a0)
        return result
    
    int64_t* rdx_9 = *(*result + rcx_7 * 0x10)
    
    if (rdx_9 != 0)
        sub_141db8590(arg3, rdx_9)
