...
int64_t r9 = *arg1
(*(r9 + 8))(arg1, sx.q(arg2[1].d) * 0x48, sx.q(*(arg2 + 0xc)) * 0x48, r9)
int64_t r9_1 = *arg1
...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        void* rbx_1 = *var_58 + sx.q(i) * 0x48
        (*(*arg1 + 0x140))(arg1, rbx_1)
        zmm1_1 = sub_141cd3b50(arg1, rbx_1 + 8, zmm1_1)
        int32_t var_4c
...
do
    ...
    if (rdx_9 == 0)
        ...
        *rdx_12 &= not.d(1 << (rsi_1.b & 0x1f))
        ...
        rdi_1 = sx.q(arg2[6].d)
        int64_t r9_2 = *arg2
        int64_t r8_6 = sx.q(*(r9_2 + rdi_1 * 0x48 + 4))
        arg2[6].d = r8_6.d
        *(arg2 + 0x34) = rdx_9 - 1
        
        if (rdx_9 != 1)
            *(r9_2 + r8_6 * 0x48) = 0xffffffff
    ...
    *r8_7 |= 1 << (rdi_1.b & 0x1f)
    int64_t rdx_14 = *arg2
    int64_t rcx_13 = sx.q(rdi_1.d) * 9
    *(rdx_14 + (rcx_13 << 3)) = 0
    *(rdx_14 + (rcx_13 << 3) + 0x10) = 1
    void* rdi_2 = rdx_14 + (rcx_13 << 3)
    *(rdi_2 + 0x18) = 0
    *(rdi_2 + 8) = &data_142e40618
    *(rdi_2 + 0x20) = 0
    *(rdi_2 + 0x28) = 0
    int64_t var_68
    *(rdi_2 + 0x30) = var_68
    int32_t var_60
    *(rdi_2 + 0x38) = var_60
    int512_t zmm1 = sub_1409dd290(rdi_2 + 8, 0)
    *(rdi_2 + 0x40) = 0xffffffff
    (*(*arg1 + 0x140))(arg1, rdi_2)
    sub_141cd3b50(arg1, rdi_2 + 8, zmm1)
    r15 += 1
while (r15 s< arg_8)
