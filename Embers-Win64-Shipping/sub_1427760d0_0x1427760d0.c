...
if (i != 0xffffffff)
    ...
    do
        ...
        if (*(rax_19 + rdx) == arg2)
            ...
            int64_t rax_21 = sx.q(*(r8_9 + rdx + 0x54)) & rbp_1
            void* rcx_11 = r11 + (rax_21 << 2)
            
            for (int32_t j = *(r11 + (rax_21 << 2)); j != 0xffffffff; j = *rcx_11)
                if (j == i)
                    *rcx_11 = *(r8_9 + rdx + 0x50)
                    break
                
                rcx_11 = sx.q(j) * 0x60 + 0x50 + rdx
            
            void* rcx_16 = *arg1 + r8_9
            
            if (*(rcx_16 + 0x10) != 0)
                void* rax_24 = *(rcx_16 + 0x20)
                void* rcx_17 = rcx_16 + 0x30
