...
if (data_143e8df90 s> *rdi_1)
    _Init_thread_header(&data_143e8df90)
    
    if (data_143e8df90 == 0xffffffff)
        ...
        data_143e8df88 = rax_12
        _Init_thread_footer(&data_143e8df90)

if (data_143e8dfb0 s> *rdi_1)
    _Init_thread_header(&data_143e8dfb0)
    
    if (data_143e8dfb0 == 0xffffffff)
        ...
        data_143e8dfa8 = rax_15
        _Init_thread_footer(&data_143e8dfb0)

if (data_143e8dfd0 s> *rdi_1)
    _Init_thread_header(&data_143e8dfd0)
    
    if (data_143e8dfd0 == 0xffffffff)
        ...
        data_143e8dfc8 = rax_18
        _Init_thread_footer(&data_143e8dfd0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8df88
int64_t rcx
...
label_1412ab608:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412ab603
    
    rbx.b = 1
    goto label_1412ab608
