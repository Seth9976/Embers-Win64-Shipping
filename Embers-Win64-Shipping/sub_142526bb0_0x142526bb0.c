...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_7[4]
    sub_140d30490(arg2, &var_174, r8_7)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_9[4]
    sub_140d30490(arg2, &var_170, r8_9)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_13[4]
    sub_140d30490(arg2, &var_160, r8_13)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_21[4]
    sub_140d30490(arg2, &var_f8, r8_21)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_23[4]
    sub_140d30490(arg2, &var_108, r8_23)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_25[4]
    r9 = sub_140d30490(arg2, &var_178, r8_25)
else
...
int32_t var_188 = var_178.d
uint128_t* var_190 = &var_e8
int128_t var_d8
int128_t* var_198 = &var_d8
int64_t* rcx_14 = var_168
char var_1a0 = r15.b
void* var_1a8 = rsi
char rax_20 = var_170.b
*(arg2 + 0x20) = rdi + rax_16
var_d8 = zmm1
char result = sub_1420d54a0(rcx_14, &var_118, &var_128, r9, rax_20, r12.b, r14, rax_19)
