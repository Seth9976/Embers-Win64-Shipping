...
if (not(cond:0))
    ...
    do
        ...
        if ((0x800 & r9_2.w) != 0 || j_16.d == 0)
            int64_t* rcx_32 = *r13
            int32_t var_2c4_1 = 0
            *(rcx_32 + rbx_3) = (_mm_unpacklo_ps(zx.o(0), 0)).q
            *(rcx_32 + rbx_3 + 8) = 0
            int64_t rax_46 = *arg2
            int64_t rcx_33 = *r13
            zmm1 = *(rbx_3 + rax_46 + 4)
            ...
            *(rbx_3 + rcx_33 + 8) = zmm2
            ...
            if (r8 == 0)
                sub_1409965c0(rcx_13, rdx_3, r8_1, r9_4)
            else
                sub_140996400(rcx_13, rdx_3, r8_1, &var_398, &var_318, r9_4)
                j_12 = var_380:4.d
            ...
            *(rcx_20 + rbx_3 + 8) = 0
            ...
            if (j_17.d s> 0)
                ...
                do
                    ...
                    zmm3[0] = zmm3[0] f* *(rax_27 + (rcx_21 << 2))
                    zmm2 = zmm2 * zmm3[0]
                    zmm1 = zmm1 * zmm3[0] f+ *(rbx_3 + rdx_7 + 4)
                    zmm3[0] = zmm3[0] f+ *(rbx_3 + rdx_7)
            ...
            if (j_14 s> 0)
                ...
                do
                    ...
                    zmm3[0] = zmm3[0] f* *(rax_29 + (rcx_22 << 2))
                    zmm2 = zmm2 * zmm3[0]
                    zmm1 = zmm1 * zmm3[0] f+ *(rbx_3 + rdx_8 + 4)
                    zmm3[0] = zmm3[0] f+ *(rbx_3 + rdx_8)
            ...
            zmm1 = *(rbx_3 + rax_31 + 4)
            zmm2 = *(rbx_3 + rax_31 + 8)
            zmm3[0] = zmm3[0] f* *(rbx_3 + rax_31)
            zmm2 = zmm2 * zmm3[0]
            zmm1 = zmm1 * zmm3[0] f+ *(rbx_3 + rcx_23 + 4)
            zmm3[0] = zmm3[0] f+ *(rbx_3 + rcx_23)
            ...
            *(rbx_3 + rcx_23 + 8) = zmm2
            ...
            if (r14_1 == 0)
                ...
                int64_t rcx_24 = *arg4
                int32_t var_2d0_1 = 0
                *(rbx_3 + rcx_24) = temp0_2.q
                *(rbx_3 + rcx_24 + 8) = 0
                int64_t* rcx_25 = *arg5
                *(rcx_25 + rbx_3) = (_mm_unpacklo_ps(zx.o(0), 0)).q
                *(rcx_25 + rbx_3 + 8) = var_2d0_1
                ...
                if (j_13 s> 0)
                    ...
                    do
                        ...
                        zmm3 = *(r8_7 + rdi_1 - r10_1)
                        int64_t rcx_26 = sx.q(*r13_1) * 3
                        int64_t rax_35 = *arg2
                        zmm3[0] = zmm3[0] f* *(rax_35 + (rcx_26 << 2))
                        zmm1 = *(rax_35 + (rcx_26 << 2) + 4)
                        zmm2 = *(rax_35 + (rcx_26 << 2) + 8)
                        zmm3[0] = zmm3[0] f+ *(rbx_3 + rdx_9)
                        zmm1 = zmm1 * zmm3[0]
                        zmm3[0] = zmm3[0] * zmm2
                        zmm1 = zmm1 f+ *(rbx_3 + rdx_9 + 4)
                        *(rbx_3 + rdx_9) = zmm3[0]
                        zmm3[0] = zmm3[0] f+ *(rbx_3 + rdx_9 + 8)
                        *(rbx_3 + rdx_9 + 4) = zmm1
                        *(rbx_3 + rdx_9 + 8) = zmm3[0]
                        ...
                        zmm3 = *(rax_37 + (rcx_27 << 2) + 8)
                        zmm4[0] = zmm4[0] f* *(rax_37 + (rcx_27 << 2))
                        zmm4[0] = zmm4[0] * zmm3[0]
                        zmm1 = zmm1 * zmm2 f+ *(rbx_3 + rdx_10 + 4)
                        zmm4[0] = zmm4[0] f+ *(rbx_3 + rdx_10)
                        zmm4[0] = zmm4[0] f+ *(rbx_3 + rdx_10 + 8)
                        *(rbx_3 + rdx_10 + 4) = zmm1
                        *(rbx_3 + rdx_10) = zmm4[0]
                        *(rbx_3 + rdx_10 + 8) = zmm4[0]
                        j_4 = j_10
                        j_10 -= 1
                    while (j_4 != 1)
                ...
                if (j_12 s> 0)
                    ...
                    do
                        ...
                        zmm4 = *(r8_9 + rbx_2 - rcx_9)
                        zmm1 = zmm4[0]
                        int64_t rcx_28 = sx.q(*rdi_3) * 3
                        int64_t rax_39 = *arg2
                        zmm4[0] = zmm4[0] f* *(rax_39 + (rcx_28 << 2))
                        zmm2 = *(rax_39 + (rcx_28 << 2) + 4)
                        zmm3 = *(rax_39 + (rcx_28 << 2) + 8)
                        zmm4[0] = zmm4[0] f+ *(rbx_3 + rdx_11)
                        zmm4[0] = zmm4[0] * zmm3[0]
                        zmm1 = zmm1 * zmm2 f+ *(rbx_3 + rdx_11 + 4)
                        *(rbx_3 + rdx_11) = zmm4[0]
                        zmm4[0] = zmm4[0] f+ *(rbx_3 + rdx_11 + 8)
                        *(rbx_3 + rdx_11 + 4) = zmm1
                        *(rbx_3 + rdx_11 + 8) = zmm4[0]
                        ...
                        zmm3 = *(rax_41 + (rcx_29 << 2) + 8)
                        zmm4[0] = zmm4[0] f* *(rax_41 + (rcx_29 << 2))
                        zmm3[0] = zmm3[0] * zmm4[0]
                        zmm1 = zmm1 * zmm2 f+ *(rbx_3 + rdx_12 + 4)
                        zmm4[0] = zmm4[0] f+ *(rbx_3 + rdx_12)
                        zmm3[0] = zmm3[0] f+ *(rbx_3 + rdx_12 + 8)
                        *(rbx_3 + rdx_12 + 4) = zmm1
                        *(rbx_3 + rdx_12) = zmm4[0]
                        *(rbx_3 + rdx_12 + 8) = zmm3[0]
                        j_5 = j_11
                        j_11 -= 1
                    while (j_5 != 1)
                ...
                int64_t rax_43 = *arg2
                zmm1 = zmm4[0]
                zmm4[0] = zmm4[0] f* *(rbx_3 + rax_43)
                zmm2 = *(rbx_3 + rax_43 + 4)
                zmm3 = *(rbx_3 + rax_43 + 8)
                zmm4[0] = zmm4[0] f+ *(rbx_3 + rcx_30)
                zmm3[0] = zmm3[0] * zmm4[0]
                zmm1 = zmm1 * zmm2 f+ *(rbx_3 + rcx_30 + 4)
                *(rbx_3 + rcx_30) = zmm4[0]
                zmm3[0] = zmm3[0] f+ *(rbx_3 + rcx_30 + 8)
                *(rbx_3 + rcx_30 + 4) = zmm1
                *(rbx_3 + rcx_30 + 8) = zmm3[0]
                zmm4 = *rcx_8
                int64_t rax_45 = *arg2
                int64_t rcx_31 = *arg5
                zmm1 = zmm4[0]
                zmm2 = *(rbx_3 + rax_45 + 4)
                zmm3 = *(rbx_3 + rax_45 + 8)
                zmm4[0] = zmm4[0] f* *(rbx_3 + rax_45)
                zmm4[0] = zmm4[0] f+ *(rbx_3 + rcx_31)
                zmm4[0] = zmm4[0] * zmm3[0]
                zmm1 = zmm1 * zmm2 f+ *(rbx_3 + rcx_31 + 4)
                zmm4[0] = zmm4[0] f+ *(rbx_3 + rcx_31 + 8)
                *(rbx_3 + rcx_31) = zmm4[0]
                *(rbx_3 + rcx_31 + 4) = zmm1
                *(rbx_3 + rcx_31 + 8) = zmm4[0]
