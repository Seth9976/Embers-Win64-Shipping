...
if (not(cond:0))
    ...
    do
        ...
        if (rbp_1 == 0)
            ...
            zmm0 = zx.o(0)
            zmm0[0] = float.s(rcx)
            zmm5_1 = ((zmm1.d * 6f f- zmm2.d) f* zmm1.d + zmm3) f* zmm1.d
        ...
        zmm3 = (*(&data_142dfce50 + (zx.q(arg1[zx.q(rsi_1 + rdx_3)]) << 2)) f- zmm0[0])
            * zmm5_1 f+ zmm0[0]
        zmm0 = *(&data_142dfce50 + (zx.q(arg1[zx.q(rdi_1 + rdx_4)]) << 2))
