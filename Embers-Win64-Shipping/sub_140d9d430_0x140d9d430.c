...
label_140d9d5a0:
    ...
    if (sub_140d9be20(arg1, arg1[1].d - *(arg1 + 0x34), 0) == 0)
        void* r9_2 = &arg1[7]
        ...
        *(arg4 + 0x2c) = rax_20
        ...
        arg4[5].d = *(rax_21 + (((sx.q(arg1[9].d) - 1) & r8_2) << 2))
        void* rax_23 = *(r9_2 + 8)
    ...
    label_140d9d4e3:
        ...
        while (true)
            ...
            if (*(rdx_3 + (rcx_2 << 3)) == *arg4 && *(rdx_3 + (rcx_2 << 3) + 8) == arg4[1].d
                    ...
                    && *(arg4 + 0x14) f== *(rdx_3 + (rcx_2 << 3) + 0x14))
                break
            
            rbx_1 = *(rdx_3 + (rcx_2 << 3) + 0x28)
            
            if (rbx_1 == 0xffffffff)
                goto label_140d9d4e3
