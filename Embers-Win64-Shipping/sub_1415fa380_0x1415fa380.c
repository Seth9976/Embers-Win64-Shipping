...
while (true)
    ...
    *(&var_178 + (rcx_4 << 2)) = temp0_31.q
    (&var_170)[rcx_4] = var_218
    *(&var_148 + (rcx_4 << 2)) = (_mm_unpacklo_ps(temp0_28, temp0_30[0].q)).q
    (&var_140)[rcx_4] = var_1e8_1
    int64_t var_118
    *(&var_118 + (rcx_4 << 2)) = (_mm_unpacklo_ps(zmm1, zmm15[0].q)).q
    int32_t var_110
...
if (zmm15[0] <= zmm10[0])
    ...
    if (i_6 s> 0)
        ...
        do
            ...
            uint64_t rcx_20 = var_268
            int64_t rdx_8 = rdi_2 * 3
            int32_t rax_25 = *(&var_170 + rbx)
            *(rcx_20 + (rdx_8 << 2)) = *(&var_178 + rbx)
            *(rcx_20 + (rdx_8 << 2) + 8) = rax_25
    ...
    int32_t rax_28
    float zmm9_1[0x4]
    rax_28, zmm9_1, zmm10 = sub_1415b3fb0(&var_268, &var_278, &var_210, &var_208, &var_27c, 
        &var_298, &var_230, &var_220)
    uint128_t zmm0_2
    uint128_t zmm1_1
    uint128_t zmm2_1
    uint128_t zmm3_1
    ...
    if (rax_28 == 2)
        ...
        *arg5 = (_mm_unpacklo_ps(zmm0_2, zmm1_1.q)).q
        ...
        int32_t var_21c
        zmm2_1.d = var_21c.d f- zmm1_1.d
        zmm0_2.d = var_218.d f- zmm4_1[0]
