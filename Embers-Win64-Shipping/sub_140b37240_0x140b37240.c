...
label_140b373e6:
    ...
    if (r8_4 s> 0 && (rax_18 == 0 || rax_18 s< rbp))
        ...
        *(arg4 + 0x844) = rax_21
        ...
        arg4[0x108].d = *(rax_22 + (((sx.q(arg1[9].d) - 1) & r8_5) << 2))
        void* rax_24 = *(r9_2 + 8)
    ...
    label_140b37309:
        ...
        while (true)
            int64_t* rdi_1 = sx.q(rbx_1) * 0x848
            int16_t* rdx_3
            ...
            rcx_1 = *arg1
            rbx_1 = *(rdi_1 + rcx_1 + 0x840)
            
            if (rbx_1 == 0xffffffff)
                goto label_140b37309
    ...
    if (rbx_1 == 0xffffffff)
        ...
        int64_t* rdi_3 = sx.q(rbx_1) * 0x848 + *arg1
        int64_t rcx_3 = rdi_3[2]
        ...
        memmove(rdi_3, arg4, 0x840)
        int64_t rcx_6 = sx.q(arg5)
        void* r10_1 = &arg1[2]
        
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0x848 + *arg1) = rcx_6.d
        
        int32_t* rax_8 = rcx_6 * 0x848 + *arg1
        *rax_8 = 0xffffffff
