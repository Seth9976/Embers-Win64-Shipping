...
if (data_143e8b518 s> *rdi_1)
    _Init_thread_header(&data_143e8b518)
    
    if (data_143e8b518 == 0xffffffff)
        ...
        data_143e8b510 = rax_12
        _Init_thread_footer(&data_143e8b518)

if (data_143e8b528 s> *rdi_1)
    _Init_thread_header(&data_143e8b528)
    
    if (data_143e8b528 == 0xffffffff)
        ...
        data_143e8b520 = rax_15
        _Init_thread_footer(&data_143e8b528)

if (data_143e8b538 s> *rdi_1)
    _Init_thread_header(&data_143e8b538)
    
    if (data_143e8b538 == 0xffffffff)
        ...
        data_143e8b530 = rax_18
        _Init_thread_footer(&data_143e8b538)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b510
int64_t rcx
