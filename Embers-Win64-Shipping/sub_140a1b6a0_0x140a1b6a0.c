...
if (rsi s> 0)
    ...
    *rbx += 1
    ...
    if (i s< rsi)
        ...
        void* r9_1 = r15 + (sx.q(i) << 3)
        uint64_t i_1
        
        do
            uint32_t rdx_3 = (r9_1 u>> 4).d
            r9_1 += 8
            int32_t r8_1 = (0x9e3779b9 - rdx_3) ^ rdx_3 << 8
            int32_t rcx_3 = neg.d(r8_1 + rdx_3) ^ r8_1 u>> 0xd
            int32_t rdx_6 = (rdx_3 - r8_1 - rcx_3) ^ rcx_3 u>> 0xc
            int32_t r8_4 = (r8_1 - rdx_6 - rcx_3) ^ rdx_6 << 0x10
            int32_t rcx_6 = (rcx_3 - r8_4 - rdx_6) ^ r8_4 u>> 5
            int32_t rdx_9 = (rdx_6 - r8_4 - rcx_6) ^ rcx_6 u>> 3
            int32_t r8_7 = (r8_4 - rdx_9 - rcx_6) ^ rdx_9 << 0xa
            rbx_1 += (rcx_6 - r8_7 - rdx_9) ^ r8_7 u>> 0xf
            i_1 = i_2
            i_2 -= 1
        while (i_1 != 1)
