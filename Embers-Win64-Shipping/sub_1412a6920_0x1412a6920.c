...
if (data_143e8e570 s> *rdi_1)
    _Init_thread_header(&data_143e8e570)
    
    if (data_143e8e570 == 0xffffffff)
        ...
        data_143e8e568 = rax_9
        _Init_thread_footer(&data_143e8e570)

if (data_143e8e580 s> *rdi_1)
    _Init_thread_header(&data_143e8e580)
    
    if (data_143e8e580 == 0xffffffff)
        ...
        data_143e8e578 = rax_12
        _Init_thread_footer(&data_143e8e580)

if (data_143e8e590 s> *rdi_1)
    _Init_thread_header(&data_143e8e590)
    
    if (data_143e8e590 == 0xffffffff)
        ...
        data_143e8e588 = rax_15
        _Init_thread_footer(&data_143e8e590)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8e568
int64_t rcx
...
label_1412a6a23:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412a6a1e
        
        rbx.b = 1
        goto label_1412a6a23
