...
if (arg2 + 0x1d0 != arg1 + 0x518)
    ...
    if (*(arg2 + 0x1d8) != 0 && rcx_19 != 0)
        (*(*rcx_19 + 0x40))(rcx_19, arg1 + 0x518)
    else if (*(arg1 + 0x520) != 0)
        int64_t* rcx_20 = *(arg1 + 0x518)
        
        if (rcx_20 != 0)
            (*(*rcx_20 + 0x38))(rcx_20, 0)
            int64_t rcx_21 = *(arg1 + 0x518)
            
            if (rcx_21 != 0)
                *(arg1 + 0x518) = sub_140a84c80(rcx_21, 0, 0)
...
if (arg2 + 0x200 != arg1 + 0x548)
    ...
    if (*(arg2 + 0x208) != 0 && rcx_25 != 0)
        (*(*rcx_25 + 0x40))(rcx_25, arg1 + 0x548)
    else if (*(arg1 + 0x550) != 0)
        int64_t* rcx_26 = *(arg1 + 0x548)
        
        if (rcx_26 != 0)
            (*(*rcx_26 + 0x38))(rcx_26, 0)
            int64_t rcx_27 = *(arg1 + 0x548)
            
            if (rcx_27 != 0)
                *(arg1 + 0x548) = sub_140a84c80(rcx_27, 0, 0)
...
int64_t rax_24 = rcx_28 + 0x4e8

if (rcx_28 == 0)
    rax_24 = 0

*(arg1 + 0x4c0) = rax_24
int64_t* rcx_29 = *(arg1 + 0x4c8)
