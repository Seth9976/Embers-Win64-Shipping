...
if (data_143e8db70 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8db70)
    
    if (data_143e8db70 == 0xffffffff)
        ...
        data_143e8db68 = rax_4
        _Init_thread_footer(&data_143e8db70)

if (data_143e8db68 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()
