...
if (data_143e8cb88 s> *rdi_1)
    _Init_thread_header(&data_143e8cb88)
    
    if (data_143e8cb88 == 0xffffffff)
        ...
        data_143e8cb80 = rax_12
        _Init_thread_footer(&data_143e8cb88)

if (data_143e8cb98 s> *rdi_1)
    _Init_thread_header(&data_143e8cb98)
    
    if (data_143e8cb98 == 0xffffffff)
        ...
        data_143e8cb90 = rax_15
        _Init_thread_footer(&data_143e8cb98)

if (data_143e8cbb0 s> *rdi_1)
    _Init_thread_header(&data_143e8cbb0)
    
    if (data_143e8cbb0 == 0xffffffff)
        ...
        data_143e8cba0 = rax_18
        _Init_thread_footer(&data_143e8cbb0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8cb80
int64_t rcx
...
label_1412b2e88:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412b2e83
    
    rbx.b = 1
    goto label_1412b2e88
