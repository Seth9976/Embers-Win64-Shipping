...
label_140753092:
    ...
    if (r8_2 u>= 4)
        ...
        rbp = 1 << ((not.d(rcx_6 << 0x1a s>> 0x1f)).b & (0x20 - r9_3))
    ...
    if (r8_2 s> 0 && (rax_17 == 0 || rax_17 s< rbp))
        arg1[9].d = rbp
        sub_140771f10(arg1)
    else
        void* r9_4 = &arg1[7]
        ...
        arg4[1] = *(rax_21 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2))
        void* rax_23 = *(r9_4 + 8)
    ...
    if (rbx_1 == 0xffffffff)
        ...
        memmove(*arg1 + sx.q(rbx_1) * 0xc, arg4, 4)
        int64_t rcx_4 = sx.q(arg5)
        void* r10_1 = &arg1[2]
        
        if (*(arg1 + 0x34) != 0)
            *(*arg1 + sx.q(arg1[6].d) * 0xc) = rcx_4.d
