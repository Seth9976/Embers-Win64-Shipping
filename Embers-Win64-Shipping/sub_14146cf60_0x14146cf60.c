...
void* var_48
sub_1419a2ec0(arg4[0xa2a], &var_48, &data_143ee17d0, 0)
void* rbp = var_58
int64_t rax = 0
...
if (data_143ee5cc8 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143ee5cc8)
    
    if (data_143ee5cc8 == 0xffffffff)
        ...
        int64_t r8_3
        r8_3.b = 1
        data_143ee5cc0 = (*(*rcx_12 + 0xb0))(rcx_12, u"r.Shadow.MaxSoftKernelSize", r8_3)
        _Init_thread_footer(&data_143ee5cc8)

int64_t* rcx_10 = data_143ee5cc0
