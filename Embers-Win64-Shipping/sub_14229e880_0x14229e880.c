...
int32_t var_31c_4 = 0xc2b40000
int32_t rdx = arg9[0x1d].d
...
int32_t var_114 = 0
void var_2a8
sub_141fd6cc0(&var_2a8, rdx, 1, 0, 0, var_340)
...
float temp0_11[0x4] = _mm_shuffle_ps(zmm14, zmm14, 0x55)
...
do
    float* rax_2
    rax_2, zmm7_1, zmm8_1 = sub_14077e760(&var_1e8, r15)
    int32_t var_1a8
    ...
    arg6 = *(rax_2 + 0x20)
    arg7 = *(rax_2 + 0x30)
    float temp0_18[0x4] = __mulps_xmmps_memps(arg5, temp0_6)
    float temp0_19[0x4] = _mm_mul_ps(arg6, zmm8_1)
    ...
    float temp0_23[0x4] = _mm_mul_ps(arg7, zmm7_1)
    float temp0_24[0x4] = _mm_mul_ps(zmm9_1, zmm14)
    float temp0_25[0x4] = _mm_add_ps(temp0_19, temp0_23)
    float temp0_26[0x4] = __mulps_xmmps_memps(arg5, temp0_11)
    zmm6_1 = _mm_add_ps(temp0_22, temp0_25)
    float temp0_28[0x4] = __mulps_xmmps_memps(arg6, temp0_9)
    float temp0_29[0x4] = _mm_add_ps(temp0_24, temp0_26)
    float temp0_31[0x4] = _mm_add_ps(temp0_28, __mulps_xmmps_memps(arg7, temp0_8))
    float temp0_32[0x4] = __mulps_xmmps_memps(arg5, temp0_16)
    zmm7_1 = _mm_add_ps(temp0_29, temp0_31)
    float temp0_34[0x4] = __mulps_xmmps_memps(arg6, temp0_15)
    zmm8_1 = _mm_add_ps(_mm_add_ps(temp0_21, temp0_32), 
        _mm_add_ps(temp0_34, __mulps_xmmps_memps(arg7, temp0_14)))
    int64_t j
    
    do
        float zmm2_1[0x4] = *(rbx_1 - 4)
        int32_t var_338_1 = 0x4399f630
        ...
        float temp0_51[0x4] = _mm_mul_ps(temp0_48, arg7)
        int32_t var_310_1 = 0
        float temp0_52[0x4] = _mm_mul_ps(temp0_49, arg6)
        int64_t var_318_2 = 0
        float temp0_54[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_47, temp0_47, 0), zmm9_1)
        int32_t var_310_2 = 0
        float temp0_55[0x4] = _mm_add_ps(temp0_51, temp0_52)
        float temp0_56[0x4] = _mm_mul_ps(temp0_50, arg5)
        int64_t var_318_3 = 0
        int32_t var_310_3 = 0
        var_308 = zmm6_1[0]
        ...
        float var_324 = temp0_58[0]
        float temp0_59[0x4] = _mm_shuffle_ps(temp0_58, temp0_58, 0x55)
        float var_31c_6 = _mm_shuffle_ps(temp0_58, temp0_58, 0xaa)[0]
        float var_320_1 = temp0_59[0]
        int32_t rax_3
        rax_3, zmm6_1, zmm7_1, zmm8_1, zmm9_1, arg5, arg6, arg7, zmm13, zmm14, zmm15 =
            sub_141fdacb0(&var_2a8, &var_324, rsi_1, &var_2f0, var_348, var_340_1)
        *rdi_1 = rax_3
        rsi_1 = &rsi_1[1]
        rdi_1 = &rdi_1[1]
        rbx_1 += 0xc
    ...
    int32_t var_19c
    sub_141fdaaf0(&var_2a8, var_1a8, var_1a0, var_19c)
    r15 += 0xc
    i = i_1
    i_1 -= 1
while (i != 1)
...
float temp0_97[0x4] = _mm_mul_ps(_mm_shuffle_ps(arg5, arg5, 0x55), zmm7_1)
float temp0_98[0x4] = _mm_add_ps(temp0_95, temp0_93)
float temp0_100[0x4] = _mm_mul_ps(_mm_shuffle_ps(arg5, arg5, 0xaa), zmm8_1)
float var_1c8[0x4] = _mm_add_ps(temp0_98, temp0_91)
var_340_1.b = j_1.b
char var_348_1 = j_1.b
float var_1b8[0x4] = _mm_add_ps(
    _mm_add_ps(_mm_add_ps(_mm_mul_ps(_mm_shuffle_ps(arg5, arg5, 0), zmm6_1), temp0_97), temp0_100), 
    _mm_mul_ps(_mm_shuffle_ps(arg5, arg5, 0xff), zmm9_1))
int512_t zmm10
int512_t zmm11
int512_t zmm12
zmm10, zmm11, zmm12 =
    sub_141fe3230(&var_2a8, &var_1e8, arg3, arg4, var_348_1, var_340_1.b, arg8, arg9)
