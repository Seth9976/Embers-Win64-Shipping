...
if (rax_2 == 0 || *(rax_2 + 0x300) s<= 0 || (*(arg2 + 0x71a) & 2) != 0 || 0f f>= *(arg2 + 0x734)
    ...
    int64_t var_88_2 = arg6
    sub_141f4f8c0(arg1, arg2, rdi_1, &arg4[0x17], arg5, r14)
else
    ...
    if (not(cond:0_1))
        int64_t var_88_1 = arg6
        float zmm6_1
        float zmm7_1
        float zmm8_1
        float zmm9_1
        zmm6_1, zmm7_1, zmm8_1, zmm9_1 = sub_141f4f8c0(&var_68, arg2, rdi_1, &arg4[0x17], arg5, r14)
        float zmm1_1 = *(arg2 + 0x734)
        float zmm0_1[0x4] = var_68.d
        zmm9_1 = zmm9_1 - zmm1_1
        zmm0_1[0] = zmm0_1[0] * zmm9_1
        zmm8_1 = zmm8_1 * zmm1_1 + zmm0_1[0]
        zmm0_1 = var_68:4.d
        zmm0_1[0] = zmm0_1[0] * zmm9_1
        ...
        var_70_1 = zmm7_1 * zmm1_1 + zmm0_1[0]
