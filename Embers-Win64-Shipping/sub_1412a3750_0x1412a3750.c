...
if (data_143e8aa90 s> *rdi_1)
    _Init_thread_header(&data_143e8aa90)
    
    if (data_143e8aa90 == 0xffffffff)
        ...
        data_143e8aa88 = rax_12
        _Init_thread_footer(&data_143e8aa90)

if (data_143e8aaa0 s> *rdi_1)
    _Init_thread_header(&data_143e8aaa0)
    
    if (data_143e8aaa0 == 0xffffffff)
        ...
        data_143e8aa98 = rax_15
        _Init_thread_footer(&data_143e8aaa0)

if (data_143e8aab0 s> *rdi_1)
    _Init_thread_header(&data_143e8aab0)
    
    if (data_143e8aab0 == 0xffffffff)
        ...
        data_143e8aaa8 = rax_18
        _Init_thread_footer(&data_143e8aab0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8aa88
int64_t rcx
...
label_1412a3848:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412a3843
    
    rbx.b = 1
    goto label_1412a3848
