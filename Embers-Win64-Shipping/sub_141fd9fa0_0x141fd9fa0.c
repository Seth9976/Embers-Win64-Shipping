    ...
    if (rbx_1 s>= 4)
        ...
        do
            ...
            zmm2 = (*(rdi_2 + (rax_20 << 2)) f- *(r11_1 + (rax_20 << 2))) f* zmm4_1 f+
                *(r11_1 + (rax_20 << 2)) f+ (*(r10_4 - 4) f- *(r9_3 + r10_4 - 4)) f* zmm8.d f+
                *(r9_3 + r10_4 - 4)
            *(*(arg1 + 8) + r12_1 - 8) = zmm2
            ...
            *(*(arg1 + 8) + r12_1 - 4) = zmm2
            ...
            zmm2 = (*(rdi_2 + (rax_28 << 2)) f- *(r11_1 + (rax_28 << 2))) f* zmm4_1 f+
                *(r11_1 + (rax_28 << 2)) f+ (*(r10_4 + 4) f- *(r9_3 + r10_4 + 4)) f* zmm8.d f+
                *(r9_3 + r10_4 + 4)
            *(r12_1 + *(arg1 + 8)) = zmm2
            int32_t temp20_1
            int32_t temp21_1
