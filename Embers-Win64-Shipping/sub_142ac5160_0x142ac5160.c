...
if (arg1[0xd].b != 0)
    ...
    if (arg_8 s<= 0)
        double zmm0_1 = sub_142ad1130(arg1[0x11])
        
        if (not(zmm0_1 f> arg2.q))
            if (arg3 == 0)
                arg2.q f- zmm0_1
            
            if (arg3 != 0 || is_unordered.q(arg2.q, zmm0_1) || not(arg2.q f== zmm0_1))
                int64_t rdi = *arg1[0x12]
                int32_t rax_1 = sub_141b60020(arg1[0x13])
                int32_t rax_2 = sub_1405f8de0(arg1[0x13])
                double var_38
                char rax_3 =
                    (*(rdi + 0x48))(arg1[0x12], arg2.q, zx.q(rax_2), zx.q(rax_1), arg3, &var_38)
                int64_t rdi_1 = *arg1[0x13]
                int32_t rax_4 = sub_141b60020(arg1[0x12])
                int32_t rax_5 = sub_1405f8de0(arg1[0x12])
                double var_30
                char rax_6 =
                    (*(rdi_1 + 0x48))(arg1[0x13], arg2.q, zx.q(rax_5), zx.q(rax_4), arg3, &var_30)
                zmm0_1 = var_38
                double zmm1 = var_30
                
                if (rax_3 != 0 && (rax_6 == 0 || not(zmm0_1 <= zmm1)))
                    sub_142838410(arg4, zmm0_1)
                    sub_142ad1140(arg4, arg1[0x13])
                    sub_142ad1180(arg4, arg1[0x12])
                    return 1
                
                if (rax_6 == 0 || (rax_3 != 0 && zmm1 <= zmm0_1))
                    return 0
