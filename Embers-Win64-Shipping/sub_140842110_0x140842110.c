...
while (true)
    ...
    if (rsi_1 == 0)
    label_1408422e4:
        sub_140841ce0(r10_1, rax_8, zx.q(arg3), arg4)
    else
        while (true)
            if (rax_8 s<= 8)
                for (; i u> r10_1; i -= 4)
                    ...
                    if (&r10_1[1] u<= i)
                        int64_t r9_2 = *(*arg4 + 0x18)
                        
                        do
                            if (*(r9_2 + (sx.q(*r8_2) << 3)) f< *(r9_2 + (sx.q(*rdx_4) << 3)))
                                rdx_4 = r8_2
                            
                            r8_2 += 4
                        while (r8_2 u<= i)
                    
                    int32_t rcx_16 = *rdx_4
                    *rdx_4 = *i
                    *i = rcx_16
            ...
            *r10_1 = rcx_3
            ...
            while (true)
                ...
                if (r8 u<= i)
                    int64_t rdx_1 = *(*arg4 + 0x18)
                    
                    if (*(rdx_1 + (sx.q(*r8) << 3)) f>= *(rdx_1 + (sx.q(*r10_1) << 3)))
                        continue
                ...
                do
                    ...
                    rdx_2 = *(*arg4 + 0x18)
                while (*(rdx_2 + (sx.q(*r10_1) << 3)) f>= *(rdx_2 + (sx.q(*r9) << 3)))
                rax_15 = *r9
