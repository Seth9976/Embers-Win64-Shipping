...
while (true)
    ...
    if (rax_20.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0x68 && rcx_7 == arg1 + 0x58)
        return result
    
    int128_t zmm0
    zmm0, result = sub_142367e50(*rcx_7 + (rax_20 << 5) + 4, 0)
