...
if (data_143e8e210 s> *rdi_1)
    _Init_thread_header(&data_143e8e210)
    
    if (data_143e8e210 == 0xffffffff)
        ...
        data_143e8e208 = rax_12
        _Init_thread_footer(&data_143e8e210)

if (data_143e8e220 s> *rdi_1)
    _Init_thread_header(&data_143e8e220)
    
    if (data_143e8e220 == 0xffffffff)
        ...
        data_143e8e218 = rax_15
        _Init_thread_footer(&data_143e8e220)

if (data_143e8e230 s> *rdi_1)
    _Init_thread_header(&data_143e8e230)
    
    if (data_143e8e230 == 0xffffffff)
        ...
        data_143e8e228 = rax_18
        _Init_thread_footer(&data_143e8e230)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e208
int64_t rcx
...
label_1412ad2d8:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412ad2d3
    
    rbx.b = 1
    goto label_1412ad2d8
