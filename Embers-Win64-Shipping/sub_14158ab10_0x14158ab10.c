...
rax_2, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13, zmm15 =
    sub_1416b60a0(r15, arg2, arg3, arg4, &var_260)
int32_t rdi_1
        ...
        while (true)
            if (rdx_5 s< 0x80)
                ...
                rax_28, zmm6_1, zmm7, zmm8, zmm9, zmm10, zmm11, zmm14_1, zmm15_1 =
                    sub_141716230(arg4, &var_140, &var_1ac)
                zmm13 = rsi_5[6]
                zmm12 = zx.o(*rax_28)
                ...
                if (not(zmm14_1 f< zmm13.d))
                    ...
                    int64_t rcx_20 = *r15
                    int64_t rdx_13 = r14_3 * 3
                    *(rcx_20 + (rdx_13 << 2)) = var_1e8_1.q
                    *(rcx_20 + (rdx_13 << 2) + 8) = var_1e0_1
                    ...
                    *(rax_43 + (rcx_22 << 2) + 8) = rax_29
                    ...
                    int64_t r13_1 = sx.q(var_258.d)
                    int32_t r8_11 = var_268
                    int32_t rax_44 = r8_11 + r13_1.d
                    var_258.d = rax_44
                    ...
                    if (r8_11 s>= 3)
                        ...
                        if (r8_11 s<= 0)
                            ...
                            while (true)
                                int64_t* rdx_18 = var_270
                                int64_t rcx_26 = var_260
                                int64_t r15_1 = sx.q(rdx_18[rsi_6].d)
                                int64_t r14_5 = sx.q(*(&rdx_18[rsi_6] + 4))
                                int32_t* r9_5 = rdi_3 + rcx_26
                                int64_t r10_9 = r15_1 * 0x38 + rcx_26
                                ...
                                if (rbx_2 s<= r13_1.d)
                                    rax_50 = r8_11 + r13_1.d
                                
                                int32_t rax_52 = *(r10_9 + (r14_5 << 2))
                                int64_t rdx_23 = *arg1
                                int64_t rax_54 = sx.q(*(r10_9 + (sx.q((r14_5 + 1).d s% 3) << 2)))
                                int32_t var_24c_2 = rax_54.d
                                int64_t rcx_29 = rax_54 * 3
                                zmm10 = *(rdx_23 + (rcx_29 << 2))
                                zmm10[0] = zmm10[0] f- *(r8_12 + (rcx_29 << 2))
                                zmm6 = *(rdx_23 + (rcx_29 << 2) + 4)
                                zmm6[0] = zmm6[0] f- *(r8_12 + (rcx_29 << 2) + 4)
                                zmm11 = *(rdx_23 + (rcx_29 << 2) + 8)
                                ...
                                zmm7 = *(rdx_23 + (rdx_13 << 2) + 4)
                                zmm7[0] = zmm7[0] f- *(r8_12 + (rdx_13 << 2) + 4)
                                ...
                                *(r9_5 + 0xc) = var_248_1.q
                                ...
                                r12 = arg2
                                r15 = arg1
                                *(r10_9 + (r14_5 << 2) + 0x1c) = rbx_2
                                *(r10_9 + (r14_5 << 2) + 0x28) = 0
