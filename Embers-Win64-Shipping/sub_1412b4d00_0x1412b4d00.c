...
if (data_143e8cc00 s> *rdi_1)
    _Init_thread_header(&data_143e8cc00)
    
    if (data_143e8cc00 == 0xffffffff)
        ...
        data_143e8cbf8 = rax_12
        _Init_thread_footer(&data_143e8cc00)

if (data_143e8cc10 s> *rdi_1)
    _Init_thread_header(&data_143e8cc10)
    
    if (data_143e8cc10 == 0xffffffff)
        ...
        data_143e8cc08 = rax_15
        _Init_thread_footer(&data_143e8cc10)

if (data_143e8cc28 s> *rdi_1)
    _Init_thread_header(&data_143e8cc28)
    
    if (data_143e8cc28 == 0xffffffff)
        ...
        data_143e8cc18 = rax_18
        _Init_thread_footer(&data_143e8cc28)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8cbf8
int64_t rcx
...
label_1412b4df8:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412b4df3
    
    rbx.b = 1
    goto label_1412b4df8
