...
if (arg1[2] u> 0 || arg1[0x76] u> 0 || arg1[5] u> 0)
    ...
    float zmm6_1 = sub_1405d0e10(arg2, &arg_18, arg1, &var_128, 0)
    ...
    sub_1405d0e10(arg2, &arg_18, &arg1[0x74], &var_128, 0)
...
if (not(cond:2))
    ...
    sub_1405d0e10(arg2, &arg_18, &arg1[0x77], &var_128, 0)
...
do
    ...
    if (rbx_2 == 0)
        ...
        sub_1405d0e10(arg2, &arg_18, &arg1[0x32 + rdi_10], &var_108, 0)
        result = sub_1405d0e10(arg2, &arg_18, &arg1[rdi_10 + 0x53], &var_108, 0)
        rdi_8 = var_118.q
    else
        result = rbx_2[2]
        ...
        if (rdi_8[-0x21] u> 0 || *rdi_8 u> 0)
            ...
            sub_1405d0e10(arg2, &arg_18, &arg1[0x32 + rdi_9], &var_e8, 0)
            ...
            result = sub_1405d0e10(arg2, &arg_18, &arg1[0x53 + rdi_9], &var_d8, 0)
            rdi_8 = var_118.q
