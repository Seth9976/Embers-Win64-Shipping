...
if (arg1 != arg2)
    ...
    *(arg1 + 0x24) = *(arg2 + 0x24)
    ...
    if (arg1 + 0x38 != arg2 + 0x38)
        ...
        sub_141554790(arg1 + 0x38, *(arg2 + 0x38), *(arg2 + 0x40), *(arg1 + 0x44), 0)
    
    if (arg1 + 0x48 != arg2 + 0x48)
        sub_141554b20(arg1 + 0x48, *(arg2 + 0x48), *(arg2 + 0x50), *(arg1 + 0x54), 0)
    
    if (arg1 + 0x58 != arg2 + 0x58)
        sub_141554b20(arg1 + 0x58, *(arg2 + 0x58), *(arg2 + 0x60), *(arg1 + 0x64), 0)
