...
if (data_143e8d690 s> *rdi_1)
    _Init_thread_header(&data_143e8d690)
    
    if (data_143e8d690 == 0xffffffff)
        ...
        data_143e8d688 = rax_9
        _Init_thread_footer(&data_143e8d690)

if (data_143e8d6a0 s> *rdi_1)
    _Init_thread_header(&data_143e8d6a0)
    
    if (data_143e8d6a0 == 0xffffffff)
        ...
        data_143e8d698 = rax_12
        _Init_thread_footer(&data_143e8d6a0)

if (data_143e8d6b8 s> *rdi_1)
    _Init_thread_header(&data_143e8d6b8)
    
    if (data_143e8d6b8 == 0xffffffff)
        ...
        data_143e8d6a8 = rax_15
        _Init_thread_footer(&data_143e8d6b8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d688
int64_t rcx
...
label_1412adfd3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412adfce
        
        rbx.b = 1
        goto label_1412adfd3
