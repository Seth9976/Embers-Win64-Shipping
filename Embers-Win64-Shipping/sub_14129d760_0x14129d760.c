...
if (data_143e8d188 s> *rdi_1)
    _Init_thread_header(&data_143e8d188)
    
    if (data_143e8d188 == 0xffffffff)
        ...
        data_143e8d180 = rax_12
        _Init_thread_footer(&data_143e8d188)

if (data_143e8d1a8 s> *rdi_1)
    _Init_thread_header(&data_143e8d1a8)
    
    if (data_143e8d1a8 == 0xffffffff)
        ...
        data_143e8d1a0 = rax_15
        _Init_thread_footer(&data_143e8d1a8)

if (data_143e8d1c8 s> *rdi_1)
    _Init_thread_header(&data_143e8d1c8)
    
    if (data_143e8d1c8 == 0xffffffff)
        ...
        data_143e8d1c0 = rax_18
        _Init_thread_footer(&data_143e8d1c8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d180
int64_t rcx
...
label_14129d858:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_14129d853
    
    rbx.b = 1
    goto label_14129d858
