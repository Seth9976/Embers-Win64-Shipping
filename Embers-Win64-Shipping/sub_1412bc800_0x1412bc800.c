...
if (data_143e8bee8 s> *rdi_1)
    _Init_thread_header(&data_143e8bee8)
    
    if (data_143e8bee8 == 0xffffffff)
        ...
        data_143e8bee0 = rax_9
        _Init_thread_footer(&data_143e8bee8)

if (data_143e8bef8 s> *rdi_1)
    _Init_thread_header(&data_143e8bef8)
    
    if (data_143e8bef8 == 0xffffffff)
        ...
        data_143e8bef0 = rax_12
        _Init_thread_footer(&data_143e8bef8)

if (data_143e8bf08 s> *rdi_1)
    _Init_thread_header(&data_143e8bf08)
    
    if (data_143e8bf08 == 0xffffffff)
        ...
        data_143e8bf00 = rax_15
        _Init_thread_footer(&data_143e8bf08)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8bee0
int64_t rcx
