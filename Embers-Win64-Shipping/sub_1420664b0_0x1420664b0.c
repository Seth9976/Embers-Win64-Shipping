...
if (rdx.d u< rbx.d)
    ...
    *(arg1 + 0x18) = r8_3
    ...
    if (r8_3 s> *(arg1 + 0x1c))
        return sub_1419d6f80(arg1 + 0x10, rcx_1) __tailcall
    ...
    if (rbp_1 != rbx.d)
        ...
        if (r8_6 != rbx.d)
            ...
            memmove(rcx_4 + rbx * 0x18, rcx_4 + rdx * 0x18, (r8_6 - rbx.d) * 0x18)
            rax_2 = *(arg1 + 0x18)
        
        *(arg1 + 0x18) = rax_2 - rbp_2
        sub_1419d70d0(arg1 + 0x10)
