...
if (data_143e8c7a0 s> *rdi_1)
    _Init_thread_header(&data_143e8c7a0)
    
    if (data_143e8c7a0 == 0xffffffff)
        ...
        data_143e8c798 = rax_12
        _Init_thread_footer(&data_143e8c7a0)

if (data_143e8c7c0 s> *rdi_1)
    _Init_thread_header(&data_143e8c7c0)
    
    if (data_143e8c7c0 == 0xffffffff)
        ...
        data_143e8c7b8 = rax_15
        _Init_thread_footer(&data_143e8c7c0)

if (data_143e8c7e0 s> *rdi_1)
    _Init_thread_header(&data_143e8c7e0)
    
    if (data_143e8c7e0 == 0xffffffff)
        ...
        data_143e8c7d8 = rax_18
        _Init_thread_footer(&data_143e8c7e0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c798
int64_t rcx
...
label_1412b33c8:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412b33c3
    
    rbx.b = 1
    goto label_1412b33c8
