...
if (data_143e8ac90 s> *rdi_1)
    _Init_thread_header(&data_143e8ac90)
    
    if (data_143e8ac90 == 0xffffffff)
        ...
        data_143e8ac88 = rax_12
        _Init_thread_footer(&data_143e8ac90)

if (data_143e8aca0 s> *rdi_1)
    _Init_thread_header(&data_143e8aca0)
    
    if (data_143e8aca0 == 0xffffffff)
        ...
        data_143e8ac98 = rax_15
        _Init_thread_footer(&data_143e8aca0)

if (data_143e8acb0 s> *rdi_1)
    _Init_thread_header(&data_143e8acb0)
    
    if (data_143e8acb0 == 0xffffffff)
        ...
        data_143e8aca8 = rax_18
        _Init_thread_footer(&data_143e8acb0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8ac88
int64_t rcx
...
label_1412a3308:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412a3303
    
    rbx.b = 1
    goto label_1412a3308
