...
float (* r10_3)[0x4] = zx.q(zx.d(rax[2]) * r8_1) + *(arg1 + 0x70)
float zmm3[0x4] = *(sx.q(rcx_2) + *(rdi + (sx.q(r9) << 3)))
*(arg1 + 0x10) = &rax[3]
...
if (result.d s> 0)
    ...
    do
        ...
        result = result_1
        r10_3 = &r10_3[1]
        float temp0_2[0x4] = _mm_sub_ps(data_143f87770, zmm1)
        result_1 += 0x10
        float temp0_3[0x4] = _mm_mul_ps(zmm1, temp0_1)
