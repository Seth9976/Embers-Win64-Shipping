...
if (data_143e8c050 s> *rdi_1)
    _Init_thread_header(&data_143e8c050)
    
    if (data_143e8c050 == 0xffffffff)
        ...
        data_143e8c048 = rax_9
        _Init_thread_footer(&data_143e8c050)

if (data_143e8c060 s> *rdi_1)
    _Init_thread_header(&data_143e8c060)
    
    if (data_143e8c060 == 0xffffffff)
        ...
        data_143e8c058 = rax_12
        _Init_thread_footer(&data_143e8c060)

if (data_143e8c070 s> *rdi_1)
    _Init_thread_header(&data_143e8c070)
    
    if (data_143e8c070 == 0xffffffff)
        ...
        data_143e8c068 = rax_15
        _Init_thread_footer(&data_143e8c070)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c048
int64_t rcx
...
label_1412ba483:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412ba47e
        
        rbx.b = 1
        goto label_1412ba483
