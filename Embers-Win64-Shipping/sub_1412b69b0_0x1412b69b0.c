...
if (data_143e8b6bc s> *rdi_1)
    _Init_thread_header(&data_143e8b6bc)
    
    if (data_143e8b6bc == 0xffffffff)
        ...
        data_143e8b6b0 = rax_9
        _Init_thread_footer(&data_143e8b6bc)

if (data_143e8b6d4 s> *rdi_1)
    _Init_thread_header(&data_143e8b6d4)
    
    if (data_143e8b6d4 == 0xffffffff)
        ...
        data_143e8b6c8 = rax_12
        _Init_thread_footer(&data_143e8b6d4)

if (data_143e8b6ec s> *rdi_1)
    _Init_thread_header(&data_143e8b6ec)
    
    if (data_143e8b6ec == 0xffffffff)
        ...
        data_143e8b6e0 = rax_15
        _Init_thread_footer(&data_143e8b6ec)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b6b0
int64_t rcx
