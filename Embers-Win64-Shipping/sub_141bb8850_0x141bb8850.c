...
if (data_143f32168 s> *rdi_1)
    _Init_thread_header(&data_143f32168)
    
    if (data_143f32168 == 0xffffffff)
        sub_140b58260(&data_143f32160, u"TTableViewMetadata", 1)
        _Init_thread_footer(&data_143f32168)

int64_t result

if (data_143f32160 != *arg2)
