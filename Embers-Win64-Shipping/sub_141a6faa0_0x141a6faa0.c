...
char rax = arg2[0x10].b
int64_t* rdi = arg2
int64_t** result = arg1

if ((rax & 1) == 0)
    char rax_9 = arg1[0x10].b
    
    if ((rax_9 & 1) != 0)
        if ((rax_9 & 2) == 0)
            arg1 = *arg1
        
        result[0x10].b = rax_9 & 0xfe
        (**arg1)(arg1, 0)
        
        if ((result[0x10].b & 2) == 0)
