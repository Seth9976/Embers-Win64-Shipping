...
while (true)
    ...
    *arg1 = 0
    ...
    if (r10_1 != 0 && zx.w(*rdi_1) * 0x100 == neg.w(zx.w(rdi_1[1])))
        rax_8 = sub_142bf9bc0(&rdi_1[2], arg1, rdi_1)
    
    if (r10_1 != 0 && zx.w(*rdi_1) * 0x100 == neg.w(zx.w(rdi_1[1])) && rax_8 != 0)
        rsi.b = 1
        ...
        if (arg1[8] != 0)
            ...
            if (sub_142bf7510(arg1, rdi_1, 4).b == 0
                    || zx.w(*rdi_1) * 0x100 != neg.w(zx.w(rdi_1[1])))
                rax_10.b = 0
            else if (sub_142bf9bc0(&rdi_1[2], arg1, rdi_1).b == 0)
                rax_10.b = 0
            else
                rax_10 = 1
