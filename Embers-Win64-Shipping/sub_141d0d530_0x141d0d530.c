...
if (i_2 != 0)
    ...
    if (0 s< r9_1)
        ...
        while (true)
            ...
            if ((rax_14.b & 1) != 0)
                rax_14 = (rax_14 s>> 1) + rbx
            
            void* rbx_3 = (sx.q(rsi_1) << 5) + rax_14
            void* rcx_6
            ...
            if (*(rbx_3 + 8) == 0)
                ...
                if ((rcx_6.b & 1) != 0)
                    rcx_6 = (rcx_6 s>> 1) + rbx_3
            
            int32_t rax_16 = sub_1405de2b0(rcx_6) & (*r15 - 1)
            *(rbx_3 + 0x1c) = rax_16
            void* rcx_10 = arg1[5]
            
            if ((rcx_10.b & 1) != 0)
                rcx_10 = (rcx_10 s>> 1) + &arg1[5]
            
            int64_t rdx_7 = sx.q(rax_16)
            *(rbx_3 + 0x18) = *(rcx_10 + (((sx.q(*r15) - 1) & rdx_7) << 2))
            void* rcx_12 = arg1[5]
            
            if ((rcx_12.b & 1) != 0)
                rcx_12 = (rcx_12 s>> 1) + &arg1[5]
            
            *(rcx_12 + (((sx.q(*r15) - 1) & rdx_7) << 2)) = rsi_1
