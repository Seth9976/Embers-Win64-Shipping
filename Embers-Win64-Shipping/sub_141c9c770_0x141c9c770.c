...
if (r10 != 0)
    ...
    label_141c9c80a:
        ...
        while (true)
            ...
            if (rcx != 0)
                goto label_141c9c80a
        
        var_44.d = r10

int64_t* rcx_3 = arg1
int64_t* var_38 = rcx_3
...
if (0 s< r10)
    ...
    while (true)
        void* rbx_2 = sx.q(rdx_2) * 0xf0 + *rcx_3
        sub_140cad990(rbx_2 + 0x20)
        sub_141c94120(rbx_2 + 0x10)
        var_20.d &= not.d(var_30:4.d)
        sub_14059bdd0(&var_30)
        rdx_2 = var_20:4.d
        
        if (rdx_2 s>= *(var_30:8.q + 0x18))
            break
