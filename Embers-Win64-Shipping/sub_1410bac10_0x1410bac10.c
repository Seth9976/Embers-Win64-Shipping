...
if (data_143e2d390 s> *rdi_1)
    _Init_thread_header(&data_143e2d390)
    
    if (data_143e2d390 == 0xffffffff)
        ...
        data_143e2d388 = rax_8
        _Init_thread_footer(&data_143e2d390)

if (data_143e2d3a0 s> *rdi_1)
    _Init_thread_header(&data_143e2d3a0)
    
    if (data_143e2d3a0 == 0xffffffff)
        ...
        data_143e2d398 = rax_11
        _Init_thread_footer(&data_143e2d3a0)

int64_t rdi_2 = data_143e2d398
int64_t rcx
