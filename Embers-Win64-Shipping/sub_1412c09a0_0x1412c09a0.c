...
if (data_143e8bb98 s> *rdi_1)
    _Init_thread_header(&data_143e8bb98)
    
    if (data_143e8bb98 == 0xffffffff)
        ...
        data_143e8bb90 = rax_12
        _Init_thread_footer(&data_143e8bb98)

if (data_143e8bbb8 s> *rdi_1)
    _Init_thread_header(&data_143e8bbb8)
    
    if (data_143e8bbb8 == 0xffffffff)
        ...
        data_143e8bbb0 = rax_15
        _Init_thread_footer(&data_143e8bbb8)

if (data_143e8bbd8 s> *rdi_1)
    _Init_thread_header(&data_143e8bbd8)
    
    if (data_143e8bbd8 == 0xffffffff)
        ...
        data_143e8bbd0 = rax_18
        _Init_thread_footer(&data_143e8bbd8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8bb90
int64_t rcx
...
label_1412c0a98:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412c0a93
    
    rbx.b = 1
    goto label_1412c0a98
