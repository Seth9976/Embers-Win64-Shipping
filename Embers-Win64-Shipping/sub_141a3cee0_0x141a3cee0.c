...
while (true)
    ...
    if (result.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0xb0 && rdx_9 == arg1 + 0xa0)
        return result
    
    void* rbx_3 = result * 0xc0 + *rdx_9
    sub_141a630b0(rbx_3 + 0x18)
    sub_141a63190(rbx_3 + 0x68)
    (*(*arg2 + 0x70))(arg2)
    int32_t var_5c
