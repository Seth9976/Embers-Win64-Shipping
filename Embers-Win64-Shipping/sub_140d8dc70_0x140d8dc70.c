...
zmm5[0] = zmm5[0] - 0.5f
int32_t rcx_1 = int.d(zmm5[0]) s>> 1
...
if (rdx_1 s< 1 || r10 s< 1)
    *arg2 = 0
    ...
    if (rdx_2 != 0)
        ...
        var_160_1 = 1
        zmm3[0] = zmm3[0] f* r11[1]
        zmm3[0] = zmm3[0] f* r11[3]
...
label_140d8deea:
    ...
    while (true)
        ...
        *r10_3 = var_1a0_1
                    ...
                    if (rdi_4 != 0)
                        ...
                        if (rax_26 != 0)
                            ...
                            if (rdi_4 != 0)
                                ...
                                float temp0_6[0x4] = _mm_min_ss(temp0_3[0], zmm6[0])
                                temp0_3[0] = temp0_3[0] + zmm6[0]
                                float temp0_8[0x4] =
                                    _mm_min_ss(_mm_min_ss(temp0_6[0], temp0_3[0])[0], zmm8.d)
                                temp0_8[0] = temp0_8[0] + 0.100000001f
                                
                                if (temp0_8[0] <= zmm13[0])
                                label_140d8e2eb:
                                    rcx_8 = var_1d0_1
                                label_140d8e2f0:
                                    rdi_4[1].d -= 1
                                    ...
                                    if (_mm_max_ss(
                                            _mm_max_ss(_mm_max_ss(temp0_3[0], zmm6[0])[0], 
                                                temp0_3[0])[0], 
                                            temp0_5[0])[0] f< *arg4)
                                        goto label_140d8e2eb
                                    
                                    if (_mm_min_ss(
                                            _mm_min_ss(_mm_min_ss(temp0_3[0], zmm6[0])[0], 
                                                temp0_3[0])[0], 
                                            temp0_5[0])[0] f> arg4[2])
                                        goto label_140d8e2eb
                                    
                                    if (_mm_max_ss(
                                            _mm_max_ss(_mm_max_ss(temp0_3[0], zmm6[0])[0], 
                                                temp0_3[0])[0], 
                                            zmm8.d)[0] f< arg4[1] || temp0_8[0] f> arg4[3])
                                        goto label_140d8e2eb
                                    ...
                                    label_140d8e171:
                                        ...
                                        if (zmm11[0] > temp0_8[0])
                                            goto label_140d8e171
                                    
                                    rdi_4[1].d -= 1
                                    
                                    if (rdi_4[1].d == 1)
                                        goto label_140d8e2fc
        ...
        if (rax_50 == 2)
            if (var_1d8_1 != 0)
                goto label_140d8e536
            
            zmm1 = r11[1]
            zmm0 = var_164
            float var_18c
            int32_t* rax_51 = &var_18c
