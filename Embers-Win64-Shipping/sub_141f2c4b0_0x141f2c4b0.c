    ...
    do
        ...
        if (r13_1 s< arg2)
            do
                ...
                if (rcx s< arg2)
                    if (sub_141f2f970(arg4, &arg1[sx.q(rcx)], &arg1[sx.q(rbx_1.d)]) != 0)
                        rbx_1 = zx.q(rsi_1)
                    
                    rbx_1 = zx.q(rbx_1.d + 1)
                
                int32_t* rsi_2 = &arg1[sx.q(rbx_1.d)]
                int64_t* rbp_1 = &arg1[sx.q(r14_1)]
                result = sub_141f2f970(arg4, rbp_1, rsi_2)
    ...
    do
        ...
        if (i s> 1)
            ...
            do
                ...
                if (rcx_3 s< i)
                    if (sub_141f2f970(arg4, &arg1[sx.q(rcx_3)], &arg1[sx.q(rbx_2.d)]) != 0)
                        rbx_2 = zx.q(rsi_3)
                    
                    rbx_2 = zx.q(rbx_2.d + 1)
                
                int32_t* rsi_4 = &arg1[sx.q(rbx_2.d)]
                int32_t* rbp_2 = &arg1[sx.q(r15_1)]
                result = sub_141f2f970(arg4, rbp_2, rsi_4)
