...
int32_t var_84 = 1
int32_t rbx = *(arg1 + 0x690)
int32_t rcx = 0
void* var_80 = arg1 + 0x678
int32_t var_88 = 0
int32_t r8 = 0
...
if (rbx != 0)
    ...
    label_14084afe8:
        ...
        while (true)
            ...
            if (rdx_3 != 0)
                goto label_14084afe8
        
        var_74.d = rbx

int32_t rdx_5 = *(arg1 + 0x690)
...
var_74.d = rdx_5
int128_t var_68 = (arg1 + 0x668).o
int128_t var_58 = var_38

if (rdx_5 != rbx)
    void* rax_11 = *(arg1 + 0x688)
...
while (true)
    ...
    if (rcx_7.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x678 && rax_20 == arg1 + 0x668)
        return sub_14084ef80(arg1 + 0x668, 0) __tailcall
    
    int64_t* rbx_1 = *((rcx_7 << 5) + *rax_20 + 0x10)
