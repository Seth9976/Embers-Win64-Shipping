...
if (rbx.d != 1)
    ...
    void* rdx_2 = (rdi_1 + 0x1b + sx.q((rbx << 2).d)) & 0xfffffffffffffffc
    float zmm0[0x4]
    ...
    if (rbx.d s< 2 || zmm0[0] <= 0f)
        ...
        r10_1 = 0
    label_141dfaafe:
        void* rsi_2 = rdi_1 + 0xc
        
        if (i_8.d == r10_1.d)
            result = sub_141df2200(&var_88, rdi_1, rsi_2, rdi_1 + 0x18 + sx.q((i_8 << 2).d))
            *arg2 = *result
        else
            float zmm8[0x4] =
                *sub_141df2200(&var_88, rdi_1, rsi_2, rdi_1 + 0x18 + sx.q((i_8 << 2).d))
            result = sub_141df2200(&var_88, rdi_1, rsi_2, rdi_1 + 0x18 + sx.q((r10_1 << 2).d))
            float temp0_10[0x4] = _mm_shuffle_ps(zmm8, zmm8, 0x55)
            uint32_t zmm0_2[0x4] = temp0_10
            float temp0_11[0x4] = _mm_shuffle_ps(zmm8, zmm8, 0xaa)
            float zmm7[0x4] = *result
            zmm8[0] = zmm8[0] * zmm7[0]
            float temp0_12[0x4] = _mm_shuffle_ps(zmm7, zmm7, 0x55)
            ...
            zmm8[0] = zmm8[0] f+ zmm0_2[0]
            float temp0_15[0x4] = _mm_shuffle_ps(zmm7, zmm7, 0xff)
            zmm0_2 = temp0_11
            zmm0_2[0] = zmm0_2[0] f* temp0_13[0]
            zmm8[0] = zmm8[0] f+ zmm0_2[0]
            zmm0_2 = temp0_14
            zmm0_2[0] = zmm0_2[0] f* temp0_15[0]
            zmm8[0] = zmm8[0] f+ zmm0_2[0]
            ...
            temp0_15[0] = temp0_15[0] f* zmm6.d
            zmm12.d = zmm12.d f* zmm0_2[0]
            temp0_10[0] = temp0_10[0] f* zmm12.d
            temp0_13[0] = temp0_13[0] f* zmm6.d
            ...
            zmm0_2 = _mm_cmpeq_ps(_mm_shuffle_ps(0x322bcc77, 0x322bcc77, 0), temp0_24, 2)
            *arg2 = _mm_and_ps(
        ...
        if (zmm0[0] < 1f)
            int32_t rcx_4 = r9 - 2
            zmm6 = _mm_cvtepi32_ps(zx.o(r9 - 1))
            ...
            if (r9 s<= 0xff)
                if (zx.d(*(rax_6 + rdx_2)) s> rcx_4)
                    ...
                    for (; i_1 s<= rbx - 1; i_1 += 1)
                        if (zx.d(*(i_1 + rdx_2)) s> rcx_4)
                            i_8 = zx.q(i_6 - 1)
                            break
                        
                        i_6 += 1
                
                r8_1 = zx.d(*(sx.q(i_8.d) + rdx_2))
                int32_t rax_17 = (i_8 + 1).d
                
                if (rax_17 s<= r10_1.d)
                    r10_1 = zx.q(rax_17)
                
                rcx_5 = zx.d(*(sx.q(r10_1.d) + rdx_2))
            else
                i_8 = sx.q(r10_1.d)
                
                if (zx.d(*(rdx_2 + (rax_6 << 1))) s> rcx_4)
                    i_8 = 0
                    int32_t i_5 = r11_1 - 1
                    ...
                    for (int64_t i_3 = sx.q(i_4); i_3 s<= i_8; i_3 += 1)
                        if (zx.d(*(rdx_2 + (i_3 << 1))) s> rcx_4)
                            i_8 = zx.q(i_4 - 1)
                            break
                        
                        i_4 += 1
                
                r8_1 = zx.d(*(rdx_2 + (sx.q(i_8.d) << 1)))
                int32_t rax_11 = (i_8 + 1).d
                
                if (rax_11 s<= r10_1.d)
                    r10_1 = zx.q(rax_11)
                
                rcx_5 = zx.d(*(rdx_2 + (sx.q(r10_1.d) << 1)))
            
            uint32_t rcx_6 = rcx_5 - r8_1
            
            if (rsi_1 != 1)
                uint32_t rax_19 = 1
                float temp0_8[0x4] = _mm_cvtepi32_ps(zx.o(r8_1))
            ...
            goto label_141dfaafe
        
        result = sub_141df2200(&var_88, rdi_1, rdi_1 + 0xc, rdi_1 + 0x18 + sx.q(r10_1.d << 2))
        *arg2 = *result
else
