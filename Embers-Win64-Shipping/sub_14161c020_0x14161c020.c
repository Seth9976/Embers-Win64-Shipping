...
while (true)
    ...
    var_268 = (zmm13 ^ zmm6)[0]
    var_264 = (zmm14 ^ zmm6)[0]
    var_260 = (zmm12 ^ zmm6)[0]
    float zmm11_1[0x4] = sub_141758e70(arg1, &var_298, &var_268, zmm11)
    void* rcx = var_220
    int64_t zmm9_1 = zmm12[0].q
    float zmm8_1 = (*var_210)[1]
    float zmm5_1 = (*var_210)[2]
    float zmm7_1 = *var_210
    float zmm3_1[0x4] = (*var_210)[3]
    zmm14[0] = zmm14[0] * zmm5_1
    float zmm1_1 = zmm3_1[0]
    zmm13[0] = zmm13[0] * zmm5_1
    zmm9_1.d = zmm9_1.d f* zmm8_1
    zmm14[0] = zmm14[0] * zmm7_1
    zmm9_1.d = zmm9_1.d f- zmm14[0]
    zmm12[0] = zmm12[0] * zmm7_1
    zmm13[0] = zmm13[0] - zmm12[0]
    zmm13[0] = zmm13[0] * zmm8_1
    zmm9_1.d = zmm9_1.d f+ zmm9_1.d
    zmm14[0] = zmm14[0] - zmm13[0]
    zmm1_1 = zmm1_1 f* zmm9_1.d
    zmm13[0] = zmm13[0] + zmm13[0]
    int64_t zmm2_1 = zmm9_1
    zmm9_1.d = zmm9_1.d f* zmm8_1
    ...
    zmm14[0] = zmm14[0] - zmm13[0]
    zmm14[0] = zmm14[0] * zmm7_1
    zmm14[0] = zmm14[0] + zmm1_1
    zmm1_1 = zmm3_1[0] * zmm13[0]
    zmm2_1.d = zmm2_1.d f- zmm14[0]
    zmm3_1[0] = zmm3_1[0] * zmm14[0]
    zmm13[0] = zmm13[0] * zmm7_1
    zmm1_1 = zmm1_1 + zmm14[0]
    zmm3_1[0] = zmm3_1[0] + zmm12[0]
    zmm13[0] = zmm13[0] f- zmm9_1.d
    zmm2_1.d = zmm2_1.d f+ zmm1_1
    zmm13[0] = zmm13[0] + zmm3_1[0]
    int64_t var_200 = (_mm_unpacklo_ps(zmm14, zmm2_1)).q
    float var_1f8_1 = zmm13[0]
    zmm11 = sub_141758e70(rcx, &var_258, &var_200, zmm11_1)
    zmm4 = *arg3
    float temp0_9[0x4] = _mm_unpacklo_ps(var_258, var_250[0].q)
    float temp0_10[0x4] = _mm_unpacklo_ps(var_254, zmm11[0].q)
    float temp0_11[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xc9)
    float temp0_12[0x4] = _mm_unpacklo_ps(temp0_9, temp0_10[0].q)
    ...
    float temp0_17[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_12, temp0_12, 0xd2), temp0_11)
    ...
    int32_t var_294
    zmm2 = var_294
    float temp0_26[0x4] = _mm_mul_ps(temp0_24, temp0_11)
    zmm3 = var_298
    zmm0 = var_290
    float temp0_29[0x4] =
    ...
    *(&var_118 + (rcx_2 << 2)) = (_mm_unpacklo_ps(zmm3, zmm2[0].q)).q
    ...
    if (i_6 == 1)
        ...
        uint64_t* rax_15
        rax_15, zmm11, zmm14, zmm15 = sub_1416fa750(&var_278, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_15)
        rax_13 = rax_15[1].d
    else if (i_6 == 4)
        ...
        uint64_t* rax_14
        rax_14, zmm11, zmm14, zmm15 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_14)
        rax_13 = rax_14[1].d
    else
...
if (zmm15[0] <= zmm9[0])
    ...
    float zmm9_2
    float zmm11_2[0x4]
    rax_28, zmm9_2, zmm11_2 = sub_14156cad0(&var_278, &var_288, &var_228, &var_220, zmm14, zmm15, 
    ...
    temp0_38[0] = temp0_38[0] + temp0_38[0]
    temp0_38[0] = temp0_38[0] * zmm11[0]
    temp0_38[0] = temp0_38[0] * zmm11[0]
    temp0_38[0] = temp0_38[0] * zmm11[0]
    *arg7 = (_mm_unpacklo_ps(temp0_38, temp0_38[0].q)).q
    zmm2[0] = zmm2[0] + zmm3[0]
    float var_2ac_2 = temp0_38[0]
    float temp0_40[0x4] = _mm_sqrt_ss(0, zmm15[0])
    arg7[2] = var_2ac_2
    ...
    *arg5 = (_mm_unpacklo_ps(zmm2, zmm2[0].q)).q
    ...
    zmm11[0] = zmm11[0] - zmm3[0]
    zmm11[0] = zmm11[0] - zmm3[0]
    float temp0_42[0x4] = _mm_unpacklo_ps(zmm11, zmm11[0].q)
    result = zmm11[0]
    *arg6 = temp0_42.q
    arg6[1].d = result
    result.b = 1
