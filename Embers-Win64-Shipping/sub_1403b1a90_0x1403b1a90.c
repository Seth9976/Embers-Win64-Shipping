...
do
    ...
    zmm4 = zx.o(arg1[arg2])
    zmm7 = zmm4
    uint128_t zmm5 = zx.o(rdi_1[arg2])
    ...
    zmm7 = __pmaddubsw_xmmdq_memdq(_mm_unpacklo_epi8(zmm7, zx.o(arg1[arg2 * 2])[0].q), var_d8)
...
if (i == 2)
    zmm6 = zx.o(*(arg1 + rsi_1))
    int32_t temp0_37[0x4] = _mm_unpacklo_epi8(zx.o(*arg1), zx.o(*(arg1 + arg2))[0].q)
    zmm7 = zx.o(*(rdi_1 + rsi_1))
    result = __pmaddubsw_xmmdq_memdq(temp0_37, temp0_5)
    zmm2 = zx.o(*(arg1 + (arg2 << 1)))
    zmm6 = _mm_unpacklo_epi8(zmm6, zmm7[0].q)
    zmm3 = zx.o(*(rdi_1 + (arg2 << 1)))
    char temp0_40[0x10] = __pmaddubsw_xmmdq_memdq(zmm6, var_d8)
    zmm4 = zx.o(arg1[arg2])
    zmm2 = _mm_unpacklo_epi8(zmm2, zmm3[0].q)
    zmm4 = _mm_unpacklo_epi8(zmm4, zx.q(rdi_1[arg2]))
    zmm2 = __pmaddubsw_xmmdq_memdq(zmm2, var_f8)
    zmm4 = __pmaddubsw_xmmdq_memdq(zmm4, var_e8)
    zmm2 = _mm_adds_epi16(zmm2, temp0_40)
    result =
