...
if (rax_5 != 0)
    ...
    if ((*(arg1 + 0x2b) & 8) != 0 && rax_5 s> 0x80000)
        *(arg1 + 0x29) = rcx_3 | 1
        return arg1
    
    if ((arg1[5].b & 1) != 0)
        int512_t zmm1 = sub_142432900(arg2, rax_5)
        int32_t r14 = 0
    ...
    if (rax_5 s> 0)
        do
            sub_142429de0(arg1, (sx.q(i) << 5) + *arg2, arg3)
            i += 1
        while (i s< arg2[1].d)
else if ((arg1[5].b & 1) != 0)
    sub_142432900(arg2, 0)
