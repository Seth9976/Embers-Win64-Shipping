...
if (i_3.d s> 0)
    ...
    do
        ...
        if (rbx.d s> 0)
            ...
            do
                zmm14 = *rbp_1
                int128_t zmm2 = *(rbp_1 + 4)
                int128_t zmm5 = *(r12_1 + 4)
                int64_t rax_9 = *rsi_1
                zmm15 = zmm14
                zmm14.d = zmm14.d f* *r8_7
                float zmm0 = zmm2.d f* *r8_7
                zmm15.d = zmm15.d f* r8_7[-1]
                zmm2.d = zmm2.d f* r8_7[-1]
                int128_t zmm3 = *r14_1
                zmm13 = *(r14_1 + 4)
                zmm7 = *(r15_1 + 4)
                zmm12 = zmm3
                ...
                *(rsi_1 + 4) = zmm1
                ...
                zmm2.d = (zmm2 ^ data_142d3f780).d f- zmm12.d f* result_2:4.d
                ...
                *(r12_1 - 4) = zmm2.d
                *(r14_1 - 8) = zmm13.d f+ zmm10.d
                *(r14_1 - 4) = zmm15.d f+ zmm11.d
