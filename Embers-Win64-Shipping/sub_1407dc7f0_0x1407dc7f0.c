...
if (rcx_3 == 0x7fff)
    ...
    rdx_3 = zx.q(*(arg2 + 0x80) * rcx_3) + *(arg2 + 0x70)
int32_t* var_28 = rdx_3
int32_t rcx_5 = zx.d(rax[2]) & 0x7fff
*(arg2 + 0x10) = &rax[3]
int32_t var_68 = rcx_5
int32_t rax_3
rax_3.b = rcx_5 != 0x7fff
void* var_58
void var_60
...
uint32_t rcx_12 = zx.d(rax[4])
*(arg2 + 0x10) = &rax[5]
int32_t r10_5 = rcx_12 & 0x7fff
int64_t result
result.b = r10_5 != 0x7fff
...
if (r10_5 == 0x7fff)
    ...
    var_10 = zx.q(*(arg2 + 0x80) * r10_5) + *(arg2 + 0x70)
...
if (*(arg2 + 0x40) s> 0)
    while (true)
        ...
        *rdx_3 = 0xffffffff
        ...
        var_58 = &rdx_4[sx.q(rax_3)]
        *rdx_4 = 0
        int32_t* rdx_5 = var_40
        var_40 = &rdx_5[sx.q(rax_4)]
        *rdx_5 = 0
        ...
        *rdx_6 = 0
        ...
        if (r10_6 s>= *(arg2 + 0x40))
            break
        
        rdx_3 = &rdx_3[sx.q(r9_1)]
        r9_1 = var_34
