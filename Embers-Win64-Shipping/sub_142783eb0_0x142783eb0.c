...
int64_t var_350_1 = arg1 - 0x58 + sx.q(arg2) * 0x58
int128_t zmm7
        ...
        while (true)
            ...
            if (rdx_3 s<= 8)
                for (; i u> r11_1; i -= 0x58)
                    ...
                    if (r11_1 + 0x58 u<= i)
                        do
                            if (__maxss_xmmss_memss((*(rax_28 + 0x34)).d, rax_28[3].d).d
                                    f> __maxss_xmmss_memss((*(rcx_14 + 0x34)).d, rcx_14[3].d).d)
                                rax_28 = rcx_14
            ...
            uint128_t* r10_1 = i + 0x58
            uint128_t* r9_1 = r11_1
            
            while (true)
                r9_1 += 0x58
                
                if (r9_1 u<= i && __maxss_xmmss_memss((*(r11_1 + 0x34)).d, r11_1[3].d).d
                        f<= __maxss_xmmss_memss((*(r9_1 + 0x34)).d, r9_1[3].d).d)
                    continue
                ...
                do
                    ...
                    zmm0_2 = *(r11_1 + 0x34)
                    zmm1 = __maxss_xmmss_memss((*(r10_1 + 0x34)).d, r10_1[3].d)
                    zmm0_2 = __maxss_xmmss_memss(zmm0_2.d, r11_1[3].d)
            ...
            if ((r10_1 - r11_1 - 0x58) s/ 0x58 s< (i - r9_1) s/ 0x58)
                if (i u> r9_1)
                    *r14_1 = r9_1
                    r14_1[1] = i
                    r14_1[2].d = rbp_1
