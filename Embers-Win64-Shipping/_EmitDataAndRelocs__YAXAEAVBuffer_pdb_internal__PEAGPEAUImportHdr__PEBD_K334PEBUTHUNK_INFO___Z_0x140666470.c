// 函数: ?EmitDataAndRelocs@@YAXAEAVBuffer@pdb_internal@@PEAGPEAUImportHdr@@PEBD_K334PEBUTHUNK_INFO@@@Z
// 地址: 0x140666470
...
if (r9 != 0)
    ...
    label_140666576:
        ...
        var_54.d = rcx_3 - rax_10 + 0x1f
        
        if (rcx_3 - rax_10 + 0x1f s> r9)
            var_54.d = r9
    else
        while (true)
            rbx_2 += 1
            ...
            if (rbx_2 s> ((temp2_1 & 0x1f) + temp3_1) s>> 5)
                break
            
            var_58 = 0xffffffff
            rdx_3 = *(r8 + (sx.q(rbx_2) << 2))
            
            if (rdx_3 != 0)
                goto label_140666576
...
if (0 s< r9)
    ...
    do
        ...
        if (r8_2 != neg.q(*arg2))
            ...
            *r8_3 = *(rcx_6 + (rdx_6 << 3) + 0x10)
            void* rax_16 = *(rcx_6 + (rdx_6 << 3) + 0x18)
            r8_3[1] = rax_16
