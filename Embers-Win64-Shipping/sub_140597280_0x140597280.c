...
if (r10 != 0)
    ...
    label_14059732a:
        ...
        while (true)
            ...
            if (rcx != 0)
                goto label_14059732a
        
        var_54.d = r10

int64_t* rdx_3 = arg1
int64_t* var_48 = rdx_3
...
if (0 s< r10)
    ...
    while (true)
        void* rbx_2 = sx.q(rcx_3) * 0x88 + *rdx_3
        *(rbx_2 + 0x78) = 0
        int64_t rcx_4 = *(rbx_2 + 0x70)
        
        if (rcx_4 != 0)
            sub_140a74f90(rcx_4)
        
        sub_140597460(rbx_2 + 0x30)
        sub_140596e10(rbx_2 + 0x10)
