...
if (data_143e8be28 s> *rdi_1)
    _Init_thread_header(&data_143e8be28)
    
    if (data_143e8be28 == 0xffffffff)
        ...
        data_143e8be20 = rax_12
        _Init_thread_footer(&data_143e8be28)

if (data_143e8be38 s> *rdi_1)
    _Init_thread_header(&data_143e8be38)
    
    if (data_143e8be38 == 0xffffffff)
        ...
        data_143e8be30 = rax_15
        _Init_thread_footer(&data_143e8be38)

if (data_143e8be50 s> *rdi_1)
    _Init_thread_header(&data_143e8be50)
    
    if (data_143e8be50 == 0xffffffff)
        ...
        data_143e8be40 = rax_18
        _Init_thread_footer(&data_143e8be50)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8be20
int64_t rcx
...
label_1412b8f78:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412b8f73
    
    rbx.b = 1
    goto label_1412b8f78
