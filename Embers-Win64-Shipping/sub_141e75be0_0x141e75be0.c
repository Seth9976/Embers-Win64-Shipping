...
if (arg2.d f!= 0f)
    ...
    while (true)
        int64_t rdi_4 = sx.q(var_a8_1:0xc.d)
        int64_t* rax_40 = var_b8.q
        
        if (rdi_4.d == (var_c8_5.q u>> 0x20).d && var_a8_1.q == arg1 + 0x20
                && rax_40 == arg1 + 0x10)
            break
        ...
        if (not(arg2.d f< zmm6.d))
            char rax_41
            rax_41, zmm6, zmm7, zmm8 = sub_141e760a0(*(rsi_2 + rdi_4 * 0x18 + 8), arg2)
    ...
    if (rdx_4 != rdi)
        ...
        label_141e75d82:
            ...
            while (true)
                ...
                if (rdx_8 != 0)
                    goto label_141e75d82
            
            var_c4.d = rdi
    
    while (true)
        int64_t rax_19 = sx.q(var_a8:0xc.d)
        int64_t* rcx_8 = var_b8.q
        
        if (rax_19.d == (var_c8_2.q u>> 0x20).d && var_a8.q == arg1 + 0x20 && rcx_8 == arg1 + 0x10)
            break
        
        zmm7 = sub_141e760a0(*(*rcx_8 + rax_19 * 0x18 + 8), zmm7)
