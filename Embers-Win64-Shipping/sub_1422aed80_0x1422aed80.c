...
if (r11 != 0)
    ...
    label_1422aee28:
        ...
        while (true)
            ...
            if (rdx_3 != 0)
                goto label_1422aee28
        
        var_64.d = r11

void* var_10 = arg1 + 0x38
int128_t zmm0 = var_78.o
int128_t var_20 = 0xffffffff
int16_t var_40 = 0
void* result = zmm0.q
var_68.o = zmm0
var_78.o = (arg1 + 0x38).o
...
if (0 s< *(result + 0x18))
    ...
    do
        if (*(sx.q(i) * 0x60 + *var_78.q + 0x40) u< data_143de5458)
            sub_1422a92e0(zmm0:8.q, i)
            var_40.b = 1
    ...
    if (var_40.b != 0 && var_40:1.b != 0)
        result = sub_142212c40(arg1 + 0x38, *(arg1 + 0x40) - *(arg1 + 0x6c), 1)
