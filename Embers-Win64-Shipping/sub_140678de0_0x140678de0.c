...
while (true)
    int64_t* r9_4 = sx.q(r10_2) * 0x38 + *rbx
    uint32_t rcx_5 = (*r9_4 u>> 4).d
    ...
    *(r9_4 + 0x34) = r8_16
    ...
    r9_4[6].d = *(rax_28 + (((sx.q(*rsi) - 1) & r8_17) << 2))
    ...
    *(rax_30 + (((sx.q(*rsi) - 1) & r8_17) << 2)) = r10_2
