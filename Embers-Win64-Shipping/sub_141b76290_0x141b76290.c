...
if (rax_2 == 0 || rdi_1 == 0)
    if (sub_140cc16a0(&var_58, sub_140bdfab0()) != 0)
        int64_t rbx_8 = var_58
        
        if (rbx_8 != 0)
            sub_1413f7120(arg2, rbx_8)
            return sub_141b97b20(arg1, rbx_8, arg4)
    ...
    if (sub_140cc1670(&var_58, &data_143e1b820).b == 0 || var_58 == 0)
        ...
        void var_48
        int64_t* rax_12 = sub_141b464f0(rax_10, &var_48)
        void* rsi_2 = nullptr
        int64_t rdi_2
        ...
        int64_t rbx_9 = *(rdi_2 + 8)
        sub_140d11050()
        
        if (rbx_9 != &data_143e1b9d0)
            result.b = 0
        else
            if (rbp_2 == 0xffffffff)
                rbp_2 = 0
            ...
            if (*(rdi_2 + 0x3c) != 1 || rbp_2 s>= *(rdi_2 + 0x38))
                ...
                int64_t rbx_10 = sx.q(rbp_2)
                int64_t rbx_11 = rbx_10 + result
                
                if (rbx_10 == neg.q(result))
                    result.b = 0
                else
                    sub_140a8cee0(arg2, rbx_11)
                    void var_38
                    int128_t* rax_14 = sub_141b464f0(rax_10, &var_38)
                    
                    if (*(rax_14 + 8) == 0)
                        rsi_2 = *rax_14
                    
                    result.b = (*(rsi_2 + 0x7b) & *(zx.q(*(rsi_2 + 0x79)) + rbx_11)) != 0
                    *arg4 = result.b
                    result.b = 1
                    *arg3 = rdi_2
