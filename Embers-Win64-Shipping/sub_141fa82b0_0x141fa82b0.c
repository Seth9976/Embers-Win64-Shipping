...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        uint64_t* rbx_1 = *var_58 + sx.q(i) * 0x28
        zmm1_1 = sub_140a1d9d0(arg1, rbx_1, zmm1_1)
        sub_1407e5270(arg1, &rbx_1[2], zmm1_1)
        int32_t var_4c
...
int512_t zmm1 = sub_141cdb8d0(arg2, arg_8)
int32_t r15 = 0
...
do
    ...
    if (rdx_9 == 0)
        ...
        *rdx_12 &= not.d(1 << (rbp_1.b & 0x1f))
        ...
        rdi_1 = sx.q(arg2[6].d)
        int64_t r9_2 = *arg2
        int64_t r8_6 = sx.q(*(r9_2 + rdi_1 * 0x28 + 4))
        arg2[6].d = r8_6.d
        *(arg2 + 0x34) = rdx_9 - 1
        
        if (rdx_9 != 1)
            *(r9_2 + r8_6 * 0x28) = 0xffffffff
    ...
    *r8_7 |= 1 << (rdi_1.b & 0x1f)
    int64_t rdx_14 = *arg2
    int64_t rcx_13 = sx.q(rdi_1.d) * 5
    *(rdx_14 + (rcx_13 << 3)) = 0
    *(rdx_14 + (rcx_13 << 3) + 8) = 0
    uint64_t* rdx_15 = rdx_14 + (rcx_13 << 3)
    rdx_15[2] = 0
    rdx_15[3] = 0
    rdx_15[4].d = 0xffffffff
    zmm1 = sub_140a1d9d0(arg1, rdx_15, zmm1)
    sub_1407e5270(arg1, &rdx_15[2], zmm1)
    r15 += 1
while (r15 s< arg_8)
