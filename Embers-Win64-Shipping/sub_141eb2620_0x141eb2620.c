...
if (arg2 s> 0)
    ...
    do
        if (r8_1 s< r11.d && r9_1[4] s< *r9_1)
            int128_t* rcx_2 = (sx.q(r8_1) << 4) + rbx
            int128_t* rdx_2 = (sx.q(r8_1 - 1) << 4) + rbx
        ...
        if (i_3 s> 0)
            while (i_8 s< i_5)
                ...
                while (j s> 0)
                    ...
                    if (*(r14_1 + sx.q(i_8) * 0x10 + 8)
                            s>= *(r14_1 + (sx.q(rax_6) + sx.q(rbx_1)) * 0x10 + 8))
                        r9_3 = rax_6 + rcx_4
                ...
                if (j_1 s> 0)
                    ...
                    do
                        ...
                        if (*(r14_1 + (sx.q(rax_10) + sx.q(i_8)) * 0x10 + 8) s< *(rsi_3 + 8))
                            j_10 = rcx_11 + rax_10
                    while (j_1 s> 0)
                            ...
                            do
                                ...
                                if (j_8.d s> 0)
                                    ...
                                    do
                                        ...
                                        void* rcx_19 = (sx.q(rdx_12 + rbx_2) << 4) + r14_1
                                        void var_50
