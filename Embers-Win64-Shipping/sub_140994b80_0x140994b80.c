...
if (rbx_1 != r15_3)
    do
        ...
        int64_t* rax_4 = sub_1409e46d0(rbx_1 + 0x18, &var_28)
        int16_t* const r14_1
        ...
        int64_t var_48
        int64_t* rax_5 = sub_140993b50(&var_48, rbx_1 + 8)
        int16_t* const r8_1
        ...
        sub_140a2e390(&var_58, 
            VertexID:%s, VertexInstanceAttributes:%s, OriginalVertexInstanceID:%s", r8_2)
