...
if (data_143f89a20 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143f89a20)
    
    if (data_143f89a20 == 0xffffffff)
        void var_28
        ...
        sub_1428200c0()
        sub_142826608(&data_143f89a00, &data_143f897e0, rax_4)
        void* var_40
        ...
        atexit(sub_142d14ab8)
        _Init_thread_footer(&data_143f89a20)

return &data_143f89a00
