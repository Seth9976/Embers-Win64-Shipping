...
if (data_143e8d308 s> *rdi_1)
    _Init_thread_header(&data_143e8d308)
    
    if (data_143e8d308 == 0xffffffff)
        ...
        data_143e8d300 = rax_12
        _Init_thread_footer(&data_143e8d308)

if (data_143e8d328 s> *rdi_1)
    _Init_thread_header(&data_143e8d328)
    
    if (data_143e8d328 == 0xffffffff)
        ...
        data_143e8d320 = rax_15
        _Init_thread_footer(&data_143e8d328)

if (data_143e8d348 s> *rdi_1)
    _Init_thread_header(&data_143e8d348)
    
    if (data_143e8d348 == 0xffffffff)
        ...
        data_143e8d340 = rax_18
        _Init_thread_footer(&data_143e8d348)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d300
int64_t rcx
...
label_14129b648:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_14129b643
    
    rbx.b = 1
    goto label_14129b648
