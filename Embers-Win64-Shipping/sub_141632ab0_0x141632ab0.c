...
if (zmm8[0] < 0f)
    ...
    rdi = 2
    var_300 = *(arg1 + 0x10)
    int32_t var_2f8_1 = rax_4
else
    float zmm0[0x4] = *(arg1 + 0x28)
    rdx = &var_360
...
int32_t r10_2 = rcx_1 & 0xfffffffe
int32_t rax_8 = rdx[2]
...
float var_35c_2 = (zmm10 ^ 0x80000000)[0]
...
uint128_t zmm12_1
double zmm13_1[0x2]
rax_9, zmm6_1, zmm9, zmm12_1, zmm13_1 = sub_1417105f0(&var_238, &var_320, &var_360)
uint128_t zmm5_1 = var_338[0]
uint128_t zmm4_1 = var_338[1]
double zmm3_1[0x2] = zmm5_1
uint128_t zmm11_1 = var_338[2]
uint128_t zmm1_1 = zmm6_1
uint128_t zmm2_1 = zx.o(*rax_9)
uint128_t zmm7 = zmm11_1
...
if (rdi.b == 0)
    while (true)
        ...
        if (rax_10 s>= 0x20)
            ...
            zmm3_1[0].d = zmm3_1[0].d f* zmm1_1.d
            zmm5_1.d = 0.5f f- zmm3_1[0].d
            zmm3_1 = *(rax_11 + 0x1c)
            zmm0_1[0].d = zmm0_1[0].d f* zmm5_1.d
            zmm5_1 = *(rax_11 + 0x24)
            zmm4_1.d = zmm4_1.d f+ zmm0_1[0].d
            ...
            if (zmm2_1.d f< zmm9[0].d)
                ...
                zmm4_1.d = zmm4_1.d f* zmm0_1[0].d
                zmm3_1[0].d = zmm3_1[0].d f+ *(rax_11 + 0x10)
                zmm5_1.d = zmm5_1.d f* zmm0_1[0].d
                zmm4_1.d = zmm4_1.d f+ *(rax_11 + 0x14)
                zmm5_1.d = zmm5_1.d f+ *(rax_11 + 0x18)
            ...
            int32_t r10_3 = r10_2 | rcx_5
            var_2d8 = (zmm12_1 ^ 0x80000000)[0].d
            int32_t rcx_7 = r10_3 & 0xfffffff7
            uint64_t var_270_1 = zmm7.q
            int32_t var_278_1 = rax_14[0].d
            
            if ((r10_3.b & 8) == 0)
                rcx_7 = r10_3
            
            int32_t rdx_3 = rcx_7 & 0xfffffffb
            int32_t var_2d4_1 = (zmm10_1 ^ 0x80000000).d
            
            if ((rcx_7.b & 4) == 0)
                rdx_3 = rcx_7
            
            int32_t var_2d0_1 = (zmm11_1 ^ 0x80000000)[0].d
            var_348 = rdx_3
            void var_1bc
            int32_t* rax_17
            rax_17, zmm6_1, zmm7, zmm8_1, zmm9, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm14, zmm15 =
                sub_1417105f0(&var_238, &var_1bc, &var_2d8)
            zmm1_1 = zx.o(*rax_17)
            int32_t rcx_9 = rax_17[2]
            zmm2_1.d = zmm7.d f- zmm1_1.d
            zmm0_1 = zmm1_1
            zmm0_1 = _mm_shuffle_ps(zmm0_1, zmm0_1, 0x55)
            zmm6_1[0].d = zmm6_1[0].d f- zmm0_1[0].d
            zmm0_1 = rax_14
            zmm0_1[0].d = zmm0_1[0].d f- rcx_9
            zmm4_1.d = zmm14.d f- zmm2_1.d
            (&var_184)[sx.q(r13.d)] = r13.d
            r13 = sx.q(var_188)
            int32_t var_324_1 = zmm2_1.d
            zmm2_1.d = zmm15.d f- zmm6_1[0].d
            int32_t var_2b4_1 = zmm0_1[0].d
            int32_t var_2b8_1 = zmm6_1[0].d
            zmm3_1 = var_350
            uint64_t rcx_11 = r13 * 3
            zmm3_1[0].d = zmm3_1[0].d f- zmm0_1[0].d
            var_360 = zmm4_1.d
            *(&var_130 + (rcx_11 << 2)) = (_mm_unpacklo_ps(zmm7, zmm6_1[0])).q
            zmm0_1 = zmm12_1
            *(&var_100 + (rcx_11 << 2)) = zmm1_1.q
            zmm5_1.d = zmm10_1.d f* zmm2_1.d
            (&var_128)[rcx_11] = var_278_1
            zmm0_1[0].d = zmm0_1[0].d f* zmm4_1.d
            (&var_f8)[rcx_11] = rax_17[2]
            zmm1_1.d = zmm11_1.d f* zmm3_1[0].d
            zmm5_1.d = zmm5_1.d f+ zmm0_1[0].d
            ...
            label_141633393:
                ...
                zmm1_1.d = var_160:0xc.d.d f+ zmm3_1[0].d
                ...
                zmm2_1.d = zmm15.d f- var_2b8_1
                var_140_1 = zmm0_1[0].d
                zmm0_1 = zmm7
                zmm0_1[0].d = zmm0_1[0].d f- var_2b4_1
            ...
            if (rdi.b != 0)
                int64_t* rax_31
                rax_31, zmm6_1, zmm7, zmm8_1, zmm9, zmm13_1, zmm14, zmm15 =
                ...
                var_300 = zmm1_1.q
                zmm3_1 = var_300.d
                zmm10_1 = _mm_shuffle_ps(zmm0_1, zmm0_1, 0x55)
                var_324 = zmm3_1[0].d
            else
                ...
                if (rcx_12 == 1)
                    ...
                    int64_t rcx_19 = rax_27 * 3
                    var_170[rax_27] = 0x3f800000
                    zmm0_1 = zx.o(*(&var_160 + (rcx_19 << 2)))
                    rax_23 = *(&var_160:8 + (rcx_19 << 2))
                else if (rcx_12 == 2)
                    void var_198
                    uint64_t* rax_26
                    rax_26, zmm6_1, zmm7, zmm8_1, zmm9 =
                    ...
                    uint64_t var_1a4
                    uint64_t* rax_25
                    rax_25, zmm6_1, zmm7, zmm8_1, zmm9, zmm13_1, zmm14, zmm15 =
                    ...
                    uint64_t var_1b0
                    uint64_t* rax_24
                    rax_24, zmm6_1, zmm7, zmm8_1, zmm9, zmm13_1, zmm14, zmm15 =
                ...
                var_170[3] = zmm3_1[0].d
                var_150_1:4.d = rdx_9
                int32_t rdx_10 = (&var_128)[r14]
                var_140_1 = rcx_20
                int32_t rcx_21 = (&var_128)[rsi_1]
                var_140_1 = rax_28
                ...
                if (result.b == 0)
                    goto label_1416337e5
                
                if (rdi.b == 0)
                    goto label_1416337ea
                
                if (not(zmm8_1.d f!= zmm9[0].d))
                    zmm1_1 = 0x3eb0c6f7a0b5ed8d
                    
                    if (not(_mm_cvtps_pd(zmm2_1.q)[0] f<= zmm1_1.q)
                            && not(_mm_cvtps_pd(zmm4_1.q)[0] f<= zmm1_1.q) && r13.d s< 4)
                        r14.b = 1
                        rdi.b = 0
                        var_368 = 1
                        goto label_1416337f0
...
if (not(cond:2_1))
    ...
    *arg8 = var_2f0
    ...
    zmm9[0].d = zmm9[0].d f- zmm0_1[0].d
    zmm0_1 = zmm2_1
    zmm0_1[0].d = zmm0_1[0].d f* arg8[1]
    zmm2_1.d = zmm2_1.d f* arg8[2]
    zmm1_1.d = zmm1_1.d f+ zmm5_1.d
    zmm4_1.d = zmm4_1.d f- zmm0_1[0].d
    zmm9[0].d = zmm9[0].d f- zmm2_1.d
    zmm9[0].d = zmm9[0].d f+ zmm1_1.d
    zmm1_1.d = zmm8_1.d f* arg4[1]
    zmm8_1.d = zmm8_1.d f* arg4[2]
    zmm1_1.d = zmm1_1.d f+ var_338[1]
    zmm8_1.d = zmm8_1.d f+ var_338[2]
    zmm4_1.d = zmm4_1.d f+ zmm1_1.d
    zmm9[0].d = zmm9[0].d f+ zmm8_1.d
    *arg7 = (_mm_unpacklo_ps(zmm9, zmm4_1.q)).q
    arg7[1].d = zmm9[0].d
else if (result.b != 0)
    double temp0_21[0x2]
    
    if (not(zmm13_1[0].d f<= zmm9[0].d))
        temp0_21 = _mm_cvtps_pd(zmm6_1[0])
    
    if (zmm13_1[0].d f<= zmm9[0].d || temp0_21[0] <= 9.9999999999999995e-07
            || zmm6_1[0].d f>= zmm1_1.d)
        var_170[0].q = 0
        var_170[2].q = 0
        var_338[0].q = 0
        var_338[2].q = 0
        ...
        label_141633dd6:
            ...
            *arg8 = zmm0_2.q
            ...
            zmm12_1.d = zmm12_1.d f* arg8[2]
            zmm1_1.d = zmm1_1.d f* arg8[1]
            ...
            if (r13.d s> 0)
                ...
                do
                    ...
                    *(rcx_28 + (rdx_14 << 2)) = *(&var_130 + r12)
                    zmm0_2.d = zmm14.d f+ *(&var_100 + r12)
                    *(rcx_28 + (rdx_14 << 2) + 8) = rax_42
                    ...
                    if (rax_43 s> var_338[3])
                        sub_14083a7e0(&var_338)
                    
                    int64_t rcx_30 = var_338[0].q
                    int64_t rdx_16 = rdi_5 * 3
                    r12 += 0xc
                    *(rcx_30 + (rdx_16 << 2)) = var_360.q
                    *(rcx_30 + (rdx_16 << 2) + 8) = var_358_2
                    i_1 = i_5
                    i_5 -= 1
                while (i_1 != 1)
                rdi_3 = arg6
            ...
            int32_t rax_47
            rax_47, zmm12_1, zmm13_1 = sub_1415c03d0(&var_170, &var_338, &var_260, &var_238, 
                &var_348, &var_360, &var_2a0, &var_248)
            zmm0_2 = zx.o(var_360.q)
            rax_48 = var_358_2
            
            if (rax_47 == 2)
                goto label_141633dd6
            
            *arg8 = zmm0_2.q
            zmm0_2.d = (var_348 ^ data_142d3f780).d f- zmm13_1[0].d
            arg8[2] = rax_48
            result = result_1
            *rdi_3 = zmm0_2.d
            zmm0_2 = zx.o(var_2a0)
        ...
        *arg8 = var_2f0
        ...
        if (rcx_4 == 0)
            ...
            zmm0_1 = zmm2_1
            zmm5_1 = rax_38
            zmm12_1 = _mm_shuffle_ps(zmm0_1, zmm0_1, 0x55)
            zmm10_1 = rax_39
            var_300 = zmm1_1.q
            zmm3_1 = var_300.d
            var_2d8.q = zmm2_1.q
            ...
            do
                ...
                r12 += 0xc
                zmm12_1.d = zmm12_1.d f+ zmm0_1[0].d
        ...
        zmm6_1 = var_338[2]
        zmm14 = var_338[0]
        zmm6_1[0].d = zmm6_1[0].d f+ zmm10_1.d
        zmm15 = var_338[1]
        zmm8_1.d = zmm14.d f+ zmm11_1.d
        zmm7.d = zmm15.d f+ zmm12_1.d
        zmm6_1[0].d = zmm6_1[0].d f- zmm5_1.d
        ...
        zmm0_1 = zmm4_1
        zmm0_1[0].d = zmm0_1[0].d f* zmm8_1.d
        zmm1_1.d = zmm4_1.d f* zmm7.d
        zmm4_1.d = zmm4_1.d f* zmm6_1[0].d
        ...
        *arg8 = zmm0_1.q
        ...
        if (not(zmm13_1[0].d f< zmm9[0].d))
            zmm9 = __minss_xmmss_memss(zmm13_1[0].d, 0x7f7fffff)
        ...
        zmm11_1.d = zmm11_1.d f+ zmm9[0].d
        zmm9[0].d = zmm9[0].d f* zmm2_1.d
        zmm12_1.d = zmm12_1.d f+ zmm9[0].d
        zmm0_1 = zmm9
        zmm9 ^= data_142d3f780
        zmm0_1[0].d = zmm0_1[0].d f* zmm3_1[0].d
