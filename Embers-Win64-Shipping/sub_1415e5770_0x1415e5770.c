...
float (* rax_3)[0x4]
int64_t r9
rax_3, r9 = sub_140ad7d70(arg3, &var_88, arg5)
char rcx_1 = *(rdi + 8)
void* rdx_1 = rdi
...
if (rdx_1 == 0)
    ...
    if (rax_10 == 0)
        ...
        if (rdi != 0)
            int32_t* var_228_3 = &var_218
            
            if (sub_1415d1750(arg4, rdi, &var_178, r9, &var_210, &var_200) != 0)
                arg1[3].d = var_218[0]
                ...
                float temp0_113[0x4] =
                    _mm_mul_ps(_mm_shuffle_ps(temp0_108, temp0_108, 0xc9), temp0_109)
                ...
                float temp0_120[0x4] =
                    _mm_mul_ps(_mm_shuffle_ps(temp0_117, temp0_117, 0xc9), temp0_109)
                ...
                *(arg1 + 0x14) = var_190_1
                ...
                float temp0_138[0x4] =
                    _mm_mul_ps(_mm_shuffle_ps(temp0_132, temp0_132, 0xd2), temp0_136)
        ...
        if (rdx_5 != 0)
            int32_t* var_228_2 = &var_218
            
            if (sub_1415d1750(arg4, rdx_5, &var_178, r9, &var_210, &var_200) != 0)
                arg1[3].d = var_218[0]
                ...
                float temp0_70[0x4] = _mm_sub_ps(
                    _mm_mul_ps(_mm_shuffle_ps(temp0_62, temp0_62, 0xd2), temp0_63), temp0_67)
                ...
                float temp0_80[0x4] = __addps_xmmps_memps(
                    _mm_add_ps(_mm_sub_ps(_mm_mul_ps(temp0_75, temp0_63), temp0_74), temp0_76), 
                    arg5[1])
    ...
    void** var_118
    sub_141703a00(&var_118, rdx_2, &var_1f0, zx.o(0)[0])
    int32_t zmm3_2 = arg6 f+ *(arg4 + 0x40)
    ...
    var_1d8 = *(arg4 + 0x28)
    char rax_5 =
        sub_1417aff50(rcx_3, &var_118, &var_b8, zmm3_2, var_238_1, var_230_1, var_228_1, var_220_1)
