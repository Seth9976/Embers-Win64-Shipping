    ...
    do
        ...
        if (rdi_1 s< arg2)
            do
                ...
                if ((rdx_1 + 1).d s< arg2)
                    if (*(&arg1[sx.q(r10_1)] + 0x2c) s> *(&arg1[sx.q(rdx_1.d)] + 0xc))
                        rdx_1 = zx.q(r10_1)
                ...
                result = zx.q(*(rcx_4 + 0xc))
                
                if (*(r9_4 + 0xc) s<= result.d)
                    break
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if ((result + 1).d s< i)
                    if (*(&arg1[sx.q(result_1)] + 0x2c) s> *(&arg1[sx.q(result.d)] + 0xc))
