...
if (data_143e8b898 s> *rdi_1)
    _Init_thread_header(&data_143e8b898)
    
    if (data_143e8b898 == 0xffffffff)
        ...
        data_143e8b890 = rax_9
        _Init_thread_footer(&data_143e8b898)

if (data_143e8b8b8 s> *rdi_1)
    _Init_thread_header(&data_143e8b8b8)
    
    if (data_143e8b8b8 == 0xffffffff)
        ...
        data_143e8b8b0 = rax_12
        _Init_thread_footer(&data_143e8b8b8)

if (data_143e8b8d8 s> *rdi_1)
    _Init_thread_header(&data_143e8b8d8)
    
    if (data_143e8b8d8 == 0xffffffff)
        ...
        data_143e8b8d0 = rax_15
        _Init_thread_footer(&data_143e8b8d8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b890
int64_t rcx
...
label_1412bfd73:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412bfd6e
        
        rbx.b = 1
        goto label_1412bfd73
