...
if (data_143e8c230 s> *rdi_1)
    _Init_thread_header(&data_143e8c230)
    
    if (data_143e8c230 == 0xffffffff)
        ...
        data_143e8c228 = rax_9
        _Init_thread_footer(&data_143e8c230)

if (data_143e8c240 s> *rdi_1)
    _Init_thread_header(&data_143e8c240)
    
    if (data_143e8c240 == 0xffffffff)
        ...
        data_143e8c238 = rax_12
        _Init_thread_footer(&data_143e8c240)

if (data_143e8c250 s> *rdi_1)
    _Init_thread_header(&data_143e8c250)
    
    if (data_143e8c250 == 0xffffffff)
        ...
        data_143e8c248 = rax_15
        _Init_thread_footer(&data_143e8c250)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c228
int64_t rcx
...
label_1412ba1d3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412ba1ce
        
        rbx.b = 1
        goto label_1412ba1d3
