...
if (data_143e8e010 s> *rdi_1)
    _Init_thread_header(&data_143e8e010)
    
    if (data_143e8e010 == 0xffffffff)
        ...
        data_143e8e008 = rax_12
        _Init_thread_footer(&data_143e8e010)

if (data_143e8e030 s> *rdi_1)
    _Init_thread_header(&data_143e8e030)
    
    if (data_143e8e030 == 0xffffffff)
        ...
        data_143e8e028 = rax_15
        _Init_thread_footer(&data_143e8e030)

if (data_143e8e050 s> *rdi_1)
    _Init_thread_header(&data_143e8e050)
    
    if (data_143e8e050 == 0xffffffff)
        ...
        data_143e8e048 = rax_18
        _Init_thread_footer(&data_143e8e050)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e008
int64_t rcx
...
label_1412ad578:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412ad573
    
    rbx.b = 1
    goto label_1412ad578
