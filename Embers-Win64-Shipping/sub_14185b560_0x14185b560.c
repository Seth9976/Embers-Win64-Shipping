...
*rdx_8 |= 1 << (rbp.b & 0x1f)
int128_t* rbx_2 = *arg4
int128_t* rdi_3 = *arg1 + sx.q(rbp.d) * 0x28
void var_38
int64_t* rax_15 = pdb_internal::Array<struct DBI1::SrcMap>::Array<struct DBI1::SrcMap>(&var_38)
*rdi_3 = *rbx_2
sub_14181d6d0(&rdi_3[1], rax_15)
sub_1418221b0(&var_38)
rdi_3[2].d = 0xffffffff
sub_1418366a0(arg1, arg2, arg3, rdi_3, rbp.d, arg5)
return arg2
