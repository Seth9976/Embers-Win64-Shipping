...
int32_t rsi = *(rax_1 + (rdx << 2) + 0x10)
int64_t rax_2 = sx.q(*(arg4 + 0x78))
int128_t var_28 = *(rax_1 + (rdx << 2))
var_28.d = arg3
...
sub_141fd3f30(arg4 + 0x70, rdi, 1)
int64_t rdx_3 = sx.q(rdi) * 5
int64_t rcx_3 = *(arg4 + 0x70)
*(rcx_3 + (rdx_3 << 2)) = 0
*(rcx_3 + (rdx_3 << 2) + 8) = 0
*(rcx_3 + (rdx_3 << 2) + 0x10) = 0
int64_t rcx_4 = *(arg4 + 0x70)
*(rcx_4 + (rdx_3 << 2)) = var_28
*(rcx_4 + (rdx_3 << 2) + 0x10) = rsi
return zx.q(rdi)
