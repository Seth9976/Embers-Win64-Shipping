...
if (data_143e8ad50 s> *rdi_1)
    _Init_thread_header(&data_143e8ad50)
    
    if (data_143e8ad50 == 0xffffffff)
        ...
        data_143e8ad48 = rax_9
        _Init_thread_footer(&data_143e8ad50)

if (data_143e8ad60 s> *rdi_1)
    _Init_thread_header(&data_143e8ad60)
    
    if (data_143e8ad60 == 0xffffffff)
        ...
        data_143e8ad58 = rax_12
        _Init_thread_footer(&data_143e8ad60)

if (data_143e8ad70 s> *rdi_1)
    _Init_thread_header(&data_143e8ad70)
    
    if (data_143e8ad70 == 0xffffffff)
        ...
        data_143e8ad68 = rax_15
        _Init_thread_footer(&data_143e8ad70)
