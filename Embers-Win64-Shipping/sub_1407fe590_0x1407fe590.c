...
int32_t rsi = (data_143ce2e40.q).d
int32_t rax = 1
...
int32_t r14_2 = (data_143ce2e50.q).d
...
__builtin_memcpy(result_13, u"Texture3D ", 0x14)
...
int32_t rax_9 = (data_143ce2e60.q).d
...
result_10[1].d = 0x330074
*(result_10 + 0xc) = 0x20
int64_t rbx_7 = sx.q(rbx_6)
memcpy(result_10 + 0xe, data_143ce2e58, rbx_7.d * 2)
