...
if (data_143e8ce28 s> *rdi_1)
    _Init_thread_header(&data_143e8ce28)
    
    if (data_143e8ce28 == 0xffffffff)
        ...
        data_143e8ce20 = rax_9
        _Init_thread_footer(&data_143e8ce28)

if (data_143e8ce38 s> *rdi_1)
    _Init_thread_header(&data_143e8ce38)
    
    if (data_143e8ce38 == 0xffffffff)
        ...
        data_143e8ce30 = rax_12
        _Init_thread_footer(&data_143e8ce38)

if (data_143e8ce48 s> *rdi_1)
    _Init_thread_header(&data_143e8ce48)
    
    if (data_143e8ce48 == 0xffffffff)
        ...
        data_143e8ce40 = rax_15
        _Init_thread_footer(&data_143e8ce48)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ce20
int64_t rcx
...
label_14129abd3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_14129abce
        
        rbx.b = 1
        goto label_14129abd3
