...
if (rax_2 - 1 s>= 0)
    int64_t r12_2 = rax_4 << 4
    
    while (i s> 0)
        int64_t* rsi_2 = *(arg1 + 0x58) + r12_2
        
        if (rdx == rcx_1)
            goto label_141897220
        ...
        while (true)
            ...
            int32_t r8_3 = (*(r15_1 + (rdx_3 << 3) + 4) ^ *(rsi_2 + 4))
                | (*(r15_1 + (rdx_3 << 3) + 8) ^ rsi_2[1].d)
                | (*(r15_1 + (rdx_3 << 3) + 0xc) ^ *(rsi_2 + 0xc))
            
            if ((r8_3 | (*(r15_1 + (rdx_3 << 3)) ^ *rsi_2)) == 0)
                break
            
            rax_10 = *(r15_1 + (rdx_3 << 3) + 0x10)
            
            if (rax_10 == 0xffffffff)
                goto label_141897216
        ...
        label_141897220:
            ...
            if ((*r14)((*(*rcx_11 + 8))(rcx_11), rsi_2) == 0)
                r9 = var_58
            else
                int32_t var_b0
