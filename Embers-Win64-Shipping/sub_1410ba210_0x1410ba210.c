...
if (data_143e2cbc0 s> *rsi_1)
    _Init_thread_header(&data_143e2cbc0)
    
    if (data_143e2cbc0 == 0xffffffff)
        ...
        data_143e2cbb8 = rax_6
        _Init_thread_footer(&data_143e2cbc0)

uint32_t rax_2

if (data_143e2cbd0 s> *rsi_1)
    int64_t r8_2
    rax_2, r8_2 = _Init_thread_header(&data_143e2cbd0)
    
    if (data_143e2cbd0 == 0xffffffff)
        ...
        data_143e2cbc8 = rax_9
        _Init_thread_footer(&data_143e2cbd0)

int64_t rbp = data_143e2cbc8
uint16_t rsi_2
...
label_1410ba310:
    ...
    if (sub_1405fba70(*arg1, 3) != 0 && sub_1410be940(arg1) != 0)
        return 1
else
    char rax_3
