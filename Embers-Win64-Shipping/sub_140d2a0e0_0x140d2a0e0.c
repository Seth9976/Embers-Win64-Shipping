...
int32_t i = *(r11 + (((sx.q(rcx_5 - r8_7 - r9_7) ^ zx.q(r8_7) u>> 0xf) & rdi_1) << 2))
...
if (i != 0xffffffff)
    ...
    do
        ...
        if (*(rax_19 + rdx) == arg2)
            ...
            int64_t rax_21 = sx.q(*(r8_9 + rdx + 0x5c)) & rdi_1
            ...
            void* rdi_3 = *arg1 + r8_9
            *(rdi_3 + 0x50) = 0
            int64_t rcx_15 = *(rdi_3 + 0x48)
            
            if (rcx_15 != 0)
                sub_140a74f90(rcx_15)
            
            sub_1407ece30(rdi_3 + 8, 0)
            int64_t rcx_17 = *(rdi_3 + 0x28)
            
            if (rcx_17 != 0)
                sub_140a74f90(rcx_17)
            
            int64_t rcx_18 = *(rdi_3 + 8)
