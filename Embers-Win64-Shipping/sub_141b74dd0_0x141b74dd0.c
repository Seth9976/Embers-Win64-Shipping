...
if (rax_2 == 0 || rbx_1 == 0)
    if (sub_140cc16a0(&var_48, sub_140bdfab0()) != 0)
        ...
        if (rbx_2 != 0)
            ...
            return sub_141b978b0(arg1, rbx_2, arg4)
    ...
    if (sub_140cc1670(&var_48, &data_143e1b820).b == 0 || var_48 == 0)
        ...
        uint64_t rsi_6 = zx.q(sub_1408e52c0(rax_10))
        void var_38
        ...
        if (*(result + 8) != 0)
            ...
            if (rbx_1 == 0 || ((zx.q(*(*(rbx_1 + 8) + 0x10)) u>> 0x14).b & 1) == 0)
                ...
                if (result.b == 0)
                    ...
                    if (rsi_6.d == 0xffffffff)
                        rsi_6 = 0
                    
                    if (*(rbx_1 + 0x3c) != 0x28 || rsi_6.d s>= *(rbx_1 + 0x38))
                        result.b = 0
                    else
                        int64_t rsi_7 = sx.q((rsi_6 * 5).d << 3)
    ...
    if (rax_1 s< 0 || rax_1 s>= rsi_1[1].d || r14_1 == 0
        ...
        if (result.b == 0 || *(*(rbx_1 + 0x78) + 0x3c) != 0x28 || rsi_1[1].d == 0)
            result.b = 0
        else
            result = *rsi_1
