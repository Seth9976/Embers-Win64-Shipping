...
if (result == 0 || arg2 == 0xff)
    ...
    if (arg2 u< r8)
        ...
        if (rcx_2 == 0)
            ...
            r14 = sub_1426b21a0(rcx_2, arg2)
    else
        r14 = *(result + 0x38) + (zx.q(arg2) - zx.q(r8)) * 0x18
...
if (r14 == 0)
    ...
    if (rdi_1 == 0)
        result.b = 0
    else if (*(rdi_1 + 0x10) != sub_14272e2f0())
        result.b = 0
    else
        uint32_t rax_4
        ...
        uint64_t r15_1 = (zx.q(*(r14[1] + 0x2b) u>> 1) & 1) << 2
        uint64_t* rcx_4 = r15_1 + r8_2
                ...
                if ((*(*(arg1 + 0xc0) + 0x48) & 1) != 0)
                    ...
                    if (result.b != 0)
                        ...
                        label_1426a4d52:
                            ...
                            if (rax_6 != 0)
                                goto label_1426a4d52
                            
                            rdi_3 = nullptr
                        
                        int32_t var_108
                        sub_1426a6560(&var_108, rdi_3 + 0xd8, *(arg1 + 0xc0))
                    label_1426a4d9b:
                        ...
                        while (true)
                            ...
                            if (rax_13 != 0 && sub_1426bf730(arg1, rax_13) != 0)
                                ...
                                if (rcx_16 == 0)
                                    ...
                                    rdx_10 = sub_1426b2260(rcx_16, r14)
                            ...
                            *(rdx_12 + (rcx_19 << 3) + 0x10) = i
                            ...
                            if (i != 0xffffffff)
                                ...
                                do
                                    int64_t* r8_8 = *rdi_5
                                    int64_t rax_21 = *(rdi_5 + 8)
                                    *(rdi_5 + 0x14) = *(*r8_8 + sx.q(i) * 0x18 + 0x10)
