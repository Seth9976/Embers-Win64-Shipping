...
if (result_1.b == 0)
    ...
    *(arg1 + 0x10) = result
    ...
    if (i_4 s> 0)
        zmm8 = tanf(temp0_1[0].q.d)
        zmm7 = tanf(_mm_shuffle_ps(temp0_1, temp0_1, 0x55)[0])
        zmm6 = tanf(_mm_shuffle_ps(temp0_1, temp0_1, 0xaa)[0])
        float temp0_4[0x4] = _mm_unpacklo_ps(zmm7, tanf(temp0_1[0]))
