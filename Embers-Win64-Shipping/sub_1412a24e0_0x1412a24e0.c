...
if (data_143e8ab10 s> *rdi_1)
    _Init_thread_header(&data_143e8ab10)
    
    if (data_143e8ab10 == 0xffffffff)
        ...
        data_143e8ab08 = rax_9
        _Init_thread_footer(&data_143e8ab10)

if (data_143e8ab20 s> *rdi_1)
    _Init_thread_header(&data_143e8ab20)
    
    if (data_143e8ab20 == 0xffffffff)
        ...
        data_143e8ab18 = rax_12
        _Init_thread_footer(&data_143e8ab20)

if (data_143e8ab30 s> *rdi_1)
    _Init_thread_header(&data_143e8ab30)
    
    if (data_143e8ab30 == 0xffffffff)
        ...
        data_143e8ab28 = rax_15
        _Init_thread_footer(&data_143e8ab30)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ab08
int64_t rcx
...
label_1412a25e3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412a25de
        
        rbx.b = 1
        goto label_1412a25e3
