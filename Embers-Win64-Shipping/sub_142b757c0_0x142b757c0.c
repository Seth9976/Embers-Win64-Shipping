        ...
        if (r8_7 == 0x75 || r8_7 == 0x55)
            ...
            if (r8_10 == 0x72 || r8_10 == 0x52)
                ...
                if (arg2 + 4 u< result.d)
                    ...
                    r9 = *(r8_12 + (sx.q(arg2 + 4) << 1))
                
                if (r9 == 0x61 || r9 == 0x41)
                    int16_t r8_13 = *(arg1 + 0x18)
                    
                    if (r8_13 s< 0)
                        result = zx.q(*(arg1 + 0x1c))
                    else
                        result = zx.q(sx.d(r8_13) s>> 5)
                    ...
                    if (arg2 + 5 u< result.d)
                        ...
                        if ((0xffdf & (*(rcx + (sx.q(arg2 + 5) << 1)) - 0x4c)) == 0)
                            result.b = 1
                            return 0xff01
