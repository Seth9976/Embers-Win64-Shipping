...
if (data_143f2a828 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143f2a828)
    
    if (data_143f2a828 == 0xffffffff)
        sub_140b58170(&data_143f2a820, "IntegralCurve", 1)
        _Init_thread_footer(&data_143f2a828)

int32_t rcx
rcx.b = *(arg2 + 0xc) == 0
int64_t result

if ((rcx.b & sub_140b5b8a0(*(arg2 + 8), 0xa).b) == 0 || *(arg2 + 0x1c) != data_143f2a820)
    result.b = 0
else
    ...
    while (true)
        ...
        uint128_t zmm1_1 = _mm_cvtepi32_pd(zx.q(var_130.d))
        char r13_1 = *(*rax_8 + (sx.q(var_108) << 3) + 4)
                ...
                do
                    if (rbx_1 s>= *rax_15)
                        ...
                        *(arg1 + 0x28) = r12_2 + 1
                        ...
                        int64_t rdx_9 = sx.q(r13_2 + 1) + *(arg1 + 0x20)
                        memmove(rdx_9 + 1, rdx_9, r12_2 - (r13_2 + 1))
                        r12_1 = var_100_1
                        *(*(arg1 + 0x20) + rsi_3 + 1) = r13_1
                        break
