...
if (data_143e8e670 s> *rdi_1)
    _Init_thread_header(&data_143e8e670)
    
    if (data_143e8e670 == 0xffffffff)
        ...
        data_143e8e668 = rax_9
        _Init_thread_footer(&data_143e8e670)

if (data_143e8e680 s> *rdi_1)
    _Init_thread_header(&data_143e8e680)
    
    if (data_143e8e680 == 0xffffffff)
        ...
        data_143e8e678 = rax_12
        _Init_thread_footer(&data_143e8e680)

if (data_143e8e690 s> *rdi_1)
    _Init_thread_header(&data_143e8e690)
    
    if (data_143e8e690 == 0xffffffff)
        ...
        data_143e8e688 = rax_15
        _Init_thread_footer(&data_143e8e690)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8e668
int64_t rcx
...
label_1412a6773:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412a676e
        
        rbx.b = 1
        goto label_1412a6773
