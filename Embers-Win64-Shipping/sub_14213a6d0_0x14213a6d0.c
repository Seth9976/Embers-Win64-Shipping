...
if (rax_7 != 0)
    ...
    if ((arg1[5].b & 1) != 0)
        ...
        do
            ...
            char* rdx_6 = *arg2 + rbp_1 * 0x18
            
            if (rdx_6 == 0)
                rdx_6 = nullptr
            else
                *rdx_6 &= 0xfffffff0
                __builtin_memcpy(&rdx_6[4], 
                    "\x00\x00\x00\x41\x00\x00\x00\x00\x00\x00\x80\x3f\x00\x00\x80\x3f\x00\x00\x80\x3f", 
                    0x14)
            
            sub_14228ac80(arg1, rdx_6, arg3)
            r14 += 1
        while (r14 s< arg_8)
    ...
    if (rax_7 s> 0)
        do
            sub_14228ac80(arg1, *arg2 + sx.q(i) * 0x18, arg3)
            i += 1
        while (i s< arg2[1].d)
