...
if (r9.d s> 0 && r9.d u>= 8)
    ...
    do
        ...
        float temp0_4[0x4] = _mm_unpacklo_ps(*(rax + rdx - 0x190), zmm1[0].q)
        zmm5 = _mm_min_ps(zmm5, temp0_3)
        zmm4 = _mm_max_ps(zmm4, temp0_3)
        float temp0_8[0x4] =
            _mm_unpacklo_ps(_mm_unpacklo_ps(*(rax + rdx - 0x1e0), zmm0[0].q), temp0_4[0].q)
