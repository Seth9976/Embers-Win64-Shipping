...
if (r8 == 0)
    *arg3 = 0
    ...
    int32_t i = *(arg1[3] + (r10 << 2))
    bool cond:0_1 = i != 0xffffffff
    
    if (i != 0xffffffff)
        do
            if (*(arg1[1] + zx.q(i) * 0x10) == r9_1)
                break
...
if (*(arg1 + 0x34) == arg1[4].d)
    ...
    r10 = (zx.q((rdx_3 u>> 0x1f).d) ^ zx.q(rdx_3.d)) & zx.q(*(arg1 + 0x24) - 1)

uint64_t r8_2 = zx.q(*(arg1 + 0x2c))
int64_t rcx_15 = arg1[3]
int64_t rdx_4 = arg1[2]
*(arg1 + 0x2c) = (r8_2 + 1).d
