...
if (cond:0)
    void* rax_2
    rax_2, arg5 = sub_14139d8d0(arg1, arg2, *(arg1 + 0x38c))
    r14 = rax_2
else
    r14 = arg1 + 0x1b8
...
int64_t rax_11 = r14_8 + 0x46

if (rax_11 u> *(arg2 + 0x38))
    arg5 = sub_140b0e3d0(arg2 + 0x30, 0x48)
    r14_8 = (*(arg2 + 0x30) + 1) & 0xfffffffffffffffe
    rax_11 = r14_8 + 0x46

wchar16 const* const rcx_13 = u"BeginRenderingSeparateTranslucency"
*(arg2 + 0x30) = rax_11
wchar16 const i

do
    i = *rcx_13
    *(rcx_13 + r14_8 - u"BeginRenderingSeparateTranslucency") = i
    rcx_13 = &rcx_13[1]
while (i != 0)
