...
if (data_143e8a6b0 s> *rdi_1)
    _Init_thread_header(&data_143e8a6b0)
    
    if (data_143e8a6b0 == 0xffffffff)
        ...
        data_143e8a6a8 = rax_12
        _Init_thread_footer(&data_143e8a6b0)

if (data_143e8a6c0 s> *rdi_1)
    _Init_thread_header(&data_143e8a6c0)
    
    if (data_143e8a6c0 == 0xffffffff)
        ...
        data_143e8a6b8 = rax_15
        _Init_thread_footer(&data_143e8a6c0)

if (data_143e8a6d0 s> *rdi_1)
    _Init_thread_header(&data_143e8a6d0)
    
    if (data_143e8a6d0 == 0xffffffff)
        ...
        data_143e8a6c8 = rax_18
        _Init_thread_footer(&data_143e8a6d0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8a6a8
int64_t rcx
...
label_1412a9158:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412a9153
    
    rbx.b = 1
    goto label_1412a9158
