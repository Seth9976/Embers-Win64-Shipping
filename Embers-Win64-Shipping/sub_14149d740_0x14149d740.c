...
float zmm0[0x4] = sub_141472f80(arg1 + 0x11a, arg2, r15, arg6, zmm6)
int64_t* rbx_1 = *(*(arg6 + 0x5c0) + 0x20)
...
float var_60_1 = *(arg6 + 0x8fc)
float var_64_1 = *(arg6 + 0x8f8)
...
sub_14139bef0(arg2)
void* rax_12 = sub_1422c6ca0(arg2)

if (rax_12 == 0)
    rax_12 = data_1439b70c8

void* rax_13 = *(rax_12 + 0x10)
...
if (r11 s> 0)
    ...
    while (true)
        void* rcx_36 = *(arg1 + 0xd8)
        
        if ((*(arg1 + 0xd8) & 1) != 0)
            rcx_36 = (rcx_36 s>> 1) + arg1 + 0xd8
        
        if (*(rcx_36 + (rdx_8 << 3)) == data_143e83070)
            break
...
label_14149db8f:
    ...
    void* rcx_40 = *(arg1 + 0xe8)
    
    if ((rcx_40.b & 1) != 0)
        rcx_40 = (rcx_40 s>> 1) + arg1 + 0xe8
    
    rdx_9 = rcx_40 + (sx.q(rsi) << 1)
...
var_78.q = arg4
return sub_1412155b0(arg2, r15, &arg_18, *(arg6 + 0x5c0), var_78)
