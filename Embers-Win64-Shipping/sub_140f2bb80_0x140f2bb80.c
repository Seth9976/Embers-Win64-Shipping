...
float zmm10[0x4] = *(arg4 + 0x28)
int128_t zmm9
zmm9.d = (*(arg4 + 0x2c)).d f+ *(arg4 + 0x24)
float zmm8[0x4] = *arg2
zmm7[0] = zmm7[0] + zmm10[0]
int32_t rdi = *(arg4 + 0x48)
float zmm6[0x4] = zmm8
int32_t var_154
zmm9.d = zmm9.d f+ var_154
zmm6[0] = zmm6[0] - zmm7[0]
uint64_t var_150

if (rdi != 0)
    float temp0_1[0x4] = _mm_min_ss((*sub_140e13cf0(*(arg4 + 0x10), &var_150))[0], zmm6[0])
...
zmm10[0] = zmm10[0] f+ *(arg4 + 0x24)
float var_174 = var_154[0]
bool cond:0 = data_143e20cf4 != 0
float var_178 = zmm6[0]
float var_168 = zmm10[0]
var_170 = 0x3f800000
...
if (cond:0)
    int128_t* rax_7 = sub_140e111c0(rcx_4 + 0x1c8)
    char rcx_6 = 0
    ...
    if (rcx_6 == 0)
        goto label_140f2be1b
    
    uint64_t var_e8_2 = var_120
    var_f8 = zmm1_1
    goto label_140f2bd5a
