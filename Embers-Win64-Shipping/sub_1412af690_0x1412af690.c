...
if (data_143e8d198 s> *rdi_1)
    _Init_thread_header(&data_143e8d198)
    
    if (data_143e8d198 == 0xffffffff)
        ...
        data_143e8d190 = rax_12
        _Init_thread_footer(&data_143e8d198)

if (data_143e8d1b8 s> *rdi_1)
    _Init_thread_header(&data_143e8d1b8)
    
    if (data_143e8d1b8 == 0xffffffff)
        ...
        data_143e8d1b0 = rax_15
        _Init_thread_footer(&data_143e8d1b8)

if (data_143e8d1d8 s> *rdi_1)
    _Init_thread_header(&data_143e8d1d8)
    
    if (data_143e8d1d8 == 0xffffffff)
        ...
        data_143e8d1d0 = rax_18
        _Init_thread_footer(&data_143e8d1d8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d190
int64_t rcx
...
label_1412af788:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412af783
    
    rbx.b = 1
    goto label_1412af788
