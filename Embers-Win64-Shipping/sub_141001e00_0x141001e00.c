...
if ((*(arg3 + 0x20) & 6) == 0)
    void* rcx_13 = *(arg3 + 0x30)
    void* var_100 = rcx_13
    int64_t var_f8 = *(arg3 + 0x80)
    
    if (arg6 != 0)
        result = sub_1410130c0(rcx_13 + 0x7c0, arg_28, 0x200, arg3 + 0xf8)
    else
        *(arg3 + 0x168) |= 2
        void** rax_9 = zx.q(arg_28 + arg_20)
        int32_t var_110_1 = 0
        void* const arg_8 = nullptr
        int32_t r8_4 = *(rcx_13 + 0x10)
        int32_t rax_10
        int128_t zmm2_1
        int128_t zmm3_1
        rax_10, zmm2_1, zmm3_1 = sub_141048240(r12, 3, r8_4, zx.q(r8_4), rax_9, &arg_8, 0)
        ...
        if (arg2 != 0 && arg2[0x10] == 0)
            int32_t rbx_7 = data_143f029c8
            sub_140b34200("FlushRHIThreadTotal", rbx_7)
            ...
            rdx_10.b = 1
            sub_14198b7d0()
            sub_140b38680("FlushRHIThreadTotal", rbx_7)
    ...
    if (arg2 == 0 || arg2[0x10] != 0 || arg6 != 1)
        ...
        void* rbx_6 = arg_18
        result = result_1
        int512_t zmm0_1 = sub_14105b290(rbx_6 + 0x70, &var_a8, zmm0)
        
        if (data_1439c7a34 u> 1)
            for (void* i = *(rbx_6 + 0xe0); i != 0; i = *(i + 0xe0))
                zmm0_1 = sub_141059540(*(i + 0x30), i + 0x70, rbx_6 + 0x70, zmm0_1)
        
        j_sub_141059a80(&var_a8, zmm0_1)
    else
