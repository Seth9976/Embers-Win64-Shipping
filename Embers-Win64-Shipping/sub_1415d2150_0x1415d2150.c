...
float var_238
sub_141731000(arg2, &var_238)
int32_t var_220
int32_t* var_278 = &var_220
var_238 = var_238 f- arg4.d
float var_234
float var_234_1 = var_234 f- arg4.d
float var_230
float var_230_1 = var_230 f- arg4.d
float var_22c = var_22c f+ arg4.d
float var_228
float var_228_1 = var_228 f+ arg4.d
float var_224
float var_224_1 = var_224 f+ arg4.d
int64_t var_210
uint128_t zmm10
int512_t zmm11
uint128_t zmm13
uint128_t zmm14
int128_t zmm15
zmm10, zmm11, zmm13, zmm14, zmm15 = sub_14003bce0(arg3, &var_238, &var_22c, &var_210, var_278)
int64_t zmm0_1 = var_210
float zmm3[0x4] = var_210.d
int32_t zmm1_1 = var_220
...
uint128_t zmm8
uint128_t zmm9
zmm7, zmm8, zmm9 = sub_14173e270(arg1, &var_1e8, &var_1d8)
uint64_t rcx_3 = var_1d8
int32_t zmm12 = (zx.o(0)).d
uint64_t rbx_1 = rcx_3
zmm11.o = 0x7f7fffff
int64_t rax_6 = rcx_3 + (sx.q(var_1d0) << 3)
var_210 = rax_6
...
if (rcx_3 != rax_6)
    ...
    do
        uint32_t rax_7 = zx.d(*(arg1 + 0x46))
        int32_t r9_3 = rax_7 * *(rbx_1 + 4) + *rbx_1
        int32_t rax_9 = (rax_7 - 1) * *(rbx_1 + 4)
        int32_t rax_10 = rax_9 + *rbx_1
        
        if (rax_9 + *rbx_1 s< 0 || rax_10 s>= *(arg1 + 0x28)
                || *(sx.q(rax_10) + *(arg1 + 0x20)) != 0xff)
            int32_t zmm2_1 = *(arg1 + 0x3c)
            ...
            uint128_t zmm0_2
            zmm0_2.d = _mm_cvtepi32_ps(zx.o(*(rdx_5 + (rcx_5 << 1)))).d f* zmm1_2.d
            zmm0_2.d = zmm0_2.d f+ zmm2_1
            int32_t var_148_1 = zmm0_2.d
            zmm7 = (_mm_unpacklo_ps(zmm9, zmm3_1.q)).q:4.d
            zmm0_2.d = _mm_cvtepi32_ps(zx.o(*(rdx_5 + (rcx_5 << 1) + 2))).d f* zmm1_2.d
            zmm0_2.d = zmm0_2.d f+ zmm2_1
            ...
            zmm0_2.d = var_f8_1:4.d.d f* zmm2_1
            ...
            float (* var_258_1)[0x4] = &var_220
            int32_t var_f0_2 = zmm1_2.d
            uint64_t var_170
            uint64_t* var_268_1 = &var_170
            uint64_t var_1bc_1 = (_mm_unpacklo_ps(zmm6_1, zmm5_1)).q
            int64_t var_180
            int64_t* var_270_1 = &var_180
            zmm10.d = zmm10.d f* zmm4_1.d
            int32_t var_218_1 = 0
            zmm1_2.d = var_ec_1:4.d.d f* zmm2_1
            int64_t var_120[0x2]
            ...
            uint64_t zmm14_1
            int128_t zmm15_1
            rax_27, zmm6_2, zmm7_1, zmm11_1, zmm12_1, zmm13_1, zmm14_1, zmm15_1 = sub_1416238d0(
            ...
            int64_t var_160
            int64_t* var_270_2 = &var_160
            float (* var_278_2)[0x4] = &var_1e8
            var_1c8 = zmm7_1
            int64_t var_1bc_2 = zmm6_2
            ...
            bool rax_31
            int128_t zmm11_2
            rax_31, zmm11_2, zmm12, zmm13, zmm14, zmm15 = sub_1416238d0(&var_1c8, arg2, arg3, 
