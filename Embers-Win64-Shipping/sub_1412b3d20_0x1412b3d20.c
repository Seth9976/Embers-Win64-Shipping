...
if (data_143e8cb10 s> *rdi_1)
    _Init_thread_header(&data_143e8cb10)
    
    if (data_143e8cb10 == 0xffffffff)
        ...
        data_143e8cb08 = rax_9
        _Init_thread_footer(&data_143e8cb10)

if (data_143e8cb20 s> *rdi_1)
    _Init_thread_header(&data_143e8cb20)
    
    if (data_143e8cb20 == 0xffffffff)
        ...
        data_143e8cb18 = rax_12
        _Init_thread_footer(&data_143e8cb20)

if (data_143e8cb38 s> *rdi_1)
    _Init_thread_header(&data_143e8cb38)
    
    if (data_143e8cb38 == 0xffffffff)
        ...
        data_143e8cb28 = rax_15
        _Init_thread_footer(&data_143e8cb38)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8cb08
int64_t rcx
...
label_1412b3e23:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412b3e1e
        
        rbx.b = 1
        goto label_1412b3e23
