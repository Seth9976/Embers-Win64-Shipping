...
if (data_143e8b82c s> *rdi_1)
    _Init_thread_header(&data_143e8b82c)
    
    if (data_143e8b82c == 0xffffffff)
        ...
        data_143e8b820 = rax_12
        _Init_thread_footer(&data_143e8b82c)

if (data_143e8b848 s> *rdi_1)
    _Init_thread_header(&data_143e8b848)
    
    if (data_143e8b848 == 0xffffffff)
        ...
        data_143e8b840 = rax_15
        _Init_thread_footer(&data_143e8b848)

if (data_143e8b868 s> *rdi_1)
    _Init_thread_header(&data_143e8b868)
    
    if (data_143e8b868 == 0xffffffff)
        ...
        data_143e8b860 = rax_18
        _Init_thread_footer(&data_143e8b868)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b820
int64_t rcx
