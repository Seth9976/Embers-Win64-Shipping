...
label_14187e401:
    ...
    if (r8_5 s> 0 && (rax_23 == 0 || rax_23 s< rbp))
        ...
        arg4[0x20] = *(rax_27 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_29 = *(r9_3 + 8)
    ...
    label_14187e336:
        ...
        while (true)
            void* rdx_4 = sx.q(rbx_1) * 0x88 + *arg1
    ...
    if (rbx_1 == 0xffffffff)
        ...
        void* rdi_3 = sx.q(rbx_1) * 0x88 + *arg1
        sub_141866a80(rdi_3 + 0x10)
        memmove(rdi_3, arg4, 0x80)
        int64_t rcx_8 = sx.q(arg5)
        void* r10_2 = &arg1[2]
        
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0x88 + *arg1) = rcx_8.d
        
        int32_t* rax_13 = rcx_8 * 0x88 + *arg1
        *rax_13 = 0xffffffff
