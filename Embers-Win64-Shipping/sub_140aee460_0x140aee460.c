...
label_140aee5ff:
    ...
    if (r8_4 s> 0 && (rax_19 == 0 || rax_19 s< rbp))
        ...
        *(arg4 + 0x5c) = rax_22
        ...
        arg4[0xb].d = *(rax_23 + (((sx.q(arg1[9].d) - 1) & r8_5) << 2))
        void* rax_25 = *(r9_1 + 8)
    ...
    label_140aee527:
        ...
        while (true)
            ...
            rcx_1 = *arg1
            rbx_1 = *(rdi_2 + rcx_1 + 0x58)
            
            if (rbx_1 == 0xffffffff)
                goto label_140aee527
    ...
    if (rbx_1 == 0xffffffff)
        ...
        int64_t* rdi_5 = sx.q(rbx_1) * 0x60 + *arg1
        sub_140ae70e0(&rdi_5[2])
        int64_t rcx_4 = *rdi_5
        
        if (rcx_4 != 0)
            sub_140a74f90(rcx_4)
        
        memmove(rdi_5, arg4, 0x58)
