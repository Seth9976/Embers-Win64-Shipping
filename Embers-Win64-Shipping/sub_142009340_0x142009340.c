...
uint64_t result = sub_142008f10(arg1, arg2, arg3)

if (result.b != 0 && arg1[0x17].b == arg2[0x17].b && *(arg1 + 0xb9) == *(arg2 + 0xb9)
        && arg1[0x1a].b == arg2[0x1a].b && arg1[0x18] == arg2[0x18] && arg1[0x19] == arg2[0x19])
    if (arg1[0x15] != arg2[0x15])
        result, arg3 = sub_14200b1f0(&arg1[0x13], &arg2[0x13], 0x3f800000[0])
    
    if (arg1[0x15] == arg2[0x15] || result.b != 0)
        uint32_t zmm0_1[0x4] = arg1[0x16].d
        zmm0_1[0] = zmm0_1[0] f- arg2[0x16].d
        arg3.o = 0x7fffffff
        
        if (not(_mm_and_ps(zmm0_1, 0x7fffffff)[0] f> 9.99999994e-09f))
            zmm0_1 = *(arg1 + 0xb4)
            zmm0_1[0] = zmm0_1[0] f- *(arg2 + 0xb4)
            
            if (not(_mm_and_ps(zmm0_1, 0x7fffffff)[0] f> 9.99999994e-09f))
                arg3.o = zx.o(0)
                float zmm3[0x4] = *(arg2 + 0xd4)
                float temp0_3[0x4] = _mm_unpacklo_ps(arg1[0x1b].d, 0)
                float temp0_4[0x4] = _mm_unpacklo_ps(*(arg1 + 0xd4), (*(arg1 + 0xdc))[0].q)
                zmm0_1 = *(arg2 + 0xdc)
                float temp0_5[0x4] = _mm_unpacklo_ps(temp0_4, temp0_3[0].q)
                float temp0_6[0x4] = _mm_unpacklo_ps(arg2[0x1b].d, 0)
                float temp0_8[0x4] =
                    _mm_unpacklo_ps(_mm_unpacklo_ps(zmm3, zmm0_1[0].q), temp0_6[0].q)
                ...
                arg3.o ^= zmm8
                zmm0_1 = _mm_shuffle_ps(0x40400000, 0x40400000, 0)
