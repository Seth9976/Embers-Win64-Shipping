...
label_1405b7c46:
    ...
    if (r8_5 s> 0 && (rax_18 == 0 || rax_18 s< rbp))
        ...
        arg4[0x50] = *(rax_22 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_24 = *(r9_2 + 8)
    ...
    label_1405b7b56:
        ...
        while (true)
            int32_t* rcx_1 = sx.q(rbx_1) * 0x148
            
            if (*(rcx_1 + rdx_3) == *arg4 && *(rcx_1 + rdx_3 + 4) == arg4[1])
                break
            
            rbx_1 = *(rcx_1 + rdx_3 + 0x140)
            
            if (rbx_1 == 0xffffffff)
                goto label_1405b7b56
    ...
    if (rbx_1 == 0xffffffff)
        ...
        void* rdi_1 = sx.q(rbx_1) * 0x148 + *arg1
        sub_1405add40(rdi_1 + 0x128)
        int64_t rcx_3 = *(rdi_1 + 0x118)
        
        if (rcx_3 != 0)
            sub_140a74f90(rcx_3)
        
        int64_t rcx_4 = *(rdi_1 + 0xc8)
        
        if (rcx_4 != 0)
            sub_140a74f90(rcx_4)
        
        memmove(rdi_1, arg4, 0x140)
        int64_t rcx_6 = sx.q(arg5)
        void* r10_1 = &arg1[2]
        
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0x148 + *arg1) = rcx_6.d
        
        int32_t* rax_8 = rcx_6 * 0x148 + *arg1
        *rax_8 = 0xffffffff
