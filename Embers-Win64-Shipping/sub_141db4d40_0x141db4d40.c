...
while (true)
    ...
    if (rdx_9.d != (var_150:8.q u>> 0x20).d || var_120.q != rsi)
        rax_13.b = 0
    else
        rax_13.b = 1
...
if (rsi_4 != 0)
    do
        var_178.o = *arg3
        var_168.q = arg3[2]
        result = sub_141db4d40(*rdi_4, arg2, &var_178)
        r14 += 1
        rdi_4 += 8
    while (r14 != rsi_4)
