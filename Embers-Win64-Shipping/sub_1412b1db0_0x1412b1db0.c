...
if (data_143e8ca98 s> *rdi_1)
    _Init_thread_header(&data_143e8ca98)
    
    if (data_143e8ca98 == 0xffffffff)
        ...
        data_143e8ca90 = rax_9
        _Init_thread_footer(&data_143e8ca98)

if (data_143e8caa8 s> *rdi_1)
    _Init_thread_header(&data_143e8caa8)
    
    if (data_143e8caa8 == 0xffffffff)
        ...
        data_143e8caa0 = rax_12
        _Init_thread_footer(&data_143e8caa8)

if (data_143e8cac0 s> *rdi_1)
    _Init_thread_header(&data_143e8cac0)
    
    if (data_143e8cac0 == 0xffffffff)
        ...
        data_143e8cab0 = rax_15
        _Init_thread_footer(&data_143e8cac0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ca90
int64_t rcx
...
label_1412b1eb3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412b1eae
        
        rbx.b = 1
        goto label_1412b1eb3
