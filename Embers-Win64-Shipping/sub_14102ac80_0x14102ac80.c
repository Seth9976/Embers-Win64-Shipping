...
if (rdx != *(arg1 + 0x878) || rcx_4 != *(arg1 + 0x880) || rax_6 != *(arg1 + 0x884))
    *(arg1 + 0x880) = rcx_4
    *(arg1 + 0x878) = rdx
    *(arg1 + 0x884) = rax_6
...
sub_141037220(arg1 + 0x1c0, *(rdi + 0x80), 0x200, 0xffffffff)
void* rbx_1 = *(arg1 + 0x1c8)
int32_t rdx_3 = *(rbx_1 + 0x128)
int64_t* rcx_8 = *(rbx_1 + 0x30)

if (rdx_3 != 0)
    (*(*rcx_8 + 0xd0))(rcx_8, rdx_3, *(rbx_1 + 0x120))
    *(rbx_1 + 0x128) = 0
    rbx_1 = *(arg1 + 0x1c8)

int64_t* rcx_9 = *(rbx_1 + 0x30)
(*(*rcx_9 + 0x1d8))(rcx_9, *(*(*(arg1 + 0x138) + 0x20) + 0x420), 1, *(*(rdi + 0x80) + 0x20), 
    zx.q(*(rdi + 0x18) * arg4) + *(rdi + 0xc0), 0, 0)
return sub_14105c1a0(*(rdi + 0x80), arg1 + 0x1c0) __tailcall
