...
sub_141cd5500(arg1, &var_98, arg3)
int32_t var_70
int32_t r11 = var_70
int64_t var_88
...
while (true)
    ...
    sub_14090ab00(arg2, *rsi_3, 0, &var_d0, 0)
    int64_t rbx_1 = *rsi_3
    var_d0.q = rbx_1
    void* const rcx_10
    ...
    label_141cd17b1:
        ...
        int32_t var_cc
        int32_t rax_19 = sub_140b5ead0(rbx_1.d) + var_cc
        void* r8_3 = &arg2[7]
        void* rcx_8 = *(r8_3 + 8)
    ...
    *(r15_1 + 0x10) = rsi_3[3].d
    ...
    if (r15_1 + 0x18 != &rsi_3[4])
        ...
        sub_141ccfa60(r15_1 + 0x18, rsi_3[4], rsi_3[5].d, *(r15_1 + 0x24), 0)
    
    *(r15_1 + 0x28) = rsi_3[6].d
