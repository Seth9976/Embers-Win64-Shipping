...
if (data_143e8de10 s> *rdi_1)
    _Init_thread_header(&data_143e8de10)
    
    if (data_143e8de10 == 0xffffffff)
        ...
        data_143e8de08 = rax_12
        _Init_thread_footer(&data_143e8de10)

if (data_143e8de30 s> *rdi_1)
    _Init_thread_header(&data_143e8de30)
    
    if (data_143e8de30 == 0xffffffff)
        ...
        data_143e8de28 = rax_15
        _Init_thread_footer(&data_143e8de30)

if (data_143e8de50 s> *rdi_1)
    _Init_thread_header(&data_143e8de50)
    
    if (data_143e8de50 == 0xffffffff)
        ...
        data_143e8de48 = rax_18
        _Init_thread_footer(&data_143e8de50)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8de08
int64_t rcx
...
label_1412ad818:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412ad813
    
    rbx.b = 1
    goto label_1412ad818
