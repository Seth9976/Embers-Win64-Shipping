...
while (true)
    ...
    void* rbx_3 = result * 0xd8 + *rdx_7
    int64_t rdx_8 = *(rbx_3 + 0xc8)
    
    if (rdx_8 == 0)
        *arg4 += *(rbx_3 + 0xc0)
        sub_1421595f0(arg3, rbx_3 + 0x18)
        sub_1421595f0(arg3, rbx_3 + 0x68)
    else
        sub_1422c58e0(arg1, rdx_8, arg3, arg4, var_98, arg2 + 0x10, var_88_2)
