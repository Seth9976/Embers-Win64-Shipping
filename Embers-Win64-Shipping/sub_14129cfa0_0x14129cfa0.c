...
if (data_143e8d488 s> *rdi_1)
    _Init_thread_header(&data_143e8d488)
    
    if (data_143e8d488 == 0xffffffff)
        ...
        data_143e8d480 = rax_9
        _Init_thread_footer(&data_143e8d488)

if (data_143e8d4a8 s> *rdi_1)
    _Init_thread_header(&data_143e8d4a8)
    
    if (data_143e8d4a8 == 0xffffffff)
        ...
        data_143e8d4a0 = rax_12
        _Init_thread_footer(&data_143e8d4a8)

if (data_143e8d4c8 s> *rdi_1)
    _Init_thread_header(&data_143e8d4c8)
    
    if (data_143e8d4c8 == 0xffffffff)
        ...
        data_143e8d4c0 = rax_15
        _Init_thread_footer(&data_143e8d4c8)
...
if ((rbx_1 != 0 || (*(rdi_2 + (rbx << 2)) & 0xfffffffd) == 0) && sub_1410be3c0(arg1).b != 0)
