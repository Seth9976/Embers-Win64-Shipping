...
if (not(test_bit(arg5, 0x18)))
    rdi_1 = (&data_1439c85fc)[rsi * 0xa]
else
    rdi_1 = 0x57

int32_t rax_3 = sub_140fe7330(rdi_1, (arg5 u>> 4).b & 1)
int64_t i_1 = 4
int32_t r8 = 4
int32_t var_130 = 4
int32_t rcx_3 = rax_3
...
if ((rax_4 & 0x40) != 0)
    ...
    for (int32_t i = 0; i u< 4; )
        ...
        *rdi_3 = 0
        ...
        int32_t rax_29 = (*(*r14_1 + 0x50))(r14_1, var_138, &var_f8, rdi_3, var_168)
...
if ((rax_4 & 8) != 0)
    ...
    int32_t rax_39 = (*(*rbx_1 + 0x38))(rbx_1, var_138, &var_110, &var_d0, var_168)
...
if (result_1 == 0)
    ...
    *result = &data_142ef29a0
    int128_t* var_150_1 = &var_60
    int64_t* var_158_1 = &var_128
    result[0xc].d = r10_1
    int32_t var_8c
    *(result + 0x64) = var_8c
    sub_140fd9330(&result[0xd], arg1, var_138, r9_4, var_84, var_146, var_158_1, var_150_1)
    int32_t rcx_32 = *(result + 0xf4)
    *result = &data_142ef5b20
    result[0xd] = &data_142ef5b78
    result[0x1e].d = arg5
    *(result + 0xf4) = ((rcx_32 & 0xfffffffe) | zx.d(arg3)) & 0xfffffffd
...
if (rcx_40 != 0)
    int64_t rdx_15 = *rcx_40
    (*(rdx_15 + 0x10))(rcx_40, rdx_15)
