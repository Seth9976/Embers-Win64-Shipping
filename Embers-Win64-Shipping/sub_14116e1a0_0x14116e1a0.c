...
if (result != 0)
    ...
    char rax_22 = sub_1419bfd30(r13, r15_2, 0x230 << ((not.d(rcx_10)).b & (0x20 - rdx_10)))
    ...
    if (rcx_21.d s> 0)
        ...
        if (rcx_21.d s> 0)
            ...
            do
                var_328.q = u"PrimitiveUploadBuffer"
                sub_1419cff60(rax_28, r12_1, 0x230, 1, var_328)
                int64_t r9_4 = var_2e0
                int64_t r8_5 = 0
                int64_t var_2f8_1 = 0
                ...
                *rcx_31 = &data_142da7798
                zmm2_1, zmm3_1 =
                    sub_1419c02f0(arg2 + 0x1778, r13, arg2 + 0x1758, r9_4.b, zmm2_1, zmm3_1)
                rbx_2 += var_2e0
                rax_28 = arg2 + 0x1778
                r15_3 += r12_1
                var_304_1 = r15_3
    ...
    if (data_143e6a680 != 0 && (*(arg2 + 0x1750) u> 0 || *(arg2 + 0x1770) u> 0))
        ...
        char var_310_1 = 1
        var_2ec = 0
        (*(*rcx_50 + 0x510))(rcx_50, &data_143f02b98, r8_8, 0, 0, &var_2ec, 0, var_310_1, rax_22, 
            var_300, var_2f8, var_2f0_1, var_2e8_1, var_2e0, arg1)
        int64_t rcx_51 = sx.q(*(arg2 + 0xde0))
        int64_t rax_50
        int64_t rdx_22
        rdx_22:rax_50 = mulu.dp.q(-0x15f15f15f15f15f1, data_1439c7a80)
        uint32_t r8_9 = rcx_51.d
        uint32_t rdx_23 = (rdx_22 u>> 5).d
        
        if (rdx_23 u<= rcx_51.d)
            r8_9 = rdx_23
        ...
        var_320_1.b = 1
        var_328.b = 0
        (*(*rcx_53 + 0x518))(rcx_53, &data_143f02b98, *r15_2, 0, var_328, var_320_1)
    
    if (var_2e4_1 s> 0)
        if (var_2f0_1 s> 0)
            var_328.q = u"LightmapUploadBuffer"
            int64_t* r12_4 = arg2 + 0x1858
            sub_1419cff60(r12_4, var_2f0_1, 0xf0, 1, var_328)
                    ...
                    if (rax_55.d s< *(arg2 + 0xde0))
                        ...
                        if (var_288_1 s> 0)
                            ...
                            do
                                ...
                                zmm2_1, zmm3_1 =
                                    sub_1420f33b0(&var_278, *(rdx_28 + r14_6), *(arg2 + 8))
