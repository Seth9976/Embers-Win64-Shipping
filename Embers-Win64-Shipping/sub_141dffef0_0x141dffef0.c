...
int64_t rdi_1 = sx.q(*(rax_1 + (rcx << 2))) + *(r10 + 0x38)
...
label_141e001de:
    ...
    if (rsi != 1)
        ...
        zmm6.d = zmm6.d f/ _mm_cvtepi32_ps(zx.o(rax_20)).d
    else
        zmm6 = zx.o(0)
    ...
    int32_t rax_28 = zx.d(*(rcx_5 + rdi_1 + 2)) - 0x7fff
    zmm0.d = _mm_cvtepi32_ps(zx.o(zx.d(*(rcx_5 + rdi_1)) - 0x7fff)).d f* 0.00390636921f
    int32_t rax_30 = zx.d(*(rcx_5 + rdi_1 + 4)) - 0x7fff
    uint128_t zmm1 = _mm_cvtepi32_ps(zx.o(rax_28))
    int32_t rax_32 = zx.d(*(rdx_3 + rdi_1)) - 0x7fff
    zmm1.d = zmm1.d f* 0.00390636921f
    zmm3 = _mm_cvtepi32_ps(zx.o(rax_30))
    uint32_t rax_33 = zx.d(*(rdx_3 + rdi_1 + 2))
    zmm3.d = zmm3.d f* 0.00390636921f
    uint128_t zmm4
    zmm4.d = _mm_cvtepi32_ps(zx.o(rax_32)).d f* 0.00390636921f
    zmm4.d = zmm4.d f- zmm0.d
    result = zx.d(*(rdx_3 + rdi_1 + 4)) - 0x7fff
    zmm4.d = zmm4.d f* zmm6.d
    zmm2.d = _mm_cvtepi32_ps(zx.o(rax_33 - 0x7fff)).d f* 0.00390636921f
    zmm4.d = zmm4.d f+ zmm0.d
...
*(arg2 + 0x10) = _mm_unpacklo_ps(_mm_unpacklo_ps(zmm3, zmm0.q), zmm2.q)
return result
