...
if (var_80 != 0)
    ...
    if (rax_2 == 0 || r10_1 == 0)
        if (r14.d == r12_2)
            return (*(*arg5 + 8))(arg5, arg2, arg4)
        
        void* var_90 = nullptr
        uint128_t* var_70 = nullptr
        int64_t var_68_1 = 1
        int128_t var_60
        __builtin_memset(&var_60, 0, 0x11)
        sub_1405c4ec0(&var_70)
        uint128_t* rax_40 = var_70
        *rax_40 = *r13
        rax_40[1] = *(r13 + 0x10)
        rax_40[2].q = r13[4]
        int64_t var_48[0x2]
        result = sub_141b456a0(arg2, &var_70, &var_48, &var_90)
        void* rcx_26
        ...
        if (result.b != 0 && rcx_26 != 0)
            arg4[4].b = 0
            rax_29 = sub_141b45c70(*(rcx_26 + 0x10), rcx_26, zx.q((r14 + 1).d), arg4, arg5)
            rcx_17 = var_70
        label_141b45ed4:
    ...
    label_141b46064:
        ...
        if (((zx.q(*(*(r10_1 + 8) + 0x10)) u>> 0x10).b & 1) != 0)
            arg4[4].b = 0
            void* rcx_5 = *(sx.q(*(r10_1 + 0x4c)) + sx.q(*(r10_1 + 0x3c) * r15) + arg2)
            
            if (rcx_5 != 0)
                return sub_141b45c70(*(rcx_5 + 0x10), rcx_5, zx.q((r14 + 1).d), arg4, arg5)
        ...
        if (((rcx_7 u>> 0x1b).b & 1) == 0)
            if (((rcx_7 u>> 0x1d).b & 1) != 0)
                ...
                rax_29 = sub_141b45c70(result_1[1].q, result_1, zx.q((r14 + 1).d), arg4, arg5)
                rcx_17 = var_a0
                goto label_141b45ed4
            
            if (((rcx_7 u>> 0x14).b & 1) != 0)
                return sub_141b46090(*(r10_1 + 0x78), 
                    sx.q(*(r10_1 + 0x4c)) + sx.q(*(r10_1 + 0x3c) * r15) + arg2, (r14 + 1).d, arg4, 
                    arg5)
                ...
                if (r11_1 != 0 && ((zx.q((*(r11_1 + 8))[1].d) u>> 0x14).b & 1) != 0)
                    ...
                    if (r15 s>= 0)
                        ...
                        if (r15 s< result.d)
                            ...
                            return sub_141b46090(*(r11_1 + 0x78), rsi, (r14 + 1).d, arg4, arg5)
        else
            arg4[4].b = 0
            ...
            if (result != 0)
                return sub_141b45c70(result[1].q, result, zx.q((r14 + 1).d), arg4, arg5)
