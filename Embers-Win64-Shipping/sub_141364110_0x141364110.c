...
wchar16 const* const rcx_4 = u"PostProcessSunAlphaES2"
*(rsi + 0x30) = rax_12
wchar16 const i

do
    i = *rcx_4
    *(rbx_2 - u"PostProcessSunAlphaES2" + rcx_4) = i
    rcx_4 = &rcx_4[1]
while (i != 0)
...
if (sub_1410b7780(arg2, &var_1c8, zx.o(0), zmm3.o) f== *(*arg2 + 0x126c))
    zmm2_1, zmm6_2 = sub_1413452a0(arg2)
else
    zmm2_1, zmm6_2 = sub_141345090(arg2)

int64_t rax_19 = *(arg1 + 0xb8)
int64_t var_1d8_1 = rax_19
int32_t temp4
int32_t temp5
temp4:temp5 = sx.q(rax_19.d)
var_1d8_1.d = (temp5 + (temp4 & 3)) s>> 2
int32_t temp6
int32_t temp7
temp6:temp7 = sx.q(var_1d8_1:4.d)
var_1d8_1:4.d = (temp7 + (temp6 & 3)) s>> 2
void* r9 = sub_1419a2ec0(arg2[0xc], &var_1c8, &data_143ebb320, 0)
zmm2_1.o = zx.o(0)
zmm3.o = zx.o(0)
var_1c8.o = var_1c8.o
...
var_228.d = zmm2_1.d
zmm2_1.o = zx.o(0)
sub_1413993b0(arg2[8], zx.o(0), zmm2_1, r9, zmm3, var_228, zmm6_2, var_218, zmm3.d, var_208, 
