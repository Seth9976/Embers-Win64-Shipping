...
while (true)
    ...
    zmm4 = zx.o(*(rax_13 + 0x10))
    int32_t rax_14 = *(rax_13 + 0x18)
    zmm7 = var_288
    float temp0_10[0x4] = _mm_unpacklo_ps(_mm_shuffle_ps(zmm4, zmm4, 0x55), zmm10[0].q)
    float temp0_11[0x4] = _mm_unpacklo_ps(zmm4, rax_14[0].q)
    zmm4 = *arg3
    float temp0_12[0x4] = _mm_unpacklo_ps(temp0_11, temp0_10[0].q)
    float temp0_13[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xc9)
    float temp0_14[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xd2)
    float temp0_16[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_12, temp0_12, 0xc9), temp0_14)
    ...
    *(&var_1a8:4 + (sx.q(i_6) << 2)) = i_6
    ...
    int32_t i_7 = rdx.d + 1
    *(&var_178 + (rcx_5 << 2)) = (_mm_unpacklo_ps(zmm9, zmm8[0].q)).q
    (&var_170)[rcx_5] = var_1f0_1
    *(&var_148 + (rcx_5 << 2)) = (_mm_unpacklo_ps(temp0_30, temp0_32[0].q)).q
    (&var_140)[rcx_5] = var_1e0_1
    int64_t var_118
    *(&var_118 + (rcx_5 << 2)) = (_mm_unpacklo_ps(zmm9, zmm8[0].q)).q
    int32_t var_110
    (&var_110)[rcx_5] = zmm7[0]
    var_1a8.d = rdx.d + 1
    
    if (rdx.d == 0)
        int64_t rax_24 = sx.q(var_1a8:4.d)
        int64_t rcx_13 = rax_24 * 3
        var_188[rax_24] = 0x3f800000
        zmm0 = zx.o(*(&var_118 + (rcx_13 << 2)))
        var_2b8 = (&var_110)[rcx_13]
    else
        uint64_t* rax_21
        
        if (rdx.d == 1)
            rax_21 = sub_1416e69d0(&var_2a0, &var_118, &var_1a8:4, &var_1a8, &var_188)
        label_1416063af:
            zmm0 = zx.o(*rax_21)
            var_2b8 = rax_21[1].d
            i_7 = var_1a8.d
...
if (zmm13[0] <= zmm8[0])
    ...
    uint128_t zmm11_1
    uint128_t zmm12_1
    rax_35, zmm8_1, zmm10_1, zmm11_1, zmm12_1 = sub_1415721b0(&var_280, &var_2a0, &var_240, 
        &var_210, &var_2c8, &var_290, &var_270, &var_2c0)
    uint128_t zmm0_2
    uint128_t zmm1_1
    uint128_t zmm2_1
    uint128_t zmm3_1
    ...
    if (rax_35 == 2)
        ...
        if (i_6 s> 0)
            ...
            do
                ...
                zmm10_1[0] = zmm10_1[0] f+ zmm2_1.d
                i_1 = i_4
                i_4 -= 1
            while (i_1 != 1)
        ...
        *arg7 = var_290
        ...
        zmm11_1.d = zmm11_1.d f+ zmm10_1[0]
        *arg5 = (_mm_unpacklo_ps(zmm0_2, zmm1_1.q)).q
        ...
        zmm10_1[0] = zmm10_1[0] f- zmm12_1.d
        ...
        *arg4 = zmm0_2.d
        ...
        zmm1_1.d = zmm11_1.d f* arg7[1]
        zmm11_1.d = zmm11_1.d f* arg7[2]
        zmm0_2.d = zmm0_2.d f+ var_270
        zmm1_1.d = zmm1_1.d f+ var_26c
        zmm11_1.d = zmm11_1.d f+ var_268
        *arg5 = (_mm_unpacklo_ps(zmm0_2, zmm1_1.q)).q
        arg5[1].d = zmm11_1.d
        zmm0_2.d = zmm12_1.d f* *arg7
        zmm1_1.d = zmm12_1.d f* arg7[1]
        zmm12_1.d = zmm12_1.d f* arg7[2]
        zmm3_1.d = zmm3_1.d f- zmm0_2.d
        zmm2_1.d = var_2bc.d f- zmm1_1.d
        zmm0_2.d = var_2b8.d f- zmm12_1.d
    ...
    *arg7 = temp0_39.q
    ...
    float var_2a8_2 = zmm10[0]
    zmm12[0] = zmm12[0] - temp0_40[0]
    arg7[2] = var_2a8_2
    zmm0 = zmm11
    *arg4 = zmm12[0]
    zmm1 = zmm11
