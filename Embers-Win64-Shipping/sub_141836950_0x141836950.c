...
label_141836aa3:
    ...
    if (r8_5 s> 0 && (rax_23 == 0 || rax_23 s< rbp))
        ...
        arg4[9] = *(rax_27 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_29 = *(r9_3 + 8)
    ...
    label_141836a00:
        ...
        while (true)
            void* rdx_4 = sx.q(rbx_1) * 0x2c + *arg1
    ...
    if (rbx_1 == 0xffffffff)
        ...
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0x2c + *arg1) = rcx_8.d
        
        int32_t* rax_13 = rcx_8 * 0x2c + *arg1
        *rax_13 = 0xffffffff
