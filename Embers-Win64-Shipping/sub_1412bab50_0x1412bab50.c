...
if (data_143e8c710 s> *rdi_1)
    _Init_thread_header(&data_143e8c710)
    
    if (data_143e8c710 == 0xffffffff)
        ...
        data_143e8c708 = rax_12
        _Init_thread_footer(&data_143e8c710)

if (data_143e8c730 s> *rdi_1)
    _Init_thread_header(&data_143e8c730)
    
    if (data_143e8c730 == 0xffffffff)
        ...
        data_143e8c728 = rax_15
        _Init_thread_footer(&data_143e8c730)

if (data_143e8c750 s> *rdi_1)
    _Init_thread_header(&data_143e8c750)
    
    if (data_143e8c750 == 0xffffffff)
        ...
        data_143e8c748 = rax_18
        _Init_thread_footer(&data_143e8c750)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c708
int64_t rcx
...
label_1412bac48:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412bac43
    
    rbx.b = 1
    goto label_1412bac48
