...
while (true)
    int64_t* rdi_2 = sx.q(r15_1) * 0x30 + *rbx
    int64_t rbx_1 = *rdi_2
    int32_t rax_13 = sub_140b5ead0(rbx_1.d)
    int32_t r8_10 = ((rdi_2[3].d & 1) ^ (rax_13 + (rbx_1 u>> 0x20).d)) & (*r14 - 1)
    void* rax_16 = arg1 + 0x38
    *(rdi_2 + 0x2c) = r8_10
    void* rdx_6 = *(arg1 + 0x40)
    int64_t r9_3 = sx.q(r8_10)
    
    if (rdx_6 != 0)
        rax_16 = rdx_6
    
    rdi_2[5].d = *(rax_16 + (((sx.q(*r14) - 1) & r9_3) << 2))
    ...
    *(rax_18 + (((sx.q(*r14) - 1) & r9_3) << 2)) = r15_1
