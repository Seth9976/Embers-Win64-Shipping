...
if (data_143e8a890 s> *rdi_1)
    _Init_thread_header(&data_143e8a890)
    
    if (data_143e8a890 == 0xffffffff)
        ...
        data_143e8a888 = rax_12
        _Init_thread_footer(&data_143e8a890)

if (data_143e8a8a0 s> *rdi_1)
    _Init_thread_header(&data_143e8a8a0)
    
    if (data_143e8a8a0 == 0xffffffff)
        ...
        data_143e8a898 = rax_15
        _Init_thread_footer(&data_143e8a8a0)

if (data_143e8a8b0 s> *rdi_1)
    _Init_thread_header(&data_143e8a8b0)
    
    if (data_143e8a8b0 == 0xffffffff)
        ...
        data_143e8a8a8 = rax_18
        _Init_thread_footer(&data_143e8a8b0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8a888
int64_t rcx
