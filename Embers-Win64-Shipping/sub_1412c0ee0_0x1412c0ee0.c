...
if (data_143e8b798 s> *rdi_1)
    _Init_thread_header(&data_143e8b798)
    
    if (data_143e8b798 == 0xffffffff)
        ...
        data_143e8b790 = rax_12
        _Init_thread_footer(&data_143e8b798)

if (data_143e8b7b8 s> *rdi_1)
    _Init_thread_header(&data_143e8b7b8)
    
    if (data_143e8b7b8 == 0xffffffff)
        ...
        data_143e8b7b0 = rax_15
        _Init_thread_footer(&data_143e8b7b8)

if (data_143e8b7d8 s> *rdi_1)
    _Init_thread_header(&data_143e8b7d8)
    
    if (data_143e8b7d8 == 0xffffffff)
        ...
        data_143e8b7d0 = rax_18
        _Init_thread_footer(&data_143e8b7d8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b790
int64_t rcx
...
label_1412c0fd8:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412c0fd3
    
    rbx.b = 1
    goto label_1412c0fd8
