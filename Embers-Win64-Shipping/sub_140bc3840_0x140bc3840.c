...
int128_t var_78 = (&data_1439a98b0).o
...
while (true)
    ...
    if (rax_11.d == ((0xffffffff << (r10.b & 0x1f)).q u>> 0x20).d && var_68.q == &data_1439a98c0
        ...
        return sub_1405b8890(&data_1439a98b0, 0) __tailcall
    
    int64_t* r14_1 = *(*rdx_5 + rax_11 * 0x18 + 8)
    
    if (r14_1 != 0)
        int32_t i_1 = r14_1[1].d
        void* rcx_5 = *r14_1
