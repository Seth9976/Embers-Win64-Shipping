...
if (data_143e8b558 s> *rdi_1)
    _Init_thread_header(&data_143e8b558)
    
    if (data_143e8b558 == 0xffffffff)
        ...
        data_143e8b550 = rax_9
        _Init_thread_footer(&data_143e8b558)

if (data_143e8b568 s> *rdi_1)
    _Init_thread_header(&data_143e8b568)
    
    if (data_143e8b568 == 0xffffffff)
        ...
        data_143e8b560 = rax_12
        _Init_thread_footer(&data_143e8b568)

if (data_143e8b578 s> *rdi_1)
    _Init_thread_header(&data_143e8b578)
    
    if (data_143e8b578 == 0xffffffff)
        ...
        data_143e8b570 = rax_15
        _Init_thread_footer(&data_143e8b578)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b550
int64_t rcx
...
label_1412be363:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412be35e
        
        rbx.b = 1
        goto label_1412be363
