...
if (data_143e8e830 s> *rdi_1)
    _Init_thread_header(&data_143e8e830)
    
    if (data_143e8e830 == 0xffffffff)
        ...
        data_143e8e828 = rax_12
        _Init_thread_footer(&data_143e8e830)

if (data_143e8e840 s> *rdi_1)
    _Init_thread_header(&data_143e8e840)
    
    if (data_143e8e840 == 0xffffffff)
        ...
        data_143e8e838 = rax_15
        _Init_thread_footer(&data_143e8e840)

if (data_143e8e970 s> *rdi_1)
    _Init_thread_header(&data_143e8e970)
    
    if (data_143e8e970 == 0xffffffff)
        ...
        data_143e8e848 = rax_18
        _Init_thread_footer(&data_143e8e970)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e828
int64_t rcx
...
label_1412a93f8:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412a93f3
    
    rbx.b = 1
    goto label_1412a93f8
