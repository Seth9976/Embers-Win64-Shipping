...
if (data_143e8aef0 s> *rdi_1)
    _Init_thread_header(&data_143e8aef0)
    
    if (data_143e8aef0 == 0xffffffff)
        ...
        data_143e8aee8 = rax_12
        _Init_thread_footer(&data_143e8aef0)

if (data_143e8af00 s> *rdi_1)
    _Init_thread_header(&data_143e8af00)
    
    if (data_143e8af00 == 0xffffffff)
        ...
        data_143e8aef8 = rax_15
        _Init_thread_footer(&data_143e8af00)

if (data_143e8af10 s> *rdi_1)
    _Init_thread_header(&data_143e8af10)
    
    if (data_143e8af10 == 0xffffffff)
        ...
        data_143e8af08 = rax_18
        _Init_thread_footer(&data_143e8af10)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8aee8
int64_t rcx
