...
if (data_143e8e530 s> *rdi_1)
    _Init_thread_header(&data_143e8e530)
    
    if (data_143e8e530 == 0xffffffff)
        ...
        data_143e8e528 = rax_12
        _Init_thread_footer(&data_143e8e530)

if (data_143e8e540 s> *rdi_1)
    _Init_thread_header(&data_143e8e540)
    
    if (data_143e8e540 == 0xffffffff)
        ...
        data_143e8e538 = rax_15
        _Init_thread_footer(&data_143e8e540)

if (data_143e8e550 s> *rdi_1)
    _Init_thread_header(&data_143e8e550)
    
    if (data_143e8e550 == 0xffffffff)
        ...
        data_143e8e548 = rax_18
        _Init_thread_footer(&data_143e8e550)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e528
int64_t rcx
