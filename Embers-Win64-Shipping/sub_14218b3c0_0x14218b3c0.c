...
if (sub_140d23dc0(arg1, 0x30) != 1)
    ...
    if (rcx_6 s> 0)
        ...
        do
            int64_t* r14_1 = *(arg1[0xc0] + (rbp_1 << 3))
            ...
            if (r14_1 != 0)
                if ((r14_1[0x1c].b & 2) == 0)
                    ...
                    if (rcx_6 s> 0)
                        do
                            if (rdi != rbp_1)
                                int64_t* rcx_7 = *(arg1[0xc0] + (rdi << 3))
                                
                                if (rcx_7 != 0)
                                    (*(*rcx_7 + 0x170))(rcx_7, r14_1)
        ...
        if (rdi.b != 0)
            ...
            int64_t rcx_11 = arg1[0x7d]
            
            if (rcx_11 != 0)
                sub_142208350(rcx_11)
