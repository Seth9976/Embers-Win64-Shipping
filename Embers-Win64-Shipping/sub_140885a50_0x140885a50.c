...
if (r10 != 0)
    ...
    label_140885aea:
        ...
        while (true)
            ...
            if (rcx != 0)
                goto label_140885aea
        
        var_54.d = r10

uint64_t* rdx_2 = arg1
uint64_t* var_48 = rdx_2
...
if (0 s< r10)
    ...
    while (true)
        int64_t rbx_3 = (sx.q(rcx_3) << 7) + *rdx_2
        sub_140a1d5c0(rbx_3 + 0x50)
        void* rbx_4 = *(rbx_3 + 0x28)
        
        if ((rbx_4.b & 1) != 0)
            rbx_4 = &(rbx_3 + 0x28)[rbx_4 s>> 1]
        
        int32_t i_1 = *(rbx_3 + 0x30)
