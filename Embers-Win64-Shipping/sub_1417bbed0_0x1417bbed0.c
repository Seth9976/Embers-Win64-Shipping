...
uint64_t rcx = zx.q(*(r9 + (r10 << 1) + 2)) * 3
int128_t zmm6
...
uint64_t rcx_1 = zx.q(*(r9 + (r10 << 1) + 4)) * 3
uint128_t zmm3
...
void** var_a8
sub_141703c00(&var_a8, rdx_2, &var_128, zx.o(0))
...
if (sub_141672db0(&var_f8, &var_a8, &arg1[0xe], &arg1[0xb], zmm1_1, &arg_8, &var_d0, &var_c0, 
