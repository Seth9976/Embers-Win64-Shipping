...
if (data_143e8df10 s> *rdi_1)
    _Init_thread_header(&data_143e8df10)
    
    if (data_143e8df10 == 0xffffffff)
        ...
        data_143e8df08 = rax_9
        _Init_thread_footer(&data_143e8df10)

if (data_143e8df30 s> *rdi_1)
    _Init_thread_header(&data_143e8df30)
    
    if (data_143e8df30 == 0xffffffff)
        ...
        data_143e8df28 = rax_12
        _Init_thread_footer(&data_143e8df30)

if (data_143e8df50 s> *rdi_1)
    _Init_thread_header(&data_143e8df50)
    
    if (data_143e8df50 == 0xffffffff)
        ...
        data_143e8df48 = rax_15
        _Init_thread_footer(&data_143e8df50)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8df08
int64_t rcx
...
label_1412ac5c3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412ac5be
        
        rbx.b = 1
        goto label_1412ac5c3
