...
if (result.d s<= 0 && *(arg1 + 0x150) s<= 0 && *(arg1 + 0x1d0) s<= 0 && *(arg1 + 0x250) s<= 0)
    *(arg1 + 0x40) = 0
...
if (cond:2)
    ...
    result = sub_141f89220(arg1 + 0x1d8, &var_28)
    zmm1 = *(arg1 + 0x40)
    zmm0 = *(result + 4)

bool cond:3 = *(arg1 + 0xd0) s<= 0
float temp0_3[0x4] = _mm_min_ss(zmm1[0], zmm0[0])
*(arg1 + 0x44) = 0x800000
*(arg1 + 0x40) = temp0_3[0]
float zmm2[0x4]
...
if (cond:6)
    ...
    result = sub_141f89d50(arg1 + 0x1d8, &var_28)
    zmm0 = *(arg1 + 0x44)
    zmm2 = *(result + 4)

zmm1 = 0x3f800000
float temp0_7[0x4] = _mm_max_ss(zmm2[0], zmm0[0])
temp0_7[0] = temp0_7[0] f- *(arg1 + 0x40)
*(arg1 + 0x44) = temp0_7[0]
zmm1[0] = 1f / temp0_7[0]
*(arg1 + 0x48) = zmm1[0]
return result
