...
if (arg1 != arg2)
    ...
    while (true)
        ...
        if (rax_20.d == (var_68_3.q u>> 0x20).d && var_50:8.q == &arg1[2] && r9_2 == arg1)
            break
        
        sub_140bd6610((rax_20 << 5) + 8 + *r9_2)
