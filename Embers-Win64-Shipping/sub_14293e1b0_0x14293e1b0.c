...
int32_t zmm7[0x4] = data_14353e010
...
for (int32_t i = 0; i u< 0x10; )
    int32_t rax_34 = i + 4
    rcx = &rcx[8]
    zmm1 = _mm_cmpeq_epi32(_mm_add_epi32(_mm_shuffle_epi32(zx.o(i), 0), zmm9), zmm8)
    i += 8
    uint128_t zmm2 = _mm_add_epi32((zmm1 & not.o(zmm6)) | (zmm7 & zmm1), *(rcx - 0x20))
    int32_t temp0_7[0x4] =
        _mm_cmpeq_epi32(_mm_add_epi32(_mm_shuffle_epi32(zx.o(rax_34), 0), zmm9), zmm8)
    *(rcx - 0x20) = zmm2
    *(rcx - 0x10) = _mm_add_epi32((temp0_7 & not.o(zmm6)) | (temp0_7 & zmm7), *(rcx - 0x10))

sub_14293f960(&var_148)
int32_t var_108
sub_14296dcf0(&var_108, arg2, &var_148)
...
sub_14296dcf0(&arg1[0x10], arg2 + 0x40, &var_148)
...
int32_t var_d8
int32_t var_98 = r15 + var_d8
int32_t var_118_2 = r15 - var_d8
int32_t var_d4
int32_t var_94 = rsi_1 + var_d4
int32_t var_114_2 = rsi_1 - var_d4
int32_t var_d0
int32_t var_90 = r11 + var_d0
...
do
    ...
    rcx_6 += 0x20
    int32_t temp0_10[0x4] = _mm_add_epi32(_mm_shuffle_epi32(zx.o(i_1), 0), zmm9)
    i_1 += 8
    int32_t temp0_11[0x4] = _mm_cmpeq_epi32(temp0_10, zmm8)
    zmm1 = _mm_add_epi32((temp0_11 & zmm7) | (temp0_11 & not.o(zmm6)), *(rcx_6 - 0x20))
    int32_t temp0_15[0x4] =
        _mm_cmpeq_epi32(_mm_add_epi32(_mm_shuffle_epi32(zx.o(rax_116), 0), zmm9), zmm8)
    *(rcx_6 - 0x20) = zmm1
    *(rcx_6 - 0x10) = _mm_add_epi32((temp0_15 & zmm7) | (temp0_15 & not.o(zmm6)), *(rcx_6 - 0x10))
while (i_1 u< 0x10)

sub_14293f960(&var_148)
sub_14293f8c0(&arg1[0x10], &arg1[0x20], arg1)
sub_14293f610(&arg1[0x10], 2)
sub_14293f960(&arg1[0x10])
