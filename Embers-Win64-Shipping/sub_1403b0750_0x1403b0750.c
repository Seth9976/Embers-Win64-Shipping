...
do
    zmm4 = *(arg1 - 2)
    result = __pmaddubsw_xmmdq_memdq(*(arg1 - 3), temp0_5)
    ...
    int32_t temp0_19[0x4] = _mm_adds_epi16(_mm_adds_epi16(result, zmm2), _mm_adds_epi16(zmm1, zmm3))
    ...
    result = _mm_srai_epi16(temp0_23, 7)
    int16_t temp0_26[0x8] = _mm_srai_epi16(zmm4, 7)
    result = __pavgb_xmmdq_memdq(
        _mm_unpacklo_epi8(_mm_packus_epi16(result, result), 
            _mm_packus_epi16(temp0_26, temp0_26)[0].q), 
        *arg3)
    arg1 += arg2
    *arg3 = result
    arg3 = &(*arg3)[arg4]
