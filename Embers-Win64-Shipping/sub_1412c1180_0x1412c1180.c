...
if (data_143e8b618 s> *rdi_1)
    _Init_thread_header(&data_143e8b618)
    
    if (data_143e8b618 == 0xffffffff)
        ...
        data_143e8b610 = rax_12
        _Init_thread_footer(&data_143e8b618)

if (data_143e8b628 s> *rdi_1)
    _Init_thread_header(&data_143e8b628)
    
    if (data_143e8b628 == 0xffffffff)
        ...
        data_143e8b620 = rax_15
        _Init_thread_footer(&data_143e8b628)

if (data_143e8b638 s> *rdi_1)
    _Init_thread_header(&data_143e8b638)
    
    if (data_143e8b638 == 0xffffffff)
        ...
        data_143e8b630 = rax_18
        _Init_thread_footer(&data_143e8b638)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b610
int64_t rcx
...
label_1412c1278:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412c1273
    
    rbx.b = 1
    goto label_1412c1278
