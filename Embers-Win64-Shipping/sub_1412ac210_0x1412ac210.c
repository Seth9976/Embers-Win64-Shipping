...
if (data_143e8e110 s> *rdi_1)
    _Init_thread_header(&data_143e8e110)
    
    if (data_143e8e110 == 0xffffffff)
        ...
        data_143e8e108 = rax_9
        _Init_thread_footer(&data_143e8e110)

if (data_143e8e130 s> *rdi_1)
    _Init_thread_header(&data_143e8e130)
    
    if (data_143e8e130 == 0xffffffff)
        ...
        data_143e8e128 = rax_12
        _Init_thread_footer(&data_143e8e130)

if (data_143e8e150 s> *rdi_1)
    _Init_thread_header(&data_143e8e150)
    
    if (data_143e8e150 == 0xffffffff)
        ...
        data_143e8e148 = rax_15
        _Init_thread_footer(&data_143e8e150)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8e108
int64_t rcx
...
label_1412ac313:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412ac30e
        
        rbx.b = 1
        goto label_1412ac313
