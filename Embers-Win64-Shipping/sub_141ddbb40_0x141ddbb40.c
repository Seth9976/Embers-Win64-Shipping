...
while (true)
    ...
    int64_t* rax_20 = result_1.q
    
    if (rcx_7.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0x68 && rax_20 == arg1 + 0x58)
        return result
    
    sub_142378680((rcx_7 << 5) + *rax_20 + 4, arg2.d)
