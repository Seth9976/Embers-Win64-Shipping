...
if (rax == 0)
    ...
    if (data_143e7b178
        ...
        _Init_thread_header(&data_143e7b178)
        
        if (data_143e7b178 == 0xffffffff)
            int64_t (* i)(int64_t arg1, int64_t* arg2) = sub_1411fd530
            var_48 = nullptr
            int32_t var_40_2 = 0
            ...
            int32_t var_68_1 = 0x110
            sub_1419c2220(&data_143e7b0e0, 0, FHairDeepShadowRasterPassParameters", 
                FHairDeepShadowRasterPassParameters", 0, nullptr)
            int128_t* rcx_7 = var_48
            
            if (rcx_7 != 0)
                sub_140a74f90(rcx_7)
            
            atexit(&data_142cd6f90)
            _Init_thread_footer(&data_143e7b178)
    
    var_48 = arg3
    void* var_40_1 = &data_143e7b110
    var_48.o = var_48.o
