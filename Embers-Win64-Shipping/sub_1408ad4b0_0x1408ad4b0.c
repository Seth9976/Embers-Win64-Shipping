...
if (r10 == 0)
    ...
    zmm6[0] = zmm6[0] f* arg7[2]
    var_b8 = zmm6[0]
    uint32_t var_b4_4 = zmm6[0]
    uint32_t var_b0_4 = zmm6[0]
    uint32_t zmm0_2[0x4]
    zmm0_2, zmm6, zmm7, zmm8 = sub_1408b32e0(&arg6, &var_b8)
    zmm10 = zmm0_2
    zmm12 = 0x3f800000
    zmm13 = 0x3f800000
    result = zx.q(*arg5)
    ...
    zmm7[0] = zmm7[0] f* arg7[1]
    zmm7[0] = zmm7[0] f* arg7[2]
    var_b8 = zmm7[0]
    uint32_t var_b4_2 = zmm7[0]
    uint32_t var_b0_2 = zmm7[0]
    uint32_t zmm0_1[0x4]
    int32_t zmm15_1
    zmm0_1, zmm7, zmm10, zmm11, zmm15_1 = sub_1408b32e0(&arg6, &var_b8)
    ...
    int32_t rcx = *arg1
    var_b8 = zmm1 f* *arg7
    int32_t var_b4_1 = zmm1 f* arg7[1]
    float var_b0_1 = zmm1 * arg7[2]
    return sub_1408b3af0(rcx, arg3, arg4, arg5, &var_b8)
return result
