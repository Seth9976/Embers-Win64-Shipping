...
if (r10 != 0)
    ...
    label_141e3d41a:
        ...
        while (true)
            ...
            if (rcx != 0)
                goto label_141e3d41a
        
        var_64.d = r10

uint64_t* rdx_2 = arg1
uint64_t* var_58 = rdx_2
...
if (0 s< r10)
    ...
    while (true)
        int64_t rsi_3 = (sx.q(rcx_3) << 7) + *rdx_2
        *(rsi_3 + 0x70) = 0
        int64_t rcx_4 = *(rsi_3 + 0x68)
        
        if (rcx_4 != 0)
            sub_140a74f90(rcx_4)
        
        sub_1417eaf00(rsi_3 + 0x28)
        int32_t i_1 = *(rsi_3 + 0x20)
        void* rcx_6 = *(rsi_3 + 0x18)
