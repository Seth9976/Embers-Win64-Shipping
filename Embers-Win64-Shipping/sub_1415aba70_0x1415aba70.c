...
rax_3, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13_1, zmm14 =
    sub_1416d1150(arg1, arg2, arg3, arg4, var_248)
int32_t rdi_1
...
if (rax_3 != 0)
    ...
    label_1415ac4cc:
        zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm14_1, zmm15 =
            sub_14154a2a0(*arg1, *arg2, &var_128, var_170, arg7, var_180, arg9)
        rdi_1 = 1
    else
        zmm8 = 0x7fffffff
        zmm14 = 0x322bcc77
            ...
            if (rdx_5 s< 0x80)
                ...
                label_1415ac47c:
                    ...
                    if (_mm_and_ps(temp0_29, zmm8)[0] <= zmm0_1[0])
                        zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm14_1, zmm15 =
                            sub_14154a2a0(*r14, *r15, rsi_5, var_170, arg7, var_180, arg9)
                        rsi_1 = var_220
                        rdi_1 = 0
                        break
                    ...
                    if (not(zmm13_1 < zmm12[0]))
                        ...
                        *(rcx_18 + (rdx_13 << 2) + 8) = var_198_1
                        ...
                        if (r8_10 s>= 3)
                                ...
                                do
                                    ...
                                    *(r10_8 + (rdi_3 << 2) + 0x28) = 0
                                    ...
                                    if (not(zmm0_1[0] < zmm12[0]) && not(zmm0_1[0] > zmm13_1))
                                        char rax_60
                                        rax_60, zmm12, zmm13_1, zmm14, arg5 =
                            ...
                            r12 = var_218_1:4.d
                            goto label_1415ac47c
            
        label_1415ac495:
            rsi_1 = var_220
            goto label_1415ac4cc
