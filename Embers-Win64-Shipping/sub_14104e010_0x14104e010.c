...
uint32_t r11 = r10
uint32_t rax_8 = *(arg1 + 0x60) u>> arg3.b
uint32_t rcx_3 = r8
...
int32_t r12_3 =
    (divu.dp.d(0:(r8 - 1 + rcx_3), r8) * (&data_1439c85f4)[rax_6 * 0xa] + 0xff) & 0xffffff00
int32_t rax_15 = divu.dp.d(0:(r10 - 1 + r11), r10) * r12_3
void* rcx_5 = *(arg1 + 0x78)
void** var_178 = **(var_1e0 + 0x6d8) + 0x1c0
int64_t result_1 = 0
int64_t* rax_19 = sub_141023a10(rcx_5)
int64_t result

if ((*(*rax_19 + 0x758))(rax_19, &result_1, zx.q(var_1e8), zx.q(var_1d0), *(arg1 + 0x40), arg5, 
        arg1 + 0x210, rbx_1, arg6) != 0)
    sub_14103b0d0(arg1 + 0x1b0, &var_1bc, &var_128)
    result = result_1
else
    if (arg5 != 1)
        rdi[0xf].d |= 2
        void* rax_22 = *(arg1 + 0xc8)
        uint64_t rbx_3 = zx.q(rax_15)
        int32_t* var_1f8
        var_1f8.b = 1
        int64_t var_13c_1 = 1
        int32_t var_168_1 = 1
        ...
        int32_t var_150_1 = 1
        int32_t var_1a4_1 = rax_24
        int32_t var_90_1 = rax_24
        int64_t var_144_1 = 1
        ...
        int32_t rax_25 = sub_141048420(rcx_10, &var_88, r8_2, &var_a0, var_218, var_210, var_208_1, 
            var_200_1, var_1f8.b)
        ...
        uint32_t var_1a8_2 = r11
        var_1b0:4.d = rcx_3
        int32_t var_1a4_2 = 1
        int32_t var_104_1 = 0
        int64_t var_120_1 = 0
        var_1b0.d = *(rax_22 + 0xa8)
        ...
        sub_141042be0(&var_1b0)
        sub_141022330(**(var_1e0 + 0x6d8), &var_178, 1)
        var_178 = &data_142efcd90
        int64_t* var_170
        
        if (var_170 != 0)
            int32_t rax_34 = *(var_170 + 0x14)
            *(var_170 + 0x14) -= 1
            
            if (rax_34 == 1 && var_170 != 0)
                sub_14100eba0(var_170)
                j_sub_140a74f90(var_170)
        
        *(rdi + 0x74) = r12_3
        *arg6 = r12_3
        goto label_14104e4c1
    
    result = sub_1410130c0(var_1e0 + 0x7c0, (rax_15 + 0x1ff) & 0xfffffe00, 0x200, &rdi[1])
