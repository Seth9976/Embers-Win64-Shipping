    ...
    do
        ...
        if (rsi_1 s< arg2)
            do
                ...
                if ((r8_1 + 1).d s< arg2)
                    if (*(arg1 + sx.q(r11_1) * 0x18 + 0x42) u> *(arg1 + sx.q(r8_1.d) * 0x18 + 0x12))
                        r8_1 = zx.q(r11_1)
                ...
                result = zx.q(*(rdx_2 + 0x12))
                int128_t* r10_2 = arg1 + (rcx_2 << 3)
                
                if (*(arg1 + (rcx_2 << 3) + 0x12) u<= result.w)
                    break
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if ((result + 1).d s< i)
                    if (*(arg1 + sx.q(result_1) * 0x18 + 0x42)
                            u> *(arg1 + sx.q(result.d) * 0x18 + 0x12))
                ...
                if (*(arg1 + (rdx_5 << 3) + 0x12) u<= *(r8_3 + 0x12))
                    break
