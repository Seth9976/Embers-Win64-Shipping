...
float* rax_2
int512_t zmm15
rax_2, zmm15 = sub_141716230(rcx_2, &var_d8, &var_c8)
zmm15.o = zx.o(*rax_2)
float r14 = rax_2[2]
float* rax_3
float zmm6_1
...
float zmm14_1
uint128_t zmm15_1
rax_3, zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_2, zmm12_1, zmm13_1, zmm14_1, zmm15_1 =
    sub_141716230(rcx_2, &var_c8, arg2)
...
zmm12_1 = (zmm12_1 f- _mm_shuffle_ps(zmm15_1, zmm15_1, 0x55).d) f* *(arg2 + 4)
int64_t rdi_1 = sx.q(rbx_2[1].d)
int32_t rax_4 = (rdi_1 + 1).d
rbx_2[1].d = rax_4
int64_t result

if (zmm8_1 * zmm11_2 + (zmm7_1 f- zmm1_2.d) * zmm14_1 + (zmm6_1 - r15) * zmm13_1
        < zmm12_1 + zmm10_1 + zmm9_1)
    if (rax_4 s> *(rbx_2 + 0xc))
        sub_14083a7e0(rbx_2)
    
    int64_t rcx_8 = *rbx_2
    int64_t rdx_8 = rdi_1 * 3
    *(rcx_8 + (rdx_8 << 2)) = var_e8.q
    *(rcx_8 + (rdx_8 << 2) + 8) = zmm9
    ...
    *(rcx_4 + (rdx_5 << 2)) = var_f8.q
    *(rcx_4 + (rdx_5 << 2) + 8) = zmm6
