...
while (true)
    ...
    int32_t rcx_10 = ((r10_4[1].d << 8 ^ *(r10_4 + 0xc)) << 8 ^ r8_14 u>> 0xf
        ^ (rdx_11 - r8_14 - r9_10)) & (*rsi - 1)
    void* rax_30 = arg1 + 0x38
    *(r10_4 + 0x1c) = rcx_10
    void* rdx_14 = *(arg1 + 0x40)
    int64_t r8_15 = sx.q(rcx_10)
    
    if (rdx_14 != 0)
        rax_30 = rdx_14
    
    r10_4[3].d = *(rax_30 + (((sx.q(*rsi) - 1) & r8_15) << 2))
    ...
    *(rax_32 + (((sx.q(*rsi) - 1) & r8_15) << 2)) = r11_1
