...
rax_3, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13, zmm14, zmm15 =
    sub_1416b3860(arg1, arg2, arg3, arg4, var_258)
int32_t rsi_1
        ...
        while (true)
            if (rdx_5 s< 0x80)
                ...
                label_1415886b1:
                    ...
                    float var_1a0_1 = zmm13[0]
                    
                    if (zmm1_1[0] f<= rdi_5[4])
                        zmm14 = rax_22[1].d
                    else
                        zmm14 = *(rax_22 + 4)
                    
                    int32_t var_19c_1 = zmm14.d
                    
                    if (zmm1_1[0] f<= rdi_5[5])
                        zmm15 = *(rax_22 + 0x14)
                    else
                        zmm15 = *(rax_22 + 8)
                    
                    float zmm4_1[0x4] = rdi_5[4] ^ zmm2_1
                    ...
                    zmm13[0] = zmm13[0] f* rdi_5[3]
                    float var_18c_1 = temp0_26[0]
                    zmm12[0] = zmm12[0] * 0.00999999978f
                    int32_t var_1ec_1 = zmm14.d
                    zmm14.d = zmm14.d f* rdi_5[4]
                    ...
                    if (not(zmm13[0] < zmm12[0]))
                        ...
                        *(rcx_17 + (rdx_12 << 2) + 8) = var_188_1
                        ...
                        if (r8_10 s>= 3)
                                ...
                                do
                                    ...
                                    *(r10_8 + (r14_2 << 2) + 0x28) = 0
                                    ...
                                    if (not(zmm0_1[0] < zmm12[0]) && not(zmm0_1[0] > zmm13[0]))
                                        char rax_57
                                        rax_57, zmm12, zmm13 = sub_141743d50(r9_5, *r14, *r15)
                            ...
                            zmm2_1 = 0x80000000
                            r13 = var_228_1:4.d
                            goto label_1415886b1
            
        label_1415886ca:
            rdi_1 = var_230
            goto label_141588701
