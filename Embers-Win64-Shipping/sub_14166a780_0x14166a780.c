...
double zmm10_1[0x2]
float zmm11_1[0x4]
rax_5, zmm6_1, zmm9_1, zmm10_1, zmm11_1 = sub_14170eae0(&var_218, &var_30c, &var_328)
...
if (rdi.b == 0)
    while (true)
        ...
        if (rax_6 s>= 0x20)
            ...
            float var_1bc
            float* rax_9
            rax_9, zmm6_1, zmm7, zmm8, zmm9_1, zmm10_1, zmm11_1, zmm12, zmm13 =
                sub_14170eae0(&var_218, &var_1bc, &var_2c8)
            zmm4 = zmm12
            zmm1_1 = zx.o(*rax_9)
            ...
            zmm0_1 = zmm7
            zmm7 = var_2a8_1
            zmm4[0].d = zmm4[0].d f* temp0_11[0]
            ...
            *(&var_100 + (rcx_6 << 2)) = zmm1_1.q
            ...
            label_14166aede:
                ...
                if (r14.b != 0 && not(zmm4[0].d f< zmm9_1[0].d))
                    ...
                    rdi.b = zmm4[0].d f>= zmm15[0]
            else
                zmm3_1 = *(rsi + 4)
                zmm5 = *rsi
                zmm0_1 = zmm3_1
                zmm6_1 = *(rsi + 8)
                zmm2_1.d = zmm5.d f* temp0_11[0]
            ...
            if (rdi.b != 0)
                int64_t* rax_23
                rax_23, zmm8, zmm9_1, zmm10_1, zmm12, zmm13, zmm14, zmm15 =
            ...
            label_14166b323:
                ...
                if (rcx_7 == 1)
                    ...
                    *(&var_170 + (rax_19 << 2)) = 0x3f800000
                    ...
                    uint64_t var_1a4
                    uint64_t* rax_17
                    rax_17, zmm8, zmm9_1, zmm10_1, zmm12, zmm13, zmm14, zmm15 =
                    ...
                    uint64_t var_1b0
                    uint64_t* rax_16
                    rax_16, zmm8, zmm9_1, zmm10_1, zmm12, zmm13, zmm14, zmm15 =
                ...
                bool cond:4_1 = zmm2_1.d f>= zmm15[0]
                var_318 = zmm2_1.d
                zmm15 = zmm2_1
                rdx_8.b = cond:4_1
                var_347 = rdx_8.b
                ...
                if (result.b == 0)
                    goto label_14166b323
                
                if (rdi.b == 0)
                    goto label_14166b331
                
                zmm11_1 = 0x3eb0c6f7a0b5ed8d
                
                if (zmm8.d f!= zmm9_1[0].d)
                    goto label_14166b32c
...
if (not(cond:0_1))
    ...
    *arg7 = (_mm_unpacklo_ps(zmm0_1, zmm1_1.q)).q
    ...
    if (not(zmm10_1[0].d f<= zmm9_1[0].d))
        temp0_21 = _mm_cvtps_pd(zmm15[0].q)
    
    if (zmm10_1[0].d f<= zmm9_1[0].d || temp0_21[0] f<= zmm11_1[0].q || zmm15[0] f>= zmm1_1.d)
        var_170[0] = 0
        var_170[1] = 0
        var_338[0] = 0
        var_338[1] = 0
        ...
        label_14166b8e5:
            *arg8 = zmm0_2.q
            ...
            int32_t rax_39
            rax_39, zmm10_1 = sub_141591b50(&var_170, &var_338, &var_248, &var_218, zmm15, 
                &var_310, &var_328, &var_288, &var_228)
            rax_40 = var_320
            
            if (rax_39 == 2)
                *rdi_3 = (zmm10_1 ^ data_142d3f780).d
                zmm0_2 = zx.o(var_328.q)
                goto label_14166b8e5
