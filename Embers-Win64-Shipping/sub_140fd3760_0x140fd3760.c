...
if (result_1 == 0)
    ...
    *result = &data_142ef29f8
    ...
    int32_t var_8c
    *(result + 0x64) = var_8c
    sub_140fd9330(&result[0xe], arg1, var_138, r9_4, var_84, var_146, var_158_1, var_150_1)
    int32_t rcx_32 = *(result + 0xfc)
    *result = &data_142ef6a98
    result[0xe] = &data_142ef6af0
    result[0x1f].d = arg5
