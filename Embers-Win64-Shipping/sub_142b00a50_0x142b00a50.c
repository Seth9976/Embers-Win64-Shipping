...
if (*(rcx + 0x50) == 1)
    sub_142b6b510(rcx, &data_143665340, 4, arg1 + 0x20, rsi, arg1 + 0x30, 0xffffffff, arg2)
    *(*(arg1 + 8) + 0x50) = 0
    ...
    if (rdi u< r12)
        if (rax u< rsi)
            ...
            if ((rdx & 0xfffff800) != 0xd800)
                goto label_142b00b51
            
            if ((rdx & 0xfffffc00) != 0xd800)
                goto label_142b00bd6
        ...
        label_142b00b1c:
            ...
            if (rdi u>= r12)
                *(*(arg1 + 8) + 0x54) = rdx
                ...
                if (*(arg1 + 2) == 0)
                    goto label_142b00be0
                
                goto label_142b00bd9
