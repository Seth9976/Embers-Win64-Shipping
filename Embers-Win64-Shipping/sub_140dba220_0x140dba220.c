...
while (true)
    int16_t* r9_4 = sx.q(r10_2) * 0x88 + *rbx
    uint64_t r8_9 = zx.q(*rsi - 1) & zx.q(*r9_4)
    ...
    *(r9_4 + 0x80) = *(rax_14 + (((sx.q(*rsi) - 1) & r8_9) << 2))
    ...
    *(rax_16 + (((sx.q(*rsi) - 1) & r8_9) << 2)) = r10_2
