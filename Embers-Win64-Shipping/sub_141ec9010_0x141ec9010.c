...
if (rcx != 0)
    *(rbx + 0x8b0) = sub_140a84c80(rcx, 0, 0)
...
sub_1407c3460(arg1 + 0x830, 0, i_2, 4)
int32_t rcx_2 = 0
...
if (i_2 s> 0)
    ...
    do
        void* rdx_1 = *(arg1 + 0x8b0)
        void* rax_1 = arg1 + 0x830
...
while (true)
    void* rax_12 = *(rbx + 0x800)
    
    if (rax_12 != 0)
        rbx = rax_12
    
    void* rbx_1 = rbx + (sx.q(r9_3) << 5)
    ...
    int32_t r8_17 = ((r8_12 - rdx_13 - rcx_11) ^ rdx_13 u>> 0xf ^ *(rbx_1 + 8)) & (*rsi - 1)
    void* rax_31 = arg1 + 0x830
    *(rbx_1 + 0x1c) = r8_17
    void* rdx_15 = *(arg1 + 0x8b0)
    int64_t r8_18 = sx.q(r8_17)
    
    if (rdx_15 != 0)
        rax_31 = rdx_15
    
    *(rbx_1 + 0x18) = *(rax_31 + (((sx.q(*rsi) - 1) & r8_18) << 2))
    void* rax_33 = arg1 + 0x830
    void* rcx_15 = *(arg1 + 0x8b0)
    
    if (rcx_15 != 0)
        rax_33 = rcx_15
    
    *(rax_33 + (((sx.q(*rsi) - 1) & r8_18) << 2)) = r9_3
