...
label_14263fd49:
    ...
    if (sub_1405b6520(arg1, r10_3, 0) == 0)
        void* r9_2 = &arg1[7]
        int32_t rax_17 = (arg1[9].d - 1) & r12.d
        *(r15_2 + 0x1c) = rax_17
        void* rdx_11 = *(r9_2 + 8)
        ...
        r15_2[3].d = *(rax_18 + (((sx.q(arg1[9].d) - 1) & r8_2) << 2))
        void* rax_20 = *(r9_2 + 8)
        
        if (rax_20 != 0)
            r9_2 = rax_20
        
        *(r9_2 + (((sx.q(arg1[9].d) - 1) & r8_2) << 2)) = rdi.d
else
    int32_t rbx_1
    ...
    if (r10_3 != 0)
        ...
        rbx_1 = *(r8_1 + (((sx.q(arg1[9].d) - 1) & r12) << 2))
    ...
    label_14263fd06:
        ...
        while (true)
            int64_t rax_13 = sx.q(rbx_1) << 5
            
            if (*(rax_13 + rcx_8) == rcx_6)
                break
            
            rbx_1 = *(rax_13 + rcx_8 + 0x18)
            
            if (rbx_1 == 0xffffffff)
                goto label_14263fd06
    
    rbp.b = rbx_1 != 0xffffffff
    
    if (rbx_1 == 0xffffffff)
        goto label_14263fd49
