...
while (true)
    ...
    if (r12_1 == 0)
    label_140d8f982:
        sub_140d8f3f0(r14_1, rax_10, zx.q(arg3), arg4)
    else
        while (true)
            uint128_t zmm1
            ...
            if (rax_10 s<= 8)
                for (; i u> r14_1; i -= 0x10)
                    uint128_t* rsi_2 = r14_1
                    uint128_t* rbp_2 = &r14_1[1]
                    
                    if (&r14_1[1] u<= i)
                        do
                            if ((*arg4)(rsi_2, rbp_2) != 0)
                                rsi_2 = rbp_2
            ...
            while (true)
                ...
                if (rsi_1 u<= i && (*arg4)(r14_1, rsi_1) == 0)
                    continue
