...
if (data_143e8ccb0 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8ccb0)
    
    if (data_143e8ccb0 == 0xffffffff)
        ...
        data_143e8cca8 = rax_6
        _Init_thread_footer(&data_143e8ccb0)

int64_t rbx = data_143e8cca8
int64_t rcx
