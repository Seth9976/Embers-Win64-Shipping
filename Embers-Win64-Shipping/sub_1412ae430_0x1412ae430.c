...
if (data_143e8d298 s> *rdi_1)
    _Init_thread_header(&data_143e8d298)
    
    if (data_143e8d298 == 0xffffffff)
        ...
        data_143e8d290 = rax_9
        _Init_thread_footer(&data_143e8d298)

if (data_143e8d2b8 s> *rdi_1)
    _Init_thread_header(&data_143e8d2b8)
    
    if (data_143e8d2b8 == 0xffffffff)
        ...
        data_143e8d2b0 = rax_12
        _Init_thread_footer(&data_143e8d2b8)

if (data_143e8d2d8 s> *rdi_1)
    _Init_thread_header(&data_143e8d2d8)
    
    if (data_143e8d2d8 == 0xffffffff)
        ...
        data_143e8d2d0 = rax_15
        _Init_thread_footer(&data_143e8d2d8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d290
int64_t rcx
...
label_1412ae533:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412ae52e
        
        rbx.b = 1
        goto label_1412ae533
