...
if (not(zmm8[0] != 1f))
    ...
    float temp0_2[0x4] = _mm_rsqrt_ss(zmm8[0], zmm3)
    zmm3 = zmm3 * 0.5f
    zmm0.d = temp0_2.d f* temp0_2[0]
    zmm2[0] = 0.5f - zmm3 f* zmm0.d
...
zmm0.d = (*arg4).d f- *arg2
zmm0.d = zmm0.d f* zmm8[0]
float zmm4 = (*(arg4 + 4) f- arg2[1]) f* zmm6.d f+ zmm0.d + (*(arg4 + 8) f- arg2[2]) f* zmm7.d
zmm8[0] = zmm8[0] * zmm4
