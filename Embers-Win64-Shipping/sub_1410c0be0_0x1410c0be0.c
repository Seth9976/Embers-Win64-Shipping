...
if (data_143e2d0d0 s> *rdi_1)
    _Init_thread_header(&data_143e2d0d0)
    
    if (data_143e2d0d0 == 0xffffffff)
        ...
        data_143e2d0c8 = rax_6
        _Init_thread_footer(&data_143e2d0d0)

if (data_143e2d0e0 s> *rdi_1)
    _Init_thread_header(&data_143e2d0e0)
    
    if (data_143e2d0e0 == 0xffffffff)
        ...
        data_143e2d0d8 = rbx
        _Init_thread_footer(&data_143e2d0e0)

if (data_143e2d0d8 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()

if (data_143e2d0c8 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()
