...
if (rax_6 != 0)
    ...
    if ((*(arg1 + 0x2b) & 8) != 0 && rax_6 s> 0x20000)
        *(arg1 + 0x29) = rcx_3 | 1
        return arg1
    ...
    if ((arg1[5].b & 1) != 0)
        ...
        do
            ...
            int64_t rcx_7 = rbp_1 << 7
            void* const rax_8
            
            if (rcx_7 == neg.q(*arg2))
                rax_8 = nullptr
            else
                rax_8 = sub_140cd3ae0(rcx_7 + *arg2)
            
            sub_140cd49f0(arg1, rax_8, arg3)
            r14 += 1
        while (r14 s< arg_8)
    ...
    if (rax_6 s> 0)
        do
            sub_140cd49f0(arg1, (sx.q(i) << 7) + *arg2, arg3)
            i += 1
        while (i s< arg2[1].d)
