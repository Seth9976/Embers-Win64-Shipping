...
if (data_143e8b458 s> *rdi_1)
    _Init_thread_header(&data_143e8b458)
    
    if (data_143e8b458 == 0xffffffff)
        ...
        data_143e8b450 = rax_9
        _Init_thread_footer(&data_143e8b458)

if (data_143e8b468 s> *rdi_1)
    _Init_thread_header(&data_143e8b468)
    
    if (data_143e8b468 == 0xffffffff)
        ...
        data_143e8b460 = rax_12
        _Init_thread_footer(&data_143e8b468)

if (data_143e8b478 s> *rdi_1)
    _Init_thread_header(&data_143e8b478)
    
    if (data_143e8b478 == 0xffffffff)
        ...
        data_143e8b470 = rax_15
        _Init_thread_footer(&data_143e8b478)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b450
int64_t rcx
