...
if (data_143e8c820 s> *rdi_1)
    _Init_thread_header(&data_143e8c820)
    
    if (data_143e8c820 == 0xffffffff)
        ...
        data_143e8c818 = rax_12
        _Init_thread_footer(&data_143e8c820)

if (data_143e8c840 s> *rdi_1)
    _Init_thread_header(&data_143e8c840)
    
    if (data_143e8c840 == 0xffffffff)
        ...
        data_143e8c838 = rax_15
        _Init_thread_footer(&data_143e8c840)

if (data_143e8c860 s> *rdi_1)
    _Init_thread_header(&data_143e8c860)
    
    if (data_143e8c860 == 0xffffffff)
        ...
        data_143e8c858 = rax_18
        _Init_thread_footer(&data_143e8c860)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c818
int64_t rcx
...
label_1412b5338:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412b5333
    
    rbx.b = 1
    goto label_1412b5338
