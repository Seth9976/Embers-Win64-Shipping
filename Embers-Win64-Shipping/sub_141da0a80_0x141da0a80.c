...
void** const var_98 = &data_1432398d0
int64_t (* var_b8)(int64_t* arg1) = j_sub_141d96f70
...
void** const var_58 = &data_14320af00
int64_t var_e0 = 0
int64_t (* var_78)(int64_t* arg1) = sub_141d9b9b0
*(r15 + 0x10) = sub_141d9b9b0
*(r15 + 0x20) = var_68
*(r15 + 0x30) = var_58.o
*(r15 + 0x40) = rdi.o
