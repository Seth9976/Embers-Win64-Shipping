...
if (data_143e8e090 s> *rdi_1)
    _Init_thread_header(&data_143e8e090)
    
    if (data_143e8e090 == 0xffffffff)
        ...
        data_143e8e088 = rax_9
        _Init_thread_footer(&data_143e8e090)

if (data_143e8e0b0 s> *rdi_1)
    _Init_thread_header(&data_143e8e0b0)
    
    if (data_143e8e0b0 == 0xffffffff)
        ...
        data_143e8e0a8 = rax_12
        _Init_thread_footer(&data_143e8e0b0)

if (data_143e8e0d0 s> *rdi_1)
    _Init_thread_header(&data_143e8e0d0)
    
    if (data_143e8e0d0 == 0xffffffff)
        ...
        data_143e8e0c8 = rax_15
        _Init_thread_footer(&data_143e8e0d0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8e088
int64_t rcx
...
label_1412aa3a3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412aa39e
        
        rbx.b = 1
        goto label_1412aa3a3
