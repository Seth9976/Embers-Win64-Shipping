...
if (rax_1 == 0)
    ...
    if (rax_2 == 0)
        ...
        *rdi = &data_142ef2928
        *(rdi + 0x2c) = 3
        sub_1418d12b0(&rdi[6], r13, 3, 0x10)
        *rdi = &data_142feee68
        rdi[6] = &data_142feee70
    
    uint64_t r8_1 = arg_10
    void* rbx_1 = &rdi[6]
    int32_t var_80_1 = r15.d
    int128_t var_48 = r12.o
    sub_1418ee3f0(rbx_1, &var_48, r8_1, arg5)
    AcquireSRWLockExclusive(r13 + 0x470)
    uint64_t* var_78 = &arg_10
    
    if (rdi == 0)
        rbx_1 = nullptr
    
    void* arg_20 = rbx_1
    void** var_70_1 = &arg_20
    int32_t arg_8
    sub_1418ca8c0(r13 + 0x568, &arg_8, &var_78, nullptr)
