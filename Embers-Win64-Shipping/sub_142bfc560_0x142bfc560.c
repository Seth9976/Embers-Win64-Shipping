...
while (true)
    ...
    *arg1 = 0
    ...
    if (rdi_1 u<= r8_4 && r8_4.d - rdi_1.d u>= 0x24)
        rcx_3 = arg1[6]
        arg1[6] = rcx_3 - 1
    
    char r10_1
    
    if (rdi_1 u> r8_4 || r8_4.d - rdi_1.d u< 0x24 || rcx_3 s<= 0)
        r10_1 = 0
    else
        r10_1 = 1
    ...
    char* var_48_1 = rdi_1
    int32_t var_50_2 = 0x24
    void* var_58_2 = &rdi_1[0x24]
    char* var_60_2 = rdi_1
    ...
    if (r10_1 != 0 && zx.w(*rdi_1) * 0x100 + zx.w(rdi_1[1]) == 1)
        ...
        if (arg1[8] != 0)
            arg1[8] = 0
            uint16_t rax_9 = sub_142bf7510(arg1, rdi_1, 0x24)
            int16_t rdx_8
            
            if (rax_9.b != 0)
                rdx_8 = zx.w(*rdi_1) * 0x100 + zx.w(rdi_1[1])
            
            if (rax_9.b == 0 || rdx_8 != 1)
                rax_9.b = 0
            else
                rax_9 = zx.w(rdx_8.b)
    ...
    int64_t rax_8 = sub_142c09bf0(arg2, nullptr)
    *(arg1 + 8) = rax_8
    *(arg1 + 0x10) = zx.q(arg2[6]) + rax_8
