...
while (true)
    ...
    int64_t rax_13 = *rbx
    void* r9_3 = rax_13 + (rcx_4 << 3)
    int64_t rax_14 = *(rax_13 + (rcx_4 << 3))
    int32_t rcx_9 = ((rax_14 u>> 0x20).d << 0x12 ^ rax_14.d) & (*rsi - 1)
    void* rax_17 = &arg1[7]
    *(r9_3 + 0x14) = rcx_9
    void* rdx_6 = arg1[8]
    int64_t r8_7 = sx.q(rcx_9)
    
    if (rdx_6 != 0)
        rax_17 = rdx_6
    
    *(r9_3 + 0x10) = *(rax_17 + (((sx.q(*rsi) - 1) & r8_7) << 2))
    void* rax_19 = &arg1[7]
    void* rcx_13 = arg1[8]
    ...
    *(rax_19 + (((sx.q(*rsi) - 1) & r8_7) << 2)) = r10_2
