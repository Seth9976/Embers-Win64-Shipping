...
if (rbx != 0)
    ...
    label_14086a27a:
        ...
        while (true)
            ...
            if (rcx != 0)
                goto label_14086a27a
        
        var_74.d = rbx

int32_t rdx_3 = *(arg1 + 0x4f8)
...
while (true)
    ...
    if (result.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x4e0 && rcx_8 == arg1 + 0x4d0)
        return result
    
    int64_t* rbx_3 = result * 0x50 + *rcx_8
    sub_140806960(*rbx_3)
    sub_140861590(&rbx_3[1], arg1)
    int32_t var_5c
