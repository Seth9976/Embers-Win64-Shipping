...
if (data_143e8be70 s> *rdi_1)
    _Init_thread_header(&data_143e8be70)
    
    if (data_143e8be70 == 0xffffffff)
        ...
        data_143e8be68 = rax_9
        _Init_thread_footer(&data_143e8be70)

if (data_143e8be80 s> *rdi_1)
    _Init_thread_header(&data_143e8be80)
    
    if (data_143e8be80 == 0xffffffff)
        ...
        data_143e8be78 = rax_12
        _Init_thread_footer(&data_143e8be80)

if (data_143e8be90 s> *rdi_1)
    _Init_thread_header(&data_143e8be90)
    
    if (data_143e8be90 == 0xffffffff)
        ...
        data_143e8be88 = rax_15
        _Init_thread_footer(&data_143e8be90)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8be68
int64_t rcx
