...
if (data_144016530 != 2)
    rax_1 = sub_142a85f00(&data_144016530)

if (data_144016530 == 2 || rax_1 == 0)
    int32_t rcx_1 = arg_18
    int32_t rax_3 = data_144016534
    ...
    sub_142ac93e0(&arg_18)
    data_144016534 = arg_18
    sub_142a85e80(&data_144016530)
...
if (arg_18 s> 0)
    *(arg3 + 0xc) = rsi
    ...
    arg_20 = rbx_1
    sub_142b50fc0(data_144016528, arg2, rsi, rbx_1, &arg_18)
