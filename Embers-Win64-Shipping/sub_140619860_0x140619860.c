...
label_1406198ef:
    ...
    if (r10_2 s> 0 && (rax_5 == 0 || rax_5 s< rsi))
        ...
        *(arg4 + 0x14) = *(rax_10 + (((sx.q(arg1[9].d) - 1) & r8_2) << 2))
        void* rax_12 = *(r9_5 + 8)
    ...
    if (rbx_1 == 0xffffffff)
        ...
        memmove(sx.q(rbx_1) * 0x1c + rdx_3, arg4, 0x14)
        sub_14061ca80(arg1, arg5, 1)
    
    if (rbp.b == 0)
        goto label_1406198ef
