...
while (true)
    ...
    if (result.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x10 && rdx_8 == arg1)
        return result
    
    int64_t rcx_8 = result * 9
    int64_t rax_20 = *rdx_8
    void* rdi_1 = rax_20 + (rcx_8 << 3)
    int32_t rax_21 = *(rax_20 + (rcx_8 << 3) + 0x20)
    int64_t rbx_1 = sx.q(rax_21 - 1)
    
    if (rax_21 - 1 s>= 0)
        int64_t temp7_1
        
        do
            int64_t* rcx_9 = *(*(rdi_1 + 0x18) + (rbx_1 << 3))
    ...
    int32_t rax_24 = *(rdi_1 + 0x30)
    int64_t rbx_2 = sx.q(rax_24 - 1)
    
    if (rax_24 - 1 s>= 0)
        int64_t temp6_1
        
        do
            int64_t* rcx_10 = *(*(rdi_1 + 0x28) + (rbx_2 << 3))
            
            if (rcx_10 != 0)
                sub_142188ca0(rcx_10)
