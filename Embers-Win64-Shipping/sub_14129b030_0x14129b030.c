...
if (data_143e8d408 s> *rdi_1)
    _Init_thread_header(&data_143e8d408)
    
    if (data_143e8d408 == 0xffffffff)
        ...
        data_143e8d400 = rax_9
        _Init_thread_footer(&data_143e8d408)

if (data_143e8d428 s> *rdi_1)
    _Init_thread_header(&data_143e8d428)
    
    if (data_143e8d428 == 0xffffffff)
        ...
        data_143e8d420 = rax_12
        _Init_thread_footer(&data_143e8d428)

if (data_143e8d448 s> *rdi_1)
    _Init_thread_header(&data_143e8d448)
    
    if (data_143e8d448 == 0xffffffff)
        ...
        data_143e8d440 = rax_15
        _Init_thread_footer(&data_143e8d448)
