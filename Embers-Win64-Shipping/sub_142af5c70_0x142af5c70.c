...
if (r8_3.d u< 0xd800)
    return zx.q(*(&data_14365d690
        + (zx.q((r8_3.d & 0x1f) + (zx.d(*(&data_14365d690 + (r8_3 s>> 5 << 1))) << 2)) << 1))) & 0x1f
...
uint64_t rax_21 = zx.q((r8_3.d & 0x1f) + (zx.d(*(&data_14365d690 + (
    zx.q(zx.d(*(&data_14365d690 + (sx.q((r8_3.d s>> 0xb) + 0x820) << 1))) + (r8_3.d s>> 5 & 0x3f))
    << 1))) << 2))
return zx.q(*(&data_14365d690 + (rax_21 << 1))) & 0x1f
