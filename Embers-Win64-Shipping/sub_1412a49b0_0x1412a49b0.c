...
if (data_143e8a950 s> *rdi_1)
    _Init_thread_header(&data_143e8a950)
    
    if (data_143e8a950 == 0xffffffff)
        ...
        data_143e8a948 = rax_9
        _Init_thread_footer(&data_143e8a950)

if (data_143e8a960 s> *rdi_1)
    _Init_thread_header(&data_143e8a960)
    
    if (data_143e8a960 == 0xffffffff)
        ...
        data_143e8a958 = rax_12
        _Init_thread_footer(&data_143e8a960)

if (data_143e8a970 s> *rdi_1)
    _Init_thread_header(&data_143e8a970)
    
    if (data_143e8a970 == 0xffffffff)
        ...
        data_143e8a968 = rax_15
        _Init_thread_footer(&data_143e8a970)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8a948
int64_t rcx
...
label_1412a4ab3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412a4aae
        
        rbx.b = 1
        goto label_1412a4ab3
