...
if (data_143e8bb18 s> *rdi_1)
    _Init_thread_header(&data_143e8bb18)
    
    if (data_143e8bb18 == 0xffffffff)
        ...
        data_143e8bb10 = rax_12
        _Init_thread_footer(&data_143e8bb18)

if (data_143e8bb38 s> *rdi_1)
    _Init_thread_header(&data_143e8bb38)
    
    if (data_143e8bb38 == 0xffffffff)
        ...
        data_143e8bb30 = rax_15
        _Init_thread_footer(&data_143e8bb38)

if (data_143e8bb58 s> *rdi_1)
    _Init_thread_header(&data_143e8bb58)
    
    if (data_143e8bb58 == 0xffffffff)
        ...
        data_143e8bb50 = rax_18
        _Init_thread_footer(&data_143e8bb58)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8bb10
int64_t rcx
...
label_1412beb28:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412beb23
    
    rbx.b = 1
    goto label_1412beb28
