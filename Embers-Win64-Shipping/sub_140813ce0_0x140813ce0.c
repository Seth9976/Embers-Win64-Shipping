...
if ((not.b((rax_28 u>> 0xf).b) & 1) == 0)
    ...
    var_258 = sx.q(r9_9) + *(*(arg1 + 0x18) + (sx.q(r10_13) << 3))
...
if ((not.b((rax_34 u>> 0xf).b) & 1) == 0)
    var_288 = zx.q(*(arg1 + 0x80) * r9_11) + *(arg1 + 0x70)
else
    ...
    var_288 = sx.q(r9_11) + *(*(arg1 + 0x18) + (sx.q(r10_16) << 3))
...
if (rcx_73 == 0x7fff)
    ...
    r9_29 = zx.q(*(arg1 + 0x80) * rcx_73) + *(arg1 + 0x70)
void* var_c8 = r9_29
uint32_t rcx_74 = zx.d(rax_2[0x14])
*(arg1 + 0x10) = &rax_2[0x15]
int32_t r11_16 = rcx_74 & 0x7fff
int32_t var_b8 = r11_16
int32_t rdx_1
rdx_1.b = r11_16 != 0x7fff
...
if (result.d s> 0)
    uint64_t i_2 = i_1
    int128_t* rbx_22 = rbx_21 - r10_30
    int128_t* r9_30 = r9_29 - r10_30
    int128_t* rdx_3 = var_250 - r10_30
    float (* var_288_1)[0x4] = var_288 - r10_30
    result = var_248 - r10_30
    float (* var_280_1)[0x4] = var_280 - r10_30
    int128_t* rcx_78 = rcx_77 - r10_30
    float (* var_278_1)[0x4] = var_278 - r10_30
    int64_t r13_3 = r13_2 - r10_30
    float (* r12_3)[0x4] = r12_2 - r10_30
    float temp0_5[0x4] = _mm_mul_ps(temp0_4, temp0)
    float (* r11_17)[0x4] = i_2 - r10_30
    ...
    float temp0_8[0x4] =
        _mm_sub_ps(zx.o(0), _mm_max_ps(__minps_xmmps_memps(temp0_5, data_143ce3940), zx.o(0)))
    uint64_t i
    
    do
        float zmm4[0x4] = *r10_30
        float zmm3[0x4] = *(rdx_3 + r10_30)
        float zmm2[0x4] = *(result + r10_30)
        float temp0_9[0x4] = _mm_max_ps(*(var_288_1 + r10_30), zmm10)
        *(rbx_22 + r10_30) = zmm4
        float temp0_10[0x4] = _mm_rcp_ps(temp0_9)
        *(r9_30 + r10_30) = zmm3
        float temp0_11[0x4] = _mm_mul_ps(temp0_10, temp0)
        *(rcx_78 + r10_30) = zmm2
        float temp0_13[0x4] = _mm_add_ps(zmm4, _mm_mul_ps(temp0_11, temp0_1))
        float temp0_14[0x4] = _mm_mul_ps(temp0_11, temp0_2)
        float temp0_15[0x4] = _mm_mul_ps(temp0_11, temp0_3)
        float temp0_16[0x4] = _mm_add_ps(zmm3, temp0_14)
        float temp0_17[0x4] = _mm_mul_ps(temp0_8, temp0_13)
        float temp0_18[0x4] = _mm_add_ps(zmm2, temp0_15)
        float zmm1[0x4] = *(var_280_1 + r10_30)
        float temp0_19[0x4] = _mm_add_ps(temp0_13, temp0_17)
        float temp0_20[0x4] = _mm_mul_ps(temp0_8, temp0_16)
        *(r14_3 + r10_30) = temp0_19
        float temp0_21[0x4] = _mm_add_ps(temp0_16, temp0_20)
        float temp0_22[0x4] = _mm_mul_ps(temp0_8, temp0_18)
        *(rsi_3 + r10_30) = temp0_21
        float temp0_23[0x4] = _mm_add_ps(temp0_18, temp0_22)
        ...
        *(r10_30 + r13_3) = temp0_25
        float temp0_27[0x4] = _mm_add_ps(*(r11_17 + r10_30), temp0_26)
