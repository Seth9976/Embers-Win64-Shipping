...
if (rax_13 != 0)
    ...
    do
        ...
        uint64_t rcx_5 = zx.q(*(r8_2 + (r9_1 << 1))) * 3
        uint64_t rax_17 = zx.q(*(r8_2 + (r9_1 << 1) + 2))
        zmm1_1[0] = zmm1_1[0] f* *(r10_1 + (rcx_5 << 2) + 8)
        zmm7[0] = zmm7[0] f* *(r10_1 + (rcx_5 << 2))
        int64_t zmm4_1
        zmm4_1.d = zmm6_1.d f* *(r10_1 + (rcx_5 << 2) + 4)
        uint64_t rcx_6 = rax_17 * 3
        uint64_t rax_18 = zx.q(*(r8_2 + (r9_1 << 1) + 4))
