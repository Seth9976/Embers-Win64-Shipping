...
if (data_143e8dc90 s> *rdi_1)
    _Init_thread_header(&data_143e8dc90)
    
    if (data_143e8dc90 == 0xffffffff)
        ...
        data_143e8dc88 = rax_9
        _Init_thread_footer(&data_143e8dc90)

if (data_143e8dcb0 s> *rdi_1)
    _Init_thread_header(&data_143e8dcb0)
    
    if (data_143e8dcb0 == 0xffffffff)
        ...
        data_143e8dca8 = rax_12
        _Init_thread_footer(&data_143e8dcb0)

if (data_143e8dcd0 s> *rdi_1)
    _Init_thread_header(&data_143e8dcd0)
    
    if (data_143e8dcd0 == 0xffffffff)
        ...
        data_143e8dcc8 = rax_15
        _Init_thread_footer(&data_143e8dcd0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8dc88
int64_t rcx
...
label_1412aa903:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412aa8fe
        
        rbx.b = 1
        goto label_1412aa903
