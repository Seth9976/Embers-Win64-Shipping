...
if (result_1.b == 0)
    ...
    *(arg1 + 0x10) = &rax[5]
    ...
    if (result.d s> 0)
        ...
        do
            ...
            rsi_3 = &rsi_3[1]
            zmm8 = atanf(zmm9[0].q.d)
            zmm7 = atanf(_mm_shuffle_ps(zmm9, zmm9, 0x55)[0])
            zmm6 = atanf(_mm_shuffle_ps(zmm9, zmm9, 0xaa)[0])
            int64_t zmm0
            zmm0, result = atanf(_mm_shuffle_ps(zmm9, zmm9, 0xff)[0])
            float temp0_10[0x4] = _mm_unpacklo_ps(zmm7, zmm0)
            *rbx_3 = _mm_unpacklo_ps(_mm_unpacklo_ps(zmm8, zmm6[0].q), temp0_10[0].q)
            i = i_3
            i_3 -= 1
        while (i != 1)
else if (result.d == 1)
    ...
    *(arg1 + 0x10) = &rax[3]
    ...
    zmm9 = *(sx.q(rcx_1) + *(*(arg1 + 0x18) + (sx.q(r8_1) << 3)))
    result = &rax[5]
    ...
    *(arg1 + 0x10) = result
    ...
    if (i_4 s> 0)
        zmm8 = atanf(temp0_1[0].q.d)
        zmm7 = atanf(_mm_shuffle_ps(temp0_1, temp0_1, 0x55)[0])
        zmm6 = atanf(_mm_shuffle_ps(temp0_1, temp0_1, 0xaa)[0])
        float temp0_4[0x4] = _mm_unpacklo_ps(zmm7, atanf(temp0_1[0]))
        uint64_t i_2 = zx.q(i_4)
        float temp0_6[0x4] = _mm_unpacklo_ps(_mm_unpacklo_ps(zmm8, zmm6[0].q), temp0_4[0].q)
        uint64_t i_1
