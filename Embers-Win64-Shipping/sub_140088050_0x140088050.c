...
if (r15_4 s<= 0)
    ...
    result = 0
    arg7[0].o = data_142e11d00
    arg8[0].o = data_142fc9500
    ...
    while (true)
        ...
        if (not(cond:1_1))
            ...
            zmm3[0].o = *(arg4 + rax_2)
            zmm4[0].o = *(arg4 + rax_2 + 0x10)
            zmm5[0].o = *(arg4 + rax_2 + 0x20)
            arg5[0].o = *(arg4 + rax_2 + 0x30)
            arg6[0].o = *(arg4 + rax_2 + 0x40)
            zmm0[0].o = *(arg4 + rax_2 + 0x50)
            zmm1[0].o = __vshufps_xmmdq_xmmdq_xmmdq_immb(zmm3[0].o, zmm4[0].o, 0xec)
            zmm2[0].o = _mm_permute_ps(zmm5[0].o, 0x44)
            arg10[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm2[0].o, 8)
            zmm2[0].o = __vshufps_xmmdq_xmmdq_xmmdq_immb(arg5[0].o, arg6[0].o, 0xec)
            zmm1[0].o = _mm_permute_ps(zmm0[0].o, 0x44)
            arg11[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm2[0].o, zmm1[0].o, 8)
            zmm2[0].o = _mm_permute_ps(zmm3[0].o, 0xe5)
            zmm1[0].o = _mm_permute_ps(zmm4[0].o, 0xf0)
            zmm1[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm2[0].o, 1)
            zmm2[0].o = _mm_permute_ps(zmm5[0].o, 0xa4)
            arg12[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm2[0].o, 8)
            zmm2[0].o = _mm_permute_ps(arg5[0].o, 0xe5)
            zmm1[0].o = _mm_permute_ps(arg6[0].o, 0xf0)
            zmm1[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm2[0].o, 1)
            zmm2[0].o = _mm_permute_ps(zmm0[0].o, 0xa4)
            zmm1[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm2[0].o, 8)
            zmm2[0].o = _mm_permute_ps(zmm3[0].o, 0x4e)
            zmm2[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm2[0].o, zmm4[0].o, 2)
            zmm2[0].o = __vshufps_xmmdq_xmmdq_xmmdq_immb(zmm2[0].o, zmm5[0].o, 0xc4)
            zmm3[0].o = _mm_permute_ps(arg5[0].o, 0x4e)
            zmm3[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm3[0].o, arg6[0].o, 2)
            zmm0[0].o = __vshufps_xmmdq_xmmdq_xmmdq_immb(zmm3[0].o, zmm0[0].o, 0xc4)
            zmm3 = _mm256_insertf128_ps(arg10, arg11[0].o, 1)
            ...
            int32_t var_340_1[0x8] = zmm0
            float var_320_1[0x8] = arg9
            zmm2 = _mm256_broadcast_ss(arg3[3])
            double var_200_1[0x4] = zmm2
            double var_1e0_1[0x4] = zmm2
            double var_1c0_1[0x4] = zmm2
            double var_1a0_1[0x4] = zmm2
            ...
            arg11 = _mm256_mul_ps(arg10, zmm1)
            zmm1 = _mm256_sub_ps(zmm5, _mm256_mul_ps(arg5, zmm1))
            zmm0 = _mm256_sub_ps(arg6, _mm256_mul_ps(arg10, zmm0))
            zmm3 = _mm256_sub_ps(arg11, _mm256_mul_ps(zmm4, zmm3))
            zmm1 = _mm256_add_ps(zmm1, zmm1)
            zmm0 = _mm256_add_ps(zmm0, zmm0)
            zmm3 = _mm256_add_ps(zmm3, zmm3)
            zmm5 = _mm256_mul_ps(zmm2, zmm1)
            ...
            zmm2 = __vaddps_ymmqq_ymmqq_memqq(zmm2, var_340_1)
            arg11 = _mm256_mul_ps(zmm3, zmm4)
            arg12 = _mm256_mul_ps(zmm1, arg5)
            arg13 = _mm256_mul_ps(zmm0, arg10)
            zmm0 = _mm256_add_ps(zmm5, _mm256_sub_ps(arg11, _mm256_mul_ps(zmm0, arg5)))
            zmm3 = _mm256_add_ps(arg6, _mm256_sub_ps(arg12, _mm256_mul_ps(zmm3, arg10)))
            zmm1 = _mm256_add_ps(zmm2, _mm256_sub_ps(arg13, _mm256_mul_ps(zmm1, zmm4)))
            ...
            zmm0 = _mm256_add_ps(_mm256_mul_ps(zmm0, _mm256_broadcast_ss(*arg1)), 
                _mm256_mul_ps(zmm2, _mm256_broadcast_ss(arg1[1])))
            zmm2 = _mm256_broadcast_ss(arg1[2])
            zmm1 = _mm256_mul_ps(zmm1, zmm2)
            zmm3 = _mm256_add_ps(zmm0, zmm1)
            zmm0 = _mm256_cmp_ps(zmm3, _mm256_broadcast_ss(*arg16), 1)
            ...
            if (i_2 == 0)
                ...
                zmm1[0].o = __vpaddd_xmmdq_xmmdq_xmmdq(zmm0[0].o, arg7[0].o)
...
if (rbx.d s< arg17)
    ...
    if (not(cond:0_1))
        ...
        zmm1[0].o = __vpcmpgtd_xmmdq_xmmdq_xmmdq(zmm1[0].o, arg13[0].o)
        ...
        zmm3[0].o = __vpaddd_xmmdq_xmmdq_xmmdq(arg13[0].o, arg13[0].o)
        zmm3[0].o = __vpaddd_xmmdq_xmmdq_xmmdq(zmm3[0].o, arg13[0].o)
        zmm2 = _mm256_insertf128_ps(zmm3, zmm2[0].o, 1)
        arg8 = _mm256_and_ps(arg12, zmm2)
        int64_t rax_5 = sx.q(arg8[0])
        ...
        zmm4 = __vandps_ymmqq_ymmqq_memqq(arg12, data_142fc9520)
        zmm5[0].o = _mm256_extractf128_ps(zmm4[0].o, 1)
        arg7[0].o = *(zx.q(zmm5[0]) + rbx_1)
        arg5 = __vandps_ymmqq_ymmqq_memqq(arg12, data_142fc9540)
        zmm1[0].o = _mm256_extractf128_ps(arg5[0].o, 1)
        arg6[0].o = *(zx.q(zmm1[0]) + rbx_1)
        int32_t temp0_111 = __vpextrd_gpr32d_xmmdq_immb(zmm3[0].o, 2)
        ...
        int32_t temp0_125 = __vpextrd_gpr32d_xmmdq_immb(arg8[0].o, 2)
        ...
        zmm1 = _mm256_broadcast_ss(arg3[5])
        arg14 = _mm256_broadcast_ss(arg3[6])
        float var_280_1[0x8] = zmm3
        float var_260_1[0x8] = zmm4
        float var_240_1[0x8] = zmm5
        zmm4 = _mm256_mul_ps(zmm4, arg9)
        zmm5 = _mm256_mul_ps(zmm5, arg9)
        arg9[0].o = __vxorps_xmmdq_xmmdq_xmmdq(arg9[0].o, arg9[0].o)
        float var_220_1[0x8] = arg9
        double var_200_2[0x4] = zmm2
        double var_1e0_2[0x4] = zmm2
        double var_1c0_2[0x4] = zmm2
        double var_1a0_2[0x4] = zmm2
        arg6 = _mm256_mul_ps(zmm3, arg6)
        arg9 = _mm256_mul_ps(zmm2, arg9)
        zmm5 = _mm256_sub_ps(arg6, zmm5)
        zmm3 = _mm256_sub_ps(zmm4, _mm256_mul_ps(zmm3, arg5))
        zmm4 = _mm256_sub_ps(arg9, arg9)
        ...
        arg6 = _mm256_mul_ps(zmm2, arg5)
        arg7 = _mm256_mul_ps(zmm2, zmm5)
        arg9 = _mm256_mul_ps(zmm2, zmm3)
        zmm2 = _mm256_mul_ps(zmm2, zmm4)
        zmm4 = __vaddps_ymmqq_ymmqq_memqq(arg6, var_280_1)
        arg6 = __vaddps_ymmqq_ymmqq_memqq(arg7, var_260_1)
        arg7 = __vaddps_ymmqq_ymmqq_memqq(arg9, var_240_1)
        float var_180_1[0x8] = zmm4
        float var_160_1[0x8] = arg6
        float var_140_1[0x8] = arg7
        double var_120_1[0x4] = __vaddps_ymmqq_ymmqq_memqq(zmm2, var_220_1)
        zmm2 = _mm256_mul_ps(zmm3, arg8)
        arg9 = _mm256_mul_ps(arg5, arg10)
        arg10 = _mm256_mul_ps(zmm5, arg10)
        zmm5 = _mm256_mul_ps(zmm5, arg11)
        zmm2 = _mm256_sub_ps(zmm2, arg10)
        zmm3 = _mm256_sub_ps(arg9, _mm256_mul_ps(zmm3, arg11))
        arg9 = _mm256_broadcast_ss(*arg2)
        arg10 = _mm256_broadcast_ss(arg2[1])
        arg11 = _mm256_broadcast_ss(arg2[2])
        arg5 = _mm256_mul_ps(arg5, arg8)
        zmm5 = _mm256_sub_ps(zmm5, arg5)
        zmm2 = _mm256_add_ps(zmm4, zmm2)
        zmm3 = _mm256_add_ps(arg6, zmm3)
        zmm4 = _mm256_add_ps(arg7, zmm5)
        zmm0 = _mm256_add_ps(zmm2, zmm0)
        zmm1 = _mm256_add_ps(zmm3, zmm1)
        zmm2 = _mm256_add_ps(zmm4, arg14)
        zmm0 = _mm256_sub_ps(zmm0, arg9)
        zmm1 = _mm256_sub_ps(zmm1, arg10)
        zmm2 = _mm256_sub_ps(zmm2, arg11)
        zmm2 = _mm256_add_ps(
            _mm256_add_ps(_mm256_mul_ps(zmm0, _mm256_broadcast_ss(*arg1)), 
                _mm256_mul_ps(zmm1, _mm256_broadcast_ss(arg1[1]))), 
            _mm256_mul_ps(zmm2, _mm256_broadcast_ss(arg1[2])))
        zmm0 = _mm256_and_ps(_mm256_cmp_ps(zmm2, _mm256_broadcast_ss(*arg16), 1), arg12)
        ...
        if (i_3 == 0)
            ...
            do
                ...
                if (i_1 == 0)
                    ...
                    if ((result.b & 1) == 0)
                    label_1400887f1:
                        double var_300[0x4] = zmm2
                        uint64_t rdx_1 = zx.q(rdx.d) & 7
                        zmm0[0].o = *(&var_300 + (rdx_1 << 2))
                        *arg16 = zmm0[0]
