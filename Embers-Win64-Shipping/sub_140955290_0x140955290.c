...
if (rcx == 0 || rax_3 == 0)
    result = sub_14096aef0(arg1)
else
    *(arg1 + 0x342) = 1
    sub_140955b10(arg1, 0)
    
    if (*(arg1 + 0x341) == 0)
        result = sub_14096aef0(arg1)
    else
        (*(*arg1 + 0x728))(arg1, &arg1[0x5f])
        int64_t* result_1 = nullptr
        int32_t var_90_1 = 0
        int64_t (* var_88_1)(int64_t* arg1) = sub_14096afd0
        int32_t var_80_1 = 0
        ...
        sub_1423e6200(rdi_2, &arg1[0x69], &var_78, 0x40a00000, 0, 0xbf800000)
