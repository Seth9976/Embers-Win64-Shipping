// 函数: agsDriverExtensionsDX11_MultiDrawInstancedIndirectCountIndirect
// 地址: 0x142c4e300
...
if ((rax.b & 0x20) != 0)
    ...
    if (test_bit(rax, 0x15))
        ...
        int32_t var_20 = arg7
        int32_t var_28 = arg6
        result = (*(*rcx + 0x50))(rcx, arg3, zx.q(arg4))
        goto label_142c4e3b8
    
    if (arg2 == 0 || arg2 == *(arg1 + 0x128))
        int64_t* rcx_1 = *(arg1 + 0x150)
        int32_t var_20_1 = arg7
        int32_t var_28_1 = arg6
        result = (*(*rcx_1 + 0x30))(rcx_1, arg3, zx.q(arg4))
    label_142c4e3b8:
