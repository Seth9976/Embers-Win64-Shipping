...
for (; i == 0; i = *arg1)
    ...
    int32_t** i_1 = sub_140dc0ea0(1, 0x120)
    
    if (i_1 != 0)
        sub_142c00e10(i_1, rbx)
    ...
    if (i != 0 && i != &data_14369a5d0)
        ...
        i[0x12] = 0
        i[0x13] = 0
        int32_t j_4 = i[0x1f].d
        
        if (j_4 != 0)
            int64_t* rdi_3 = &i[0x20][4]
        ...
        i[0x1f] = 0
        i[0x20] = 0
        int32_t j_5 = i[0x21].d
        
        if (j_5 != 0)
            int64_t* rdi_5 = &i[0x22][4]
