// 函数: ?do_put@?$money_put@GV?$ostreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MEBA?AV?$ostreambuf_iterator@GU?$char_traits@G@std@@@2@V32@_NAEAVios_base@2@GAEBV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@@Z
// 地址: 0x14279f2a0
...
var_b8 = 0
void* rax_15 = sub_140d2dfc0(sub_1427c0e90(), arg1, 0, 0, 0, 0, 0, 0, 0)
void* r14_2 = nullptr
...
if (rax_15 == 0)
    ...
    rax_28 = sub_140d21950(rax_15, sub_1427bae60())
