...
if (rdx_7 != r11)
    ...
    label_141814472:
        ...
        while (true)
            ...
            if (rdx_11 != 0)
                goto label_141814472
        
        var_74.d = r11

while (true)
    int64_t rcx_13 = sx.q(var_58:0xc.d)
    int64_t result = var_68.q
    
    if (rcx_13.d == (var_78_2.q u>> 0x20).d && var_58.q == arg2 + 0x10 && result == arg2)
        return result
    
    int128_t* rdx_14 = (rcx_13 << 5) + *result
    sub_1418182f0(arg1, rdx_14, &rdx_14[1])
    int32_t var_5c
