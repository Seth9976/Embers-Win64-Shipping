...
if (data_143e8c3a0 s> *rdi_1)
    _Init_thread_header(&data_143e8c3a0)
    
    if (data_143e8c3a0 == 0xffffffff)
        ...
        data_143e8c398 = rax_12
        _Init_thread_footer(&data_143e8c3a0)

if (data_143e8c3c0 s> *rdi_1)
    _Init_thread_header(&data_143e8c3c0)
    
    if (data_143e8c3c0 == 0xffffffff)
        ...
        data_143e8c3b8 = rax_15
        _Init_thread_footer(&data_143e8c3c0)

if (data_143e8c3e0 s> *rdi_1)
    _Init_thread_header(&data_143e8c3e0)
    
    if (data_143e8c3e0 == 0xffffffff)
        ...
        data_143e8c3d8 = rax_18
        _Init_thread_footer(&data_143e8c3e0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c398
int64_t rcx
