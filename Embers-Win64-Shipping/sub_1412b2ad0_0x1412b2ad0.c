...
if (data_143e8c2a0 s> *rdi_1)
    _Init_thread_header(&data_143e8c2a0)
    
    if (data_143e8c2a0 == 0xffffffff)
        ...
        data_143e8c298 = rax_9
        _Init_thread_footer(&data_143e8c2a0)

if (data_143e8c2c0 s> *rdi_1)
    _Init_thread_header(&data_143e8c2c0)
    
    if (data_143e8c2c0 == 0xffffffff)
        ...
        data_143e8c2b8 = rax_12
        _Init_thread_footer(&data_143e8c2c0)

if (data_143e8c2e0 s> *rdi_1)
    _Init_thread_header(&data_143e8c2e0)
    
    if (data_143e8c2e0 == 0xffffffff)
        ...
        data_143e8c2d8 = rax_15
        _Init_thread_footer(&data_143e8c2e0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c298
int64_t rcx
