...
int64_t arg_8 = *(sub_141ae7ff0() + 0x18)
int16_t* var_38
...
int64_t var_28
int64_t* rax_1 = sub_140b63b70(arg1 + 0x100, &var_28)

if (rax_1[1].d != 0)
    rdi = *rax_1

sub_140a2e390(&var_38, u" Active: %s)", rdi)
int32_t r8_6
...
sub_140a20ba0(&var_48, var_38, r8_6)
