...
int32_t arg_18 = 0
int32_t result = (*(*arg2 + 8))(rdi, &var_58, &var_78)
...
while (result.b != 0)
    ...
    if (var_78.q != 0)
        ...
        if (rsi_1 - 1 s>= 0)
            ...
            do
                int64_t* rdi_1 = *(rbx + 0x80)
                int64_t* rbx_1 = *(rdi_1 + r14_2 + 8)
                
                if (rbx_1 == 0)
                    sub_141c8bf50(rbx + 0x80, rsi_2, 1, 1)
                else
                    int32_t rax_2 = 0
                    bool z_1
    ...
    result = (*(rax_12 + 8))(rdi, &var_58, &var_78)
    rbx = arg1
