...
float zmm1 = (*(arg1 + 0x54) f- *(arg1 + 0x44)) f* zmm5.d f+ *(arg1 + 0x44)
int32_t var_38 = zmm0.d
zmm0.d = (*(arg1 + 0x58)).d f- *(arg1 + 0x48)
float var_34 = zmm1
zmm0.d = zmm0.d f* zmm5.d
zmm0.d = zmm0.d f+ *(arg1 + 0x48)
zmm1 = (*(arg1 + 0x5c) f- *(arg1 + 0x4c)) f* zmm5.d f+ *(arg1 + 0x4c)
int32_t var_30 = zmm0.d
sub_140777ed0(arg2, rdx, &var_38)
int64_t var_18
