...
if (data_143e8aad0 s> *rdi_1)
    _Init_thread_header(&data_143e8aad0)
    
    if (data_143e8aad0 == 0xffffffff)
        ...
        data_143e8aac8 = rax_12
        _Init_thread_footer(&data_143e8aad0)

if (data_143e8aae0 s> *rdi_1)
    _Init_thread_header(&data_143e8aae0)
    
    if (data_143e8aae0 == 0xffffffff)
        ...
        data_143e8aad8 = rax_15
        _Init_thread_footer(&data_143e8aae0)

if (data_143e8aaf0 s> *rdi_1)
    _Init_thread_header(&data_143e8aaf0)
    
    if (data_143e8aaf0 == 0xffffffff)
        ...
        data_143e8aae8 = rax_18
        _Init_thread_footer(&data_143e8aaf0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8aac8
int64_t rcx
...
label_1412a57b8:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412a57b3
    
    rbx.b = 1
    goto label_1412a57b8
