...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_1[4]
    sub_140d30490(arg2, &var_160, r8_1)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_5[4]
    sub_140d30490(arg2, &var_148, r8_5)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_7[4]
    sub_140d30490(arg2, &var_170, r8_7)
else
    sub_140d30460(arg2, *(arg2 + 0x18), &var_170)
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_9[4]
    sub_140d30490(arg2, &var_174, r8_9)
else
    sub_140d30460(arg2, *(arg2 + 0x18), &var_174)
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_11[4]
    sub_140d30490(arg2, &var_168, r8_11)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_15[4]
    sub_140d30490(arg2, &var_158, r8_15)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_21[4]
    sub_140d30490(arg2, &arg_20, r8_21)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_25[4]
    sub_140d30490(arg2, &var_108, r8_25)
else
...
if (*(arg2 + 0x20) == 0)
    int64_t* r8_27 = *(arg2 + 0x80)
    *(arg2 + 0x80) = r8_27[4]
    r9 = sub_140d30490(arg2, &var_178, r8_27)
else
    r9 = sub_140d30460(arg2, *(arg2 + 0x18), &var_178)

int64_t rax_17 = *(arg2 + 0x20)
int128_t zmm1 = var_f8
int64_t rdi
rdi.b = rax_17 != 0
int512_t zmm3
zmm3.o = var_170
uint128_t var_e8 = var_108
uint64_t var_128 = var_148
int32_t var_140
int32_t var_120 = var_140
uint64_t var_118 = var_138
int32_t var_180 = var_178.d
uint128_t* var_188 = &var_e8
int128_t var_d8
int128_t* var_190 = &var_d8
int64_t* rcx_15 = var_160
char var_198 = r15.b
void* var_1a0 = rsi
int32_t var_130
int32_t var_110 = var_130
char rax_20 = arg_10
char rax_21 = var_168.b
int32_t var_1c8 = var_174.d
*(arg2 + 0x20) = rdi + rax_17
var_d8 = zmm1
char result = sub_1420b5bb0(rcx_15, &var_118, &var_128, r9, var_1c8, rax_21, r12.b, r14, rax_20)
