...
if (data_143e8b2b8 s> *rdi_1)
    _Init_thread_header(&data_143e8b2b8)
    
    if (data_143e8b2b8 == 0xffffffff)
        ...
        data_143e8b2b0 = rax_12
        _Init_thread_footer(&data_143e8b2b8)

if (data_143e8b2c8 s> *rdi_1)
    _Init_thread_header(&data_143e8b2c8)
    
    if (data_143e8b2c8 == 0xffffffff)
        ...
        data_143e8b2c0 = rax_15
        _Init_thread_footer(&data_143e8b2c8)

if (data_143e8b2d8 s> *rdi_1)
    _Init_thread_header(&data_143e8b2d8)
    
    if (data_143e8b2d8 == 0xffffffff)
        ...
        data_143e8b2d0 = rax_18
        _Init_thread_footer(&data_143e8b2d8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b2b0
int64_t rcx
...
label_1412c2a08:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412c2a03
    
    rbx.b = 1
    goto label_1412c2a08
