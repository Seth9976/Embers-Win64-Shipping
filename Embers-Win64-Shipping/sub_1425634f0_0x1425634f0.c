...
uint32_t zmm3[0x4] = data_143f6b170
int128_t var_38 = zx.o(0)
uint32_t temp0[0x4] = __andps_xmmxud_memxud(zmm3, data_143f6b180)
...
rdi.b = rax_5 != 0
*(arg2 + 0x20) = rdi + rax_5
int64_t result = sub_142251fa0(arg1, rdx_4, r8_4)
