...
if (rax_6 != 0)
    ...
    if ((*(arg1 + 0x2b) & 8) != 0 && rax_6 s> 0xbe82)
        *(arg1 + 0x29) = rcx_3 | 1
        return arg1
    
    if ((arg1[5].b & 1) != 0)
        int512_t zmm1 = sub_14229d5f0(arg2, rax_6)
        int32_t r14 = 0
        ...
        do
            ...
            int64_t rcx_6 = rbp_1 * 0x158
            int32_t* rax_9
            
            if (rcx_6 == neg.q(*arg2))
                rax_9 = nullptr
            else
                rax_9 = sub_142287aa0(rcx_6 + *arg2)
            
            sub_14213b490(arg1, rax_9, zmm1)
            r14 += 1
        while (r14 s< arg_8)
    ...
    if (rax_6 s> 0)
        do
            sub_14213b490(arg1, sx.q(i) * 0x158 + *arg2, arg3)
            i += 1
        while (i s< arg2[1].d)
else if ((arg1[5].b & 1) != 0)
    sub_14229d5f0(arg2, 0)
