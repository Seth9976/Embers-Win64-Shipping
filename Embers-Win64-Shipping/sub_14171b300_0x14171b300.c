...
float var_88
float* rax = sub_14170d700(rcx_1, &var_88, &var_98)
uint128_t zmm10 = zx.o(*rax)
int32_t rsi = rax[2]
float* rax_1
int64_t zmm6_1
int32_t zmm7_1
int32_t zmm9_1
rax_1, zmm6_1, zmm7_1, zmm9_1 = sub_14170d700(rcx_1, &var_98, arg2)
int64_t* rbx = arg1[2]
...
float zmm2_1 = (zmm6:4.d f- _mm_shuffle_ps(zmm11, zmm11, 0x55).d) f* zmm8.d f+ zmm0_1.d
zmm0_1.d = rdi.d f- r15
zmm0_1.d = zmm0_1.d f* zmm9_1
zmm2_1 = zmm2_1 f+ zmm0_1.d
float var_a4
float zmm1_1 = var_a4 f- _mm_shuffle_ps(zmm10, zmm10, 0x55).d
zmm0_1.d = var_a8.d f- zmm10.d
zmm0_1.d = zmm0_1.d f* *arg2
zmm1_1 = zmm1_1 f* *(arg2 + 4) f+ zmm0_1.d
int32_t var_a0
zmm0_1.d = var_a0.d f- rsi
...
if (zmm2_1 < zmm1_1 f+ zmm0_1.d)
    ...
    *(rcx_7 + (rdx_7 << 2)) = var_a8.q
    *(rcx_7 + (rdx_7 << 2) + 8) = var_a0
    ...
    result = *rbx_2
    int64_t rcx_9 = rdi_3 * 3
    *(result + (rcx_9 << 2)) = zmm10.q
    *(result + (rcx_9 << 2) + 8) = rsi
else
    ...
    *(result + (rcx_5 << 2)) = zmm11.q
    *(result + (rcx_5 << 2) + 8) = r15
