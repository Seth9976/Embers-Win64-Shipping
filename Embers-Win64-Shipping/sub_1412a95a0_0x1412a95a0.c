...
if (data_143e8e730 s> *rdi_1)
    _Init_thread_header(&data_143e8e730)
    
    if (data_143e8e730 == 0xffffffff)
        ...
        data_143e8e728 = rax_12
        _Init_thread_footer(&data_143e8e730)

if (data_143e8e740 s> *rdi_1)
    _Init_thread_header(&data_143e8e740)
    
    if (data_143e8e740 == 0xffffffff)
        ...
        data_143e8e738 = rax_15
        _Init_thread_footer(&data_143e8e740)

if (data_143e8e750 s> *rdi_1)
    _Init_thread_header(&data_143e8e750)
    
    if (data_143e8e750 == 0xffffffff)
        ...
        data_143e8e748 = rax_18
        _Init_thread_footer(&data_143e8e750)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e728
int64_t rcx
...
label_1412a9698:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412a9693
    
    rbx.b = 1
    goto label_1412a9698
