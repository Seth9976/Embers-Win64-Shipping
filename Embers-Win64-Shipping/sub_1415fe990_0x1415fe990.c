...
while (true)
    ...
    zmm0 = zmm4
    var_258 = *(rax_7 + 0x18)
    float temp0_9[0x4] = _mm_unpacklo_ps(_mm_shuffle_ps(zmm0, zmm0, 0x55), zmm9[0].q)
    var_260.q = zmm4.q
    ...
    zmm4 = _mm_add_ps(zmm4, temp0_11)
    float temp0_29[0x4] = __addps_xmmps_memps(
        _mm_add_ps(_mm_sub_ps(_mm_mul_ps(temp0_24, temp0_12), temp0_23), zmm4), arg3[1])
    *(&var_1a8:4 + (sx.q(i_6) << 2)) = i_6
    ...
    zmm4 = _mm_shuffle_ps(temp0_29, temp0_29, 0x55)
    int64_t rcx_4 = r13 * 3
    zmm7[0] = zmm7[0] f- zmm4.d
    i_6 = r13.d + 1
    float temp0_32[0x4] = _mm_unpacklo_ps(zmm12, zmm7[0].q)
    float var_1d8_1 = zmm11[0]
    *(&var_178 + (rcx_4 << 2)) = temp0_32.q
    (&var_170)[rcx_4] = var_1f8_1
    *(&var_148 + (rcx_4 << 2)) = (_mm_unpacklo_ps(temp0_29, zmm4.q)).q
    (&var_140)[rcx_4] = var_1e8_1
    int64_t var_118
    *(&var_118 + (rcx_4 << 2)) = (_mm_unpacklo_ps(zmm12, zmm7[0].q)).q
    int32_t var_110
    ...
    if (zmm2[0] < zmm15[0] || zmm2[0] >= zmm13[0])
        rcx_1 = var_2a8
        zmm13 = zmm2
        var_284 = zmm2[0]
        break
    ...
    rcx = var_2a8
    float temp0_36[0x4] = _mm_sqrt_ss(0, zmm2[0])
    zmm1 = zmm14
    var_284 = zmm2[0]
    zmm13 = zmm2
...
if (zmm13[0] <= zmm15[0])
    ...
    uint128_t zmm10_1
    float zmm15_1
    rax_29, zmm9_1, zmm10_1, zmm15_1 = sub_14156fb80(&var_270, &var_280, &var_220, &var_218, 
