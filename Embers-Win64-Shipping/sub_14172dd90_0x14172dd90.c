...
if (_mm_movemask_ps(_mm_cmpeq_ps(_mm_min_ps(zmm14, zmm8), data_143ef7530, 1)) == 0)
    ...
    float temp0_153[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm3, zmm3, 0xd2), temp0_151)
    zmm6 = _mm_add_ps(temp0_150, temp0_149)
    float temp0_157[0x4] =
        _mm_sub_ps(temp0_153, _mm_mul_ps(_mm_shuffle_ps(zmm3, zmm3, 0xc9), temp0_148))
    ...
    float temp0_163[0x4] = _mm_add_ps(temp0_159, zmm3)
    ...
    zmm3 = _mm_mul_ps(temp0_112, zmm6)
    float temp0_119[0x4] = _mm_add_ps(
        _mm_mul_ps(_mm_sub_ps(zmm6, _mm_mul_ps(_mm_mul_ps(temp0_113, temp0_113), zmm3)), 
            temp0_113), 
        temp0_113)
    zmm1 = zx.o(0)
    float temp0_122[0x4] = _mm_sub_ps(zmm6, _mm_mul_ps(_mm_mul_ps(temp0_119, temp0_119), zmm3))
...
int64_t result = (*(*rcx_2 + 0x68))(zmm0, zmm1, &var_f8, zmm3, var_158)
