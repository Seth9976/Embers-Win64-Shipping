...
if (data_143e8d518 s> *rdi_1)
    _Init_thread_header(&data_143e8d518)
    
    if (data_143e8d518 == 0xffffffff)
        ...
        data_143e8d510 = rax_9
        _Init_thread_footer(&data_143e8d518)

if (data_143e8d538 s> *rdi_1)
    _Init_thread_header(&data_143e8d538)
    
    if (data_143e8d538 == 0xffffffff)
        ...
        data_143e8d530 = rax_12
        _Init_thread_footer(&data_143e8d538)

if (data_143e8d558 s> *rdi_1)
    _Init_thread_header(&data_143e8d558)
    
    if (data_143e8d558 == 0xffffffff)
        ...
        data_143e8d550 = rax_15
        _Init_thread_footer(&data_143e8d558)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d510
int64_t rcx
...
label_1412b01f3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412b01ee
        
        rbx.b = 1
        goto label_1412b01f3
