...
if (arg3[0x2f].b == 0)
    r12 = sub_14065fb60(&var_b8, &arg3[0x1e])
    rdi = 8
else
    int64_t var_1c0
    arg4 = sub_140a96170(&var_1c0)
    int64_t rax_2 = arg3[0x2c]
    var_190 |= 1
    int64_t var_188_1 = rax_2
    void* rax_3 = arg3[0x2d]
    char var_1a8_1 = 0
    var_1a0 = 0
    int32_t var_198_1 = 0
    ...
    int32_t var_178_1 = arg3[0x2e].d
    char var_170_1 = arg3[0x2f].b
    int64_t var_168 = 0
    int32_t var_160_1 = 0
    sub_140692f90(&var_168, &arg3[0x30])
...
sub_140e23130(*arg1, arg3, &arg3[6], &arg3[8], arg4, &arg3[0xc], &arg3[0xf], arg3[0x12].d, 
    &arg3[0x13], &arg3[0x19], &arg3[0x1d], *(arg3 + 0x94), *(arg3 + 0x95), *(arg3 + 0x96), r12, 
    &arg3[0x32])
