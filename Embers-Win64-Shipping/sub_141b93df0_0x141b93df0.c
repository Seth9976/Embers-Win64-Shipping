...
int64_t var_30 = 0
int32_t var_28 = 0
sub_140f60400(rcx_3, &var_48)
sub_140745b20(&var_30)
sub_140f5e570(*(arg1 + 0x50), zx.d(*(arg1 + 0x48)))
sub_140f61770(*(arg1 + 0x50), zx.d(*(arg1 + 0x49)))
...
int64_t result = sub_140f5d870(*(arg1 + 0x50), rdx_4)
