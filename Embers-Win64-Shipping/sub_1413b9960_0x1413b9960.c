        ...
        while (true)
            ...
            if (rax_10 s<= 8)
                for (; i u> r10_1; i -= 0x10)
                    ...
                    uint128_t* rcx_14 = &r10_1[1]
                    
                    if (&r10_1[1] u<= i)
                        do
                            void* r8_2 = *(rdx_3 + 8)
                            void* rax_25 = *(rcx_14 + 8)
                            zmm0_2 = *(r8_2 + 0x34)
                            zmm1 = *(rax_25 + 0x34)
                            
                            if (zmm0_2.d f== zmm1.d)
                                r8_2.b = *(r8_2 + 0x3c) u< *(rax_25 + 0x3c)
                            else
                                r8_2.b = zmm1.d f> zmm0_2.d
                            
                            uint128_t* rax_27 = rcx_14
            ...
            while (true)
                ...
                if (rdx_1 u<= i)
                    void* rcx_5 = *(r10_1 + 8)
                    uint64_t rax_14 = *(rdx_1 + 8)
                    zmm0_2 = *(rcx_5 + 0x34)
                    zmm1 = *(rax_14 + 0x34)
                    
                    if (zmm0_2.d f== zmm1.d)
                        rax_14.b = *(rcx_5 + 0x3c) u< *(rax_14 + 0x3c)
                    else
                        rax_14.b = zmm1.d f> zmm0_2.d
                ...
                do
                    ...
                    if (zmm0_2.d f== zmm1.d)
                        rax_15.b = *(rcx_6 + 0x3c) u< *(rax_15 + 0x3c)
                    else
                        rax_15.b = zmm1.d f> zmm0_2.d
                while (rax_15.b == 0)
