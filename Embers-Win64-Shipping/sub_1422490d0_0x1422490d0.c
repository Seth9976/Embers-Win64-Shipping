...
label_1422491c0:
    ...
    if (sub_142242e60(arg1, arg1[1].d - *(arg1 + 0x34), 0) == 0)
        void* r9 = &arg1[7]
        ...
        arg4[3] = *(rax_10 + (((sx.q(arg1[9].d) - 1) & r8_2) << 2))
        void* rax_12 = *(r9 + 8)
    ...
    label_142249160:
        ...
        while (true)
            ...
            if (*(rdx_3 + (rcx_1 << 2)) == *arg4 && *(rdx_3 + (rcx_1 << 2) + 4) == arg4[1])
                break
            
            rbx_1 = *(rdx_3 + (rcx_1 << 2) + 0xc)
            
            if (rbx_1 == 0xffffffff)
                goto label_142249160
