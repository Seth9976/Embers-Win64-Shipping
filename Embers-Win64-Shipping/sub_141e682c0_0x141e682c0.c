...
while (true)
    int64_t* rdi_2 = sx.q(r15_1) * 0x90 + *rbx
    int64_t rbx_1 = *rdi_2
    int32_t rax_13 = sub_140b5ead0(rbx_1.d)
    int32_t rcx_7 = (*r14 - 1) & (rax_13 + (rbx_1 u>> 0x20).d)
    ...
    *(rdi_2 + 0x8c) = rcx_7
    ...
    rdi_2[0x11].d = *(rax_15 + (((sx.q(*r14) - 1) & r8_7) << 2))
    ...
    *(rax_17 + (((sx.q(*r14) - 1) & r8_7) << 2)) = r15_1
