...
int64_t arg_8 = *(sub_141ae21a0() + 0x18)
int16_t* var_38
...
wchar16 const* const r8_1 = u"false"

if (*(arg1 + 0x30) != 0)
    r8_1 = u"true"

sub_140a2e390(&var_38, u"(Mesh Space Additive: %s)", r8_1)
int32_t r8_3
...
var_38 = nullptr
var_30_1.q = 0
sub_141e21d10(arg1 + 0x10, UnDecorator::getTemplateArgumentList(arg2, 0x3f800000, &var_38))
var_38 = nullptr
var_30_1.q = 0
int64_t result =
    sub_141e21d10(arg1 + 0x20, UnDecorator::getTemplateArgumentList(arg2, 0x3f800000, &var_38))
