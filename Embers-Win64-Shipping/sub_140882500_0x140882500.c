...
UnDecorator::getReferenceType(var_58, u"Niagara", 0x10)
sub_140b7c510()
...
int32_t rax_7 = var_50_1 + 0x13
var_50_1 = rax_7

if (rax_7 s> 0)
    sub_140594770(&var_58)

int64_t result = UnDecorator::getReferenceType(var_58, u"/Plugin/FX/Niagara", 0x26)
