...
label_141a459be:
    ...
    if (r8_3 u>= 4)
        ...
        rbp = 1 << ((not.d(rcx_9 << 0x1a s>> 0x1f)).b & (0x20 - r9))
    ...
    if (r8_3 s> 0 && (rax_8 == 0 || rax_8 s< rbp))
        ...
        arg4[0x2e] = *(rax_12 + (((sx.q(arg1[9].d) - 1) & r8_4) << 2))
        void* rax_14 = *(r9_1 + 8)
    ...
    if (rbx_1 == 0xffffffff)
        ...
        *(rdi_2 + 0xb0) = 0
        int64_t rcx_3 = *(rdi_2 + 0xa8)
        
        if (rcx_3 != 0)
            sub_140a74f90(rcx_3)
        
        sub_141a32530(rdi_2 + 0x68)
        *(rdi_2 + 0x60) = 0
        int64_t rcx_5 = *(rdi_2 + 0x58)
        
        if (rcx_5 != 0)
            sub_140a74f90(rcx_5)
        
        sub_141a32460(rdi_2 + 0x18)
        memmove(rdi_2, arg4, 0xb8)
        sub_140808630(arg1, arg5, 1)
        r11 = zx.q(arg3)
        rdi_3 = rbx_1
    
    if (rbx_1 == 0xffffffff)
        goto label_141a459be
