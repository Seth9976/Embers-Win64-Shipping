...
if (data_143e8a990 s> *rdi_1)
    _Init_thread_header(&data_143e8a990)
    
    if (data_143e8a990 == 0xffffffff)
        ...
        data_143e8a988 = rax_12
        _Init_thread_footer(&data_143e8a990)

if (data_143e8a9a0 s> *rdi_1)
    _Init_thread_header(&data_143e8a9a0)
    
    if (data_143e8a9a0 == 0xffffffff)
        ...
        data_143e8a998 = rax_15
        _Init_thread_footer(&data_143e8a9a0)

if (data_143e8a9b0 s> *rdi_1)
    _Init_thread_header(&data_143e8a9b0)
    
    if (data_143e8a9b0 == 0xffffffff)
        ...
        data_143e8a9a8 = rax_18
        _Init_thread_footer(&data_143e8a9b0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8a988
int64_t rcx
...
label_1412a3ae8:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412a3ae3
    
    rbx.b = 1
    goto label_1412a3ae8
