...
if (arg1[1] == 0)
    ...
    arg3.b = 1
    sub_1429bf050(arg1, arg2, arg3.b, *arg1, arg4)
    return arg2
...
if (arg3 == *r13_1)
    ...
    if (rdx - i s< 0)
        ...
        void* r8_1
        r8_1.b = 1
        sub_1429bf050(arg1, arg2, r8_1.b, arg3, arg4)
        return arg2
else if (arg3 != r13_1)
    void* rdi_1 = &arg3[4]
    void** rax_6 = arg4
    ...
    if (rdx_6 - i_1 s< 0)
        ...
        if (rdx_8 - i_2 s< 0)
            ...
            if (*(r9_3[2] + 0x19) != 0)
                sub_1429bf050(arg1, arg2, 0, r9_3, arg4)
                return arg2
            
            r8_7.b = 1
            sub_1429bf050(arg1, arg2, r8_7.b, arg3, arg4)
            return arg2
    ...
    if (rcx_6 - i_3 s< 0)
        ...
        if (*rax_10 == r13_1 || rdx_13 - i_4 s< 0)
            ...
            if (*(arg3[2] + 0x19) != 0)
                sub_1429bf050(arg1, arg2, 0, arg3, arg4)
                return arg2
            
            r8_8.b = 1
            sub_1429bf050(arg1, arg2, r8_8.b, r9_5, arg4)
            return arg2
else
    void** r9_2 = r13_1[2]
    void* rax_4 = &r9_2[4]
    ...
    if (rdx_3 - i_5 s< 0)
        ...
        sub_1429bf050(arg1, arg2, 0, r9_2, arg4)
        return arg2

void* var_28
*arg2 = *sub_1429bf580(arg1, &var_28, 0, arg4, arg5)
return arg2
