...
while (true)
    ...
    if (result.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0x18 && rcx_7 == arg1 + 8)
        return result
    
    int64_t* rdx_11 = result * 0x30 + *rcx_7
    
    if (*rdx_11 == arg2 && rdx_11[1] == arg3)
        return sub_141d208d0(arg1 + 8, rdx_11)
