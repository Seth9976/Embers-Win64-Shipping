...
if (sub_142bf7510(arg2, arg1, 2) != 0
        && sub_142bf7510(arg2, &arg1[2], ((zx.d(*arg1) << 8) + zx.d(arg1[1])) << 3) != 0)
    ...
    label_142bf9d2c:
        ...
        while (true)
            int64_t r8_4 = *(arg2 + 8)
            void* r10_2 = &arg1[2 + (zx.q(rdi) << 3)]
            int32_t rcx_2
            
            if (r8_4 u<= r10_2 && r10_2 u<= *(arg2 + 0x10) && arg2[4] - r10_2.d u>= 8)
                rcx_2 = arg2[6]
                arg2[6] = rcx_2 - 1
            
            char r11_1
            
            if (r8_4 u> r10_2 || r10_2 u> *(arg2 + 0x10) || arg2[4] - r10_2.d u< 8 || rcx_2 s<= 0)
                r11_1 = 0
            else
                r11_1 = 1
            ...
            int64_t var_48_1 = r8_4
            int32_t var_50_1 = 8
            void* var_58_1 = r10_2 + 8
            void* var_60_1 = r10_2
            char const* const var_68_1 = "check_range [%p..%p] (%d bytes) in [%p..%p] -> %s"
            int64_t var_70_1 = 0
            int32_t var_78_1 = *arg2 + 1
            
            if (r11_1 != 0 && sub_142bf9f90(r10_2 + 4, arg2, arg3).b != 0)
                rdi += 1
                
                if (rdi u>= rbp_1 + result.d)
                    goto label_142bf9d2c
