...
if ((arg1[5].b & 1) == 0)
    ...
    if (rax_6 s> 0)
        do
            int32_t* rdx_12 = (sx.q(i) << 4) + *arg2
            sub_1409ac7a0(sub_1409ac7a0(arg1, rdx_12, arg3), &rdx_12[2], arg3)
            i += 1
        while (i s< arg2[1].d)
...
if (rax_6 s> 0)
    do
        ...
        sub_1409ac7a0(sub_1409ac7a0(arg1, rdx_8, arg3), &rdx_8[2], arg3)
        rbp += 1
    while (rbp s< arg_8)
