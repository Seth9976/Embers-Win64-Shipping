...
if (sub_14103c200(&var_130, rbx, arg4) != 0)
    int32_t r8 = *(rbx + 0xd4)
    rbx[0x1a].d = rsi.d
    ...
    rbx[0x1b].d = var_78
    int32_t rdx_11 = rbx[0x16].d
    
    if (rdx_11 s> *(rbx + 0x4c))
        sub_1405c5510(&rbx[8], rdx_11)
