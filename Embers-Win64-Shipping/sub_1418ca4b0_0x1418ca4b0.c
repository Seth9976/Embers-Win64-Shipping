...
if (r9 == 0)
    ...
    *(rbx_1 + (rdx_5 << 2)) &= not.d(1 << (rdi_1.b & 0x1f))
    ...
    rbp = sx.q(arg1[6].d)
    int64_t r10_1 = *arg1
    int64_t rdx = sx.q(*(r10_1 + rbp * 0x30 + 4))
    arg1[6].d = rdx.d
    *(arg1 + 0x34) = r9 - 1
    
    if (r9 != 1)
        *(r10_1 + rdx * 0x30) = 0xffffffff
...
sub_1418ce670(rbx_4, arg2)
*(rbx_4 + 0x18) = *arg3
rbx_4[5].d = 0xffffffff
int32_t arg_8
sub_1418df550(arg1, &arg_8, rbx_4[2].d, rbx_4, rbp.d, nullptr)
return *arg1 + 0x18 + sx.q(arg_8) * 0x30
