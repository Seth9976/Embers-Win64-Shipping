...
int64_t r12_9 = data_1439b5f08

if (*(arg1 + 0x196) u> 0)
    uint32_t rdi_7 = zx.d(*(arg1 + 0x194))
    void*** rcx_69 = (*(arg2 + 0x30) + 7) & 0xfffffffffffffff8
    void* rax_53 = &rcx_69[5]
    ...
    *(arg2 + 8) = &rcx_69[1]
    rcx_69[1] = 0
    *rcx_69 = &data_142d99560
    rcx_69[2] = r15
    rcx_69[3].d = rdi_7
    rcx_69[4] = r12_9

int64_t rdi_8 = data_1439b5f28

if (*(arg1 + 0x19a) u> 0)
    uint32_t r12_10 = zx.d(*(arg1 + 0x198))
    void*** rcx_75 = (*(arg2 + 0x30) + 7) & 0xfffffffffffffff8
    void* rax_56 = &rcx_75[5]
