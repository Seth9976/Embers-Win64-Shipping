...
if (0 s< r10)
    ...
    do
        sub_14077a5e0(arg2, &arg_8, *var_78.q + sx.q(i) * 0xc, nullptr)
...
if (0 s< r9_2)
    ...
    do
        sub_14077a5e0(arg2, &arg_8, *var_78_1.q + sx.q(i_1) * 0xc, nullptr)
