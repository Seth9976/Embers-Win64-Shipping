...
if (r10 == 0)
    ...
    uint32_t zmm0_2[0x4]
    zmm0_2, zmm6, zmm7, zmm8 = sub_1408b3f80(&arg7, arg6, &var_b8)
    zmm10 = zmm0_2
    zmm12 = 0x3f800000
    zmm13 = 0x3f800000
    result = zx.q(*arg5)
    ...
    if (result.d s> 1)
        ...
        do
            ...
            zmm0_2, result, zmm6, zmm7, zmm8, zmm9 = sub_1408b3f80(&arg7, arg6, &var_b8)
    ...
    zmm11 = zmm7
    arg7.d = rbx_1
    zmm10[0] = zmm10[0] f* *arg8
    zmm11[0] = zmm11[0] f* arg8[1]
    zmm7[0] = zmm7[0] f* arg8[2]
    var_b8 = zmm10[0]
    uint32_t var_b4_2 = zmm11[0]
    uint32_t var_b0_2 = zmm7[0]
    uint32_t zmm0_1[0x4]
    zmm0_1, zmm7 = sub_1408b3f80(&arg7, arg6, &var_b8)
    ...
    if (result.d s> 1)
        ...
        do
            ...
            zmm12.d = zmm12.d f* zmm14[0]
            zmm0_1, result, zmm6, zmm7, zmm8, zmm9 = sub_1408b3f80(&arg7, arg6, &var_b8)
    ...
    return sub_1408b45c0(rcx, arg3, arg4, arg5, arg6, &var_b8)
return result
