...
void* arg_10 = arg2
int32_t result_1 = *(arg2 + 0x70) & zx.d(*(arg1 + 0x3b68))
...
do
    ...
    if (rax_2.d != 0)
        ...
        do
            ...
            zmm6 = sub_14103d810(arg1 + 0x250, rdx, zx.d(rbx_1.b))
            rbx_1 = *rdi_2
            rdi_2 = &rdi_2[1]
    ...
    if (rax_14.d != 0)
        ...
        do
            ...
            sub_14103d810(arg1 + 0x250, rdx_1, zx.d(rcx_12.b))
            rcx_12 = *rbx_3
            rbx_3 = &rbx_3[1]
    ...
    if (rax_21.d != 0)
        ...
        do
            ...
            if (*(arg1 + (r8_4 << 3) + 0x30f8) != rcx_15)
                *(arg1 + (r8_4 << 3) + 0x30f8) = rcx_15
                *(arg1 + 0x2ef0) |= (1 << (r8_4.d u% 0x20)).w
