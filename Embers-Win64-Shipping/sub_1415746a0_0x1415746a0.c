...
rax_3, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13, zmm15 =
    sub_1416a3cd0(arg1, arg2, arg3, arg4, var_288)
int32_t rsi_1
            ...
            if (rdx_5 s< 0x80)
                ...
                label_1415750cc:
                    ...
                    rax_23, zmm6_2, zmm7_2, zmm8_2, zmm9_2, zmm10_2, zmm11_2, zmm14_1, zmm15_1 =
                        sub_1417092b0(arg4, &var_140, &var_198)
                    ...
                    if (not(zmm14_1 f< zmm13_1.d))
                        ...
                        *(rax_39 + (rcx_18 << 2) + 8) = rax_24
                        ...
                        if (r8_12 s>= 3)
                            ...
                            zmm12 = 0x80000000
                            r13_1 = var_258_1:4.d
                            goto label_1415750cc
            
        label_1415750e3:
            rbx_1 = var_260
            goto label_14157511a
