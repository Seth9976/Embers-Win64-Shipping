...
while (true)
    char* r9_4 = sx.q(r10_2) * 0xb0 + *rbx
    uint64_t r8_9 = zx.q(*rsi_1 - 1) & zx.q(*r9_4)
    ...
    *(r9_4 + 0xa8) = *(rax_15 + (((sx.q(*rsi_1) - 1) & r8_9) << 2))
    ...
    *(rax_17 + (((sx.q(*rsi_1) - 1) & r8_9) << 2)) = r10_2
