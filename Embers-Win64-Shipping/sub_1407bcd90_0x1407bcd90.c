...
if (rdi == 0 || r14_1 == 0 || *(rdi + 0x728) != 0)
    ...
    if (data_143ce2480
        ...
        _Init_thread_header(&data_143ce2480)
        
        if (data_143ce2480 == 0xffffffff)
            sub_140b58170(&arg_18, "ID", 1)
            data_143ce2458 = arg_18.q
            data_143ce2460 = data_14396f138
            data_143ce2468 = data_14396f140
            data_143ce246a = 0xffffffff
            data_143ce2470 = 0
            data_143ce2478 = 0
            atexit(sub_142cb2a60)
            _Init_thread_footer(&data_143ce2480)
    
    result = zx.q(*(r14_1 + 0xb0))
    arg_18 = result.d
    
    if (*(r14_1 + 0x40) s> 0)
        int64_t var_240_1 = data_14396f0e8
        ...
        int128_t zmm6_1
        result, zmm6_1 =
            sub_14077dde0(&var_d8, *(rdi + 0x778), sub_140745220(&var_78, &data_143ce2458))
                    ...
                    if (rdx_6.d s>= 0 && rdx_6.d s< arg_18)
                        ...
                        if (r9_2 == r8_2.d && rcx_9 == *rdx_4)
                            ...
                            if (var_120 == 0 || var_118 == 0 || var_110 == 0 || var_108 == 0
                                ...
                                var_258_1 = zmm6.d
                                int32_t var_254_2 = zmm6:4.d
                                int32_t var_250_2 = zmm6:8.d
                                int32_t var_24c_2 = zmm6:0xc.d
                            else
