...
if (rdx == 0)
    ...
    rdi = sx.q(arg1[6].d)
    int64_t r10_1 = *arg1
    int64_t r8 = sx.q(*(r10_1 + rdi * 0x50 + 4))
    arg1[6].d = r8.d
    *(arg1 + 0x34) = rdx - 1
...
int64_t* r15_2 = sx.q(rdi.d) * 0x50 + *arg1
int64_t rcx_8 = **arg3
*r15_2 = rcx_8
...
label_141e6e340:
    ...
    if (sub_140864250(arg1, r10_3, 0) == 0)
        void* r9_1 = &arg1[7]
        ...
        *(r15_2 + 0x4c) = rax_29
        ...
        r15_2[9].d = *(rax_30 + (((sx.q(arg1[9].d) - 1) & r8_4) << 2))
        void* rax_32 = *(r9_1 + 8)
    ...
    label_141e6e2f9:
        ...
        while (true)
            int64_t rcx_18 = sx.q(rbx_1) * 0xa
            
            if (*(rdx_18 + (rcx_18 << 3)) == rcx_8)
                break
            
            rbx_1 = *(rdx_18 + (rcx_18 << 3) + 0x48)
            
            if (rbx_1 == 0xffffffff)
                goto label_141e6e2f9
    
    r13.b = rbx_1 != 0xffffffff
    
    if (rbx_1 == 0xffffffff)
        goto label_141e6e340
    
    memmove(sx.q(rbx_1) * 0x50 + *arg1, r15_2, 0x48)
    sub_1407c2c60(arg1, rdi.d, 1)
    rdi = zx.q(rbx_1)
