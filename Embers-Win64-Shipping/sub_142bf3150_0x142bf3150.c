...
if (*(result + 0x148) == sub_142bf2ff0)
    ...
    if (i_2.d != 0)
        ...
        do
            ...
            if (rax_3 != 0)
                rdx_2 = sx.q(*(rax_3 + 0x20))
                rax_4 = sx.q(*(arg1 + 0x20))
    ...
    do
        void* rax = *(arg1 + 0x40)
        result = (*(rax + 0x148))(arg1, *(arg1 + 0x48), zx.q(*rsi), *(rax + 0x38))
        *rbx_1 = result.d
        rsi += zx.q(arg6)
        rbx_1 += zx.q(arg8)
        i_1 = i_2
