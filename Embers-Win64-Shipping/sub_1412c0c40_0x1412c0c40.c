...
if (data_143e8b998 s> *rdi_1)
    _Init_thread_header(&data_143e8b998)
    
    if (data_143e8b998 == 0xffffffff)
        ...
        data_143e8b990 = rax_12
        _Init_thread_footer(&data_143e8b998)

if (data_143e8b9b8 s> *rdi_1)
    _Init_thread_header(&data_143e8b9b8)
    
    if (data_143e8b9b8 == 0xffffffff)
        ...
        data_143e8b9b0 = rax_15
        _Init_thread_footer(&data_143e8b9b8)

if (data_143e8b9d8 s> *rdi_1)
    _Init_thread_header(&data_143e8b9d8)
    
    if (data_143e8b9d8 == 0xffffffff)
        ...
        data_143e8b9d0 = rax_18
        _Init_thread_footer(&data_143e8b9d8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b990
int64_t rcx
...
label_1412c0d38:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412c0d33
    
    rbx.b = 1
    goto label_1412c0d38
