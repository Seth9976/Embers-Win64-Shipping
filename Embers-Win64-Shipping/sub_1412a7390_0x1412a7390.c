...
if (data_143e8e7f0 s> *rdi_1)
    _Init_thread_header(&data_143e8e7f0)
    
    if (data_143e8e7f0 == 0xffffffff)
        ...
        data_143e8e7e8 = rax_12
        _Init_thread_footer(&data_143e8e7f0)

if (data_143e8e800 s> *rdi_1)
    _Init_thread_header(&data_143e8e800)
    
    if (data_143e8e800 == 0xffffffff)
        ...
        data_143e8e7f8 = rax_15
        _Init_thread_footer(&data_143e8e800)

if (data_143e8e810 s> *rdi_1)
    _Init_thread_header(&data_143e8e810)
    
    if (data_143e8e810 == 0xffffffff)
        ...
        data_143e8e808 = rax_18
        _Init_thread_footer(&data_143e8e810)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e7e8
int64_t rcx
...
label_1412a7488:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412a7483
    
    rbx.b = 1
    goto label_1412a7488
