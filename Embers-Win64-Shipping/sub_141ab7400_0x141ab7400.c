...
int64_t arg_8 = *(sub_141ae2320() + 0x18)
int16_t* var_38
...
if (*(arg1 + 0x18) s> 0)
    ...
    do
        int128_t* rax_1 = *(arg1 + 0x30)
        int64_t rbx_1 = *(arg1 + 0x10)
        var_38 = nullptr
        var_30_1.q = 0
        result = sub_141e21d10((sx.q(i) << 4) + rbx_1, 
            UnDecorator::getTemplateArgumentList(arg2, *(rax_1 + rbp_1), &var_38))
        i += 1
        rbp_1 += 4
    while (i s< *(arg1 + 0x18))
