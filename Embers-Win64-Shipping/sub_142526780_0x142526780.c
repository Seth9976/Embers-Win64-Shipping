...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_19[4]
    sub_140d30490(arg2, &var_178, r8_19)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_25[4]
    r9 = sub_140d30490(arg2, &var_174, r8_25)
else
...
var_d8 = zmm1
char result = sub_1420d52e0(rcx_15, &var_118, &var_128, r9, rcx_14, r12.b, r14, rax_19)
int64_t rcx_16 = var_160
*arg3 = result
