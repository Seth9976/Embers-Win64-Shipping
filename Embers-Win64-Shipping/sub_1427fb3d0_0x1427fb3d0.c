...
if ((*(*rax_1 + 0x28))(rax_1) != 0)
    rax_3 = __std_type_info_name(&data_143ccd058, &data_14401b730)
else
...
if (rax_4 == 0)
    ...
    int64_t rdx = *arg1
    var_28.q = arg4
    result = sub_1427fc7d0(rax_4, (*(rdx + 0x20))(arg1, rdx), arg2, arg3, var_28, arg5)
...
int64_t rax_8 = (*(*arg1 + 0xf0))(arg1, arg2, arg4, r9_1, &data_143b7c0d0, 0x80)
result[0xc] = rax_8
