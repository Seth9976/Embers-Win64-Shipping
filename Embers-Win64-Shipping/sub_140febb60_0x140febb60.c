...
if (arg4 != 1)
    ...
    if (rax_25 s< 0)
        ...
        "GetInitReference())", 
            ...
            0x663, *(arg1 + 0x60), *(arg1 + 0x64), *(arg1 + 0x68), var_68, var_120, var_118.b, 
    ...
    int64_t* rcx_16 = *(*(arg1 + 0x88) + 0x150)
    int32_t rax_39 = (*(*rcx_16 + 0x70))(rcx_16, result_1, 0, 1, 0, var_140_2)
    ...
    *arg5 = var_80
    ...
    goto label_140febebb

if (arg6 == 0 && (*(arg1 + 0xf8) & 0x20) != 0)
    int32_t var_140
    var_140.q = &result_1
    int64_t* rcx_3 = *(*(arg1 + 0x88) + 0x150)
    int32_t rax_17 = (*(*rcx_3 + 0x70))(rcx_3, *(arg1 + 0xa8), zx.q(rsi_2), 2, 0, var_140)
