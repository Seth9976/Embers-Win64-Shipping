...
if (data_143e8da80 s> *rdi_1)
    _Init_thread_header(&data_143e8da80)
    
    if (data_143e8da80 == 0xffffffff)
        ...
        data_143e8da78 = rax_9
        _Init_thread_footer(&data_143e8da80)

if (data_143e8daa0 s> *rdi_1)
    _Init_thread_header(&data_143e8daa0)
    
    if (data_143e8daa0 == 0xffffffff)
        ...
        data_143e8da98 = rax_12
        _Init_thread_footer(&data_143e8daa0)

if (data_143e8dac0 s> *rdi_1)
    _Init_thread_header(&data_143e8dac0)
    
    if (data_143e8dac0 == 0xffffffff)
        ...
        data_143e8dab8 = rax_15
        _Init_thread_footer(&data_143e8dac0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8da78
int64_t rcx
...
label_1412a09a0:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412a099e
        
        rbx.b = 1
        goto label_1412a09a0
