...
if (data_143e8d398 s> *rdi_1)
    _Init_thread_header(&data_143e8d398)
    
    if (data_143e8d398 == 0xffffffff)
        ...
        data_143e8d390 = rax_12
        _Init_thread_footer(&data_143e8d398)

if (data_143e8d3b8 s> *rdi_1)
    _Init_thread_header(&data_143e8d3b8)
    
    if (data_143e8d3b8 == 0xffffffff)
        ...
        data_143e8d3b0 = rax_15
        _Init_thread_footer(&data_143e8d3b8)

if (data_143e8d3d8 s> *rdi_1)
    _Init_thread_header(&data_143e8d3d8)
    
    if (data_143e8d3d8 == 0xffffffff)
        ...
        data_143e8d3d0 = rax_18
        _Init_thread_footer(&data_143e8d3d8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d390
int64_t rcx
...
label_1412af4e8:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412af4e3
    
    rbx.b = 1
    goto label_1412af4e8
