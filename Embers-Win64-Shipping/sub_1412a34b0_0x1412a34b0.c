...
if (data_143e8ab90 s> *rdi_1)
    _Init_thread_header(&data_143e8ab90)
    
    if (data_143e8ab90 == 0xffffffff)
        ...
        data_143e8ab88 = rax_12
        _Init_thread_footer(&data_143e8ab90)

if (data_143e8aba0 s> *rdi_1)
    _Init_thread_header(&data_143e8aba0)
    
    if (data_143e8aba0 == 0xffffffff)
        ...
        data_143e8ab98 = rax_15
        _Init_thread_footer(&data_143e8aba0)

if (data_143e8abb0 s> *rdi_1)
    _Init_thread_header(&data_143e8abb0)
    
    if (data_143e8abb0 == 0xffffffff)
        ...
        data_143e8aba8 = rax_18
        _Init_thread_footer(&data_143e8abb0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8ab88
int64_t rcx
...
label_1412a35a8:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412a35a3
    
    rbx.b = 1
    goto label_1412a35a8
