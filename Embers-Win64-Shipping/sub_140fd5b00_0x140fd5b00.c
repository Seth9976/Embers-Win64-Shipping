...
void* rax_30 = var_138
sub_1419a2ec0(rax_29, &var_158, &data_143f1e6c0, 0)
void* r8_6 = var_158.q
int64_t rax_31 = 0
var_180 = r8_6
...
int128_t zmm3
int512_t zmm6
zmm2, zmm3, zmm6 = sub_1419d8470(rax_30, arg2, arg11, arg12, var_198, arg10[1])

if (*(arg2 + 0x14) u> 0)
    zmm2, zmm3, zmm6 = sub_14196fa90(&data_143f02b88, arg2, zmm2, zmm3)

if (arg3 != 0)
    void* rdx_13 = arg3 + 0x68
    ...
    int32_t var_190_1 = 0
    var_198.q = *(arg3 + 0x58)
    sub_140fd5010(arg1, rdx_13, *(arg3 + 0xa8), zx.d(*(var_180 + 0x118)))
...
if (arg3 != 0)
    void* rdx_15 = arg3 + 0x68
    
    if (arg3 == 0)
        rdx_15 = nullptr
    
    sub_140fdf350(arg1, rdx_15, 0)
