...
if (data_143e8a810 s> *rdi_1)
    _Init_thread_header(&data_143e8a810)
    
    if (data_143e8a810 == 0xffffffff)
        ...
        data_143e8a808 = rax_9
        _Init_thread_footer(&data_143e8a810)

if (data_143e8a820 s> *rdi_1)
    _Init_thread_header(&data_143e8a820)
    
    if (data_143e8a820 == 0xffffffff)
        ...
        data_143e8a818 = rax_12
        _Init_thread_footer(&data_143e8a820)

if (data_143e8a830 s> *rdi_1)
    _Init_thread_header(&data_143e8a830)
    
    if (data_143e8a830 == 0xffffffff)
        ...
        data_143e8a828 = rax_15
        _Init_thread_footer(&data_143e8a830)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8a808
int64_t rcx
