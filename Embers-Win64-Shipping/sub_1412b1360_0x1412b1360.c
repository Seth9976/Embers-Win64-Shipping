...
if (data_143e8d418 s> *rdi_1)
    _Init_thread_header(&data_143e8d418)
    
    if (data_143e8d418 == 0xffffffff)
        ...
        data_143e8d410 = rax_12
        _Init_thread_footer(&data_143e8d418)

if (data_143e8d438 s> *rdi_1)
    _Init_thread_header(&data_143e8d438)
    
    if (data_143e8d438 == 0xffffffff)
        ...
        data_143e8d430 = rax_15
        _Init_thread_footer(&data_143e8d438)

if (data_143e8d458 s> *rdi_1)
    _Init_thread_header(&data_143e8d458)
    
    if (data_143e8d458 == 0xffffffff)
        ...
        data_143e8d450 = rax_18
        _Init_thread_footer(&data_143e8d458)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d410
int64_t rcx
...
label_1412b1458:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412b1453
    
    rbx.b = 1
    goto label_1412b1458
