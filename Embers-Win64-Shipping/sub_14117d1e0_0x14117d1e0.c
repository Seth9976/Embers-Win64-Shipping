...
uint128_t zmm7 = zx.o(*(arg1 + 0x298))
void* rax_2 = &rdx_2[5]
uint128_t zmm8 = zx.o(*(arg1 + 0x294))
uint128_t zmm9 = zx.o(*(arg1 + 0x290))
uint128_t zmm6 = _mm_cvtepi32_ps(zx.o(*(arg1 + 0x29c)))
...
void* rcx_4 = *(arg1 + 0x280)
var_128:8.q = rax_9
int64_t rax_12 = 0

if (rcx_4 != 0)
    int64_t rdx_7 = sx.q(*(rcx_4 + 0x10c))
    int64_t* r15_2 = *(*(arg1 + 0x288) + 0x10)
...
int128_t var_108
var_108.q = rax_12
int32_t var_d0 = *(arg1 + 0x2b4)
sub_1419870b0(arg2, &var_128, 2)
void* rax_16 = *(arg1 + 0x270)
int64_t r8 = 0

if (rax_16 != 0)
    int64_t rdx_9 = sx.q(*(rax_16 + 0x10c))
    int64_t* r15_3 = *(*(arg1 + 0x278) + 0x10)
...
sub_141169540(arg2, arg1 + 0x270, r8, arg1 + 0x10)
void* rax_19 = *(arg1 + 0x280)
int64_t r8_1 = 0

if (rax_19 != 0)
    int64_t rdx_11 = sx.q(*(rax_19 + 0x10c))
    int64_t* r15_4 = *(*(arg1 + 0x288) + 0x10)
...
sub_141168f80(arg2, arg1 + 0x280, r8_1, arg1 + 0x140)
int32_t rsi_1 = *(arg1 + 0x2b0)
