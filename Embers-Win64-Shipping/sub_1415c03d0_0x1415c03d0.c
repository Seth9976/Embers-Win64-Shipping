...
rax_2, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm14, zmm15 =
    sub_1416e2100(r15, arg2, arg3, arg4, &var_248)
int32_t rsi_1
...
if (rax_2 != 0)
    ...
    if (var_240.d s> 0)
        do
            ...
            rax_4, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm14, zmm15 =
                sub_141743d50(sx.q(i) * 0x38 + var_248, *r15, *r12)
    ...
    label_1415c0f0a:
        zmm6_2, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_2, zmm12_2, zmm14_2, zmm15_2 =
            sub_14154a2a0(*r15, *r12, &var_128, arg5, arg6, var_1d0, arg8)
        rsi_1 = 1
    else
        zmm6 = zx.o(0)
        zmm10 = 0x80000000
            ...
            if (rdx_5 s< 0x80)
                ...
                *r14_3
                ...
                if (_mm_and_ps(temp0_7, zmm11_1)[0] f<= zmm0_2.d)
                    zmm6_2, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_2, zmm12_2, zmm14_2, zmm15_2 =
                        sub_14154a2a0(*r15, *r12, rdi_5, arg5, arg6, var_1d0, arg8)
                    rdi_1 = var_260
                    rsi_1 = 0
                    break
                
                if (not(zmm13_1 f< zmm12_1.d))
                    int32_t rcx_18 = r15[1].d
                    ...
                    var_f8_1:4.b = r10_7
                    int32_t var_22c_1 = rcx_18
                    r15[1].d = rcx_18 + 1
                    
                    if (rcx_18 + 1 s> *(r15 + 0xc))
                        sub_14083a7e0(r15)
                        rcx_18 = var_22c_1
                    
                    int64_t rcx_20 = *r15
                    int64_t rdx_14 = sx.q(rcx_18) * 3
                    int32_t rax_38 = r14_3[2]
                    *(rcx_20 + (rdx_14 << 2)) = zmm6_1.q
                    *(rcx_20 + (rdx_14 << 2) + 8) = rax_38
                    ...
                    int64_t rax_40 = *r12
                    int64_t rcx_22 = r14_5 * 3
                    int32_t var_258 = 0
                    *(rax_40 + (rcx_22 << 2)) = zmm10.q
                    *(rax_40 + (rcx_22 << 2) + 8) = r13_2
                    rdi_5[0xd].b = 1
                    int32_t var_254
                    ...
                    sub_1415c5980(&var_248, var_250_1, &var_1a0, &var_260)
                    int64_t r13_3 = sx.q(var_240.d)
                    int32_t r8_11 = var_258
                    int32_t rax_42 = r8_11 + r13_3.d
                    var_240.d = rax_42
                    ...
                    if (r8_11 s>= 3)
                        ...
                        if (r8_11 s<= 0)
                            ...
                            while (true)
                                ...
                                int64_t rcx_26 = var_248
                                int64_t r15_1 = sx.q(rdx_18[rdi_6].d)
                                int64_t r14_6 = sx.q(*(&rdx_18[rdi_6] + 4))
                                int32_t* r9_5 = rcx_26 + rsi_3
                                void* r10_9 = r15_1 * 0x38 + rcx_26
                                ...
                                if (rbx_2 s<= r13_3.d)
                                    rax_48 = r8_11 + r13_3.d
                                
                                int32_t rax_50 = *(r10_9 + (r14_6 << 2))
                                int64_t rdx_23 = *arg1
                                int64_t rax_52 = sx.q(*(r10_9 + (sx.q((r14_6 + 1).d s% 3) << 2)))
                                int32_t var_1e8_1 = rax_52.d
                                int64_t rcx_29 = rax_52 * 3
                                zmm10.d = (*(rdx_23 + (rcx_29 << 2))).d f- *(r8_12 + (rcx_29 << 2))
                                zmm6.d = (*(rdx_23 + (rcx_29 << 2) + 4)).d f-
                                    *(r8_12 + (rcx_29 << 2) + 4)
                                zmm11_1 = *(rdx_23 + (rcx_29 << 2) + 8)
                                zmm11_1[0] = zmm11_1[0] f- *(r8_12 + (rcx_29 << 2) + 8)
                                int64_t rcx_30 = sx.q(rax_50) * 3
                                float zmm2_1[0x4] = *(rdx_23 + (rcx_30 << 2) + 8)
                                ...
                                label_1415c0d18:
                                    var_230_1 = zmm7[0]
                                    float var_234_2 = zmm3_1[0]
                                    var_238_1 = zmm1_1[0]
                                else
                                    var_238_1 = data_143dbb1f8[0]
                                    var_230_1 = data_143dbb200[0]
                                    float var_234_1 = data_143dbb1fc[0]
                                
                                *(r9_5 + 0xc) = var_238_1.q
                                r9_5[5] = var_230_1
                                zmm0_1 = r9_5[4]
                                zmm2_1 = r9_5[3]
                                zmm1_1 = r9_5[5]
                                ...
                                r12 = arg2
                                r15 = arg1
                                *(r10_9 + (r14_6 << 2) + 0x1c) = rbx_2
                                *(r10_9 + (r14_6 << 2) + 0x28) = 0
