                    ...
                    if (rdi_4 != 0)
                        ...
                        if (rax_26 != 0)
                            ...
                            if (rdi_4 != 0)
                                ...
                                float temp0_6[0x4] = _mm_max_ss(temp0_3[0], zmm6[0])
                                temp0_3[0] = temp0_3[0] + zmm6[0]
                                float temp0_8[0x4] =
                                    _mm_max_ss(_mm_max_ss(temp0_6[0], temp0_3[0])[0], zmm8.d)
                                ...
                                label_140d8d830:
                                    ...
                                    if (_mm_max_ss(
                                            _mm_max_ss(_mm_max_ss(temp0_3[0], zmm6[0])[0], 
                                                temp0_3[0])[0], 
                                            temp0_5[0])[0] f< *arg4)
                                        goto label_140d8d82b
                                    
                                    if (_mm_min_ss(
                                            _mm_min_ss(_mm_min_ss(temp0_3[0], zmm6[0])[0], 
                                                temp0_3[0])[0], 
                                            temp0_5[0])[0] f> arg4[2] || temp0_8[0] f< arg4[1])
                                        goto label_140d8d82b
                                    ...
                                    label_140d8d6b1:
                                        ...
                                        if (zmm11[0] < temp0_8[0])
                                            goto label_140d8d6b1
                                    
                                    rdi_4[1].d -= 1
                                    
                                    if (rdi_4[1].d == 1)
                                        goto label_140d8d83c
