        ...
        while (true)
            if (isspace(sx.d(*rbx_2)) == 0)
                ...
                if (*r14_1 != 0)
                    ...
                    int64_t zmm0 = sub_1427e6ee0(arg_8, &arg_8)
                    r14_1 = arg_8
                    var_40 = zmm0.d
                ...
                if (i u< count + 0xc)
                    ...
                    int64_t rax_11 = (*(*arg6 + 8))(arg6, zx.q(i))
                    
                    if (count != 0)
                        memcpy(rax_11, r15_1, count)
                ...
                count += 0xc
                *(count_1 + r15_1) = var_48.q
                *(count_1 + r15_1 + 8) = var_40
                break
            
            rbx_2 = &rbx_2[1]
            
            if (*rbx_2 == 0)
                goto label_1428065c5
