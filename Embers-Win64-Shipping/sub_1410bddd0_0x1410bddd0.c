...
if (data_143e2cb60 s> *rdi_1)
    _Init_thread_header(&data_143e2cb60)
    
    if (data_143e2cb60 == 0xffffffff)
        ...
        data_143e2cb58 = rax_8
        _Init_thread_footer(&data_143e2cb60)

if (data_143e2cb70 s> *rdi_1)
    _Init_thread_header(&data_143e2cb70)
    
    if (data_143e2cb70 == 0xffffffff)
        ...
        data_143e2cb68 = rax_11
        _Init_thread_footer(&data_143e2cb70)

int64_t rdi_2 = data_143e2cb68
int64_t rcx
