...
float zmm4[0x4] = _mm_permute_pd(zmm1, 1) f* *(&arg1[r8] + 0xe8)
zmm0[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm1, zmm0[0].o)
zmm1 = _mm_permute_ps(__vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zmm2, 0x88), 0xd8)
float zmm5[0x4] = __vaddps_xmmdq_xmmdq_xmmdq(zmm3, zmm1)
zmm1 = __vsubps_xmmdq_xmmdq_xmmdq(zmm1, zmm3)
...
zmm2 = __vinsertps_xmmdq_xmmdq_xmmdq_immb(__vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm4, zmm4, 0x1c), 
    zmm2, 0x60)
zmm3 = _mm_broadcast_ss(1f)
zmm0[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm2)
zmm0[0].o = __vsubps_xmmdq_xmmdq_xmmdq(zmm3, zmm0[0].o)
float zmm19[0x4] = _mm_mask_load_ss(arg5, *(arg1 + (rax << 2) + 0x60))
zmm3 = __vinsertps_xmmdq_xmmdq_memd_immb(zmm0[0].o, *(arg1 + (rax << 2) + 0x64), 0x1d)
float zmm20[0x4] =
    __vinsertps_xmmf32_xmmf32_memf32_imm8_avx512(zmm0[0].o, *(arg1 + (rax << 2) + 0x68), 0x2b)
float zmm6[0x8]
zmm6[0].o = _mm_broadcastss_ps(zmm0[0].o)
float zmm17[0x4] = _mm_mask_mul_ps(arg5, zmm19, zmm6[0].o)
zmm6[0].o = _mm_permute_ps(zmm1, 0xea)
zmm6[0].o = _mm_mask3_fmadd_ps(zmm6[0].o, arg5, zmm3, zmm17)
zmm2 = _mm_mask3_fmadd_ps(_mm_permute_ps(zmm5, 0xd5), arg5, zmm20, zmm6[0].o)
zmm17 = _mm_mask_permute_ps(arg5, zmm5, 0xea)
zmm6[0].o = _mm_permute_ps(zmm0[0].o, 0xd5)
zmm6[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm3, zmm6[0].o)
zmm6[0].o = _mm_mask3_fmadd_ps(zmm6[0].o, arg5, zmm19, zmm17)
zmm4 = _mm_mask3_fmadd_ps(_mm_broadcastss_ps(zmm1), arg5, zmm20, zmm6[0].o)
zmm17 = _mm_mask_permute_ps(arg5, zmm1, 0xd5)
zmm6[0].o = _mm_broadcastss_ps(zmm5)
zmm3 = _mm_mask3_fmadd_ps(__vmulps_xmmdq_xmmdq_xmmdq(zmm3, zmm6[0].o), arg5, zmm19, zmm17)
zmm6[0].o = _mm_permute_ps(zmm0[0].o, 0xea)
zmm6[0].o = _mm_mask3_fmadd_ps(zmm6[0].o, arg5, zmm20, zmm3)
zmm17 = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(
    __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zmm5, 0x9c), zmm1, 0x60)
zmm3 = __vinsertps_xmmdq_xmmdq_xmmdq_immb(
    __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zmm1, 0x8c), zmm5, 0x20)
...
zmm5 = _mm_mask3_fmadd_ps(__vmulps_xmmdq_xmmdq_xmmdq(zmm3, _mm_permute_ps(zmm2, 0xd5)), arg5, 
    zmm17, zmm1)
zmm19 = _mm_mask3_fmadd_ps(_mm_mask_permute_ps(arg5, zmm2, 0xea), arg5, zmm0[0].o, zmm5)
zmm1 = _mm_broadcastss_ps(zmm4)
zmm2 = _mm_mask3_fmadd_ps(__vmulps_xmmdq_xmmdq_xmmdq(zmm3, _mm_permute_ps(zmm4, 0xd5)), arg5, 
    zmm17, zmm1)
float zmm21[0x4] = _mm_mask3_fmadd_ps(_mm_mask_permute_ps(arg5, zmm4, 0xea), arg5, zmm0[0].o, zmm2)
zmm1 = _mm_broadcastss_ps(zmm6[0].o)
zmm2 = _mm_mask3_fmadd_ps(__vmulps_xmmdq_xmmdq_xmmdq(zmm3, _mm_permute_ps(zmm6[0].o, 0xd5)), arg5, 
    zmm17, zmm1)
float zmm23[0x4] =
    _mm_mask3_fmadd_ps(_mm_mask_permute_ps(arg5, zmm6[0].o, 0xea), arg5, zmm0[0].o, zmm2)
zmm0[0].o = __vmovsd_xmmdq_memq(*(arg1 + (rax << 2) + 0x80))
zmm0[0].o = __vinsertps_xmmdq_xmmdq_memd_immb(zmm0[0].o, *(arg1 + (rax << 2) + 0x88), 0x20)
zmm17 = __vinsertps_xmmf32_xmmf32_memf32_imm8_avx512(
    __vmovsd_xmmdq_memq(*(arg1 + (rax << 2) + 0xc0)), *(arg1 + (rax << 2) + 0xc8), 0x20)
double zmm30[0x2] = _mm_mask_sub_ps(arg5, zmm0[0].o, zmm17)
zmm1 = _mm_broadcast_ss(-0f)
zmm20 = _mm_mask_permute_pd(arg5, zmm30, 1)
zmm3 = _mm_mask_xor_pd(arg5, zmm20, zmm1)
...
float zmm22[0x4] = _mm_mask_permute_ps(arg5, zmm21, 0xc1)
...
zmm2 = _mm_mask3_fmadd_ps(__vmulps_xmmdq_xmmdq_xmmdq(zmm2, _mm_mask_permute_ps(arg5, zmm23, 0xda)), 
    arg5, zmm6[0].o, zmm24)
zmm6[0].o = _mm_mask_add_ps(arg5, zmm18, 
    _mm_mask3_fmadd_ps(
...
zmm2 = _mm_mask_broadcastss_ps(arg5, zmm19)
zmm3 = _mm_permute_ps(zmm1, 0xa0)[0].q | zmm30[0] << 0x40
zmm4 = _mm_fmadd_ps(
    __vmulps_xmmdq_xmmdq_xmmdq(zmm3, 
        _mm_mask_shuffle_ps(arg5, zmm23, _mm_mask_shuffle_ps(arg5, zmm21, zmm23, 0x30), 0x80)), 
    zmm0[0].o, zmm2)
...
int64_t k0 = __vcmpps_maskmskw_maskmskw_ymmf32_memf32_imm8_avx512(arg5, zmm0, 0x322bcc77, 2)
...
int64_t k1 = _mm_cmp_round_ss_mask(k0, 0x322bcc77, zmm4, 6)
zmm19 = _mm_mask_xor_ps(k0, zmm19, zmm19)
zmm6[0].o = 0xffffffff
zmm6[0].o = _mm_mask_move_ss(k1, zmm0[0].o, zmm19)
zmm0[0].o = zmm4 f* 0.5f
zmm4 = __vrsqrtss_xmmdq_xmmdq_xmmd(zmm4, zmm4[0])
zmm1 = _mm_fmadd_ss(_mm_fnmadd_ss(zmm4 f* zmm4[0], zmm0[0], 0.5f), zmm4[0], zmm4[0])
zmm0[0].o = _mm_broadcastss_ps(_mm_fmadd_ss(_mm_fnmadd_ss(zmm1 f* zmm1[0], zmm0[0], 0.5f), zmm1[0], 
    zmm1[0]))
...
int64_t k1_1 = _mm_cmp_round_ss_mask(k0, zmm19, zmm1 f+ __vmovshdup_xmmdq_xmmdq(zmm1)[0], 2)
zmm18 = _mm_mask_load_ss(k0, 1f)
zmm1 = _mm_broadcastss_ps(_mm_mask_move_ss(k1_1, zmm0[0].o, zmm18))
zmm0[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm1)
arg1[0xf] = zmm0[0].o
zmm0[0].o = *(r10 + 0xe0)
zmm1 = *(r10 + 0xe4)
zmm7 = *(r10 + 0xe8)
zmm6[0].o = *(&arg1[rax] + 0x18)
zmm5 = arg1[rax + 1].d
...
zmm7 = __vmovsd_xmmdq_memq(arg1[rax + 1].q)
zmm0[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, zmm1, 0x20)
zmm1 = __vinsertps_xmmdq_xmmdq_xmmdq_immb(__vmovsd_xmmdq_memq(*(&arg1[rax] + 0x14)), zmm5, 0x20)
...
zmm1 = __vinsertps_xmmdq_xmmdq_memd_immb(*(arg1 + (rax << 2) + 0xc0), *(arg1 + (rax << 2) + 0xc4), 
    0x10)
zmm0[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm2, zmm0[0].o)
zmm0[0].o = __vaddps_xmmdq_xmmdq_xmmdq(
    __vinsertps_xmmdq_xmmdq_memd_immb(zmm1, *(arg1 + (rax << 2) + 0xc8), 0x20), zmm0[0].o)
...
zmm2 = *(&arg1[rax] + 8)
zmm3 = *(&arg1[rax] + 4)
char temp0_323 = __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(
    _mm_mask_mul_ps(k0, 
...
zmm7 = _mm_mask3_fmadd_ps(zmm7, k0, zmm16, temp0_323)
