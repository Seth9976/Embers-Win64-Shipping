...
while (true)
    ...
    if (r14_2 != 0)
        ...
        if (rax_24.d s<= *(rdx_10 + 0x38) && *(*(rdx_10 + 0x30) + (rax_24 << 3)) == rax_23 + 0x30)
            int64_t rsi_1 = sx.q(*(arg3 + 0x48))
            int32_t rax_26 = (rsi_1 + 1).d
            *(arg3 + 0x48) = rax_26
            
            if (rax_26 s> *(arg3 + 0x4c))
                sub_1407752f0(arg3, rsi_1.d)
            
            void* rax_27 = *(arg3 + 0x40)
            void* rcx_11 = arg3
