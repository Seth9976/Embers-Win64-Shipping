...
if (data_143e8cdb0 s> *rdi_1)
    _Init_thread_header(&data_143e8cdb0)
    
    if (data_143e8cdb0 == 0xffffffff)
        ...
        data_143e8cda8 = rax_12
        _Init_thread_footer(&data_143e8cdb0)

if (data_143e8cdc0 s> *rdi_1)
    _Init_thread_header(&data_143e8cdc0)
    
    if (data_143e8cdc0 == 0xffffffff)
        ...
        data_143e8cdb8 = rax_15
        _Init_thread_footer(&data_143e8cdc0)

if (data_143e8cdd0 s> *rdi_1)
    _Init_thread_header(&data_143e8cdd0)
    
    if (data_143e8cdd0 == 0xffffffff)
        ...
        data_143e8cdc8 = rax_18
        _Init_thread_footer(&data_143e8cdd0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8cda8
int64_t rcx
...
label_14129dd98:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_14129dd93
    
    rbx.b = 1
    goto label_14129dd98
