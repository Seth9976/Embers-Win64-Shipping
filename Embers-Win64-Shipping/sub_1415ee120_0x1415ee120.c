...
while (true)
    ...
    *(&var_1a0:4 + (sx.q(i_6) << 2)) = i_6
    ...
    i_6 = r13.d + 1
    float temp0_28[0x4] = _mm_unpacklo_ps(zmm12, zmm11[0].q)
    float var_1b8_1 = zmm7[0]
    *(&var_178 + (rcx_4 << 2)) = temp0_28.q
    (&var_170)[rcx_4] = var_208
    *(&var_148 + (rcx_4 << 2)) = (_mm_unpacklo_ps(temp0_25, temp0_27[0].q)).q
    (&var_140)[rcx_4] = var_1c8_1
    int64_t var_118
    *(&var_118 + (rcx_4 << 2)) = (_mm_unpacklo_ps(zmm12, zmm11[0].q)).q
    int32_t var_110
    (&var_110)[rcx_4] = var_1b8_1
    var_1a0.d = i_6
    int32_t rax_14
    ...
    if (i_6 == 1)
        ...
        rax_14 = (&var_110)[rcx_12]
    else if (i_6 == 2)
        uint64_t* rax_17
        rax_17, zmm8, zmm9 = sub_1416e69d0(&var_260, &var_118, &var_1a0:4, &var_1a0, &var_188)
        i_6 = var_1a0.d
        zmm0 = zx.o(*rax_17)
        rax_14 = rax_17[1].d
    else if (i_6 == 3)
...
if (zmm13[0] <= zmm15[0])
    ...
    if (i_6 s> 0)
        ...
        do
            ...
            *(rcx_20 + (rdx_7 << 2)) = *(&var_178 + rbx)
            *(rcx_20 + (rdx_7 << 2) + 8) = rax_26
            ...
            rbx += 0xc
            *(rcx_22 + (rdx_9 << 2)) = zmm0_1
            *(rcx_22 + (rdx_9 << 2) + 8) = rax_28
            i = i_5
            i_5 -= 1
        while (i != 1)
    ...
    float zmm10_1[0x4]
    float zmm15_1
    rax_29, zmm9_1, zmm10_1, zmm15_1 = sub_1415831d0(&var_250, &var_260, &var_200, &var_1e8, zmm15, 
    ...
    if (rax_29 == 2)
        ...
        *arg5 = (_mm_unpacklo_ps(zmm2_1, zmm2_1[0].q)).q
        arg5[1].d = zmm2_1[0]
        zmm10_1[0] = zmm10_1[0] f* *arg7
        zmm10_1[0] = zmm10_1[0] f* arg7[1]
        zmm10_1[0] = zmm10_1[0] f* arg7[2]
        zmm9_1[0] = zmm9_1[0] - zmm10_1[0]
        zmm4_1.d = zmm4_1.d f- zmm10_1[0]
        zmm9_1[0] = zmm9_1[0] - zmm10_1[0]
        ...
        *arg4 = zmm0_2[0]
        ...
        zmm2_1[0] = zmm2_1[0] f* arg7[1]
        zmm2_1[0] = zmm2_1[0] f* arg7[2]
        zmm2_1[0] = zmm2_1[0] f+ var_220.d
        zmm2_1[0] = zmm2_1[0] f+ var_220:4.d
        int32_t var_218
        zmm2_1[0] = zmm2_1[0] f+ var_218
        *arg5 = (_mm_unpacklo_ps(zmm2_1, zmm2_1[0].q)).q
        float var_268_5 = zmm2_1[0]
        int32_t var_20c
        zmm2_1 = var_20c
        arg5[1].d = var_268_5
        zmm10_1[0] = zmm10_1[0] f* *arg7
    ...
    temp0_33[0] = temp0_33[0] + temp0_33[0]
    temp0_33[0] = temp0_33[0] * zmm9[0]
    temp0_33[0] = temp0_33[0] * zmm9[0]
    temp0_33[0] = temp0_33[0] * zmm9[0]
    float temp0_34[0x4] = _mm_unpacklo_ps(temp0_33, temp0_33[0].q)
    zmm1 = zmm10
    *arg7 = temp0_34.q
    zmm1[0] = zmm1[0] + zmm2[0]
    float temp0_35[0x4] = __sqrtss_xmmss_memss(temp0_34[0], var_264)
    float var_268_2 = temp0_33[0]
