...
float zmm13[0x4] = data_143f65c20
float zmm14[0x4] = data_143f65c60
zmm13[0].q = zx.o(0) u>> 0x40
*arg1 = _mm_shuffle_ps(zx.o(0), zmm13, 0xc4)
arg1[2] = __andps_xmmxud_memxud(zmm13, data_143f65be0)
...
if (_mm_movemask_ps(_mm_cmpeq_ps(temp0_2, zmm14, 1)) == 0)
    ...
    float temp0_140[0x4] = __mulps_xmmps_memps(temp0_136, data_143f65c10)
    ...
    float temp0_149[0x4] = __mulps_xmmps_memps(temp0_145, data_143f65c00)
    float temp0_150[0x4] = _mm_shuffle_ps(temp0_139, temp0_139, 0xd2)
    float temp0_151[0x4] = __mulps_xmmps_memps(temp0_148, data_143f65bf0)
    ...
    *arg1 = temp0_153
    ...
    arg1[1] = __addps_xmmps_memps(
        _mm_add_ps(_mm_sub_ps(temp0_163, _mm_mul_ps(temp0_164, temp0_155)), temp0_165), arg3[1])
else
    float zmm3[0x4] = *arg3
    ...
    float zmm1[0x4] = __andps_xmmxud_memxud(_mm_mul_ps(temp0_20, zmm7), data_143f65be0)
    ...
    zmm1 = __andps_xmmxud_memxud(_mm_mul_ps(temp0_48, zmm12), data_143f65be0)
    ...
    zmm14_1 =
        _mm_and_ps(_mm_cmpeq_ps(zmm14_1, zmm11_1, 2), data_143f65c50 ^ zmm13_1) ^ data_143f65c50
    ...
    float zmm5_1[0x4] = data_143f65c40
    ...
    zmm5_1 = _mm_and_ps(_mm_mul_ps(temp0_128, zmm6_1) ^ data_143f65c30, zmm0_2) ^ data_143f65c30
