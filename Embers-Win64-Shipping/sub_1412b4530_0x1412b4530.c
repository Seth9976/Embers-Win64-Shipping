...
if (data_143e8c520 s> *rdi_1)
    _Init_thread_header(&data_143e8c520)
    
    if (data_143e8c520 == 0xffffffff)
        ...
        data_143e8c518 = rax_9
        _Init_thread_footer(&data_143e8c520)

if (data_143e8c540 s> *rdi_1)
    _Init_thread_header(&data_143e8c540)
    
    if (data_143e8c540 == 0xffffffff)
        ...
        data_143e8c538 = rax_12
        _Init_thread_footer(&data_143e8c540)

if (data_143e8c560 s> *rdi_1)
    _Init_thread_header(&data_143e8c560)
    
    if (data_143e8c560 == 0xffffffff)
        ...
        data_143e8c558 = rax_15
        _Init_thread_footer(&data_143e8c560)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c518
int64_t rcx
...
label_1412b4633:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412b462e
        
        rbx.b = 1
        goto label_1412b4633
