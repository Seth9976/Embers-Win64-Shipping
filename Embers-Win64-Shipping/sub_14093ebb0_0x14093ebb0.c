...
label_14093ed13:
    ...
    if (sub_14093d600(arg1, arg1[1].d - *(arg1 + 0x34), 0) == 0)
        void* r9_3 = &arg1[7]
        int32_t rax_22 = (arg1[9].d - 1) & r12.d
        arg4[5] = rax_22
        void* rdx_11 = *(r9_3 + 8)
        int64_t r8_2 = sx.q(rax_22)
        void* rax_23 = r9_3
        
        if (rdx_11 != 0)
            rax_23 = rdx_11
        
        arg4[4] = *(rax_23 + (((sx.q(arg1[9].d) - 1) & r8_2) << 2))
        void* rax_25 = *(r9_3 + 8)
