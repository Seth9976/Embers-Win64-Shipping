...
while (true)
    ...
    if (result.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x68 && rcx_7 == arg1 + 0x58)
        return result
    
    (*(*arg2 + 0x38))(arg2, result * 0x50 + *rcx_7, 0, 0, var_88, arg1 + 0x68, var_78_2)
    int32_t var_5c
