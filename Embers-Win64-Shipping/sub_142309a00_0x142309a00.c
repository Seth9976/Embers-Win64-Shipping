...
if (rax_2 != 0)
    int64_t rax_3 = sx.q(arg1[0x5f].d)
    
    if (rax_3.d != 0)
        int32_t rdi_1 = 0
        int32_t r12_1 = 0
        int64_t r15
        r15.b = *arg1[0x5e] != rax_2
        int64_t rbx_1 = 0
        ...
        do
            ...
            if (rbx_1 s< rax_3)
                int64_t* rcx_1 = arg1[0x5e] + (rbx_1 << 3)
...
int64_t rdi_2 = sx.q(arg1[0x5f].d)
int32_t rax_7 = (rdi_2 + 1).d
arg1[0x5f].d = rax_7

if (rax_7 s> *(arg1 + 0x2fc))
    sub_1405a4d70(&arg1[0x5e])

*(arg1[0x5e] + (rdi_2 << 3)) = rsi_1
