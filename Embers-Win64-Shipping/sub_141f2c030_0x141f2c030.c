...
label_141f2c21d:
    ...
    if (sub_140d1a980(arg1, r10_3, 0) == 0)
        void* r9_1 = &arg1[7]
        int32_t rax_30 = (arg1[9].d - 1) & rbp_8
        *(r12 + 0x24) = rax_30
        void* rdx_23 = *(r9_1 + 8)
        int64_t r8_4 = sx.q(rax_30)
        void* rax_31 = r9_1
        
        if (rdx_23 != 0)
            rax_31 = rdx_23
        
        r12[4].d = *(rax_31 + (((sx.q(arg1[9].d) - 1) & r8_4) << 2))
        void* rax_33 = *(r9_1 + 8)
    ...
    label_141f2c1d6:
        ...
        while (true)
            int64_t rcx_16 = sx.q(rbx_1) * 5
            
            if (*(rdx_19 + (rcx_16 << 3)) == rcx_7)
                break
            
            rbx_1 = *(rdx_19 + (rcx_16 << 3) + 0x20)
            
            if (rbx_1 == 0xffffffff)
                goto label_141f2c1d6
    
    r13.b = rbx_1 != 0xffffffff
    
    if (rbx_1 == 0xffffffff)
        goto label_141f2c21d
    
    memmove(*arg1 + sx.q(rbx_1) * 0x28, r12, 0x20)
