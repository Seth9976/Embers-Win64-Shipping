...
if (rax_5 != 0)
    ...
    if ((*(arg1 + 0x2b) & 8) != 0 && rax_5 s> 0x40000)
        *(arg1 + 0x29) = rcx_3 | 1
        return arg1
    
    if ((arg1[5].b & 1) != 0)
        int512_t zmm1 = sub_1408ca220(arg2, rax_5)
        int32_t r14 = 0
        ...
        do
            ...
            if (rdx_7 == neg.q(*arg2))
                ...
                rdx_8[6] = 0xffff0000
                __builtin_memset(&rdx_8[8], 0, 0x20)
            
            sub_1408c8dc0(arg1, rdx_8, zmm1)
            r14 += 1
        while (r14 s< arg_8)
    ...
    if (rax_5 s> 0)
        do
            sub_1408c8dc0(arg1, (sx.q(i) << 6) + *arg2, arg3)
            i += 1
        while (i s< arg2[1].d)
else if ((arg1[5].b & 1) != 0)
    sub_1408ca220(arg2, 0)
