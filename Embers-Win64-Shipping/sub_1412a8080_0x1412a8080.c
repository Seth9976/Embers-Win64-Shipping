...
if (data_143e8a630 s> *rdi_1)
    _Init_thread_header(&data_143e8a630)
    
    if (data_143e8a630 == 0xffffffff)
        ...
        data_143e8a628 = rax_9
        _Init_thread_footer(&data_143e8a630)

if (data_143e8a640 s> *rdi_1)
    _Init_thread_header(&data_143e8a640)
    
    if (data_143e8a640 == 0xffffffff)
        ...
        data_143e8a638 = rax_12
        _Init_thread_footer(&data_143e8a640)

if (data_143e8a650 s> *rdi_1)
    _Init_thread_header(&data_143e8a650)
    
    if (data_143e8a650 == 0xffffffff)
        ...
        data_143e8a648 = rax_15
        _Init_thread_footer(&data_143e8a650)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8a628
int64_t rcx
...
label_1412a8183:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412a817e
        
        rbx.b = 1
        goto label_1412a8183
