...
if (data_143e8bea0 s> *rdi_1)
    _Init_thread_header(&data_143e8bea0)
    
    if (data_143e8bea0 == 0xffffffff)
        ...
        data_143e8be98 = rax_9
        _Init_thread_footer(&data_143e8bea0)

if (data_143e8beb0 s> *rdi_1)
    _Init_thread_header(&data_143e8beb0)
    
    if (data_143e8beb0 == 0xffffffff)
        ...
        data_143e8bea8 = rax_12
        _Init_thread_footer(&data_143e8beb0)

if (data_143e8bec8 s> *rdi_1)
    _Init_thread_header(&data_143e8bec8)
    
    if (data_143e8bec8 == 0xffffffff)
        ...
        data_143e8beb8 = rax_15
        _Init_thread_footer(&data_143e8bec8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8be98
int64_t rcx
...
label_1412b5d93:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412b5d8e
        
        rbx.b = 1
        goto label_1412b5d93
