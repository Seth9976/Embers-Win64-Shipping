        ...
        do
            ...
            if (not(cond:2_1))
                ...
                if (arg_20 == 0)
                    ...
                    if (data_143ef7b20 s> *(0x14
                            + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
                        _Init_thread_header(&data_143ef7b20)
                        
                        if (data_143ef7b20 == 0xffffffff)
                            __builtin_memcpy(&data_143ef7ae0, 
                            ...
                            "00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00", 
                                0x40)
                            atexit(sub_142ce9bd0)
                            _Init_thread_footer(&data_143ef7b20)
                    
                    int128_t* i_2 = &data_143ef7ae0
