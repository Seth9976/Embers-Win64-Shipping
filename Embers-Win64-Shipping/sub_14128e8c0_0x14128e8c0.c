...
void* arg_10 = arg2
int64_t rdx = sx.q(*(arg1 + 0x1028))

if (rdx.d != 0)
    int32_t rdi_1 = 0
    int32_t r12_1 = 0
    int64_t r15
    r15.b = **(arg1 + 0x1020) != arg2
    int64_t rbx_1 = 0
    ...
    do
        ...
        if (rbx_1 s< rdx)
            int64_t* rcx = *(arg1 + 0x1020) + (rbx_1 << 3)
...
if (data_143f138f4 == 0)
    ...
    if (data_143de5480 == 0 || rax_8.b != 0)
        ...
        return sub_14125dbc0(&var_68)

void var_58
int64_t* rax_10 = sub_141266940(&var_58, nullptr, 0xff)
*(*rax_10 + 0x10) = var_78.o
void* rcx_7 = *rax_10
int32_t r8_3 = rax_10[2].d
int64_t* rdx_5 = rax_10[1]
...
int32_t result = sub_1405e48c0(rcx_7, rdx_5, r8_3, 1)
