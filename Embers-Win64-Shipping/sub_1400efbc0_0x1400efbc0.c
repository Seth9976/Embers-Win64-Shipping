...
do
    ...
    float temp0_8[0x4] = __vaddps_xmmdq_xmmdq_xmmdq(temp0_3, 
        __vmulps_xmmdq_xmmdq_xmmdq(__vmulps_xmmdq_xmmdq_xmmdq(_mm_permute_ps(zmm4, 0x1b), temp0_4), 
            zmm1))
    float temp0_9[0x4] = _mm_permute_ps(temp0_1, 0x55)
    float temp0_13[0x4] = __vaddps_xmmdq_xmmdq_xmmdq(
        __vmulps_xmmdq_xmmdq_xmmdq(__vmulps_xmmdq_xmmdq_xmmdq(_mm_permute_pd(zmm4, 1), temp0_9), 
            zmm2), 
        temp0_8)
    float temp0_14[0x4] = _mm_permute_ps(temp0_1, 0xaa)
    *rdx_2 = __vaddps_xmmdq_xmmdq_xmmdq(
