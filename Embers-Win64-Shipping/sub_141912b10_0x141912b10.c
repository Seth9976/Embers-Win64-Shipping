...
int64_t arg_48
int64_t rdi = arg_48
int32_t* var_d0 = &arg_20
char arg_30
char* var_c0 = &arg_30
int32_t arg_40
int32_t* var_b0 = &arg_40
int32_t arg_28
int32_t arg_38

if (data_143f01c92 == 0)
    sub_141946100(arg1, arg2, arg4, zx.q(arg_28), arg_30, arg_38, arg_40, rdi)
else if (sub_140a80f10() != 0)
    sub_141946100(arg1, arg2, arg_20, zx.q(arg_28), arg_30, arg_38, arg_40, rdi)
else
    ...
    *rax_3 = rdi_3
    *(arg3 + 8) = &rdi_3[1]
    void*** rax_4 = sub_140a82f30(0x48, 8)
    *rax_4 = &data_142ff5d88
    *(rax_4 + 8) = (&arg_48).o
    *(rax_4 + 0x18) = arg1.o
    *(rax_4 + 0x28) = (&arg_28).o
    *(rax_4 + 0x38) = _mm_unpacklo_pd((&arg_38).o, rdi)
    void**** (* var_58)(int64_t* arg1)
    void**** (* rax_5)(int64_t* arg1) = var_58
    
    if (rax_4 != -8)
        rax_5 = j_sub_141908630
