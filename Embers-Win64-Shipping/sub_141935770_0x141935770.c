...
if (0x400 - rcx_2.d s<= 1)
    int64_t rbx_1 = sx.q(0x400 - rcx_2.d) << 2
    memcpy(arg1 + 0x28, (rcx_2 << 2) + &data_143efcd00, rbx_1.d)
    data_143effcf0(0x400, &data_143efcd00)
    r12_1 = 1 - (0x400 - rcx_2.d)
    memcpy(rbx_1 + arg1 + 0x28, &data_143efcd00, r12_1 << 2)
else
    *(arg1 + 0x28) = *(&data_143efcd00 + (rcx_2 << 2))
    r12_1 = data_1439c74cc + 1

data_1439c74cc = r12_1
sub_141909ed0(*(arg1 + 0x28))
int64_t r9_1
