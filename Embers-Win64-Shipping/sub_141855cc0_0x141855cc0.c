...
int64_t (* var_88)(int64_t arg1, int64_t* arg2) = sub_14187adb0
void*** var_78 = nullptr
void*** rax_3 = sub_14185e720(arg4)
void* r14 = &rax_3[2]
void* var_138 = r14
void*** var_130 = rax_3
...
if (arg2 s>= 0)
    ...
    if (arg2 s<= 1)
        ...
        *(rsi_3 + 0x40) = var_58
        ...
        if (rax_19 == 0)
            sub_14185eca0(&var_138, &var_88, arg5, arg6, zmm1_2)
        else
