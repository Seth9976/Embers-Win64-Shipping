...
if (data_143e8c008 s> *rdi_1)
    _Init_thread_header(&data_143e8c008)
    
    if (data_143e8c008 == 0xffffffff)
        ...
        data_143e8c000 = rax_12
        _Init_thread_footer(&data_143e8c008)

if (data_143e8c018 s> *rdi_1)
    _Init_thread_header(&data_143e8c018)
    
    if (data_143e8c018 == 0xffffffff)
        ...
        data_143e8c010 = rax_15
        _Init_thread_footer(&data_143e8c018)

if (data_143e8c030 s> *rdi_1)
    _Init_thread_header(&data_143e8c030)
    
    if (data_143e8c030 == 0xffffffff)
        ...
        data_143e8c020 = rax_18
        _Init_thread_footer(&data_143e8c030)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c000
int64_t rcx
...
label_1412b8cd8:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412b8cd3
    
    rbx.b = 1
    goto label_1412b8cd8
