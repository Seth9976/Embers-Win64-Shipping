                    ...
                    label_141ea03db:
                        ...
                        if ((*(rcx_4 + (sx.q(rax_7 s>> 5) << 2)) & rsi_2) != 0)
                            ...
                            if (arg3[1].d != 0)
                                ...
                                if ((not.b(rbx_2) & 1) == 0 && (rcx_12.b & 1) != 0)
                                    rcx_12 = (rcx_12 s>> 1) + arg3
                                
                                rdx_3 = sx.q(rbp_2 * rax_9) + rcx_12
                            else
                                rdx_3 = nullptr
                            
                            (*(*r13_1 + 0xc0))(r13_1, rdx_3)
                            i -= 1
