...
wchar16 const* const var_28 = u"StartSessionCallback"

if (rax_1 == 0)
    int64_t arg_20 = 0
    int16_t* var_60
    sub_140a2e390(&var_60, %s - Invalid or uninitialized OnlineSubsystem", StartSessionCallback")
