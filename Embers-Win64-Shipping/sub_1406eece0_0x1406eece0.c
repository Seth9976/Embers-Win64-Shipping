...
if (arg3[0x86].b == 0)
    ...
    if (rax_14 != 0)
        rax_14[1] = arg1
        *rax_14 = &data_142da27e8
        rax_14[3] = sub_140a387b0()
        *rax_14 = &data_142da2840
    
    rax_11 = &var_18
    
    if (&var_18 == arg4)
        goto label_1406eeec2
    ...
    if (rbx_1 == 0)
        if (rax_6 != 0)
            rax_6[1] = arg1
            *rax_6 = &data_142da2738
            rax_6[3] = sub_140a387b0()
            *rax_6 = &data_142da2790
    else if (rax_6 != 0)
        rax_6[1] = arg1
        *rax_6 = &data_142da2688
        rax_6[3] = sub_140a387b0()
        *rax_6 = &data_142da26e0
    
    rax_11 = &var_18
    
    if (&var_18 == arg4)
        goto label_1406eedfc
