...
if (data_143e8ba98 s> *rdi_1)
    _Init_thread_header(&data_143e8ba98)
    
    if (data_143e8ba98 == 0xffffffff)
        ...
        data_143e8ba90 = rax_9
        _Init_thread_footer(&data_143e8ba98)

if (data_143e8bab8 s> *rdi_1)
    _Init_thread_header(&data_143e8bab8)
    
    if (data_143e8bab8 == 0xffffffff)
        ...
        data_143e8bab0 = rax_12
        _Init_thread_footer(&data_143e8bab8)

if (data_143e8bad8 s> *rdi_1)
    _Init_thread_header(&data_143e8bad8)
    
    if (data_143e8bad8 == 0xffffffff)
        ...
        data_143e8bad0 = rax_15
        _Init_thread_footer(&data_143e8bad8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ba90
int64_t rcx
...
label_1412bfac3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412bfabe
        
        rbx.b = 1
        goto label_1412bfac3
