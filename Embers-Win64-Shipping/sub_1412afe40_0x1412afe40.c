...
if (data_143e8d708 s> *rdi_1)
    _Init_thread_header(&data_143e8d708)
    
    if (data_143e8d708 == 0xffffffff)
        ...
        data_143e8d700 = rax_9
        _Init_thread_footer(&data_143e8d708)

if (data_143e8d718 s> *rdi_1)
    _Init_thread_header(&data_143e8d718)
    
    if (data_143e8d718 == 0xffffffff)
        ...
        data_143e8d710 = rax_12
        _Init_thread_footer(&data_143e8d718)

if (data_143e8d730 s> *rdi_1)
    _Init_thread_header(&data_143e8d730)
    
    if (data_143e8d730 == 0xffffffff)
        ...
        data_143e8d720 = rax_15
        _Init_thread_footer(&data_143e8d730)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d700
int64_t rcx
...
label_1412aff43:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412aff3e
        
        rbx.b = 1
        goto label_1412aff43
