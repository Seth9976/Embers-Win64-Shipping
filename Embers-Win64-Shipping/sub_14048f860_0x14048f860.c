...
int64_t (* i)(int64_t arg1, int64_t* arg2) = sub_1412e9ce0
...
int32_t var_28 = 0x260
sub_1419c2220(&data_143e8eb90, 1, FMobileBasePassUniformParameters", 
    FMobileBasePassUniformParameters", 0x42f4bd28, nullptr)
int128_t* rcx_3 = var_18

if (rcx_3 != 0)
    sub_140a74f90(rcx_3)

return atexit(sub_142cd8ee0) __tailcall
