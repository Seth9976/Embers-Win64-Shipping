...
if (data_143e2cf10 s> *rdi_1)
    _Init_thread_header(&data_143e2cf10)
    
    if (data_143e2cf10 == 0xffffffff)
        ...
        data_143e2cf08 = rax_8
        _Init_thread_footer(&data_143e2cf10)

if (data_143e2cf20 s> *rdi_1)
    _Init_thread_header(&data_143e2cf20)
    
    if (data_143e2cf20 == 0xffffffff)
        ...
        data_143e2cf18 = rax_11
        _Init_thread_footer(&data_143e2cf20)

int64_t rdi_2 = data_143e2cf18
int64_t rcx
