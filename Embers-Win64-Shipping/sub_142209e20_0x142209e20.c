...
int32_t rcx_12 = (rcx_9 - rdx_7 - rbp_2) ^ rbp_2 u>> 0xc
int32_t rdx_10 = (rdx_7 - rbp_2 - rcx_12) ^ rcx_12 << 0x10
int32_t rbp_5 = (rbp_2 - rdx_10 - rcx_12) ^ rdx_10 u>> 5
int32_t rcx_15 = (rcx_12 - rdx_10 - rbp_5) ^ rbp_5 u>> 3
int32_t rdx_13 = (rdx_10 - rbp_5 - rcx_15) ^ rcx_15 << 0xa
int32_t rbp_8 = (rbp_5 - rdx_13 - rcx_15) ^ rdx_13 u>> 0xf

if (r10_3 == 1)
label_14220a021:
    
    if (sub_142212c40(arg1, r10_3, 0) == 0)
        void* r9_1 = &arg1[7]
        ...
        *(r15_2 + 0x54) = rax_29
        ...
        r15_2[0xa].d = *(rax_30 + (((sx.q(arg1[9].d) - 1) & r8_4) << 2))
        void* rax_32 = *(r9_1 + 8)
    ...
    label_142209fda:
        ...
        while (true)
            int64_t rcx_18 = sx.q(rbx_1) * 0x60
            
            if (*(rcx_18 + rdx_18) == rcx_8)
                break
            
            rbx_1 = *(rcx_18 + rdx_18 + 0x50)
            
            if (rbx_1 == 0xffffffff)
                goto label_142209fda
    
    r13.b = rbx_1 != 0xffffffff
    
    if (rbx_1 == 0xffffffff)
        goto label_14220a021
    
    memmove(sx.q(rbx_1) * 0x60 + *arg1, r15_2, 0x50)
