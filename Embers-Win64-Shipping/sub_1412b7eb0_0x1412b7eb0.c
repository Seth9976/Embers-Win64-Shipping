...
if (data_143e8bd28 s> *rdi_1)
    _Init_thread_header(&data_143e8bd28)
    
    if (data_143e8bd28 == 0xffffffff)
        ...
        data_143e8bd20 = rax_9
        _Init_thread_footer(&data_143e8bd28)

if (data_143e8bd48 s> *rdi_1)
    _Init_thread_header(&data_143e8bd48)
    
    if (data_143e8bd48 == 0xffffffff)
        ...
        data_143e8bd40 = rax_12
        _Init_thread_footer(&data_143e8bd48)

if (data_143e8bd68 s> *rdi_1)
    _Init_thread_header(&data_143e8bd68)
    
    if (data_143e8bd68 == 0xffffffff)
        ...
        data_143e8bd60 = rax_15
        _Init_thread_footer(&data_143e8bd68)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8bd20
int64_t rcx
...
label_1412b7fb3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412b7fae
        
        rbx.b = 1
        goto label_1412b7fb3
