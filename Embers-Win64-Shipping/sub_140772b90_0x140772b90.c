...
while (true)
    int64_t* rdi_2 = sx.q(r13_1) * 0x118 + *rbx
    int64_t rbx_1 = *rdi_2
    int32_t rax_10 = sub_140b5ead0(rbx_1.d)
    int16_t r8_5 = rdi_2[2].w
    ...
    if (r8_5 != 3)
        ...
        if (rsi_1 == 0 || rax_26.d s> *(rdx_17 + 0x38)
                || *(*(rdx_17 + 0x30) + (rax_26 << 3)) != rax_25 + 0x30)
            rsi_1 = nullptr
    else
    ...
    *(rdi_2 + 0x114) = r14_11
    ...
    uint64_t rax_77 = arg1 + 0x38
    
    if (rcx_44 != 0)
        rax_77 = rcx_44
    
    rdi_2[0x22].d = *(rax_77 + (((sx.q(*r12) - 1) & sx.q(r14_11)) << 2))
    uint64_t rcx_45 = *(arg1 + 0x40)
    uint64_t rax_80 = arg1 + 0x38
