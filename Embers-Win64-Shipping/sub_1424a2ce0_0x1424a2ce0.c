...
void* rdi_1 = rdi + 0x30
void* rbx_2 = &r14_1[0x24]
int32_t i_1

do
    *r14_1 = *(rdi_1 - 0x30)
    sub_140596d10(rbx_2 - 0x1c, rdi_1 - 0x28)
    *(rbx_2 - 0xc) = 0
    int64_t rbp_1 = sx.q(*(rdi_1 - 0x10))
    int64_t rax_3 = *(rdi_1 - 0x18)
    *(rbx_2 - 4) = rbp_1.d
    
    if (rbp_1.d != 0)
        sub_1405c4a00(rbx_2 - 0xc, rbp_1.d, 0)
        memcpy(*(rbx_2 - 0xc), rax_3, (rbp_1 << 3).d)
    else
        *rbx_2 = 0
    
    *(rbx_2 + 4) = 0
    int64_t rbp_2 = sx.q(*rdi_1)
    int64_t rax_4 = *(rdi_1 - 8)
    *(rbx_2 + 0xc) = rbp_2.d
    
    if (rbp_2.d != 0)
        sub_1405c4a00(rbx_2 + 4, rbp_2.d, 0)
        memcpy(*(rbx_2 + 4), rax_4, (rbp_2 << 3).d)
    else
        *(rbx_2 + 0x10) = 0
