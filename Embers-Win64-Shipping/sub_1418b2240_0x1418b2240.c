...
if (data_143de5432 == 0)
    ...
    if (rcx == 0 || result.b == 0)
        ...
        void* rcx_5 = arg1[1]
        int32_t* rax_2 = rcx_5 + 0x7a8
        
        if (not(zmm6_2 f!= *rax_2))
            rax_2 = rcx_5 + 0x7a0
        ...
        int64_t* rax_6 = sub_140de79b0(rax_5, &var_108)
        sub_1409786b0(rax_6, *arg1)
        ...
        sub_140e1f680(rcx_17, &var_a0, &var_70, &var_b0, rax_6, var_120_2, var_118_1, rax_11)
        int64_t* rcx_18 = arg1[5]
        result = (*(*rcx_18 + 0x48))(rcx_18, rax_5)
        *(rax_5 + 0x38) = data_143dbb1f0
