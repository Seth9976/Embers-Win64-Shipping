...
if (data_143e8c770 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8c770)
    
    if (data_143e8c770 == 0xffffffff)
        ...
        data_143e8c768 = rax_6
        _Init_thread_footer(&data_143e8c770)

int64_t rbx = data_143e8c768
int64_t rcx
