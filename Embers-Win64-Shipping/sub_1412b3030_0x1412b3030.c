...
if (data_143e8c9a0 s> *rdi_1)
    _Init_thread_header(&data_143e8c9a0)
    
    if (data_143e8c9a0 == 0xffffffff)
        ...
        data_143e8c998 = rax_12
        _Init_thread_footer(&data_143e8c9a0)

if (data_143e8c9c0 s> *rdi_1)
    _Init_thread_header(&data_143e8c9c0)
    
    if (data_143e8c9c0 == 0xffffffff)
        ...
        data_143e8c9b8 = rax_15
        _Init_thread_footer(&data_143e8c9c0)

if (data_143e8c9e0 s> *rdi_1)
    _Init_thread_header(&data_143e8c9e0)
    
    if (data_143e8c9e0 == 0xffffffff)
        ...
        data_143e8c9d8 = rax_18
        _Init_thread_footer(&data_143e8c9e0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c998
int64_t rcx
...
label_1412b3128:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412b3123
    
    rbx.b = 1
    goto label_1412b3128
