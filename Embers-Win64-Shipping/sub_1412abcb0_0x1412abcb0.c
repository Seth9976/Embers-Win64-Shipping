...
if (data_143e8db90 s> *rdi_1)
    _Init_thread_header(&data_143e8db90)
    
    if (data_143e8db90 == 0xffffffff)
        ...
        data_143e8db88 = rax_12
        _Init_thread_footer(&data_143e8db90)

if (data_143e8dbb0 s> *rdi_1)
    _Init_thread_header(&data_143e8dbb0)
    
    if (data_143e8dbb0 == 0xffffffff)
        ...
        data_143e8dba8 = rax_15
        _Init_thread_footer(&data_143e8dbb0)

if (data_143e8dbd0 s> *rdi_1)
    _Init_thread_header(&data_143e8dbd0)
    
    if (data_143e8dbd0 == 0xffffffff)
        ...
        data_143e8dbc8 = rax_18
        _Init_thread_footer(&data_143e8dbd0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8db88
int64_t rcx
