...
while (true)
    ...
    if (rsi_1 == 0)
    label_140818c74:
        sub_1408185e0(r10_1, rax_8, zx.q(arg3), arg4)
    else
        while (true)
            if (rax_8 s<= 8)
                for (; i u> r10_1; i -= 4)
                    ...
                    if (&r10_1[1] u<= i)
                        int64_t r9_2 = *(*arg4 + 0x38)
                        
                        do
                            if (*(r9_2 + (sx.q(*rdx_4) << 2)) f< *(r9_2 + (sx.q(*r8_2) << 2)))
                                rdx_4 = r8_2
            ...
            *r10_1 = rcx_3
            ...
            while (true)
                ...
                if (r8 u<= i)
                    int64_t rdx_1 = *(*arg4 + 0x38)
                    
                    if (*(rdx_1 + (sx.q(*r8) << 2)) f<= *(rdx_1 + (sx.q(*r10_1) << 2)))
                        continue
                ...
                do
                    ...
                    rdx_2 = *(*arg4 + 0x38)
                while (*(rdx_2 + (sx.q(*r10_1) << 2)) f<= *(rdx_2 + (sx.q(*r9) << 2)))
                rax_15 = *r9
