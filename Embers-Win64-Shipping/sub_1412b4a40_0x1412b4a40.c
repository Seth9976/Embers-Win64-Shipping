...
if (data_143e8c320 s> *rdi_1)
    _Init_thread_header(&data_143e8c320)
    
    if (data_143e8c320 == 0xffffffff)
        ...
        data_143e8c318 = rax_9
        _Init_thread_footer(&data_143e8c320)

if (data_143e8c340 s> *rdi_1)
    _Init_thread_header(&data_143e8c340)
    
    if (data_143e8c340 == 0xffffffff)
        ...
        data_143e8c338 = rax_12
        _Init_thread_footer(&data_143e8c340)

if (data_143e8c360 s> *rdi_1)
    _Init_thread_header(&data_143e8c360)
    
    if (data_143e8c360 == 0xffffffff)
        ...
        data_143e8c358 = rax_15
        _Init_thread_footer(&data_143e8c360)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c318
int64_t rcx
