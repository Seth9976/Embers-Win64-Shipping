...
uint128_t zmm10_1
uint128_t zmm15_1
rax_5, zmm7, zmm9_1, zmm10_1, zmm15_1 = sub_14170c1c0(&var_228, &var_2d8, &var_300)
...
label_14162cc29:
    ...
    *rdi_3 = zmm8.d
        ...
        *arg7 = (_mm_unpacklo_ps(zmm0_1, zmm1_1.q)).q
        ...
        label_14162cecb:
            ...
            *arg7 = zmm1_1.q
            ...
            int32_t rax_32
            int128_t zmm6_2
            rax_32, zmm6_2 = sub_1415a41f0(&var_2c8, &var_170, &var_240, &var_228, &var_2ec, 
                &var_300, &var_268, &var_238)
            zmm0_2 = zx.o(var_300.q)
            rax_33 = var_2f8
            
            if (rax_32 == 2)
                goto label_14162cecb
    ...
    while (true)
        ...
        int32_t var_194
        int32_t* rax_8
        rax_8, zmm6_1, zmm7, zmm8, zmm9_1, zmm10_1, zmm11, zmm12, zmm13, zmm14, zmm15_1 =
            sub_14170c1c0(&var_228, &var_194, &var_210)
        zmm5 = var_304_1
        zmm1_1 = zx.o(*rax_8)
        ...
        r12 = sx.q(var_188)
        zmm0_1 = _mm_unpacklo_ps(zmm5, zmm15_1.q)
        var_2ec = zmm3_1.d
