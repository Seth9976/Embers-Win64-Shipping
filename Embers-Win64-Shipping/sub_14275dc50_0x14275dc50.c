...
if (rdx.b == 0)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            uint128_t zmm0 = *r10_4
            r10_4 = &r10_4[1]
            rax = rcx_6
            rcx_6 += 0x10
            *rax = __pcmpgtd_xmmdq_memdq(zmm0, data_143f87810)
            i = i_3
            i_3 -= 1
        while (i != 1)
else if (rax.d == 1)
    ...
    *(arg1 + 0x10) = &rax_8[3]
    ...
    uint128_t zmm1 = zx.o(*(sx.q(rcx_1) + *(*(arg1 + 0x18) + (sx.q(r8_1) << 3))))
    uint64_t rdx_4 = zx.q(*(arg1 + 0x80) * zx.d(*(rax_8 + 3)))
    *(arg1 + 0x10) = &rax_8[5]
    rax = zx.q(*(arg1 + 0x44))
    zmm1 = _mm_shuffle_epi32(zmm1, 0)
    uint128_t* rdx_5 = rdx_4 + *(arg1 + 0x70)
    ...
    if (rax.d s> 0)
        ...
        do
            rax_6 = rdx_5
            rdx_5 = &rdx_5[1]
            *rax_6 = __pcmpgtd_xmmdq_memdq(zmm1, data_143f87810)
            i_1 = i_2
            i_2 -= 1
        while (i_1 != 1)
        return rax_6
