...
do
    ...
    *(rbx_1 - 0x23) = *(rdi_1 + rbx_1 - 0x23)
    sub_14086c240(rbx_1 - 0x1c, rdi_1 - 0x1c + rbx_1)
    ...
    if (rbx_1 - 0xc != rax_11)
        ...
        *(rbx_1 - 4) = rsi_2
        ...
        if (rsi_2 != 0 || r8_3 != 0)
            sub_1405c4b20(rbx_1 - 0xc, rsi_2, r8_3)
    ...
    *(rbx_1 + 0x6c) = *(rdi_1 + rbx_1 + 0x6c)
    ...
    i_4 -= 1
while (i_1 != 1)
void* rbx_2 = arg1 + 0x3f4
int64_t i_2

do
    *(rbx_2 - 0x24) = *(rbx_2 + rdi_1 - 0x24)
    *(rbx_2 - 0x23) = *(rbx_2 + rdi_1 - 0x23)
    sub_14086c240(rbx_2 - 0x1c, rdi_1 - 0x1c + rbx_2)
    int64_t* rax_18 = rdi_1 - 0xc + rbx_2
    ...
    if (rbx_2 - 0xc != rax_18)
        ...
        *(rbx_2 - 4) = rsi_3
        ...
        if (rsi_3 != 0 || r8_5 != 0)
            sub_1405c4b20(rbx_2 - 0xc, rsi_3, r8_5)
            memcpy(*(rbx_2 - 0xc), rbp, rsi_3 * 0x1c)
        else
            *rbx_2 = rsi_3
    
    *(rbx_2 + 4) = *(rbx_2 + rdi_1 + 4)
    *(rbx_2 + 8) = *(rbx_2 + rdi_1 + 8)
    sub_141f98dc0(rbx_2 + 0xc)
