...
label_1425d9b4b:
    ...
    if (r8_4 s> 0 && (rax_18 == 0 || rax_18 s< rbp))
        ...
        arg4[0x24] = *(rax_22 + (((sx.q(arg1[9].d) - 1) & r8_5) << 2))
        void* rax_24 = *(r9_2 + 8)
    ...
    label_1425d9a6d:
        ...
        while (true)
            int64_t rcx_2 = sx.q(rbx_1) * 0xa0
            
            if (*(rcx_2 + rdx_3) == *arg4)
                break
            
            rbx_1 = *(rcx_2 + rdx_3 + 0x90)
            
            if (rbx_1 == 0xffffffff)
                goto label_1425d9a6d
    ...
    if (rbx_1 == 0xffffffff)
        ...
        void* rdi_2 = sx.q(rbx_1) * 0xa0 + *arg1
        ...
        memmove(rdi_2, arg4, 0x90)
        int64_t rcx_6 = sx.q(arg5)
        void* r10_1 = &arg1[2]
        
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0xa0 + *arg1) = rcx_6.d
        
        int32_t* rax_8 = rcx_6 * 0xa0 + *arg1
        *rax_8 = 0xffffffff
