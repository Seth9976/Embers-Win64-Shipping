...
if (data_143e8e080 s> *rdi_1)
    _Init_thread_header(&data_143e8e080)
    
    if (data_143e8e080 == 0xffffffff)
        ...
        data_143e8e078 = rax_9
        _Init_thread_footer(&data_143e8e080)

if (data_143e8e0a0 s> *rdi_1)
    _Init_thread_header(&data_143e8e0a0)
    
    if (data_143e8e0a0 == 0xffffffff)
        ...
        data_143e8e098 = rax_12
        _Init_thread_footer(&data_143e8e0a0)

if (data_143e8e0c0 s> *rdi_1)
    _Init_thread_header(&data_143e8e0c0)
    
    if (data_143e8e0c0 == 0xffffffff)
        ...
        data_143e8e0b8 = rax_15
        _Init_thread_footer(&data_143e8e0c0)
