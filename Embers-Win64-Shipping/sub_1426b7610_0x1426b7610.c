...
if (rbx_1 == 0)
    ...
    if (rax_6 == 0)
        ...
        if (rax_7.d s> *(rbx_1 + 0x38) || *(*(rbx_1 + 0x30) + (rax_7 << 3)) != rax_6 + 0x30)
            rbx_1 = arg1[0x61]

int32_t var_34 = arg3.d
void* var_40 = rbx_1
int32_t var_38
int32_t var_38_2 = (zx.d(arg6) << 2 | zx.d(arg4)) << 5
    | ((((zx.d(arg7) * 2) | zx.d(arg5)) << 2 | (var_38 & 0xffffff73) | 0x73) & 0xffffff5f)
uint32_t rsi_1 = zx.d(*((*(*arg1 + 0x770))(arg1, &arg_38, &var_58, 0, var_68) + 4))
int64_t* var_28
