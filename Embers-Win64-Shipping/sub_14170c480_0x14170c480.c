...
float var_c8
float* rax_1 = sub_14170b7f0(arg1[1], &var_c8, &var_d8)
...
rax_2, zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm14_1, zmm15_1 =
    sub_14170b7f0(arg1[1], &var_d8, arg2)
int64_t* rbx = arg1[2]
...
if (zmm8_1 - (zmm11_1 f- zmm1.d) * zmm10_1 + (zmm14_1 - r14) * zmm7_1
    ...
    *(rcx_8 + (rdx_6 << 2)) = zmm9.d.q
    *(rcx_8 + (rdx_6 << 2) + 8) = zmm12.d
