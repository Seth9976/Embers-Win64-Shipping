...
do
    ...
    zmm7 = zx.o(*(rsi_2 + (rdx_1 << 1)))
    uint16_t zmm2[0x8] = zx.o(*(rsi_2 + result))
    uint16_t zmm3[0x8] = zx.o(*(rsi_2 + (result << 1)))
    uint16_t zmm4[0x8] = zx.o(*(rsi_2 + rdx_1))
    uint16_t zmm5[0x8] = zx.o(*(rsi_2 + (result << 2)))
    int32_t temp0_17[0x4] = __punpcklbw_xmmdq_memdq(zx.o(*rsi_1), zx.o(0))
    ...
    int32_t temp0_25[0x4] = __pmullw_xmmdq_memdq(temp0_17, temp0_8)
        ...
        __paddsw_xmmdq_memdq(
            _mm_adds_epi16(
                _mm_adds_epi16(
                    _mm_adds_epi16(
                        _mm_adds_epi16(
                            _mm_adds_epi16(_mm_adds_epi16(_mm_adds_epi16(temp0_25, zmm1), zmm6), 
                                zmm7), 
                            zmm2), 
                        zmm5), 
                    zmm3), 
            ...
            var_70), 
        7)
    *rdi_1 = _mm_avg_epu8(_mm_packus_epi16(zmm0, zmm0), zx.o(*rdi_1))[0].q
    void* rsi_3 = rsi_2 - result
    zmm1 = zx.o(*(rsi_3 + result + 8))
    zmm6 = zx.o(*(rsi_3 + (rdx_1 << 1) + 8))
    rsi_1 = rsi_3 + result
    zmm7 = zx.o(*(rsi_1 + (rdx_1 << 1) + 8))
    zmm2 = zx.o(*(rsi_1 + result + 8))
    zmm3 = zx.o(*(rsi_1 + (result << 1) + 8))
    zmm4 = zx.o(*(rsi_1 + rdx_1 + 8))
    zmm5 = zx.o(*(rsi_1 + (result << 2) + 8))
    int32_t temp0_44[0x4] = __punpcklbw_xmmdq_memdq(zx.o(*(rsi_3 + 8)), zx.o(0))
    zmm1 = __punpcklbw_xmmdq_memdq(zmm1, zx.o(0))
    zmm6 = __punpcklbw_xmmdq_memdq(zmm6, zx.o(0))
    zmm7 = __punpcklbw_xmmdq_memdq(zmm7, zx.o(0))
    zmm2 = __punpcklbw_xmmdq_memdq(zmm2, zx.o(0))
    ...
    zmm3 = __punpcklbw_xmmdq_memdq(zmm3, zx.o(0))
    zmm4 = __punpcklbw_xmmdq_memdq(zmm4, zx.o(0))
    int32_t temp0_52[0x4] = __pmullw_xmmdq_memdq(temp0_44, temp0_8)
    zmm1 = __pmullw_xmmdq_memdq(zmm1, var_e0)
    zmm6 = __pmullw_xmmdq_memdq(zmm6, var_90)
    zmm7 = __pmullw_xmmdq_memdq(zmm7, var_80)
    zmm2 = __pmullw_xmmdq_memdq(zmm2, var_d0)
        ...
        __paddsw_xmmdq_memdq(
            _mm_adds_epi16(
                _mm_adds_epi16(
                    _mm_adds_epi16(
                        _mm_adds_epi16(
                            _mm_adds_epi16(_mm_adds_epi16(_mm_adds_epi16(temp0_52, zmm1), zmm6), 
                                zmm7), 
                            zmm2), 
                        zmm5), 
                    zmm3), 
            ...
            var_70), 
        7)
    *(rdi_1 + 8) = _mm_avg_epu8(_mm_packus_epi16(zmm0, zmm0), zx.o(*(rdi_1 + 8)))[0].q
    rdi_1 += sx.q(arg4)
    i = i_1
    i_1 -= 1
while (i != 1)
