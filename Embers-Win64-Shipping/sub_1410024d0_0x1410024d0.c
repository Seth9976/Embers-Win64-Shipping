...
if ((*(arg3 + 0x1c) & 6) == 0)
    void* rcx_12 = *(arg3 + 0x28)
    void* var_100 = rcx_12
    int64_t var_f8 = *(arg3 + 0x78)
    
    if (arg6 != 0)
        result = sub_1410130c0(rcx_12 + 0x7c0, arg_28, 0x200, arg3 + 0xf0)
    else
        *(arg3 + 0x160) |= 2
        ...
        sub_141010870(&var_e0)
        sub_141014320(arg3 + 0xf0, arg_8, arg_28, 0)
        result = *(arg3 + 0x130)
else if ((*(arg3 + 0x160) & 4) == 0)
    ...
    if (arg2 == 0 || arg2[0x10] != 0 || arg6 != 1)
        ...
        result_1, zmm0 = sub_141012e10(*(r12 + (zx.q(*(r15_1 + 0x18)) << 3) + 0x4a0), 
            *(rcx_8 + 0x18), *(rcx_8 + 0xd0), &var_a8, arg5)
        result = result_1
        j_sub_141059a80(&var_a8, sub_141068110(arg_18, &var_a8, zmm0))
    else
        ...
        *(arg2 + 8) = &rbx_3[1]
        rbx_3[1] = 0
        rbx_3[2] = rcx_1
        *rbx_3 = &data_142efff40
        sub_14103f450(&rbx_3[3], r15_1)
        void* rcx_3 = arg_18
        result = sub_141012e10(*(r12 + (zx.q(*(r15_1 + 0x18)) << 3) + 0x4a0), *(rcx_3 + 0x18), 
            *(rcx_3 + 0xd0), &rbx_3[3], arg5)
        int64_t* var_108
...
*(arg3 + 0x158) = arg_20
*(arg3 + 0x15c) = arg_28
*(arg3 + 0x160) = (*(arg3 + 0x160) & 0xfffffffb) | 1
return result
