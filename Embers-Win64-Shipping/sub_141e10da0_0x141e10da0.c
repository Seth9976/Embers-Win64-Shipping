    ...
    do
        ...
        if (rsi_1 s< arg2)
            do
                ...
                if (r10_1 s< arg2)
                    if ((*(arg1 + sx.q(r8_1.d) * 0xc + 8)).d f> *(arg1 + sx.q(r10_1) * 0xc + 8))
                        r10_1 = r8_1.d
                ...
                if ((*(arg1 + (rcx_2 << 2) + 8)).d f<= r10_2[1].d)
                    break
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if (r10_3 s< i)
                    if ((*(arg1 + sx.q(r8_2.d) * 0xc + 8)).d f> *(arg1 + sx.q(r10_3) * 0xc + 8))
                        r10_3 = r8_2.d
