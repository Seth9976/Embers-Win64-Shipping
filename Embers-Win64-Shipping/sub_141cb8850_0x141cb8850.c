...
if (arg1 != arg2)
    ...
    if (rdx_5 != rsi_1)
        ...
        int32_t rdx_9 = *(rsi_2 + (sx.q(r9_3) << 2)) & r12_1
        int32_t var_64_6
        ...
        label_141cb89c1:
            ...
            int32_t var_64_5 = r10_2 - r11_1 + 0x1f
            
            if (r10_2 - r11_1 + 0x1f s> rsi_1)
                var_64_6 = rsi_1
        else
            while (true)
                ...
                rdx_9 = *(rsi_2 + (rcx_5 << 2) + 4)
                var_68_3 = 0xffffffff
                
                if (rdx_9 != 0)
                    goto label_141cb89c1
    ...
    while (true)
        ...
        if (*(rax_21 + (rcx_7 << 3) + 0x18) != 0)
            *(rax_21 + (rcx_7 << 3) + 0x18) = 0
            int64_t rcx_8 = *(rax_21 + (rcx_7 << 3) + 8)
