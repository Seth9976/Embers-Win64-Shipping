...
if (result.d != 0)
        ...
        if (i != 0)
            ...
            if (rcx_6.d != result.d)
                ...
                if (rdi_2 != 0xffffffff)
                    ...
                    if (rdx_4 != rdi_2 + 1)
                        memmove((rcx_6 << 4) + *(arg1 + 8), 
                            (sx.q(rcx_6.d + rdi_2 + 1) << 4) + *(arg1 + 8), 
                            (rdx_4 - (rdi_2 + 1)) << 4)
                        rax_3 = *(arg1 + 0x10)
            ...
            if (rsi_2 != 0xffffffff)
                ...
                if (rcx_1 != rsi_2 + 1)
                    memmove((r10_1 << 4) + *(arg1 + 8), 
                        (sx.q(r10_1.d + rsi_2 + 1) << 4) + *(arg1 + 8), (rcx_1 - (rsi_2 + 1)) << 4)
                    rax = *(arg1 + 0x10)
    ...
    if (*(arg1 + 0x14) != rdx_9)
        return sub_1405a5410(arg1 + 8, rdx_9)
