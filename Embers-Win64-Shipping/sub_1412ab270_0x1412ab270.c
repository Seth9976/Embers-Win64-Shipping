...
if (data_143e8e190 s> *rdi_1)
    _Init_thread_header(&data_143e8e190)
    
    if (data_143e8e190 == 0xffffffff)
        ...
        data_143e8e188 = rax_12
        _Init_thread_footer(&data_143e8e190)

if (data_143e8e1b0 s> *rdi_1)
    _Init_thread_header(&data_143e8e1b0)
    
    if (data_143e8e1b0 == 0xffffffff)
        ...
        data_143e8e1a8 = rax_15
        _Init_thread_footer(&data_143e8e1b0)

if (data_143e8e1d0 s> *rdi_1)
    _Init_thread_header(&data_143e8e1d0)
    
    if (data_143e8e1d0 == 0xffffffff)
        ...
        data_143e8e1c8 = rax_18
        _Init_thread_footer(&data_143e8e1d0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e188
int64_t rcx
...
label_1412ab368:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412ab363
    
    rbx.b = 1
    goto label_1412ab368
