...
if (data_143e2cd70 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    int64_t r8_1
    result, r8_1 = _Init_thread_header(&data_143e2cd70)
    
    if (data_143e2cd70 == 0xffffffff)
        ...
        data_143e2cd68 = rax_3
        _Init_thread_footer(&data_143e2cd70)

int64_t rdi = data_143e2cd68
