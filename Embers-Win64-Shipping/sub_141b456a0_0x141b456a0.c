...
if (rax_2 == 0 || rbx_1 == 0)
    result = sub_140cc16a0(&var_38, sub_140bdfab0())
    void* rbx_2
    ...
    if (result.b == 0 || rbx_2 == 0)
        ...
        if (sub_140cc1670(&var_38, &data_143e1b820).b == 0 || var_38.q == 0)
            ...
            int64_t rcx_23 = sx.q(arg2[1].d) * 5
            int64_t rax_20 = *arg2
            uint128_t zmm0_1 = *(rax_20 + (rcx_23 << 3) - 0x10)
            int32_t rdx_12 = *(rax_20 + (rcx_23 << 3) - 0x20)
            ...
            if (_mm_bsrli_si128(zmm0_1, 8).d.b != 0)
                ...
                if (rbx_1 == 0 || ((zx.q(*(*(rbx_1 + 8) + 0x10)) u>> 0x10).b & 1) == 0)
                    ...
                    if (result.d == 8 && rdx_12 s< *(rbx_1 + 0x38))
                        int64_t rcx_26 = sx.q(*(rbx_1 + 0x4c))
                        result = sx.q(result.d * rdx_12) + arg1
                        rcx_11 = rcx_26 + result
                        cond:0_1 = rcx_26 == neg.q(result)
                        goto label_141b45816
        ...
        if (*(rbx_2 + 0xb4) != 1)
            ...
            result = sub_140be0b10(rbx_2)
            
            if (result == 0 || ((zx.q(*(*(result + 8) + 0x10)) u>> 0x10).b & 1) == 0
                    || *(result + 0x3c) != 8)
                result.b = 0
            else
                ...
                if (rax_9 s>= data_143e1d9b4)
                    ...
                    int32_t rax_11 = temp2_1 + rdx_9
                    rax_16 = *(data_143e1d9a0 + (sx.q(rax_11 s>> 0x10) << 3))
                        + sx.q(zx.d(rax_11.w) - rdx_9) * 0x18
                
                if (((*(rax_16 + 8) u>> 0x1c).b & 1) != 0)
                    result.b = 0
                else
                    (*(*arg1 + 0x210))(arg1, rbx_2, arg4)
                    result.b = 1
