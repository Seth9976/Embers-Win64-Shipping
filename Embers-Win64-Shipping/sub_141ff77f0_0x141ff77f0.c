...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        int16_t* rdi_1 = *var_58 + sx.q(i) * 0xc
        int64_t* rcx_22 = arg1[1]
        int16_t* rdx_23 = *rcx_22
        
        if (&rdx_23[1] u<= rcx_22[1])
            *rdi_1 = *rdx_23
            int64_t* rax_37 = arg1[1]
            *rax_37 += 2
        else if ((*(arg1 + 0x29) & 0x20) != 0)
            sub_140b54000(arg1, rdi_1, zmm1)
        else
            (*(*arg1 + 0x150))(arg1, rdi_1, 2)
        
        int64_t* rcx_24 = arg1[1]
        int16_t* r8_9 = *rcx_24
        
        if (&r8_9[1] u<= rcx_24[1])
            rdi_1[1] = *r8_9
            int64_t* rax_41 = arg1[1]
            *rax_41 += 2
        else if ((*(arg1 + 0x29) & 0x20) != 0)
            sub_140b54000(arg1, &rdi_1[1], zmm1)
        else
            (*(*arg1 + 0x150))(arg1, &rdi_1[1], 2)
...
do
    ...
    *(rdx_15 + (rcx_14 << 2)) = 0
    int16_t* rdx_16 = rdx_15 + (rcx_14 << 2)
    rdx_16[1] = 0
    *(rdx_16 + 4) = 0xffffffff
    ...
    if (&r8_8[1] u<= rcx_15[1])
        ...
        *rax_20 += 2
        ...
        sub_140b54000(arg1, rdx_16, arg3)
    else
        (*(*arg1 + 0x150))(arg1, rdx_16, 2)
    
    int64_t* rcx_17 = arg1[1]
    int16_t* rdx_17 = *rcx_17
    ...
    if (&rdx_17[1] u<= rcx_17[1])
        ...
        *rax_24 += 2
        ...
        sub_140b54000(arg1, &rdx_16[1], arg3)
    else
        (*(*arg1 + 0x150))(arg1, &rdx_16[1], 2)
