...
label_142771dc9:
    ...
    if (sub_142771100(arg1, arg1[1].d - *(arg1 + 0x34), 0) == 0)
        void* r9_1 = &arg1[7]
        ...
        *(arg4 + 0x34) = rax_17
        ...
        arg4[6].d = *(rax_18 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2))
        void* rax_20 = *(r9_1 + 8)
    ...
    if (rbx_1 == 0xffffffff)
        ...
        int64_t* rdi_3 = sx.q(rbx_1) * 0x38 + *arg1
