...
if (rax == 0)
    ...
    r14 = nullptr
    int64_t var_140_1 = 0
    int64_t var_148_1 = r15[8] + 0x10
    rdi = arg2
    void*** result_2 = sub_14103e1d0(rax, rdi, **r15, *r15[1], *r15[2], *r15[3], (*r15[4]).b, 
        *r15[5], *r15[6], *r15[7])
    result = result_2
    result_1 = result_2
