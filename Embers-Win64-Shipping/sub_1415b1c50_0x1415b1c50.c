...
int64_t* r15 = arg2
int64_t* r12 = arg1
uint64_t* var_240 = arg7
int64_t var_210
int64_t* var_248 = &var_210
int32_t* var_170 = arg8
var_210 = 0
int64_t var_208 = 0
char rax_3
float zmm6[0x4]
...
float zmm13_1
int128_t zmm14
rax_3, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13_1, zmm14 =
    sub_1416d61d0(arg1, arg2, arg3, arg4, var_248)
int32_t rsi_1

if (rax_3 != 0)
    int128_t var_1c0
    __builtin_memset(&var_1c0, 0, 0x18)
    float (* rsi_2)[0x4] = var_1c0:8.q
    int32_t i = 0
    float (* rbx_1)[0x4] = var_1c0.q
    int64_t* var_220
    int64_t var_1b0
    float zmm1_1[0x4]
    ...
    if (var_208.d s> 0)
        do
            char rax_5
            rax_5, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13_1, zmm14, arg5 =
                sub_141743d50(sx.q(i) * 0x38 + var_210, *r12, *r15)
            ...
            if (rax_5 != 0)
                ...
                if (var_1b0 == rsi_2)
                    sub_141701fc0(&var_1c0, rsi_2, &var_220)
                    rsi_2 = var_1c0:8.q
                    rbx_1 = var_1c0.q
                else
                    *rsi_2 = var_220.o
    ...
    if (rcx_7 == 0)
    label_1415b2736:
        zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm14_1, zmm15 =
            sub_14154a2a0(*arg1, *arg2, &var_128, arg6, arg7, var_170, arg9)
        rsi_1 = 1
    else
        zmm11 = 0x7fffffff
        zmm14 = 0x322bcc77
        ...
        while (true)
            if (rdx_5 s< 0x80)
                ...
                rsi_2 -= 0x10
                var_1c0:8.q = rsi_2
                int32_t* rdi_5 = sx.q(rax_11) * 0x38 + var_210
                ...
                label_1415b26e6:
                    ...
                    zmm10 = rdi_5[3]
                    zmm9 = rdi_5[5]
                    zmm10[0] = zmm10[0] f* *rax_22
                    zmm9[0] = zmm9[0] f* rax_22[2]
                    zmm8[0] = zmm8[0] f* rax_22[1]
                    zmm8[0] = zmm8[0] f* rax_22[4]
                    zmm8[0] = zmm8[0] f* rax_22[7]
                    zmm8[0] = zmm8[0] + zmm10[0]
                    zmm10[0] = zmm10[0] f* rax_22[3]
                    zmm8[0] = zmm8[0] + zmm9[0]
                    zmm9[0] = zmm9[0] f* rax_22[5]
                    zmm8[0] = zmm8[0] + zmm10[0]
                    zmm10[0] = zmm10[0] f* rax_22[6]
                    zmm8[0] = zmm8[0] + zmm9[0]
                    zmm9[0] = zmm9[0] f* rax_22[8]
                    zmm8[0] = zmm8[0] + zmm10[0]
                    bool cond:0_1 = zmm8[0] < zmm8[0]
                    zmm8[0] = zmm8[0] + zmm9[0]
                    int32_t r14_2
                    
                    if (not(cond:0_1) && not(zmm8[0] < zmm8[0]))
                        zmm7 = zx.o(*rax_22)
                        r14_2 = rax_22[2]
                    else if (zmm8[0] < zmm8[0] || zmm8[0] < zmm8[0])
                        zmm7 = zx.o(*(rax_22 + 0x18))
                        r14_2 = rax_22[8]
                    else
                        zmm7 = zx.o(*(rax_22 + 0xc))
                        r14_2 = rax_22[5]
                    
                    zmm12 = rdi_5[6]
                    uint64_t var_1e8_1 = zmm7.q
                    void* rcx_13 = arg4[1]
                    void* rax_23 = *(rcx_13 + 0x10)
                    float zmm3_1[0x4] = *(rax_23 + 0x10)
                    zmm3_1[0] = zmm3_1[0] f* *(rcx_13 + 0x28)
                    zmm0_1 = *(rax_23 + 0x18)
                    zmm0_1[0] = zmm0_1[0] f* *(rcx_13 + 0x30)
                    float zmm2_1[0x4] = *(rax_23 + 0x14)
                    zmm2_1[0] = zmm2_1[0] f* *(rcx_13 + 0x2c)
                    int128_t* rax_24 = arg4[2]
                    ...
                    if (not(zmm13_1 < zmm12[0]))
                        ...
                        int64_t rax_37 = *r12
                        *(rax_37 + (rcx_16 << 2)) = zmm7.q
                        *(rax_37 + (rcx_16 << 2) + 8) = r14_2
                        ...
                        *(rcx_18 + (rdx_12 << 2) + 8) = var_188_1
                        ...
                        sub_1415c5980(&var_210, var_228_1, &var_1d8, &var_220)
                        int64_t r13_1 = sx.q(var_208.d)
                        int32_t r8_10 = var_218_1.d
                        int32_t rax_40 = r8_10 + r13_1.d
                        var_208.d = rax_40
                        
                        if (rax_40 s> var_208:4.d)
                        ...
                        if (r8_10 s>= 3)
                            ...
                            if (r8_10 s> 0)
                                void* r14_4 = r13_1 * 0x38
                                int32_t rbx_2 = r13_1.d
                                int32_t r11_7 = 1 - r13_1.d
                                int32_t var_198_1 = r11_7
                                
                                do
                                    int64_t* rdx_15 = var_220
                                    int64_t rcx_22 = var_210
                                    int64_t r12_1 = sx.q(rdx_15[rdi_6].d)
                                    int64_t rsi_3 = sx.q(*(&rdx_15[rdi_6] + 4))
                                    int32_t* r9_5 = r14_4 + rcx_22
                                    ...
                                    if (zmm3_1[0] f>= zmm14.d)
                                        ...
                                        zmm3_1[0] = zmm3_1[0] * temp0_32[0]
                                        zmm7.d = zmm7.d f* temp0_32[0]
                                    label_1415b2597:
                                        var_1f8_1 = zmm7.d
                                        float var_1fc_2 = zmm3_1[0]
                                        var_200_1 = zmm8[0]
                                    else
                                        var_200_1 = data_143dbb1f8[0]
                                        var_1f8_1 = data_143dbb200[0]
                                        float var_1fc_1 = data_143dbb1fc[0]
                                    
                                    *(r9_5 + 0xc) = var_200_1.q
                                    r9_5[5] = var_1f8_1
                                    zmm0_1 = r9_5[4]
                                    zmm2_1 = r9_5[3]
                                    zmm1_1 = r9_5[5]
                            ...
                            r13 = var_218_1:4.d
                            goto label_1415b26e6
            
        label_1415b26ff:
            rdi_1 = var_220
            goto label_1415b2736
    ...
    if (rbx_1 != 0)
        ...
        if (((var_1b0 - rbx_1) & 0xfffffffffffffff0) u>= 0x1000)
            rbx_1 = *(rbx_1 - 8)
