...
int32_t var_84 = 1
int32_t var_88 = 0
int32_t rbx = *(arg1 + 0x488)
int32_t r9 = 0
void* var_80 = arg1 + 0x470
int32_t var_78 = 0xffffffff
int64_t var_74 = 0

if (rbx != 0)
    void* rax_1 = *(arg1 + 0x480)
    void* r10_1 = arg1 + 0x470
    ...
    label_1405bf34a:
        ...
        while (true)
            ...
            if (rcx != 0)
                goto label_1405bf34a
        
        var_74.d = rbx

int32_t rdx_3 = *(arg1 + 0x488)
...
var_74.d = rdx_3
int128_t result = (arg1 + 0x460).o
int128_t result_1 = result
int128_t var_58 = var_38

if (rdx_3 != rbx)
    void* rax_11 = *(arg1 + 0x480)
    void* r10_2 = arg1 + 0x470
    ...
    label_1405bf412:
        ...
        while (true)
            ...
            if (rdx_7 != 0)
                goto label_1405bf412
        
        var_74.d = rbx

while (var_58:0xc.d != (var_78_2.q u>> 0x20).d || var_58.q != arg1 + 0x470
        || result_1.q != arg1 + 0x460)
    int32_t var_5c
    var_58:8.d &= not.d(var_5c)
    sub_14059bdd0(&result_1:8)

void* rcx_9 = *(arg1 + 0x500)
*(arg1 + 0x2e0) = 0

if (rcx_9 == 0)
    return result

return sub_1405c2450(rcx_9, arg1, 0x20)
