...
if (((*(arg1 + 0x88) & 2) != 0 && (*(arg1 + 0xd8) & 1) != 0 && (*(arg1 + 0x110) & 1) != 0)
...
do
    ...
    if ((*(rdi_3 + 0x5c) & 0x4000000) == 0)
        ...
        (*(*r10_1 + 0x388))(r10_1, arg2, rdi_3, &arg_8, &var_90, &var_50, &var_58, &var_60, 
            &var_68, &var_70, &var_78, &var_80, &var_88, &var_98, var_98, var_90, var_88, var_80, 
        ...
        var_e0_1.d = rbx_2
        int32_t* rax
        rax, arg4 = sub_14219a490(arg1, arg2, var_90, rdi_3, arg4, &arg_18, var_e0_1.d, var_d8_1.b)
        r10_1 = var_48_1
