...
if (data_143e8b138 s> *rdi_1)
    _Init_thread_header(&data_143e8b138)
    
    if (data_143e8b138 == 0xffffffff)
        ...
        data_143e8b130 = rax_9
        _Init_thread_footer(&data_143e8b138)

if (data_143e8b148 s> *rdi_1)
    _Init_thread_header(&data_143e8b148)
    
    if (data_143e8b148 == 0xffffffff)
        ...
        data_143e8b140 = rax_12
        _Init_thread_footer(&data_143e8b148)

if (data_143e8b158 s> *rdi_1)
    _Init_thread_header(&data_143e8b158)
    
    if (data_143e8b158 == 0xffffffff)
        ...
        data_143e8b150 = rax_15
        _Init_thread_footer(&data_143e8b158)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b130
int64_t rcx
...
label_1412c1ce3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412c1cde
        
        rbx.b = 1
        goto label_1412c1ce3
