...
while (true)
    void* r9_3 = *rbx + sx.q(r10_2) * 0x48
    int32_t rcx_9 = (not.d(*(r9_3 + 4)) ^ *(r9_3 + 8) ^ *r9_3) & (*rsi - 1)
    void* rax_16 = &arg1[7]
    *(r9_3 + 0x44) = rcx_9
    void* rdx_6 = arg1[8]
    ...
    *(r9_3 + 0x40) = *(rax_16 + (((sx.q(*rsi) - 1) & r8_7) << 2))
    void* rax_18 = &arg1[7]
    void* rcx_13 = arg1[8]
    ...
    *(rax_18 + (((sx.q(*rsi) - 1) & r8_7) << 2)) = r10_2
