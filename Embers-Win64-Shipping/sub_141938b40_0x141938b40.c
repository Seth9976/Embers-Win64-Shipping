...
while (true)
    ...
    if (rax_20.d == (var_88_2.q u>> 0x20).d && var_68.q == &arg1[2] && rcx_7 == arg1)
        arg1[0xc].d = arg2
        arg1[1].d = 0
        ...
        *(arg1 + 0x34) = 0
        ...
        void* result = sub_141934710(arg1, arg2, 1)
    ...
    j_sub_140a74f90(*(*rcx_7 + rax_20 * 0x10))
