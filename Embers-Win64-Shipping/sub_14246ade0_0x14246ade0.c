...
do
    ...
    *(rbx_1 - 0x14) = rbp_1.d
    ...
    if (rbp_1.d != 0)
        ...
        memcpy(*r14_1, r13_1, (rbp_1 * 0xc).d)
    else
        *(rbx_1 - 0x10) = 0
    ...
    *(rbx_1 - 4) = rbp_2.d
    ...
    if (rbp_2.d != 0)
        sub_1405a4be0(rbx_1 - 0xc, rbp_2.d, 0)
        memcpy(*(rbx_1 - 0xc), rax_2, (rbp_2 << 4).d)
    else
        *rbx_1 = 0
    ...
    *(rbx_1 + 0xc) = rbp_3.d
    ...
    if (rbp_3.d != 0)
        sub_1407c3650(rbx_1 + 4, rbp_3.d, 0)
        memcpy(*(rbx_1 + 4), rax_3, (rbp_3 * 0xc).d)
    else
        *(rbx_1 + 0x10) = 0
