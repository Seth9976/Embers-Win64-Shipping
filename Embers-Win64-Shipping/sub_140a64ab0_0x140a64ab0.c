...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        ...
        zmm1_2 = sub_140a646c0(arg1, &rbx_2[2], sub_140a1d9d0(arg1, rbx_2, zmm1_2))
        int32_t var_4c
...
int512_t zmm1 = sub_140a71d50(arg2, arg_8)
int32_t r15 = 0
...
do
    ...
    if (rdx_8 == 0)
        ...
        *rdx_11 &= not.d(1 << (rbp_1.b & 0x1f))
        ...
        rdi_1 = sx.q(arg2[6].d)
        int64_t r9_2 = *arg2
        int64_t r8_5 = sx.q(*(rdi_1 * 0x68 + r9_2 + 4))
        arg2[6].d = r8_5.d
        *(arg2 + 0x34) = rdx_8 - 1
    ...
    *r8_6 |= 1 << (rdi_1.b & 0x1f)
    uint64_t* rdx_14 = *arg2 + sx.q(rdi_1.d) * 0x68
    ...
    *(rcx_14 + 0x1c) = 0x80
    ...
    zmm1 = sub_140a646c0(arg1, &rdx_14[2], sub_140a1d9d0(arg1, rdx_14, zmm1))
    r15 += 1
while (r15 s< arg_8)
