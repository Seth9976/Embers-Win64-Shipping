...
void* __offset(_RTL_CRITICAL_SECTION, 0x38) var_80 = arg1 + 0x38
int32_t rcx = 0
...
while (true)
    ...
    if (result.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x38 && rdx_11 == &arg1[1])
        if (arg1 == 0)
            return result
        
        return LeaveCriticalSection(arg1)
    
    int64_t* rcx_8 = *(result * 0x78 + *rdx_11 + 0x68)
