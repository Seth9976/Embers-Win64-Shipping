    ...
    do
        ...
        if (rdi_1 s< arg2)
            do
                ...
                if ((rdx_1 + 1).d s< arg2)
                    if (arg1[(sx.q(r10_1) + 2) * 2].q u< arg1[sx.q(rdx_1.d) * 2].q)
                        rdx_1 = zx.q(r10_1)
                    
                    rdx_1 = zx.q(rdx_1.d + 1)
                
                int64_t* r9_4 = &arg1[sx.q(r9_1) * 2]
                uint64_t* rcx_5 = &arg1[sx.q(rdx_1.d) * 2]
                result = *rcx_5
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if ((result + 1).d s< i)
                    if (*(((sx.q(result_1) + 2) << 5) + arg1) u< arg1[sx.q(result.d) * 2].q)
