...
if (result.d != 0)
        ...
        if (i != 0)
            ...
            if (r10_2.d != result.d)
                ...
                if (rdi_2 != 0xffffffff)
                    ...
                    int32_t rcx_6 = rax_3 - r10_2.d
                    
                    if (rcx_6 != rdi_2 + 1)
                        int64_t r9_2 = *(arg1 + 8)
                        memmove(r9_2 + (r10_2 << 2), r9_2 + (sx.q(r10_2.d + rdi_2 + 1) << 2), 
                            (rcx_6 - (rdi_2 + 1)) << 2)
                        rax_3 = *(arg1 + 0x10)
            ...
            if (rsi_2 != 0xffffffff)
                ...
                if (rcx_1 != rsi_2 + 1)
                    int64_t r9_1 = *(arg1 + 8)
                    memmove(r9_1 + (r10_1 << 2), r9_1 + (sx.q(r10_1.d + rsi_2 + 1) << 2), 
                        (rcx_1 - (rsi_2 + 1)) << 2)
                    rax = *(arg1 + 0x10)
    ...
    if (*(arg1 + 0x14) != rdx_2)
        return sub_1405dadb0(arg1 + 8, rdx_2)
