...
while (true)
    int64_t* r9_5 = (sx.q(r10_2) << 4) + *rbx
    int64_t rdx_6 = *r9_5
    uint32_t r8_8 = (rdx_6 u>> 0x20).d
    int32_t rdx_8 = (rdx_6.d - r8_8) ^ r8_8 u>> 0xd
    int32_t rcx_6 = (0x9e3779b9 - r8_8 - rdx_8) ^ rdx_8 << 8
    int32_t r8_11 = (r8_8 - rcx_6 - rdx_8) ^ rcx_6 u>> 0xd
    int32_t rdx_11 = (rdx_8 - rcx_6 - r8_11) ^ r8_11 u>> 0xc
    int32_t rcx_9 = (rcx_6 - rdx_11 - r8_11) ^ rdx_11 << 0x10
    int32_t r8_14 = (r8_11 - rcx_9 - rdx_11) ^ rcx_9 u>> 5
    int32_t rdx_14 = (rdx_11 - rcx_9 - r8_14) ^ r8_14 u>> 3
    int32_t rcx_12 = (rcx_9 - rdx_14 - r8_14) ^ rdx_14 << 0xa
    int32_t r8_18 = ((r8_14 - rcx_12 - rdx_14) ^ rcx_12 u>> 0xf) & (*rsi - 1)
    void* rax_30 = arg1 + 0x38
    *(r9_5 + 0xc) = r8_18
    void* rdx_15 = *(arg1 + 0x40)
    int64_t r8_19 = sx.q(r8_18)
    
    if (rdx_15 != 0)
        rax_30 = rdx_15
    
    r9_5[1].d = *(rax_30 + (((sx.q(*rsi) - 1) & r8_19) << 2))
    void* rax_32 = arg1 + 0x38
    void* rcx_17 = *(arg1 + 0x40)
    
    if (rcx_17 != 0)
        rax_32 = rcx_17
    
    *(rax_32 + (((sx.q(*rsi) - 1) & r8_19) << 2)) = r10_2
