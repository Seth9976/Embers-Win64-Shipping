...
if (data_143e8b178 s> *rdi_1)
    _Init_thread_header(&data_143e8b178)
    
    if (data_143e8b178 == 0xffffffff)
        ...
        data_143e8b170 = rax_9
        _Init_thread_footer(&data_143e8b178)

if (data_143e8b188 s> *rdi_1)
    _Init_thread_header(&data_143e8b188)
    
    if (data_143e8b188 == 0xffffffff)
        ...
        data_143e8b180 = rax_12
        _Init_thread_footer(&data_143e8b188)

if (data_143e8b198 s> *rdi_1)
    _Init_thread_header(&data_143e8b198)
    
    if (data_143e8b198 == 0xffffffff)
        ...
        data_143e8b190 = rax_15
        _Init_thread_footer(&data_143e8b198)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b170
int64_t rcx
...
label_1412c3c53:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412c3c4e
        
        rbx.b = 1
        goto label_1412c3c53
