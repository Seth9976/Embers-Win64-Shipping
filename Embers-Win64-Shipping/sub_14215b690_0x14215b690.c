    ...
    do
        ...
        if (rsi_1 s< arg2)
            do
                ...
                if ((r8_1 + 1).d s< arg2)
                    if (*(arg1 + sx.q(r11_1) * 0x14 + 0x30) s< *(arg1 + sx.q(r8_1.d) * 0x14 + 8))
                        r8_1 = zx.q(r11_1)
                    
                    r8_1 = zx.q(r8_1.d + 1)
                
                int128_t* rdx_2 = arg1 + sx.q(r8_1.d) * 0x14
                int64_t rcx_2 = sx.q(r10_1) * 5
                result = zx.q(*(rdx_2 + 8))
                int128_t* r10_2 = arg1 + (rcx_2 << 2)
                
                if (*(arg1 + (rcx_2 << 2) + 8) s>= result.d)
                    break
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if ((result + 1).d s< i)
                    if (*(arg1 + sx.q(result_1) * 0x14 + 0x30)
                            s< *(arg1 + sx.q(result.d) * 0x14 + 8))
                        result = zx.q(result_1)
                    
                    result = zx.q(result.d + 1)
                
                void* r8_3 = arg1 + sx.q(result.d) * 0x14
                int64_t rdx_5 = sx.q(r10_3) * 5
                void* r10_4 = arg1 + (rdx_5 << 2)
                
                if (*(arg1 + (rdx_5 << 2) + 8) s>= *(r8_3 + 8))
                    break
                
                if (r10_4 != r8_3)
                    int32_t rdx_6 = *(r10_4 + 0x10)
                    zmm1 = *r10_4
                    *r10_4 = *r8_3
