...
if (data_143e8ca68 s> *rdi_1)
    _Init_thread_header(&data_143e8ca68)
    
    if (data_143e8ca68 == 0xffffffff)
        ...
        data_143e8ca60 = rax_9
        _Init_thread_footer(&data_143e8ca68)

if (data_143e8ca78 s> *rdi_1)
    _Init_thread_header(&data_143e8ca78)
    
    if (data_143e8ca78 == 0xffffffff)
        ...
        data_143e8ca70 = rax_12
        _Init_thread_footer(&data_143e8ca78)

if (data_143e8ca88 s> *rdi_1)
    _Init_thread_header(&data_143e8ca88)
    
    if (data_143e8ca88 == 0xffffffff)
        ...
        data_143e8ca80 = rax_15
        _Init_thread_footer(&data_143e8ca88)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ca60
int64_t rcx
