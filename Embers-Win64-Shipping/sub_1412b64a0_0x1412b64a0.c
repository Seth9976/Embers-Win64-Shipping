...
if (data_143e8b8a8 s> *rdi_1)
    _Init_thread_header(&data_143e8b8a8)
    
    if (data_143e8b8a8 == 0xffffffff)
        ...
        data_143e8b8a0 = rax_9
        _Init_thread_footer(&data_143e8b8a8)

if (data_143e8b8c8 s> *rdi_1)
    _Init_thread_header(&data_143e8b8c8)
    
    if (data_143e8b8c8 == 0xffffffff)
        ...
        data_143e8b8c0 = rax_12
        _Init_thread_footer(&data_143e8b8c8)

if (data_143e8b8e8 s> *rdi_1)
    _Init_thread_header(&data_143e8b8e8)
    
    if (data_143e8b8e8 == 0xffffffff)
        ...
        data_143e8b8e0 = rax_15
        _Init_thread_footer(&data_143e8b8e8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b8a0
int64_t rcx
...
label_1412b65a3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412b659e
        
        rbx.b = 1
        goto label_1412b65a3
