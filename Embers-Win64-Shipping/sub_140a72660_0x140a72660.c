...
if (rdi != 0)
    ...
    label_140a72718:
        ...
        while (true)
            ...
            if (rdx_2 != 0)
                goto label_140a72718
        
        var_84.d = rdi

int32_t rdx_4 = *(arg1 + 0x58)
...
while (true)
    ...
    if (result.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0x40 && rdx_9 == arg1 + 0x30)
        break
    
    int64_t rcx_8 = result * 5
    int64_t rax_20 = *rdx_9
    result = (*arg2)(*(arg2 + 8), rax_20 + (rcx_8 << 3), *(rax_20 + (rcx_8 << 3) + 0x10) + 0x10)
