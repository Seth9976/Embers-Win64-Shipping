...
if (data_143e8bda8 s> *rdi_1)
    _Init_thread_header(&data_143e8bda8)
    
    if (data_143e8bda8 == 0xffffffff)
        ...
        data_143e8bda0 = rax_12
        _Init_thread_footer(&data_143e8bda8)

if (data_143e8bdc8 s> *rdi_1)
    _Init_thread_header(&data_143e8bdc8)
    
    if (data_143e8bdc8 == 0xffffffff)
        ...
        data_143e8bdc0 = rax_15
        _Init_thread_footer(&data_143e8bdc8)

if (data_143e8bde8 s> *rdi_1)
    _Init_thread_header(&data_143e8bde8)
    
    if (data_143e8bde8 == 0xffffffff)
        ...
        data_143e8bde0 = rax_18
        _Init_thread_footer(&data_143e8bde8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8bda0
int64_t rcx
...
label_1412b7008:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412b7003
    
    rbx.b = 1
    goto label_1412b7008
