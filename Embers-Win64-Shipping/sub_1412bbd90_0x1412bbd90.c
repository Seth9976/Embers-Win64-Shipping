...
if (data_143e8c490 s> *rdi_1)
    _Init_thread_header(&data_143e8c490)
    
    if (data_143e8c490 == 0xffffffff)
        ...
        data_143e8c488 = rax_9
        _Init_thread_footer(&data_143e8c490)

if (data_143e8c4b0 s> *rdi_1)
    _Init_thread_header(&data_143e8c4b0)
    
    if (data_143e8c4b0 == 0xffffffff)
        ...
        data_143e8c4a8 = rax_12
        _Init_thread_footer(&data_143e8c4b0)

if (data_143e8c4d0 s> *rdi_1)
    _Init_thread_header(&data_143e8c4d0)
    
    if (data_143e8c4d0 == 0xffffffff)
        ...
        data_143e8c4c8 = rax_15
        _Init_thread_footer(&data_143e8c4d0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c488
int64_t rcx
...
label_1412bbe93:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412bbe8e
        
        rbx.b = 1
        goto label_1412bbe93
