...
while (true)
    int128_t* r9_5 = sx.q(r10_2) * 0x60 + *rbx
    int32_t rax_15 = (*rsi - 1) & (*r9_5).d
    *(r9_5 + 0x5c) = rax_15
    ...
    *(r9_5 + 0x58) = *(rax_16 + (((sx.q(*rsi) - 1) & r8_3) << 2))
    ...
    *(rax_18 + (((sx.q(*rsi) - 1) & r8_3) << 2)) = r10_2
    var_30_1.d &= not.d(var_40:4.d)
    sub_14059bdd0(&var_40)
    r10_2 = var_30_1:4.d
    
    if (r10_2 s>= *(var_40:8.q + 0x18))
        break
