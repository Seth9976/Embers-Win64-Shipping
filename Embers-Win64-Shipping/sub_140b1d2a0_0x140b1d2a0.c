...
if (data_143de69a8 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143de69a8)
    
    if (data_143de69a8 == 0xffffffff)
        ...
        sub_140a2cf70(&var_18, u"Build/PerforceBuild.txt", 0x17)
        sub_140a464c0()
        ...
        data_143de69a4 = rax_5
        
        if (rcx_7 != 0)
            sub_140a74f90(rcx_7)
        
        _Init_thread_footer(&data_143de69a8)

return zx.q(data_143de69a4)
