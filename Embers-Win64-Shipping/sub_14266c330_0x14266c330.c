...
if (r11 != 0)
    ...
    label_14266c3c8:
        ...
        while (true)
            ...
            if (rdx_2 != 0)
                goto label_14266c3c8
        
        var_64.d = r11

void* var_10 = arg1 + 0x1f8
int128_t zmm0 = var_78.o
int128_t var_20 = 0xffffffff
int16_t var_40 = 0
void* result = zmm0.q
var_68.o = zmm0
var_78.o = (arg1 + 0x1f8).o
...
if (0 s< *(result + 0x18))
    ...
    do
        int64_t* rax_14 = sub_140d3c6e0(*var_78.q + 0x30 + (sx.q(i) << 6))
        
        if (rax_14 != 0)
            int64_t r8_2 = *rax_14
            (*(r8_2 + 0x758))(rax_14, arg2, r8_2)
    ...
    if (var_40.b != 0 && var_40:1.b != 0)
        return sub_14264c840(arg1 + 0x1f8, *(arg1 + 0x200) - *(arg1 + 0x22c), 1)
