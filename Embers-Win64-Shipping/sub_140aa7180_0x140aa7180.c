...
label_140aa72c7:
    ...
    if (r8_5 s> 0 && (rax_14 == 0 || rax_14 s< r14))
        arg1[9].d = r14
        sub_140abe800(arg1)
    else
        void* r9_3 = &arg1[7]
    ...
    label_140aa7222:
        ...
        while (true)
            ...
            if (*(rcx_2 + rdx_3) == *arg4 && *(rcx_2 + rdx_3 + 8) == arg4[1].d)
                break
            
            rbx_1 = *(rcx_2 + rdx_3 + 0x18)
            
            if (rbx_1 == 0xffffffff)
                goto label_140aa7222
    ...
    if (rbx_1 == 0xffffffff)
        ...
        memmove((sx.q(rbx_1) << 5) + *arg1, arg4, 0x16)
