...
if (sub_142bf7510(arg2, arg1, 2) != 0
    ...
    label_142c248fc:
        ...
        while (true)
            int64_t r8_4 = *(arg2 + 8)
            void* r10_2 = &arg1[2 + (zx.q(rdi) << 2)]
            int32_t rcx_2
            
            if (r8_4 u<= r10_2 && r10_2 u<= *(arg2 + 0x10) && arg2[4] - r10_2.d u>= 4)
                rcx_2 = arg2[6]
                arg2[6] = rcx_2 - 1
            
            char r11_1
            
            if (r8_4 u> r10_2 || r10_2 u> *(arg2 + 0x10) || arg2[4] - r10_2.d u< 4 || rcx_2 s<= 0)
                r11_1 = 0
            else
                r11_1 = 1
