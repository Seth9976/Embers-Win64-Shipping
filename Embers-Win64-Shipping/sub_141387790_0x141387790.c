...
if (rax != 0)
    ...
    int64_t rax_2 = rsi_1[3]
    
    if (*(r14_1 + rax_2) == 0)
        sub_1419ccf30(rsi_1, rdx.d)
        rax_2 = rsi_1[3]
...
int64_t r8_1 = *arg1
int64_t var_28 = 0
sub_1413845c0(&var_4a8, &arg1[3], r8_1)
int64_t rsi_2 = 0
...
if (rcx_5 != 0)
    ...
    int64_t* rdi_1 = *(arg1[4] + 0x10)
    int64_t rsi_3 = rdx_3 << 3
...
int32_t rdi_2 = *(arg1 + 0x2c)
int32_t r14_2 = arg1[5].d
