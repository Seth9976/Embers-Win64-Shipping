...
if (data_143e8ce98 s> *rdi_1)
    _Init_thread_header(&data_143e8ce98)
    
    if (data_143e8ce98 == 0xffffffff)
        ...
        data_143e8ce90 = rax_9
        _Init_thread_footer(&data_143e8ce98)

if (data_143e8ceb8 s> *rdi_1)
    _Init_thread_header(&data_143e8ceb8)
    
    if (data_143e8ceb8 == 0xffffffff)
        ...
        data_143e8ceb0 = rax_12
        _Init_thread_footer(&data_143e8ceb8)

if (data_143e8ced8 s> *rdi_1)
    _Init_thread_header(&data_143e8ced8)
    
    if (data_143e8ced8 == 0xffffffff)
        ...
        data_143e8ced0 = rax_15
        _Init_thread_footer(&data_143e8ced8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ce90
int64_t rcx
