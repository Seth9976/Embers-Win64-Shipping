...
if (rbx != 0)
    ...
    label_1419e2588:
        ...
        while (true)
            ...
            if (rdx_2 != 0)
                goto label_1419e2588
        
        var_84.d = rbx

int32_t rdx_4 = *(arg1 + 0x248)
...
while (true)
    ...
    if (result.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0x230 && rdx_9 == arg1 + 0x220)
        return result
    
    int64_t* rbx_1 = *(*rdx_9 + result * 0x18)
    
    if (rbx_1 != 0 && (*(*rbx_1 + 0x260))(rbx_1) == arg2)
