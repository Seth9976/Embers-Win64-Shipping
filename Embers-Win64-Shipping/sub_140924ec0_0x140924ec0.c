...
label_14092508b:
    ...
    if (rdx_11 u>= 4)
        ...
        rbp = 1 << ((not.d(rcx_10 << 0x1a s>> 0x1f)).b & (0x20 - r8_3))
    ...
    if (rdx_11 s> 0 && (rax_21 == 0 || rax_21 s< rbp))
        arg1[9].d = rbp
        sub_1405d3260(arg1)
    else
        void* r9_3 = &arg1[7]
        ...
        *(arg4 + 0x24) = rax_24
        ...
        arg4[4].d = *(rax_25 + (((sx.q(arg1[9].d) - 1) & r8_4) << 2))
        void* rax_27 = *(r9_3 + 8)
    ...
    label_140924f8e:
        ...
        while (true)
            ...
            if (rdx_3[sx.q(rbx_1) * 5 + 1].d == 0)
                rcx_2 = &data_142d40450
            else
                rcx_2 = rdx_3[sx.q(rbx_1) * 5]
            
            if (sub_140a54510(rcx_2, rax_3) == 0)
                break
            
            rdx_3 = *arg1
            rbx_1 = rdx_3[sx.q(rbx_1) * 5 + 4].d
            
            if (rbx_1 == 0xffffffff)
                goto label_140924f8e
    ...
    if (rbx_1 == 0xffffffff)
        ...
        int64_t rax_11 = *arg1
        int64_t rdx_7 = rcx_8 * 5
        int32_t r9 = -1
        *(rax_11 + (rdx_7 << 3)) = 0xffffffff
