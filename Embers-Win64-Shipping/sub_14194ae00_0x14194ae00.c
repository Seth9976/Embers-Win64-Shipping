...
while (true)
    ...
    int64_t rax_13 = *rbx
    void* r10_2 = rax_13 + (rcx_4 << 3)
    int64_t rcx_5 = *(rax_13 + (rcx_4 << 3))
    int32_t r8_9 = ((rcx_5 s>> 0x20).d * 0x17 + rcx_5.d) & (*rsi - 1)
    void* rax_18 = &arg1[7]
    *(r10_2 + 0x14) = r8_9
    void* rdx_6 = arg1[8]
    ...
    *(r10_2 + 0x10) = *(rax_18 + (((sx.q(*rsi) - 1) & r9_3) << 2))
    void* rax_20 = &arg1[7]
    void* rcx_9 = arg1[8]
