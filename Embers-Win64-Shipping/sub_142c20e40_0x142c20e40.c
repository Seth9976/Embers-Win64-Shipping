    ...
    do
        ...
        if ((*(r15_1 + rdx + 4) & rdi) != 0)
            ...
            if (result.b != 0)
                ...
                result = sub_142c1ef00(*arg1, *(r15_1 + var_120), *(var_120 + result_3 * 0x14))
                ...
                if (result.d != 0)
                    if (rax_2 != 4)
                        ...
                        if (arg1[1].b == 0)
                            int32_t rax_15 = rcx_8 s>> 1
                            *(r15_1 + r12 + 4) += rax_15
                            int32_t rcx_12 = rcx_8 - rax_15
                            uint64_t rax_16 = result_3 * 5
                            *(r12 + (rax_16 << 2) + 4) += rcx_12
                            *(r12 + (rax_16 << 2) + 0xc) += rcx_12
                        else
                            *(r12 + result_3 * 0x14 + 8) = rcx_8
                            *(arg3 + 0x28) |= 8
                    else
                        if (arg5 != 0)
                        ...
                        if (arg1[1].b == 0)
                            int32_t rax_10 = rcx_8 s>> 1
                            *(r15_1 + r12) += rax_10
                            int32_t rcx_10 = rcx_8 - rax_10
                            uint64_t rax_11 = result_3 * 5
                            *(r12 + (rax_11 << 2)) += rcx_10
                            *(r12 + (rax_11 << 2) + 8) += rcx_10
                        else
                            *(r12 + result_3 * 0x14 + 0xc) = rcx_8
                            *(arg3 + 0x28) |= 8
