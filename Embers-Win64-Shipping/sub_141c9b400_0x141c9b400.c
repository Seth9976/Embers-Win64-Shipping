...
label_141c9b541:
    ...
    if (r8_5 s> 0 && (rax_19 == 0 || rax_19 s< rbp))
        ...
        *(arg4 + 0x24) = *(rax_23 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_25 = *(r9_2 + 8)
    ...
    label_141c9b49e:
        ...
        while (true)
            int64_t* rcx_1 = sx.q(rbx_1) * 0x2c
            
            if (*(rcx_1 + rdx_3) == *arg4 && *(rcx_1 + rdx_3 + 0x10) == arg4[2]
                    && *(rcx_1 + rdx_3 + 0x18) == arg4[3])
                break
            
            rbx_1 = *(rcx_1 + rdx_3 + 0x24)
            
            if (rbx_1 == 0xffffffff)
                goto label_141c9b49e
    ...
    if (rbx_1 == 0xffffffff)
        ...
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0x2c + *arg1) = rcx_4.d
        
        int32_t* rax_9 = rcx_4 * 0x2c + *arg1
        *rax_9 = 0xffffffff
