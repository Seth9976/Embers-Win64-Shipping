...
if (*(data_143f02ac8 + 4) s<= 0 || arg8 != 1)
    ...
    sub_140b34200("LockStructuredBuffer_RenderThread", r12_1)
    ...
    int64_t result_2 = (*(*rcx_4 + 0x658))(rcx_4, arg2, arg3, zx.q(arg4), rdi, arg8)
    arg2[0x10] = 0
    result = result_2
    sub_140b38680("LockStructuredBuffer_RenderThread", r12_1)
else
    rdi = arg7
