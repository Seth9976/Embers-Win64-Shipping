...
int64_t* rax_3 = sub_140ac6680(
    _vfprintf_p_l(&var_28, Prints version information for the current HMD device.", 
    HeadMountedDisplay"))
int16_t* const rbx_1
...
data_143ef9658 = (*(*rcx_2 + 0x78))(rcx_2, u"vr.HMDVersion", rbx_1, &var_38, 0)
data_143ef9650 = &data_142d3ff10
int64_t* var_20
...
label_1404cff7b:
    ...
    if (rcx_5 != 0)
        ...
        int32_t var_30_1 = 0
        goto label_1404cff7b
return atexit(sub_142ceb8c0) __tailcall
