...
uint64_t var_1ec_1 = *(rax_5 + 0xc)
void* rcx_3 = arg1[3] + 0xb0
uint64_t var_1e0
uint64_t zmm0_1 = var_1e0
...
if (r12_3 != 0)
    ...
    uint64_t var_68_1 = zmm9
    uint64_t var_78_1 = zmm10
    ...
    do
        ...
        int64_t rcx_5 = sx.q(*(r8_3 + (r9_1 << 2))) * 3
        int64_t rax_12 = sx.q(*(r8_3 + (r9_1 << 2) + 4))
        zmm1_1[0] = zmm1_1[0] f* *(r10_1 + (rcx_5 << 2) + 8)
        zmm7[0] = zmm7[0] f* *(r10_1 + (rcx_5 << 2))
        zmm4_1.d = zmm4_1.d f* *(r10_1 + (rcx_5 << 2) + 4)
        int64_t rcx_6 = rax_12 * 3
        int64_t rax_13 = sx.q(*(r8_3 + (r9_1 << 2) + 8))
        ...
        int32_t* zmm13_1
        int64_t zmm14_1
        rax_16, zmm6_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm14_1 = sub_141628dc0(
        ...
        uint64_t zmm10_2
        int128_t zmm12_2
        rax_22, zmm8_2, zmm9_2, zmm10_2, zmm11, zmm12_2 = sub_141628dc0(&var_f8, rdx_6, r8_5, 
