    ...
    do
        ...
        if (rsi_1 s< arg2)
            do
                ...
                if ((r8_1 + 1).d s< arg2)
                    if (*(arg1 + (sx.q(r11_1) + 2) * 0xc) s< *(arg1 + sx.q(r8_1.d) * 0xc))
                        r8_1 = zx.q(r11_1)
                    
                    r8_1 = zx.q(r8_1.d + 1)
                
                int32_t* rdx_2 = arg1 + sx.q(r8_1.d) * 0xc
                int64_t rcx_2 = sx.q(r10_1) * 3
                result = zx.q(*rdx_2)
                int64_t* r10_2 = arg1 + (rcx_2 << 2)
                
                if (*(arg1 + (rcx_2 << 2)) s>= result.d)
                    break
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if ((result + 1).d s< i)
                    if (*(arg1 + (sx.q(result_1) + 2) * 0xc) s< *(arg1 + sx.q(result.d) * 0xc))
