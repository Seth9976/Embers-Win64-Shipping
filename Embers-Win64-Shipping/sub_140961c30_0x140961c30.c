...
wchar16 const* const var_78 = u"GetMyPlayerIndex"
...
if (var_90 != 0 && rax != 0)
    ...
    if (r15_1 == 0)
        ...
        int64_t* var_70
        void var_50
        (*(*r15_1 + 0x38))(r15_1, &var_70, sub_140596d10(&var_50, arg3))
        ...
        if (rcx_9 == 0)
            ...
            result = sub_140d23f50(r14, 3)
            int16_t* rcx_12 = var_a0
            
            if (rcx_12 != 0)
                result = sub_140a74f90(rcx_12)
        else
            result = (*(*rcx_9 + 0x40))(rcx_9)
            *arg4 = result
