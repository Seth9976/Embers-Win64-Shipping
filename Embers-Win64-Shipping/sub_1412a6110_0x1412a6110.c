...
if (data_143e8ea28 s> *rdi_1)
    _Init_thread_header(&data_143e8ea28)
    
    if (data_143e8ea28 == 0xffffffff)
        ...
        data_143e8ea20 = rax_9
        _Init_thread_footer(&data_143e8ea28)

if (data_143e8ea38 s> *rdi_1)
    _Init_thread_header(&data_143e8ea38)
    
    if (data_143e8ea38 == 0xffffffff)
        ...
        data_143e8ea30 = rax_12
        _Init_thread_footer(&data_143e8ea38)

if (data_143e8ea48 s> *rdi_1)
    _Init_thread_header(&data_143e8ea48)
    
    if (data_143e8ea48 == 0xffffffff)
        ...
        data_143e8ea40 = rax_15
        _Init_thread_footer(&data_143e8ea48)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ea20
int64_t rcx
...
label_1412a6213:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412a620e
        
        rbx.b = 1
        goto label_1412a6213
