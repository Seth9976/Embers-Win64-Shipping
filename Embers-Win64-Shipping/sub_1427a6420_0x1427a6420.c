...
label_1427a6598:
    ...
    if (r8_4 s> 0 && (rax_20 == 0 || rax_20 s< rbp))
        ...
        arg4[0x14] = *(rax_24 + (((sx.q(arg1[9].d) - 1) & r8_5) << 2))
        void* rax_26 = *(r9_2 + 8)
    ...
    label_1427a64ba:
        ...
        while (true)
            ...
            rbx_1 = *(rcx_2 + rdx_3 + 0x50)
            
            if (rbx_1 == 0xffffffff)
                goto label_1427a64ba
    ...
    if (rbx_1 == 0xffffffff)
        ...
        if (*(rdi_2 + 0x10) != 0)
            void* rax_4 = *(rdi_2 + 0x20)
            void* rcx_3 = rdi_2 + 0x30
        ...
        int32_t* rax_10 = rcx_5 * 0x60 + *arg1
        *rax_10 = 0xffffffff
