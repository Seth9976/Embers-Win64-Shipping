...
if (data_143e2ced0 s> *rdi_1)
    _Init_thread_header(&data_143e2ced0)
    
    if (data_143e2ced0 == 0xffffffff)
        ...
        data_143e2cec8 = rax_6
        _Init_thread_footer(&data_143e2ced0)

if (data_143e2cee0 s> *rdi_1)
    _Init_thread_header(&data_143e2cee0)
    
    if (data_143e2cee0 == 0xffffffff)
        ...
        data_143e2ced8 = rbx
        _Init_thread_footer(&data_143e2cee0)

if (data_143e2ced8 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()

if (data_143e2cec8 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()
