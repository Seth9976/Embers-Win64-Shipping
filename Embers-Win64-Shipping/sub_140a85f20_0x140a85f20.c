...
if (i_2 s> 0)
    ...
    do
        ...
        int64_t rdx_4 = (sx.q(*rsi_1) - 1) & r9_1
...
if (r10_1 != 0)
    ...
    label_140a86058:
        ...
        int32_t var_44_2 = rcx_3 - rax_11 + 0x1f
...
while (true)
    void* r9_4 = sx.q(r10_2) * 0xd8 + *rbx
    int32_t rax_16 = (*rsi_1 - 1) & *(r9_4 + 0x10)
    *(r9_4 + 0xd4) = rax_16
    ...
    *(r9_4 + 0xd0) = *(rax_17 + (((sx.q(*rsi_1) - 1) & r8_3) << 2))
    ...
    *(rax_19 + (((sx.q(*rsi_1) - 1) & r8_3) << 2)) = r10_2
