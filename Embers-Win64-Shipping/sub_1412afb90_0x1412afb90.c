...
if (data_143e8cf98 s> *rdi_1)
    _Init_thread_header(&data_143e8cf98)
    
    if (data_143e8cf98 == 0xffffffff)
        ...
        data_143e8cf90 = rax_12
        _Init_thread_footer(&data_143e8cf98)

if (data_143e8cfb8 s> *rdi_1)
    _Init_thread_header(&data_143e8cfb8)
    
    if (data_143e8cfb8 == 0xffffffff)
        ...
        data_143e8cfb0 = rax_15
        _Init_thread_footer(&data_143e8cfb8)

if (data_143e8cfd8 s> *rdi_1)
    _Init_thread_header(&data_143e8cfd8)
    
    if (data_143e8cfd8 == 0xffffffff)
        ...
        data_143e8cfd0 = rax_18
        _Init_thread_footer(&data_143e8cfd8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8cf90
int64_t rcx
