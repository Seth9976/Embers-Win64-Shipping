...
if (data_143e8c390 s> *rdi_1)
    _Init_thread_header(&data_143e8c390)
    
    if (data_143e8c390 == 0xffffffff)
        ...
        data_143e8c388 = rax_12
        _Init_thread_footer(&data_143e8c390)

if (data_143e8c3b0 s> *rdi_1)
    _Init_thread_header(&data_143e8c3b0)
    
    if (data_143e8c3b0 == 0xffffffff)
        ...
        data_143e8c3a8 = rax_15
        _Init_thread_footer(&data_143e8c3b0)

if (data_143e8c3d0 s> *rdi_1)
    _Init_thread_header(&data_143e8c3d0)
    
    if (data_143e8c3d0 == 0xffffffff)
        ...
        data_143e8c3c8 = rax_18
        _Init_thread_footer(&data_143e8c3d0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c388
int64_t rcx
...
label_1412bd0f8:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412bd0f3
    
    rbx.b = 1
    goto label_1412bd0f8
