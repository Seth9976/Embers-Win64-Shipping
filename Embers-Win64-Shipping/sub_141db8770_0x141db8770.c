...
void var_198
float (* result)[0x4] = __security_cookie ^ &var_198
float (* result_1)[0x4] = result

if ((arg2[0x11].b & 1) != 0)
    if (**arg1 == 0)
        result = (*(*arg2 + 0x4c8))(arg2)
    
    if (**arg1 != 0 || result.d != 0)
        int128_t* rcx_1 = arg1[1]
        float zmm8[0x4] = rcx_1[2]
        float zmm14[0x4] = *(arg2 + 0x1e0)
        int32_t var_178
        ...
        if (_mm_movemask_ps(_mm_cmpeq_ps(_mm_min_ps(zmm14, zmm8), data_143f38cd0, 1)) == 0)
            zmm5 = *rcx_1
            float zmm2[0x4] = *(arg2 + 0x1c0)
            float zmm7[0x4] = rcx_1[1]
            ...
            float temp0_138[0x4] = __mulps_xmmps_memps(temp0_135, data_143f38c90)
            zmm6 = _mm_shuffle_ps(zmm5, zmm5, 0xff)
            float var_c8_2[0x4] = _mm_mul_ps(zmm14, zmm8)
            float temp0_142[0x4] = _mm_add_ps(temp0_138, _mm_mul_ps(zmm6, zmm2))
            ...
            float temp0_148[0x4] = __mulps_xmmps_memps(temp0_144, data_143f38c80)
            float temp0_149[0x4] = _mm_shuffle_ps(zmm5, zmm5, 0xd2)
            float temp0_150[0x4] = __mulps_xmmps_memps(temp0_147, data_143f38c70)
            ...
            float temp0_158[0x4] = _mm_sub_ps(
                _mm_mul_ps(_mm_shuffle_ps(temp0_137, temp0_137, 0xd2), temp0_152), temp0_155)
            ...
            float temp0_165[0x4] = _mm_sub_ps(temp0_162, temp0_163)
            zmm3 = _mm_add_ps(temp0_164, temp0_137)
            zmm1 = _mm_add_ps(_mm_add_ps(temp0_165, zmm3), zmm7)
            float var_d8_2[0x4] = zmm1
        else
            zmm1 = *rcx_1
            float temp0_4[0x4] = _mm_shuffle_ps(zmm8, zmm8, 0xc9)
            float temp0_5[0x4] = _mm_add_ps(zmm1, zmm1)
            float zmm9[0x4] = rcx_1[1]
            float temp0_6[0x4] = _mm_shuffle_ps(zmm1, zmm1, 4)
            float zmm11[0x4] = data_143f38c20
            float temp0_7[0x4] = _mm_mul_ps(temp0_5, zmm1)
            float temp0_9[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_5, temp0_5, 0x29), temp0_6)
            float temp0_10[0x4] = _mm_shuffle_ps(zmm1, zmm1, 0xff)
            float temp0_11[0x4] = _mm_shuffle_ps(temp0_7, temp0_7, 0x1a)
            float temp0_13[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_5, temp0_5, 0x12), temp0_10)
            ...
            zmm1 = __andps_xmmxud_memxud(_mm_mul_ps(temp0_19, zmm8), data_143f38c30)
            ...
            zmm1 = __andps_xmmxud_memxud(_mm_mul_ps(temp0_47, zmm14), data_143f38c30)
            ...
            float zmm13_1[0x4]
            float zmm15_1[0x4]
            zmm11_1, zmm13_1, zmm15_1 = sub_1407740e0(&var_148, 0x322bcc77)
            uint32_t zmm0_1[0x4] = data_143f38cc0 ^ zmm11_1
            float temp0_105[0x4] = _mm_cmpeq_ps(zmm15_1, zmm13_1, 2)
            float zmm2_1[0x4] = var_148[0]
            float zmm1_1 = var_148[1]
            zmm15_1 = _mm_and_ps(temp0_105, zmm0_1) ^ data_143f38cc0
            zmm0_1 = var_148[2]
            ...
            float temp0_120[0x4] = _mm_add_ps(
                _mm_mul_ps(
                    _mm_sub_ps(zmm5_1, _mm_mul_ps(_mm_mul_ps(temp0_114, temp0_114), temp0_115)), 
                    temp0_114), 
                temp0_114)
            zmm1 = zx.o(0)
            float temp0_123[0x4] =
                _mm_sub_ps(zmm5_1, _mm_mul_ps(_mm_mul_ps(temp0_120, temp0_120), temp0_115))
            float temp0_125[0x4] =
            ...
            zmm5_1 =
                _mm_and_ps(_mm_mul_ps(temp0_127, zmm6) ^ data_143f38ca0, temp0_125) ^ data_143f38ca0
            zmm3 = _mm_unpacklo_ps(_mm_unpacklo_ps(var_118_1.d, var_118_1:8.d[0].q), temp0_128[0].q)
            float var_d8_1[0x4] = zmm3
            var_e8 = zmm5_1
        result = (*(*arg2 + 0x480))(arg2, zmm1, &var_e8, zmm3, var_178)
        float* rcx_5 = arg1[2]
        zmm8 = *result
        bool cond:1_1 = rcx_5[6].b == 0
        zmm3 = (*result)[1]
        float zmm4_2[0x4] = (*result)[2]
        zmm6 = zmm3
        float zmm5_2 = zmm8[0] + (*result)[3]
        zmm6[0] = zmm6[0] f+ result[1][0]
        zmm8[0] = zmm8[0] - (*result)[3]
        zmm3[0] = zmm3[0] - result[1][0]
        char var_150_1 = 1
        zmm4_2[0] = zmm4_2[0] + (*result)[5]
        zmm4_2[0] = zmm4_2[0] - (*result)[5]
        var_168[3] = zmm5_2
        uint32_t var_158_1 = zmm6[0]
        var_168[0] = zmm8[0]
        float var_154_1 = zmm4_2[0]
        var_168[1] = zmm3[0]
        var_168[2] = zmm4_2[0]
        ...
        if (cond:1_1)
            ...
            *rcx_5 = var_168
            *(rcx_5 + 0x10) = var_158_1.q
            rcx_5[6] = result.d
        else
            float zmm0[0x4] = *rcx_5
            float temp0_169[0x4] = __minss_xmmss_memss(zmm3[0], rcx_5[1])
            float temp0_170[0x4] = __minss_xmmss_memss(zmm4_2[0], rcx_5[2])
            float temp0_171 = __maxss_xmmss_memss(zmm5_2, rcx_5[3])
            zmm6 = __maxss_xmmss_memss(zmm6[0], rcx_5[4])
            float temp0_173[0x4] = __maxss_xmmss_memss(zmm4_2[0], rcx_5[5])
            float temp0_174[0x4] = _mm_min_ss(zmm0[0], zmm8[0])
            rcx_5[1] = temp0_169[0]
            rcx_5[2] = temp0_170[0]
            rcx_5[3] = temp0_171
            rcx_5[4] = zmm6[0]
