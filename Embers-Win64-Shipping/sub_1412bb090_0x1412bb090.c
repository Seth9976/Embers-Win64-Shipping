...
if (data_143e8c310 s> *rdi_1)
    _Init_thread_header(&data_143e8c310)
    
    if (data_143e8c310 == 0xffffffff)
        ...
        data_143e8c308 = rax_12
        _Init_thread_footer(&data_143e8c310)

if (data_143e8c330 s> *rdi_1)
    _Init_thread_header(&data_143e8c330)
    
    if (data_143e8c330 == 0xffffffff)
        ...
        data_143e8c328 = rax_15
        _Init_thread_footer(&data_143e8c330)

if (data_143e8c350 s> *rdi_1)
    _Init_thread_header(&data_143e8c350)
    
    if (data_143e8c350 == 0xffffffff)
        ...
        data_143e8c348 = rax_18
        _Init_thread_footer(&data_143e8c350)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c308
int64_t rcx
...
label_1412bb188:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412bb183
    
    rbx.b = 1
    goto label_1412bb188
