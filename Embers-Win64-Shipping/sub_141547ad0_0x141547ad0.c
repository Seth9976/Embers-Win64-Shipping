...
switch (zx.d(*(arg2 + 8)))
    case 1
        sub_141531710(arg4, arg1, arg2, arg3)
    case 3
        sub_141533650(arg4, arg1, arg2, arg3)
    case 4
        ...
        if (_mm_movemask_ps(_mm_cmpeq_ps(_mm_min_ps(zmm14, zmm6), data_143ef7530, 1)) == 0)
            ...
            zmm15_1 = _mm_and_ps(_mm_cmpeq_ps(zmm15_1, zmm13, 2), data_143ef7520 ^ zmm11_1)
                ^ data_143ef7520
            float zmm1_1 = zmm15_1[0] * var_148[1]
            uint32_t zmm0_1[0x4] = zmm15_1
            zmm0_1[0] = zmm0_1[0] f* var_148[2]
            zmm15_1[0] = zmm15_1[0] * var_148[0]
            var_148[1] = zmm1_1
            var_148[2] = zmm0_1[0]
            var_148[0] = zmm15_1[0]
            ...
            zmm0_1 = temp0_107
            zmm0_1[0] = zmm0_1[0] f* var_138_1:4.d
            temp0_107[0] = temp0_107[0] f* var_138_1:8.d
            var_138_1.d = zmm1_1 f* var_138_1.d
            zmm1_1 = temp0_108[0] f* var_128_1.d
            var_138_1:4.d = zmm0_1[0]
            zmm0_1 = temp0_108
            zmm0_1[0] = zmm0_1[0] f* var_128_1:4.d
            temp0_108[0] = temp0_108[0] f* var_128_1:8.d
            var_128_1.d = zmm1_1
            var_128_1:4.d = zmm0_1[0]
            var_138_1:8.d = temp0_107[0]
            var_128_1:8.d = temp0_108[0]
            sub_14077e4a0(&var_168, &var_148)
            float zmm5_1[0x4] = var_168.o
            zmm6 = data_143ef72b0
        ...
        sub_141547ad0(arg1, zmm1, &var_108, arg4)
    case 8
        sub_14153dc90(arg4, arg1, arg2, arg3)
    case 0x40
        sub_14153bd50(arg4, arg1, *(arg2 + 0x10), arg3)
    case 0x41
        sub_141531710(arg4, arg1, *(arg2 + 0x10), arg3)
    case 0x43
        sub_141533650(arg4, arg1, *(arg2 + 0x10), arg3)
    case 0x48
        sub_14153dc90(arg4, arg1, *(arg2 + 0x10), arg3)
    case 0x80
        void* rdx_5 = *arg4
        float (* var_170_1)[0x4] = &var_168
        float (* var_178_1)[0x4] = arg3
        int128_t* r8_3 = arg4[1]
        var_168 = 0x3f800000
        int64_t var_164_1 = 0
        sub_1415ce280(arg1, rdx_5, r8_3, arg2, var_178_1, var_170_1)
    case 0x81
        void* rdx_6 = *arg4
        float (* var_170_2)[0x4] = &var_168
        float (* var_178_2)[0x4] = arg3
        int128_t* r8_4 = arg4[1]
        var_168 = 0x3f800000
        int64_t var_164_2 = 0
        sub_1415cdd40(arg1, rdx_6, r8_4, arg2, var_178_2, var_170_2)
    case 0x83
        void* rdx_7 = *arg4
        float (* var_170_3)[0x4] = &var_168
        float (* var_178_3)[0x4] = arg3
        int128_t* r8_5 = arg4[1]
        var_168 = 0x3f800000
        int64_t var_164_3 = 0
        sub_1415cdfe0(arg1, rdx_7, r8_5, arg2, var_178_3, var_170_3)
    case 0x88
        void* rdx_8 = *arg4
        float (* var_170_4)[0x4] = &var_168
        float (* var_178_4)[0x4] = arg3
        int128_t* r8_6 = arg4[1]
        var_168 = 0x3f800000
        int64_t var_164_4 = 0
        sub_1415cd560(arg1, rdx_8, r8_6, arg2, var_178_4, var_170_4)
    default
        sub_14153bd50(arg4, arg1, arg2, arg3)
