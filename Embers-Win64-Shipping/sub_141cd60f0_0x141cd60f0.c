...
if ((arg1[5].b & 1) == 0)
    ...
    void* var_78
    int512_t zmm1_1 = sub_1407453e0(&var_78, arg2)
    void* var_68
    int32_t i_1
    
    for (int32_t i = i_1; i s< *(var_68 + 0x18); i = i_1)
        void* rbx_3 = (sx.q(i) << 6) + *var_78
        (*(*arg1 + 0x140))(arg1, rbx_3)
        zmm1_1 = sub_141cd3990(arg1, rbx_3 + 8, zmm1_1)
        int32_t var_6c
...
do
    ...
    *(rsi_5 + 0x10) = 2
    *(rsi_5 + 0x18) = 0
    *(rsi_5 + 8) = &data_142e40738
    *(rsi_5 + 0x20) = 0
    *(rsi_5 + 0x28) = 0
    *(rsi_5 + 0x30) = zmm7.d
    *(rsi_5 + 0x34) = zmm6.d
    int512_t zmm1 = sub_14090c670(rsi_5 + 8, 0)
    *(rsi_5 + 0x38) = 0xffffffff
    (*(*arg1 + 0x140))(arg1, rsi_5)
    zmm6 = sub_141cd3990(arg1, rsi_5 + 8, zmm1)
    r15 += 1
while (r15 s< arg_8)
