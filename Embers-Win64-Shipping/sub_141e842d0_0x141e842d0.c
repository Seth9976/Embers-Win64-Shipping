...
if (i != 0xffffffff)
    ...
    do
        int64_t i_1 = sx.q(i)
        int64_t rax_19 = i_1 * 0xa
        
        if (*(r8_8 + (rax_19 << 3)) == arg2)
            int64_t r9_9 = i_1 * 0xa
            int64_t rax_21 = sx.q(*(r8_8 + (r9_9 << 3) + 0x4c)) & rsi_1
            void* rcx_11 = rdi + (rax_21 << 2)
            
            for (int32_t j = *(rdi + (rax_21 << 2)); j != 0xffffffff; j = *rcx_11)
                if (j == i)
                    *rcx_11 = *(r8_8 + (r9_9 << 3) + 0x48)
                    break
                
                rcx_11 = sx.q(j) * 0x50 + 0x48 + r8_8
            
            rbx = 1
            sub_1407c2c60(arg1, i, 1)
            break
        
        i = *(r8_8 + (rax_19 << 3) + 0x48)
    while (i != 0xffffffff)
