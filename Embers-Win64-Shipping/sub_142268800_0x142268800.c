...
label_14226890d:
    ...
    if (sub_1422648f0(arg1, arg1[1].d - *(arg1 + 0x34), 0) == 0)
        void* r9 = &arg1[7]
        ...
        *(arg4 + 0x84) = rax_9
        ...
        arg4[0x10].d = *(rax_10 + (((sx.q(arg1[9].d) - 1) & r8_1) << 2))
        void* rax_12 = *(r9 + 8)
    ...
    label_1422688ab:
        ...
        while (true)
            ...
            rcx_1 = *arg1
            rbx_1 = *(rsi + rcx_1 + 0x80)
            
            if (rbx_1 == 0xffffffff)
                goto label_1422688ab
    ...
    if (rbx_1 == 0xffffffff)
        ...
        memmove(sx.q(rbx_1) * 0x90 + *arg1, arg4, 0x80)
        sub_140dbb160(arg1, arg5, 1)
        rdi_1 = rbx_1
    
    if (rbx_1 == 0xffffffff)
        goto label_14226890d
