...
if (data_143e8d018 s> *rdi_1)
    _Init_thread_header(&data_143e8d018)
    
    if (data_143e8d018 == 0xffffffff)
        ...
        data_143e8d010 = rax_12
        _Init_thread_footer(&data_143e8d018)

if (data_143e8d038 s> *rdi_1)
    _Init_thread_header(&data_143e8d038)
    
    if (data_143e8d038 == 0xffffffff)
        ...
        data_143e8d030 = rax_15
        _Init_thread_footer(&data_143e8d038)

if (data_143e8d058 s> *rdi_1)
    _Init_thread_header(&data_143e8d058)
    
    if (data_143e8d058 == 0xffffffff)
        ...
        data_143e8d050 = rax_18
        _Init_thread_footer(&data_143e8d058)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d010
int64_t rcx
