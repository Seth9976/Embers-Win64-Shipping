...
if (rcx == 0)
    *arg2 = 8
    ...
    r8_2 = 0x18
    rdx_2 = u"Null Stream"
    goto label_1425c765a

uint32_t rax_3 = (*(*rcx + 0x30))(rcx)

if (rax_3.b != 0)
    if (*(arg1 + 0x69) != 0)
        goto label_1425c73fd
    ...
    *(arg1 + 0x30) = 0
    ...
    while (true)
        ...
        if (rcx_9 == 5)
            ...
            *(arg1 + 0x18) = 0
            char rax_12
            rax_12, arg3 = sub_1425c6430(arg1, arg1 + 0x18, arg3)
            ...
            if (rax_12 != 0)
                ...
                label_1425c75a1:
                    ...
                    *(arg1 + 0x18) = 0
                    char rax_14
                    rax_14, arg3 = sub_1425c6430(arg1, arg1 + 0x18, arg3)
                    
                    if (rax_14 != 0)
                        goto label_1425c7555
        else
            if (rcx_9 == 6)
                char rax_11
                rax_11, arg3 = sub_1425c7690(arg1, arg1 + 0x18, arg3)
                rsi = zx.q(rax_11)
                
                if (rax_11 == 0)
                    break
                
                goto label_1425c7558
            
            sub_1425c7250(arg1)
            *(arg1 + 0x18) = 0
            char rax_7
            rax_7, arg3 = sub_1425c6430(arg1, arg1 + 0x18, arg3)
            ...
            if (rax_7 != 0)
                ...
                goto label_1425c75a1
        rsi.b = 0
        break
    
    *arg2 = *(&data_143b4c6e8 + (sx.q(*(arg1 + 0x18)) << 2))
