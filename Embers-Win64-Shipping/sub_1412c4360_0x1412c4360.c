...
if (data_143e8b378 s> *rdi_1)
    _Init_thread_header(&data_143e8b378)
    
    if (data_143e8b378 == 0xffffffff)
        ...
        data_143e8b370 = rax_9
        _Init_thread_footer(&data_143e8b378)

if (data_143e8b388 s> *rdi_1)
    _Init_thread_header(&data_143e8b388)
    
    if (data_143e8b388 == 0xffffffff)
        ...
        data_143e8b380 = rax_12
        _Init_thread_footer(&data_143e8b388)

if (data_143e8b398 s> *rdi_1)
    _Init_thread_header(&data_143e8b398)
    
    if (data_143e8b398 == 0xffffffff)
        ...
        data_143e8b390 = rax_15
        _Init_thread_footer(&data_143e8b398)
