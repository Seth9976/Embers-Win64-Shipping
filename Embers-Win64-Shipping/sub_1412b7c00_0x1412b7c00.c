...
if (data_143e8bf18 s> *rdi_1)
    _Init_thread_header(&data_143e8bf18)
    
    if (data_143e8bf18 == 0xffffffff)
        ...
        data_143e8bf10 = rax_9
        _Init_thread_footer(&data_143e8bf18)

if (data_143e8bf28 s> *rdi_1)
    _Init_thread_header(&data_143e8bf28)
    
    if (data_143e8bf28 == 0xffffffff)
        ...
        data_143e8bf20 = rax_12
        _Init_thread_footer(&data_143e8bf28)

if (data_143e8bf40 s> *rdi_1)
    _Init_thread_header(&data_143e8bf40)
    
    if (data_143e8bf40 == 0xffffffff)
        ...
        data_143e8bf30 = rax_15
        _Init_thread_footer(&data_143e8bf40)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8bf10
int64_t rcx
...
label_1412b7d03:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412b7cfe
        
        rbx.b = 1
        goto label_1412b7d03
