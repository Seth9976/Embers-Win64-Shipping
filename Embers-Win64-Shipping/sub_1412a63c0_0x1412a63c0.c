...
if (data_143e8e770 s> *rdi_1)
    _Init_thread_header(&data_143e8e770)
    
    if (data_143e8e770 == 0xffffffff)
        ...
        data_143e8e768 = rax_9
        _Init_thread_footer(&data_143e8e770)

if (data_143e8e780 s> *rdi_1)
    _Init_thread_header(&data_143e8e780)
    
    if (data_143e8e780 == 0xffffffff)
        ...
        data_143e8e778 = rax_12
        _Init_thread_footer(&data_143e8e780)

if (data_143e8e790 s> *rdi_1)
    _Init_thread_header(&data_143e8e790)
    
    if (data_143e8e790 == 0xffffffff)
        ...
        data_143e8e788 = rax_15
        _Init_thread_footer(&data_143e8e790)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8e768
int64_t rcx
...
label_1412a64c3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412a64be
        
        rbx.b = 1
        goto label_1412a64c3
