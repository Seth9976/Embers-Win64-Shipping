...
if (data_143e8dd90 s> *rdi_1)
    _Init_thread_header(&data_143e8dd90)
    
    if (data_143e8dd90 == 0xffffffff)
        ...
        data_143e8dd88 = rax_12
        _Init_thread_footer(&data_143e8dd90)

if (data_143e8ddb0 s> *rdi_1)
    _Init_thread_header(&data_143e8ddb0)
    
    if (data_143e8ddb0 == 0xffffffff)
        ...
        data_143e8dda8 = rax_15
        _Init_thread_footer(&data_143e8ddb0)

if (data_143e8ddd0 s> *rdi_1)
    _Init_thread_header(&data_143e8ddd0)
    
    if (data_143e8ddd0 == 0xffffffff)
        ...
        data_143e8ddc8 = rax_18
        _Init_thread_footer(&data_143e8ddd0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8dd88
int64_t rcx
...
label_1412ab8a8:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412ab8a3
    
    rbx.b = 1
    goto label_1412ab8a8
