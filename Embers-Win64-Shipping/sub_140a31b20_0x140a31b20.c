...
if (arg2 != 0)
    ...
    if (arg2[5].d s> 0)
        ...
        do
            ...
            int64_t* rcx = arg2
            char arg_8 = 0
            char (* var_88)(int64_t, char* arg2) = sub_1405991d0
            ...
            void* var_70_1 = arg1
            char* var_80_1 = &arg_8
            char (** var_78)(int64_t, char* arg2) = &var_88
            void* r14_1 = *(rcx + r8)
            ...
            uint64_t var_a0 = zx.q(rsi_2.d) & 1
            int32_t rax_5
            int128_t zmm6_1
            rax_5, zmm6_1 = sub_1405991f0(&var_78, &var_a0)
            int32_t rbp_1 = rax_5
            uint64_t rcx_4
            ...
            label_140a31ccb:
                ...
                while (true)
                    ...
                    *(rcx_4 + 0x10) = rbx_1.d & 0x3ffffff
                    ...
                    rbx_1 = rax_13
                    rsi_2 = rax_13 u>> 0x1a
                    var_a0 = zx.q(rsi_2.d) & 1
                    int32_t rax_16
                    rax_16, zmm6_1 = sub_1405991f0(&var_78, &var_a0)
                    rbp_1 = rax_16
                    
                    if (rax_16 == 0)
                        goto label_140a31ccb
...
int64_t* rcx_9 = data_143cf8c40
return (**rcx_9)(rcx_9, arg1, zx.q(*(arg1 + 8)), zx.q(arg3))
