...
while (true)
    ...
    if (result.d == (var_88_1.q u>> 0x20).d && var_68.q == arg2 + 0x10 && rcx_13 == arg2)
        return result
    
    int64_t rax_26 = result * 0x60 + *rcx_13
    var_98.q = rax_26
    int64_t var_90_1 = rax_26 + 8
    void arg_8
    sub_141cf1c40(arg1, &arg_8, &var_98, nullptr)
