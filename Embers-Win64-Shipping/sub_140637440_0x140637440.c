...
while (true)
    ...
    int32_t rcx_5 = rax_11 - 1
    
    if (rax_11 == 0)
        rcx_5 = 0
    
    int32_t rax_13 = sub_1405969c0(rcx_5, rdx_7) & (*r14 - 1)
    *(rbx_2 + 0x1c) = rax_13
    void* rdx_8 = *(arg1 + 0x40)
    int64_t r8_5 = sx.q(rax_13)
    void* rax_14 = arg1 + 0x38
    
    if (rdx_8 != 0)
        rax_14 = rdx_8
    
    rbx_2[3].d = *(rax_14 + (((sx.q(*r14) - 1) & r8_5) << 2))
    ...
    *(rax_16 + (((sx.q(*r14) - 1) & r8_5) << 2)) = r15_1
