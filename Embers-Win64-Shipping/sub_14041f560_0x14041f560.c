...
int32_t rax = var_2c0 + 7

if (rax s> 0)
    sub_140594770(&var_2c8)

sub_1405a7220(var_2c8, 7, "dark-2", 7, 0x3f)
int16_t* var_2d8 = nullptr
int32_t var_2d0 = 0
sub_1405947f0(&var_2d8, 7)
int32_t rax_1 = var_2d0 + 7

if (rax_1 s> 0)
    sub_140594770(&var_2d8)

sub_1405a7220(var_2d8, 7, "dark-1", 7, 0x3f)
int16_t* var_2e8 = nullptr
int32_t var_2e0 = 0
sub_1405947f0(&var_2e8, 0xc)
int32_t rax_2 = var_2e0 + 0xc

if (rax_2 s> 0)
    sub_140594770(&var_2e8)

sub_1405a7220(var_2e8, 0xc, "transparent", 0xc, 0x3f)
...
*(rax_23 + 0x228) = zx.o(0)
*(rax_23 + 0x238) = zmm6_1
sub_14068def0(&data_143cdd500, rax_23)
...
return atexit(sub_142cb1580) __tailcall
