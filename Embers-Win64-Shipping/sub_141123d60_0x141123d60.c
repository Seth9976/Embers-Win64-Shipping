...
label_141123f03:
    ...
    if (r8_5 s> 0 && (rax_18 == 0 || rax_18 s< rbp))
        ...
        *(arg4 + 0x28) = *(rax_22 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_24 = *(r9_2 + 8)
    ...
    label_141123e28:
        ...
        while (true)
            ...
            if (*(r9 + (rcx_2 << 3)) == zmm0.q && *(r9 + (rcx_2 << 3) + 8) == zmm0:8.q
                    && *(r9 + (rcx_2 << 3) + 0x10) == arg4[1].q)
                break
            
            rbx_1 = *(r9 + (rcx_2 << 3) + 0x28)
            
            if (rbx_1 == 0xffffffff)
                goto label_141123e28
