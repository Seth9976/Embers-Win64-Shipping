...
if (data_143e8c0ac s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8c0ac)
    
    if (data_143e8c0ac == 0xffffffff)
        ...
        data_143e8c0a0 = rax_6
        _Init_thread_footer(&data_143e8c0ac)

int64_t rbx = data_143e8c0a0
int64_t rcx
