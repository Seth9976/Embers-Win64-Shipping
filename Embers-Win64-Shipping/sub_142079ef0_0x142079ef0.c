...
if (rax_6 != 0)
    ...
    if ((arg1[5].b & 1) != 0)
        ...
        do
            ...
            if (rdx_7 == neg.q(*arg2))
                ...
                *rdx_8 = data_14399f6e0
                arg3.o = data_14399f6f0
                *(rdx_8 + 0x10) = arg3.o
                *(rdx_8 + 0x20) = data_14399f700
                arg3.o = data_14399f710
                *(rdx_8 + 0x30) = arg3.o
            
            sub_1408dbe80(arg1, rdx_8, arg3)
            r14 += 1
        while (r14 s< arg_8)
    ...
    if (rax_6 s> 0)
        do
            sub_1408dbe80(arg1, (sx.q(i) << 6) + *arg2, arg3)
            i += 1
        while (i s< arg2[1].d)
