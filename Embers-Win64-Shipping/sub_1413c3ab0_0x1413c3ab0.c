...
if (0 s< r10)
    ...
    while (true)
        void* rbx_3 = sx.q(rcx_3) * 0x30 + *rdx_3
        int64_t* rcx_4 = *(rbx_3 + 0x20)
        
        if (rcx_4 != 0 && *(rbx_3 + 0x18) != 0)
            (*(*rcx_4 + 0x10))(rcx_4, rbx_3 + 0x18)
            *(rbx_3 + 0x20) = 0
        
        sub_14081c9d0(rbx_3 + 0x18)
