...
int32_t var_84 = 1
int32_t rbx = *(arg1 + 0x900)
int32_t rcx = 0
void* var_80 = arg1 + 0x8e8
int32_t var_88 = 0
int32_t r8 = 0
...
if (rbx != 0)
    void* rax_1 = *(arg1 + 0x8f8)
    void* r9_1 = arg1 + 0x8e8
    ...
    label_141a99118:
        ...
        while (true)
            ...
            if (rdx_3 != 0)
                goto label_141a99118
        
        var_74.d = rbx

int32_t rdx_5 = *(arg1 + 0x900)
...
var_74.d = rdx_5
int128_t var_68 = (arg1 + 0x8d8).o
int128_t var_58 = var_38

if (rdx_5 != rbx)
    void* rax_11 = *(arg1 + 0x8f8)
    void* r10_1 = arg1 + 0x8e8
...
while (true)
    ...
    if (rax_20.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x8e8 && rdx_10 == arg1 + 0x8d8)
        return sub_140ba2630(arg1 + 0x8d8, 0) __tailcall
    
    int64_t* rcx_8 = *(*rdx_10 + rax_20 * 0x18 + 8)
