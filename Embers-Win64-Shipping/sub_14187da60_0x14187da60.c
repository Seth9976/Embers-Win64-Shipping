...
label_14187dbf8:
    ...
    if (r8_5 u>= 4)
        ...
        uint64_t rflags_1
        int32_t temp0_3
        temp0_3, rflags_1 = _bit_scan_reverse(rax_15 + 8)
        int32_t rcx_7
        ...
        uint64_t rflags_2
        char temp0_4
        temp0_4, rflags_2 = _bit_scan_reverse(rax_15 + 7)
        char r9_3
    ...
    if (r8_5 s> 0 && (rax_18 == 0 || rax_18 s< rbp))
        ...
        rbx[6] = *(rax_22 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_24 = *(r9_4 + 8)
