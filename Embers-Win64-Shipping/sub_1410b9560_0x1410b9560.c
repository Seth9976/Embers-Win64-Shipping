...
if (data_143e2d2f0 s> *rsi_1)
    _Init_thread_header(&data_143e2d2f0)
    
    if (data_143e2d2f0 == 0xffffffff)
        ...
        data_143e2d2e8 = rax_6
        _Init_thread_footer(&data_143e2d2f0)

uint32_t rax_2

if (data_143e2d300 s> *rsi_1)
    int64_t r8_2
    rax_2, r8_2 = _Init_thread_header(&data_143e2d300)
    
    if (data_143e2d300 == 0xffffffff)
        ...
        data_143e2d2f8 = rax_9
        _Init_thread_footer(&data_143e2d300)

int64_t rbp = data_143e2d2f8
uint16_t rsi_2
...
label_1410b9660:
    ...
    if (sub_1405fba70(*arg1, 3) != 0 && sub_1410be640(arg1) != 0)
        return 1
else
    char rax_3
