...
if (result != 0)
    ...
    if (r15_1 s<= 0)
        ...
        if (rbx_2 != *(r12_1 + 0x18))
            sub_140837d00(r12_1)
            sub_1419bfb10(arg1, r12_1, rbx_2, u"ViewPrimitiveShaderDataBuffer")
        ...
        *rcx_15 = &data_142da7798
        ...
        int128_t zmm3_1
        zmm2_1, zmm3_1 =
            sub_1419bf7f0(arg1, r12_1, arg2 + 0x1738, *(arg2 + 0xdc0) * 0x230, var_4e8_1, var_4e0_1)
        ...
        *(rcx_24 + 0x24) = 3
        ...
        if (r15_1 s> 0)
            ...
            do
                var_4e8_1.q = u"PrimitiveUploadBuffer"
                sub_1419cff60(rax_14, r12_2, 0x230, 1, var_4e8_1)
                ...
                *rcx_37 = &data_142da7798
                ...
                rcx_37[4].d = 2
                *(rcx_37 + 0x24) = 3
                zmm2_1, zmm3_1 = sub_1419bfef0(arg2 + 0x1778, arg1, r12_1, 0, zmm2_1, zmm3_1)
                rax_14 = arg2 + 0x1778
        ...
        *(rcx_46 + 0x24) = 1
        ...
        if (data_143e6a680 != 0 && (*(arg2 + 0x1750) u> 0 || *(arg2 + 0x1770) u> 0))
            ...
            (*(*rcx_50 + 0x158))(rcx_50, &data_143f02b98, *r12_1, 0, *(r12_1 + 0x18), 0, var_4d8_1, 
                var_4d0_4, r12_1, arg3)
            int64_t rax_27
            int64_t rdx_12
            rdx_12:rax_27 = mulu.dp.q(-0x15f15f15f15f15f1, data_1439c7a80)
            uint32_t r13_3 = *(r13 + 0x26f8) + *(arg2 + 0xde0)
            uint32_t rdx_13 = (rdx_12 u>> 5).d
            uint32_t r8_7 = r13_3
            ...
            int32_t rax_28 = 0
            uint32_t var_4b8_1 = r8_7
            int32_t var_4d8_2 = 0
            int64_t r15_3 = sx.q(r8_7)
            int64_t rdx_14 = sx.q(r13_3)
            ...
            if (r13_3 s> 0)
                ...
                do
                    ...
                    var_4d8_2 = rax_28
                    var_4d0_5 = rcx_51
                while (rcx_51 s< rdx_14)
            
            int64_t* rcx_56 = data_143f0f180
            (*(*rcx_56 + 0x160))(rcx_56, &data_143f02b98, *r12_1)
            r13 = arg3
        
        void* rcx_57 = *(r13 + 0x15a8)
        void* rcx_58 = r13 + 0x2700
    ...
    *(*(r13 + 0x15b0) + 0xf58) = *rcx_59
    *(*(r13 + 0x15b0) + 0xf68) = *(arg2 + 0x1848)
    int64_t* rcx_60 = data_143f0f180
    (*(*rcx_60 + 0x100))(rcx_60, *(r13 + 0x10), *(r13 + 0x15b0))
