...
if (*(arg1 + 0x108) s> 0)
    ...
    do
        int32_t* rsi_2 = *(arg1 + 0x100) + r15_1
        void arg_8
...
if (*(arg2 + 0xc) != 2)
    rsi_3 = sx.q(sub_14210eb80(arg1 + 0x188, 2, arg2).d)
...
if (*(arg2 + 0xc) == 2 || rsi_3.d == 0xffffffff)
    if (*(arg1 + 0xd0) != 0)
        ...
        *(rcx_6 + arg1 + 0x13a) = 1
        ...
        char rax_2 = (*(*rcx_7 + 0x3c8))(rcx_7, arg2, arg3, zx.q(arg4))
    ...
    *arg3 = 0
    ...
    result = sub_142111f50(arg1 + 0x188, 2, rsi_3.d, arg4)
    *arg3 = *(*(arg1 + 0x2e8) + (rsi_3 << 3))
