...
while (true)
    ...
    if (result.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0xf8 && rdx_10 == arg1 + 0xe8)
        return result
    
    sub_141c64c30(result * 0x78 + *rdx_10 + 8)
    int32_t var_5c
