...
sub_1405a6e30(arg2, arg1 + 0x68, 0, 0)
...
while (true)
    ...
    if (rcx_8.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x28 && result == arg1 + 0x18)
        return result
    
    (*(*arg2 + 0x38))(arg2, *result + (rcx_8 << 5) + 0x10, 0, 0, var_88, arg1 + 0x28, var_78_2)
    int32_t var_5c
