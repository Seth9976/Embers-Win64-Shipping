...
if (data_143e8ca20 s> *rdi_1)
    _Init_thread_header(&data_143e8ca20)
    
    if (data_143e8ca20 == 0xffffffff)
        ...
        data_143e8ca18 = rax_12
        _Init_thread_footer(&data_143e8ca20)

if (data_143e8ca30 s> *rdi_1)
    _Init_thread_header(&data_143e8ca30)
    
    if (data_143e8ca30 == 0xffffffff)
        ...
        data_143e8ca28 = rax_15
        _Init_thread_footer(&data_143e8ca30)

if (data_143e8ca48 s> *rdi_1)
    _Init_thread_header(&data_143e8ca48)
    
    if (data_143e8ca48 == 0xffffffff)
        ...
        data_143e8ca38 = rax_18
        _Init_thread_footer(&data_143e8ca48)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8ca18
int64_t rcx
...
label_1412b5098:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412b5093
    
    rbx.b = 1
    goto label_1412b5098
