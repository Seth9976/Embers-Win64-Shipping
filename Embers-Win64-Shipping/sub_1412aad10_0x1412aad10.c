...
if (data_143e8da90 s> *rdi_1)
    _Init_thread_header(&data_143e8da90)
    
    if (data_143e8da90 == 0xffffffff)
        ...
        data_143e8da88 = rax_9
        _Init_thread_footer(&data_143e8da90)

if (data_143e8dab0 s> *rdi_1)
    _Init_thread_header(&data_143e8dab0)
    
    if (data_143e8dab0 == 0xffffffff)
        ...
        data_143e8daa8 = rax_12
        _Init_thread_footer(&data_143e8dab0)

if (data_143e8dad0 s> *rdi_1)
    _Init_thread_header(&data_143e8dad0)
    
    if (data_143e8dad0 == 0xffffffff)
        ...
        data_143e8dac8 = rax_15
        _Init_thread_footer(&data_143e8dad0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8da88
int64_t rcx
