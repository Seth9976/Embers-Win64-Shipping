...
if (rdx.b == 0)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            ...
            rax = rcx_6
            rcx_6 += 0x10
            *rax = _mm_and_ps(_mm_cmpeq_ps(zmm3, _mm_and_ps(zmm4, zmm1), 1), 
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        float temp0_3[0x4] = _mm_cmpeq_ps(data_143f87750, _mm_and_ps(data_143f87760, temp0_1), 1)
        float temp0_4[0x4] = _mm_rcp_ps(temp0_1)
        float (* rax_6)[0x4]
        uint64_t i_1
