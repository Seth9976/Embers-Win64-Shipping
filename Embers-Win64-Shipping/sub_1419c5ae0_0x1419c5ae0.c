...
if (r10 != 0)
    ...
    label_1419c5bbc:
        ...
        while (true)
            ...
            if (rdx_2 != 0)
                goto label_1419c5bbc
        
        var_d4.d = r10

uint128_t zmm4 = var_d8.o
void* var_40 = arg1 + 0x80
...
if (_mm_bsrli_si128(zmm4, 4).d s< *(rax_11 + 0x18))
    ...
    if (var_80.b != 0 && var_80:1.b != 0)
        sub_1408854b0(arg1 + 0x80, *(arg1 + 0x88) - *(arg1 + 0xb4), 1)
...
label_1419c6018:
    ...
    result = zx.q(lookup_table_1419c6068[rdx_21])
    
    switch (result)
        case nullptr
            result = sub_1408891d0(arg2 + 0x2a8, u"PLATFORM_SUPPORTS_SRV_UB", &(*U"RGBXYZF10|")[7])
        case 1
            goto label_1419c6018
