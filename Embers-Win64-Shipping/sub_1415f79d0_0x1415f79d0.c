...
float zmm8[0x4] = (*arg9)[2] ^ 0x80000000
...
while (true)
    ...
    if (zmm4[0] > zmm13[0])
        ...
        zmm4[0] = zmm4[0] f+ *(rax_7 + 0x10)
        zmm6[0] = zmm6[0] * zmm0[0]
        zmm5[0] = zmm5[0] f+ *(rax_7 + 0x14)
        zmm6[0] = zmm6[0] f+ *(rax_7 + 0x18)
        var_260 = zmm4[0]
        var_25c = zmm5[0]
        var_258 = zmm6[0]
    ...
    void* rax_11 = var_200
    zmm4 = zx.o(*(rax_11 + 0x10))
    int32_t rax_12 = *(rax_11 + 0x18)
    float temp0_9[0x4] = _mm_unpacklo_ps(_mm_shuffle_ps(zmm4, zmm4, 0x55), zmm9[0].q)
    float temp0_10[0x4] = _mm_unpacklo_ps(zmm4, rax_12[0].q)
    zmm4 = *arg3
    ...
    *(&var_118 + (rcx_4 << 2)) = (_mm_unpacklo_ps(zmm3, zmm2[0].q)).q
    ...
    if (rdx.d == 0)
        ...
        var_2a8 = (&var_110)[rcx_12]
    else
        uint64_t* rax_19
        
        if (rdx.d == 1)
            rax_19, zmm8, zmm9 = sub_1416e69d0(&var_290, &var_118, &var_1a8:4, &var_1a8, &var_188)
        label_1415f7e06:
            zmm0 = zx.o(*rax_19)
            var_2a8 = rax_19[1].d
            i_7 = var_1a8.d
            ...
            if (rdx.d == 2)
                rax_19, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13, zmm14, zmm15 =
                    sub_1416fa750(&var_270, &var_118, &var_1a8, &var_188)
                goto label_1415f7e06
    ...
    if (zmm4[0] < zmm14[0] || zmm4[0] >= zmm8[0])
        i_6 = i_7
        zmm8 = zmm4
        rcx_1 = var_2b8
        var_294 = zmm4[0]
    ...
    rcx = var_2b8
    zmm3 = zmm12
    float temp0_35[0x4] = _mm_sqrt_ss(0, zmm4[0])
    zmm8 = zmm4
    var_294 = zmm4[0]
...
if (zmm8[0] <= zmm14[0])
    ...
    if (i_6 s> 0)
        ...
        do
            ...
            *(rcx_19 + (rdx_10 << 2)) = *(&var_178 + rbx)
            *(rcx_19 + (rdx_10 << 2) + 8) = rax_30
            ...
            rbx += 0xc
            *(rcx_21 + (rdx_12 << 2)) = zmm0_1
            *(rcx_21 + (rdx_12 << 2) + 8) = rax_32
            i = i_5
            i_5 -= 1
        while (i != 1)
    ...
    uint128_t zmm11_1
    float zmm14_1
    rax_33, zmm9_1, zmm10_1, zmm11_1, zmm14_1 = sub_141557580(&var_270, &var_290, &var_230, 
        &var_200, &var_2b8, &var_280, &var_260, &var_2b0)
    uint128_t zmm0_2
    uint128_t zmm1_1
    uint128_t zmm2_1
    uint128_t zmm3_1
    ...
    if (rax_33 == 2)
        ...
        *arg7 = var_280
        ...
        zmm1_1.d = zmm10_1.d f* *(arg7 + 4)
        zmm10_1.d = zmm10_1.d f* arg7[1].d
        zmm0_2.d = zmm0_2.d f+ zmm5_1
        zmm1_1.d = zmm1_1.d f+ zmm6_1
        zmm10_1.d = zmm10_1.d f+ zmm7[0]
        *arg5 = (_mm_unpacklo_ps(zmm0_2, zmm1_1.q)).q
        arg5[1].d = zmm10_1.d
        zmm0_2.d = zmm11_1.d f* *arg7
        zmm1_1.d = zmm11_1.d f* *(arg7 + 4)
        zmm11_1.d = zmm11_1.d f* arg7[1].d
        ...
        *arg7 = var_280
        arg7[1].d = var_278
        zmm0_2.d = var_2b8.d f+ zmm10_1.d
        ...
        *arg5 = (_mm_unpacklo_ps(zmm0_2, zmm1_1.q)).q
        ...
        zmm0_2.d = var_2a8.d f- zmm11_1.d
    ...
    *arg4 = zmm11[0]
    ...
    zmm10[0] = zmm10[0] f* *(arg7 + 4)
    zmm10[0] = zmm10[0] f* arg7[1].d
    zmm10[0] = zmm10[0] + zmm9[0]
    zmm10[0] = zmm10[0] + zmm9[0]
    zmm10[0] = zmm10[0] + var_2b8
