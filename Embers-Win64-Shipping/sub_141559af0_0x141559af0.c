...
rax_2, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13, zmm14_1, zmm15 =
    sub_14168dca0(r14, arg2, arg3, arg4, &var_258)
int32_t rsi_1
...
if (rax_2 != 0)
    ...
    label_14155a6a8:
        zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm15_1 =
            sub_14154a2a0(*r14, *r15, &var_128, arg5, arg6, var_1a8, arg8)
        rsi_1 = 1
    else
        zmm15 = 0x322bcc77
        zmm8 = zx.o(0)
        ...
        while (true)
            if (rdx_5 s< 0x80)
                ...
                uint128_t zmm4_1 = *(rcx_15 + 0x1c)
                uint128_t zmm5_1 = *(rcx_15 + 0x24)
                ...
                var_248 = rdx_12
                void* rax_26 = arg4[1]
                zmm4_1 = zx.o(*(rax_26 + 0x10))
                int32_t rax_27 = *(rax_26 + 0x18)
                zmm0_1 = zmm4_1
                float temp0_6[0x4] = _mm_shuffle_ps(zmm0_1, zmm0_1, 0x55)
                int128_t* rax_28 = arg4[2]
                float temp0_7[0x4] = _mm_unpacklo_ps(temp0_6, 0)
                zmm6 = _mm_unpacklo_ps(zmm4_1, rax_27[0].q)
                zmm5_1 = *rax_28
                zmm6 = _mm_unpacklo_ps(zmm6, temp0_7[0].q)
                zmm4_1 = _mm_shuffle_ps(zmm5_1, zmm5_1, 0xc9)
                float temp0_11[0x4] = _mm_shuffle_ps(zmm5_1, zmm5_1, 0xd2)
                float temp0_13[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm6, zmm6, 0xc9), temp0_11)
                float temp0_15[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm6, zmm6, 0xd2), zmm4_1)
                ...
                zmm5_1 = _mm_mul_ps(zmm5_1, temp0_18)
                float temp0_21[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_18, temp0_18, 0xc9), temp0_11)
                ...
                if (__andps_xmmxud_memxud(temp0_30, data_142d3f770)[0] <= zmm0_1[0])
                    zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm15_1 =
                        sub_14154a2a0(*r14, *r15, rdi_5, arg5, arg6, var_1a8, arg8)
                    rdi_1 = var_270
                    rsi_1 = 0
                    break
                ...
                if (not(zmm14_1 < zmm12[0]))
                    ...
                    *(rcx_20 + (rdx_15 << 2)) = var_1d8_1.q
                    *(rcx_20 + (rdx_15 << 2) + 8) = var_1d0_1
                    ...
                    int64_t rcx_22 = *r15
                    int64_t rdx_18 = r13_3 * 3
                    var_268_1.d = 0
                    *(rcx_22 + (rdx_18 << 2)) = var_1c8_1.q
                    *(rcx_22 + (rdx_18 << 2) + 8) = var_1c0_1
                    rdi_5[0xd].b = 1
                    ...
                    int32_t rax_43 = r12_2.d + r8_10
                    var_250.d = rax_43
                    
                    if (rax_43 s> var_250:4.d)
                    ...
                    if (r12_2.d s>= 3)
                        ...
                        if (r12_2.d s<= 0)
                            ...
                            while (true)
                                int64_t* rdx_21 = var_270
                                int64_t rcx_26 = var_258
                                int64_t r13_4 = sx.q(rdx_21[rdi_6].d)
                                int64_t r11_7 = sx.q(*(&rdx_21[rdi_6] + 4))
                                ...
                                int64_t rdx_24 = *arg1
                                int32_t rax_51 = *(r10_8 + (r11_7 << 2))
                                int64_t rax_53 = sx.q(*(r10_8 + (sx.q((r11_7 + 1).d s% 3) << 2)))
                                int32_t var_1ec_1 = rax_53.d
                                int64_t rcx_29 = rax_53 * 3
                                zmm10 = *(rdx_24 + (rcx_29 << 2))
                                zmm10[0] = zmm10[0] f- *(r8_11 + (rcx_29 << 2))
                                zmm6.d = (*(rdx_24 + (rcx_29 << 2) + 4)).d f-
                                    *(r8_11 + (rcx_29 << 2) + 4)
                                zmm11 = *(rdx_24 + (rcx_29 << 2) + 8)
                                zmm11[0] = zmm11[0] f- *(r8_11 + (rcx_29 << 2) + 8)
                                int64_t rcx_30 = sx.q(rax_51) * 3
                                zmm2_1 = *(rdx_24 + (rcx_30 << 2) + 8)
                                zmm2_1[0] = zmm2_1[0] f- *(r8_11 + (rcx_30 << 2) + 8)
                                zmm5_1 = *(rdx_24 + (rcx_30 << 2))
                                zmm7 = *(rdx_24 + (rdx_15 << 2) + 4)
                                zmm7[0] = zmm7[0] f- *(r8_11 + (rdx_15 << 2) + 4)
                                zmm1_1 = *(rdx_24 + (rdx_15 << 2) + 8)
                                zmm1_1[0] = zmm1_1[0] f- *(r8_11 + (rdx_15 << 2) + 8)
                                zmm3_1 = *(rdx_24 + (rdx_15 << 2))
                                zmm2_1[0] = zmm2_1[0] - zmm11[0]
                                zmm3_1[0] = zmm3_1[0] f- *(r8_11 + (rdx_15 << 2))
                                zmm4_1 = *(rdx_24 + (rcx_30 << 2) + 4)
                                zmm7[0] = zmm7[0] f- zmm6.d
                                zmm5_1.d = zmm5_1.d f- *(r8_11 + (rcx_30 << 2))
                                zmm4_1.d = zmm4_1.d f- *(r8_11 + (rcx_30 << 2) + 4)
                                ...
                                *(r10_8 + (r11_7 << 2) + 0x28) = 0
                                ...
                                if (not(zmm0_1[0] < zmm12[0]) && not(zmm0_1[0] > zmm14_1))
                                    char rax_59
                                    rax_59, zmm12, zmm14_1, zmm15 = sub_141743d50(r9_5, *arg1, *r15)
                                    
                                    if (rax_59 != 0)
                                        int32_t var_130_1 = rbx_2
                                        int64_t* var_138 = &var_258
                                        sub_14175ce20(&var_210, &var_138)
                                ...
                                if (rdi_6 s>= var_178_1)
                                    rsi_2 = var_210:8.q
                                    rbx_1 = var_210.q
                                    r14 = arg1
                                    rax_44 = zx.q(var_278_1)
                                    break
