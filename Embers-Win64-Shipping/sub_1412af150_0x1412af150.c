...
if (data_143e8d598 s> *rdi_1)
    _Init_thread_header(&data_143e8d598)
    
    if (data_143e8d598 == 0xffffffff)
        ...
        data_143e8d590 = rax_12
        _Init_thread_footer(&data_143e8d598)

if (data_143e8d5b8 s> *rdi_1)
    _Init_thread_header(&data_143e8d5b8)
    
    if (data_143e8d5b8 == 0xffffffff)
        ...
        data_143e8d5b0 = rax_15
        _Init_thread_footer(&data_143e8d5b8)

if (data_143e8d5d8 s> *rdi_1)
    _Init_thread_header(&data_143e8d5d8)
    
    if (data_143e8d5d8 == 0xffffffff)
        ...
        data_143e8d5d0 = rax_18
        _Init_thread_footer(&data_143e8d5d8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d590
int64_t rcx
...
label_1412af248:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412af243
    
    rbx.b = 1
    goto label_1412af248
