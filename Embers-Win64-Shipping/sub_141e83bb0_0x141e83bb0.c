...
while (true)
    void* r9_3 = *rbx + sx.q(r10_2) * 0x28
    int32_t r8_7 = *(r9_3 + 0x10)
    int32_t rdx_8 = (*(r9_3 + 0xc) - r8_7) ^ r8_7 u>> 0xd
    ...
    int32_t r8_17 = ((r8_13 - rcx_13 - rdx_14) ^ rcx_13 u>> 0xf) & (*rsi - 1)
    void* rax_32 = &arg1[7]
    *(r9_3 + 0x24) = r8_17
    void* rdx_15 = arg1[8]
    ...
    *(r9_3 + 0x20) = *(rax_32 + (((sx.q(*rsi) - 1) & r8_18) << 2))
    void* rax_34 = &arg1[7]
    void* rcx_18 = arg1[8]
    ...
    *(rax_34 + (((sx.q(*rsi) - 1) & r8_18) << 2)) = r10_2
