...
if (data_143e8abd0 s> *rdi_1)
    _Init_thread_header(&data_143e8abd0)
    
    if (data_143e8abd0 == 0xffffffff)
        ...
        data_143e8abc8 = rax_12
        _Init_thread_footer(&data_143e8abd0)

if (data_143e8abe0 s> *rdi_1)
    _Init_thread_header(&data_143e8abe0)
    
    if (data_143e8abe0 == 0xffffffff)
        ...
        data_143e8abd8 = rax_15
        _Init_thread_footer(&data_143e8abe0)

if (data_143e8abf0 s> *rdi_1)
    _Init_thread_header(&data_143e8abf0)
    
    if (data_143e8abf0 == 0xffffffff)
        ...
        data_143e8abe8 = rax_18
        _Init_thread_footer(&data_143e8abf0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8abc8
int64_t rcx
...
label_1412a5518:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412a5513
    
    rbx.b = 1
    goto label_1412a5518
