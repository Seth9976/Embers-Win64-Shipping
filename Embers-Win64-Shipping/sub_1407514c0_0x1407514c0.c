...
if (arg3 == 0 || rax_3.d s> *(rdx + 0x38) || *(*(rdx + 0x30) + (rax_3 << 3)) != rax_2 + 0x30)
    ...
    void var_138
    void** var_108
    void*** rax_6 = sub_1407432d0(&var_108, sub_140745220(&var_138, arg1 + 0x68), arg3 + 0xe8)
    arg2[0x10].b &= 0xfc
    ...
    *rbx_1 = &data_142d9abb0
    rbx_1[9] = &data_142d9ab38
    rbx_1[0xa] = 0
    rbx_1[0xa] = rax_6[0xa]
    rax_6[0xa] = 0
    ...
    *(rbx_1 + 0x5c) = *(rax_6 + 0x5c)
    rax_6[0xb] = 0
    rbx_1[0xc].b = rax_6[0xc].b
    *(rbx_1 + 0x61) = *(rax_6 + 0x61)
    rbx_1[0xd] = 0
    rbx_1[0xd] = rax_6[0xd]
    rax_6[0xd] = 0
