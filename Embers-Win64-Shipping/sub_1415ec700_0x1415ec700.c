...
while (true)
    ...
    *(&var_178 + (rcx_3 << 2)) = temp0_31.q
    (&var_170)[rcx_3] = var_218
    *(&var_148 + (rcx_3 << 2)) = (_mm_unpacklo_ps(temp0_28, temp0_30[0].q)).q
    (&var_140)[rcx_3] = var_1e8_1
    int64_t var_118
    *(&var_118 + (rcx_3 << 2)) = (_mm_unpacklo_ps(zmm5, zmm1[0].q)).q
    int32_t var_110
    ...
    if (i_6 == 1)
        ...
        int64_t rcx_11 = rax_17 * 3
        var_188[rax_17] = 0x3f800000
        zmm0 = zx.o(*(&var_118 + (rcx_11 << 2)))
        rax_13 = (&var_110)[rcx_11]
    else if (i_6 == 2)
        uint64_t* rax_16
        rax_16, zmm9 = sub_1416e69d0(&var_280, &var_118, &var_1a8:4, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_16)
        rax_13 = rax_16[1].d
    else if (i_6 == 3)
        uint64_t* rax_15
        rax_15, zmm9, zmm15 = sub_1416fa750(&var_270, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_15)
        rax_13 = rax_15[1].d
    else if (i_6 == 4)
    ...
    if (zmm3[0] < 9.99999997e-07f || zmm3[0] >= var_28c)
        zmm1 = zmm3
        var_28c = zmm3[0]
        break
...
if (zmm1[0] <= zmm10[0])
    ...
    if (i_6 s> 0)
        ...
        do
            ...
            *(rcx_19 + (rdx_9 << 2) + 8) = rax_25
            ...
            rbx += 0xc
            *(rcx_21 + (rdx_11 << 2)) = zmm0_1
            *(rcx_21 + (rdx_11 << 2) + 8) = rax_27
            i = i_5
            i_5 -= 1
        while (i != 1)
    ...
    int32_t rax_28
    float zmm9_1[0x4]
    rax_28, zmm9_1, zmm10 = sub_14159c8c0(&var_270, &var_280, &var_210, &var_208, &var_288, 
        &var_2a8, &var_230, &var_220)
    float zmm2_1[0x4]
    float zmm3_1[0x4]
    ...
    if (rax_28 == 2)
        ...
        *arg4 = zmm0_2[0]
        ...
        zmm2_1[0] = zmm2_1[0] f* *(arg7 + 4)
        zmm2_1[0] = zmm2_1[0] f* arg7[1].d
        zmm2_1[0] = zmm2_1[0] f+ var_230.d
        zmm2_1[0] = zmm2_1[0] f+ var_230:4.d
        int32_t var_228
        zmm2_1[0] = zmm2_1[0] f+ var_228
        *arg5 = (_mm_unpacklo_ps(zmm2_1, zmm2_1[0].q)).q
        float var_290_5 = zmm2_1[0]
        int32_t var_21c
        zmm2_1 = var_21c
        arg5[1].d = var_290_5
    ...
    *arg7 = temp0_37.q
    ...
    float temp0_38[0x4] = __sqrtss_xmmss_memss(temp0_37[0], var_28c)
    float var_290_2 = temp0_36[0]
