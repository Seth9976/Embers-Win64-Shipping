...
int64_t arg_8 = *(sub_141add760() + 0x18)
int16_t* var_48
...
if (*(arg1 + 0x10c) != 0)
    int64_t* rax_3 = sub_140b63b70(arg1 + 0xf4, &var_38)
    
    if (rax_3[1].d != 0)
        *rax_3
    
    int64_t* rax_4 = sub_140b63b70(arg1 + 0xc8, &var_28)
    
    if (rax_4[1].d != 0)
        rbx = *rax_4
    
    sub_140a2e390(&var_48, u"  DrivingBone: %s\nDrivenParameter: %s", rbx)
    int32_t r8_9
    ...
    sub_140a20ba0(&var_58, var_48, r8_9)
    ...
    int64_t* rax_1 = sub_140b63b70(arg1 + 0xfc, &var_28)
