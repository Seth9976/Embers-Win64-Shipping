...
label_141e79ef2:
    ...
    if (sub_141e77b10(arg1, arg1[1].d - *(arg1 + 0x34), 0) == 0)
        void* r9_1 = &arg1[7]
        ...
        *(arg4 + 0x64) = rax_7
        ...
        arg4[0xc].d = *(rax_8 + (((sx.q(arg1[9].d) - 1) & r8_1) << 2))
        void* rax_10 = *(r9_1 + 8)
    ...
    if (rbx_1 == 0xffffffff)
        ...
        memmove(sx.q(rbx_1) * 0x68 + *arg1, arg4, 0x60)
        sub_1408fa9b0(arg1, arg5, 1)
        rdi = rbx_1
    
    if (rbx_1 == 0xffffffff)
        goto label_141e79ef2
