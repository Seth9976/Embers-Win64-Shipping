...
if (r10 == 0)
    ...
    uint32_t zmm0_2[0x4]
    zmm0_2, zmm6, zmm7 = sub_1408b1820(&arg7, arg6, &var_b8)
    zmm9 = zmm0_2
    zmm10 = 0x3f800000
    zmm11 = 0x3f800000
    result = zx.q(*arg5)
    ...
    if (result.d s> 1)
        ...
        do
            ...
            zmm0_2, result, zmm6, zmm7, zmm8, zmm9, zmm10 = sub_1408b1820(&arg7, arg6, &var_b8)
    ...
    arg7.d = rbx_1
    zmm8[0] = zmm8[0] f* arg8[1]
    var_b8 = zmm8[0]
    uint32_t var_b4_1 = zmm8[0]
    uint32_t zmm0_1[0x4]
    zmm0_1, zmm8, zmm9 = sub_1408b1820(&arg7, arg6, &var_b8)
    ...
    if (result.d s> 1)
        ...
        do
            ...
            zmm0_1, result, zmm6, zmm7, zmm8, zmm9, zmm10 = sub_1408b1820(&arg7, arg6, &var_b8)
    ...
    return sub_1408b2190(rcx, arg3, arg4, arg5, arg6, (_mm_unpacklo_ps(zmm1, zmm1[0].q)).d)
return result
