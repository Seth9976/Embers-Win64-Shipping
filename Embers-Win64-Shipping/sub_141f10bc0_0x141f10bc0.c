...
label_141f10d60:
    ...
    if (r8_5 u>= 4)
        ...
        r14 = 1 << ((not.d(rcx_9 << 0x1a s>> 0x1f)).b & (0x20 - r9))
    ...
    if (r8_5 s> 0 && (rax_20 == 0 || rax_20 s< r14))
        arg1[9].d = r14
        sub_140942f40(arg1)
    else
        void* r9_1 = &arg1[7]
        ...
        *(r11 + 0x2c) = rax_23
        ...
        r11[5].d = *(rax_24 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_26 = *(r9_1 + 8)
    ...
    if (rbx_1 == 0xffffffff)
        ...
        if (*(arg1 + 0x34) != 0)
            *(*arg1 + sx.q(arg1[6].d) * 0x30) = rcx_7.d
        
        int32_t* rax_10 = rcx_7 * 0x30 + *arg1
        *rax_10 = 0xffffffff
