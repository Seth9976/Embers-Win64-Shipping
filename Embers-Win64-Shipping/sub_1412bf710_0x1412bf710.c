...
if (data_143e8b4d8 s> *rdi_1)
    _Init_thread_header(&data_143e8b4d8)
    
    if (data_143e8b4d8 == 0xffffffff)
        ...
        data_143e8b4d0 = rax_12
        _Init_thread_footer(&data_143e8b4d8)

if (data_143e8b4e8 s> *rdi_1)
    _Init_thread_header(&data_143e8b4e8)
    
    if (data_143e8b4e8 == 0xffffffff)
        ...
        data_143e8b4e0 = rax_15
        _Init_thread_footer(&data_143e8b4e8)

if (data_143e8b4f8 s> *rdi_1)
    _Init_thread_header(&data_143e8b4f8)
    
    if (data_143e8b4f8 == 0xffffffff)
        ...
        data_143e8b4f0 = rax_18
        _Init_thread_footer(&data_143e8b4f8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b4d0
int64_t rcx
