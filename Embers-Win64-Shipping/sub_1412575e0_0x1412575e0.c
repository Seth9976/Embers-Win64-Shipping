...
void* result = sub_141080ac0(arg1, arg2, r14, *(arg3 + 0x10))
...
if (*(arg1 + 0x12a) u> 0)
    uint32_t rbp_5 = zx.d(*(arg1 + 0x128))
    void*** rcx_26 = (*(arg2 + 0x30) + 7) & 0xfffffffffffffff8
    void* rax_11 = &rcx_26[5]
...
if (*(arg1 + 0x132) u> 0)
    uint32_t rsi_1 = zx.d(*(arg1 + 0x130))
    void*** rcx_38 = (*(arg2 + 0x30) + 7) & 0xfffffffffffffff8
    void* rax_17 = &rcx_38[5]
