...
void* r12_1 = var_2e0
sub_1419a2ec0(rax_33, &var_2c8, &data_143f1e6c0, 0)
...
void* rdx_22 = *(arg3 + 0x158)
void* r8_8 = arg1 + (rbx_6 << 3)

if (*(r8_8 + 0x1068) != rdx_22)
    int64_t rax_48
