...
if (r10 != 0)
    ...
    label_140ac7b0c:
        ...
        uint64_t rflags_5
        int32_t temp0_5
        temp0_5, rflags_5 = _bit_scan_reverse(rax_19)
        ...
        var_134.d = r8_2 - rax_20 + 0x1f
        
        if (r8_2 - rax_20 + 0x1f s> r10)
            var_134.d = r10
    else
        while (true)
...
if (rdx_10 != r10)
    ...
    if (rdx_14 != 0)
    label_140ac7bff:
        int32_t rax_30 = ((rdx_14 - 1) & rdx_14) ^ rdx_14
        uint64_t rflags_6
        int32_t temp0_7
        temp0_7, rflags_6 = _bit_scan_reverse(rax_30)
        ...
        int32_t var_ec_1 = r9_3 - rsi_1 + 0x1f
...
while (true)
    ...
    int64_t rax_31 = sx.q(arg_10.d)
    
    if (rax_31.d == 0xffffffff)
    label_140ac7d11:
        void*** rax_36 = j_sub_140a82f30(0x20)
        int64_t* r8_7 = rax_36
        ...
        *(rcx_31 + 0x14) = 1
        r9_5[7].d = 0xffffffff
        int32_t rdx_19 = r9_5[3].d
        int32_t rcx_34 = (r9_5[1].d - rdx_19) ^ rdx_19 u>> 0xd
        ...
        void var_a4
        sub_140aa8150(arg1 + 0x30, &var_a4, r8_16 u>> 0xf ^ (rdx_25 - (r8_16 + rcx_40)), r9_5, 
            var_90, nullptr)
        int32_t var_80
        ...
        *(r9_6 + 0x20) = var_d8
        ...
        void var_a0
        sub_140aa6f60(r12_1, &var_a0, (r8_24 - rcx_50 - rdx_37) ^ rdx_37 u>> 0xf, r9_6, var_80, 
            nullptr)
        ...
        if (rdi_13 != 0)
            ...
            if (rdi_13[1].d == 1)
                (**var_120_1)(var_120_1)
                int32_t rax_80 = *(var_120_1 + 0xc)
                *(var_120_1 + 0xc) -= 1
                
                if (rax_80 == 1)
                    (*(*var_120_1 + 8))(var_120_1, 1)
    else
        int64_t rcx_24 = rax_31 << 6
        
        if (rcx_24 == neg.q(*(arg1 + 0x30)))
            goto label_140ac7d11
