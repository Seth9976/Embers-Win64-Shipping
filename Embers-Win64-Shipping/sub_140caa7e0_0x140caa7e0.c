...
if (0 s< r13)
    ...
    while (true)
        ...
        int32_t* r12_1 = *r15_1
        int64_t r8_2 = sx.q(r12_1[sx.q(rcx_2) * 4])
        ...
        label_140caa9be:
            ...
            *(*arg2 + (rbx_1 << 2)) = r12_1[sx.q(rcx_2) * 4]
            void var_c0
            sub_14077a5e0(&var_88, &var_c0, *r15_1 + (sx.q(rcx_2) << 4), nullptr)
        else
            void var_50
            void* rax_13 = &var_50
            ...
            int32_t rax_14 = *(rax_13 + ((sx.q(r14 - 1) & r8_2) << 2))
            
            if (rax_14 == 0xffffffff)
                goto label_140caa9be
            
            while (true)
                int64_t rdx_4 = sx.q(rax_14) * 3
