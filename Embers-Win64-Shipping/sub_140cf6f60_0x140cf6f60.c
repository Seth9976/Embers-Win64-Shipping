    ...
    switch (*rax - 1)
        ...
        case 1
            ...
            *(sx.q(*(arg1 + 0x4c)) + sx.q(*(arg2 + 0x40) * *(arg1 + 0x3c)) + arg4) = r8
            return 2
        case 3
            sub_140cefa50(&arg_10, arg1, arg3, arg4, arg5, arg6, arg2)
            return 2
        case 7
            sub_140cefee0(&arg_10, arg1, arg3, arg4, arg5, arg6, arg2)
            return 2
        case 0x13
            int64_t* r9_3 = *(*arg3 + 8)
            ...
            if (&rdx_7[1] u> rcx_9[1])
                ...
                arg_10.q = *rdx_7
                int64_t* rax_28 = r9_3[1]
                *rax_28 += 8
            
            *(sx.q(*(arg1 + 0x4c)) + sx.q(*(arg2 + 0x40) * *(arg1 + 0x3c)) + arg4) = arg_10.q
            return 2
        case 0x15
            int64_t* r9_1 = *(*arg3 + 8)
        ...
        label_140cf6fc0:
            ...
            *(sx.q(*(arg1 + 0x4c)) + sx.q(*(arg2 + 0x40) * *(arg1 + 0x3c)) + arg4) = sx.q(arg_10)
            return 2
        case 0x17
            sub_140cf0390(&arg_10, arg1, arg3, arg4, arg5, arg6, arg2)
            return 2
        case 0x18
            sub_140cef690(&arg_10, arg1, arg3, arg4, arg5, arg6, arg2)
            return 2
        case 0x19
            int64_t* r9_4 = *(*arg3 + 8)
            int64_t* rcx_16 = r9_4[1]
            int16_t* rdx_12 = *rcx_16
            
            if (&rdx_12[1] u> rcx_16[1])
                char* rdx_13 = &arg_10
                
                if ((*(r9_4 + 0x29) & 0x20) != 0)
                    sub_140b54000(r9_4, rdx_13, arg6)
                    r8 = zx.q(arg_10.w)
                else
                    (*(*r9_4 + 0x150))(r9_4, rdx_13, 2)
                    r8 = zx.q(arg_10.w)
            else
                arg_10.w = *rdx_12
                int64_t* rax_37 = r9_4[1]
                *rax_37 += 2
                r8 = zx.q(arg_10.w)
