...
if (data_143ed8fc0 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    int64_t r8_1
    rax_2, r8_1 = _Init_thread_header(&data_143ed8fc0)
    
    if (data_143ed8fc0 == 0xffffffff)
        ...
        data_143ed8fb8 = rax_5
        _Init_thread_footer(&data_143ed8fc0)

int64_t rdi = data_143ed8fb8
