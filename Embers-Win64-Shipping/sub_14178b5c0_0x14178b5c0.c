...
void* r8 = *arg1
int64_t* r13 = arg2
uint64_t var_1f8 = *(r8 + 0x44)
uint64_t var_1ec = *(r8 + 0x50)
float zmm2 = *arg1[1]
uint64_t zmm0
...
if (r12_3 != 0)
    ...
    do
        ...
        int32_t* zmm13_1
        int64_t zmm14_1
        rax_16, zmm6_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm14_1 = sub_1416271b0(
        ...
        uint64_t zmm10_2
        int128_t zmm12_2
        rax_22, zmm8_2, zmm9_2, zmm10_2, zmm11, zmm12_2 = sub_1416271b0(&var_f8, rdx_6, r8_5, 
