...
if ((arg1[5].b & 1) == 0)
    ...
    int32_t* rdx_19 = *rcx_1
    
    if (&rdx_19[1] u> rcx_1[1])
        int32_t* rdx_20 = &arg_8
        
        if ((*(arg1 + 0x29) & 0x20) != 0)
            sub_140b54070(arg1, rdx_20, arg3)
        else
            (*(*arg1 + 0x150))(arg1, rdx_20, 4)
    else
        arg_8 = *rdx_19
        *rcx_1 += 4
    
    int64_t* var_58
    int512_t zmm1 = sub_1407453e0(&var_58, arg2)
    void* var_48
    int32_t i_1
    
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        int32_t* rdi_1 = *var_58 + sx.q(i) * 0x14
        sub_1409ac7a0(arg1, rdi_1, zmm1)
        int64_t* rcx_22 = arg1[1]
        int32_t* rdx_24 = *rcx_22
        
        if (&rdx_24[1] u> rcx_22[1])
            int32_t rax_34
            rax_34.b = rdi_1[2].b != 0
            arg_10 = rax_34
...
do
    ...
    if (rdx_10 == 0)
        ...
        *rdx_13 &= not.d(1 << (r14_1.b & 0x1f))
    else
        rsi_1 = sx.q(arg2[6].d)
        int64_t r9_2 = *arg2
        int64_t r8_6 = sx.q(*(r9_2 + rsi_1 * 0x14 + 4))
        arg2[6].d = r8_6.d
        *(arg2 + 0x34) = rdx_10 - 1
        
        if (rdx_10 != 1)
            *(r9_2 + r8_6 * 0x14) = 0xffffffff
    ...
    *r8_7 |= 1 << (rsi_1.b & 0x1f)
    int64_t rdx_15 = *arg2
    int64_t rcx_14 = sx.q(rsi_1.d) * 5
    *(rdx_15 + (rcx_14 << 2) + 8) = 0
    *(rdx_15 + (rcx_14 << 2) + 0xc) = 0xffffffff
    int32_t* rsi_2 = rdx_15 + (rcx_14 << 2)
    sub_1409ac7a0(arg1, rsi_2, arg3)
    int64_t* rcx_16 = arg1[1]
    int32_t* rdx_17 = *rcx_16
    
    if (&rdx_17[1] u> rcx_16[1])
        int32_t rax_20
        rax_20.b = rsi_2[2].b != 0
        arg_10 = rax_20
        (*(*arg1 + 0x150))(arg1, &arg_10, 4)
        rsi_2[2].b = arg_10 != 0
    else
