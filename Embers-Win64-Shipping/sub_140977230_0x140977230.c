...
int32_t rax_2 = (*(*rcx + 0x2d8))(rcx)
int64_t* rcx_1 = *(arg1 + 0x248)
int64_t rdx_1 = *rcx_1

if (rax_2 s>= (*(rdx_1 + 0x2d0))(rcx_1, rdx_1).d)
    return 
