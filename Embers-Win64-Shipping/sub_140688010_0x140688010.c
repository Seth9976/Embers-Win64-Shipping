...
while (true)
    ...
    label_140688243:
        ...
        while (true)
                ...
                for (; i u> r15_1; i -= 0x10)
                    ...
                    if (&r15_1[1] u<= i)
                        do
                            ...
                            if (sub_140a54510(rcx_11, rdx_4) s< 0)
                                rsi_2 = r14_2
            ...
            void* rax_16 = &r15_1[sx.q((temp1_1 - temp0_3) s>> 1)]
