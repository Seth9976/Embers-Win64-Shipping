...
int32_t r15_4 = ((arg11 s>> 0x1f u>> 0x1d) + arg11) & 0xfffffff8
int32_t result
uint32_t rbx
int32_t zmm0[0x8]
int32_t zmm2[0x8]
...
if (r15_4 s<= 0)
    ...
    while (true)
        ...
        if (temp1_1 == 0)
            ...
            zmm5 = __vpaddd_ymmu32_maskmskw_ymmu32_memu32_avx512(arg5, zmm3, 4)
            int64_t k1_3 = _kxnor_mask16(arg5, arg5)
            arg8[0].o = _mm_mask_xor_ps(arg5, arg8[0].o, arg8[0].o)
            int64_t k1_4
            int128_t temp0_10
            temp0_10, k1_4 = _mm256_mmask_i32gather_ps(k1_3, *(arg4 + zmm5[0].q))
            arg8 = temp0_10
            ...
            float var_2a0_1[0x8] = _mm256_mask_store_ps(arg5, arg8)
            float var_280_1[0x8] = zmm5
            ...
            zmm5 = _mm256_mask3_fmsub_ps(zmm5, arg5, zmm17, zmm20)
            ...
            arg8 = _mm256_mask_add_ps(arg5, arg8, arg8)
            zmm20 = _mm256_mask3_fmadd_ps(_mm256_mask_load_ps(arg5, var_2c0_1), arg5, zmm3, zmm5)
            zmm21 = _mm256_mask3_fmadd_ps(_mm256_mask_load_ps(arg5, var_2a0_1), arg5, zmm3, arg7)
            zmm3 = __vfmadd213ps_ymmf32_maskmskw_ymmf32_memf32_avx512(zmm3, arg5, arg8, var_280_1)
            zmm22 = _mm256_mask_mul_ps(arg5, arg7, zmm18)
            zmm23 = _mm256_mask_mul_ps(arg5, arg8, zmm19)
            float zmm24[0x8] = _mm256_mask_mul_ps(arg5, zmm5, zmm17)
            arg8 = _mm256_mask_add_ps(arg5, zmm20, _mm256_mask3_fmsub_ps(zmm22, arg5, arg8, zmm17))
            zmm5 = _mm256_mask_add_ps(arg5, zmm21, _mm256_mask3_fmsub_ps(zmm23, arg5, zmm5, zmm18))
            zmm3 = _mm256_mask_add_ps(arg5, zmm3, _mm256_mask3_fmsub_ps(zmm24, arg5, arg7, zmm19))
            arg7 = __vaddps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, arg8, arg3[4])
            zmm5 = __vaddps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, zmm5, arg3[5])
            ...
            zmm5 = __vsubps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, zmm5, (*arg2)[1])
            zmm3 = __vsubps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, zmm3, (*arg2)[2])
            arg7 = _mm256_fmadd_ps(_mm256_fmadd_ps(_mm256_fmadd_ps(arg7, arg7, arg6), zmm5, zmm5), 
                zmm3, zmm3)
            zmm3 = _mm256_mask_rsqrt14_ps(arg5, arg7)
            zmm3 = __vmulps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, 
                _mm256_mul_ps(zmm3, 
                    __vfnmadd213ps_ymmf32_maskmskw_ymmf32_memf32_avx512(_mm256_mul_ps(arg7, zmm3), 
                        arg5, zmm3, 0x40400000)), 
                0x3f000000)
            arg7 = _mm256_mask_rcp14_ps(arg5, zmm3)
            zmm3 = __vfnmadd213ps_ymmf32_maskmskw_ymmf32_memf32_avx512(
                __vfnmadd213ps_ymmf32_maskmskw_ymmf32_memf32_avx512(zmm3, arg5, arg7, 0x40000000), 
                arg5, arg7, *arg1)
            arg5 = __vcmpps_maskmskw_maskmskw_ymmf32_memf32_imm8_avx512(arg5, zmm3, *arg10, 1)
...
if (rbx s< arg11)
    ...
    if (temp2_1 == 0)
        ...
        uint64_t k1_7 = __vpcmpgtd_maskmskw_maskmskw_ymmi32_ymmi32_avx512(arg5, 
            _mm256_mask_set1_epi32(arg5, arg11), zmm0)
        arg6 = __vpmulld_ymmu32_maskmskw_ymmu32_memu32_avx512(arg5, zmm0, 3)
        int64_t k2_2
        int128_t temp0_64
        temp0_64, k2_2 = _mm256_mmask_i32gather_ps(__kmovq_maskmskw_masku64_avx512(k1_7), 
            *(arg4 + (arg6[0].q << 2)))
        zmm2 = temp0_64
        ...
        float var_100_2[0x8] = zmm5
        float var_e0_2[0x8] = zmm5
        arg8 = __vbroadcastss_ymmf32_maskmskw_memf32_avx512(arg5, arg3[1])
        ...
        zmm19 = _mm256_mask_mul_ps(arg5, zmm5, arg6)
        zmm20 = _mm256_mask_mul_ps(arg5, arg7, zmm17)
        zmm21 = _mm256_mask_mul_ps(arg5, zmm3, zmm18)
        zmm22 = _mm256_mask_mul_ps(arg5, zmm2, arg8)
        zmm20 = _mm256_mask3_fmsub_ps(zmm20, arg5, arg8, zmm3)
        zmm21 = _mm256_mask3_fmsub_ps(zmm21, arg5, zmm17, zmm2)
        zmm22 = _mm256_mask3_fmsub_ps(zmm22, arg5, zmm18, arg7)
        zmm2 = _mm256_mask_sub_ps(arg5, zmm19, zmm19)
        ...
        int256_t var_280_2 = _mm256_mask_store_ps(arg5, arg8)
        int32_t var_260_2[0x8] = zmm2
        zmm17 = _mm256_mask3_fmadd_ps(_mm256_mask_load_ps(arg5, var_1c0_1), arg5, zmm5, zmm3)
        zmm18 = _mm256_mask_load_ps(arg5, var_1a0_1)
        zmm19 = _mm256_mask_load_ps(arg5, var_180_1)
        zmm18 = _mm256_mask3_fmadd_ps(zmm18, arg5, zmm5, arg7)
        zmm19 = _mm256_mask3_fmadd_ps(zmm19, arg5, zmm5, arg8)
        zmm2 = __vfmadd213ps_ymmqq_ymmqq_memqq(zmm2, zmm5, var_160_1)
        int256_t var_c0_1 = _mm256_mask_store_ps(arg5, zmm17)
        int256_t var_a0_1 = _mm256_mask_store_ps(arg5, zmm18)
        int256_t var_80_1 = _mm256_mask_store_ps(arg5, zmm19)
        ...
        zmm21 = _mm256_mask_mul_ps(arg5, arg7, zmm5)
        zmm22 = _mm256_mask_mul_ps(arg5, arg8, zmm20)
        zmm23 = _mm256_mask_mul_ps(arg5, zmm3, zmm2)
        zmm21 = _mm256_mask3_fmsub_ps(zmm21, arg5, arg8, zmm2)
        zmm22 = _mm256_mask3_fmsub_ps(zmm22, arg5, zmm3, zmm5)
        ...
        zmm2 = __vaddps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, zmm2, arg3[4])
        zmm3 = __vaddps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, zmm3, arg3[5])
        arg7 = __vaddps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, arg7, arg3[6])
        zmm2 = __vsubps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, zmm2, *arg2)
        zmm3 = __vsubps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, zmm3, (*arg2)[1])
        arg7 = __vsubps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg5, arg7, (*arg2)[2])
        zmm2 = _mm256_fmadd_ps(_mm256_fmadd_ps(_mm256_fmadd_ps(zmm2, zmm2, arg6), zmm3, zmm3), 
            arg7, arg7)
        arg6 = _mm256_mask_rsqrt14_ps(arg5, zmm2)
        ...
        arg6 = __vfnmadd213ps_ymmf32_maskmskw_ymmf32_memf32_avx512(
            __vfnmadd213ps_ymmf32_maskmskw_ymmf32_memf32_avx512(arg6, arg5, zmm2, 0x40000000), 
            arg5, zmm2, *arg1)
        int64_t k0 = __vcmpps_maskmskw_maskmskw_ymmf32_memf32_imm8_avx512(k1_7, arg6, *arg10, 1)
