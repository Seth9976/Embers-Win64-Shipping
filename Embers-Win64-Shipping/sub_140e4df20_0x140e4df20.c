    ...
    do
        ...
        label_140e4e15f:
            ...
            sub_1405979f0(&var_2f8, 
                (*(*var_200 + 0x68))(var_200, &var_118, &var_238, &var_368, var_388, var_380, arg2))
            sub_140597700(&var_118)
            rcx_7 = var_30c
        else
            void var_1d8
            sub_1405979f0(&var_2f8, 
                (*(*var_200 + 0xf8))(var_200, &var_1d8, &var_238, &var_368, var_388, var_380, arg2))
            sub_140597700(&var_1d8)
            rcx_7 = var_30c
            
            if (rcx_7 == 0)
                goto label_140e4e15f
            
            if (var_2f8 == 0 && *(*arg5 + 0x460) != 0)
                goto label_140e4e15f
        
        if (rcx_7 != 0)
            void* rax_11 = *arg5
            
            if (*(rax_11 + 0x438) == 0 && *(rax_11 + 0x439) == 0)
                (*(*var_200 + 0x80))(var_200, &var_368)
        ...
        var_380 = var_35c
        var_388 = &var_368
        MRECmpImpl::FPushFile(arg2, r13, arg1, r13, var_388, var_380)
        int64_t* var_320
