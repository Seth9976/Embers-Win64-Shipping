...
if (rax_5 != 0)
    ...
    if ((arg1[5].b & 1) != 0)
        int512_t zmm1 = sub_14218ca70(arg2, rax_5)
        int32_t r14 = 0
    ...
    if (rax_5 s> 0)
        do
            int64_t* rdx_11 = (sx.q(i) << 4) + *arg2
            
            if ((arg1[5].b & 1) != 0)
                *rdx_11 = 0
                rdx_11[1] = 0
            
            sub_142183480(arg1, rdx_11, arg3)
            i += 1
        while (i s< arg2[1].d)
else if ((arg1[5].b & 1) != 0)
    sub_14218ca70(arg2, 0)
