...
if (r11 != 0)
    ...
    label_14270b428:
        ...
        while (true)
            ...
            if (rdx_3 != 0)
                goto label_14270b428
        
        var_64.d = r11

void* var_10 = arg1 + 0xe8
int128_t zmm0 = var_78.o
int128_t var_20 = 0xffffffff
int16_t var_40 = 0
void* result = zmm0.q
var_68.o = zmm0
var_78.o = (arg1 + 0xe8).o
...
if (0 s< *(result + 0x18))
    ...
    do
        if (sub_140d3e110(sx.q(i) * 0x38 + *var_78.q + 8) == 0)
            sub_14270b230(zmm0:8.q, i)
            var_40.b = 1
    ...
    if (var_40.b != 0 && var_40:1.b != 0)
        return sub_1426f6bf0(arg1 + 0xe8, *(arg1 + 0xf0) - *(arg1 + 0x11c), 1)
