    ...
    if (r14_1 - 1 s>= 0)
        ...
        do
            ...
            if (rax_7.d s> 0)
                ...
                do
                    if (*rax_8 == rsi_3[1])
                        goto label_141cae97c
                    
                    rcx_2 += 1
                    rax_8 = &rax_8[1]
                while (rcx_2 s< rax_7)
                
                goto label_141caef67
            
        label_141cae97c:
            int64_t rax_9 = sx.q(arg3[3].d)
            
            if (rax_9.d s<= 0)
                goto label_141caebb0
            ...
            if (arg3[0x1c].b == 0)
                ...
                if (rax_9.d s> 0)
                    ...
                    while (*rax_21 != rsi_3[2])
                        rcx_18 += 1
                        rax_21 = &rax_21[1]
                        
                        if (rcx_18 s>= rax_9)
                            goto label_141caec06
                    
                    goto label_141caeba6
            ...
            label_141caef67:
                ...
                if (arg3[3].d s> 0)
                    do
                        int64_t var_140
                        sub_140b63b70(arg3[2] + (sx.q(j) << 3), &var_140)
                        char rax_11
            ...
            label_141caebb0:
                ...
                if (arg3[5].d s> 0)
                    int64_t* rcx_17 = arg3[4]
                    void* rdx_11 = &rcx_17[sx.q(arg3[5].d)]
                    ...
                    if (*(arg3 + 0xe1) == 0)
                        ...
                        if (var_70 != 0)
                            ...
                            label_141caecac:
                                ...
                                rax_32 = r8_7 - rax_31 + 0x1f
                                
                                if (rax_32 s> var_70)
                                    rax_32 = var_70
                            else
                                while (true)
                                    int64_t rdx_16 = sx.q(rcx_19)
                                    r8_7 += 0x20
                                    rcx_19 += 1
                                    var_17c_1:4.d = r8_7
                                    var_190_1 = rcx_19
                        ...
                        while (true)
                            ...
                            int64_t* rcx_23 = var_f0.q
                            
                            if (rax_33.d == ((0xffffffff << (r9.b & 0x1f)).q u>> 0x20).d
                                    && var_e0_1.q == &var_88 && rcx_23 == &var_98)
                                goto label_141caef67
                            
                            if (*(*rcx_23 + rax_33 * 0x10) == rsi_3[4])
                                break
                ...
                if (arg3[9].d - *(arg3 + 0x74) s> 0)
                    ...
                    int32_t rcx_29 = var_110_1:0xc.d
                    
                    while (true)
                        int64_t rdx_25 = sx.q(rcx_29) * 5
                        int64_t rcx_30 = *var_120.q
                        int64_t* rbx_5 = rcx_30 + (rdx_25 << 3)
                        int64_t r8_12 = *rbx_5
                        int16_t* const rcx_32
                        int16_t* rdx_27
                        
                        if (*(rcx_30 + (rdx_25 << 3) + 0x18) != 0)
                            ...
                            label_141caef3d:
                                int32_t rax_54
                                rax_54, r9 = sub_140a54510(rcx_32, rdx_27)
                            ...
                            if (rax_52 != 0)
                                ...
                                goto label_141caef3d
                        var_110_1:8.d &= not.d(var_120:0xc.d)
                        sub_14059bdd0(&var_120:8)
                        rcx_29 = var_110_1:0xc.d
                        
                        if (rcx_29 s>= *(var_110_1.q + 0x18))
                            goto label_141caef67
            i -= 1
            i_2 = i_3 - 1
            i_1 = i
