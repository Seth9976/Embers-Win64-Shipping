...
while (true)
    ...
    float temp0_17[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_11, temp0_11, 0xd2), temp0_13)
    ...
    float temp0_29[0x4] = __addps_xmmps_memps(
        _mm_add_ps(
            _mm_sub_ps(_mm_mul_ps(_mm_shuffle_ps(temp0_20, temp0_20, 0xd2), temp0_13), temp0_23), 
            temp0_24), 
        arg3[1])
    *(&var_1a8:4 + (sx.q(i_6) << 2)) = i_6
    ...
    i_6 = r13.d + 1
    float temp0_32[0x4] = _mm_unpacklo_ps(zmm1, zmm5[0].q)
    float var_1d0_1 = zmm15[0]
    *(&var_178 + (rcx_5 << 2)) = temp0_32.q
    (&var_170)[rcx_5] = var_210
    ...
    *(&var_118 + (rcx_5 << 2)) = (_mm_unpacklo_ps(zmm1, zmm5[0].q)).q
    ...
    if (i_6 == 1)
        ...
        uint64_t* rax_17
        rax_17, zmm9 = sub_1416e69d0(&var_270, &var_118, &var_1a8:4, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_17)
        rax_14 = rax_17[1].d
    else if (i_6 == 3)
        uint64_t* rax_16
        rax_16, zmm9, zmm13, zmm14 = sub_1416fa750(&var_260, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_16)
        rax_14 = rax_16[1].d
    else if (i_6 == 4)
        ...
        uint64_t* rax_15
        rax_15, zmm9, zmm13, zmm14 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_15)
        rax_14 = rax_15[1].d
    else
    ...
    if (zmm3[0] < 9.99999997e-07f || zmm3[0] >= var_27c)
        zmm1 = zmm3
        var_27c = zmm3[0]
        break
...
if (zmm1[0] <= zmm8[0])
    ...
    float zmm9_1[0x4]
    float zmm13_1[0x4]
    rax_29, zmm8_1, zmm9_1, zmm13_1 = sub_1415a89d0(&var_260, &var_270, &var_208, &var_200, zmm14, 
        &var_278, &var_298, &var_228, &var_218)
    float zmm2_1[0x4]
    ...
    if (rax_29 == 2)
        ...
        *arg6 = (_mm_unpacklo_ps(zmm9_1, zmm9_1[0].q)).q
        ...
        float zmm3_1[0x4] = var_218
        int32_t var_214
        zmm2_1 = var_214
        *arg7 = var_298
        float zmm0_2[0x4] = var_278
        arg7[2] = var_290
        ...
        *arg4 = zmm0_2[0]
        ...
        zmm13_1[0] = zmm13_1[0] f* arg7[1]
        zmm13_1[0] = zmm13_1[0] f* arg7[2]
        zmm13_1[0] = zmm13_1[0] f+ var_228.d
        zmm13_1[0] = zmm13_1[0] f+ var_228:4.d
        int32_t var_220
        zmm13_1[0] = zmm13_1[0] f+ var_220
        *arg5 = (_mm_unpacklo_ps(zmm13_1, zmm13_1[0].q)).q
        arg5[1].d = zmm13_1[0]
    ...
    *arg7 = temp0_38.q
    ...
    float temp0_39[0x4] = __sqrtss_xmmss_memss(temp0_38[0], var_27c)
    float var_280_2 = temp0_37[0]
