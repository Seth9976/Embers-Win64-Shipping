...
while (true)
    ...
    *(&var_118 + (rcx_2 << 2)) = (_mm_unpacklo_ps(zmm5, zmm1[0].q)).q
    ...
    if (i_6 == 1)
        ...
        uint64_t* rax_15
        rax_15, zmm9, zmm15 = sub_1416fa750(&var_260, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_15)
        rax_13 = rax_15[1].d
    else if (i_6 == 4)
    ...
    if (zmm3[0] < 9.99999997e-07f || zmm3[0] >= var_274)
        rdx_1 = var_298
        zmm1 = zmm3
        var_274 = zmm3[0]
        break
...
if (zmm1[0] <= zmm10[0])
    ...
    if (i_6 s> 0)
        ...
        do
            ...
            uint64_t rcx_18 = var_260
            int64_t rdx_9 = rdi_2 * 3
            int32_t rax_25 = *(&var_170 + rbx)
            *(rcx_18 + (rdx_9 << 2)) = *(&var_178 + rbx)
            *(rcx_18 + (rdx_9 << 2) + 8) = rax_25
            ...
            rbx += 0xc
            *(rcx_20 + (rdx_11 << 2)) = zmm0_1
            *(rcx_20 + (rdx_11 << 2) + 8) = rax_27
            i = i_5
            i_5 -= 1
        while (i != 1)
    ...
    float zmm9_1[0x4]
    float zmm10_1
    rax_28, zmm9_1, zmm10_1 = sub_141598800(&var_260, &var_270, &var_208, &var_200, &var_298, 
        &var_290, &var_228, &var_218)
    float zmm2_1[0x4]
    float zmm3_1[0x4]
    ...
    if (rax_28 == 2)
        ...
        *arg4 = zmm0_2[0]
        ...
        zmm2_1[0] = zmm2_1[0] f* arg7[1]
        zmm2_1[0] = zmm2_1[0] f* arg7[2]
        zmm2_1[0] = zmm2_1[0] f+ var_228.d
        zmm2_1[0] = zmm2_1[0] f+ var_228:4.d
        int32_t var_220
        zmm2_1[0] = zmm2_1[0] f+ var_220
        *arg5 = (_mm_unpacklo_ps(zmm2_1, zmm2_1[0].q)).q
    ...
    *arg7 = temp0_37.q
    ...
    float temp0_38[0x4] = __sqrtss_xmmss_memss(temp0_37[0], var_274)
