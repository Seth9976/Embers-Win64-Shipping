...
int128_t* rcx = *(arg1 + 0x638)
int32_t i = 1
int128_t* rdi_1 = *(arg1 + (sx.q(*(arg1 + 0x490)) + 0x45) * 0x10)
*rdi_1 = *rcx
rdi_1[1] = rcx[1]
rdi_1[2] = rcx[2]
...
if (*(arg1 + 0x640) s> 1)
    ...
    float zmm15[0x4] = data_143f3afa0
    float zmm6[0x4]
    ...
    do
        int64_t rcx_3 = sx.q(*(*(*(arg1 + 0x430) + 0x1a8) + r15_1 + 8)) * 6
        zmm13 = *(rbx_1 + 0x10)
        zmm9 = *(rdi_1 + (rcx_3 << 3) + 0x20)
        float zmm3[0x4]
        float zmm5[0x4]
        
        if (zx.d(_mm_movemask_ps(_mm_cmpeq_ps(_mm_min_ps(zmm13, zmm9), data_143f3afe0, 1))) == 0)
            zmm6 = *(rdi_1 + (rcx_3 << 3))
            zmm3 = *(rbx_1 - 0x10)
            zmm5 = *rbx_1
            zmm8 = *(rdi_1 + (rcx_3 << 3) + 0x10)
            float temp0_133[0x4] = _mm_shuffle_ps(zmm3, zmm3, 0x4e)
            float temp0_136[0x4] =
                _mm_mul_ps(_mm_shuffle_ps(zmm3, zmm3, 0x1b), _mm_shuffle_ps(zmm6, zmm6, 0))
            float temp0_137[0x4] = _mm_mul_ps(zmm9, zmm5)
            float temp0_138[0x4] = _mm_shuffle_ps(zmm6, zmm6, 0xff)
            float temp0_139[0x4] = _mm_mul_ps(temp0_136, zmm15)
            ...
            float temp0_145[0x4] = _mm_mul_ps(temp0_133, _mm_shuffle_ps(zmm6, zmm6, 0x55))
            float temp0_147[0x4] = _mm_mul_ps(temp0_141, _mm_shuffle_ps(zmm6, zmm6, 0xaa))
            float temp0_148[0x4] = __mulps_xmmps_memps(temp0_145, data_143f3af90)
            float temp0_149[0x4] = _mm_shuffle_ps(temp0_137, temp0_137, 0xc9)
            float temp0_150[0x4] = __mulps_xmmps_memps(temp0_147, data_143f3af80)
            float temp0_151[0x4] = _mm_add_ps(temp0_143, temp0_148)
            *(r12_2 + rbx_1 + 0x10) = temp0_142
            float temp0_152[0x4] = _mm_add_ps(temp0_151, temp0_150)
            float temp0_153[0x4] = _mm_shuffle_ps(temp0_137, temp0_137, 0xd2)
            *(r12_2 + rbx_1 - 0x10) = temp0_152
            float temp0_154[0x4] = _mm_shuffle_ps(zmm6, zmm6, 0xd2)
            ...
            *(r12_2 + rbx_1) = _mm_add_ps(
            ...
            float zmm1[0x4] = __andps_xmmxud_memxud(temp0_21, data_143f3adb0)
            ...
            zmm1 = __andps_xmmxud_memxud(_mm_mul_ps(temp0_47, zmm13), data_143f3adb0)
            ...
            zmm14 =
                _mm_and_ps(_mm_cmpeq_ps(zmm14, zmm12, 2), data_143f3afd0 ^ zmm10) ^ data_143f3afd0
            ...
            zmm6 =
                _mm_and_ps(_mm_mul_ps(temp0_127, zmm5) ^ data_143f3afb0, temp0_125) ^ data_143f3afb0
            *(r12_2 + rbx_1) =
                _mm_unpacklo_ps(_mm_unpacklo_ps(var_d8_1.d, var_d8_1:8.d[0].q), temp0_128[0].q)
            var_118 = zmm6
            *(r12_2 + rbx_1 + 0x10) = zmm12
            *(r12_2 + rbx_1 - 0x10) = zmm6
        i += 1
        r15_1 += 0xc
        rbx_1 += 0x30
    while (i s< *(arg1 + 0x640))
