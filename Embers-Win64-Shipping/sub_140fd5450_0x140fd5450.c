    ...
    label_140fd5676:
        ...
        while (true)
                ...
                for (; i u> r10_1; i -= 0x20)
                    ...
                    if (&r10_1[2] u<= i)
                        do
                            ...
                            if (*(r11_2 + 0x10) * 0xffff + *(r11_2 + 0x14)
                                    u>= *(r8_2 + 0x10) * 0xffff + *(r8_2 + 0x14))
                                rcx_16 = r11_2
            ...
            while (true)
                ...
                if (rdx_1 u<= i && r10_1[1].d * 0xffff + *(r10_1 + 0x14)
                        u>= rdx_1[1].d * 0xffff + *(rdx_1 + 0x14))
                    continue
                ...
                do
                    ...
                    if (r8 u<= r10_1)
                        break
                while (r8[1].d * 0xffff + *(r8 + 0x14) u>= r10_1[1].d * 0xffff + *(r10_1 + 0x14))
