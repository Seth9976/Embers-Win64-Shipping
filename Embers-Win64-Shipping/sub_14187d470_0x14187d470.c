...
label_14187d57a:
    ...
    if (sub_14144aa10(arg1, arg1[1].d - *(arg1 + 0x34), 0) == 0)
        ...
        arg4[0xa] = *(rax_8 + (((sx.q(arg1[9].d) - 1) & r8_1) << 2))
        void* rax_10 = *(r9_1 + 8)
    ...
    if (rbx_1 == 0xffffffff)
        ...
        void* rsi_3 = sx.q(rbx_1) * 0x30 + *arg1
        sub_140745b20(rsi_3 + 0x18)
        sub_140745b20(rsi_3 + 8)
        memmove(rsi_3, arg4, 0x28)
        sub_1407c2ba0(arg1, arg5, 1)
        rdi = rbx_1
    
    if (rbx_1 == 0xffffffff)
        goto label_14187d57a
