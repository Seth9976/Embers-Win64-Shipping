...
int64_t r9 = *arg1
(*(r9 + 8))(arg1, sx.q(arg2[1].d) * 0x50, sx.q(*(arg2 + 0xc)) * 0x50, r9)
int64_t r9_1 = *arg1
...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_38 + 0x18); i = i_1)
        int32_t* rbx_3 = sx.q(i) * 0x50 + *var_48
        sub_1409ac860(arg1, rbx_3, zmm1_1)
        sub_1420f5240(arg1, &rbx_3[4], zmm1_1)
        int32_t var_3c
...
int512_t zmm1 = sub_1420f8330(arg2, arg_8)
int32_t r14 = 0
...
do
    ...
    if (rdx_9 == 0)
        ...
        rdi_1 = sx.q(arg2[6].d)
        int64_t r9_2 = *arg2
        int64_t r8_6 = sx.q(*(r9_2 + rdi_1 * 0x50 + 4))
        arg2[6].d = r8_6.d
        *(arg2 + 0x34) = rdx_9 - 1
        
        if (rdx_9 != 1)
            *(r9_2 + r8_6 * 0x50) = 0xffffffff
    ...
    *r8_7 |= 1 << (rdi_1.b & 0x1f)
    int32_t* rdx_14 = sx.q(rdi_1.d) * 0x50 + *arg2
    __builtin_memset(rdx_14, 0, 0x48)
    rdx_14[0x12] = 0xffffffff
    sub_1409ac860(arg1, rdx_14, zmm1)
    sub_1420f5240(arg1, &rdx_14[4], zmm1)
    r14 += 1
while (r14 s< arg_8)
