...
int64_t r14 = rdx << 3
int32_t rdx_1 = *(result_3 + (rdx << 3))

if (rdx_1 != 0xffffffff)
    sub_14122ef20(arg1, rdx_1)
    result_16 = *(arg1 + 0x88)
...
if (rbp.d != 0xffffffff)
    int32_t rcx_2 = *(result_1 + 0x80)
    int32_t rax_2 = rcx_2 - rbp.d
    
    if (rax_2 != 1)
        memmove(result_10 + rbp * 0x18, result_10 + sx.q((rbp + 1).d) * 0x18, (rax_2 - 1) * 0x18)
        rcx_2 = *(result_1 + 0x80)
    
    *(result_1 + 0x80) = rcx_2 - 1
    sub_141238b80(result_1)
    int32_t i = 0
...
if (rbp_1.d != 0xffffffff)
    int32_t rcx_8 = *(result_1 + 0x80)
    int32_t rax_13 = rcx_8 - rbp_1.d
    
    if (rax_13 != 1)
        memmove(result_2 + rbp_1 * 0x18, result_2 + sx.q((rbp_1 + 1).d) * 0x18, (rax_13 - 1) * 0x18)
        rcx_8 = *(result_1 + 0x80)
    
    *(result_1 + 0x80) = rcx_8 - 1
    sub_141238b80(result_1)
