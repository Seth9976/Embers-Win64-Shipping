...
if (arg4.b != 0)
    int32_t* i = *(arg1 + 0x100)
    result = sx.q(*(arg1 + 0x108))
    ...
    for (void* rsi_1 = &i[result * 0xa]; i != rsi_1; i = &i[0xa])
        ...
        if (*result == *arg2 && i[3] == arg2[1].d && i[2].b == *(arg2 + 0xc))
            *arg3 = *(i + 0x10)
            result.b = 1
            goto label_142128bad

if (*(arg2 + 0xc) != 2)
    result, arg4 = sub_14210eb80(arg1 + 0x188, 2, arg2)
...
if (*(arg2 + 0xc) == 2 || result.d == 0xffffffff)
    ...
    if (rcx_5 != 0)
        arg4.b = 1
        return (*(*rcx_5 + 0x338))(rcx_5, arg2, arg3, arg4)
    
    result.b = 0
else
    int64_t rcx_3 = sx.q(result.d)
    result.b = 1
    *arg3 = *(*(arg1 + 0x2e8) + (rcx_3 << 3))
