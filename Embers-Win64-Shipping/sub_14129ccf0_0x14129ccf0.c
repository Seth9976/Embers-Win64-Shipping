...
if (data_143e8ccc0 s> *rdi_1)
    _Init_thread_header(&data_143e8ccc0)
    
    if (data_143e8ccc0 == 0xffffffff)
        ...
        data_143e8ccb8 = rax_9
        _Init_thread_footer(&data_143e8ccc0)

if (data_143e8ccd0 s> *rdi_1)
    _Init_thread_header(&data_143e8ccd0)
    
    if (data_143e8ccd0 == 0xffffffff)
        ...
        data_143e8ccc8 = rax_12
        _Init_thread_footer(&data_143e8ccd0)

if (data_143e8cce0 s> *rdi_1)
    _Init_thread_header(&data_143e8cce0)
    
    if (data_143e8cce0 == 0xffffffff)
        ...
        data_143e8ccd8 = rax_15
        _Init_thread_footer(&data_143e8cce0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ccb8
int64_t rcx
...
label_14129cdf3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_14129cdee
        
        rbx.b = 1
        goto label_14129cdf3
