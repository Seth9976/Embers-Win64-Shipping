...
int128_t zmm7
uint32_t zmm9[0x4]
zmm0_2, zmm7, zmm9 = sub_1408b3f80(&arg_8, arg5, arg6)
int128_t zmm13 = *arg3
int128_t zmm1_1
...
_mm_max_ss(_mm_min_ss(zmm13.d f* zmm1_1.d, zmm7.d), 0)

if (rsi_1 s> 1)
    uint32_t var_68_1[0x4] = zmm9
    zmm9 = *arg2
    int128_t zmm10 = *(arg6 + 4)
    int128_t zmm11 = *(arg6 + 8)
    
    do
        zmm10.d = zmm10.d f* zmm9[0]
        r15 += 1
        zmm9[0] = zmm9[0] f* *arg6
        arg_8 = r15
        ...
        *(arg6 + 8) = zmm11.d
        float zmm8_1
        zmm0_2, zmm6_1, zmm7, zmm8_1, zmm9 = sub_1408b3f80(&arg_8, arg5, arg6)
        float zmm1_2 = zmm7.d f- _mm_and_ps(zmm0_2, 0x7fffffff)[0]
        zmm1_2 = zmm1_2 * zmm1_2 * zmm8_1
        zmm8_1 = zmm13.d * zmm1_2
        zmm1_2 = zmm1_2 f* rbp[r14]
        r14 += 1
        zmm6_1.d = zmm6_1.d f+ zmm1_2
        _mm_max_ss(_mm_min_ss(zmm8_1, zmm7.d), 0)
    while (r14 s< rsi_1)
