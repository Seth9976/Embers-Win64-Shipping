...
data_143ef95c8 = (*(*rcx_2 + 0x78))(rcx_2, u"vr.TrackingOrigin", rbx_1, &var_38, 0)
data_143ef95c0 = &data_142d3ff10
int64_t* var_20
...
label_1404d029b:
    ...
    if (rcx_5 != 0)
        ...
        int32_t var_30_1 = 0
        goto label_1404d029b
return atexit(sub_142ceb960) __tailcall
