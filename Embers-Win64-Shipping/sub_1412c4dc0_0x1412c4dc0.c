...
if (data_143e8b0f8 s> *rdi_1)
    _Init_thread_header(&data_143e8b0f8)
    
    if (data_143e8b0f8 == 0xffffffff)
        ...
        data_143e8b0f0 = rax_12
        _Init_thread_footer(&data_143e8b0f8)

if (data_143e8b108 s> *rdi_1)
    _Init_thread_header(&data_143e8b108)
    
    if (data_143e8b108 == 0xffffffff)
        ...
        data_143e8b100 = rax_15
        _Init_thread_footer(&data_143e8b108)

if (data_143e8b118 s> *rdi_1)
    _Init_thread_header(&data_143e8b118)
    
    if (data_143e8b118 == 0xffffffff)
        ...
        data_143e8b110 = rax_18
        _Init_thread_footer(&data_143e8b118)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b0f0
int64_t rcx
...
label_1412c4eb8:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412c4eb3
    
    rbx.b = 1
    goto label_1412c4eb8
