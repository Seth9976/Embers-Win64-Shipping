...
int32_t rdi = *(arg1 + 0x200)
int32_t rcx_1 = 0
int32_t var_94 = 1
int32_t var_98 = 0
int32_t r8 = 0
void* var_90 = arg1 + 0x1e8
int32_t var_88 = 0xffffffff
int64_t var_84 = 0

if (rdi != 0)
    void* rax_1 = *(arg1 + 0x1f8)
    void* r9_1 = arg1 + 0x1e8
    ...
    label_140a852a8:
        ...
        while (true)
            ...
            if (rdx_2 != 0)
                goto label_140a852a8
        
        var_84.d = rdi

int32_t rdx_4 = *(arg1 + 0x200)
...
var_84.d = rdx_4
int128_t var_78 = (arg1 + 0x1d8).o
int96_t var_68 = var_48:8.12

if (rdx_4 != rdi)
    void* rax_11 = *(arg1 + 0x1f8)
...
while (true)
    ...
    if (result.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0x1e8 && rcx_8 == arg1 + 0x1d8)
        if (arg1 == -0x228)
            return result
        
        return LeaveCriticalSection(arg1 + 0x228)
    
    r8_3.b = 1
    sub_140a84ed0(*(*rcx_8 + result * 0x28 + 0x10), arg2, r8_3.b)
