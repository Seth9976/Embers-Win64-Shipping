...
label_140f5c462:
    ...
    if (arg4 == 0 && result != 0)
        ...
        if (not(sub_140ed8eb0(&r12[0x9c], rsi, zmm8[0]).d f== 0f))
            result, zmm6 = sub_140f89930(r12)
    else if (rbx.b == 0)
        void* rax = r12[0xdc]
        ...
        if (rax != 0 && *(rax + 8) s> 0)
            ...
            if (not(zmm11[0] f== 0f))
                ...
                do
                    ...
                    int64_t* r15_2 = *rax_1 + r13_2
                    
                    if (*r15_2 != 0)
                        int64_t* var_158
                        sub_140ec04c0(&r12[0x9e], &var_158, r15_2)
                        ...
                        if (r12_1 != 0)
                            ...
                            void* rax_4 = r15_2[1]
                            void* var_128_1 = rax_4
                            
                            if (rax_4 != 0)
                                *(rax_4 + 8) += 1
                            
                            void var_f8
                            int64_t* rax_6 = (*(*arg1 + 0x2a8))(arg1, &var_f8, &var_130)
                            ...
                            int128_t zmm0_2 = sub_140eca900(&r12[0x9e], &var_110, &var_120)
                            void var_e8
                            zmm7 = sub_140e25880(*(*(*r12_1 + 0x50))(r12_1, &var_e8), zmm15, zmm0_2)
                            int64_t* var_e0
                        ...
                        r12 = arg1
                        void var_140
                        sub_140f66410(&var_140, r12[0x9b].d, rax_21)
                        int64_t* var_d0
