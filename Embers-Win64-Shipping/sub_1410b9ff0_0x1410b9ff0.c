...
if (data_143e2ce70 s> *rsi_1)
    _Init_thread_header(&data_143e2ce70)
    
    if (data_143e2ce70 == 0xffffffff)
        ...
        data_143e2ce68 = rax_6
        _Init_thread_footer(&data_143e2ce70)

uint32_t rax_2

if (data_143e2ce80 s> *rsi_1)
    int64_t r8_2
    rax_2, r8_2 = _Init_thread_header(&data_143e2ce80)
    
    if (data_143e2ce80 == 0xffffffff)
        ...
        data_143e2ce78 = rax_9
        _Init_thread_footer(&data_143e2ce80)

int64_t rbp = data_143e2ce78
uint16_t rsi_2
