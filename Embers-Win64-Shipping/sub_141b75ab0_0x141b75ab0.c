...
if (rax_2 == 0 || rdi_1 == 0)
    if (sub_140cc16a0(&var_48, sub_140bdfab0()) != 0)
        ...
        if (rbx_8 != 0)
            ...
            return sub_141b97a50(arg1, rbx_8, arg4)
    ...
    if (sub_140cc1670(&var_48, &data_143e1b820).b == 0 || var_48 == 0)
        ...
        uint64_t r14_2 = zx.q(sub_1408e52c0(rax_10))
        void var_38
        ...
        if (rbx_10 != &data_143e1d7f0)
            ...
            if (*(rdi_1 + 0x3c) != 0x18 || r14_2.d s>= rdi_1[7].d)
                ...
                int64_t rbx_11 = sx.q((r14_2 * 3).d << 3)
