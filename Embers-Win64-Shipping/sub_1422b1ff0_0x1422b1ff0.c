        ...
        if (((rcx u>> 3).b & 1) == 0)
            ...
            if (rax_6 != 0)
                ...
                if (*(rdi + 8) != 0 && r15_3[5].d != 0xffffffff)
                    ...
                    if (*(r15_3 + 0x24) == 1)
                        goto label_1422b238d
                    
                    goto label_1422b2193
                
                arg_18.b = 0
            label_1422b2193:
                int16_t** rsi_3 = sx.q(*(r14_3 + 0xc)) + *r10
                int32_t* r10_2 = sx.q(r14_3[2].d) + *(arg2 + 8)
                ...
                switch (rax_6)
                    ...
                    label_1422b238d:
                        ...
                        if (arg_20 != 0 && (*rdi & *(r15_3 + 0x2c)) != 0)
                            int64_t rdx_12 = sx.q(r14_3[2].d) + *(r10 + 8)
                            int64_t rcx_24 = sx.q(*(r14_3 + 0xc)) + *r10
                            int64_t* r10_3 = *r14_3
                ...
                int16_t rsi_1 = i + 1
                int64_t* r15_5 = sx.q(r14_3[2].d) + *(r10 + 8)
                int64_t* rbx_2 = sx.q(*(r14_3 + 0xc)) + *r10
                int32_t rdx = r15_5[1].d
                i = r14_3[1].w - 1
                
                if (rdx == rbx_2[1].d)
                    goto label_1422b2107
                ...
                label_1422b2107:
                    ...
                    if (r15_5[1].d s> 0)
                        do
                            ...
                            var_78 = rcx_3 + rbx_3
                            r13.b |= sub_1422b1ff0(arg1, &var_78)
                            j += 1
                        while (j s< r15_5[1].d)
