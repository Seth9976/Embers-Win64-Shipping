...
if (data_143e8d8e8 s> *rdi_1)
    _Init_thread_header(&data_143e8d8e8)
    
    if (data_143e8d8e8 == 0xffffffff)
        ...
        data_143e8d8e0 = rax_9
        _Init_thread_footer(&data_143e8d8e8)

if (data_143e8d8f8 s> *rdi_1)
    _Init_thread_header(&data_143e8d8f8)
    
    if (data_143e8d8f8 == 0xffffffff)
        ...
        data_143e8d8f0 = rax_12
        _Init_thread_footer(&data_143e8d8f8)

if (data_143e8d910 s> *rdi_1)
    _Init_thread_header(&data_143e8d910)
    
    if (data_143e8d910 == 0xffffffff)
        ...
        data_143e8d900 = rax_15
        _Init_thread_footer(&data_143e8d910)
