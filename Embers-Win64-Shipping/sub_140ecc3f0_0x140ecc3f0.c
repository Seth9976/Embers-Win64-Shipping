    ...
    *(arg2 + 0xb0) = 0x20702
    ...
    if (rax_7 == 3)
        ...
        if ((rax_12 & 0xc) != 0)
            ...
            r9.b = 1
            r8.b = rcx_5 == 0
            (*(*r12 + 0x28))(r12, &var_140, r8, r9, rax_11)
        label_140ecc55b:
            bool cond:3_1 = *(arg1 + 0x4d0) != 1
            *(arg1 + 0x568) = 1
            ...
            var_140 = *rax_9
            void* rax_17 = rax_9[1]
            void* var_138_2 = rax_17
            
            if (rax_17 != 0)
                *(rax_17 + 8) += 1
            
            (*(*r12 + 0x38))(r12, &var_140)
            goto label_140ecc55b
    
    if (rcx_5 == 0 && *(arg1 + 0x568) == rcx_5)
        (*(*r12 + 0x30))(r12)
        var_140 = *rax_9
        void* rax_22 = rax_9[1]
        void* var_138_3 = rax_22
        ...
        int64_t r9_1
        r9_1.b = 1
        (*(*r12 + 0x28))(r12, &var_140, 1, r9_1, rax_11)
    ...
    int64_t* var_138_4 = rdi_4
    int64_t rax_33 = r15_2 + 8
    ...
    int64_t var_130 = data_143e1e008
    int64_t var_128_1 = data_143e1e010
    int64_t* rax_36 = data_143e1e018
    ...
    void var_118
    sub_140596b00(arg2, 
        sub_140eae530(sub_140dbdce0(&var_108, (*(*r12 + 0xe0))(r12, &var_118), 0, 0), &var_140))
