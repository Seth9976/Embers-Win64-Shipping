...
char rbp = *(arg3 + 4)
int64_t rsi = sx.q(*(rax_1 + (rcx << 2) + 4))
int32_t* rbx_1 = sx.q(*(rax_1 + (rcx << 2))) + *(r10 + 0x38)
int32_t r10_1 = *(r10 + 8)
...
if (rsi.d s< 2 || zmm0.d f<= 0f)
    ...
    if (rbp != 1)
        ...
        zmm12.d = zmm12.d f- zmm0.d
        zmm12.d = zmm12.d f/ _mm_cvtepi32_ps(zx.o(rax_19)).d
    else
        zmm12 = zx.o(0)
else
    i_8 = zx.q(r9.d)
...
*(arg2 + 0x10) = _mm_unpacklo_ps(_mm_unpacklo_ps(zmm3, zmm0.q), temp0_5[0].q)
return result
