        ...
        if (r13_1 s< arg2)
            do
                ...
                if ((r8 + 1).d s< arg2)
                    ...
                    int64_t rdx_1 = **arg4
                    int32_t rdi_1 = *(rbp_1 * 0xd8 + rdx_1 + 0x90)
                    int32_t rax_7 = *(rsi_1 * 0xd8 + rdx_1 + 0x90)
                ...
                int32_t rdi_2 = *(rbx_2 * 0xd8 + rdx_2 + 0x90)
                int32_t temp3_1 = *(r10_2 * 0xd8 + rdx_2 + 0x90)
        ...
        if (j s> 1)
            do
                ...
                if ((result + 1).d s< j)
                    ...
                    int64_t r8_1 = **arg4
                    int32_t rdi_3 = *(r14_1 * 0xd8 + r8_1 + 0x90)
                    int32_t rcx_9 = *(rbp_2 * 0xd8 + r8_1 + 0x90)
                ...
                int64_t r8_2 = **arg4
                int32_t rsi_4 = *(rdi_4 * 0xd8 + r8_2 + 0x90)
                int32_t temp4_1 = *(r10_3 * 0xd8 + r8_2 + 0x90)
