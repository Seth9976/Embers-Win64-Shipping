...
label_1413e1584:
    ...
    if (r8_2 s> 0 && (rax_8 == 0 || rax_8 s< rbp))
        ...
        *(arg4 + 0xa4) = rax_11
        ...
        arg4[0x14].d = *(rax_12 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2))
        void* rax_14 = *(r9_2 + 8)
    ...
    label_1413e152c:
        ...
        while (true)
            int64_t* rcx_1 = sx.q(rbx_1) * 0xb0
            
            if (*(rcx_1 + rdx_3) == *arg4)
                break
            
            rbx_1 = *(rcx_1 + rdx_3 + 0xa0)
            
            if (rbx_1 == 0xffffffff)
                goto label_1413e152c
    ...
    if (rbx_1 == 0xffffffff)
        ...
        memmove(sx.q(rbx_1) * 0xb0 + *arg1, arg4, 0xa0)
        sub_1413f1020(arg1, arg5, 1)
        rdi = rbx_1
    
    if (rbx_1 == 0xffffffff)
        goto label_1413e1584
