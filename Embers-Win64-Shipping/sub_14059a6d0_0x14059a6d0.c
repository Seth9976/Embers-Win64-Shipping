...
label_14059a85a:
    ...
    if (sub_1405996f0(arg1, arg1[1].d - *(arg1 + 0x34), 0) == 0)
        void* r9 = &arg1[7]
        ...
        *(arg4 + 0x14) = rax_18
        ...
        arg4[2].d = *(rax_19 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2))
        void* rax_21 = *(r9 + 8)
    ...
    label_14059a78e:
        ...
        while (true)
            ...
            rdx_3 = *arg1
            rbx_1 = *(rdi_1 + rdx_3 + 0x10)
            
            if (rbx_1 == 0xffffffff)
                goto label_14059a78e
    ...
    if (rbx_1 == 0xffffffff)
        ...
        int64_t rax_6 = *arg1
        int64_t rcx_4 = *(rax_6 + (rcx_3 << 3))
        
        if (rcx_4 != 0)
            sub_140a74f90(rcx_4)
        
        memmove(rax_6 + (rcx_3 << 3), arg4, 0x10)
