...
label_141b9fc05:
    ...
    rdx_3 = &var_78
    int32_t var_68_1 = *(arg1 + 0x40)
    rbp = 2
    char var_60_1 = 1
    var_58 = 0
    int32_t var_50_1 = 0
else
    void* rax_1 = sub_140d3c6e0(arg1 + 0x48)
    
    if (rax_1 == 0)
        goto label_141b9fc05
    
    if (sub_140d1fd20(rax_1, *(arg1 + 0x50)) == 0)
        goto label_141b9fc05
    
    arg_8.q = *(arg1 + 0x50)
    void var_48
    int64_t* rax_5 = sub_141b70480(&var_48, sub_140d3c6e0(arg1 + 0x48), &arg_8)
    rdx_3 = rax_5
    rbp = 1
    rcx_5 = *rax_5
