...
while (true)
    ...
    if (r12_1 == 0)
    label_141a8a2b1:
        sub_141a89570(r15_1, rax_8, zx.q(arg3), arg4)
    else
        while (true)
            if (rax_8 s<= 8)
                for (; i u> r15_1; i -= 8)
                    ...
                    if (&r15_1[1] u<= i)
                        do
                            if (sub_141a91d80(arg4, *rsi_2, *r14_2) != 0)
                                rsi_2 = r14_2
            ...
            *r15_1 = rcx_3
            ...
            while (true)
                ...
                if (rsi_1 u<= i && sub_141a91d80(arg4, *r15_1, *rsi_1) == 0)
                    continue
                ...
                do
                    ...
                    i_1 = sub_141a91d80(arg4, *r14_1, *r15_1)
                while (i_1 == 0)
                rax_12 = *r14_1
