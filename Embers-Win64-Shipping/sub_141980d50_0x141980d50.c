...
if (*(rax_3 + 4) s<= 0 || rcx_1 != 1)
    ...
    sub_140b34200("UnlockVertexBuffer_BottomOfPipe", rbx)
    ...
    (*(*rcx_19 + 0x678))(rcx_19, arg2, arg3)
    data_1439c8510 = 0
    arg2[0x10] = 0
    result = sub_140b38680("UnlockVertexBuffer_BottomOfPipe", rbx)
else
    if (arg2[0x10] == 0)
        ...
        *(rcx_9 + 0x10) = arg3.o
        rcx_9[1] = 0
        *(rcx_9 + 0x20) = zmm6
        *rcx_9 = &data_143003ba8
        rcx_9[6] = zmm7:8.q
    else
        int64_t* rcx_2 = data_143f0f180
        memcpy((*(*rcx_2 + 0x660))(rcx_2, arg2, arg3, count_1.q u>> 0x20, count, 1), var_80:8.q, 
            count)
        sub_140a74f90(var_80:8.q)
        int64_t* rcx_5 = data_143f0f180
        (*(*rcx_5 + 0x678))(rcx_5, arg2, arg3)
