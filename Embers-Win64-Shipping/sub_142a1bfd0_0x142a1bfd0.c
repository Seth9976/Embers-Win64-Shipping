...
do
    uint16_t temp0_2[0x10] =
        __vpsadbw_ymmqq_ymmqq_memqq(__vpavgb_ymmqq_ymmqq_memqq(*rax, *arg3), *arg1)
    temp0_3 = __vpavgb_ymmqq_ymmqq_memqq(rax[1], arg3[1])
    int32_t zmm2[0x8] = __vpsadbw_ymmqq_ymmqq_memqq(temp0_3, arg1[1])
    arg1 = &(*arg1)[sx.q(arg2)]
    rax = &rax[2]
    arg3 = &(*arg3)[sx.q(arg4)]
