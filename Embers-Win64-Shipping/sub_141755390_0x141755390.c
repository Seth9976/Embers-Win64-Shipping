...
int32_t rax_2
int512_t zmm1
rax_2, zmm1 = sub_140b4e7c0(arg2, &data_1439a9538)
void* var_78

if (rax_2 s>= 0x1f)
    sub_141708230(arg2, &arg1[2], zmm1)
else
    var_78 = nullptr
    int32_t i_5 = 0
    ...
    else if (i_3 s< rax_3 && rax_3 != i_3)
        arg1[3].d = i_3
        sub_1405fde90(&arg1[2])
    ...
    if (arg1[3].d s> 0)
        ...
        do
            ...
            i += 1
            r8_1 += 0x18
            *(r8_1 + rax_5 - 0x18) = zmm0_1
            zmm1.o = zx.o(*(rcx_8 - 0x18))
            *(r8_1 + rax_5 - 8) = (zmm1.o).q
        while (i s< arg1[3].d)
...
sub_141754910(&arg1[4], arg2, zmm1)
...
if (result s>= 0x14)
    ...
    if (&r8_2[1] u> rcx_13[1])
        if ((*(arg2 + 0x29) & 0x20) != 0)
            sub_140b54070(arg2, &arg1[0xf], zmm1_1)
            return sub_14152dda0(arg2, arg1 + 0x7c, zmm1_1)
        
        (*(*arg2 + 0x150))(arg2, &arg1[0xf], 4)
        return sub_14152dda0(arg2, arg1 + 0x7c, zmm1_1)
...
if ((arg2[5].b & 1) != 0)
    ...
    sub_141731520(&arg1[4], &arg1[2], &var_78, &var_68, &arg1[0xc])
    sub_14175d510(&arg1[4], &var_78, &arg1[0xf], arg1 + 0x7c)
