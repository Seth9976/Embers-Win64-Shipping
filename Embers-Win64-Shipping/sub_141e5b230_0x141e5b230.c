...
label_141e5b397:
    ...
    if (r8_5 s> 0 && (rax_17 == 0 || rax_17 s< rbp))
        ...
        *(arg4 + 0x8c) = rax_20
        ...
        arg4[0x11].d = *(rax_21 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_23 = *(r9_4 + 8)
    ...
    label_141e5b2cd:
        ...
        while (true)
            int64_t rdx_2 = sx.q(rbx_1) * 0x12
            
            if (*(r8_3 + (rdx_2 << 3)) == *arg4)
                break
            
            rbx_1 = *(r8_3 + (rdx_2 << 3) + 0x88)
            
            if (rbx_1 == 0xffffffff)
                goto label_141e5b2cd
