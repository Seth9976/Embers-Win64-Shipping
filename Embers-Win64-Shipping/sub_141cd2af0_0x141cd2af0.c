...
sub_141cd59e0(arg1, &var_98, arg3)
int32_t var_70
int32_t r11 = var_70
int64_t var_88
int64_t* var_f8 = &var_88
int32_t rcx_3 = 0
int32_t var_100 = 0
int32_t r8_1 = 0
int32_t var_fc = 1
...
if (r11 != 0)
    ...
    label_141cd2c2b:
        ...
        while (true)
            ...
            if (rdx_4 != 0)
                goto label_141cd2c2b

int128_t var_c0 = var_100.o
...
while (true)
    int32_t var_e4
    int64_t rax_16 = sx.q(var_e4)
    int64_t rcx_5 = var_100.q
    
    if (rax_16.d == r11 && var_f0.q == &var_88 && rcx_5 == &var_98)
        int32_t var_50_1 = 0
    ...
    sub_14099ccf0(arg2, *rsi_3, 0, &var_108, 0)
    int64_t rbx_1 = *rsi_3
    void* const rcx_10
    ...
    label_141cd2d80:
        ...
        int32_t rax_19 = sub_140b5ead0(rbx_1.d) + rbx_1:4.d
        void* r8_3 = &arg2[7]
        void* rcx_8 = *(r8_3 + 8)
    ...
    *(r15_1 + 0x10) = rsi_3[3].d
    ...
    if (r15_1 + 0x18 != &rsi_3[4])
        ...
        sub_140841520(r15_1 + 0x18, rsi_3[4], rsi_3[5].d, *(r15_1 + 0x24), 0)
    
    *(r15_1 + 0x28) = rsi_3[6].b
