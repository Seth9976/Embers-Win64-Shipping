...
if (rdx u> 0x40)
    ...
    *(arg1 + 0xa00) = sub_140a84c80(rcx_3, sx.q(rdx) * 0x28, 0)
else if (rcx_3 != 0)
    memmove(arg1, rcx_3, (rsi * 0x28).d)
    rcx_3 = *(arg1 + 0xa00)
    
    if (rcx_3 != 0)
        *(arg1 + 0xa00) = sub_140a84c80(rcx_3, 0, 0)
