...
rax_3, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13 =
    sub_1416af1f0(arg1, arg2, arg3, arg4, var_258)
int32_t rsi_1

if (rax_3 != 0)
    int128_t var_1c8
    __builtin_memset(&var_1c8, 0, 0x18)
    float (* rsi_2)[0x4] = var_1c8:8.q
    int32_t i = 0
    float (* rbx_1)[0x4] = var_1c8.q
    int64_t* var_230
    int64_t var_1b8
    float zmm1_1[0x4]
    ...
    if (var_218.d s> 0)
        do
            ...
            rax_5, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13, arg5, arg6 =
                sub_141743d50(sx.q(i) * 0x38 + var_220, *r12, *r15)
            ...
            if (rax_5 != 0)
                ...
                if (var_1b8 == rsi_2)
                    sub_141701fc0(&var_1c8, rsi_2, &var_230)
                    rsi_2 = var_1c8:8.q
                    rbx_1 = var_1c8.q
                else
                    *rsi_2 = var_230.o
    ...
    label_1415830a9:
        zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm14, zmm15 =
            sub_14154a2a0(*arg1, *arg2, &var_130, arg7, arg8, var_178, arg10)
        rsi_1 = 1
    else
        zmm6 = 0x80000000
        ...
        while (true)
            if (rdx_5 s< 0x80)
                ...
                label_14158305a:
                    ...
                    arg5 = rdi_5[4]
                    arg6 = rdi_5[3]
                    float zmm5_1[0x4] = rdi_5[5]
                    arg6[0] = arg6[0] f* *rax_22
                    zmm5_1[0] = zmm5_1[0] f* rax_22[2]
                    arg5[0] = arg5[0] f* rax_22[1]
                    arg5[0] = arg5[0] f* rax_22[4]
                    arg5[0] = arg5[0] f* rax_22[7]
                    arg5[0] = arg5[0] + arg6[0]
                    arg6[0] = arg6[0] f* rax_22[3]
                    arg5[0] = arg5[0] + zmm5_1[0]
                    zmm5_1[0] = zmm5_1[0] f* rax_22[5]
                    arg5[0] = arg5[0] + arg6[0]
                    arg6[0] = arg6[0] f* rax_22[6]
                    arg5[0] = arg5[0] + zmm5_1[0]
                    zmm5_1[0] = zmm5_1[0] f* rax_22[8]
                    arg5[0] = arg5[0] + arg6[0]
                    bool cond:0_1 = arg5[0] < arg5[0]
                    arg5[0] = arg5[0] + zmm5_1[0]
                    int32_t r14_2
                    
                    if (not(cond:0_1) && not(arg5[0] < arg5[0]))
                        zmm12 = zx.o(*rax_22)
                        r14_2 = rax_22[2]
                    else if (arg5[0] < arg5[0] || arg5[0] < arg5[0])
                        zmm12 = zx.o(*(rax_22 + 0x18))
                        r14_2 = rax_22[8]
                    else
                        zmm12 = zx.o(*(rax_22 + 0xc))
                        r14_2 = rax_22[5]
                    
                    zmm7 = zmm5_1 ^ zmm6
                    uint64_t var_1f0_1 = zmm12.q
                    float zmm4_1[0x4] = arg5 ^ zmm6
                    int128_t* rax_23 = *arg4
                    zmm11 = arg6 ^ zmm6
                    zmm8 = *(rax_23 + 4)
                    zmm9 = *(rax_23 + 8)
                    ...
                    zmm3_1 = var_1f0_1:4.d
                    zmm3_1[0] = zmm3_1[0] - temp0_26[0]
                    float var_194_1 = temp0_26[0]
                    zmm0_1 = r14_2
                    zmm0_1[0] = zmm0_1[0] - temp0_27[0]
                    float var_190_1 = temp0_27[0]
                    float var_1e0 = zmm2_1[0]
                    zmm2_1[0] = zmm2_1[0] * arg6[0]
                    float var_1dc_1 = zmm3_1[0]
                    zmm3_1[0] = zmm3_1[0] * arg5[0]
                    float var_1d8_3 = zmm0_1[0]
                    zmm0_1[0] = zmm0_1[0] f* rdi_5[5]
                    zmm3_1[0] = zmm3_1[0] + zmm2_1[0]
                    zmm3_1[0] = zmm3_1[0] + zmm0_1[0]
                    zmm13[0] = zmm13[0] * 0.00999999978f
                    float temp0_28[0x4] = __minss_xmmss_memss(zmm3_1[0], var_204)
                    zmm0_1 = __andps_xmmxud_memxud(zmm13, data_142d3f770)
                    arg5 = temp0_28
                    temp0_28[0] = temp0_28[0] - zmm13[0]
                    var_204 = arg5[0]
                    
                    if (__andps_xmmxud_memxud(temp0_28, data_142d3f770)[0] <= zmm0_1[0])
                        zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm14, 
                            zmm15 = sub_14154a2a0(*r12, *r15, rdi_5, arg7, arg8, var_178, arg10)
                        rdi_1 = var_230
                        rsi_1 = 0
                        break
                    
                    if (not(arg5[0] < zmm13[0]))
                        int32_t rcx_14 = r12[1].d
                        ...
                        var_100_1:4.b = 0
                        int32_t var_200_1 = rcx_14
                        r12[1].d = rcx_14 + 1
                        
                        if (rcx_14 + 1 s> *(r12 + 0xc))
                            sub_14083a7e0(r12)
                            rcx_14 = var_200_1
                        
                        int64_t rcx_16 = sx.q(rcx_14) * 3
                        int64_t rax_38 = *r12
                        *(rax_38 + (rcx_16 << 2)) = zmm12.q
                        *(rax_38 + (rcx_16 << 2) + 8) = r14_2
                        ...
                        var_228_1.d = 0
                        *(rcx_18 + (rdx_11 << 2)) = var_198_1.q
                        *(rcx_18 + (rdx_11 << 2) + 8) = var_190_1
                        rdi_5[0xd].b = 1
                        
                        if (r13 s< 0 && r13 != 0)
                            sub_1405c5570(&var_230, 0)
                        
                        sub_1415c5980(&var_220, var_238_1, &var_1e0, &var_230)
                        int64_t r13_1 = sx.q(var_218.d)
                        int32_t r8_10 = var_228_1.d
                        int32_t rax_41 = r8_10 + r13_1.d
                        var_218.d = rax_41
                        ...
                        if (r8_10 s>= 3)
                            ...
                            if (r8_10 s> 0)
                                ...
                                int32_t var_1a0_1 = r11_7
                                
                                do
                                    int64_t* rdx_14 = var_230
                                    int64_t rcx_22 = var_220
                                    int64_t r12_1 = sx.q(rdx_14[rdi_6].d)
                                    int64_t r14_4 = sx.q(*(&rdx_14[rdi_6] + 4))
                                    ...
                                    *(r10_8 + (r14_4 << 2) + 0x28) = 0
                                    ...
                                    if (rax_54.b == 0)
                                        rbx_1 = var_1c8.q
                                        goto label_141583073
                                    
                                    zmm0_1 = r9_5[6]
                                    r15 = arg2
                                    r12 = arg1
                                    
                                    if (not(zmm0_1[0] < zmm13[0]) && not(zmm0_1[0] > arg5[0]))
                                        char rax_58
                                        rax_58, zmm13, arg5 = sub_141743d50(r9_5, *r12, *r15)
                                        
                                        if (rax_58 != 0)
                                            int32_t var_138_1 = rbx_2
                                            int64_t* var_140 = &var_220
                                            sub_14175ce20(&var_1c8, &var_140)
                            ...
                            zmm6 = 0x80000000
                            r13 = var_228_1:4.d
                            goto label_14158305a
            
        label_141583073:
            rdi_1 = var_230
            goto label_1415830a9
    ...
    if (rbx_1 != 0)
        ...
        if (((var_1b8 - rbx_1) & 0xfffffffffffffff0) u>= 0x1000)
            rbx_1 = *(rbx_1 - 8)
