...
sub_142b55100(&var_368, sub_142a45710(&var_f8, "@calendar=coptic", nullptr, nullptr, nullptr), 
    &var_378)
var_368 = &icu_64::CopticCalendar::`vftable'{for `icu_64::CECalendar'}
sub_142a45a20(&var_f8)

if (var_378 s<= 0)
    sub_142a6c1a0(&var_368, j_sub_142a4bbc0(), &var_378)
    sub_142a67700(&var_368, 1, 0xffffffb0, &var_378)
    data_143ccb130 = sub_142a6a540(&var_368, &var_378)
    data_143ccb138 = sub_142a695b0(&var_368, 1, &var_378)
