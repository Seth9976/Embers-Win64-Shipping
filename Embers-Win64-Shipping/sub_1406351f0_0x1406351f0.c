...
if (rcx_1 != 0 && rcx_1 u>= 8 && data_143ccb970 s>= 2)
    ...
    do
        i += 8
        zmm1 = _mm_min_epi32(zmm1, *rax_1)
        int32_t zmm0[0x4] = rax_1[1]
        rax_1 = &rax_1[2]
        zmm2 = _mm_min_epi32(zmm2, zmm0)
    while (i != (rcx_1 & 0xfffffffffffffff8))
    
    zmm1 = _mm_min_epi32(zmm1, zmm2)
    zmm1 = _mm_min_epi32(zmm1, _mm_bsrli_si128(zmm1, 8))
    rdx = _mm_min_epi32(zmm1, _mm_bsrli_si128(zmm1, 4)).d
