...
if (r12 s< *(arg2 + 0x14))
    do
        ...
        if (((rcx u>> 3).b & 1) == 0)
            ...
            if (rax_6 != 0)
                int16_t** rsi_3 = sx.q(*(r14_3 + 0xc)) + *(arg2 + 8)
                int32_t* r10_2 = sx.q(r14_3[2].d) + *arg2
                        ...
                        label_1422b2dd9:
                            ...
                            if ((*(r15_3 + 0x2c) & 1) != 0)
                                ...
                                if (not(test_bit(zx.q(rbx_5[8].d), 0xd)))
                                    ...
                                    label_1422b2f56:
                                        int64_t* r10_3 = *r14_3
                                        int64_t rdx_19 = sx.q(*(r14_3 + 0xc)) + *(arg_10 + 8)
                                        int64_t rcx_34 = sx.q(r14_3[2].d) + *arg_10
                                    ...
                                    label_1422b2e7f:
                                        void* i = (*(*rbx_5 + 0x140))(rbx_5, 
                                            sx.q(*(r14_3 + 0xc)) + *(arg_10 + 8))
                                        
                                        if (i == 0)
                                            goto label_1422b2f56
                ...
                int64_t* r15_5 = sx.q(*(r14_3 + 0xc)) + *(arg2 + 8)
                int64_t* rbx_2 = sx.q(r14_3[2].d) + *arg2
                int32_t rdx = r15_5[1].d
                r12.w = r14_3[1].w - 1
                
                if (rdx == rbx_2[1].d)
                    goto label_1422b2b2e
                ...
                label_1422b2b2e:
                    ...
                    if (r15_5[1].d s> 0)
                        do
                            ...
                            var_68 = rcx_3 + rbx_3
                            r13.b |= sub_1422b2a30(arg1, &var_68)
                            i_1 += 1
