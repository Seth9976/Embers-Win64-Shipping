...
label_140d1ef79:
    ...
    if (r8_7 s> 0 && (rax_16 == 0 || rax_16 s< rbp))
        ...
        *(arg4 + 0x6c) = rax_19
        ...
        arg4[0xd].d = *(rax_20 + (((sx.q(arg1[9].d) - 1) & r8_8) << 2))
        void* rax_22 = *(r9_3 + 8)
    ...
    label_140d1eeb7:
        ...
        while (true)
            int64_t* rdx_1 = sx.q(rbx_1) * 0x70
            
            if (*(rdx_1 + r8_3) == *arg4)
                break
            
            rbx_1 = *(rdx_1 + r8_3 + 0x68)
            
            if (rbx_1 == 0xffffffff)
                goto label_140d1eeb7
