...
if (result != 0 && arg2 != 0)
    ...
    void var_b8
    sub_1423fac90(&var_b8, &var_e8, r8_1, &var_cc, &var_d4, &var_dc, arg11)
    int64_t var_50_1 = _mm_unpacklo_ps(zx.o(0), arg15)
    int32_t var_e0_1 = 0
    int64_t var_44_1 = arg16
    int32_t var_48_1 = 0
    ...
    int32_t var_a4_1 = sub_142402aa0(arg12)
    int512_t zmm6_1
