    ...
    do
        ...
        if (rsi_1 s< arg2)
            do
                ...
                if (r10_1 s< arg2)
                    if ((*(arg1 + sx.q(r8_1.d) * 0xc)).d f> *(arg1 + sx.q(r10_1) * 0xc))
                        r10_1 = r8_1.d
                    
                    r8_1 = zx.q(r10_1)
                
                result = sx.q(r8_1.d)
                int32_t* r10_2 = arg1 + sx.q(r11_1.d) * 0xc
                uint64_t rcx_2 = result * 3
                int64_t* rdx_2 = arg1 + (rcx_2 << 2)
                
                if ((*(arg1 + (rcx_2 << 2))).d f<= *r10_2)
                    break
                
                if (r10_2 != rdx_2)
                    zmm1 = *r10_2
                    int32_t rcx_3 = r10_2[2]
                    *r10_2 = *rdx_2
                    r10_2[2] = rdx_2[1].d
                    *rdx_2 = zmm1
                    rdx_2[1].d = rcx_3
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if (r10_3 s< i)
                    if ((*(arg1 + sx.q(r8_2.d) * 0xc)).d f> *(arg1 + sx.q(r10_3) * 0xc))
                        r10_3 = r8_2.d
