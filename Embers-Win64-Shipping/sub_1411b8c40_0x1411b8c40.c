...
if (data_143e80410 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    arg5 = _Init_thread_header(&data_143e80410)
    
    if (data_143e80410 == 0xffffffff)
        void arg_10
        arg6 = sub_140b4c820(&arg_10, u"FHairStrandsVertexFactory")
        data_143e80408 = sub_1419cfe40(&arg_10)
        arg5 = _Init_thread_footer(&data_143e80410)

(*(*arg9 + 0x168))(arg9)
void* rax_4 = (*(*rbx + 0x40))(rbx)
int64_t* rcx_2 = *(arg2 + 0x78)
void* rbx_1 = data_143e80408
int64_t rdx = *rcx_2
...
if (*(result + 0x20) == *(rbx_1 + 0x20))
    ...
    void** rax_5
    int512_t zmm0
    rax_5, zmm0 = sub_142127800(arg9, &var_118, &data_143e7b2f0, rax_4, arg5)
    char var_1c0_2 = 1
    int32_t var_1c8_2 = 0
