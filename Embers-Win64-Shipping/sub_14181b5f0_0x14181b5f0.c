...
while (true)
    ...
    int32_t rdx_3 = ((i - r15_1) s/ 0x18).d + 1
    
    if (r12_1 == 0)
    label_14181b8c5:
        sub_14181a600(r15_1, rdx_3)
    else
        while (true)
            uint128_t zmm3
            
            if (rdx_3 s<= 8)
                for (; i u> r15_1; i -= 0x18)
                    int64_t* rsi_2 = r15_1
                    int64_t* r14_2 = r15_1 + 0x18
            ...
            void* rcx_5 = r15_1 + sx.q((temp1_1 - temp0_3) s>> 1) * 0x18
            
            if (rcx_5 != r15_1)
                zmm3 = *rcx_5
                zmm2 = zx.o(*(rcx_5 + 0x10))
                *rcx_5 = *r15_1
                *(rcx_5 + 0x10) = r15_1[1].q
                *r15_1 = zmm3
                r15_1[1].q = zmm2.q
            
            uint128_t* r14_1 = r15_1
            uint128_t* rsi_1 = i + 0x18
            ...
            if ((rsi_1 - r15_1 - 0x18) s/ 0x18 s< (i - r14_1) s/ 0x18)
                if (i u> r14_1)
                    *r13_1 = r14_1
                    r13_1[1] = i
                    r13_1[2].d = r12_1
            ...
            rdx_3 = ((i - r15_1) s/ 0x18).d + 1
            
            if (r12_1 == 0)
                goto label_14181b8c5
