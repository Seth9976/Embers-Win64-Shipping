...
void* rbx_2 = *arg1
sub_140f9bdd0(rbx_2 + 0x390, arg3 + 0x1a0)

if (*(arg3 + 0x1d8) != 0)
    int64_t* rcx_14 = *(arg3 + 0x1d0)
    ...
    if (rcx_14 != 0 && (*(*rcx_14 + 0x28))(rcx_14) != 0)
        ...
        *(arg3 + 0x1c8) = (*(*rcx_15 + 0x48))(rcx_15)

*(rbx_2 + 0x3b8) = *(arg3 + 0x1c8)

if (*(arg3 + 0x1f0) != 0)
    int64_t* rcx_16 = *(arg3 + 0x1e8)
    
    if (rcx_16 != 0 && (*(*rcx_16 + 0x28))(rcx_16) != 0)
        if (*(arg3 + 0x1f0) != 0)
            r14 = *(arg3 + 0x1e8)
        
        *(arg3 + 0x1e0) = (*(*r14 + 0x48))(r14)

*(rbx_2 + 0x3bc) = *(arg3 + 0x1e0)
int64_t* rbx_3 = *arg1
int32_t rax_28

if ((rbx_3[5].b & 0x20) == 0)
    rax_28 = (*(*rbx_3 + 0x220))(rbx_3)

if ((rbx_3[5].b & 0x20) != 0 || rax_28.b != 0)
    rax_28.b = 0x40
