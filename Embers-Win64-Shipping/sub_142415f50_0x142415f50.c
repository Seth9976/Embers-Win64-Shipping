...
label_14241620c:
    ...
    while (true)
        ...
        if (result.d == (var_88_3.q u>> 0x20).d && var_68_1.q == arg1 + 0x270
                && rcx_7 == arg1 + 0x260)
            goto label_14241620c
        
        int64_t* rbx_3 = result * 0xf0 + *rcx_7
        
        if (sub_140d6de40(rbx_3) == 0 && sub_140d6df40(rbx_3).b == 0 && (*(rbx_3 + 0x34) & 1) != 0)
            int64_t* rbx_4 = r15[2]
