...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        int32_t* rbx_3 = (sx.q(i) << 5) + *var_58
        sub_1409ac860(arg1, rbx_3, zmm1)
        (*(*arg1 + 0x130))(arg1, &rbx_3[4])
        int32_t var_4c
...
do
    ...
    *r8_7 |= 1 << (rdi_1.b & 0x1f)
    int64_t rdx_17 = (sx.q(rdi_1.d) << 5) + *arg2
    __builtin_memset(rdx_17, 0, 0x18)
    *(rdx_17 + 0x18) = 0xffffffff
    sub_1409ac860(arg1, rdx_17, arg3)
    (*(*arg1 + 0x130))(arg1, rdx_17 + 0x10)
    r15 += 1
while (r15 s< arg_8)
