...
if (arg3 != 0 || ((arg2[5].b & 2) != 0 && arg2[0xe] == 0) || (*(arg2 + 0x29) & 0x20) != 0)
    return sub_14213a180(arg2, arg1, arg4)

int64_t r9_1 = *arg2
(*(r9_1 + 8))(arg2, sx.q(arg1[1].d) * 0x24, sx.q(*(arg1 + 0xc)) * 0x24, r9_1)
...
if ((result & 1) == 0)
    ...
    int64_t r9_2 = *arg2
    return (*(r9_2 + 0x150))(arg2, rdx_14, sx.q(arg_18 * arg_10), r9_2)
...
if (rdx_7 != rcx_5)
    sub_142152f20(arg1, rcx_5)
    rdx_7 = *(arg1 + 0xc)
    rcx_5 = arg_18
    rsi_1 = arg1[1].d

int32_t rax_8 = rsi_1 + rcx_5
arg1[1].d = rax_8

if (rax_8 s> rdx_7)
    sub_142152cc0(arg1, rsi_1)
    rcx_5 = arg_18
