...
if (data_143e8ac10 s> *rdi_1)
    _Init_thread_header(&data_143e8ac10)
    
    if (data_143e8ac10 == 0xffffffff)
        ...
        data_143e8ac08 = rax_9
        _Init_thread_footer(&data_143e8ac10)

if (data_143e8ac20 s> *rdi_1)
    _Init_thread_header(&data_143e8ac20)
    
    if (data_143e8ac20 == 0xffffffff)
        ...
        data_143e8ac18 = rax_12
        _Init_thread_footer(&data_143e8ac20)

if (data_143e8ac30 s> *rdi_1)
    _Init_thread_header(&data_143e8ac30)
    
    if (data_143e8ac30 == 0xffffffff)
        ...
        data_143e8ac28 = rax_15
        _Init_thread_footer(&data_143e8ac30)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ac08
int64_t rcx
...
label_1412a2333:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412a232e
        
        rbx.b = 1
        goto label_1412a2333
