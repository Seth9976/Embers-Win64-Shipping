...
while (true)
    ...
    zmm1 = var_2c4
    float temp0_25[0x4] = _mm_add_ps(temp0_22, temp0_12)
    zmm5 = var_2c8_1
    ...
    *(&var_1a8:4 + (sx.q(i_6) << 2)) = i_6
    ...
    zmm15[0] = zmm15[0] - temp0_32[0]
    int32_t i_7 = rdx_1.d + 1
    *(&var_178 + (rcx_5 << 2)) = (_mm_unpacklo_ps(zmm5, zmm15[0].q)).q
    (&var_170)[rcx_5] = var_1f8_1
    *(&var_148 + (rcx_5 << 2)) = (_mm_unpacklo_ps(temp0_30, temp0_32[0].q)).q
    (&var_140)[rcx_5] = var_1e8_1
    int64_t var_118
    *(&var_118 + (rcx_5 << 2)) = (_mm_unpacklo_ps(zmm5, zmm15[0].q)).q
    int32_t var_110
    ...
    if (rdx_1.d == 0)
        ...
        label_141601a14:
            ...
            if (rdx_1.d == 2)
                rax_21, zmm9, zmm13, zmm14, zmm15 =
                    sub_1416fa750(&var_290, &var_118, &var_1a8, &var_188)
                goto label_141601a14
...
if (zmm1[0] <= zmm8[0])
    ...
    float zmm9_1[0x4]
    float zmm13_1[0x4]
    rax_35, zmm8_1, zmm9_1, zmm13_1 = sub_141568140(&var_290, &var_2a0, &var_238, &var_230, zmm14, 
        zmm15, &var_2c4, &var_2c0, &var_278, &var_248)
    float zmm2_1[0x4]
