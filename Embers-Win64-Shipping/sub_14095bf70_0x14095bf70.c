...
label_14095c097:
    ...
    if (r8_2 s> 0 && (rax_11 == 0 || rax_11 s< rbp))
        ...
        *(arg4 + 0x28) = *(rax_15 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2))
        void* rax_17 = *(r9_1 + 8)
    ...
    label_14095c006:
        ...
        while (true)
            int64_t rdi_2 = sx.q(rbx_1) * 0x30
            
            if (sub_14094dfb0(rcx_1 + rdi_2, arg4) != 0)
                break
            
            rcx_1 = *arg1
            rbx_1 = *(rdi_2 + rcx_1 + 0x28)
            
            if (rbx_1 == 0xffffffff)
                goto label_14095c006
