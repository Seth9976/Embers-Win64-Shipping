...
int16_t* rcx = rax + (r10_1 << 3)

if (rcx != 0)
    int16_t* r8_3 = (zx.q(*(arg1 + 0x34)) << 4) + rax
    *rcx = *r8_3
    *(rcx + 8) = *(r8_3 + 8)

int64_t rdx = *(arg1 + 0x10)
*(rdx + (r11 << 2)) = *(rdx + (zx.q(*(arg1 + 0x34)) << 2))
uint32_t rcx_2 = zx.d(*(*(arg1 + 8) + (r10_1 << 3)))
int32_t r10_2 = *(arg1 + 0x34)
...
int64_t rax_17 = *(arg1 + 0x18)
uint64_t rdx_4 = (zx.q(rax_16.d) u>> 0x10 ^ rax_16) & zx.q(*(arg1 + 0x24) - 1)
