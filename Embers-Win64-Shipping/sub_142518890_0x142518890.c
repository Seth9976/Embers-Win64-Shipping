...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_7[4]
    sub_140d30490(arg2, &var_16c, r8_7)
else
    sub_140d30460(arg2, *(arg2 + 0x18), &var_16c)
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_21[4]
    sub_140d30490(arg2, &var_178, r8_21)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_27[4]
    r9 = sub_140d30490(arg2, &var_174, r8_27)
else
    r9 = sub_140d30460(arg2, *(arg2 + 0x18), &var_174)
...
int32_t var_1c8 = var_170.d
*(arg2 + 0x20) = rdi + rax_17
var_d8 = zmm1
char result = sub_1420b59e0(rcx_16, &var_118, &var_128, r9, var_1c8, rcx_15, r12.b, r14, rax_20)
int64_t rcx_17 = var_160
*arg3 = result
