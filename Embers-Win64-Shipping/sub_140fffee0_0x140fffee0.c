...
if (rdx_1 != 0)
    ...
    if (rdi != 0)
        ...
        while (true)
            ...
            void*** rax_3
            rax_3, arg5 = j_sub_140a82f30(0x170)
            
            if (rax_3 == 0)
                rbx = 0
            else
                rbx = sub_14100d760(rax_3, rsi_1, arg6, rbx.d, arg8)
            
            *(rbx + 0xd8) = arg4
            
            if (*(rsi_1 + 0x18) != var_1c4)
                arg5 = sub_141059540(rsi_1, rbx + 0x70, var_1b8_1 + 0x70, arg5)
            else
                (*(*arg_8 + 0x10))(arg_8, rsi_1, arg3, zx.q(count), arg8, arg9, arg4, rbx + 0xe0, 
                    rbx + 0x70)
                var_1b8_1 = rbx
    ...
    while (true)
        ...
        void*** rax_15
        rax_15, arg5 = j_sub_140a82f30(0x170)
        
        if (rax_15 == 0)
            rbx = 0
        else
            rbx = sub_14100d760(rax_15, r14_2, arg6, rbx.d, arg8)
        
        *(rbx + 0xd8) = arg4
        (*(*arg_8 + 0x10))(arg_8, r14_2, arg3, zx.q(count), arg8, arg9, arg4, rbx + 0xe0, 
            rbx + 0x70)
...
if (rcx_37 != 0)
    if (rdx_1 == 0 && *(result + 0x78) != rdx_1)
        ...
        void* var_168
        sub_14103f450(&var_168, *(result + 0x30))
        ...
        if (rbx.b != 0)
            ...
            if (sub_140a80f40() == 0)
                ...
                if (data_143f138f4 != 0 || (data_143de5480 != 0 && rax_35.b == 0))
                    void var_68
                    int64_t* rax_36 = sub_14101b8e0(&var_68, nullptr, 0xff)
                    void* rcx_26 = *rax_36
                    ...
                    *(rcx_26 + 0x20) = count.q
                    ...
                    zmm0_3 = sub_1410104a0(&var_188, &data_143f02b98, zmm0_2)
            else
                zmm0_3 = sub_1410104a0(&result_1, &data_143f02b98, zmm0_2)
        else if (arg2 == 0)
            void* rdx_16 = var_168
            void** const var_f8 = &data_142f00038
            int64_t var_f0_1 = 0
            ...
            zmm0_3 = j_sub_141059a80(&var_e0, sub_1410205c0(&var_f8))
        else
