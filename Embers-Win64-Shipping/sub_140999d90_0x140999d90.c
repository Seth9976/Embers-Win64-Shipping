...
if (rdx_2 != rbx)
    ...
    label_140999f02:
        ...
        while (true)
            ...
            if (rdx_6 != 0)
                goto label_140999f02
        
        var_74.d = rbx

uint32_t rbx_2 = (var_78_1.q u>> 0x20).d

while (true)
    int64_t rax_20 = sx.q(var_58:0xc.d)
    int64_t* rdx_7 = result_1.q
    
    if (rax_20.d == rbx_2 && var_58.q == arg1 + 0x10 && rdx_7 == arg1)
        return result
    
    result = *arg2
    int64_t* rcx_9 = *rdx_7 + rax_20 * 0x18
    void* r8_3 = rcx_9[1]
    var_88.o = result
    var_78_1.q = arg2[1].q
    (&data_142e40ad8)[zx.q(*(r8_3 + 8))](*rcx_9, &var_88, r8_3)
    int32_t var_5c
