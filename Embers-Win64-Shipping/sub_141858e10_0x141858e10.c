...
if (arg2 s>= 0)
    if (arg2 s<= 1)
        ...
        *(r12_1 + 0x68) = rax_38
        void* rcx_29 = *rax_37
        int64_t* rsi_3 = *(rcx_29 + 0x78)
        
        if (rsi_3 != 0)
            rsi_3[9].d += 1
        
        sub_1405ff810(rcx_29, rax_37[1], rax_37[2].d, 1)
        ...
        if (rax_18 == 0)
            int128_t* rcx_21 = &var_68
            
            if (var_78 != 0)
                rcx_21 = var_78
            
            var_88((*(*rcx_21 + 8))(rcx_21))
            *(r14 + 0x80) = 0
...
if (*r13 != 0)
    ...
    int64_t rdx_9 = *rcx_35
    (*(rdx_9 + 0x10))(rcx_35, rdx_9)
