...
rax_3, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm14, zmm15 =
    sub_1416cfd30(arg1, arg2, arg3, arg4, var_278)
int32_t rdi_1
...
if (rax_3 != 0)
    ...
    label_1415aadb0:
        zmm6_2, zmm7_1, zmm8_1, zmm9_1, zmm10_2, zmm11_2, zmm12_2, zmm14_2, zmm15_2 =
            sub_14154a2a0(*arg1, *arg2, &var_130, var_1a8, arg6, var_1b8, arg8)
        rdi_1 = 1
    else
        ...
        while (true)
            if (rdx_5 s< 0x80)
                ...
                label_1415aad60:
                    ...
                    void* rax_22 = *r13
                    zmm7 = rsi_5[5]
                    int32_t r13_2 = *(rax_22 + 0x18)
                    zmm1_1 = rsi_5[4] ^ zmm2_1
                    *(rax_22 + 0x10)
                    float var_1a0 = (rsi_5[3] ^ zmm2_1)[0]
                    float var_19c_1 = zmm1_1[0]
                    float var_198_1 = (zmm7 ^ zmm2_1)[0]
                    float var_140[0x4]
                    float* rax_23
                    int32_t zmm6_1
                    ...
                    int32_t zmm14_1
                    int32_t zmm15_1
                    rax_23, zmm6_1, zmm7, zmm8, zmm9, zmm11_1, zmm13_1, zmm14_1, zmm15_1 =
                        sub_141716230(arg4, &var_140, &var_1a0)
                    uint128_t zmm12_1 = rsi_5[6]
                    uint128_t zmm2_2 = _mm_shuffle_ps(zmm9, zmm9, 0x55)
                    float zmm10_1[0x4] = zx.o(*rax_23)
                    ...
                    zmm0_2.d = r13_2.d f- rax_24
                    int32_t var_190 = zmm1_2.d
                    zmm1_2.d = zmm1_2.d f* zmm8[0]
                    int32_t var_18c_1 = zmm2_2.d
                    zmm2_2.d = zmm2_2.d f* zmm6_1
                    int32_t var_188_1 = zmm0_2.d
                    ...
                    if (_mm_and_ps(zmm1_2, zmm11_1).d f<= zmm0_2.d)
                        zmm6_2, zmm7_1, zmm8_1, zmm9_1, zmm10_2, zmm11_2, zmm12_2, zmm14_2, 
                            zmm15_2 = sub_14154a2a0(*r14, *r12, rsi_5, var_1a8, arg6, var_1b8, arg8)
                        rsi_1 = var_250
                        rdi_1 = 0
                        break
                    
                    if (not(zmm13_1 f< zmm12_1.d))
                        int32_t rcx_14 = r14[1].d
                        ...
                        var_100_1:4.b = r10_7
                        int32_t var_218_1 = rcx_14
                        r14[1].d = rcx_14 + 1
                        
                        if (rcx_14 + 1 s> *(r14 + 0xc))
                            sub_14083a7e0(r14)
                            rcx_14 = var_218_1
                        
                        int64_t rcx_16 = sx.q(rcx_14) * 3
                        int64_t rax_37 = *r14
                        *(rax_37 + (rcx_16 << 2)) = zmm9.q
                        *(rax_37 + (rcx_16 << 2) + 8) = r13_2
                        ...
                        *(rax_39 + (rcx_18 << 2) + 8) = rax_24
                        ...
                        sub_1415c5980(&var_240, var_258_1, &var_190, &var_250)
                        ...
                        if (r8_11 s>= 3)
                            ...
                            if (r8_11 s<= 0)
                                ...
                                do
                                    ...
                                    int64_t r10_9 = r15_1 * 0x38 + rcx_22
                                    ...
                                    if (rbx_2 s<= r13_3.d)
                                        rax_46 = r8_11 + r13_3.d
                                    
                                    int32_t rax_48 = *(r10_9 + (r14_2 << 2))
                                    int64_t rdx_20 = *arg1
                                    int64_t rax_50 =
                                        sx.q(*(r10_9 + (sx.q((r14_2 + 1).d s% 3) << 2)))
                                    int32_t var_230_2 = rax_50.d
                                    int64_t rcx_25 = rax_50 * 3
                                    zmm7 = *(rdx_20 + (rcx_25 << 2))
                                    zmm7[0] = zmm7[0] f- *(r8_12 + (rcx_25 << 2))
                                    zmm6 = *(rdx_20 + (rcx_25 << 2) + 4)
                                    zmm6[0] = zmm6[0] f- *(r8_12 + (rcx_25 << 2) + 4)
                                    zmm8 = *(rdx_20 + (rcx_25 << 2) + 8)
                                    zmm8[0] = zmm8[0] f- *(r8_12 + (rcx_25 << 2) + 8)
                                    int64_t rcx_26 = sx.q(rax_48) * 3
                                    zmm2_1 = *(rdx_20 + (rcx_26 << 2) + 8)
                                    zmm2_1[0] = zmm2_1[0] f- *(r8_12 + (rcx_26 << 2) + 8)
                                    float zmm5_1[0x4] = *(rdx_20 + (rcx_26 << 2))
                                    zmm9.d = (*(rdx_20 + (rcx_16 << 2) + 4)).d f-
                                        *(r8_12 + (rcx_16 << 2) + 4)
                                    zmm1_1 = *(rdx_20 + (rcx_16 << 2) + 8)
                                    zmm1_1[0] = zmm1_1[0] f- *(r8_12 + (rcx_16 << 2) + 8)
                                    uint32_t zmm3_1[0x4] = *(rdx_20 + (rcx_16 << 2))
                                    zmm2_1[0] = zmm2_1[0] f- zmm8[0]
                                    zmm3_1[0] = zmm3_1[0] f- *(r8_12 + (rcx_16 << 2))
                                    float zmm4_1 = *(rdx_20 + (rcx_26 << 2) + 4)
                                    ...
                                    if (zmm11_1[0] f!= 1f)
                                        if (zmm11_1[0] f>= zmm14_1)
                                            ...
                                            var_22c_1 = temp0_11[0]
                                            zmm1_1[0] = zmm1_1[0] f* zmm11_1[0]
                                            var_224_1 = temp0_11[0]
                                        else
                            ...
                            zmm2_1 = 0x80000000
                            r15 = var_248_1:4.d
                            goto label_1415aad60
            
        label_1415aad79:
            rsi_1 = var_250
            goto label_1415aadb0
