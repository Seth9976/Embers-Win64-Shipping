...
if (data_143f2a848 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143f2a848)
    
    if (data_143f2a848 == 0xffffffff)
        sub_140b58170(&data_143f2a840, "IntegralCurve", 1)
        _Init_thread_footer(&data_143f2a848)

int32_t rcx
rcx.b = *(arg2 + 0xc) == 0
int64_t result

if ((rcx.b & sub_140b5b8a0(*(arg2 + 8), 0xa).b) == 0 || *(arg2 + 0x1c) != data_143f2a840)
    result.b = 0
else
    ...
    if (rdx_1 s> *(arg1 + 0x2c))
        sub_1405dadb0(arg1 + 0x20, rdx_1)
    
    int64_t var_138
    int128_t zmm6_1
    uint128_t zmm7_1
    zmm6_1, zmm7_1 = sub_141a514d0(&var_138)
    int64_t* var_110
    ...
    while (true)
        ...
        var_138 = rdi_1
        uint128_t zmm0_1 = sub_140b21100(&var_138)
        uint128_t zmm0_2 = sub_140b21100(&var_138) ^ -0x8000000000000000
        
        if (not(zmm6_1.q f< zmm0_2.q))
            zmm0_2 = _mm_min_sd(zmm0_1.q, zmm6_1.q)
        
        int64_t* rax_8 = var_110
        uint128_t zmm1_1 = _mm_cvtepi32_pd(zx.q(var_138.d))
        int32_t r13_1 = *(*rax_8 + (sx.q(var_108) << 3) + 4)
        zmm1_1.q = zmm1_1.q f* zmm0_2.q
        zmm1_1.q = zmm1_1.q f/ _mm_cvtepi32_pd(zx.q(var_138:4.d)).q
        ...
        label_141a67d9b:
            ...
            *(*(arg1 + 0x20) + (rbx_3 << 2)) = r13_1
        else
            int32_t* rcx_12 = *(arg1 + 8)
            
            if (rbx_1 s>= *(rcx_12 + r14_1))
                ...
                *(arg1 + 0x10) = rax_12
                ...
                rcx_12[r14_2] = rbx_1
                goto label_141a67d9b
            
            int32_t r13_2 = var_120_1
            int64_t r14_3 = r12_1
            
            if (r12_1 s>= 0)
                void* rax_15 = r14_1 - 4 + rcx_12
                int64_t temp0_7
                
                do
                    if (rbx_1 s>= *rax_15)
                        sub_141a54e70(arg1 + 8, &var_128, r13_2 + 1)
                        ...
                        *(arg1 + 0x28) = r12_2 + 1
                        ...
                        int64_t rdx_8 = *(arg1 + 0x20) + (sx.q(r13_2 + 1) << 2)
                        memmove(rdx_8 + 4, rdx_8, (r12_2 - (r13_2 + 1)) << 2)
                        r12_1 = var_100_1
                        *(*(arg1 + 0x20) + (r14_3 << 2) + 4) = r13_1
                        break
            ...
            if (r13_2 s< 0)
                ...
                *(arg1 + 0x10) = rax_19
                ...
                memmove(rdx_10 + 4, rdx_10, (r14_4 << 2).d)
                **(arg1 + 8) = rbx_1
                int64_t rbx_2 = sx.q(*(arg1 + 0x28))
                int32_t rax_21 = (rbx_2 + 1).d
                *(arg1 + 0x28) = rax_21
                
                if (rax_21 s> *(arg1 + 0x2c))
                    sub_1405a4cf0(arg1 + 0x20)
                
                int64_t rdx_12 = *(arg1 + 0x20)
                memmove(rdx_12 + 4, rdx_12, (rbx_2 << 2).d)
                **(arg1 + 0x20) = r13_1
