...
if ((arg1[5].b & 1) == 0)
    ...
    if (rax_7 s> 0)
        do
            int32_t* rdx_8 = *arg2 + sx.q(i) * 0x18
            sub_14152dda0(sub_14152dda0(arg1, rdx_8, arg3), &rdx_8[3], arg3)
            i += 1
        while (i s< arg2[1].d)
...
if (rax_7 s> 0)
    do
        ...
        int32_t* rdx_6 = *arg2 + rbx_1 * 0x18
        
        if (rdx_6 == 0)
            rdx_6 = nullptr
        else
            __builtin_memcpy(rdx_6, 
                "\xff\xff\x7f\x7f\xff\xff\x7f\x7f\xff\xff\x7f\x7f\xff\xff\x7f\xff\xff\xff\x7f\xff\xff\x"
            "ff\x7f\xff", 
                0x18)
        
        sub_14152dda0(sub_14152dda0(arg1, rdx_6, arg3), &rdx_6[3], arg3)
        r14 += 1
    while (r14 s< arg_8)
