...
void var_78
int64_t* rax_2 = sub_140d44c30(arg1 + 0x38, &var_78, 1)
void var_a0
char* var_88
char** rax_4 = sub_140a96390(&var_88, _vfprintf_p_l(&var_a0, u"Pointer({0}, {1})", u"Events"))
int32_t var_60 = 4
int64_t rax_5 = *rax_2
