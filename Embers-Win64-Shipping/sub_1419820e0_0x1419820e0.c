...
while (true)
    void* r11_2 = sx.q(r14) * 0x78 + *rbx
    int64_t rcx_4 = *(r11_2 + 0x60)
    int64_t rdx_6 = *(r11_2 + 0x58)
    int64_t r8_7 = *(r11_2 + 0x50)
    int64_t r9_3 = *(r11_2 + 0x48)
    int32_t r10_6 = ((rcx_4 u>> 0x20).d * 0x17 + rcx_4.d) ^ ((rdx_6 u>> 0x20).d * 0x17 + rdx_6.d)
        ^ ((r8_7 u>> 0x20).d * 0x17 + r8_7.d) ^ ((r9_3 u>> 0x20).d * 0x17 + r9_3.d)
    int32_t r10_9 = (r10_6 ^ zx.d(*(r11_2 + 4)) ^ *r11_2) & (*rsi - 1)
    void* rax_24 = arg1 + 0x38
    *(r11_2 + 0x74) = r10_9
    void* rdx_7 = *(arg1 + 0x40)
    int64_t r8_8 = sx.q(r10_9)
    
    if (rdx_7 != 0)
        rax_24 = rdx_7
    
    *(r11_2 + 0x70) = *(rax_24 + (((sx.q(*rsi) - 1) & r8_8) << 2))
    void* rax_26 = arg1 + 0x38
    void* rcx_14 = *(arg1 + 0x40)
    
    if (rcx_14 != 0)
        rax_26 = rcx_14
    
    *(rax_26 + (((sx.q(*rsi) - 1) & r8_8) << 2)) = r14
