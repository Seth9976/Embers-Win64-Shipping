...
if (rbx != 0)
    ...
    label_140b913ea:
        ...
        while (true)
            ...
            if (rcx != 0)
                goto label_140b913ea
        
        var_74.d = rbx

int32_t rdx_3 = *(arg1 + 0x28)
int128_t var_28 = 0xffffffff
int32_t r14 = 0xffffffff << (rdx_3.b & 0x1f)
...
if (rdx_3 != rbx)
    ...
    int32_t rdx_7 = *(r10_2 + (sx.q(r8_2) << 2)) & r14
...
while (true)
    ...
    if (rcx_8.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x10 && result == arg1)
        return result
    
    void* rbx_1 = *(*result + rcx_8 * 0x10)
    
    if (rbx_1 != 0)
        sub_140b9bd00(rbx_1, 0x83400)
        int32_t rax_21 = *(rbx_1 + 0xc)
        void* const rax_25
        
        if (rax_21 s>= data_143e1d9b4)
            rax_25 = nullptr
        else
            uint32_t rdx_8 = zx.d(rax_21.w)
            
            if (rax_21 s< 0)
                rax_21 += 0xffff
                rdx_8 -= 0x10000
            
            rax_25 = *(data_143e1d9a0 + (sx.q(rax_21 s>> 0x10) << 3)) + sx.q(rdx_8) * 0x18
        
        if ((*(rax_25 + 0xb) & 1) != 0)
            sub_140d1e720(&data_143e1d678, rbx_1)
