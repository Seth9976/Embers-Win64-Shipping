...
if (data_143e8d208 s> *rdi_1)
    _Init_thread_header(&data_143e8d208)
    
    if (data_143e8d208 == 0xffffffff)
        ...
        data_143e8d200 = rax_9
        _Init_thread_footer(&data_143e8d208)

if (data_143e8d228 s> *rdi_1)
    _Init_thread_header(&data_143e8d228)
    
    if (data_143e8d228 == 0xffffffff)
        ...
        data_143e8d220 = rax_12
        _Init_thread_footer(&data_143e8d228)

if (data_143e8d248 s> *rdi_1)
    _Init_thread_header(&data_143e8d248)
    
    if (data_143e8d248 == 0xffffffff)
        ...
        data_143e8d240 = rax_15
        _Init_thread_footer(&data_143e8d248)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d200
int64_t rcx
...
label_14129a673:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_14129a66e
        
        rbx.b = 1
        goto label_14129a673
