...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_3[4]
    sub_140d30490(arg2, &var_1a8, r8_3)
else
...
rdi.b = rax_5 != 0
*(arg2 + 0x20) = rdi + rax_5
char* result = sub_1406ce990(&var_198, &var_1a8, r8_6, arg3)
int64_t var_90
