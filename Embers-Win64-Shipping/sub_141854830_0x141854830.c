...
if (rdx_7 != r10)
    ...
    int32_t rdx_11 = r11_1[sx.q(r8_6)] & rsi
...
while (true)
    ...
    int128_t* rbx_7 = *rdx_12 + rcx_12 * 0x18
    sub_140598750(arg1, &var_98)
    *(arg2 + 0x10) = *rbx_7
    *(arg2 + 0x20) = 0xffffffff
    void arg_8
    sub_14093ebb0(arg1, &arg_8, sub_140a6b260(arg2 + 0x10, 0x10), arg2 + 0x10, var_98, nullptr)
