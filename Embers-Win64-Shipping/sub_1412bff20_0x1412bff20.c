...
if (data_143e8b6b8 s> *rdi_1)
    _Init_thread_header(&data_143e8b6b8)
    
    if (data_143e8b6b8 == 0xffffffff)
        ...
        data_143e8b6a8 = rax_9
        _Init_thread_footer(&data_143e8b6b8)

if (data_143e8b6d0 s> *rdi_1)
    _Init_thread_header(&data_143e8b6d0)
    
    if (data_143e8b6d0 == 0xffffffff)
        ...
        data_143e8b6c0 = rax_12
        _Init_thread_footer(&data_143e8b6d0)

if (data_143e8b6e8 s> *rdi_1)
    _Init_thread_header(&data_143e8b6e8)
    
    if (data_143e8b6e8 == 0xffffffff)
        ...
        data_143e8b6d8 = rax_15
        _Init_thread_footer(&data_143e8b6e8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b6a8
int64_t rcx
...
label_1412c0023:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412c001e
        
        rbx.b = 1
        goto label_1412c0023
