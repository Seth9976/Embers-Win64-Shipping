                    ...
                    if (rdi_4 != 0)
                        ...
                        if (rax_26 != 0)
                            ...
                            if (rdi_4 != 0)
                                ...
                                zmm4[0] = zmm4[0] + zmm3[0]
                                zmm9 = _mm_max_ss(
                                    _mm_max_ss(_mm_max_ss(zmm4[0], zmm3[0])[0], zmm4[0])[0], 
                                    zmm6[0])
                                zmm9[0] = zmm9[0] - 0.100000001f
                                
                                if (zmm9[0] >= zmm13[0] || zmm9[0] f< *arg4)
                                label_140d8cd6c:
                                    rcx_8 = var_1d0_1
                                label_140d8cd71:
                                    rdi_4[1].d -= 1
                                    ...
                                    if (_mm_min_ss(
                                            _mm_min_ss(_mm_min_ss(zmm4[0], zmm3[0])[0], zmm4[0])[
                                                0], 
                                            zmm6[0])[0] f> *(arg4 + 8))
                                        goto label_140d8cd6c
                                    
                                    if (_mm_max_ss(
                                            _mm_max_ss(_mm_max_ss(zmm4[0], zmm3[0])[0], zmm4[0])[
                                                0], 
                                            zmm5.d)[0] f< *(arg4 + 4))
                                        goto label_140d8cd6c
                                    ...
                                    label_140d8cbf2:
                                        ...
                                        if (zmm11[0] < zmm9[0])
                                            goto label_140d8cbf2
                                    
                                    rdi_4[1].d -= 1
                                    
                                    if (rdi_4[1].d == 1)
                                        goto label_140d8cd7d
