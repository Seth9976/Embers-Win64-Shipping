...
if (result == 0 || arg2 == 0xff)
    ...
    if (arg2 u< rcx)
        ...
        if (rcx_3 == 0)
            ...
            rbp = sub_1426b21a0(rcx_3, arg2)
    else
        rbp = *(result + 0x38) + (zx.q(arg2) - zx.q(rcx)) * 0x18
...
label_1426a5b85:
    ...
    if (rbx_1 == 0)
        goto label_1426a5b85
    
    if (*(rbx_1 + 0x10) != sub_14272e7f0())
        goto label_1426a5b85
    
    void* r9_1 = rbp[1]
    uint8_t rcx_4 = *(r9_1 + 0x2b) u>> 1 & 1
    uint32_t rax_3
    ...
    uint64_t r15_1 = zx.q(rcx_4) << 2
    
    if (rdx_3 == neg.q(r15_1))
        goto label_1426a5b85
    
    if (rcx_4 != 0)
        r9_1 = *(*(arg1 + 0xe8) + (r8 << 3))
    
    if (sub_1426bf410(r9_1, rdx_3 + r15_1, arg3).b != 0)
        ...
        if ((*(*(arg1 + 0xc0) + 0x48) & 1) != 0)
            ...
            label_1426a596a:
                ...
                while (true)
                    ...
                    int64_t rcx_12 = sx.q(r9_2.d) * 3
                    void* rax_13 = sub_140d3c6e0(**(r8_4 + (rcx_12 << 3))
                        + ((sx.q(*(r8_4 + (rcx_12 << 3) + 0x10)) * 3 + 1) << 3))
                    
                    if (rax_13 != 0 && sub_1426bf730(arg1, rax_13) != 0)
                        void* rcx_17 = *(rax_13 + 0xc0)
                        char rdi
                        
                        if (rcx_17 == 0)
                            rdi = 0xff
                        else
                            rdi = sub_1426b2260(rcx_17, rbp)
                        ...
                        if (rax_16 != 0xff)
                            ...
                            if (*(rax_13 + 0xd0) == 0 || rax_18.b == 0)
                                ...
                                rdx_14 =
                                    zx.q(*(*(rax_13 + 0xd8) + (zx.q(rdi) << 1))) + *(rax_13 + 0xc8)
                            
                            sub_1426bf410(r9_3, rdx_14 + r15_1, arg3)
                    ...
                    int64_t rcx_22 = sx.q(var_108) * 3
                    int32_t i = *(rdx_17 + (rcx_22 << 3) + 0x14)
                    *(rdx_17 + (rcx_22 << 3) + 0x10) = i
                    void* rbx_5 = rdx_17 + (rcx_22 << 3)
                    ...
                    if (i != 0xffffffff)
                        ...
                        do
                            ...
                            *(rbx_5 + 0x14) = *(*r8_6 + sx.q(i) * 0x18 + 0x10)
                            int64_t var_118 = rax_23
                            int64_t var_110 = *(*r8_6 + sx.q(i_1) * 0x18)
