...
if (*(arg1 + 0x158) == 0)
    int64_t* rax_2 = sub_142a6d740(2, &arg1->__offset(0x8).q)
    ...
    if (arg1 + 0x158 != &var_190)
        *(arg1 + 0x158) = rcx_2
        var_190 = nullptr
        sub_1405aeff0(arg1 + 0x160, &var_188)
        rcx_7 = var_188
...
int64_t* rbx_6 = rdi->__offset(0x160).q
int64_t* rax_23 = rdi->__offset(0x158).q
...
label_140a7ceec:
    ...
    if (arg3 != 1)
        ...
        goto label_140a7cf23
    
    r12 = 3
label_140a7cf23:
    int64_t* rax_34 = sub_142a6d740(r12, &arg1->__offset(0x8).q)
