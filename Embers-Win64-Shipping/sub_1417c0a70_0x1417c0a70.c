...
if (r12 s>= 4)
    do
        ...
        *(*arg3 + (rdx_3 << 2)) = int.d(fconvert.t(*(rdi + (rdx_3 << 2))))
        int64_t rdx_4 = sx.q(*(**arg2 + (i_1 << 3) + 0xc))
        *(*arg3 + (rdx_4 << 2)) = int.d(fconvert.t(*(rdi + (rdx_4 << 2))))
        int64_t rdx_5 = sx.q(*(**arg2 + (i_1 << 3) + 0x14))
        *(*arg3 + (rdx_5 << 2)) = int.d(fconvert.t(*(rdi + (rdx_5 << 2))))
        result = *arg3
        int64_t rdx_6 = sx.q(*(**arg2 + (i_1 << 3) + 0x1c))
        i_1 += 4
        *(result + (rdx_6 << 2)) = int.d(fconvert.t(*(rdi + (rdx_6 << 2))))
    while (i_1 s< r12 - 3)
...
while (i_1 s< r12)
    ...
    i_1 += 1
    *(result + (r8_2 << 2)) = int.d(fconvert.t(*(rdi + (r8_2 << 2))))
