...
if (i != 0xffffffff)
    ...
    do
        ...
        if (*(rdx + (rax_19 << 3)) == arg2)
            int64_t r8_9 = i_1 * 0x50
            int64_t rax_21 = sx.q(*(r8_9 + rdx + 0x4c)) & rbp_1
            void* rcx_11 = r11 + (rax_21 << 2)
            
            for (int32_t j = *(r11 + (rax_21 << 2)); j != 0xffffffff; j = *rcx_11)
                if (j == i)
                    *rcx_11 = *(r8_9 + rdx + 0x48)
                    break
                
                rcx_11 = sx.q(j) * 0x50 + 0x48 + rdx
            
            sub_140846de0(*arg1 + 8 + r8_9)
            rsi = 1
