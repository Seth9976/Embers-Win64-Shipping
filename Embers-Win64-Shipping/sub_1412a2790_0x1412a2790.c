...
if (data_143e8aa10 s> *rdi_1)
    _Init_thread_header(&data_143e8aa10)
    
    if (data_143e8aa10 == 0xffffffff)
        ...
        data_143e8aa08 = rax_9
        _Init_thread_footer(&data_143e8aa10)

if (data_143e8aa20 s> *rdi_1)
    _Init_thread_header(&data_143e8aa20)
    
    if (data_143e8aa20 == 0xffffffff)
        ...
        data_143e8aa18 = rax_12
        _Init_thread_footer(&data_143e8aa20)

if (data_143e8aa30 s> *rdi_1)
    _Init_thread_header(&data_143e8aa30)
    
    if (data_143e8aa30 == 0xffffffff)
        ...
        data_143e8aa28 = rax_15
        _Init_thread_footer(&data_143e8aa30)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8aa08
int64_t rcx
...
label_1412a2893:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412a288e
        
        rbx.b = 1
        goto label_1412a2893
