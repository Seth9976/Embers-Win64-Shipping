...
if (rax_10 != 0)
    ...
    if (rdx_2 != 0)
        char* rax_11
        int64_t r8
        rax_11, r8 = sub_142834db4(arg3, rdx_2)
        *(arg1 + 0x10) = rax_11
        
        if (rax_11 == 0)
            sub_142833a04((&rax_11[1]).d, "Couldn't find sample name", r8)
            return 0xffffffff
...
while (true)
    ...
    *(rax_12 + 0x10) = 0
    *(rax_12 + 8) = _mm_cvtepi32_pd(zx.q(sx.d(*(rsi_1 + 4)))).q
    int32_t rcx_2
    rcx_2.b = *rsi_1
    rax_12[2] = 0
    rcx_2.b &= 0x7f
    ...
    r9_2[2] = r8_2
    uint32_t rax_14 = zx.d(*rsi_1) u>> 0xa
    ...
    *r9_2 = rax_14.b
    ...
    r9_2[4] = r8_4
    uint32_t rax_16 = zx.d(*(rsi_1 + 6)) u>> 0xa
