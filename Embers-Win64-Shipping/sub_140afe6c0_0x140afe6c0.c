...
for (int32_t i = *(rax_6 + (rcx_2 << 2)); i != 0xffffffff; i = *r14)
    int64_t* rbx_2 = sx.q(i) * 0xb8 + *arg1
    int16_t* rdx_1
    ...
    if (sub_140a54510(rcx_3, rdx_1) == 0)
        ...
        if (arg1[1].d != *(arg1 + 0x34))
            void* rdx_2 = *(r15 + 8)
            void* r8_1 = *arg1
            int64_t r9_1 = rbx_3 * 0xb8
            int64_t rcx_5 = sx.q(arg1[9].d - 1) & sx.q(*(r9_1 + r8_1 + 0xb4))
            ...
            for (; j != 0xffffffff; j = *rdx_3)
                if (j == rbx_3.d)
                    *rdx_3 = *(r9_1 + r8_1 + 0xb0)
                    break
                
                rdx_3 = r8_1 + 0xb0 + sx.q(j) * 0xb8
        
        int64_t* rdi_2 = rbx_3 * 0xb8 + *arg1
        sub_140a3c110(&rdi_2[2])
        int64_t rcx_8 = *rdi_2
