...
while (i != 0xffffffff)
    int64_t* rbx_3 = sx.q(i) * 0x30 + *arg1
    int16_t* rdx_1
    ...
    if (sub_140a54510(rcx_3, rdx_1) == 0)
        ...
        if (arg1[1].d != *(arg1 + 0x34))
            ...
            void* r8_1 = *arg1
            int64_t rcx_5 = sx.q(arg1[9].d - 1) & sx.q(*(r8_1 + (r9_2 << 3) + 0x2c))
            ...
            for (; j != 0xffffffff; j = *rdx_3)
                if (j == rbx_4.d)
                    *rdx_3 = *(r8_1 + (r9_2 << 3) + 0x28)
                    break
                
                rdx_3 = r8_1 + 0x28 + sx.q(j) * 0x30
        
        sub_1418220b0(rbx_4 * 0x30 + *arg1)
        rbp = 1
