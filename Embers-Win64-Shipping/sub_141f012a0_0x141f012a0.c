...
if (rax_2 != 0xffffffff)
    ...
    sub_141de1640(&var_128, arg4, arg5 + 0x638)
    ...
    if (arg3 != 1)
        ...
        float zmm11_1[0x4]
        float zmm12_1[0x4]
        rax_4, zmm10_1, zmm11_1, zmm12_1 = sub_141dea8e0(rcx_7, &var_f8, rax_2)
        ...
        *arg1 = _mm_shuffle_ps(zx.o(0), zmm1_2, 0xc4)
        ...
        if (_mm_movemask_ps(_mm_cmpeq_ps(_mm_min_ps(zmm13_1, zmm9_1), data_143f3afe0, 1)) == 0)
            float zmm6_1[0x4] = *(arg5 + 0x1c0)
            zmm3_1 = *rax_4
            zmm5_1 = rax_4[1]
            zmm8_1 = *(arg5 + 0x1d0)
            float temp0_137[0x4] = _mm_shuffle_ps(zmm6_1, zmm6_1, 0)
            float temp0_139[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm3_1, zmm3_1, 0x1b), temp0_137)
            float temp0_140[0x4] = _mm_shuffle_ps(zmm6_1, zmm6_1, 0x55)
            float temp0_141[0x4] = _mm_mul_ps(zmm9_1, zmm5_1)
            float temp0_142[0x4] = __mulps_xmmps_memps(temp0_139, data_143f3afa0)
            float temp0_143[0x4] = _mm_shuffle_ps(zmm6_1, zmm6_1, 0xff)
            ...
            float temp0_151[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm6_1, zmm6_1, 0xaa), 
            ...
            *arg1 = temp0_156
            float temp0_158[0x4] = _mm_shuffle_ps(zmm6_1, zmm6_1, 0xd2)
            float temp0_159[0x4] = _mm_mul_ps(temp0_157, temp0_158)
            float temp0_160[0x4] = _mm_shuffle_ps(zmm6_1, zmm6_1, 0xc9)
            ...
            int96_t var_168_1 = temp0_92[0].12
            ...
            int96_t var_158_1 = temp0_103[0].12
            int96_t var_148_1 = _mm_add_ps(_mm_add_ps(temp0_106, temp0_101), temp0_105)[0].12
            float zmm10_2[0x4]
            int512_t zmm11_2
            float zmm12_2[0x4]
            float zmm14_2[0x4]
            zmm10_2, zmm11_2, zmm12_2, zmm14_2 = sub_1407740e0(&var_178, 0x322bcc77)
            zmm14_2 = _mm_and_ps(_mm_cmpeq_ps(zmm14_2, zmm12_2, 2), data_143f3afd0 ^ zmm10_2)
                ^ data_143f3afd0
            uint32_t zmm2_2[0x4] = var_178[0]
            zmm2_2[0] = zmm2_2[0] f* zmm14_2[0]
            uint32_t zmm0_3[0x4] = zmm14_2
            float zmm1_3 = zmm14_2[0] * var_178[1]
            zmm0_3[0] = zmm0_3[0] f* var_178[2]
            var_178[0] = zmm2_2[0]
            zmm2_2 = _mm_shuffle_ps(zmm14_2, zmm14_2, 0x55)
            var_178[1] = zmm1_3
            zmm1_3 = zmm2_2[0] f* var_168_1.d
            var_178[2] = zmm0_3[0]
            zmm2_2[0] = zmm2_2[0] f* var_168_1:4.d
            zmm2_2[0] = zmm2_2[0] f* var_168_1:8.d
            float temp0_112[0x4] = _mm_shuffle_ps(zmm14_2, zmm14_2, 0xaa)
            var_168_1.d = zmm1_3
            zmm1_3 = temp0_112[0] f* var_158_1.d
            var_168_1:4.d = zmm2_2[0]
            zmm0_3 = temp0_112
            zmm0_3[0] = zmm0_3[0] f* var_158_1:4.d
            temp0_112[0] = temp0_112[0] f* var_158_1:8.d
            var_158_1.d = zmm1_3
            var_158_1:4.d = zmm0_3[0]
            var_168_1:8.d = zmm2_2[0]
            var_158_1:8.d = temp0_112[0]
            ...
            float temp0_132[0x4] = _mm_unpacklo_ps(var_148_1:4.d, 0)
            zmm5_2 =
                _mm_and_ps(_mm_mul_ps(temp0_131, zmm6_2) ^ data_143f3afb0, zmm0_4) ^ data_143f3afb0
            float temp0_136[0x4] =
                _mm_unpacklo_ps(_mm_unpacklo_ps(var_148_1.d, var_148_1:8.d[0].q), temp0_132[0].q)
            arg1[2] = zmm12_2
            arg1[1] = temp0_136
            *arg1 = zmm5_2
    else
        sub_141dea8e0(rcx_7, arg1, rax_2)
    
    int128_t var_118
    int64_t rcx_11 = var_118:8.q
    ...
    int64_t* rax_3 = sub_140b63b70(&arg_10, &var_188)
    ...
    sub_140a2e390(&var_138, u"Invalid Bone Name '%s'", r8)
    int64_t rcx_3 = var_188.q
