...
if (data_143e8ca4c s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8ca4c)
    
    if (data_143e8ca4c == 0xffffffff)
        ...
        int64_t r8_3
        r8_3.b = 1
        int64_t* rax_4 = (*(*rcx_7 + 0xb0))(rcx_7, u"r.Mobile.UseHWsRGBEncoding", r8_3)
        
        if (rax_4 != 0)
            int64_t rdx_2 = *rax_4
            rax_4 = (*(rdx_2 + 0x58))(rax_4, rdx_2)
        
        data_143e8ca40 = rax_4
        _Init_thread_footer(&data_143e8ca4c)

if (data_143e8ca40 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()
