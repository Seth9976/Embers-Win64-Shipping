...
while (true)
    ...
    if (result.d == (var_88_2.q u>> 0x20).d && var_68.q == arg2 + 0x10 && rcx_8 == arg2)
        return result
    
    (*(*arg1 + 0x38))(arg1, result * 0x50 + *rcx_8, arg3, arg4, var_98, arg2 + 0x10, var_88_2)
