...
if (data_143e8d780 s> *rdi_1)
    _Init_thread_header(&data_143e8d780)
    
    if (data_143e8d780 == 0xffffffff)
        ...
        data_143e8d778 = rax_12
        _Init_thread_footer(&data_143e8d780)

if (data_143e8d790 s> *rdi_1)
    _Init_thread_header(&data_143e8d790)
    
    if (data_143e8d790 == 0xffffffff)
        ...
        data_143e8d788 = rax_15
        _Init_thread_footer(&data_143e8d790)

if (data_143e8d7a8 s> *rdi_1)
    _Init_thread_header(&data_143e8d7a8)
    
    if (data_143e8d7a8 == 0xffffffff)
        ...
        data_143e8d798 = rax_18
        _Init_thread_footer(&data_143e8d7a8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d778
int64_t rcx
...
label_1412aefa8:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412aefa3
    
    rbx.b = 1
    goto label_1412aefa8
