...
void* rax = *(rcx + 0x40)
int512_t entry_zmm2
int32_t result = (*(rax + 0x128))(arg2, *(rcx + 0x48), entry_zmm2, *(rax + 0x18))
...
if (rax_5 != 0)
    rdx_4 = sx.q(*(rax_5 + 0x20))
    rax_6 = sx.q(*(arg1 + 0x20))
...
if (rax_10 != 0)
    int64_t rdx_7 = sx.q(*(rax_10 + 0x20))
    int64_t rax_11 = sx.q(*(arg1 + 0x20))
