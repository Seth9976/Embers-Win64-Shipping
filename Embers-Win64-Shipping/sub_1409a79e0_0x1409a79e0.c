    ...
    do
        ...
        if ((0x800 & r9_1.w) == 0 && r8.d != 0 && *(r14 + 0xc) == 0)
            if ((not.b(*(sx.q(*rsi_2) + r14[0x15])) & 1) != 0)
                ...
                int32_t i_3 = i
                _kbhit_nolock(&var_210, &var_1a0, &var_1c8, r9_1 u>> 7 & 0xf)
                ...
                do
                    ...
                    *(arg3 + rdi_4 + 0x10) = zx.o(0)
                    ...
                    if ((*(rcx_27 + r14[0x15]) & 8) != 0)
                        ...
                        *(&arg3[rcx_27 * 4] + 4) =
                            *(rax_35 + 4) f* 0.166666672f f+ *(&arg3[rcx_27 * 4] + 4)
                        ...
                        *(&arg3[rcx_27 * 4] + 0x14) =
                            *(rax_35 + 0x14) f* 0.166666672f f+ *(&arg3[rcx_27 * 4] + 0x14)
                        ...
                        *(&arg3[rcx_27 * 4] + 0x1c) = zmm3 f+ *(&arg3[rcx_27 * 4] + 0x1c)
                        ...
                        arg3[rcx_27 * 4].d = zmm0.d
                        *(&arg3[rcx_27 * 4] + 4) =
                            *(rax_38 + 4) f* 0.166666672f f+ *(&arg3[rcx_27 * 4] + 4)
                        ...
                        *(&arg3[rcx_27 * 4] + 0xc) =
                        ...
                        arg3[rcx_27 * 4 + 2].d = zmm0.d
                        *(&arg3[rcx_27 * 4] + 0x14) =
                            *(rax_38 + 0x14) f* 0.166666672f f+ *(&arg3[rcx_27 * 4] + 0x14)
                        arg3[rcx_27 * 4 + 3].d = zmm2 f+ arg3[rcx_27 * 4 + 3].d
                        *(&arg3[rcx_27 * 4] + 0x1c) = zmm3 f+ *(&arg3[rcx_27 * 4] + 0x1c)
                        ...
                        i = i_1
                        *(&arg3[rcx_27 * 4] + 4) =
                            *(rdi_4 + rax_39 + 4) f* 0.666666687f f+ *(&arg3[rcx_27 * 4] + 4)
                        ...
                        *(&arg3[rcx_27 * 4] + 0xc) =
                        ...
                        zmm0.d = zmm0.d f+ arg3[rcx_27 * 4 + 2].d
                        zmm1 = *(rdi_4 + rax_39 + 0x14) f* 0.666666687f
