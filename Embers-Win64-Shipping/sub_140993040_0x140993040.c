...
if (rbx_1 != r14_1)
    do
        ...
        int64_t var_38
        int64_t* rax_4 = sub_140993b50(&var_38, rbx_1 + 8)
        int16_t* const r8_1
        ...
        int64_t* rax_5 = sub_1409e46d0(rbx_1, &var_28)
        int16_t* const r8_2
        ...
        int64_t var_48
        sub_140a2e390(&var_48, u"VertexInstanceID:%s, VertexInstanceAttributes:%s", r8_2)
