...
if (data_143e8d8b8 s> *rdi_1)
    _Init_thread_header(&data_143e8d8b8)
    
    if (data_143e8d8b8 == 0xffffffff)
        ...
        data_143e8d8b0 = rax_9
        _Init_thread_footer(&data_143e8d8b8)

if (data_143e8d8c8 s> *rdi_1)
    _Init_thread_header(&data_143e8d8c8)
    
    if (data_143e8d8c8 == 0xffffffff)
        ...
        data_143e8d8c0 = rax_12
        _Init_thread_footer(&data_143e8d8c8)

if (data_143e8d8d8 s> *rdi_1)
    _Init_thread_header(&data_143e8d8d8)
    
    if (data_143e8d8d8 == 0xffffffff)
        ...
        data_143e8d8d0 = rax_15
        _Init_thread_footer(&data_143e8d8d8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d8b0
int64_t rcx
...
label_1412a0c50:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412a0c4e
        
        rbx.b = 1
        goto label_1412a0c50
