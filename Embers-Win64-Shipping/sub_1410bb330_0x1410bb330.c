...
if (data_143e2d290 s> *rdi_1)
    _Init_thread_header(&data_143e2d290)
    
    if (data_143e2d290 == 0xffffffff)
        ...
        data_143e2d288 = rax_8
        _Init_thread_footer(&data_143e2d290)

if (data_143e2d2a0 s> *rdi_1)
    _Init_thread_header(&data_143e2d2a0)
    
    if (data_143e2d2a0 == 0xffffffff)
        ...
        data_143e2d298 = rax_11
        _Init_thread_footer(&data_143e2d2a0)

int64_t rdi_2 = data_143e2d298
int64_t rcx
...
bool rcx_2 = sub_1419a8260(*arg1) != 0
char rax_5
...
if ((rcx_2 & rax_5) != 0 && sub_1405fba70(*arg1, 3) != 0)
    return 1
