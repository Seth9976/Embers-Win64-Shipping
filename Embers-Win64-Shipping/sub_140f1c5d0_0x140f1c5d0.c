                    ...
                    if (&r10_1[1] u<= i)
                        do
                            ...
                            if (zmm0_2.d f!= zmm1.d)
                                r8_2 = zmm1.d f> zmm0_2.d
                            else
                                r8_2 = *rdx_2 s< *rcx_12
                            
                            uint64_t* rax_23 = rcx_12
