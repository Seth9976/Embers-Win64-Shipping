...
if (*(arg1 + 0x6e0) == 0)
    ...
    void* rax_6 = sub_140698b50(sub_140ea2880(*(arg1 + 0x680)))
    int128_t var_278
    ...
    if (arg1 + 0x6e0 != &var_288)
        *(arg1 + 0x6e0) = r15_1
        int64_t* rbx_6 = *(arg1 + 0x6e8)
        
        if (rdi_1 == rbx_6)
            goto label_140f5e141
        
        *(arg1 + 0x6e8) = rdi_1
        
        if (rbx_6 == 0)
            goto label_140f5e168
