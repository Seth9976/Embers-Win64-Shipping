...
if (arg2 u<= rdx_5)
    if (arg2 u<= r12_2)
        if (arg2 != r12_2)
            ...
            rax_5 = sub_1429914c0(__saved_r8_1, rsi)
            arg1[1] = __saved_r8_1
    ...
    int64_t rax_24 = sub_1429914c0(rsi, rsi)
    arg1[1] = rsi
    return rax_24
...
sub_1429914c0(rcx_8, rcx_8)
int64_t* rcx_9 = *arg1

if (rcx_9 != 0)
    sub_1429914c0(rcx_9, arg1[1])
    void* r8_5 = *arg1
    int64_t rax_18
    int64_t rdx_10
