...
while (true)
    ...
    int64_t rbx_2 = *rdx_7 + result * 0x18
    (*(*arg1 + 0x38))(arg1, rbx_2, arg3, arg4, var_98, arg2 + 0x10, var_88_2)
    (*(*arg1 + 0x38))(arg1, rbx_2 + 8, arg3, arg4)
