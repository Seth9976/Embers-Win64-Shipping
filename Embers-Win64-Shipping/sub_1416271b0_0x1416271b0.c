...
int32_t* var_1f0 = arg1
void* var_1e8 = rdi
zmm4[0] = zmm4[0] + zmm3[0]
float (* var_1d8)[0x4] = &var_1c8
...
float var_254 = zmm6[0]
uint128_t zmm13
uint128_t var_b8 = zmm13
float var_298 = _mm_cvtpd_ps(zmm0)[0]

while (true)
    int32_t rdx_2 = rdx_1 + 1
    
    if (rdx_1 s>= 0x20)
        goto label_1416279fb
    ...
    zmm4[0] = zmm4[0] * zmm15[0]
    zmm14[0] = zmm14[0] - zmm12[0]
    float var_240 = zmm15[0]
    zmm12[0] = zmm12[0] + zmm4[0]
    zmm4[0] = zmm4[0] + zmm12[0]
    zmm12[0] = zmm12[0] f* *(rdi + 0x2c)
    zmm14[0] = zmm14[0] + zmm4[0]
    float var_23c = zmm12[0]
    zmm14[0] = zmm14[0] f* *(rdi + 0x30)
    float var_238 = zmm14[0]
    int32_t var_230
    zmm11 = sub_141758e70(rcx, &var_230, &var_240, zmm11)
    zmm3 = var_230
    ...
    zmm5 = *arg3
    float temp0_12[0x4] =
        _mm_unpacklo_ps(_mm_unpacklo_ps(zmm3, zmm0[0].q), _mm_unpacklo_ps(zmm2, zmm11[0].q)[0].q)
    float temp0_13[0x4] = _mm_shuffle_ps(zmm5, zmm5, 0xc9)
    ...
    float temp0_19[0x4] = _mm_sub_ps(_mm_mul_ps(temp0_15, temp0_13), temp0_17)
    float temp0_20[0x4] = _mm_shuffle_ps(zmm5, zmm5, 0xff)
    float temp0_21[0x4] = _mm_add_ps(temp0_19, temp0_19)
    float temp0_22[0x4] = _mm_mul_ps(temp0_20, temp0_21)
    float temp0_24[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_21, temp0_21, 0xc9), temp0_16)
    ...
    float var_274_1 = zmm2[0]
    zmm2[0] = zmm2[0] * zmm15[0]
    float var_270 = zmm0[0]
    zmm0[0] = zmm0[0] * zmm12[0]
    zmm3[0] = zmm3[0] + zmm2[0]
    float var_1f8_1 = temp0_32[0]
    ...
    *(&var_1a8:4 + (sx.q(i_6) << 2)) = i_6
    ...
    var_1a8.d = i_6
    int64_t var_148
    *(&var_148 + (rcx_2 << 2)) = var_200_1.q
    zmm0 = zx.o(var_278.q)
    int32_t var_140
    (&var_140)[rcx_2] = var_1f8_1
    int64_t var_118
    *(&var_118 + (rcx_2 << 2)) = zmm0.q
    int64_t var_178
    *(&var_178 + (rcx_2 << 2)) = zmm13.q
    int32_t var_110
    (&var_110)[rcx_2] = var_270
    int32_t var_170
    (&var_170)[rcx_2] = rbx_1
    uint64_t var_288
    uint64_t var_268
    ...
    if (i_6 == 1)
        int64_t rax_13 = sx.q(var_1a8:4.d)
        int64_t rcx_10 = rax_13 * 3
        var_188[rax_13] = 0x3f800000
        zmm0 = zx.o(*(&var_118 + (rcx_10 << 2)))
        rax_9 = (&var_110)[rcx_10]
    else if (i_6 == 2)
        uint64_t* rax_12 = sub_1416e69d0(&var_288, &var_118, &var_1a8:4, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_12)
        rax_9 = rax_12[1].d
    else if (i_6 == 3)
        uint64_t* rax_11
        rax_11, zmm11, zmm14 = sub_1416fa750(&var_268, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_11)
        rax_9 = rax_11[1].d
    else if (i_6 == 4)
        ...
        uint64_t* rax_10
        rax_10, zmm11, zmm14 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_10)
        rax_9 = rax_10[1].d
    else
    ...
    int32_t var_ec_1 = rax_14
    int32_t rax_15 = (&var_170)[rdi_1]
    ...
    if (zmm3[0] < 9.99999997e-07f || zmm3[0] >= var_258)
        zmm9 = zmm3
    label_1416279fb:
        ...
        if (not(zmm9[0] <= zmm10[0]))
            ...
            temp0_35[0] = temp0_35[0] f* zmm7.d
            temp0_35[0] = temp0_35[0] * zmm10[0]
            zmm1 = var_254
            *arg7 = (_mm_unpacklo_ps(temp0_35, temp0_35[0].q)).q
            float temp0_37[0x4] = _mm_sqrt_ss(0, zmm9[0])
            float var_29c_2 = temp0_35[0]
        ...
        float zmm10_1
        uint128_t zmm11_1
        rax_24, zmm10_1, zmm11_1 = sub_1415bea90(&var_268, &var_288, &var_1f0, &var_1e8, zmm14, 
            &var_298, &var_278, &var_230, &var_240)
        uint128_t zmm0_2
        uint128_t zmm1_1
        uint128_t zmm2_1
        uint128_t zmm3_1
        ...
        if (rax_24 == 2)
            ...
            *arg5 = (_mm_unpacklo_ps(zmm0_2, zmm1_1.q)).q
            ...
            zmm7.d = zmm7.d f* arg7[2]
            zmm3_1.d = zmm3_1.d f- zmm0_2.d
            zmm2_1.d = var_23c.d f- zmm1_1.d
            zmm0_2.d = var_238.d f- zmm7.d
