...
do
    int32_t zmm1[0x4] = zx.o(*(rsi + result))
    int32_t temp0_5[0x4] = _mm_unpacklo_epi8(zx.o(*rsi), 0)
    int32_t temp0_6[0x4] = _mm_unpacklo_epi8(zmm1, 0)
    int32_t zmm0[0x4] = _mm_srai_epi16(
        _mm_adds_epi16(
            _mm_adds_epi16(_mm_mullo_epi16(temp0_5, zmm6), _mm_mullo_epi16(temp0_6, zmm7)), zmm4), 
        7)
    *rdi = _mm_packus_epi16(zmm0, zmm0)[0].q
    rsi += result
    rdi += sx.q(arg4)
    i = i_1
    i_1 -= 1
