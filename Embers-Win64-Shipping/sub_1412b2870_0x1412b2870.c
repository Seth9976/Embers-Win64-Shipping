...
if (data_143e8cc78 s> *rdi_1)
    _Init_thread_header(&data_143e8cc78)
    
    if (data_143e8cc78 == 0xffffffff)
        ...
        data_143e8cc70 = rax_9
        _Init_thread_footer(&data_143e8cc78)

if (data_143e8cc88 s> *rdi_1)
    _Init_thread_header(&data_143e8cc88)
    
    if (data_143e8cc88 == 0xffffffff)
        ...
        data_143e8cc80 = rax_12
        _Init_thread_footer(&data_143e8cc88)

if (data_143e8cca0 s> *rdi_1)
    _Init_thread_header(&data_143e8cca0)
    
    if (data_143e8cca0 == 0xffffffff)
        ...
        data_143e8cc90 = rax_15
        _Init_thread_footer(&data_143e8cca0)
...
if ((rbx_1 != 0 || (*(rdi_2 + (rbx << 2)) & 0xfffffffd) == 0) && sub_1412c5d30(arg1).b != 0)
