...
label_14196bf2b:
    ...
    if (r8_4 s> 0 && (rax_17 == 0 || rax_17 s< rbp))
        ...
        arg4[0x70] = *(rax_21 + (((sx.q(arg1[9].d) - 1) & r8_5) << 2))
        void* rax_23 = *(r9_3 + 8)
    ...
    label_14196be7b:
        ...
        while (true)
            int32_t* rcx_1 = sx.q(rbx_1) * 0x1c8
            
            if (*(rcx_1 + rdx_3) == *arg4)
                break
            
            rbx_1 = *(rcx_1 + rdx_3 + 0x1c0)
            
            if (rbx_1 == 0xffffffff)
                goto label_14196be7b
    ...
    if (rbx_1 == 0xffffffff)
        ...
        memmove(sx.q(rbx_1) * 0x1c8 + *arg1, arg4, 0x1c0)
        int64_t rcx_4 = sx.q(arg5)
        void* r10_1 = &arg1[2]
        
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0x1c8 + *arg1) = rcx_4.d
        
        int32_t* rax_7 = rcx_4 * 0x1c8 + *arg1
        *rax_7 = 0xffffffff
