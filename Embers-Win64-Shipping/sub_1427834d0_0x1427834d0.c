...
int64_t var_330_1 = arg1 - 0x1c + sx.q(arg2) * 0x1c
        ...
        while (true)
            ...
            if (rdx_3 s<= 8)
                for (; i u> r11_1; i -= 0x1c)
                    ...
                    void* rax_29 = r11_1 + 0x1c
                    
                    if (r11_1 + 0x1c u<= i)
                        float* rcx_17 = &r11_1[3]
                        ...
                        do
                            ...
                            if (_mm_sqrt_ss(zmm2.d, zmm2.d).d f>
                                    _mm_sqrt_ss(0, zmm5_1 * zmm5_1 f+ zmm3.d + zmm4_1 * zmm4_1).d)
                                rdx_14 = rax_29
                    ...
                    if (rdx_14 != i)
                        int32_t rcx_18 = *(rdx_14 + 0x18)
                        zmm3 = *rdx_14
                        zmm2 = zx.o(rdx_14[1].q)
                        *rdx_14 = *i
                        rdx_14[1].q = *(i + 0x10)
                        *(rdx_14 + 0x18) = *(i + 0x18)
                        *i = zmm3
            ...
            while (true)
                ...
                if (r9_1 u<= i)
                    ...
                    if (_mm_sqrt_ss(0, zmm2.d).d
                            f<= _mm_sqrt_ss(0, zmm5_1 * zmm5_1 f+ zmm3.d + zmm4_1 * zmm4_1).d)
                        continue
                ...
                do
                    ...
                    zmm0_2 = _mm_sqrt_ss(0, zmm5_1 * zmm5_1 f+ zmm3.d + zmm4_1 * zmm4_1)
                ...
                if (r9_1 != r10_1)
                    int32_t rcx_5 = *(r9_1 + 0x18)
                    zmm3 = *r9_1
                    zmm2 = zx.o(r9_1[1].q)
                    *r9_1 = *r10_1
                    r9_1[1].q = r10_1[1].q
                    *(r9_1 + 0x18) = *(r10_1 + 0x18)
                    *r10_1 = zmm3
                    r10_1[1].q = zmm2.q
                    *(r10_1 + 0x18) = rcx_5
            ...
            if ((r10_1 - r11_1 - 0x1c) s/ 0x1c s< (i - r9_1) s/ 0x1c)
                if (i u> r9_1)
                    *r14_1 = r9_1
                    r14_1[1] = i
                    r14_1[2].d = rbp_1
