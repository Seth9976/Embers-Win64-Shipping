...
if (data_143e2cf70 s> *rsi_1)
    _Init_thread_header(&data_143e2cf70)
    
    if (data_143e2cf70 == 0xffffffff)
        ...
        data_143e2cf68 = rax_6
        _Init_thread_footer(&data_143e2cf70)

uint32_t rax_2

if (data_143e2cf80 s> *rsi_1)
    int64_t r8_2
    rax_2, r8_2 = _Init_thread_header(&data_143e2cf80)
    
    if (data_143e2cf80 == 0xffffffff)
        ...
        data_143e2cf78 = rax_9
        _Init_thread_footer(&data_143e2cf80)

int64_t rbp = data_143e2cf78
uint16_t rsi_2
...
label_1410b9aa0:
    ...
    if (sub_1405fba70(*arg1, 3) != 0 && sub_1410be3c0(arg1) != 0)
        return 1
else
    char rax_3
