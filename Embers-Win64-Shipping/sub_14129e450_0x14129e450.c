...
if (data_143e8de00 s> *rdi_1)
    _Init_thread_header(&data_143e8de00)
    
    if (data_143e8de00 == 0xffffffff)
        ...
        data_143e8ddf8 = rax_9
        _Init_thread_footer(&data_143e8de00)

if (data_143e8de20 s> *rdi_1)
    _Init_thread_header(&data_143e8de20)
    
    if (data_143e8de20 == 0xffffffff)
        ...
        data_143e8de18 = rax_12
        _Init_thread_footer(&data_143e8de20)

if (data_143e8de40 s> *rdi_1)
    _Init_thread_header(&data_143e8de40)
    
    if (data_143e8de40 == 0xffffffff)
        ...
        data_143e8de38 = rax_15
        _Init_thread_footer(&data_143e8de40)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ddf8
int64_t rcx
...
label_14129e550:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_14129e54e
        
        rbx.b = 1
        goto label_14129e550
