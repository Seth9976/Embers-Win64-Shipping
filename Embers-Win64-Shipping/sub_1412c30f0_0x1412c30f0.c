...
if (data_143e8afb0 s> *rdi_1)
    _Init_thread_header(&data_143e8afb0)
    
    if (data_143e8afb0 == 0xffffffff)
        ...
        data_143e8afa8 = rax_12
        _Init_thread_footer(&data_143e8afb0)

if (data_143e8afc0 s> *rdi_1)
    _Init_thread_header(&data_143e8afc0)
    
    if (data_143e8afc0 == 0xffffffff)
        ...
        data_143e8afb8 = rax_15
        _Init_thread_footer(&data_143e8afc0)

if (data_143e8afd0 s> *rdi_1)
    _Init_thread_header(&data_143e8afd0)
    
    if (data_143e8afd0 == 0xffffffff)
        ...
        data_143e8afc8 = rax_18
        _Init_thread_footer(&data_143e8afd0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8afa8
int64_t rcx
...
label_1412c31e8:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412c31e3
    
    rbx.b = 1
    goto label_1412c31e8
