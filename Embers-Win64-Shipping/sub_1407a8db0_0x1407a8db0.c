...
int32_t rsi = (data_143ce0708.q).d
int32_t r14 = 1
int64_t** var_198
int32_t var_190
int32_t var_18c
...
int64_t var_168 = 0
int32_t var_160 = 0
sub_1405947f0(&var_168, 0xd)
int32_t rax_7 = var_160 + 0xd
var_160 = rax_7

if (rax_7 s> 0)
    sub_140594770(&var_168)

UnDecorator::getReferenceType(var_168, u"NumCellsName", 0x1a)
int32_t rsi_1 = (data_143ce0718.q).d
...
int32_t rax_13 = var_170 + 0xd
var_170 = rax_13

if (rax_13 s> 0)
    sub_140594770(&var_178)

UnDecorator::getReferenceType(var_178, u"CellSizeName", 0x1a)
...
int64_t* rax_20 = sub_140b3b600(&var_198, data_14396ec88, &var_98)
