...
float var_d8
float zmm10_1 = sub_141758e70(rcx_1, &var_d8, &var_f8, zx.o(0))
...
float var_f4_2 = zmm8
float* rax_2 = sub_14170aba0(rcx_2, &var_d8, &var_c8)
...
float zmm12_1
float zmm13_1
rax_3, zmm6_1, zmm7_1, zmm9_1, zmm11_2, zmm12_1, zmm13_1 = sub_14170aba0(rcx_2, &var_c8, arg2)
int64_t* rbx_2 = arg1[2]
uint128_t zmm1_2 = zx.o(*rax_3)
float r15 = rax_3[2]
zmm10_1 = (zmm10_1 f- zmm15.d) f* *arg2
zmm9_1 = (zmm9_1 - r14) f* *(arg2 + 8)
zmm8 = zmm8 f- _mm_shuffle_ps(zmm1_2, zmm1_2, 0x55).d
...
if (zmm8 * zmm11_2 + zmm7_1 + (zmm6_1 - r15) * zmm13_1 < zmm12_1 + zmm10_1 + zmm9_1)
