...
int32_t r10_1 = 0
float zmm0[0x4] = *(sx.q(r8) + *(rdi + (sx.q(r10) << 3)))
...
float zmm2[0x4] = *(sx.q(rcx_2) + *(rdi + (sx.q(r10_1) << 3)))
...
float zmm1[0x4] = *(sx.q(rcx_4) + *(rdi + (sx.q(r9) << 3)))
...
if (result.d s> 0)
    ...
    float temp0_4[0x4] = _mm_min_ps(_mm_max_ps(temp0, temp0_1), temp0_2)
    uint64_t i
