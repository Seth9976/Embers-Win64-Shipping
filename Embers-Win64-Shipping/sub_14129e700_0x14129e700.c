...
if (data_143e8dc00 s> *rdi_1)
    _Init_thread_header(&data_143e8dc00)
    
    if (data_143e8dc00 == 0xffffffff)
        ...
        data_143e8dbf8 = rax_9
        _Init_thread_footer(&data_143e8dc00)

if (data_143e8dc20 s> *rdi_1)
    _Init_thread_header(&data_143e8dc20)
    
    if (data_143e8dc20 == 0xffffffff)
        ...
        data_143e8dc18 = rax_12
        _Init_thread_footer(&data_143e8dc20)

if (data_143e8dc40 s> *rdi_1)
    _Init_thread_header(&data_143e8dc40)
    
    if (data_143e8dc40 == 0xffffffff)
        ...
        data_143e8dc38 = rax_15
        _Init_thread_footer(&data_143e8dc40)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8dbf8
int64_t rcx
...
label_14129e800:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_14129e7fe
        
        rbx.b = 1
        goto label_14129e800
