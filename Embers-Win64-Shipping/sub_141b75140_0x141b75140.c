...
if (rax_2 == 0 || rbx_1 == 0)
    ...
    if (result.b == 0 || rdx_8 == 0)
        ...
        if (sub_140cc1670(&var_48, &data_143e1b820).b == 0 || var_48 == 0)
            ...
            uint64_t rdi_6 = zx.q(sub_1408e52c0(rax_9))
            void var_38
            ...
            if (*(result + 8) != 0)
                ...
                if (rbx_1 == 0 || ((zx.q(*(*(rbx_1 + 8) + 0x10)) u>> 0x14).b & 1) == 0)
                    ...
                    if (result.b == 0)
                        ...
                        if (*(rbx_1 + 0x3c) != 0x28 || rdi_6.d s>= *(rbx_1 + 0x38))
                            result.b = 0
                        else
                            int64_t rdi_7 = sx.q((rdi_6 * 5).d << 3)
    ...
    if (rax_1 s< 0 || rax_1 s>= rdi_1[1].d || r15_1 == 0
        ...
        if (result.b == 0 || *(*(rbx_1 + 0x78) + 0x3c) != 0x28 || rdi_1[1].d == 0)
            result.b = 0
        else
            result = *rdi_1
