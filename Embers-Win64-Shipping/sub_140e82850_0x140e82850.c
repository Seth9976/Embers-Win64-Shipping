...
if (data_143e29f78 != 0)
    result = data_143e29f80

if (data_143e29f78 == 0 || result == 0 || *(result + 8) s<= 0)
    int64_t* rax_1 = j_sub_140a82f30(0xd8)
    ...
    if (rax_1 == 0)
        ...
        void var_48
        int64_t* rax_4 = _vfprintf_p_l(&var_48, u"Common Commands", u"GenericCommands")
        void arg_10
        int64_t rcx_4 = *sub_140b58260(&arg_10, u"GenericCommands", 1)
        r14_1[1] = 0
        r14_1[2] = 0
        r14_1[3] = rcx_4
        r14_1[4] = 0
        ...
        *r14_1 = &data_142ed8e80
        __builtin_memset(&r14_1[9], 0, 0x90)
    ...
    if (result == 0 || rcx_14 == 0)
        int64_t* rcx_19 = data_143e29f80
        data_143e29f78 = r14_1
        
        if (rsi_3 != rcx_19)
            if (rsi_3 != 0)
                *(rsi_3 + 0xc) += 1
                rcx_19 = data_143e29f80
        ...
        data_143e29f78 = rcx_14 - 8
        int64_t* rcx_16 = data_143e29f80
        
        if (rdi_1 != rcx_16)
            if (rdi_1 != 0)
                *(rdi_1 + 0xc) += 1
                rcx_16 = data_143e29f80
