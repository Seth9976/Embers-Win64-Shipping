...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_7[4]
    sub_140d30490(arg2, &var_ec, r8_7)
else
    sub_140d30460(arg2, *(arg2 + 0x18), &var_ec)
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_15[4]
    sub_140d30490(arg2, &var_d0, r8_15)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_19[4]
    sub_140d30490(arg2, &var_e0, r8_19)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_23[4]
    sub_140d30490(arg2, &var_68, r8_23)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_25[4]
    sub_140d30490(arg2, &var_78, r8_25)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_27[4]
    r9 = sub_140d30490(arg2, &var_f4, r8_27)
else
    r9 = sub_140d30460(arg2, *(arg2 + 0x18), &var_f4)
...
int32_t var_148 = var_f0.d
*(arg2 + 0x20) = rdi + rax_17
var_48 = zmm1
char result = sub_1420b5480(rcx_15, &var_88, &var_98, r9, var_148, rcx_14, r12.b, r14, rax_20)
int64_t rcx_16 = var_e0
*arg3 = result

if (rcx_16 != 0)
    result = sub_140a74f90(rcx_16)

int64_t rcx_17 = var_d0
