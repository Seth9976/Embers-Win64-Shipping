...
if (rbx != 0)
    ...
    label_1408d6e08:
        ...
        while (true)
            ...
            if (rdx_3 != 0)
                goto label_1408d6e08
        
        var_74_2 = rbx

int32_t rdx_6 = *(arg1 + 0xc0)
...
while (true)
    ...
    if (rax_20.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0xa8 && rdx_11 == arg1 + 0x98)
        sub_1408d84f0(arg1 + 0x98)
        return sub_1408d8560(arg1 + 0x48) __tailcall
    
    int64_t* rcx_8 = *(*rdx_11 + rax_20 * 0x18 + 8)
