...
if (*(rdi + rax) == 0)
    *(rdi + rax) = 1
    int64_t rax_1 = *arg4
    int64_t rbx_2 = rdi * 6
    *(rax_1 + (rbx_2 << 3)) = data_143dbb0c0
    *(rax_1 + (rbx_2 << 3) + 0x10) = data_143dbb0d0
    *(rax_1 + (rbx_2 << 3) + 0x20) = data_143dbb0e0
    
    if (arg3 s>= 0 && arg3 s< *(arg1 + 0x28))
        int32_t r8 = *(*(arg1 + 0x20) + rdi * 0xc + 8)
        
        if (r8 == 0xffffffff)
            int64_t rcx_5 = *arg2
            int64_t rax_5 = *arg4
            *(rax_5 + (rbx_2 << 3)) = *(rcx_5 + (rbx_2 << 3))
            *(rax_5 + (rbx_2 << 3) + 0x10) = *(rcx_5 + (rbx_2 << 3) + 0x10)
            *(rax_5 + (rbx_2 << 3) + 0x20) = *(rcx_5 + (rbx_2 << 3) + 0x20)
        else
            int64_t* var_118_1 = arg5
            int128_t* rax_3 = sub_141deaf80(arg1, arg2, r8)
            int64_t rdx_2 = *arg2
            float zmm8[0x4] = rax_3[2]
            float zmm14[0x4] = *(rdx_2 + (rbx_2 << 3) + 0x20)
            float zmm6[0x4]
            float zmm7[0x4]
            float zmm13[0x4]
            float zmm3[0x4]
            ...
            if (_mm_movemask_ps(_mm_cmpeq_ps(_mm_min_ps(zmm14, zmm8), data_143f39140, 1)) == 0)
                float zmm4_1[0x4] = *rax_3
                float zmm2[0x4] = *(rdx_2 + (rbx_2 << 3))
                zmm3 = *(rdx_2 + (rbx_2 << 3) + 0x10)
                ...
                float temp0_147[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm4_1, zmm4_1, 0xaa), 
                ...
                float zmm1[0x4] = __andps_xmmxud_memxud(temp0_20, data_143f39050)
                ...
                float zmm5_1[0x4] = *(rdx_2 + (rbx_2 << 3) + 0x10)
                ...
                int128_t zmm11_1
                float zmm15_1[0x4]
                zmm11_1, zmm13, zmm15_1 = sub_1407740e0(&var_f8, 0x322bcc77)
                zmm15_1 = _mm_and_ps(_mm_cmpeq_ps(zmm15_1, zmm13, 2), data_143f39130 ^ zmm11_1)
                    ^ data_143f39130
                ...
                zmm6 = _mm_and_ps(_mm_mul_ps(temp0_127, zmm5_2) ^ data_143f390c0, zmm0_3)
                    ^ data_143f390c0
                zmm7 =
                    _mm_unpacklo_ps(_mm_unpacklo_ps(var_c8_1.d, var_c8_1:8.d[0].q), temp0_128[0].q)
            int64_t rax_4 = *arg4
            *(rax_4 + (rbx_2 << 3)) = zmm6
            *(rax_4 + (rbx_2 << 3) + 0x10) = zmm7
            *(rax_4 + (rbx_2 << 3) + 0x20) = zmm13

return rdi * 0x30 + *arg4
