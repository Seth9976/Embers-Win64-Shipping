...
sub_140af5b90(data_143ddb400, /Script/WindowsTargetPlatform.WindowsTargetSettings", 
    SpatializationPlugin", &var_38, &data_143de5780)
TEB* gsbase

if (data_143f3a000 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143f3a000)
    
    if (data_143f3a000 == 0xffffffff)
        sub_140b58260(&data_143f39ff8, u"AudioSpatializationPlugin", 1)
        _Init_thread_footer(&data_143f3a000)

int64_t rbx = data_143f39ff8
sub_140a387e0()
int64_t* rbp = nullptr
int32_t r15 = 0
