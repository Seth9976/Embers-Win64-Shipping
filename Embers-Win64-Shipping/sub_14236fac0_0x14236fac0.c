...
if (rcx_6 != 0)
    ...
    *(arg1 + 0x3c) = rax_15
    float zmm2 = arg1[0xa].d f- *(arg1 + 0x54)
    var_238 = rax_15 u>> 9 | 0x3f800000
    *rbx_2 = zmm2 * (var_238 - 1f) f+ *(arg1 + 0x54)
    int32_t rax_19 = *(arg1 + 0x3c) * 0xbb38435 + 0x3619636b
    *(arg1 + 0x3c) = rax_19
    zmm2 = arg1[9].d f- *(arg1 + 0x4c)
    var_238 = rax_19 u>> 9 | 0x3f800000
    *(rbx_2 + 4) = zmm2 * (var_238 - 1f) f+ *(arg1 + 0x4c)
    *rdx_6 = 0

void var_228
sub_14234f710(&var_228, arg5)
float var_1cc
float var_1cc_1 = var_1cc f* *rbx_2
float var_1b0
float var_1b0_1 = var_1b0 f* *(rbx_2 + 4)
