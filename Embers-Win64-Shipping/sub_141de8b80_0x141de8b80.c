...
while (true)
    ...
    if (rcx_7.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x1b0 && rax_20 == arg1 + 0x1a0)
        return nullptr
    
    void* rbx_1 = *(*rax_20 + rcx_7 * 0x10)
    
    if (rbx_1 != 0)
        void* result = sub_140d21950(rbx_1, sub_14255c120())
