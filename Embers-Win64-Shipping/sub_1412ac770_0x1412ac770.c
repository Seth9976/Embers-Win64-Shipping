...
if (data_143e8dd10 s> *rdi_1)
    _Init_thread_header(&data_143e8dd10)
    
    if (data_143e8dd10 == 0xffffffff)
        ...
        data_143e8dd08 = rax_9
        _Init_thread_footer(&data_143e8dd10)

if (data_143e8dd30 s> *rdi_1)
    _Init_thread_header(&data_143e8dd30)
    
    if (data_143e8dd30 == 0xffffffff)
        ...
        data_143e8dd28 = rax_12
        _Init_thread_footer(&data_143e8dd30)

if (data_143e8dd50 s> *rdi_1)
    _Init_thread_header(&data_143e8dd50)
    
    if (data_143e8dd50 == 0xffffffff)
        ...
        data_143e8dd48 = rax_15
        _Init_thread_footer(&data_143e8dd50)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8dd08
int64_t rcx
...
label_1412ac873:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412ac86e
        
        rbx.b = 1
        goto label_1412ac873
