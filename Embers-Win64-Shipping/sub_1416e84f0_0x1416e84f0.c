...
float zmm3 = *(arg1 + 0x34) * *arg4
float zmm4 = *(arg1 + 0x38) * arg4[1]
float zmm5 = *(arg1 + 0x3c) * arg4[2]
...
if (temp0[0] <= 1.17549435e-38f)
    ...
    float var_188 = zmm3 f* zmm7.d
    float var_184_1 = zmm4 f* zmm7.d
    float var_180_1 = zmm5 f* zmm7.d
    void** var_108
    float zmm6_1 = sub_141703a00(&var_108, arg2, arg1 + 0x34, (zx.o(0)).d)
    ...
    int32_t var_168
    char rax_3
    rax_3, zmm7, zmm8 = sub_1417b63b0(rcx_1, &var_108, &var_a8, &var_188, zmm6_1, &var_18c, 
    ...
    if (rax_3 == 0 || zmm0_2.d f>= zmm8[0])
        ...
        *arg7 = (_mm_unpacklo_ps(zmm1_1, zmm2_2.q)).q
        ...
        label_1416e8808:
            var_190_2 = zmm8[0]
            int32_t var_194_2 = zmm7.d
            var_198_1 = zmm6_2.d
        else
            var_198_1 = data_143dbb1f8.d
            var_190_2 = data_143dbb200.d
            float var_194_1 = data_143dbb1fc[0]
