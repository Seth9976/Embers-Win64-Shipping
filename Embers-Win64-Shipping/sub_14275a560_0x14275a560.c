...
float (* r10_3)[0x4] = zx.q(rax_4 * r8_1) + r9_1
int128_t* r11_2 = zx.q(r11 * r8_1) + r9_1
...
if (result.d s> 0)
    ...
    do
        ...
        r11_2 = &r11_2[1]
        r10_3 = &r10_3[1]
        float temp0_1[0x4] = _mm_sub_ps(data_143f87770, zmm1)
        float temp0_2[0x4] = _mm_mul_ps(zmm2, zmm1)
        result_1 += 0x10
        *result = _mm_add_ps(_mm_mul_ps(temp0_1, temp0), temp0_2)
        i = i_1
        i_1 -= 1
    while (i != 1)
