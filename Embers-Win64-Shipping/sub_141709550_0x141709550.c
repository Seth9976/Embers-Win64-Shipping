...
float var_c8
float* rax_1 = sub_141711220(rcx_1, &var_c8, &var_d8)
...
float zmm12_1
float zmm13_1
rax_2, zmm6_1, zmm7_1, zmm9_1, zmm11_1, zmm12_1, zmm13_1 = sub_141711220(rcx_1, &var_d8, arg2)
int64_t* rbx = arg1[2]
uint128_t zmm1 = zx.o(*rax_2)
int32_t r14 = rax_2[2]
zmm12_1 = (zmm12_1 - rbp) f* *(arg2 + 8)
int64_t rdi = sx.q(rbx[1].d)
zmm8.d = zmm8.d f- _mm_shuffle_ps(zmm1, zmm1, 0x55).d
...
zmm8.d = zmm8.d f- (zmm11_1 f- zmm1.d) f* zmm10.d
zmm8.d = zmm8.d f+ zmm14.d
int64_t result

if (zmm8.d f< (zmm9_1 f- zmm6_1.d) f* zmm10.d
        + (zmm13_1 f- _mm_shuffle_ps(zmm6_1, zmm6_1, 0x55).d) f* zmm15.d + zmm12_1)
    if (rax_3 s> *(rbx + 0xc))
        sub_14083a7e0(rbx)
