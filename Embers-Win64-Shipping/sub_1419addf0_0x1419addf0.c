...
zmm1 = _mm_cvtepi32_ps(zx.o(rdx))
zmm3.d = zmm3.d f/ float.s(rax_6)
int64_t* rcx_1 = data_143f0f180
int32_t var_6c = zmm3.d
zmm2[0] = 0.5f f/ float.s(rcx)
zmm2[0] = zmm2[0] f* zmm1.d
(*(*rcx_1 + 0xf8))(rcx_1, &arg5, &var_b8, &data_143f11db0, 1, 1, temp0_3, temp0_4, temp0_6, 
    temp0_7, var_b8, temp0_4, temp0_6, temp0_7, rdx, zmm2[0], rax_5, rax_2, rax_3)
int32_t* rsi = arg5
arg6 = rsi
...
if (rbx s> 0)
    ...
    while (true)
        ...
        if (*(rcx_4 + (rdx_2 << 3)) == data_143f11da0)
            break
