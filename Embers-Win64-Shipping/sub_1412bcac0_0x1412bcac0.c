...
if (data_143e8c790 s> *rdi_1)
    _Init_thread_header(&data_143e8c790)
    
    if (data_143e8c790 == 0xffffffff)
        ...
        data_143e8c788 = rax_12
        _Init_thread_footer(&data_143e8c790)

if (data_143e8c7b0 s> *rdi_1)
    _Init_thread_header(&data_143e8c7b0)
    
    if (data_143e8c7b0 == 0xffffffff)
        ...
        data_143e8c7a8 = rax_15
        _Init_thread_footer(&data_143e8c7b0)

if (data_143e8c7d0 s> *rdi_1)
    _Init_thread_header(&data_143e8c7d0)
    
    if (data_143e8c7d0 == 0xffffffff)
        ...
        data_143e8c7c8 = rax_18
        _Init_thread_footer(&data_143e8c7d0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c788
int64_t rcx
...
label_1412bcbb8:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412bcbb3
    
    rbx.b = 1
    goto label_1412bcbb8
