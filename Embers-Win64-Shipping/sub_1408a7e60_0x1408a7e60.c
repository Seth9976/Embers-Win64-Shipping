...
int128_t zmm12
int32_t zmm13
zmm0, zmm7, zmm8_1, zmm9_1, zmm10_1, zmm12, zmm13 = sub_1408a7580(arg1, *arg1, arg2, arg3, arg4.d)
...
if (rsi s> 1)
    ...
    *(arg1 + 0x418)
    ...
    do
        ...
        zmm0, result, zmm7, zmm8_1, zmm9_1, zmm10_1, zmm11, zmm12, zmm13_1, zmm14_1, zmm15_1 =
            sub_1408a7580(arg1, *(rdi_1 + arg1), zmm10_1, zmm9_1, zmm8_1 f* zmm7.d)
        uint32_t temp0_1[0x4] = _mm_and_ps(zmm0, zmm15_1)
        rdi_1 = &rdi_1[1]
        temp0_1[0] = temp0_1[0] f* zmm13_1
        temp0_1[0] = temp0_1[0] f- zmm14_1
