...
if (data_143e8dc10 s> *rdi_1)
    _Init_thread_header(&data_143e8dc10)
    
    if (data_143e8dc10 == 0xffffffff)
        ...
        data_143e8dc08 = rax_12
        _Init_thread_footer(&data_143e8dc10)

if (data_143e8dc30 s> *rdi_1)
    _Init_thread_header(&data_143e8dc30)
    
    if (data_143e8dc30 == 0xffffffff)
        ...
        data_143e8dc28 = rax_15
        _Init_thread_footer(&data_143e8dc30)

if (data_143e8dc50 s> *rdi_1)
    _Init_thread_header(&data_143e8dc50)
    
    if (data_143e8dc50 == 0xffffffff)
        ...
        data_143e8dc48 = rax_18
        _Init_thread_footer(&data_143e8dc50)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8dc08
int64_t rcx
