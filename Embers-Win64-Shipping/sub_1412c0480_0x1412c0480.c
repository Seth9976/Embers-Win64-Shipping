...
if (data_143e8bc98 s> *rdi_1)
    _Init_thread_header(&data_143e8bc98)
    
    if (data_143e8bc98 == 0xffffffff)
        ...
        data_143e8bc90 = rax_9
        _Init_thread_footer(&data_143e8bc98)

if (data_143e8bcb8 s> *rdi_1)
    _Init_thread_header(&data_143e8bcb8)
    
    if (data_143e8bcb8 == 0xffffffff)
        ...
        data_143e8bcb0 = rax_12
        _Init_thread_footer(&data_143e8bcb8)

if (data_143e8bcd8 s> *rdi_1)
    _Init_thread_header(&data_143e8bcd8)
    
    if (data_143e8bcd8 == 0xffffffff)
        ...
        data_143e8bcd0 = rax_15
        _Init_thread_footer(&data_143e8bcd8)
...
if ((rbx_1 != 0 || (*(rdi_2 + (rbx << 2)) & 0xfffffffd) == 0) && sub_1412c5a20(arg1).b != 0)
