...
var_138
void** rax_8 = sub_14058b120(std::ostream::operator<<(sub_14058b120(
    sub_14058bab0(&var_138, rax_4, r8), &(*"\tv 0")[3])), &data_142d63b88)
pow(2.0, _mm_cvtepi32_pd(zx.q(*(arg1 + 0x24))))
std::ostream::operator<<(rax_8)
int64_t var_30
...
if ((rcx_11 & 2) == 0 && r8_1 != 0)
    if (r8_1 u< var_128:0x60.q)
        r8_1 = var_128:0x60.q
    
    rdx_6 = *var_128:0x18.q
    sub_14058ad40(arg2, rdx_6, r8_1 - rdx_6)
else if ((rcx_11 & 4) == 0)
