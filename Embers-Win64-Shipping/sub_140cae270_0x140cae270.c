...
if (rax_7 != 0)
    ...
    if ((*(arg1 + 0x2b) & 8) != 0 && rax_7 s> 0x49249)
        *(arg1 + 0x29) = rcx_3 | 1
        return arg1
    ...
    if ((arg1[5].b & 1) != 0)
        ...
        do
            ...
            int64_t rcx_6 = rbp_1 * 0x38
            void* const rax_9
            
            if (rcx_6 == neg.q(*arg2))
                rax_9 = nullptr
            else
                rax_9 = sub_140cd3bc0(rcx_6 + *arg2)
            
            sub_140cd4a70(arg1, rax_9, arg3)
            r14 += 1
        while (r14 s< arg_8)
    ...
    if (rax_7 s> 0)
        do
            sub_140cd4a70(arg1, sx.q(i) * 0x38 + *arg2, arg3)
            i += 1
        while (i s< arg2[1].d)
