...
if (data_143e2cbe0 s> *rdi_1)
    _Init_thread_header(&data_143e2cbe0)
    
    if (data_143e2cbe0 == 0xffffffff)
        ...
        data_143e2cbd8 = rax_8
        _Init_thread_footer(&data_143e2cbe0)

if (data_143e2cbf0 s> *rdi_1)
    _Init_thread_header(&data_143e2cbf0)
    
    if (data_143e2cbf0 == 0xffffffff)
        ...
        data_143e2cbe8 = rax_11
        _Init_thread_footer(&data_143e2cbf0)

int64_t rdi_2 = data_143e2cbe8
int64_t rcx
