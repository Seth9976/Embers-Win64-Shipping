...
if (result.d != 0)
        ...
        if (i != 0)
            ...
            if (r10_2.d != result.d)
                ...
                if (rdi_2 != 0xffffffff)
                    ...
                    int32_t rcx_7 = rax_5 - r10_2.d
                    
                    if (rcx_7 != rdi_2 + 1)
                        int64_t r9_2 = *(arg1 + 8)
                        memmove(r9_2 + r10_2 * 0xc, r9_2 + sx.q(r10_2.d + rdi_2 + 1) * 0xc, 
                            (rcx_7 - (rdi_2 + 1)) * 0xc)
                        rax_5 = *(arg1 + 0x10)
                    
                    *(arg1 + 0x10) = rax_5 - (rdi_2 + 1)
            ...
            if (rsi_2 != 0xffffffff)
                ...
                if (rcx_1 != rsi_2 + 1)
                    int64_t r9_1 = *(arg1 + 8)
                    memmove(r9_1 + r10_1 * 0xc, r9_1 + sx.q(r10_1.d + rsi_2 + 1) * 0xc, 
                        (rcx_1 - (rsi_2 + 1)) * 0xc)
                    rax = *(arg1 + 0x10)
    ...
    if (*(arg1 + 0x14) != rdx_2)
        return sub_140638cc0(arg1 + 8, rdx_2)
