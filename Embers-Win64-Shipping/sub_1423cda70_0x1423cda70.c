...
label_1423cdacd:
    ...
    void* rax_5 = sub_140d2f240(sub_1424bf360(), 0, rbp_1, 0, 0, 0)
    ...
    *arg2 = rax_5
    ...
    label_1423cdb54:
        ...
        void* rax_11 = sub_140d2f240(sub_1424bf360(), 0, rdi_1, 0, 0, 0)
        ...
        *arg2 = rax_11
        ...
        void* rax_6 = sub_1424bf360()
        
        if (rax_6 == 0)
            goto label_1423cdb54
    ...
    if (*arg2 == 0)
        result = sub_1424bf360()
        *arg2 = result
    else
        void* rax_12 = sub_1424bf360()
