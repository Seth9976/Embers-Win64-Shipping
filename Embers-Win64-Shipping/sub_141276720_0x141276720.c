...
if (data_143e8d6bc s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8d6bc)
    
    if (data_143e8d6bc == 0xffffffff)
        ...
        data_143e8d6b0 = rax_6
        _Init_thread_footer(&data_143e8d6bc)

int64_t rbx = data_143e8d6b0
int64_t rcx
