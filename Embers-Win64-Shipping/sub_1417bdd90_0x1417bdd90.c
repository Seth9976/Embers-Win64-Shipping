...
if (rbx s>= 4)
    ...
    do
        *(r11_1 + (sx.q(*rdx) << 2)) = *(arg1 + 0x1c)
        ...
        zmm2 = *(arg1 + 0x28) f- *(r8 + (rcx_1 << 2) + 4)
        zmm1 = *(arg1 + 0x24) f- *(r8 + (rcx_1 << 2))
        zmm0 = *(arg1 + 0x2c) f- *(r8 + (rcx_1 << 2) + 8)
        ...
        if (not(temp0_1 f>= zmm1))
            ...
            if (not(zmm1 <= 9.99999994e-09f))
                *(r11_1 + (sx.q(*rdx) << 2)) = *(arg1 + 0x10) / zmm1
        
        *(r11_1 + (sx.q(r9_2[-2]) << 2)) = *(arg1 + 0x1c)
        int64_t rcx_3 = sx.q(rdx[1]) * 3
        zmm2 = *(arg1 + 0x28) f- *(r8 + (rcx_3 << 2) + 4)
        zmm1 = *(arg1 + 0x24) f- *(r8 + (rcx_3 << 2))
        zmm0 = *(arg1 + 0x2c) f- *(r8 + (rcx_3 << 2) + 8)
        zmm2 = zmm2 * zmm2 + zmm1 * zmm1
        zmm1 = *(arg1 + 0x20)
        ...
        if (not(temp0_2 f>= zmm1))
            ...
            if (not(zmm1 <= 9.99999994e-09f))
                *(r11_1 + (sx.q(r9_2[-2]) << 2)) = *(arg1 + 0x10) / zmm1
        
        *(r11_1 + (sx.q(*r9_2) << 2)) = *(arg1 + 0x1c)
        int64_t rcx_5 = sx.q(rdx[3]) * 3
        zmm2 = *(arg1 + 0x28) f- *(r8 + (rcx_5 << 2) + 4)
        zmm1 = *(arg1 + 0x24) f- *(r8 + (rcx_5 << 2))
        zmm0 = *(arg1 + 0x2c) f- *(r8 + (rcx_5 << 2) + 8)
        zmm2 = zmm2 * zmm2 + zmm1 * zmm1
        zmm1 = *(arg1 + 0x20)
        ...
        if (not(temp0_3 f>= zmm1))
            ...
            if (not(zmm1 <= 9.99999994e-09f))
                *(r11_1 + (sx.q(*r9_2) << 2)) = *(arg1 + 0x10) / zmm1
        
        *(r11_1 + (sx.q(r9_2[2]) << 2)) = *(arg1 + 0x1c)
        int64_t rcx_7 = sx.q(rdx[5]) * 3
        zmm2 = *(arg1 + 0x28) f- *(r8 + (rcx_7 << 2) + 4)
        zmm1 = *(arg1 + 0x24) f- *(r8 + (rcx_7 << 2))
        zmm0 = *(arg1 + 0x2c) f- *(r8 + (rcx_7 << 2) + 8)
        zmm2 = zmm2 * zmm2 + zmm1 * zmm1
        zmm1 = *(arg1 + 0x20)
...
do
    *(r8_1 + (sx.q(*(rdx_1 + 4)) << 2)) = *(arg1 + 0x1c)
    ...
    if (not(temp0_5 f>= zmm1))
        ...
        if (not(zmm1 <= 9.99999994e-09f))
            *(r8_1 + (sx.q(*(rdx_1 + 4)) << 2)) = *(arg1 + 0x10) / zmm1
