...
if (data_143e8bf60 s> *rdi_1)
    _Init_thread_header(&data_143e8bf60)
    
    if (data_143e8bf60 == 0xffffffff)
        ...
        data_143e8bf58 = rax_12
        _Init_thread_footer(&data_143e8bf60)

if (data_143e8bf70 s> *rdi_1)
    _Init_thread_header(&data_143e8bf70)
    
    if (data_143e8bf70 == 0xffffffff)
        ...
        data_143e8bf68 = rax_15
        _Init_thread_footer(&data_143e8bf70)

if (data_143e8bf80 s> *rdi_1)
    _Init_thread_header(&data_143e8bf80)
    
    if (data_143e8bf80 == 0xffffffff)
        ...
        data_143e8bf78 = rax_18
        _Init_thread_footer(&data_143e8bf80)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8bf58
int64_t rcx
