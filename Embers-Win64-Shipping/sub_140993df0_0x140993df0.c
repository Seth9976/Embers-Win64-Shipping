...
if (rbx_1 != r14_1)
    do
        ...
        int64_t* rax_4 = sub_1409e46d0(&rbx_1[1], &var_28)
        
        if (rax_4[1].d != 0)
            *rax_4
        
        int64_t var_38
        int64_t* rax_5 = sub_1409e46d0(rbx_1, &var_38)
        int16_t* const r8_1
        ...
        sub_140a2e390(&var_48, u"PolygonID:%s, PolygonGroupID:%s", r8_1)
