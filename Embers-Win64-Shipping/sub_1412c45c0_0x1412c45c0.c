...
if (data_143e8ae70 s> *rdi_1)
    _Init_thread_header(&data_143e8ae70)
    
    if (data_143e8ae70 == 0xffffffff)
        ...
        data_143e8ae68 = rax_9
        _Init_thread_footer(&data_143e8ae70)

if (data_143e8ae80 s> *rdi_1)
    _Init_thread_header(&data_143e8ae80)
    
    if (data_143e8ae80 == 0xffffffff)
        ...
        data_143e8ae78 = rax_12
        _Init_thread_footer(&data_143e8ae80)

if (data_143e8ae90 s> *rdi_1)
    _Init_thread_header(&data_143e8ae90)
    
    if (data_143e8ae90 == 0xffffffff)
        ...
        data_143e8ae88 = rax_15
        _Init_thread_footer(&data_143e8ae90)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ae68
int64_t rcx
