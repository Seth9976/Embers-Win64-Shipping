...
label_142651730:
    ...
    if (sub_14264c840(arg1, arg1[1].d - *(arg1 + 0x34), 0) == 0)
        void* r9 = &arg1[7]
        ...
        *(arg4 + 0x38) = *(rax_8 + (((sx.q(arg1[9].d) - 1) & r8_1) << 2))
        void* rax_10 = *(r9 + 8)
    ...
    label_1426516c3:
        ...
        while (true)
            ...
            if (sub_142645ba0(rdi_2 + rax_2, arg4) != 0)
                break
