...
if (data_1439c7a08 s< 3)
    ...
    if (rdi_1 == 1)
        ...
        var_228.d = 1
        sub_141950920(&var_1e8, arg2, temp0_1, 1, var_228.d, arg3)
    else if (rdi_1 == 4)
        ...
        var_228.d = 1
        sub_140fcffc0(&var_1e8, arg2, temp0_1, rdi_1 - 3, var_228)
    result = sub_1419628c0(&var_1e8)
else
    data_143effcd8(0x8c2a, zx.q(*(arg2 + 0x1c)))
    result = data_143f002e0(0x8c2a, zx.q(arg2[4].d), 0x8d99, 0x1406, arg3)
