...
if (*(arg1 + 0x40) == 0)
    ...
    var_b0 = rdx_2
    var_b8 = rax_6 * 2
    bool var_40_2 = rax_6 == neg.d(rax_6)
    void var_88
    (*(*rcx_2 + 0x4d8))(rcx_2, &var_88, &data_143f02b98, 2, var_b8, var_b0, var_a8)
...
if (*(arg1 + 0x10) != 0)
    char rax_10 = sub_142056ae0()
    int64_t rdx_6 = *(arg1 + 0x20)
    result = (*(rdx_6 + 0x30))(arg1 + 0x20, rdx_6) | rax_10
