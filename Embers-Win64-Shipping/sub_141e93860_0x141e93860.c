...
if ((*(arg2 + 0x3a) & 2) != 0)
    sub_1423bc410(arg1, arg2, arg2 + 0x30)

void* rdi_2 = *(arg2 + 0xa0)

if (rdi_2 == 0)
    return 

if ((*(rdi_2 + 0x32) & 2) != 0)
    sub_1423bc410(arg1, rdi_2, rdi_2 + 0x28)

int32_t rcx_1 = 0
int32_t var_84_1 = 1
int32_t var_88_1 = 0
int32_t rdi_3 = *(rdi_2 + 0x1c8)
void* var_80_1 = rdi_2 + 0x1b0
int32_t r8_3 = 0
int32_t var_78_1 = 0xffffffff
int64_t var_74_1 = 0

if (rdi_3 != 0)
    void* rax_1 = *(rdi_2 + 0x1c0)
    void* r9_1 = rdi_2 + 0x1b0
    ...
    label_141e93968:
        ...
        while (true)
            ...
            if (rdx_3 != 0)
                goto label_141e93968
        
        var_74_1.d = rdi_3

int32_t rdx_5 = *(rdi_2 + 0x1c8)
...
var_74_1.d = rdx_5
int128_t var_68 = (rdi_2 + 0x1a0).o
int128_t var_58_1 = var_38_1

if (rdx_5 != rdi_3)
    void* rax_11 = *(rdi_2 + 0x1c0)
    void* r10_1 = rdi_2 + 0x1b0
...
while (true)
    ...
    if (rcx_8.d == (var_78_3.q u>> 0x20).d && var_58_1.q == rdi_2 + 0x1b0 && rax == rdi_2 + 0x1a0)
        break
    
    void* rdx_10 = *(*rax + rcx_8 * 0x10)
    
    if (rdx_10 != 0 && (*(rdx_10 + 0x3a) & 2) != 0 && *(rdx_10 + 0x38) u<= *(arg1 + 8))
        sub_1423bc410(arg1, rdx_10, rdx_10 + 0x30)
