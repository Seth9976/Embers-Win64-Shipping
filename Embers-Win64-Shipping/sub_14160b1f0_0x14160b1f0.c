...
float zmm0[0x4] = *(rax_6 + 0x1c)
float var_29c = 3.40282347e+38f
uint32_t zmm13[0x4]

if (zmm0[0] == 0f)
    zmm13 = zx.o(0)
else
    zmm13 = _mm_and_ps(*(arg1 + 0x28), 0x7fffffff)
...
if (zmm0[0] == 0f)
    ...
    zmm15 = _mm_and_ps(*(arg2 + 0x28), 0x7fffffff)
...
while (true)
    ...
    float zmm4[0x4] = (*rdx)[3]
    zmm2[0] = zmm2[0] * zmm5[0]
    zmm0 = *(rcx_2 + 0x10)
    zmm0[0] = zmm0[0] f* *(rax_9 + 0x28)
    zmm6[0] = zmm6[0] * zmm7[0]
    float var_2c8_1 = zmm0[0]
    zmm0 = *(rcx_2 + 0x14)
    zmm0[0] = zmm0[0] f* *(rax_9 + 0x2c)
    zmm12[0] = zmm12[0] * zmm8[0]
    float var_258_1 = zmm0[0]
    zmm0 = *(rcx_2 + 0x18)
    zmm0[0] = zmm0[0] f* *(rax_9 + 0x30)
    void* rcx_3 = var_228
    var_2c0 = zmm0[0]
    void* rax_10 = *(rcx_3 + 0x10)
    float var_1f0_1 = zmm0[0]
    zmm14[0] = zmm14[0] * zmm5[0]
    ...
    if (zmm3[0] < zmm11[0])
        ...
        zmm2 = *(rax_10 + 0x28)
        r13_1 = r13 | 0x10
        zmm2[0] = zmm2[0] f* *(rax_10 + 0x1c)
        zmm2[0] = zmm2[0] * zmm5[0]
        zmm2[0] = zmm2[0] f+ *(rax_10 + 0x10)
        zmm2[0] = zmm2[0] * zmm4[0]
        zmm2[0] = zmm2[0] f+ *(rax_10 + 0x14)
        zmm2[0] = zmm2[0] f+ *(rax_10 + 0x18)
        var_268 = zmm2[0]
        rax_11 = &var_268
        var_264 = zmm2[0]
        var_260 = zmm2[0]
    ...
    float temp0_12[0x4] = _mm_unpacklo_ps(zmm3, zmm0[0].q)
    zmm2[0] = zmm2[0] * zmm14[0]
    float temp0_13[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xff)
    float temp0_15[0x4] = _mm_unpacklo_ps(temp0_12, _mm_unpacklo_ps(zmm2, zmm11[0].q)[0].q)
    float temp0_17[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_15, temp0_15, 0xc9), temp0_11)
    float temp0_20[0x4] =
        _mm_sub_ps(_mm_mul_ps(_mm_shuffle_ps(temp0_15, temp0_15, 0xd2), temp0_10), temp0_17)
    float temp0_21[0x4] = _mm_add_ps(temp0_20, temp0_20)
    float temp0_22[0x4] = _mm_mul_ps(temp0_13, temp0_21)
    float temp0_24[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_21, temp0_21, 0xc9), temp0_11)
    zmm1 = var_2c0
    float temp0_25[0x4] = _mm_add_ps(temp0_22, temp0_15)
    zmm5 = var_2c8_1
    float temp0_30[0x4] = __addps_xmmps_memps(
        _mm_add_ps(
            _mm_sub_ps(_mm_mul_ps(_mm_shuffle_ps(temp0_21, temp0_21, 0xd2), temp0_10), temp0_24), 
            temp0_25), 
        arg3[1])
    ...
    *(&var_178 + (rcx_4 << 2)) = (_mm_unpacklo_ps(zmm5, zmm7[0].q)).q
    (&var_170)[rcx_4] = var_1f0_1
    *(&var_148 + (rcx_4 << 2)) = (_mm_unpacklo_ps(temp0_30, temp0_32[0].q)).q
    (&var_140)[rcx_4] = var_1e0_1
    int64_t var_118
    *(&var_118 + (rcx_4 << 2)) = (_mm_unpacklo_ps(zmm5, zmm7[0].q)).q
    int32_t var_110
    (&var_110)[rcx_4] = zmm1[0]
    var_1a8.d = rdx_3.d + 1
    
    if (rdx_3.d == 0)
        int64_t rax_24 = sx.q(var_1a8:4.d)
        int64_t rcx_12 = rax_24 * 3
        var_188[rax_24] = 0x3f800000
        zmm0 = zx.o(*(&var_118 + (rcx_12 << 2)))
        var_2b0 = (&var_110)[rcx_12]
    else
        uint64_t* rax_21
        
        if (rdx_3.d == 1)
            rax_21 = sub_1416e69d0(&var_298, &var_118, &var_1a8:4, &var_1a8, &var_188)
        label_14160b798:
            zmm0 = zx.o(*rax_21)
            var_2b0 = rax_21[1].d
            i_7 = var_1a8.d
            ...
            if (rdx_3.d == 2)
                rax_21, zmm11, zmm13, zmm15 = sub_1416fa750(&var_278, &var_118, &var_1a8, &var_188)
                goto label_14160b798
            
            if (rdx_3.d == 3)
                uint64_t var_1b8[0x2]
                rax_21, zmm11, zmm13, zmm15 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
                goto label_14160b798
    ...
    if (zmm3[0] < 9.99999997e-07f || zmm3[0] >= var_29c)
        i_6 = i_7
        zmm1 = zmm3
        var_29c = zmm3[0]
        break
...
if (zmm1[0] <= zmm8[0])
    ...
    float zmm13_1[0x4]
    float zmm15_1[0x4]
    rax_35, zmm8_1, zmm11_1, zmm13_1, zmm15_1 = sub_1415b5810(&var_278, &var_298, &var_230, 
        &var_228, &var_2c0, &var_288, &var_268, &var_2b8)
    float zmm2_1[0x4]
    ...
    if (rax_35 == 2)
        ...
        *arg6 = (_mm_unpacklo_ps(zmm11_1, zmm4_1)).q
        ...
        float zmm3_1[0x4] = var_2b8
        zmm2_1 = var_2b4
        *arg7 = var_288
        float zmm0_2[0x4] = var_2c0
        arg7[2] = var_280
        ...
        *arg4 = zmm0_2[0]
        ...
        zmm13_1[0] = zmm13_1[0] f* arg7[1]
        zmm13_1[0] = zmm13_1[0] f* arg7[2]
        zmm13_1[0] = zmm13_1[0] + var_268
        zmm13_1[0] = zmm13_1[0] + var_264
        zmm13_1[0] = zmm13_1[0] + var_260
        *arg5 = (_mm_unpacklo_ps(zmm13_1, zmm13_1[0].q)).q
        arg5[1].d = zmm13_1[0]
        zmm15_1[0] = zmm15_1[0] f* *arg7
        zmm15_1[0] = zmm15_1[0] f* arg7[1]
    ...
    *arg7 = temp0_39.q
    float temp0_40[0x4] = __sqrtss_xmmss_memss(temp0_39[0], var_29c)
