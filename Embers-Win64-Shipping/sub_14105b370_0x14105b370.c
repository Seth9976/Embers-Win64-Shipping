...
if (*(r12 + 0x1b0) == *(r12 + 0x1dc))
label_14105b450:
    rcx_3 = nullptr
else
    void* rcx_1 = *(r12 + 0x1e8)
    void* r8 = r12 + 0x1e0
    
    if (rcx_1 != 0)
        r8 = rcx_1
    
    int32_t rax_7 = *(r8 + (((sx.q(*(r12 + 0x1f0)) - 1) & sx.q(r14_2)) << 2))
    
    if (rax_7 == 0xffffffff)
    label_14105b450_1:
        rcx_3 = nullptr
    else
        int64_t r8_1 = *(r12 + 0x1a8)
...
void* rsi = *(rcx_3 + 8)
int64_t* rbx = *(rdi + 0xf8)
int64_t* rax_8 = sub_141023a10(*(rdi + 0x70))
int64_t* var_e0 = rbx
char result =
    (*(*rax_8 + 0x760))(rax_8, arg2, zx.q(arg4), zx.q(*(rdi + 0x40)), rdi + 0x208, var_e0, rdx)
void* rbx_2
...
if (result != 0 || (*(rsi + 0x78) & 2) != 0)
    ...
    if (arg2 == 0 || data_143f01c92 == 0)
        var_e0 = &var_98
        var_e8.d = 0
        result, arg5 = sub_14105c9a0(rdi + 0x68, &var_68, 0, 0, 0, var_e0)
    else
        if (*(rdi + 0x120) != 0)
            r15_1 = nullptr
    ...
    if (rcx_18 != 0)
        ...
        var_e8.d = arg6
        result, arg5 = sub_14105b370(rcx_18 - 0x68, arg2, rdi, zx.q(arg4), var_e8, var_e0)
...
return sub_140bb5c10(r12 + 0x1a8, r14_2)
