...
if (data_143e8b070 s> *rdi_1)
    _Init_thread_header(&data_143e8b070)
    
    if (data_143e8b070 == 0xffffffff)
        ...
        data_143e8b068 = rax_9
        _Init_thread_footer(&data_143e8b070)

if (data_143e8b084 s> *rdi_1)
    _Init_thread_header(&data_143e8b084)
    
    if (data_143e8b084 == 0xffffffff)
        ...
        data_143e8b078 = rax_12
        _Init_thread_footer(&data_143e8b084)

if (data_143e8b098 s> *rdi_1)
    _Init_thread_header(&data_143e8b098)
    
    if (data_143e8b098 == 0xffffffff)
        ...
        data_143e8b090 = rax_15
        _Init_thread_footer(&data_143e8b098)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b068
int64_t rcx
...
label_1412c3f03:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412c3efe
        
        rbx.b = 1
        goto label_1412c3f03
