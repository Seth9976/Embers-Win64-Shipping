...
label_141d00e85:
    ...
    if (r8_2 s> 0 && (rax_18 == 0 || rax_18 s< rbp))
        ...
        *(arg4 + 0x5c) = rax_21
        ...
        arg4[0xb].d = *(rax_22 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2))
        void* rax_24 = *(r9_4 + 8)
        
        if (rax_24 != 0)
            r9_4 = rax_24
        
        *(r9_4 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2)) = rdi_3
else
    int32_t r15_1 = -1
    int32_t rbx_1
