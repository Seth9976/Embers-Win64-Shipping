...
uint32_t rax_2 = *(rdi + 0x60) u>> arg4.b
...
label_14105bb30:
    ...
    int32_t rax_5 = *(r8 + (((sx.q(*(r12 + 0x1f8)) - 1) & sx.q(r14_2)) << 2))
...
int64_t* rax_6 = sub_141023a10(*(rdi + 0x78))
int64_t* var_e0 = rbx
char result =
    (*(*rax_6 + 0x760))(rax_6, arg2, zx.q(arg4), zx.q(*(rdi + 0x40)), rdi + 0x210, var_e0, rdx)
void* rbx_2
...
if (result != 0 || (*(rsi + 0x78) & 2) != 0)
    ...
    int32_t rax_9 = *(rdx_6 + 0xa8)
    int64_t rax_10 = *(r15_1 + 0x50)
    ...
    if (rcx_18 != 0)
        ...
        var_e8.d = arg6
        result, arg5 = sub_14105ba50(rcx_18 - 0x70, arg2, rdi, zx.q(arg4), var_e8, var_e0)
