...
while (true)
    ...
    *(&var_178 + (rcx_3 << 2)) = (_mm_unpacklo_ps(zmm5, zmm1[0].q)).q
...
if (zmm1[0] <= zmm8[0])
    ...
    float zmm11_1[0x4]
    float zmm15_1[0x4]
    rax_33, zmm8_1, zmm11_1, zmm15_1 = sub_14155ede0(&var_280, &var_2a0, &var_238, &var_230, 
