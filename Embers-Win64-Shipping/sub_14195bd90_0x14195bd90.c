...
struct _RTL_SRWLOCK r14 = arg1
int32_t rcx = 0
int32_t r11 = *(r14 + 0x28)
int32_t var_98 = 0
int32_t r8 = 0
int32_t var_94 = 1
int32_t* var_90 = r14 + 0x10
int32_t var_88 = 0xffffffff
int64_t var_84 = 0

if (r11 != 0)
    int32_t* rax_2 = *(r14 + 0x20)
    int32_t* r9_1 = r14 + 0x10
...
var_84.d = rdx_4
int128_t Ptr = r14.Ptr.o
int96_t var_68 = var_48:8.12

if (rdx_4 != r11)
    int32_t* rax_12 = *(r14 + 0x20)
    int32_t* r10_1 = r14 + 0x10
...
while (true)
    ...
    if (rax_21.d == (var_88_2.q u>> 0x20).d && var_68.q == r14 + 0x10 && rdx_9 == r14)
        struct _RTL_SRWLOCK rcx_10 = arg1
        int32_t rbx_5 = *(rcx_10 + 8) - *(rcx_10 + 0x34)
        sub_140865470(rcx_10, 0)
        *arg3 = r13
        return zx.q(rbx_5)
    
    int64_t* rcx_8 = *(*rdx_9 + rax_21 * 0x18 + 8)
