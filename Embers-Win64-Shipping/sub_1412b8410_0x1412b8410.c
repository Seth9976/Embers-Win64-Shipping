...
if (data_143e8b928 s> *rdi_1)
    _Init_thread_header(&data_143e8b928)
    
    if (data_143e8b928 == 0xffffffff)
        ...
        data_143e8b920 = rax_9
        _Init_thread_footer(&data_143e8b928)

if (data_143e8b948 s> *rdi_1)
    _Init_thread_header(&data_143e8b948)
    
    if (data_143e8b948 == 0xffffffff)
        ...
        data_143e8b940 = rax_12
        _Init_thread_footer(&data_143e8b948)

if (data_143e8b968 s> *rdi_1)
    _Init_thread_header(&data_143e8b968)
    
    if (data_143e8b968 == 0xffffffff)
        ...
        data_143e8b960 = rax_15
        _Init_thread_footer(&data_143e8b968)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b920
int64_t rcx
...
label_1412b8513:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412b850e
        
        rbx.b = 1
        goto label_1412b8513
