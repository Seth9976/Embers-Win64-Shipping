...
if (arg3 == 0)
    ...
    label_1406bca0b:
        ...
        *arg2 = 0
        ...
        sub_140596d10(arg2, rdi * 0xa8 + 0x80 + *(arg1 + 0x48))
else if (arg3 == 1)
    if (rdi.d s< 0 || rdi.d s>= *(arg1 + 0x90))
        goto label_1406bca0b
    
    sub_140596d10(arg2, rdi * 0xa8 + 0x80 + *(arg1 + 0x88))
else if (arg3 == 2)
    if (rdi.d s< 0 || rdi.d s>= *(arg1 + 0x130))
        goto label_1406bca0b
    
    sub_140596d10(arg2, rdi * 0xa8 + 0x80 + *(arg1 + 0x128))
else
    if (arg3 != 6 || rdi.d s< 0 || rdi.d s>= *(arg1 + 0x190))
        goto label_1406bca0b
    
    sub_140596d10(arg2, rdi * 0xa8 + 0x80 + *(arg1 + 0x188))
