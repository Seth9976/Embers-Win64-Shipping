...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_11[4]
    sub_140d30490(arg2, &var_158, r8_11)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_15[4]
    sub_140d30490(arg2, &var_c8, r8_15)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_17[4]
    sub_140d30490(arg2, &var_168, r8_17)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_19[4]
    sub_140d30490(arg2, &var_f8, r8_19)
else
...
int32_t var_170 = var_164.d
uint128_t* var_178 = &var_e8
int128_t var_d8
int128_t* var_180 = &var_d8
int64_t* rcx_13 = var_160
char var_188 = r15.b
int32_t var_130
...
var_d8 = zmm1
char result = sub_1420cb790(rcx_13, &var_118, &var_128, r9, r12.b, r14, rax_18, rsi)
int64_t rcx_14 = var_158
*arg3 = result
