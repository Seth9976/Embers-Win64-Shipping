...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        ...
        zmm1_1 = sub_141cd3d10(arg1, rbx_3 + 8, zmm1_1)
        int32_t var_4c
...
do
    ...
    *(rsi_5 + 0x10) = 5
    *(rsi_5 + 0x18) = 0
    *(rsi_5 + 8) = &data_142e40558
    __builtin_memset(rsi_5 + 0x20, 0, 0x11)
    int512_t zmm1 = sub_1409dd4f0(rsi_5 + 8, 0)
    *(rsi_5 + 0x38) = 0xffffffff
    (*(*arg1 + 0x140))(arg1, rsi_5)
    sub_141cd3d10(arg1, rsi_5 + 8, zmm1)
    r15 += 1
while (r15 s< arg_8)
