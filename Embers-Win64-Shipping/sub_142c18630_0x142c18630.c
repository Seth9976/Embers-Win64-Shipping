...
if (sub_142bf7510(arg2, arg1, 6) != 0 && sub_142bf7510(arg2, &arg1[4], 2) != 0)
    ...
    if (rax != 0)
        ...
        if (((arg1[3] & 0x10) == 0 || rax != 0)
                && sub_142c17d00(&arg1[4], arg2, arg1, (zx.d(*arg1) << 8) + zx.d(arg1[1])) != 0)
            int32_t rbx_2
            int32_t rsi_3
            uint32_t rdi_1
            
            if (zx.w(*arg1) * 0x100 + zx.w(arg1[1]) == 7)
            ...
            if (zx.w(*arg1) * 0x100 + zx.w(arg1[1]) != 7 || rsi_3 u<= 1)
            label_142c1878b:
                result.b = 1
            else
                while (true)
