...
float zmm2[0x4] = arg4[1].d
float temp0[0x4] = __mulps_xmmps_memps(data_143cdbe60, *rax_3)
uint128_t zmm7 = *arg4 | zmm2[0].q << 0x40
...
float temp0_7[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm7, zmm7, 0xd2), temp0_5)
float temp0_8[0x4] = _mm_shuffle_ps(temp0, temp0, 0xff)
float temp0_9[0x4] = _mm_sub_ps(temp0_7, zmm0)
zmm0 = _mm_mul_ps(temp0_1, temp0_1)
float temp0_11[0x4] = _mm_add_ps(temp0_1, temp0_1)
float temp0_12[0x4] = _mm_add_ps(temp0_9, temp0_9)
...
float temp0_26[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_12, temp0_12, 0xd2), temp0_5)
...
arg2[1].d = _mm_shuffle_ps(temp0_30, temp0_30, 0xaa)[0]
*(arg2 + 4) = zmm0.d
return arg2
