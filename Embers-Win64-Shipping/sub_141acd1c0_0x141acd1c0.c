...
float* rbx_2 = (sx.q((*arg1)[0xe]) << 5) + *(arg1[3][0].q i+ 0x70)
float zmm15[0x4] = arg1[2]
uint32_t result = _mm_movemask_ps(_mm_cmpeq_ps(_mm_min_ps(zmm15, zmm13), data_143f2b8d0, 1))
float zmm6[0x4]
float zmm7[0x4]
float zmm3[0x4]
...
*rbx_2 = zmm6[0]
rbx_2[1] = _mm_shuffle_ps(zmm6, zmm6, 0x55)[0]
rbx_2[2] = _mm_shuffle_ps(zmm6, zmm6, 0xaa)[0]
float temp0_169[0x4] = _mm_shuffle_ps(zmm7, zmm7, 0x55)
rbx_2[3] = _mm_shuffle_ps(zmm6, zmm6, 0xff)[0]
rbx_2[4] = zmm7[0]
rbx_2[6] = _mm_shuffle_ps(zmm7, zmm7, 0xaa)[0]
rbx_2[5] = temp0_169[0]
rbx_2[7].b = 1
return result
