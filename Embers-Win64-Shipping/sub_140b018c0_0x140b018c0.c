...
if (rdi s< result)
    if (*(arg1 + 0x34) s> 0)
        ...
        if (rdx_1.d != 0xffffffff)
            do
                int64_t r9_1 = *arg1
                int64_t rcx_2 = sx.q(rdx_1.d) * 6
                
                if (rdx_1.d s< rdi)
                    rdx_1 = zx.q(*(r9_1 + (rcx_2 << 3) + 4))
                else
                    rdx_1 = sx.q(*(r9_1 + (rcx_2 << 3) + 4))
                    int64_t r8_1 = sx.q(*(r9_1 + (rcx_2 << 3)))
                    
                    if (rdx_1.d != 0xffffffff)
                        *(r9_1 + rdx_1 * 0x30) = r8_1.d
                    
                    if (r8_1.d == 0xffffffff)
                        *(arg1 + 0x34) -= 1
                        arg1[6].d = rdx_1.d
                    else
                        *(*arg1 + r8_1 * 0x30 + 4) = rdx_1.d
                        *(arg1 + 0x34) -= 1
...
return sub_1405a5220(arg1, rdx_3)
