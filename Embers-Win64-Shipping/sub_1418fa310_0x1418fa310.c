...
if (arg1[1].d != *(arg1 + 0x34))
    ...
    rax_20 = *(r9_1 + (((sx.q((rbp_1 << 8 ^ r14_1) << 8 ^ r11_8 u>> 0xf)
...
label_1418fa426:
    *arg2 = 0xffffffff
    ...
    while (true)
        int64_t rcx_6 = sx.q(rax_20) << 5
        
        if (*(rcx_6 + rdx_3) == r15_1 && *(rcx_6 + rdx_3 + 8) == rbp_1
                && *(rcx_6 + rdx_3 + 0xc) == r14_1)
            *arg2 = rax_20
            break
        
        rax_20 = *(rcx_6 + rdx_3 + 0x18)
        
        if (rax_20 == 0xffffffff)
            goto label_1418fa426
