...
if ((arg1[5].b & 1) == 0)
    ...
    uint32_t r14_5 = (r15_2 + 0x1f) u>> 5
    
    if (r14_5 u<= 4)
        var_88.q = 0
        int64_t var_80_2 = 0
    else
        sub_1405a4a00(&var_88, 0, r14_5, 4)
        int64_t* r12_1 = &var_88
        uint32_t var_6c_2 = r14_5 << 5
        
        if (var_78_1 != 0)
            r12_1 = var_78_1
        
        if (r14_5 u> 8)
            memset(r12_1, 0, zx.q(r14_5) << 2)
        else if (r14_5 != 0)
            __builtin_memset(r12_1, 0, zx.q(r14_5) << 2)
        
        void* rdx_15 = r12_1 + (zx.q(r14_5 - 1) << 2)
        r12 = &arg2[2]
        *rdx_15 &= 0xffffffff u>> ((neg.d(r15_2)).b & 0x1f)
        r8_9 = var_78_1
    ...
    if (r15_2 s> 0)
        ...
        do
            void* rax_15 = arg2[4]
            void* rcx_18 = r12
            uint64_t rdx_17 = zx.q(rbx) u>> 5
            
            if (rax_15 != 0)
                rcx_18 = rax_15
            
            if ((*(rcx_18 + (rdx_17 << 2)) & rdi_7) != 0)
                int64_t* rax_16 = &var_88
                
                if (r8_9 != 0)
                    rax_16 = r8_9
                
                *(rax_16 + (rdx_17 << 2)) |= rdi_7
                r8_9 = var_78_1
    ...
    for (int32_t i = i_1; i s< *(var_58 + 0x18); i = i_1)
        uint64_t* rdi_10 = (sx.q(i) << 5) + *var_68
        ...
        if ((arg1[5].b & 1) != 0)
            ...
            if (rax_19 s< 0x11)
                sub_1409ac9a0(arg1, rdi_10, zmm1_1)
                sub_1409ac9a0(arg1, &rdi_10[2], zmm1_1)
    ...
    label_141cd4e34:
        ...
        if (r14 s< var_50_1)
            while (true)
                int32_t var_98[0x4]
                int64_t rcx_6 = *(sub_1409cafd0(arg2, &var_98, r14) + 8)
                
                if (rcx_6 != 0)
                    __builtin_memset(rcx_6, 0, 0x20)
                
                int64_t r14_3 = (sx.q(r14) << 5) + *arg2
                ...
                if ((arg1[5].b & 1) != 0)
                    ...
                    if (rax_9 s< 0x11)
                        sub_1409ac9a0(arg1, r14_3, zmm1)
                        sub_1409ac9a0(arg1, r14_3 + 0x10, zmm1)
