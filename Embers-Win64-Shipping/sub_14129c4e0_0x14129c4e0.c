...
if (data_143e8d288 s> *rdi_1)
    _Init_thread_header(&data_143e8d288)
    
    if (data_143e8d288 == 0xffffffff)
        ...
        data_143e8d280 = rax_9
        _Init_thread_footer(&data_143e8d288)

if (data_143e8d2a8 s> *rdi_1)
    _Init_thread_header(&data_143e8d2a8)
    
    if (data_143e8d2a8 == 0xffffffff)
        ...
        data_143e8d2a0 = rax_12
        _Init_thread_footer(&data_143e8d2a8)

if (data_143e8d2c8 s> *rdi_1)
    _Init_thread_header(&data_143e8d2c8)
    
    if (data_143e8d2c8 == 0xffffffff)
        ...
        data_143e8d2c0 = rax_15
        _Init_thread_footer(&data_143e8d2c8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d280
int64_t rcx
...
label_14129c5e3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_14129c5de
        
        rbx.b = 1
        goto label_14129c5e3
