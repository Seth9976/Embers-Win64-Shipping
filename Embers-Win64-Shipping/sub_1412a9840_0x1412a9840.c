...
if (data_143e8e630 s> *rdi_1)
    _Init_thread_header(&data_143e8e630)
    
    if (data_143e8e630 == 0xffffffff)
        ...
        data_143e8e628 = rax_12
        _Init_thread_footer(&data_143e8e630)

if (data_143e8e640 s> *rdi_1)
    _Init_thread_header(&data_143e8e640)
    
    if (data_143e8e640 == 0xffffffff)
        ...
        data_143e8e638 = rax_15
        _Init_thread_footer(&data_143e8e640)

if (data_143e8e650 s> *rdi_1)
    _Init_thread_header(&data_143e8e650)
    
    if (data_143e8e650 == 0xffffffff)
        ...
        data_143e8e648 = rax_18
        _Init_thread_footer(&data_143e8e650)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e628
int64_t rcx
...
label_1412a9938:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412a9933
    
    rbx.b = 1
    goto label_1412a9938
