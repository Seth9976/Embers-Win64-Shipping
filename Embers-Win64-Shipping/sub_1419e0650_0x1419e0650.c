...
if (rbx != 0)
    ...
    label_1419e06fc:
        ...
        while (true)
            ...
            if (rcx != 0)
                goto label_1419e06fc
        
        var_84.d = rbx

int32_t rdx_2 = *(arg1 + 0x248)
...
var_84.d = rdx_2
int128_t var_78 = (arg1 + 0x220).o
int96_t var_68 = var_48:8.12

if (rdx_2 != rbx)
    void* rax_11 = *(arg1 + 0x240)
    void* r10_2 = arg1 + 0x230
...
while (true)
    ...
    if (rax_20.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0x230 && rdx_7 == arg1 + 0x220)
        return sub_141dba200(arg1, arg2) __tailcall
    
    void* rbx_1 = *rdx_7 + rax_20 * 0x18
    (*(*arg2 + 0x38))(arg2, rbx_1, arg1, 0, var_98, arg1 + 0x230, var_88_2)
    int64_t* rcx_10 = *(*(rbx_1 + 8) + 8)
    
    if (rcx_10 != 0)
        (*(*rcx_10 + 8))(rcx_10, arg1, arg2)
