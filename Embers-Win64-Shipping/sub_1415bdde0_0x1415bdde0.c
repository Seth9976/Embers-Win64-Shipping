...
rax_3, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13 =
    sub_1416e02d0(arg1, arg2, arg3, arg4, var_288)
int32_t rsi_1
...
if (rax_3 != 0)
    ...
    label_1415be971:
        zmm6_2, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm14, zmm15 =
            sub_14154a2a0(*arg1, *arg2, &var_130, arg7, arg8, var_1a0, arg10)
        rsi_1 = 1
    else
        while (true)
            zmm1_1 = 0x80000000
            ...
            if (rdx_5 s< 0x80)
                ...
                label_1415be922:
                    ...
                    float zmm2_1[0x4] = rdi_5[3] ^ zmm1_1
                    ...
                    float var_188
                    sub_141758e70(rcx_14, &var_188, &var_218, zx.o(0))
                    int128_t* rax_24 = r14[1]
                    float zmm6_1[0x4] = var_188
                    float zmm5_2[0x4] = *rax_24
                    zmm12 = rdi_5[6]
                    int32_t var_184
                    float temp0_6[0x4] = _mm_unpacklo_ps(var_184, 0)
                    int32_t var_180
                    float temp0_7[0x4] = _mm_unpacklo_ps(zmm6_1, var_180.q)
                    ...
                    if (not(arg6[0] f< zmm12.d))
                        ...
                        *(rcx_16 + (r14_3 << 2)) = var_1d0_1.q
                        *(rcx_16 + (r14_3 << 2) + 8) = var_1c8_1
                        ...
                        if (r13_3.d s>= 3)
                            ...
                            if (r13_3.d s> 0)
                                ...
                                do
                                    ...
                                    int32_t var_1e4_1 = rax_51.d
                                    int64_t rcx_25 = rax_51 * 3
                                    zmm10 = *(rdx_19 + (rcx_25 << 2))
                                    zmm10[0] = zmm10[0] f- *(r8_12 + (rcx_25 << 2))
                                    zmm7 = *(rdx_19 + (rcx_25 << 2) + 4)
                                    zmm7[0] = zmm7[0] f- *(r8_12 + (rcx_25 << 2) + 4)
                                    ...
                                    float zmm4_1[0x4] = *(rdx_19 + (rcx_26 << 2) + 4)
                                    ...
                                    *(r10_8 + (rsi_3 << 2) + 0x28) = 0
                                    ...
                                    if (not(zmm0_1[0] f< zmm12.d) && not(zmm0_1[0] > arg6[0]))
                                        char rax_58
                                        rax_58, zmm12, arg6 = sub_141743d50(r9_5, *arg1, *r15)
                            ...
                            goto label_1415be922
            
        label_1415be93b:
            rdi_1 = var_268
            goto label_1415be971
