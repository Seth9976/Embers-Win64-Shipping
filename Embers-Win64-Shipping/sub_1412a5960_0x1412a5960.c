...
if (data_143e8a9d0 s> *rdi_1)
    _Init_thread_header(&data_143e8a9d0)
    
    if (data_143e8a9d0 == 0xffffffff)
        ...
        data_143e8a9c8 = rax_12
        _Init_thread_footer(&data_143e8a9d0)

if (data_143e8a9e0 s> *rdi_1)
    _Init_thread_header(&data_143e8a9e0)
    
    if (data_143e8a9e0 == 0xffffffff)
        ...
        data_143e8a9d8 = rax_15
        _Init_thread_footer(&data_143e8a9e0)

if (data_143e8a9f0 s> *rdi_1)
    _Init_thread_header(&data_143e8a9f0)
    
    if (data_143e8a9f0 == 0xffffffff)
        ...
        data_143e8a9e8 = rax_18
        _Init_thread_footer(&data_143e8a9f0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8a9c8
int64_t rcx
...
label_1412a5a58:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412a5a53
    
    rbx.b = 1
    goto label_1412a5a58
