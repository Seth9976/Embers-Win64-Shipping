...
label_1425cd801:
    ...
    if (r8_4 s> 0 && (rax_18 == 0 || rax_18 s< rbp))
        ...
        *(arg4 + 0xa4) = rax_21
        ...
        arg4[0x14].d = *(rax_22 + (((sx.q(arg1[9].d) - 1) & r8_5) << 2))
        void* rax_24 = *(r9_2 + 8)
    ...
    label_1425cd729:
        ...
        while (true)
            ...
            rcx_1 = *arg1
            rbx_1 = *(rdi_1 + rcx_1 + 0xa0)
            
            if (rbx_1 == 0xffffffff)
                goto label_1425cd729
    ...
    if (rbx_1 == 0xffffffff)
        ...
        int64_t* rdi_3 = sx.q(rbx_1) * 0xb0 + *arg1
        sub_140746680(&rdi_3[2])
        int64_t rcx_4 = *rdi_3
        
        if (rcx_4 != 0)
            sub_140a74f90(rcx_4)
        
        memmove(rdi_3, arg4, 0xa0)
        int64_t rcx_6 = sx.q(arg5)
        void* r10_1 = &arg1[2]
        
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0xb0 + *arg1) = rcx_6.d
        
        int32_t* rax_8 = rcx_6 * 0xb0 + *arg1
        *rax_8 = 0xffffffff
