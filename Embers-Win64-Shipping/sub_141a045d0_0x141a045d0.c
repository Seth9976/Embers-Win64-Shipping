...
if (arg3 != 0 || ((arg2[5].b & 2) != 0 && arg2[0xe] == 0) || (*(arg2 + 0x29) & 0x20) != 0)
    (*(*arg2 + 8))(arg2, sx.q(arg1[1].d) * 2, sx.q(*(arg1 + 0xc)) * 2)
    uint32_t result_2 = 0
    ...
    if (result_4 != 0)
        ...
        if ((result.b & 1) == 0 && result_4 s> 0
                && ((*(arg2 + 0x2b) & 8) == 0 || result_4 s<= 0x800000))
            arg1[1].d = result_4
            
            if ((arg2[5].b & 1) != 0)
                sub_1405a4c70(arg1, result_4, *(arg1 + 0xc))
                result_4 = arg1[1].d
            
            return (*(*arg2 + 0x150))(arg2, *arg1, sx.q(result_4) * 2)
