...
if (data_143e8e4b0 s> *rdi_1)
    _Init_thread_header(&data_143e8e4b0)
    
    if (data_143e8e4b0 == 0xffffffff)
        ...
        data_143e8e4a8 = rax_9
        _Init_thread_footer(&data_143e8e4b0)

if (data_143e8e4c0 s> *rdi_1)
    _Init_thread_header(&data_143e8e4c0)
    
    if (data_143e8e4c0 == 0xffffffff)
        ...
        data_143e8e4b8 = rax_12
        _Init_thread_footer(&data_143e8e4c0)

if (data_143e8e4d0 s> *rdi_1)
    _Init_thread_header(&data_143e8e4d0)
    
    if (data_143e8e4d0 == 0xffffffff)
        ...
        data_143e8e4c8 = rax_15
        _Init_thread_footer(&data_143e8e4d0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8e4a8
int64_t rcx
