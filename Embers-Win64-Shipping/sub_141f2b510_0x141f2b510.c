...
if (rax == 0 || (result & 1) != 0)
    ...
    *(*(arg1 + 0x408) + 0x8c) = 2
    ...
    int64_t var_48_1 = data_143dbb1f8.q
    int64_t zmm0_1 = data_143dbb208
    int32_t var_64_1 = 1
    int32_t var_58_1 = 6
    var_78 = &data_142e3e618
    ...
    *(rdi_1 + 0x40) = rax_43
    ...
    if (rax_43 s> *(rdi_1 + 0x44))
        sub_1407755b0(rdi_1 + 0x38)
    
    void*** rcx_20 = rsi_1 * 0x58 + *(rdi_1 + 0x38)
    *rcx_20 = &data_142e3e610
    rcx_20[1].d = var_70_1.d
    *(rcx_20 + 0xc) = var_6c_1
    *(rcx_20 + 0x14) = var_64_1
    rcx_20[3].b ^= (var_60_1 ^ rcx_20[3].b) & 1
    rcx_20[4].d = 6
    rcx_20[5] = rcx_20
    *rcx_20 = &data_142e3e618
    rcx_20[6] = var_48_1
    rcx_20[7].d = rax_41
    *(rcx_20 + 0x3c) = zmm0_1
    *(rcx_20 + 0x44) = rax_42
    rcx_20[9].d = var_30_1.d
    *(rcx_20 + 0x4c) = var_2c_1
    rcx_20[0xa].d = var_28_1.d
    ...
    *(arg1 + 0x41c) &= 0xf7
    ...
    if (result != 0)
        arg_8 = arg1
        void** var_80_1 = &arg_8
        int64_t (* var_88)(int64_t* arg1) = j_sub_141f2faa0
        return sub_14226a4e0(sub_142216820(arg1 + 0x2a8), &var_88)
