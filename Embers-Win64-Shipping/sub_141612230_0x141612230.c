...
while (true)
    ...
    zmm14[0] = zmm14[0] f* *(rbx + 0x2c)
    float var_238 = (zmm13 ^ zmm4)[0]
    zmm12[0] = zmm12[0] f* *(rbx + 0x30)
    float var_234_1 = (zmm14 ^ zmm4)[0]
    float var_230_1 = (zmm12 ^ zmm4)[0]
    zmm11 = sub_141758e70(rcx_2, &var_288, &var_238, zmm11)
    zmm10 = zmm13
    zmm0 = var_288
    ...
    zmm14[0] = zmm14[0] f* *(rcx_3 + 0x28)
    zmm4[0] = zmm4[0] + zmm14[0]
    zmm10[0] = zmm10[0] - zmm12[0]
    zmm4[0] = zmm4[0] * zmm14[0]
    zmm14[0] = zmm14[0] f* *(rax_9 + 0x1c)
    ...
    float temp0_11[0x4] = _mm_unpacklo_ps(zmm3, zmm0[0].q)
    zmm2[0] = zmm2[0] * zmm13[0]
    float temp0_12[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xff)
    float temp0_14[0x4] = _mm_unpacklo_ps(temp0_11, _mm_unpacklo_ps(zmm2, zmm11[0].q)[0].q)
    float temp0_16[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_14, temp0_14, 0xc9), temp0_10)
    float temp0_19[0x4] =
        _mm_sub_ps(_mm_mul_ps(_mm_shuffle_ps(temp0_14, temp0_14, 0xd2), temp0_9), temp0_16)
    float temp0_20[0x4] = _mm_add_ps(temp0_19, temp0_19)
    float temp0_21[0x4] = _mm_mul_ps(temp0_12, temp0_20)
    float temp0_22[0x4] = _mm_shuffle_ps(temp0_20, temp0_20, 0xd2)
    float temp0_24[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_20, temp0_20, 0xc9), temp0_10)
    float temp0_25[0x4] = _mm_mul_ps(temp0_22, temp0_9)
    float temp0_26[0x4] = _mm_add_ps(temp0_21, temp0_14)
    zmm5 = var_2e8_1
    zmm1 = var_2e4
    float temp0_29[0x4] =
    ...
    *(&var_118 + (rcx_4 << 2)) = (_mm_unpacklo_ps(zmm5, zmm7[0].q)).q
    ...
    if (rdx_3.d == 0)
        ...
        var_2c8_1 = (&var_110)[rcx_12]
    else
        uint64_t* rax_20
        
        if (rdx_3.d == 1)
            rax_20 = sub_1416e69d0(&var_2c0, &var_118, &var_1a8:4, &var_1a8, &var_188)
        label_14161280c:
            zmm0 = zx.o(*rax_20)
            var_2c8_1 = rax_20[1].d
            i_7 = var_1a8.d
        else
            if (rdx_3.d == 2)
                rax_20, zmm11, zmm15 = sub_1416fa750(&var_2a0, &var_118, &var_1a8, &var_188)
                goto label_14161280c
            
            if (rdx_3.d == 3)
                uint64_t var_1b8[0x2]
                rax_20, zmm11, zmm15 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
                goto label_14161280c
    ...
    if (zmm3[0] < 9.99999997e-07f || zmm3[0] >= var_2d4)
        i_6 = i_7
        zmm1 = zmm3
        var_2d4 = zmm3[0]
        break
...
if (zmm1[0] <= zmm8[0])
    ...
    if (var_2b8_1:4.d s< 8)
        sub_14083ad30(&var_2c0, 8)
    ...
    if (i_6 s> 0)
        ...
        do
            int64_t rsi_2 = sx.q(var_298_1.d)
            int32_t rax_30 = (rsi_2 + 1).d
            var_298_1.d = rax_30
            
            if (rax_30 s> var_298_1:4.d)
            ...
            *(rcx_19 + (rdx_13 << 2) + 8) = rax_31
            int64_t rsi_3 = sx.q(var_2b8_1.d)
            int32_t rax_32 = (rsi_3 + 1).d
            var_2b8_1.d = rax_32
            
            if (rax_32 s> var_2b8_1:4.d)
                sub_14083a7e0(&var_2c0)
            
            uint64_t rcx_21 = var_2c0
    ...
    float zmm11_1[0x4]
    float zmm15_1[0x4]
    rax_34, zmm8_1, zmm11_1, zmm15_1 = sub_1415aaed0(&var_2a0, &var_2c0, &var_240, &var_228, 
        &var_2e4, &var_2b0, &var_278, &var_288)
    float zmm2_1[0x4]
    ...
    if (rax_34 == 2)
        ...
        *arg6 = (_mm_unpacklo_ps(zmm11_1, zmm4_1)).q
        ...
        float temp3_1 = *arg4
        zmm8_1 - temp3_1
        uint64_t rcx_27 = var_2c0
        rbx.b = zmm8_1 < temp3_1
        
        if (rcx_27 != 0)
            sub_140a74f90(rcx_27)
        
        uint64_t rcx_28 = var_2a0
        ...
        zmm2_1 = arg8
        float zmm3_1[0x4] = var_288
        *arg7 = var_2b0
        float zmm0_2[0x4] = var_2e4
        ...
        *arg4 = zmm0_2[0]
        ...
        zmm2_1[0] = zmm2_1[0] f* arg7[1]
        zmm2_1[0] = zmm2_1[0] f* arg7[2]
        zmm2_1[0] = zmm2_1[0] + var_278
        zmm2_1[0] = zmm2_1[0] + var_274
        zmm2_1[0] = zmm2_1[0] + var_270
        *arg5 = (_mm_unpacklo_ps(zmm2_1, zmm2_1[0].q)).q
        float var_2d8_5 = zmm2_1[0]
        zmm2_1 = var_284
        arg5[1].d = var_2d8_5
        zmm15_1[0] = zmm15_1[0] f* *arg7
        zmm15_1[0] = zmm15_1[0] f* arg7[1]
