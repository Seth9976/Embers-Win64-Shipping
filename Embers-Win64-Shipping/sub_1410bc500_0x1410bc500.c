...
if (data_143e2d010 s> *rdi_1)
    _Init_thread_header(&data_143e2d010)
    
    if (data_143e2d010 == 0xffffffff)
        ...
        data_143e2d008 = rax_8
        _Init_thread_footer(&data_143e2d010)

if (data_143e2d020 s> *rdi_1)
    _Init_thread_header(&data_143e2d020)
    
    if (data_143e2d020 == 0xffffffff)
        ...
        data_143e2d018 = rax_11
        _Init_thread_footer(&data_143e2d020)

int64_t rdi_2 = data_143e2d018
int64_t rcx
