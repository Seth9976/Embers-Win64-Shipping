...
while (true)
    ...
    if (r15_1 == 0)
    label_14237bf87:
        sub_14237b5a0(r10_1, rax_8, zx.q(arg3), arg4)
    else
        while (true)
            if (rax_8 s<= 8)
                for (; i u> r10_1; i -= 4)
                    ...
                    if (&r10_1[1] u<= i)
                        ...
                        do
                            ...
                            int32_t r9_2 = *(rsi_3 * 0xd8 + rbp_3 + 0x90)
                            int32_t temp1_1 = *(r11_3 * 0xd8 + rbp_3 + 0x90)
                            int64_t rcx_18
            ...
            *r10_1 = rcx_3
            ...
            while (true)
                ...
                if (r8 u<= i)
                    ...
                    int64_t rdx_1 = **arg4
                    int32_t rbp_1 = *(rsi_1 * 0xd8 + rdx_1 + 0x90)
                    int32_t temp0_3 = *(r11_1 * 0xd8 + rdx_1 + 0x90)
                ...
                while (true)
                    ...
                    int64_t rdx_2 = **arg4
                    int32_t rbp_2 = *(rsi_2 * 0xd8 + rdx_2 + 0x90)
                    int32_t temp2_1 = *(r11_2 * 0xd8 + rdx_2 + 0x90)
