...
void** rax_5 = var_70
void* var_60
sub_1419a2ec0(std::_Get_future_error_what((*U"1111")[rbx_1]), &var_60, &data_143f4eec0, 0)
...
int64_t var_c0_1 = arg7
int32_t var_c8_1 = arg_18
int64_t var_d0_1 = arg6
void* var_d8_1 = rax_3 + 0x70
void** rax
int128_t zmm6_1
rax, zmm6_1 = sub_1421c1e50(rbp_1, arg1, rcx_1 * 0x38 + rax_3, rax_3 + 0x90)
void** rcx_12 = arg4
...
if (i_3 s> 0)
    ...
    do
        ...
        if (not(cond:4_1))
            uint32_t r14_3 = zx.d(rax[0x23].w)
