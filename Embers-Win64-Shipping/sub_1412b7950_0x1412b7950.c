...
if (data_143e8b7a8 s> *rdi_1)
    _Init_thread_header(&data_143e8b7a8)
    
    if (data_143e8b7a8 == 0xffffffff)
        ...
        data_143e8b7a0 = rax_12
        _Init_thread_footer(&data_143e8b7a8)

if (data_143e8b7c8 s> *rdi_1)
    _Init_thread_header(&data_143e8b7c8)
    
    if (data_143e8b7c8 == 0xffffffff)
        ...
        data_143e8b7c0 = rax_15
        _Init_thread_footer(&data_143e8b7c8)

if (data_143e8b7e8 s> *rdi_1)
    _Init_thread_header(&data_143e8b7e8)
    
    if (data_143e8b7e8 == 0xffffffff)
        ...
        data_143e8b7e0 = rax_18
        _Init_thread_footer(&data_143e8b7e8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b7a0
int64_t rcx
