    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            ...
            rcx_6 += 0x10
            *rax =
                _mm_and_ps(data_143f87770 ^ data_143f87800, _mm_cmpeq_ps(data_143f87690, zmm1, 2))
                ^ data_143f87800
            i = i_3
            i_3 -= 1
        while (i != 1)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            rax_6 = rdx_5
            rdx_5 = &rdx_5[1]
            *rax_6 = _mm_and_ps(data_143f87770 ^ data_143f87800, 
                _mm_cmpeq_ps(data_143f87690, temp0_1, 2)) ^ data_143f87800
            i_1 = i_2
            i_2 -= 1
        while (i_1 != 1)
        return rax_6
