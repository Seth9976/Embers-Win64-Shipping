...
int64_t zmm3 = 0x3f1a36e2eb1c432d
...
if (zmm2 f>= zmm0[0])
    ...
    if (zmm2 f<= zmm0[0])
        zmm0 = zx.o(0)
        zmm0[0] = fconvert.d(arg2 * 10000f + 0.5f)
        ...
        *arg1 = int.q(zmm0[0])
        ...
        int64_t var_178 = 0
        int32_t var_170_1 = 0
        sub_1405947f0(&var_178, 0x12)
        int32_t rax_6 = var_170_1 + 0x12
        var_170_1 = rax_6
        
        if (rax_6 s> 0)
            sub_140594770(&var_178)
        
        UnDecorator::getReferenceType(var_178, u"MillisecondsValue", 0x24)
    ...
    int32_t rax_2 = var_180_1 + 0x12
    var_180_1 = rax_2
    
    if (rax_2 s> 0)
        sub_140594770(&var_188)
    
    UnDecorator::getReferenceType(var_188, u"MillisecondsValue", 0x24)
