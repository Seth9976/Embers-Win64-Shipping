...
while (true)
    ...
    *arg1 = 0
    ...
    if (r10_1 != 0 && zx.w(*rdi_1) * 0x100 + zx.w(rdi_1[1]) - 2 u<= 1)
        rax_8 = sub_142c04720(&rdi_1[4], arg1, rdi_1)
    
    if (r10_1 != 0 && zx.w(*rdi_1) * 0x100 + zx.w(rdi_1[1]) - 2 u<= 1 && rax_8 != 0)
        rsi.b = 1
        ...
        if (arg1[8] != 0)
            ...
            if (sub_142bf7510(arg1, rdi_1, 8).b == 0
                    || zx.w(*rdi_1) * 0x100 - 2 + zx.w(rdi_1[1]) u> 1)
                rax_10.b = 0
            else if (sub_142c04720(&rdi_1[4], arg1, rdi_1).b == 0)
                rax_10.b = 0
            else
                rax_10 = 1
