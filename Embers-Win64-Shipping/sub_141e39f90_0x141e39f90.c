...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        ...
        zmm1_1 = sub_141e39070(arg1, rbx_3 + 8, zmm1_1)
        int32_t var_4c
...
int512_t zmm1 = sub_141e3d2b0(arg2, arg_8)
int32_t r15 = 0
...
do
    ...
    if (rcx_4 == 0)
        ...
        *rdx_12 &= not.d(1 << (rsi_1.b & 0x1f))
        ...
        rdi_1 = sx.q(arg2[6].d)
        uint64_t r8_6 = *arg2
        int64_t rdx_9 = sx.q(*((rdi_1 << 7) + r8_6 + 4))
        arg2[6].d = rdx_9.d
        *(arg2 + 0x34) = rcx_4 - 1
        
        if (rcx_4 != 1)
            *((rdx_9 << 7) + r8_6) = 0xffffffff
    ...
    *r8_7 |= 1 << (rdi_1.b & 0x1f)
    int64_t rsi_5 = (sx.q(rdi_1.d) << 7) + *arg2
    *rsi_5 = 0
    memset(rsi_5 + 0x10, 0, 0x68)
    __builtin_memset(rsi_5 + 8, 0, 0x30)
    int64_t* rcx_13 = rsi_5 + 0x38
    rcx_13[2] = 0
    rcx_13[3].d = 0
    *(rcx_13 + 0x1c) = 0x80
    int64_t* rax_20 = rcx_13[2]
    ...
    *rcx_13 = 0
    rcx_13[1] = 0
    *(rsi_5 + 0x58) = 0xffffffff
    *(rsi_5 + 0x5c) = 0
    *(rsi_5 + 0x68) = 0
    *(rsi_5 + 0x70) = 0
    *(rsi_5 + 0x78) = 0xffffffff
    (*(*arg1 + 0x140))(arg1, rsi_5)
    zmm1 = sub_141e39070(arg1, rsi_5 + 8, zmm1)
    r15 += 1
while (r15 s< arg_8)
