...
if (data_143e8cc48 s> *rdi_1)
    _Init_thread_header(&data_143e8cc48)
    
    if (data_143e8cc48 == 0xffffffff)
        ...
        data_143e8cc40 = rax_9
        _Init_thread_footer(&data_143e8cc48)

if (data_143e8cc58 s> *rdi_1)
    _Init_thread_header(&data_143e8cc58)
    
    if (data_143e8cc58 == 0xffffffff)
        ...
        data_143e8cc50 = rax_12
        _Init_thread_footer(&data_143e8cc58)

if (data_143e8cc68 s> *rdi_1)
    _Init_thread_header(&data_143e8cc68)
    
    if (data_143e8cc68 == 0xffffffff)
        ...
        data_143e8cc60 = rax_15
        _Init_thread_footer(&data_143e8cc68)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8cc40
int64_t rcx
...
label_14129ae83:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_14129ae7e
        
        rbx.b = 1
        goto label_14129ae83
