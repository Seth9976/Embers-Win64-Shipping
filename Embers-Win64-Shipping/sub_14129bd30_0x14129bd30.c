...
if (data_143e8cd38 s> *rdi_1)
    _Init_thread_header(&data_143e8cd38)
    
    if (data_143e8cd38 == 0xffffffff)
        ...
        data_143e8cd30 = rax_12
        _Init_thread_footer(&data_143e8cd38)

if (data_143e8cd48 s> *rdi_1)
    _Init_thread_header(&data_143e8cd48)
    
    if (data_143e8cd48 == 0xffffffff)
        ...
        data_143e8cd40 = rax_15
        _Init_thread_footer(&data_143e8cd48)

if (data_143e8cd58 s> *rdi_1)
    _Init_thread_header(&data_143e8cd58)
    
    if (data_143e8cd58 == 0xffffffff)
        ...
        data_143e8cd50 = rax_18
        _Init_thread_footer(&data_143e8cd58)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8cd30
int64_t rcx
...
label_14129be28:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_14129be23
    
    rbx.b = 1
    goto label_14129be28
