...
while (true)
    ...
    if (sub_142828cbc(*(arg1 + 8)) != 0)
        sub_14058a5c0(&var_98, "end of map not found")
        void var_110
    ...
    if (rcx_5 != 0xe)
        (*(*arg2 + 0x18))(arg2, &var_f0, 0)
    else
        sub_142828d00(*(arg1 + 8))
        sub_142829ce4(arg1, arg2, arg3)
    
    char rax_7 = sub_142828cbc(*(arg1 + 8))
    void* rax_8
    
    if (rax_7 == 0)
        rax_8 = sub_142828cd8(*(arg1 + 8))
    
    if (rax_7 != 0 || *(rax_8 + 4) != 0xf)
        (*(*arg2 + 0x18))(arg2, &var_f0, 0)
    else
        sub_142828d00(*(arg1 + 8))
        sub_142829ce4(arg1, arg2, arg3)
