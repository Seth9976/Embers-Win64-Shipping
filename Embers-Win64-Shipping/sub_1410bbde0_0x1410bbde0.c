...
if (data_143e2d110 s> *rdi_1)
    _Init_thread_header(&data_143e2d110)
    
    if (data_143e2d110 == 0xffffffff)
        ...
        data_143e2d108 = rax_8
        _Init_thread_footer(&data_143e2d110)

if (data_143e2d120 s> *rdi_1)
    _Init_thread_header(&data_143e2d120)
    
    if (data_143e2d120 == 0xffffffff)
        ...
        data_143e2d118 = rax_11
        _Init_thread_footer(&data_143e2d120)

int64_t rdi_2 = data_143e2d118
int64_t rcx
