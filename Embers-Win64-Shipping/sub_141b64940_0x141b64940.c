...
if (r11 != 0)
    ...
    label_141b649d8:
        ...
        while (true)
            ...
            if (rdx_2 != 0)
                goto label_141b649d8
        
        var_74.d = r11

void* var_20 = arg1 + 0xa0
int128_t zmm0 = var_88.o
int128_t var_30 = 0xffffffff
int16_t var_50 = 0
void* result = zmm0.q
var_78.o = zmm0
var_88.o = (arg1 + 0xa0).o
...
if (0 s< *(result + 0x18))
    ...
    do
        ...
        int64_t rbx_2 = sx.q(i) * 0x30
        
        if (sub_140d3e110(*r15_1 + rbx_2) == 0)
            ...
            int64_t* r8_4 = (r14_1 << 4) + *arg2
            *r8_4 = *(r12_1 + rbx_2 + 0x18)
            void* rax_15 = *(r12_1 + rbx_2 + 0x20)
            r8_4[1] = rax_15
            
            if (rax_15 != 0)
                *(rax_15 + 8) += 1
            
            sub_141b65000(*(rbx_2 + *r15_1 + 0x18))
            sub_141b64640(zmm0:8.q, i)
            var_50.b = 1
    ...
    if (var_50.b != 0 && var_50:1.b != 0)
        return sub_141b50cb0(arg1 + 0xa0, *(arg1 + 0xa8) - *(arg1 + 0xd4), 1)
