...
if (rax_2 == 0 || rdi_1 == 0)
    ...
    if (result.b == 0 || rdx_8 == 0)
        ...
        if (sub_140cc1670(&var_48, &data_143e1b820).b == 0 || var_48 == 0)
            ...
            uint64_t rbp_2 = zx.q(sub_1408e52c0(rax_9))
            void var_38
    ...
    if (rbx_5 != &data_143e1bfc0 || *(rdi_1 + 0x3c) != 4)
        result.b = 0
    else
    ...
    if (rax_1 s< 0 || rax_1 s>= r14_1[1].d)
        ...
        if (rbx_2 != &data_143e1bfc0 || *(rdi_1[0xf] + 0x3c) != 4 || r14_1[1].d == 0)
            result.b = 0
        else
            result = *r14_1
