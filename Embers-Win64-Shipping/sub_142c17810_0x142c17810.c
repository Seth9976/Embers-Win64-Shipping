...
while (*(result + 0x58) != 0)
    ...
    if (rsi_2 + 2 u<= *(rbp_2 + 0x60))
        ...
        rax_26.b = r9_8 == 0
        uint64_t rcx_13 =
            zx.q(r8_5[(zx.q(r8_5[4]) << 8) + zx.q(r8_5[5]) + zx.q(r9_8 * r14 + rax_26)])
        ...
        if (*(rbx_2 + 0x59) == 0)
            *(rbx_2 + 0x5c) += 1
            ...
            if (sub_142bf50b0(rbx_2, 1, 1) != 0)
                ...
                int64_t rax_41 = *(rbx_2 + 0x78)
                *(rax_41 + (rcx_23 << 2)) = *(rdx_20 + (r9_12 << 2))
                *(rax_41 + (rcx_23 << 2) + 0x10) = *(rdx_20 + (r9_12 << 2) + 0x10)
                *(rbx_2 + 0x64) += 1
                *(rbx_2 + 0x5c) += 1
        else
            *(rbx_2 + 0x64) += 1
