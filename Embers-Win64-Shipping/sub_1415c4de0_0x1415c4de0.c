...
rax_2, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm14, zmm15 =
    sub_1416e5d60(r14, arg2, arg3, arg4, var_268)
int32_t rsi_1
...
if (rax_2 != 0)
    ...
    if (rcx_9 == 0)
    label_1415c585c:
        zmm6_2, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm14_2, zmm15_2 =
        ...
        while (true)
            if (rdx_5 s< 0x80)
                ...
                label_1415c580b:
                    ...
                    zmm12 = rdi_5[5]
                    void* rax_20 = *arg3
                    uint128_t zmm3_1 = *(rax_20 + 0x28)
                    float zmm4_1 = *(rax_20 + 0x2c)
                    zmm7 = *(rax_20 + 0x30)
                    void* rcx_15 = *(rax_20 + 0x10)
                    zmm10[0] = zmm10[0] f* zmm3_1.d
                    zmm6[0] = zmm6[0] * zmm4_1
                    uint128_t zmm2_1
                    zmm2_1.d = zmm12.d f* zmm7[0]
                    ...
                    float var_190 = (zmm10 ^ zmm11)[0]
                    int32_t var_1c0_1 = zmm9.d
                    float var_1bc_1 = zmm8[0]
                    float var_188_1 = (zmm12 ^ zmm11)[0]
                    float var_1b8_1 = zmm7[0]
                    float var_18c_1 = (zmm6 ^ zmm11)[0]
                    float var_138[0x4]
                    float* rax_21
                    float zmm6_1[0x4]
                    float zmm13_1
                    int32_t zmm14_1
                    int32_t zmm15_1
                    rax_21, zmm6_1, zmm7, zmm8, zmm9, zmm10, zmm12, zmm13_1, zmm14_1, zmm15_1 =
                        sub_141716230(arg4, &var_138, &var_190)
                    zmm11 = zx.o(*rax_21)
                    int32_t r13_2 = rax_21[2]
                    zmm9.d = zmm9.d f- zmm11.d
                    zmm7[0] = zmm7[0] f- r13_2
                    uint128_t zmm0_2 = _mm_shuffle_ps(zmm11, zmm11, 0x55)
                    ...
                    if (not(zmm13_1 f< zmm12.d))
                        ...
                        var_f8_1:4.b = 0
                        int32_t var_214_1 = rcx_17
                        r14[1].d = rcx_17 + 1
                        
                        if (rcx_17 + 1 s> *(r14 + 0xc))
                            sub_14083a7e0(r14)
                            rcx_17 = var_214_1
                        
                        int64_t rcx_19 = *r14
                        int64_t rdx_11 = sx.q(rcx_17) * 3
                        *(rcx_19 + (rdx_11 << 2)) = var_1c0_1.q
                        *(rcx_19 + (rdx_11 << 2) + 8) = var_1b8_1
                        ...
                        int64_t rax_36 = *r12
                        int64_t rcx_21 = r14_2 * 3
                        var_240_1.d = 0
                        *(rax_36 + (rcx_21 << 2)) = zmm11.q
                        *(rax_36 + (rcx_21 << 2) + 8) = r13_2
                        rdi_5[0xd].b = 1
                        ...
                        if (r8_11 s>= 3)
                            ...
                            if (r8_11 s> 0)
                                ...
                                do
                                    ...
                                    int64_t rcx_28 = rax_48 * 3
                                    zmm10 = *(rdx_19 + (rcx_28 << 2))
                                    zmm10[0] = zmm10[0] f- *(r8_12 + (rcx_28 << 2))
                                    zmm6 = *(rdx_19 + (rcx_28 << 2) + 4)
                                    zmm6[0] = zmm6[0] f- *(r8_12 + (rcx_28 << 2) + 4)
                                    zmm11.d = (*(rdx_19 + (rcx_28 << 2) + 8)).d f-
                                        *(r8_12 + (rcx_28 << 2) + 8)
                                    int64_t rcx_29 = sx.q(rax_46) * 3
                                    zmm2_1.d = (*(rdx_19 + (rcx_29 << 2) + 8)).d f-
                                        *(r8_12 + (rcx_29 << 2) + 8)
                                    zmm5_1 = *(rdx_19 + (rcx_29 << 2))
                                    zmm7 = *(rdx_19 + (rdx_11 << 2) + 4)
                                    zmm7[0] = zmm7[0] f- *(r8_12 + (rdx_11 << 2) + 4)
                                    zmm1_1 = *(rdx_19 + (rdx_11 << 2) + 8)
                                    zmm1_1[0] = zmm1_1[0] f- *(r8_12 + (rdx_11 << 2) + 8)
                                    zmm2_1.d = zmm2_1.d f- zmm11.d
                                    zmm3_1.d =
                                        (*(rdx_19 + (rdx_11 << 2))).d f- *(r8_12 + (rdx_11 << 2))
                                    zmm4_1 = *(rdx_19 + (rcx_29 << 2) + 4)
                                    ...
                                    zmm3_1.d = zmm3_1.d f* zmm4_1
                                    zmm7[0] = zmm7[0] f- zmm3_1.d
                                    ...
                                    if (zmm2_1.d f== 1f)
                                        goto label_1415c56b9
                                    
                                    float var_220_1
                                    float var_218_1
                                    
                                    if (zmm2_1.d f>= zmm14_1)
                                        zmm0_1 = zmm2_1
                                        zmm3_1 = zmm0_1
                                        float temp0_10[0x4] = _mm_rsqrt_ss(zmm0_1[0], zmm3_1.d)
                                        ...
                                        temp0_10[0] = temp0_10[0] + temp0_10[0]
                                        temp0_10[0] = temp0_10[0] * temp0_10[0]
                                        zmm3_1.d = zmm3_1.d f* temp0_10[0]
                                        temp0_10[0] = temp0_10[0] * (0.5f f- zmm3_1.d)
                                        temp0_10[0] = temp0_10[0] + temp0_10[0]
                                        zmm8[0] = zmm8[0] * temp0_10[0]
                                        zmm9.d = zmm9.d f* temp0_10[0]
                                        zmm7[0] = zmm7[0] * temp0_10[0]
                                    label_1415c56b9:
                                        var_218_1 = zmm7[0]
                                        int32_t var_21c_2 = zmm9.d
                                        var_220_1 = zmm8[0]
                                    else
                                    ...
                                    *(r10_8 + (r14_3 << 2) + 0x28) = 0
                                    ...
                                    if (not(zmm0_1[0] f< zmm12.d) && not(zmm0_1[0] > zmm13_1))
                                        char rax_56
                                        rax_56, zmm12, zmm13_1, zmm14_1, zmm15_1 =
                            ...
                            zmm5_1 = zx.o(0)
                            r15 = var_240_1:4.d
                            goto label_1415c580b
            
        label_1415c5825:
            rdi_1 = var_248
            goto label_1415c585c
