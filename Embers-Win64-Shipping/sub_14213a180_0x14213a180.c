...
if (rax_7 != 0)
    ...
    if ((rcx_3 & 1) != 0 || rax_7 s<= 0 || ((*(arg1 + 0x2b) & 8) != 0 && rax_7 s> 0x71c71))
        *(arg1 + 0x29) = rcx_3 | 1
        ...
        if (rax_7 s> 0)
            do
                ...
                sub_142139800(arg1, rdx_10 + sx.q(i) * 0x24, arg3)
                i += 1
            while (i s< arg2[1].d)
    else
        arg2[1].d = 0
        ...
        if (rax_7 s> 0)
            do
                ...
                sub_142139800(arg1, rdx_7 + rbp_1 * 0x24, arg3)
                i += 1
            while (i s< arg_8)
else if ((arg1[5].b & 1) != 0)
    arg2[1].d = 0
