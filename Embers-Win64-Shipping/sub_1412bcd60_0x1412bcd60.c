...
if (data_143e8c590 s> *rdi_1)
    _Init_thread_header(&data_143e8c590)
    
    if (data_143e8c590 == 0xffffffff)
        ...
        data_143e8c588 = rax_12
        _Init_thread_footer(&data_143e8c590)

if (data_143e8c5b0 s> *rdi_1)
    _Init_thread_header(&data_143e8c5b0)
    
    if (data_143e8c5b0 == 0xffffffff)
        ...
        data_143e8c5a8 = rax_15
        _Init_thread_footer(&data_143e8c5b0)

if (data_143e8c5d0 s> *rdi_1)
    _Init_thread_header(&data_143e8c5d0)
    
    if (data_143e8c5d0 == 0xffffffff)
        ...
        data_143e8c5c8 = rax_18
        _Init_thread_footer(&data_143e8c5d0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c588
int64_t rcx
...
label_1412bce58:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412bce53
    
    rbx.b = 1
    goto label_1412bce58
