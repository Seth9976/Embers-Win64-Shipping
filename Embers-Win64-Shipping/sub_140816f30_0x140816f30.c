...
if ((not.b((rdx u>> 0xf).b) & 1) == 0)
    var_2a0 = zx.q(*(arg1 + 0x80) * r9_1) + *(arg1 + 0x70)
else
    ...
    var_2a0 = sx.q(r9_1) + *(*(arg1 + 0x18) + (sx.q(r10_1) << 3))
...
if ((not.b((rax_10 u>> 0xf).b) & 1) == 0)
    var_298 = zx.q(*(arg1 + 0x80) * r9_3) + *(arg1 + 0x70)
else
    ...
    var_298 = sx.q(r9_3) + *(*(arg1 + 0x18) + (sx.q(r10_4) << 3))
...
if ((not.b((rax_19 u>> 0xf).b) & 1) == 0)
    var_290 = zx.q(*(arg1 + 0x80) * r9_7) + *(arg1 + 0x70)
else
    ...
    var_290 = sx.q(r9_7) + *(*(arg1 + 0x18) + (sx.q(r11_3) << 3))
...
if ((not.b((rax_25 u>> 0xf).b) & 1) == 0)
    ...
    var_288 = sx.q(r9_9) + *(*(arg1 + 0x18) + (sx.q(r11_6) << 3))
...
if ((not.b((rax_31 u>> 0xf).b) & 1) == 0)
    var_268 = zx.q(*(arg1 + 0x80) * r9_11) + *(arg1 + 0x70)
else
    ...
    var_268 = sx.q(r9_11) + *(*(arg1 + 0x18) + (sx.q(r11_9) << 3))
...
if ((not.b((rax_37 u>> 0xf).b) & 1) == 0)
    ...
    var_280 = sx.q(r9_13) + *(*(arg1 + 0x18) + (sx.q(r11_12) << 3))
...
if ((not.b((rax_43 u>> 0xf).b) & 1) == 0)
    var_278 = zx.q(*(arg1 + 0x80) * r9_15) + *(arg1 + 0x70)
else
    ...
    var_278 = sx.q(r9_15) + *(*(arg1 + 0x18) + (sx.q(r11_15) << 3))
...
if ((not.b((rax_49 u>> 0xf).b) & 1) == 0)
    var_270 = zx.q(*(arg1 + 0x80) * r9_17) + *(arg1 + 0x70)
else
    ...
    var_270 = sx.q(r9_17) + *(*(arg1 + 0x18) + (sx.q(r11_18) << 3))
...
if ((not.b((rax_52 u>> 0xf).b) & 1) == 0)
    var_260 = zx.q(*(arg1 + 0x80) * r9_19) + *(arg1 + 0x70)
else
    ...
    var_260 = sx.q(r9_19) + *(*(arg1 + 0x18) + (sx.q(r11_21) << 3))
...
int32_t var_248 = rcx_56
*(arg1 + 0x10) = &rax_2[0xd]
int32_t rax_61
rax_61.b = rcx_56 != 0x7fff
int32_t var_244 = rax_61
void* r12_2
void var_238
...
*(arg1 + 0x10) = &rax_2[0xe]
int32_t var_218 = rcx_58
int32_t rax_62
rax_62.b = rcx_58 != 0x7fff
int32_t var_214 = rax_62
void* r15_2
void var_208
...
*(arg1 + 0x10) = &rax_2[0xf]
int32_t var_1e8 = rcx_60
int32_t rax_63
rax_63.b = rcx_60 != 0x7fff
int32_t var_1e4 = rax_63
void* r14_2
void var_1d8
...
int32_t var_1b8 = rcx_62
int32_t rax_64
rax_64.b = rcx_62 != 0x7fff
int32_t var_1b4 = rax_64
void* rsi_2
void var_1a8
...
int32_t var_188 = rcx_64
int32_t rax_65
rax_65.b = rcx_64 != 0x7fff
int32_t var_184 = rax_65
void* rdi_12
void var_178
...
int32_t var_158 = rcx_66
int32_t rax_66
rax_66.b = rcx_66 != 0x7fff
int32_t var_154 = rax_66
void* rbx_20
void var_148
...
int32_t var_128 = rcx_68
int32_t rax_67
rax_67.b = rcx_68 != 0x7fff
int32_t var_124 = rax_67
void* r11_30
void var_118
...
int32_t var_f8 = rcx_71
int32_t rax_69
rax_69.b = rcx_71 != 0x7fff
int32_t var_f4 = rax_69
void* r9_28
void var_e8
...
int32_t var_c8 = rcx_73
int32_t rdx_1
rdx_1.b = rcx_73 != 0x7fff
int32_t var_c4 = rdx_1
void* rcx_75
void var_b8
...
void* var_a8 = rcx_75
float zmm8[0x4] = *var_2a0
float temp0[0x4] = _mm_shuffle_ps(zmm8, zmm8, 0)
float zmm0[0x4] = *var_268
...
if (result.d s> 0)
    ...
    result = i_1 - r10_9
    float (* var_298_1)[0x4] = var_298 - r10_9
    int128_t* rdx_3 = var_260 - r10_9
    int128_t* var_290_1 = var_290 - r10_9
    int128_t* r11_31 = r11_30 - r10_9
    int128_t* var_288_1 = var_288 - r10_9
    int128_t* r9_29 = r9_28 - r10_9
    float (* var_280_1)[0x4] = var_280 - r10_9
    ...
    float temp0_3[0x4] = _mm_rcp_ps(__maxps_xmmps_memps(temp0_1, data_142d3f5e0))
    i_1 = zx.q(var_2a0.d)
    float zmm11[0x4] = data_143ce3940
    float temp0_4[0x4] = _mm_mul_ps(temp0_3, temp0)
    uint64_t i
    ...
    do
        ...
        float zmm3[0x4] = *(var_290_1 + r10_9)
        float temp0_5[0x4] = _mm_mul_ps(temp0_4, *(var_298_1 + r10_9))
        *(r11_31 + r10_9) = zmm7
        float zmm4[0x4] = *(var_288_1 + r10_9)
        float temp0_6[0x4] = _mm_add_ps(zmm7, temp0_5)
        float temp0_7[0x4] = _mm_mul_ps(temp0_4, zmm2)
        *(r9_29 + r10_9) = zmm6
        *(rcx_76 + r10_9) = zmm5
        float temp0_8[0x4] = _mm_add_ps(zmm6, temp0_7)
        float temp0_9[0x4] = _mm_mul_ps(zmm4, temp0)
        float temp0_10[0x4] = _mm_mul_ps(temp0_4, zmm3)
        float temp0_11[0x4] = _mm_min_ps(temp0_9, zmm11)
        float temp0_12[0x4] = _mm_add_ps(zmm5, temp0_10)
        float temp0_14[0x4] = _mm_sub_ps(zx.o(0), _mm_max_ps(temp0_11, zx.o(0)))
        float temp0_16[0x4] = _mm_add_ps(temp0_6, _mm_mul_ps(temp0_14, temp0_6))
        float temp0_17[0x4] = _mm_mul_ps(temp0_14, temp0_8)
        float temp0_18[0x4] = _mm_mul_ps(temp0_14, temp0_12)
        *(rsi_3 + r10_9) = temp0_16
        float temp0_19[0x4] = _mm_add_ps(temp0_8, temp0_17)
        float temp0_20[0x4] = _mm_add_ps(temp0_12, temp0_18)
        float temp0_21[0x4] = _mm_mul_ps(temp0_16, temp0)
        float zmm1[0x4] = *(var_280_1 + r10_9)
        *(rdi_13 + r10_9) = temp0_19
        float temp0_22[0x4] = _mm_add_ps(zmm1, temp0_21)
        float temp0_23[0x4] = _mm_mul_ps(temp0_19, temp0)
        *(rbx_21 + r10_9) = temp0_20
        *(r12_3 + r10_9) = temp0_22
        float temp0_24[0x4] = _mm_add_ps(*(var_278_1 + r10_9), temp0_23)
        float temp0_25[0x4] = _mm_mul_ps(temp0_20, temp0)
        *(r15_3 + r10_9) = temp0_24
        *(r14_3 + r10_9) = _mm_add_ps(*(var_270_1 + r10_9), temp0_25)
        r10_9 = &r10_9[1]
        i = i_1
        i_1 -= 1
    while (i != 1)
