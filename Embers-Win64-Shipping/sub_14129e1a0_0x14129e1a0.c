...
if (data_143e8cbd0 s> *rdi_1)
    _Init_thread_header(&data_143e8cbd0)
    
    if (data_143e8cbd0 == 0xffffffff)
        ...
        data_143e8cbc8 = rax_12
        _Init_thread_footer(&data_143e8cbd0)

if (data_143e8cbe0 s> *rdi_1)
    _Init_thread_header(&data_143e8cbe0)
    
    if (data_143e8cbe0 == 0xffffffff)
        ...
        data_143e8cbd8 = rax_15
        _Init_thread_footer(&data_143e8cbe0)

if (data_143e8cbf0 s> *rdi_1)
    _Init_thread_header(&data_143e8cbf0)
    
    if (data_143e8cbf0 == 0xffffffff)
        ...
        data_143e8cbe8 = rax_18
        _Init_thread_footer(&data_143e8cbf0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8cbc8
int64_t rcx
