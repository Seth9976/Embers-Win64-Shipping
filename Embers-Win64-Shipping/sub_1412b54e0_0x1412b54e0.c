...
if (data_143e8c620 s> *rdi_1)
    _Init_thread_header(&data_143e8c620)
    
    if (data_143e8c620 == 0xffffffff)
        ...
        data_143e8c618 = rax_12
        _Init_thread_footer(&data_143e8c620)

if (data_143e8c640 s> *rdi_1)
    _Init_thread_header(&data_143e8c640)
    
    if (data_143e8c640 == 0xffffffff)
        ...
        data_143e8c638 = rax_15
        _Init_thread_footer(&data_143e8c640)

if (data_143e8c660 s> *rdi_1)
    _Init_thread_header(&data_143e8c660)
    
    if (data_143e8c660 == 0xffffffff)
        ...
        data_143e8c658 = rax_18
        _Init_thread_footer(&data_143e8c660)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c618
int64_t rcx
...
label_1412b55d8:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412b55d3
    
    rbx.b = 1
    goto label_1412b55d8
