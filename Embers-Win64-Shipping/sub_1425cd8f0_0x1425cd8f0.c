...
label_1425cda63:
    ...
    if (r8_2 s> 0 && (rax_19 == 0 || rax_19 s< rbp))
        ...
        arg4[0x24] = *(rax_23 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2))
        void* rax_25 = *(r9_3 + 8)
        
        if (rax_25 != 0)
            r9_3 = rax_25
        
        *(r9_3 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2)) = rdi_6
else
    int32_t r15_1 = -1
    int32_t rbx_1
    ...
    label_1425cd999:
        ...
        while (true)
            int64_t rdi_2 = sx.q(rbx_1) * 0xa0
            
            if (sub_1425ccae0(rcx_1 + rdi_2, arg4) != 0)
                break
            
            rcx_1 = *arg1
            rbx_1 = *(rdi_2 + rcx_1 + 0x90)
            
            if (rbx_1 == 0xffffffff)
                goto label_1425cd999
    ...
    if (rbx_1 == 0xffffffff)
        ...
        sub_140746680(rdi_5)
        memmove(rdi_5, arg4, 0x90)
        int64_t rcx_5 = sx.q(arg5)
        void* r10_1 = &arg1[2]
        
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0xa0 + *arg1) = rcx_5.d
        
        int32_t* rax_9 = rcx_5 * 0xa0 + *arg1
        *rax_9 = 0xffffffff
