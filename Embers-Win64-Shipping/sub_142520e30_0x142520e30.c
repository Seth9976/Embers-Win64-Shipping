...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_11[4]
    sub_140d30490(arg2, &var_c8, r8_11)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_17[4]
    sub_140d30490(arg2, &var_e8, r8_17)
else
...
int32_t var_e4 = (zx.o(0)).d

if (*(arg2 + 0x20) == 0)
    int64_t* r8_23 = *(arg2 + 0x80)
    *(arg2 + 0x80) = r8_23[4]
    sub_140d30490(arg2, &var_e4, r8_23)
else
...
int32_t var_f0 = var_e4.d
uint128_t* var_f8 = &var_58
int128_t var_48
int128_t* var_100 = &var_48
...
var_48 = zmm1
char result = sub_1420cb320(rcx_12, &var_88, &var_98, r9, r12.b, r14, rax_18, rsi)
