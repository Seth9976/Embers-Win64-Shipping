...
int32_t r12 = 0xffffffff << (rdx_7 & 0x1f).b
...
if (rdx_7 != r10)
    int32_t* rax_16 = *(arg2 + 0x20)
    int32_t* r11_1 = arg2 + 0x10
    ...
    int32_t rdx_11 = r11_1[sx.q(r8_6)] & r12
    ...
    label_1409929c6:
        ...
        while (true)
            ...
            rdx_11 = r11_1[rcx_10 + 1]
            var_88_1 = 0xffffffff
            
            if (rdx_11 != 0)
                goto label_1409929c6
...
while (true)
    ...
    int32_t* rbx_7 = *rdx_12 + rcx_12 * 0xc
    sub_1409afd50(arg1, &var_98)
    *(arg2 + 0x10) = *rbx_7
    int32_t rax_24 = var_98
    *(arg2 + 0x14) = 0xffffffff
    void arg_8
    sub_1409b8a30(arg1, &arg_8, *(arg2 + 0x10), arg2 + 0x10, rax_24, nullptr)
