...
if (data_143e8ab50 s> *rdi_1)
    _Init_thread_header(&data_143e8ab50)
    
    if (data_143e8ab50 == 0xffffffff)
        ...
        data_143e8ab48 = rax_9
        _Init_thread_footer(&data_143e8ab50)

if (data_143e8ab60 s> *rdi_1)
    _Init_thread_header(&data_143e8ab60)
    
    if (data_143e8ab60 == 0xffffffff)
        ...
        data_143e8ab58 = rax_12
        _Init_thread_footer(&data_143e8ab60)

if (data_143e8ab70 s> *rdi_1)
    _Init_thread_header(&data_143e8ab70)
    
    if (data_143e8ab70 == 0xffffffff)
        ...
        data_143e8ab68 = rax_15
        _Init_thread_footer(&data_143e8ab70)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ab48
int64_t rcx
...
label_1412a4553:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412a454e
        
        rbx.b = 1
        goto label_1412a4553
