...
if (arg2 == 0 || arg2[0x45] == 0)
    int64_t var_90_1 = 0
    result =
        sub_140d23f50(UInAppPurchaseQueryCallbackProxy::TriggerQuery - Invalid player state", 3)
else
    int64_t arg_8 = 0
    void var_58
    int64_t* rax_2
    ...
    label_14097e149:
        int64_t var_98_1 = 0
        result = sub_140d23f50(UInAppPurchaseQueryCallbackProxy::TriggerQuery - Invalid or uninitialized OnlineSubsystem", 
            3)
    else
        void var_50
        ...
        if (var_88 == 0)
            ...
            result = sub_140d23f50(
                UInAppPurchaseQueryCallbackProxy::TriggerQuery - In App Purchases are not suppo", 3)
        else
            *(arg1 + 0x70) = 0
            ...
            if (rax_8 != 0)
                *rax_8 = &data_142e33668
                sub_140d3a3a0(&rax_8[1], arg1)
                rax_8[2] = sub_14096d540
                rax_8[4] = sub_140a387b0()
                *rax_8 = &data_142e336c0
            ...
            void var_48
            *(arg1 + 0x58) = *(*(*rcx_14 + 0x10))(rcx_14, &var_48, arg1 + 0x48)
            ...
            result = (*(*rcx_19 + 8))(rcx_19, arg3, &var_78)
