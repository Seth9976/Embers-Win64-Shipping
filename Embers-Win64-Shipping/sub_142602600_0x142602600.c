...
if (0 s< r10)
    ...
    while (true)
        void* rdi_2 = sx.q(rcx_3) * 0x88 + *rdx_2
        *(rdi_2 + 0x80) = 0
        int64_t rcx_4 = *(rdi_2 + 0x78)
        ...
        *(rdi_2 + 0x40) = 0
        ...
        if (*(rdi_2 + 0x44) != 0)
            sub_1405a5410(rdi_2 + 0x38, 0)
        
        *(rdi_2 + 0x68) = 0xffffffff
        *(rdi_2 + 0x6c) = 0
        sub_14059a8e0(rdi_2 + 0x48, 0)
        int64_t rcx_7 = *(rdi_2 + 0x58)
        
        if (rcx_7 != 0)
            sub_140a74f90(rcx_7)
        
        int64_t rcx_8 = *(rdi_2 + 0x38)
        
        if (rcx_8 != 0)
            sub_140a74f90(rcx_8)
        
        int64_t rcx_9 = *(rdi_2 + 0x28)
