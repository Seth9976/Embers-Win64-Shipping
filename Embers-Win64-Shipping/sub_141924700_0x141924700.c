...
if (rdi == 0)
    ...
    if (r9_2.d != 0x474c534c || (rax_10 != 0x4853 && data_143eff5c5 != 0))
        ...
        label_141924aa5:
            ...
            int32_t rax_12 =
                *(r9_3 + (((rdi_3 ^ rsi_2 ^ 0x8e88) & (sx.q(data_1439c7618) - 1)) << 2))
            
            if (rax_12 == 0xffffffff)
                goto label_141924aa5
            ...
            while (true)
                ...
                if (*(rdx_17 + r8_8) == 0x8e88 && *(rdx_17 + r8_8 + 4) == rdi_3.d
        ...
        if (r13_1 == 0)
            ...
            label_141924b5c:
                int64_t* rax_17 = sub_141926c80(&data_143eff670, 0x8e88, &var_268)
                r12_1 = var_268
                rdi_4 = rax_17
            else
                ...
                int32_t rax_16 = *(rax_15 + ((zx.q((data_143eff6b8.q).d - 1) & 0x8e88) << 2))
                
                if (rax_16 == 0xffffffff)
                    goto label_141924b5c
            ...
            int32_t var_278
            var_278.q = &var_248
            sub_14193add0(&var_158, &var_70, 0x8e88, &result_5, var_278)
            result_3.d = r15_2
