...
if (data_143e8aeb0 s> *rdi_1)
    _Init_thread_header(&data_143e8aeb0)
    
    if (data_143e8aeb0 == 0xffffffff)
        ...
        data_143e8aea8 = rax_12
        _Init_thread_footer(&data_143e8aeb0)

if (data_143e8aec0 s> *rdi_1)
    _Init_thread_header(&data_143e8aec0)
    
    if (data_143e8aec0 == 0xffffffff)
        ...
        data_143e8aeb8 = rax_15
        _Init_thread_footer(&data_143e8aec0)

if (data_143e8aed0 s> *rdi_1)
    _Init_thread_header(&data_143e8aed0)
    
    if (data_143e8aed0 == 0xffffffff)
        ...
        data_143e8aec8 = rax_18
        _Init_thread_footer(&data_143e8aed0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8aea8
int64_t rcx
