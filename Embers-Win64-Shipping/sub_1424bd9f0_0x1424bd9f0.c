...
if (*(arg2 + 0x20) == 0)
    int64_t* r8_16 = *(arg2 + 0x80)
    *(arg2 + 0x80) = r8_16[4]
    r8_15, r9 = sub_140d30490(arg2, &arg_18, r8_16)
else
    r8_15, r9 = sub_140d30460(arg2, *(arg2 + 0x18), &arg_18)
...
int512_t zmm2
zmm2.o = var_44
int64_t* rdx_16 = var_38
int64_t rdi
rdi.b = rax_9 != 0
int64_t rax_10 = var_40
int64_t* rcx_9 = var_30
*(arg2 + 0x20) = rdi + rax_9
int64_t* result = sub_14203f3b0(rcx_9, rdx_16, r8_15, r9, zmm0, rax_10, rsi.b, cond:1)
*arg3 = result
return result
