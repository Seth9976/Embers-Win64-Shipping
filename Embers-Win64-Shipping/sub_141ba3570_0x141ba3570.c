...
if (0 s< r9_1)
    ...
    do
        int64_t* rbx_3 = (sx.q(i) << 4) + *var_78.q
        void arg_8
        int32_t arg_10
        
        if (*sub_1408296b0(arg3, &arg_8, *rbx_3) == 0xffffffff)
            sub_140b91690(arg2, &arg_10, rbx_3, nullptr)
