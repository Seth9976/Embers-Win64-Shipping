...
do
    int32_t temp0_7[0x4] = _mm_mullo_epi16(
        _mm_unpacklo_epi8(_mm_unpacklo_epi32(zx.o(*rsi), zx.q(*(rsi + result))), 0), zmm4)
    int32_t zmm0[0x4] = _mm_srai_epi16(
        _mm_adds_epi16(_mm_adds_epi16(temp0_7, _mm_bsrli_si128(temp0_7, 8)), zmm3), 7)
