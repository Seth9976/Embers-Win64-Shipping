...
if (data_143e8aa50 s> *rdi_1)
    _Init_thread_header(&data_143e8aa50)
    
    if (data_143e8aa50 == 0xffffffff)
        ...
        data_143e8aa48 = rax_9
        _Init_thread_footer(&data_143e8aa50)

if (data_143e8aa60 s> *rdi_1)
    _Init_thread_header(&data_143e8aa60)
    
    if (data_143e8aa60 == 0xffffffff)
        ...
        data_143e8aa58 = rax_12
        _Init_thread_footer(&data_143e8aa60)

if (data_143e8aa70 s> *rdi_1)
    _Init_thread_header(&data_143e8aa70)
    
    if (data_143e8aa70 == 0xffffffff)
        ...
        data_143e8aa68 = rax_15
        _Init_thread_footer(&data_143e8aa70)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8aa48
int64_t rcx
...
label_1412a4803:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412a47fe
        
        rbx.b = 1
        goto label_1412a4803
