...
if (rdx.b == 0)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    uint32_t (* r11_4)[0x4] = zx.q(r11_2 * r8_2) + *(arg1 + 0x70)
    ...
    if (rax.d s> 0)
        ...
        do
            zmm1 = data_143f87690
            rax = rcx_6
            uint32_t zmm2[0x4] = *r11_4
            r11_4 = &r11_4[1]
            rcx_6 += 0x10
            *rax = _mm_add_ps(
                _mm_and_ps(data_143f87770 ^ zmm1, _mm_cmpeq_ps(zmm1, zmm2, 2)) ^ zmm1, 
                _mm_cvtepi32_ps(_mm_cvttps_epi32(zmm2)))
            i = i_3
            i_3 -= 1
        while (i != 1)
else if (rax.d == 1)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            ...
            rdx_5 = &rdx_5[1]
            *rax_6 = _mm_add_ps(
                _mm_and_ps(data_143f87770 ^ zmm1, _mm_cmpeq_ps(zmm1, temp0_1, 2)) ^ zmm1, temp0_3)
            i_1 = i_2
            i_2 -= 1
        while (i_1 != 1)
        return rax_6
