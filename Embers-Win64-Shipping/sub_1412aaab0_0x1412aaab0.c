...
if (data_143e8e350 s> *rdi_1)
    _Init_thread_header(&data_143e8e350)
    
    if (data_143e8e350 == 0xffffffff)
        ...
        data_143e8e348 = rax_9
        _Init_thread_footer(&data_143e8e350)

if (data_143e8e360 s> *rdi_1)
    _Init_thread_header(&data_143e8e360)
    
    if (data_143e8e360 == 0xffffffff)
        ...
        data_143e8e358 = rax_12
        _Init_thread_footer(&data_143e8e360)

if (data_143e8e370 s> *rdi_1)
    _Init_thread_header(&data_143e8e370)
    
    if (data_143e8e370 == 0xffffffff)
        ...
        data_143e8e368 = rax_15
        _Init_thread_footer(&data_143e8e370)
