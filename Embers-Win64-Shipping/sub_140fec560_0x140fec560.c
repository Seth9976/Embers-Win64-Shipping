...
if (var_4c == 2)
    ...
    if (rax_4 s< 0)
        ...
        sub_140fff020(rax_4, 
            "Direct3DDeviceIMContext->Map(IndexBuffer->Resource,0,D3D11_MAP_WRITE_DISCARD,0,"
        "&MappedSubresource)", 
    ...
    if (rax_9 s< 0)
        ...
        var_c8.q = *(arg1 + 0x168)
        sub_140fff020(rax_9, 
            "Direct3DDevice->CreateBuffer(&StagingBufferDesc,NULL,StagingIndexBuffer.GetInitReference())", 
            "D:/Build/++UE4/Sync/Engine/Source/Runtime/Windows/D3D11RHI/Private/D3D11IndexBuffer.cpp", 
            0x74)
    ...
    if (rax_14 s< 0)
        ...
        sub_140fff020(rax_14, 
            "Direct3DDeviceIMContext->Map(StagingIndexBuffer,0,D3D11_MAP_READ,0,&MappedSubresource)", 
            "D:/Build/++UE4/Sync/Engine/Source/Runtime/Windows/D3D11RHI/Private/D3D11IndexBuffer.cpp", 
            0x7c)
