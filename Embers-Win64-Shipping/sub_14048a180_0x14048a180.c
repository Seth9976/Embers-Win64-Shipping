...
int64_t (* i)(int64_t arg1, int64_t* arg2) = sub_14124bbd0
...
sub_1419c2220(&data_143e822d0, 1, FLightmapDensityPassUniformParameters", 
    FLightmapDensityPassUniformParameters", 0x42f39b58, nullptr)
int128_t* rcx_3 = var_18

if (rcx_3 != 0)
    sub_140a74f90(rcx_3)

return atexit(sub_142cd7350) __tailcall
