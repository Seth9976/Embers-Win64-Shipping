...
if (data_143e8e290 s> *rdi_1)
    _Init_thread_header(&data_143e8e290)
    
    if (data_143e8e290 == 0xffffffff)
        ...
        data_143e8e288 = rax_9
        _Init_thread_footer(&data_143e8e290)

if (data_143e8e2a0 s> *rdi_1)
    _Init_thread_header(&data_143e8e2a0)
    
    if (data_143e8e2a0 == 0xffffffff)
        ...
        data_143e8e298 = rax_12
        _Init_thread_footer(&data_143e8e2a0)

if (data_143e8e2b0 s> *rdi_1)
    _Init_thread_header(&data_143e8e2b0)
    
    if (data_143e8e2b0 == 0xffffffff)
        ...
        data_143e8e2a8 = rax_15
        _Init_thread_footer(&data_143e8e2b0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8e288
int64_t rcx
...
label_1412ac063:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412ac05e
        
        rbx.b = 1
        goto label_1412ac063
