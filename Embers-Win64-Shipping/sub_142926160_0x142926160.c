...
if (arg4 u>= 0x40000000)
    ...
    int64_t r12_1 = r12 - i_1 * 0x40000000
    uint64_t i
    ...
    do
        ...
        if (rax_2 == 0)
            sub_1428d0210(rdi, rsi, 0x40000000, rax_4, rax_3, sub_14295b840)
        else
            sub_1428d04c0(rdi, rsi, 0x40000000, rax_4, rax_3, sub_14295c5e0)
...
if (r12 != 0)
    ...
    if (rax_5 == 0)
        sub_1428d0210(rdi, rsi, r8, rax_7, rax_6, sub_14295b840)
    else
        sub_1428d04c0(rdi, rsi, r8, rax_7, rax_6, sub_14295c5e0)
