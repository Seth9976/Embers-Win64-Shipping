...
int32_t var_98 = 0
int32_t rbx = *(rsi_1 + 0x28)
void* var_90 = rsi_1 + 0x10
int32_t r8 = 0
int32_t var_88 = 0xffffffff
int64_t var_84 = 0

if (rbx != 0)
    void* rax_1 = *(rsi_1 + 0x20)
...
while (true)
    ...
    if (result.d == (var_88_2.q u>> 0x20).d && var_68.q == rsi_1 + 0x10 && rdx_9 == rsi_1)
        return result
    
    int64_t r8_4 = *rdx_9 + result * 0x48
    int64_t rcx_8 = *(arg2 + 8)
    int64_t arg_8 = r8_4
    (*arg2)(rcx_8, &arg_8, r8_4 + 0x10)
