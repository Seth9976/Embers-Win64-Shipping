...
while (*(result + 0x58) != 0)
    ...
    if (r14 != 0)
        ...
        if (rax_26 != 0 && rbp_1.d u< r15_1 && (((*(rbx_1 + 0x5c) != r15_1 || arg2[0x10] != 0) && (
                zx.w(*(rdi_1 + 4)) * 0x100 + zx.w(*(rdi_1 + 5)) != 0xffff
                || zx.w(*(rdi_1 + 6)) * 0x100 + zx.w(*(rdi_1 + 7)) != 0xffff))
                || zx.w(*rdi_1) * 0x100 != neg.w(zx.w(*(rdi_1 + 1)))
                || zx.w(*(rdi_1 + 2)) * 0x100 + zx.w(*(rdi_1 + 3)) != 0x4000))
            if (*(rbx_1 + 0x59) == 0)
    ...
    if (rbp_2 + 2 u<= *(r11_2 + 0x60))
        char* r10_3 = *arg1
        uint32_t rdx_20 = (zx.d(r10_3[1]) << 0x10) + (zx.d(r10_3[2]) << 8) + (zx.d(*r10_3) << 0x18)
            + zx.d(r10_3[3])
        void* r9_13 = &r10_3[((zx.q(r10_3[0xa]) + (((zx.q(r10_3[8]) << 8) + zx.q(r10_3[9])) << 8))
            << 8) + zx.q(r10_3[0xb])]
        int32_t rax_46
        rax_46.b = rdx_20 == 0
        uint64_t rax_47 = zx.q(rax_46 + rdx_20 * r14)
        void* r10_4 = &r10_3[((zx.q(r10_3[0xe])
            + (((zx.q(r10_3[0xc]) << 8) + zx.q(r10_3[0xd])) << 8)) << 8) + zx.q(r10_3[0xf])
            + ((zx.q(*(r9_13 + (rax_47 << 1) + 1)) + (zx.q(*(r9_13 + (rax_47 << 1))) << 8)) << 3)]
        
        if ((rbp_2 != *(r11_2 + 0x60) || arg2[0x10] != 0) && (
                zx.w(*(r10_4 + 5)) + zx.w(*(r10_4 + 4)) * 0x100 != 0xffff
                || zx.w(*(r10_4 + 6)) * 0x100 + zx.w(*(r10_4 + 7)) != 0xffff) && 2 u>= 2)
            sub_142bf5c70(r11_2, rbp_2, rbp_2 + 2)
    
    sub_142c35020(arg2, arg1, rdi_1)
    void* r9_16 = arg1[1]
    r14 = (zx.d(*rdi_1) << 8) + zx.d(*(rdi_1 + 1))
    result = zx.q(*(r9_16 + 0x60))
    
    if (*(r9_16 + 0x5c) == result.d)
        break
    
    int32_t rcx_31
    
    if ((0x4000 & (zx.w(*(rdi_1 + 3)) + zx.w(*(rdi_1 + 2)) * 0x100)) != 0)
        rcx_31 = *(r9_16 + 0x30)
        *(r9_16 + 0x30) = rcx_31 - 1
    
    if ((0x4000 & (zx.w(*(rdi_1 + 3)) + zx.w(*(rdi_1 + 2)) * 0x100)) == 0 || rcx_31 s<= 0)
        void* rbx_3 = arg1[1]
        ...
        if (*(rbx_3 + 0x59) == 0)
            *(rbx_3 + 0x5c) += 1
            ...
            if (sub_142bf50b0(rbx_3, 1, 1) != 0)
                int64_t rdx_30 = *(rbx_3 + 0x70)
                uint64_t r9_17 = zx.q(*(rbx_3 + 0x5c)) * 5
                uint64_t rcx_33 = zx.q(*(rbx_3 + 0x64)) * 5
                int64_t rax_58 = *(rbx_3 + 0x78)
                *(rax_58 + (rcx_33 << 2)) = *(rdx_30 + (r9_17 << 2))
                *(rax_58 + (rcx_33 << 2) + 0x10) = *(rdx_30 + (r9_17 << 2) + 0x10)
                *(rbx_3 + 0x64) += 1
                *(rbx_3 + 0x5c) += 1
        else
            *(rbx_3 + 0x64) += 1
