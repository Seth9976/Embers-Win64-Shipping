...
if (arg3[0x86].b == 0)
    ...
    if (rax_14 != 0)
        rax_14[1] = arg1
        *rax_14 = &data_142da5808
        rax_14[3] = sub_140a387b0()
        *rax_14 = &data_142da5860
    
    rax_11 = &var_18
    
    if (&var_18 == arg4)
        goto label_1406f0992
    ...
    if (rbx_1 == 0)
        if (rax_6 != 0)
            rax_6[1] = arg1
            *rax_6 = &data_142da5758
            rax_6[3] = sub_140a387b0()
            *rax_6 = &data_142da57b0
    else if (rax_6 != 0)
        rax_6[1] = arg1
        *rax_6 = &data_142da56a8
        rax_6[3] = sub_140a387b0()
        *rax_6 = &data_142da5700
    
    rax_11 = &var_18
    
    if (&var_18 == arg4)
        goto label_1406f08cc
