    ...
    label_1423b8d1d:
        ...
        while (true)
            ...
            if (rdx_3 s<= 8)
                for (; i u> r11_1; i -= 0xc)
                    uint64_t* r8_5 = r11_1
                    uint64_t* rdx_13 = r11_1 + 0xc
                    
                    if (r11_1 + 0xc u<= i)
                        do
                            uint64_t* rcx_18 = rdx_13
                            
                            if (r8_5[1].d s<= rdx_13[1].d)
                                rcx_18 = r8_5
            ...
            while (true)
                ...
                if (r9_1 u<= i && r11_1[1].d s<= r9_1[1].d)
                    continue
