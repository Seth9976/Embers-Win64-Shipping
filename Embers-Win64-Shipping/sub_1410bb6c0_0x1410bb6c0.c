...
if (data_143e2d210 s> *rdi_1)
    _Init_thread_header(&data_143e2d210)
    
    if (data_143e2d210 == 0xffffffff)
        ...
        data_143e2d208 = rax_8
        _Init_thread_footer(&data_143e2d210)

if (data_143e2d220 s> *rdi_1)
    _Init_thread_header(&data_143e2d220)
    
    if (data_143e2d220 == 0xffffffff)
        ...
        data_143e2d218 = rax_11
        _Init_thread_footer(&data_143e2d220)

int64_t rdi_2 = data_143e2d218
int64_t rcx
