...
if (arg2 s>= 0)
    if (arg2 s<= 1)
        void var_a8
        void** rax_36 = sub_1405f45f0(&var_a8, nullptr, 0xff)
        var_140 = nullptr
        void* r12_1 = *rax_36
        int32_t rax_37 = 2
        ...
        *(r12_1 + 0x30) = var_68.o
        *(r12_1 + 0x40) = zmm0
        void (* rax_40)(int64_t* arg1) = var_88
        ...
        *(r12_1 + 0x68) = rax_37
        ...
        sub_1405ff810(rcx_28, rax_36[1], rax_36[2].d, 1)
        ...
        if (rax_17 == 0)
            ...
            *(r14 + 0x80) = 0
            ...
            if (rax_18 == 0)
                ...
                *(rsi_2 + 0x30) = var_68.o
                *(rsi_2 + 0x40) = zmm0
                void (* rax_21)(int64_t* arg1) = var_88
            ...
            void*** rax_28
            int128_t zmm1_4
            rax_28, zmm1_4 = sub_140a6e140(rsi_2, rdx_4, 0, 0, -1, 0)
            r14_1->__offset(0x80).q = rax_28
        ...
        if (rax_7 == 0)
            ...
            *(rsi_1 + 0x30) = var_68.o
            *(rsi_1 + 0x40) = zmm0
            void (* rax_10)(int64_t* arg1) = var_88
