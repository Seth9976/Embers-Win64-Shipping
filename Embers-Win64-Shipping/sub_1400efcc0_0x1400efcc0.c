...
do
    ...
    float temp0_4[0x4] = __vaddps_xmmdq_xmmdq_memdq(
        __vmulps_xmmdq_xmmdq_memdq(temp0_1, *(arg2 + rax - 0x10)), *(arg1 + rax - 0x10))
    float temp0_7[0x4] = __vmulps_xmmdq_xmmdq_memdq(
        __vaddps_xmmdq_xmmdq_xmmdq(__vmulps_xmmdq_xmmdq_memdq(temp0_1, *(arg2 + rax)), zmm11), 
        *(arg1 + rax))
    ...
    if (not(0x3f800000 f<= (temp0_8 f* temp0_8[0])[0]))
        ...
        float temp0_15[0x4] = __vaddps_xmmdq_xmmdq_xmmdq(
            ...
            __vmulps_xmmdq_xmmdq_xmmdq(
                __vmulps_xmmdq_xmmdq_xmmdq(_mm_permute_ps(temp0_2, 0), _mm_permute_ps(zmm4, 0x1b)), 
                zmm8))
        float temp0_20[0x4] = __vaddps_xmmdq_xmmdq_xmmdq(
            __vmulps_xmmdq_xmmdq_xmmdq(
                ...
                zmm9), 
            temp0_15)
        *(arg1 + rax - 0x20) = __vaddps_xmmdq_xmmdq_xmmdq(
            __vmulps_xmmdq_xmmdq_xmmdq(
