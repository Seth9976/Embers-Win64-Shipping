...
if (r8 s< 2 || zmm0.d f<= 0f)
    rax_3 = sub_141df1fe0(&var_88, sx.q((0 << 2).d) + r9_1)
    *arg2 = *rax_3
else
    ...
    if (zmm0.d f< 1f)
        ...
        if (rcx_1.d == r8_1.d)
            rax_3 = sub_141df1fe0(&var_88, sx.q((rcx_1 << 2).d) + r9_1)
            *arg2 = *rax_3
        else
            int32_t* rax_10
            int512_t zmm7_1
            rax_10, zmm7_1 = sub_141df1fe0(&var_88, sx.q((rcx_1 << 2).d) + r9_1)
            zmm7_1.o = *rax_10
            int32_t zmm6_1
            float zmm7_2[0x4]
            rax_3, zmm6_1, zmm7_2 = sub_141df1fe0(&var_88, sx.q((r8_1 << 2).d) + r9_1)
            float temp0_11[0x4] = _mm_shuffle_ps(zmm7_2, zmm7_2, 0x55)
            ...
            float temp0_13[0x4] = _mm_shuffle_ps(zmm7_2, zmm7_2, 0xaa)
            float temp0_14[0x4] = _mm_shuffle_ps(zmm2_1, zmm2_1, 0xaa)
            zmm7_2[0] = zmm7_2[0] f+ zmm0_2[0]
            float temp0_15[0x4] = _mm_shuffle_ps(zmm7_2, zmm7_2, 0xff)
            zmm0_2 = temp0_13
            ...
            float temp0_17[0x4] = _mm_shuffle_ps(zmm7_2, zmm7_2, 0xe1)
        ...
        rax_3 = sub_141df1fe0(&var_88, sx.q(r8_1.d << 2) + r9_1)
        *arg2 = *rax_3
return rax_3
