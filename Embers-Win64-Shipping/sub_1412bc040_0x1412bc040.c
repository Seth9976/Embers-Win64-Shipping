...
if (data_143e8c290 s> *rdi_1)
    _Init_thread_header(&data_143e8c290)
    
    if (data_143e8c290 == 0xffffffff)
        ...
        data_143e8c288 = rax_9
        _Init_thread_footer(&data_143e8c290)

if (data_143e8c2b0 s> *rdi_1)
    _Init_thread_header(&data_143e8c2b0)
    
    if (data_143e8c2b0 == 0xffffffff)
        ...
        data_143e8c2a8 = rax_12
        _Init_thread_footer(&data_143e8c2b0)

if (data_143e8c2d0 s> *rdi_1)
    _Init_thread_header(&data_143e8c2d0)
    
    if (data_143e8c2d0 == 0xffffffff)
        ...
        data_143e8c2c8 = rax_15
        _Init_thread_footer(&data_143e8c2d0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c288
int64_t rcx
...
label_1412bc143:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412bc13e
        
        rbx.b = 1
        goto label_1412bc143
