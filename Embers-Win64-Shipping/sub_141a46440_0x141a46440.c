...
if (0 s< r10)
    ...
    while (true)
        void* rbx_3 = sx.q(rcx_3) * 0xc0 + *rdx_2
        *(rbx_3 + 0xb0) = 0
        int64_t rcx_4 = *(rbx_3 + 0xa8)
        
        if (rcx_4 != 0)
            sub_140a74f90(rcx_4)
        
        sub_141a32530(rbx_3 + 0x68)
        *(rbx_3 + 0x60) = 0
        int64_t rcx_6 = *(rbx_3 + 0x58)
        
        if (rcx_6 != 0)
            sub_140a74f90(rcx_6)
        
        sub_141a32460(rbx_3 + 0x18)
