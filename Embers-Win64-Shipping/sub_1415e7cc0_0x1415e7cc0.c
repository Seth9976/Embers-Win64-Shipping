...
float (* var_1e0)[0x4] = &var_108
int64_t var_188
int64_t* var_1d8 = &var_188
void arg_38
void* var_1d0 = &arg_38
int32_t var_1f8
int32_t* var_1c8 = &var_1f8
void var_168
void* var_1c0 = &var_168
var_188 = (_mm_unpacklo_ps(temp0_20, _mm_shuffle_ps(temp0_20, temp0_20, 0x55)[0].q)).q
void var_158
void* var_1b8 = &var_158
var_1f8 = 0x7f7fffff
int32_t* var_1b0 = &var_1f4
int64_t var_190 = arg7
uint64_t rax_5 = zx.q(*(arg2 + 8))
int128_t* var_1a0 = arg5
int64_t* var_1a8 = arg1
int128_t* var_198 = arg6

if (rax_5.d u> 0x88)
    sub_14153a920(&var_1e8, arg2)
else
    switch (rax_5)
        case 0, 2, 5, 6, 7, 9, 0xa, 0xb, 0xc, 0xd, 0xe, 0xf, 0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 
            ...
            sub_14153a920(&var_1e8, arg2)
        case 1
            sub_1415302e0(&var_1e8, arg2)
        case 3
            sub_141532220(&var_1e8, arg2)
        case 4
            ...
            if (_mm_movemask_ps(_mm_cmpeq_ps(_mm_min_ps(zmm14, zmm8), data_143ef7530, 1)) == 0)
                ...
                float temp0_172[0x4] = _mm_shuffle_ps(temp0_160, temp0_160, 0xd2)
                float temp0_173[0x4] = __mulps_xmmps_memps(temp0_170, data_143ef72c0)
                float temp0_174[0x4] = _mm_add_ps(temp0_165, temp0_171)
                float temp0_175[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xd2)
                float temp0_176[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xc9)
                float temp0_177[0x4] = _mm_mul_ps(temp0_172, temp0_176)
                zmm6 = _mm_add_ps(temp0_174, temp0_173)
                float temp0_181[0x4] = _mm_sub_ps(temp0_177, 
                    _mm_mul_ps(_mm_shuffle_ps(temp0_160, temp0_160, 0xc9), temp0_175))
                float temp0_182[0x4] = _mm_add_ps(temp0_181, temp0_181)
                float temp0_183[0x4] = _mm_shuffle_ps(temp0_182, temp0_182, 0xd2)
                float temp0_184[0x4] = _mm_shuffle_ps(temp0_182, temp0_182, 0xc9)
                float temp0_185[0x4] = _mm_mul_ps(temp0_183, temp0_176)
                float temp0_186[0x4] = _mm_mul_ps(temp0_184, temp0_175)
                float temp0_187[0x4] = _mm_mul_ps(temp0_182, temp0_162)
                zmm7 = __addps_xmmps_memps(
                    _mm_add_ps(_mm_sub_ps(temp0_185, temp0_186), _mm_add_ps(temp0_187, temp0_160)), 
                    arg3[1])
            else
                zmm3 = *arg3
                ...
                zmm9 = arg3[1]
                float temp0_29[0x4] = _mm_shuffle_ps(zmm3, zmm3, 4)
                _mm_mul_ps(zmm14, zmm8)
                float var_88_1[0x4] = zmm11
                zmm11 = data_143ef72f0
                float temp0_32[0x4] = _mm_mul_ps(temp0_29, _mm_shuffle_ps(temp0_28, temp0_28, 0x29))
                float temp0_33[0x4] = _mm_mul_ps(temp0_28, zmm3)
                float temp0_34[0x4] = _mm_shuffle_ps(temp0_28, temp0_28, 0x12)
                float temp0_36[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm3, zmm3, 0xff), temp0_34)
                float temp0_39[0x4] = _mm_add_ps(_mm_shuffle_ps(temp0_33, temp0_33, 0x1a), 
                    _mm_shuffle_ps(temp0_33, temp0_33, 1))
                float temp0_40[0x4] = _mm_add_ps(temp0_36, temp0_32)
                float temp0_41[0x4] = _mm_sub_ps(temp0_32, temp0_36)
                ...
                float zmm1[0x4] = __andps_xmmxud_memxud(_mm_mul_ps(temp0_42, zmm8), data_143ef7300)
                ...
                float temp0_61[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_55, temp0_55, 0x29), temp0_58)
                float temp0_62[0x4] = _mm_shuffle_ps(zmm1, zmm1, 0xff)
                float temp0_64[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_55, temp0_55, 0x12), temp0_62)
                ...
                float temp0_94[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_81, temp0_81, 0), temp0_49)
                ...
                int96_t var_118_1 = _mm_add_ps(_mm_add_ps(temp0_125, temp0_120), temp0_124)[0].12
                int512_t zmm9_1
                int512_t zmm10_1
                float zmm11_1[0x4]
                int512_t zmm12_1
                ...
                var_148[1] = zmm1_1
                zmm1_1 = var_138_1:4.d * temp0_130[0]
                var_148[2] = zmm0_1[0]
                ...
                zmm1_1 = var_128_1:4.d * temp0_131[0]
                ...
                zmm6 = _mm_and_ps(_mm_mul_ps(temp0_150, zmm5_1) ^ data_143ef72a0, zmm0_2)
                    ^ data_143ef72a0
            ...
            int512_t zmm14_1
            int512_t zmm15_2
            zmm7_1, zmm8_1, zmm13_1, zmm14_1, zmm15_2 = sub_141540110(rcx_16, &var_148, &var_1e8)
            zmm15_2.o = zmm15
            zmm14_1.o = var_b8_1
            zmm13_1.o = var_a8_1
            zmm8_1.o = var_58_1
            zmm7_1.o = var_48_1
        case 8
            sub_14153c860(&var_1e8, arg2)
        case 0x40
            sub_14153a920(&var_1e8, *(arg2 + 0x10))
        case 0x41
            sub_1415302e0(&var_1e8, *(arg2 + 0x10))
        case 0x43
            sub_141532220(&var_1e8, *(arg2 + 0x10))
        case 0x48
            sub_14153c860(&var_1e8, *(arg2 + 0x10))
        case 0x80
            sub_141537490(&var_1e8, arg2)
        case 0x81
            sub_1415340b0(&var_1e8, arg2)
        case 0x83
            sub_141535aa0(&var_1e8, arg2)
        case 0x88
            sub_141538e80(&var_1e8, arg2)
