...
float zmm6[0x4] = (*arg9)[1] ^ 0x80000000
float zmm7[0x4] = (*arg9)[2] ^ 0x80000000
...
while (true)
    ...
    zmm4[0] = zmm4[0] + zmm12[0]
    zmm12[0] = zmm12[0] f* *(rsi + 0x2c)
    zmm3[0] = zmm3[0] + zmm4[0]
    var_26c = zmm12[0]
    zmm3[0] = zmm3[0] f* *(rsi + 0x30)
    var_268 = zmm3[0]
    zmm11 = sub_141758e70(rcx_2, &var_260, &var_270, zmm11)
    zmm3 = var_260
    zmm3[0] = zmm3[0] f* *(rsi + 0x28)
    zmm0 = var_258
    zmm0[0] = zmm0[0] f* *(rsi + 0x30)
    zmm2 = var_25c
    zmm2[0] = zmm2[0] f* *(rsi + 0x2c)
    zmm4 = *arg3
    float temp0_10[0x4] =
    ...
    float temp0_14[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_10, temp0_10, 0xd2), temp0_11)
    float temp0_15[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xd2)
    float temp0_17[0x4] = _mm_sub_ps(temp0_14, _mm_mul_ps(temp0_12, temp0_15))
    float temp0_18[0x4] = _mm_add_ps(temp0_17, temp0_17)
    float temp0_19[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xff)
    float temp0_21[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_18, temp0_18, 0xc9), temp0_15)
    float temp0_23[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_18, temp0_18, 0xd2), temp0_11)
    zmm3 = var_290.d
    float temp0_24[0x4] = _mm_mul_ps(temp0_19, temp0_18)
    zmm2 = var_290:4.d
    zmm0 = var_288
    float temp0_28[0x4] = __addps_xmmps_memps(
        _mm_add_ps(_mm_sub_ps(temp0_23, temp0_21), _mm_add_ps(temp0_24, temp0_10)), arg3[1])
    *(&var_1a8:4 + (sx.q(i_6) << 2)) = i_6
    zmm3[0] = zmm3[0] - temp0_28[0]
    int64_t rdx_3 = sx.q(var_1a8.d)
    int32_t rax_12 = rbx_1[2]
    ...
    *(&var_118 + (rcx_3 << 2)) = (_mm_unpacklo_ps(zmm3, zmm2[0].q)).q
    ...
    if (rdx_3.d == 0)
        int64_t rax_19 = sx.q(var_1a8:4.d)
        int64_t rcx_11 = rax_19 * 3
        var_188[rax_19] = 0x3f800000
        zmm0 = zx.o(*(&var_118 + (rcx_11 << 2)))
        var_2ac_1 = (&var_110)[rcx_11]
    else
        uint64_t* rax_16
        
        if (rdx_3.d == 1)
            rax_16 = sub_1416e69d0(&var_2a0, &var_118, &var_1a8:4, &var_1a8, &var_188)
        label_1415f708f:
            zmm0 = zx.o(*rax_16)
            var_2ac_1 = rax_16[1].d
            i_7 = var_1a8.d
        else
            if (rdx_3.d == 2)
                rax_16, zmm11, zmm14, zmm15 = sub_1416fa750(&var_280, &var_118, &var_1a8, &var_188)
                goto label_1415f708f
            
            if (rdx_3.d == 3)
                uint64_t var_1b8[0x2]
                rax_16, zmm11, zmm14, zmm15 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
                goto label_1415f708f
    ...
    int32_t var_14c_1 = rax_21
    int32_t rax_22 = (&var_140)[rdi]
    ...
    i_6 = i_7
    rdx = var_2c8
    float temp0_34[0x4] = _mm_sqrt_ss(0, zmm4[0])
    var_2a8 = zmm4[0]
...
if (zmm15[0] <= zmm8[0])
    ...
    uint128_t zmm11_1
    uint128_t zmm14_1
    rax_30, zmm8_1, zmm11_1, zmm14_1 = sub_141558d60(&var_280, &var_2a0, &var_230, &var_218, zmm14, 
    ...
    if (rax_30 == 2)
        ...
        *arg5 = (_mm_unpacklo_ps(zmm0_2, zmm1_1.q)).q
        ...
        zmm0_2.d = var_268.d f- zmm4_1.d
        *arg6 = (_mm_unpacklo_ps(zmm3_1, zmm2_1.q)).q
        arg6[1].d = zmm0_2.d
        uint64_t rcx_23 = var_2a0
    ...
    temp0_35[0] = temp0_35[0] + temp0_35[0]
    zmm11[0] = zmm11[0] * temp0_35[0]
    zmm11[0] = zmm11[0] * temp0_35[0]
    zmm11[0] = zmm11[0] * temp0_35[0]
    float temp0_36[0x4] = _mm_unpacklo_ps(zmm11, zmm11[0].q)
    *arg7 = temp0_36.q
    float temp0_37[0x4] = __sqrtss_xmmss_memss(temp0_36[0], var_2a8)
