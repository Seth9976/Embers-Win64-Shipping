...
if (*(arg1 + 0x24) u>= 6)
    ...
    do
        ...
        zmm1 = _mm_unpacklo_pd(zmm6_1, zmm0_1.q)
        var_48 = zmm1
...
if (i u<= *(arg1 + 0x24))
    ...
    do
        ...
        if (rbp_2 u>= *(arg1 + 0x24))
            *(arg1 + 0x20) = 1
        
        int128_t* rdi_10
        
        if (rbp_2 u< *(arg1 + 0x28))
            rdi_10 = (zx.q(rbp_2) << 5) + *(arg1 + 0x30)
        else
        ...
        if (rbp_2 - 1 u>= *(arg1 + 0x24))
            *(arg1 + 0x20) = 1
        
        int128_t* rsi_10
        
        if (rbp_2 - 1 u< *(arg1 + 0x28))
            rsi_10 = (zx.q(rbp_2 - 1) << 5) + *(arg1 + 0x30)
        else
            rsi_10 = &data_144017550
            __builtin_memset(&data_144017550, 0, 0x20)
        
        sub_142c0e810(arg1, rsi_10)
        zmm1.q = var_58:8.q f+ *rdi_10
        var_58.q = var_58.q f+ *rsi_10
        var_58:8.q = zmm1.q
        sub_142c116b0(arg1, arg2, &var_58)
        rbp_2 += 2
        i = rbp_2 + 1
    while (i u<= *(arg1 + 0x24))
