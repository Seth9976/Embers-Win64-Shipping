...
float var_124 = temp0[0]
float var_120 = temp0_1[0]
void** var_108
float zmm9[0x4]
float zmm10[0x4]
float zmm11[0x4]
zmm9, zmm10, zmm11 = sub_142230c80(arg1, &var_108, &var_128, &data_143dbb0c0)
sub_140ade170(arg1 + 0x3c, &var_128)
float zmm2[0x4] = *(arg1 + 0x34)
int32_t zmm14 = (zx.o(0)).d
float zmm15[0x4] = data_14399f668
float zmm7[0x4] = arg3[2]
float zmm5[0x4] = *arg3
float zmm12[0x4] = var_128.o
float temp0_2[0x4] = _mm_unpacklo_ps(*(arg1 + 0x30), (*(arg1 + 0x38))[0].q)
float temp0_3[0x4] = _mm_unpacklo_ps(zmm15, data_14399f670[0].q)
...
uint32_t result =
    _mm_movemask_ps(__cmpps_xmmps_memps_immb(_mm_min_ps(temp0_7, zmm7), data_143f51400, 1))
float zmm6[0x4]
float zmm8[0x4]

if (result == 0)
    zmm8 = 0x322bcc77
    float temp0_140[0x4] = _mm_mul_ps(temp0_5, zmm7)
    float temp0_143[0x4] =
        _mm_mul_ps(_mm_shuffle_ps(zmm12, zmm12, 0x1b), _mm_shuffle_ps(zmm5, zmm5, 0))
    float temp0_144[0x4] = _mm_shuffle_ps(zmm12, zmm12, 0x4e)
    float temp0_145[0x4] = _mm_shuffle_ps(temp0_140, temp0_140, 0xd2)
    float temp0_146[0x4] = _mm_shuffle_ps(zmm5, zmm5, 0xff)
    float temp0_147[0x4] = __mulps_xmmps_memps(temp0_143, data_143f513c0)
    float temp0_148[0x4] = _mm_mul_ps(temp0_146, zmm12)
    float temp0_149[0x4] = _mm_shuffle_ps(zmm12, zmm12, 0xb1)
    float temp0_150[0x4] = _mm_add_ps(temp0_147, temp0_148)
    float temp0_152[0x4] = _mm_mul_ps(temp0_144, _mm_shuffle_ps(zmm5, zmm5, 0x55))
    ...
    float temp0_13[0x4] = _mm_shuffle_ps(zmm7, zmm7, 0xc9)
    float temp0_14[0x4] = _mm_mul_ps(zmm5, temp0_11)
    float temp0_16[0x4] = _mm_mul_ps(temp0_12, _mm_shuffle_ps(temp0_11, temp0_11, 0x29))
    float temp0_17[0x4] = _mm_shuffle_ps(temp0_11, temp0_11, 0x12)
    float temp0_20[0x4] =
        _mm_add_ps(_mm_shuffle_ps(temp0_14, temp0_14, 0x1a), _mm_shuffle_ps(temp0_14, temp0_14, 1))
    float temp0_22[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm5, zmm5, 0xff), temp0_17)
    float temp0_23[0x4] = _mm_sub_ps(zmm10, temp0_20)
    float temp0_24[0x4] = _mm_add_ps(temp0_22, temp0_16)
    float temp0_25[0x4] = _mm_sub_ps(temp0_16, temp0_22)
    float temp0_26[0x4] = _mm_mul_ps(temp0_23, zmm7)
    float temp0_27[0x4] = _mm_mul_ps(temp0_24, zmm7)
    float temp0_28[0x4] = _mm_mul_ps(temp0_13, temp0_25)
    float zmm1_1[0x4] = __andps_xmmxud_memxud(temp0_26, data_143f51340)
    float temp0_30[0x4] = _mm_shuffle_ps(zmm12, zmm12, 4)
    float temp0_33[0x4] = _mm_shuffle_ps(_mm_shuffle_ps(temp0_27, zmm1_1, 0), 
        _mm_shuffle_ps(temp0_28, zmm1_1, 0x32), 0x82)
    float temp0_34[0x4] = _mm_shuffle_ps(temp0_27, zmm1_1, 0x31)
    float temp0_36[0x4] = _mm_shuffle_ps(_mm_shuffle_ps(temp0_28, zmm1_1, 0x10), temp0_34, 0x88)
    float temp0_38[0x4] = _mm_shuffle_ps(_mm_shuffle_ps(temp0_27, temp0_28, 0x12), zmm1_1, 0xe8)
    float temp0_39[0x4] = _mm_add_ps(zmm12, zmm12)
    zmm10[0].q = zmm8 u>> 0x40
    float temp0_40[0x4] = _mm_shuffle_ps(zmm8, zmm10, 0xc4)
    float temp0_41[0x4] = _mm_shuffle_ps(zmm12, zmm12, 0xff)
    float temp0_42[0x4] = _mm_shuffle_ps(temp0_7, temp0_7, 0xc9)
    float temp0_43[0x4] = _mm_mul_ps(zmm12, temp0_39)
    float temp0_45[0x4] = _mm_mul_ps(temp0_30, _mm_shuffle_ps(temp0_39, temp0_39, 0x29))
    ...
    zmm1_1 = _mm_and_ps(_mm_mul_ps(temp0_53, temp0_7), zmm12)
    float temp0_60[0x4] = _mm_shuffle_ps(_mm_shuffle_ps(temp0_54, zmm1_1, 0), 
        _mm_shuffle_ps(temp0_55, zmm1_1, 0x32), 0x82)
    float temp0_61[0x4] = _mm_shuffle_ps(temp0_55, zmm1_1, 0x10)
    float temp0_62[0x4] = _mm_shuffle_ps(temp0_60, temp0_60, 0x55)
    float temp0_64[0x4] = _mm_shuffle_ps(temp0_61, _mm_shuffle_ps(temp0_54, zmm1_1, 0x31), 0x88)
    ...
    float temp0_77[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_64, temp0_64, 0), temp0_33)
    ...
    int512_t zmm11_1
    float zmm15_1[0x4]
    zmm8, zmm9_1, zmm10_1, zmm11_1, zmm12, zmm14, zmm15_1 = sub_1407740e0(&var_168, 0x322bcc77)
    float temp0_111[0x4] = __mulps_xmmps_memps(zmm15_1, arg3[2])
    float zmm2_1[0x4] = var_168[0]
    float zmm4_2[0x4] =
        _mm_and_ps(_mm_cmpeq_ps(data_143f51400, temp0_111, 2), data_143f513f0 ^ zmm10_1)
        ^ data_143f513f0
    zmm2_1[0] = zmm2_1[0] * zmm4_2[0]
    uint32_t zmm0_2[0x4] = var_168[2]
    float zmm1_2 = var_168[1] * zmm4_2[0]
    ...
    result = sub_14077e4a0(&var_118, &var_168)
    zmm5 = var_118
    zmm6 = data_143f513e0
    zmm11_1.o = zmm11
    zmm9_1.o = zmm9
    ...
    zmm7 = _mm_unpacklo_ps(_mm_unpacklo_ps(var_138_1.d, var_138_1:8.d[0].q), temp0_135[0].q)

float temp0_175[0x4] = __mulps_xmmps_memps(zmm6, data_143f51410)
zmm2 = (*arg2)[1]
float temp0_176[0x4] = _mm_unpacklo_ps(*arg2, (*arg2)[2][0].q)
float temp0_177[0x4] = _mm_shuffle_ps(temp0_175, temp0_175, 0xc9)
float temp0_180[0x4] = _mm_sub_ps(_mm_unpacklo_ps(temp0_176, _mm_unpacklo_ps(zmm2, 0)[0].q), zmm7)
float temp0_181[0x4] = _mm_shuffle_ps(temp0_175, temp0_175, 0xd2)
float temp0_182[0x4] = _mm_shuffle_ps(temp0_175, temp0_175, 0xff)
float zmm4_1[0x4] = _mm_and_ps(temp0_180, zmm12)
float temp0_185[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm4_1, zmm4_1, 0xc9), temp0_181)
float temp0_188[0x4] =
    _mm_sub_ps(_mm_mul_ps(_mm_shuffle_ps(zmm4_1, zmm4_1, 0xd2), temp0_177), temp0_185)
...
float temp0_193[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_189, temp0_189, 0xd2), temp0_177)
float temp0_194[0x4] = _mm_add_ps(temp0_190, zmm4_1)
float temp0_196[0x4] = _mm_sub_ps(temp0_193, _mm_mul_ps(temp0_191, temp0_181))
int32_t var_b8
float zmm0_1[0x4] = var_b8
zmm0_1[0] = zmm0_1[0] * 0.5f
float temp0_197[0x4] = _mm_add_ps(temp0_196, temp0_194)
float temp0_198[0x4] = _mm_shuffle_ps(temp0_197, temp0_197, 0xaa)
float temp0_199[0x4] = _mm_shuffle_ps(temp0_197, temp0_197, 0x55)
zmm4_1 = _mm_and_ps(temp0_198, 0x7fffffff)
zmm4_1[0] = zmm4_1[0] - zmm0_1[0]
zmm5 = _mm_and_ps(temp0_197, 0x7fffffff)
int32_t var_bc
zmm0_1 = var_bc
float zmm3[0x4] = _mm_and_ps(temp0_199, 0x7fffffff)
zmm0_1[0] = zmm0_1[0] * 0.5f
float temp0_203[0x4] = _mm_max_ss(zmm4_1[0], zmm14)
...
float temp0_204[0x4] = _mm_max_ss(zmm3[0], zmm14)
float temp0_205[0x4] = _mm_max_ss(zmm5[0], zmm14)
temp0_204[0] = temp0_204[0] * temp0_204[0]
temp0_205[0] = temp0_205[0] * temp0_205[0]
temp0_205[0] = temp0_205[0] + temp0_204[0]
temp0_205[0] = temp0_205[0] + temp0_203[0]
_mm_sqrt_ss(0, temp0_205[0])[0] > zmm8[0]
return result
