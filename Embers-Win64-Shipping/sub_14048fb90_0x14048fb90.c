...
int64_t (* i)(int64_t arg1, int64_t* arg2) = sub_1412eafb0
...
int32_t var_28 = 0xa010
sub_1419c2220(&data_143e8f670, 1, FPathTracingLightData", FPathTracingLightData", 0x42f49a30, 
    nullptr)
...
return atexit(sub_142cd8f10) __tailcall
