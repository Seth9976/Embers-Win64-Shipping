...
if (data_143e8e470 s> *rdi_1)
    _Init_thread_header(&data_143e8e470)
    
    if (data_143e8e470 == 0xffffffff)
        ...
        data_143e8e468 = rax_9
        _Init_thread_footer(&data_143e8e470)

if (data_143e8e480 s> *rdi_1)
    _Init_thread_header(&data_143e8e480)
    
    if (data_143e8e480 == 0xffffffff)
        ...
        data_143e8e478 = rax_12
        _Init_thread_footer(&data_143e8e480)

if (data_143e8e490 s> *rdi_1)
    _Init_thread_header(&data_143e8e490)
    
    if (data_143e8e490 == 0xffffffff)
        ...
        data_143e8e488 = rax_15
        _Init_thread_footer(&data_143e8e490)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8e468
int64_t rcx
