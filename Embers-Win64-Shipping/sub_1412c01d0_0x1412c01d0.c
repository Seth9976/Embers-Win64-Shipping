...
if (data_143e8b598 s> *rdi_1)
    _Init_thread_header(&data_143e8b598)
    
    if (data_143e8b598 == 0xffffffff)
        ...
        data_143e8b590 = rax_9
        _Init_thread_footer(&data_143e8b598)

if (data_143e8b5a8 s> *rdi_1)
    _Init_thread_header(&data_143e8b5a8)
    
    if (data_143e8b5a8 == 0xffffffff)
        ...
        data_143e8b5a0 = rax_12
        _Init_thread_footer(&data_143e8b5a8)

if (data_143e8b5b8 s> *rdi_1)
    _Init_thread_header(&data_143e8b5b8)
    
    if (data_143e8b5b8 == 0xffffffff)
        ...
        data_143e8b5b0 = rax_15
        _Init_thread_footer(&data_143e8b5b8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b590
int64_t rcx
...
label_1412c02d3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412c02ce
        
        rbx.b = 1
        goto label_1412c02d3
