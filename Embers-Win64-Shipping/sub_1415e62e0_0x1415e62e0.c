...
if (rdx_1 == 0)
    ...
    if (rax_6 == 0)
        ...
        if (rdi != 0 && sub_1415d4a10(arg4, rdi, &var_b8, arg6, &var_e0, &var_d0, &var_e8) != 0)
            arg1[3].d = var_e8[0]
        ...
        if (rdx_2 != 0 && sub_1415d4a10(arg4, rdx_2, &var_b8, arg6, &var_e0, &var_d0, &var_e8) != 0)
            arg1[3].d = var_e8[0]
            ...
            *arg1 = (_mm_unpacklo_ps(temp0_93, _mm_shuffle_ps(temp0_93, temp0_93, 0x55)[0].q)).q
            arg1[1].d = var_c8_2
else if (sub_1415d3c50(arg4, rdx_1, &var_b8, arg6, &var_e0, &var_d0, &var_e8) != 0)
    arg1[3].d = var_e8[0]
