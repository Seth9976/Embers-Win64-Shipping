...
sub_141cd5770(arg1, &var_98, arg3)
int32_t var_70
int32_t r11 = var_70
int64_t var_88
...
if (r11 != 0)
    ...
    label_141cd213b:
        ...
        while (true)
            ...
            if (rdx_4 != 0)
                goto label_141cd213b

double zmm2[0x2] = var_108.o
int128_t var_c0 = var_118.o
double var_b0[0x2] = zmm2
double temp0_3[0x2] = _mm_unpackhi_pd(zmm2, zmm2[0])
int128_t var_f0 = (&var_98).o
int128_t var_e0 = var_c0
int64_t var_d0 = temp0_3.q

while (true)
    int64_t rax_16 = sx.q(var_e0:0xc.d)
    int64_t rcx_5 = var_f0.q
    
    if (rax_16.d == r11 && var_e0.q == &var_88 && rcx_5 == &var_98)
        int32_t var_50_1 = 0
        
        if (var_58 != 0)
            sub_140a74f90(var_58)
        
        int64_t result = sub_141cdbc00(&var_98, 0)
    ...
    int64_t* rsi_3 = rax_16 * 0x60 + *rcx_5
    var_118.o = data_142d3f660
    sub_14099c850(arg2, *rsi_3, 0, &var_118, 0)
    int64_t rbx_1 = *rsi_3
    var_118.q = rbx_1
    void* const rcx_10
    ...
    label_141cd2290:
        ...
        int32_t rax_19 = sub_140b5ead0(rbx_1.d) + var_114
        void* r8_3 = &arg2[7]
        void* rcx_8 = *(r8_3 + 8)
    ...
    void* r15_1 = *(rcx_10 + 8)
    *(r15_1 + 8) = rsi_3[3].d
    *(r15_1 + 0xc) = *(rsi_3 + 0x1c)
    *(r15_1 + 0x10) = rsi_3[4].d
    
    if (r15_1 + 0x18 != &rsi_3[5])
        ...
        sub_141ccfbe0(r15_1 + 0x18, rsi_3[5], rsi_3[6].d, *(r15_1 + 0x24), 0)
    
    var_e0:8.d &= not.d(var_f0:0xc.d)
    *(r15_1 + 0x30) = *(rsi_3 + 0x40)
