...
while (true)
    ...
    if (result.d == (var_78_2.q u>> 0x20).d && var_58.q == arg2 + 0x10 && rdx_12 == arg2)
        return result
    
    int64_t* rdx_13 = *rdx_12 + result * 0x28
    sub_1406253f0(arg1, rdx_13, &rdx_13[2])
    int32_t var_5c
