    ...
    do
        ...
        if (rdi s> 0)
            if (rdi u>= 4 && result s>= 2)
                ...
                zmm8 = _mm_sub_ps(_mm_add_ps(temp0_3, temp0_3), _mm_mul_ps(zmm0, zmm1))
                float temp0_18[0x4]
                ...
                do
                    *(r12 + (rsi_1 << 2))
                    ...
                    uint32_t zmm7_1[0x4]
                    float zmm9_1[0x4]
                    zmm0_1, zmm6_1, zmm7_1, zmm9_1 = sub_142c94100(_mm_mul_ps(
                        _mm_mul_ps(
                            _mm_mul_ps(
                                _mm_cvtepi32_ps(_mm_mullo_epi32(
                                    _mm_add_epi32(_mm_shuffle_epi32(zx.o(i), 0), zmm13), zmm11)), 
                                zmm14), 
                            zmm15), 
                        zmm8))
                    _mm_add_ps(zmm9_1, _mm_mul_ps(zmm0_1, zmm6_1))
                    zmm0, zmm6, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13, zmm14, zmm15 =
                        sub_142c93930(zmm7_1)
                    i += 4
                    rsi_1 += 4
                    temp0_18 = _mm_sub_ps(zmm10, _mm_mul_ps(zmm0, zmm6))
                while (i s< rdi - rax_1)
                
                temp0_18[0].q = temp0_18 u>> 0x40
                zmm6 = _mm_add_ps(temp0_18, temp0_18)
                zmm9[0].q = zmm9 u>> 0x40
                float temp0_20[0x4] = _mm_add_ps(zmm9, zmm9)
                zmm0 = _mm_shuffle_ps(zmm6, zmm6, 0xf5)
                zmm6[0] = zmm6[0] f+ zmm0.d
                zmm0 = _mm_shuffle_ps(temp0_20, temp0_20, 0xf5)
            ...
            if (i s< rdi)
                ...
                do
                    ...
                    zmm0, zmm6, zmm7, zmm8, zmm12 = __libm_sse2_sincosf_(zmm1)
                    rbx_4 += rbp
                    zmm1.d = _mm_shuffle_ps(zmm0, zmm0, 1).d f* *rsi_2
