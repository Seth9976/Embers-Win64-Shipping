...
if (data_143e498c0 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e498c0)
    
    if (data_143e498c0 == 0xffffffff)
        ...
        data_143e498b8 = rax_15
        _Init_thread_footer(&data_143e498c0)
...
void arg_28
uint64_t result = sub_141083230(arg2, &arg_28, arg1, &var_98, var_d8, var_d0)
