...
uint128_t zmm8_1
uint128_t zmm10_1
rax_4, zmm6_1, zmm7_1, zmm8_1, zmm10_1 = sub_14170eae0(&var_248, &var_2f4, &var_320)
    ...
    *rbx_1 = zmm9.d
        ...
        *arg7 = (_mm_unpacklo_ps(zmm0_2, zmm1_2.q)).q
        ...
        label_14165b1e2:
            ...
            *arg7 = (_mm_unpacklo_ps(zmm1_2, zmm2_1.q)).q
            ...
            int32_t rax_30
            int128_t zmm15_1
            rax_30, zmm15_1 = sub_14156e310(&var_2d8, &var_170, &var_268, &var_248, &var_308, 
                &var_320, &var_280, &var_258)
            zmm0_4 = zx.o(var_320.q)
            rax_31 = var_318_1
            
            if (rax_30 == 2)
                goto label_14165b1e2
            
            *arg8 = zmm0_4.q
            arg8[1].d = rax_31
            result = result_1
            *rbx_1 = (var_308 ^ zmm15_1).d
            *arg7 = var_280
    ...
    while (true)
        ...
        *(rdi_2 + 0x2c)
        ...
        int32_t var_204_1 = (zmm15 ^ 0x80000000).d
        int32_t var_208 = (zmm14 ^ 0x80000000).d
        int32_t var_200_1 = (zmm8_2 ^ 0x80000000).d
        float var_194
        float* rax_6
        uint128_t zmm7_3
        rax_6, zmm6_1, zmm7_3, zmm8_1, zmm9, zmm10_1, zmm11, zmm12, zmm13 =
            sub_14170eae0(&var_248, &var_194, &var_208)
        zmm1_2 = zx.o(*rax_6)
