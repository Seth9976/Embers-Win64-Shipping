...
while (true)
    int64_t rcx_4 = sx.q(r14) * 3
    int64_t rax_13 = *rbx
    int64_t* rbx_1 = rax_13 + (rcx_4 << 3)
    int16_t* rcx_5
    
    if (*(rax_13 + (rcx_4 << 3) + 8) == 0)
        rcx_5 = &data_142d40450
    else
        rcx_5 = *rbx_1
    
    int32_t rax_15 = sub_140a5ff80(rcx_5, 0) & (*rsi - 1)
    *(rbx_1 + 0x14) = rax_15
    void* rdx_6 = arg1[8]
    int64_t r8_7 = sx.q(rax_15)
    void* rax_16 = &arg1[7]
    
    if (rdx_6 != 0)
        rax_16 = rdx_6
    
    rbx_1[2].d = *(rax_16 + (((sx.q(*rsi) - 1) & r8_7) << 2))
    void* rax_18 = &arg1[7]
    void* rcx_11 = arg1[8]
