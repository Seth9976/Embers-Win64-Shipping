...
int32_t var_148 = rcx_1
uint64_t var_138 = *(r8 + 0x60c)
float zmm10[0x4]
...
int32_t rsi_1 = rax_2 * arg2
float arg_8 = zmm10[0]
uint64_t result = zx.q(rax_2 + rsi_1)
...
if (rsi_1 s< result.d)
    ...
    uint32_t zmm9[0x4] = data_143ed5e00
    float zmm12[0x4]
    float var_b8_1[0x4] = zmm12
    int64_t r8_1 = sx.q(rsi_1)
    float zmm13[0x4]
    ...
    result = r8_1 << 2
    int64_t r8_2 = r8_1 << 5
    int32_t r9_2 = rsi_1 << 5
    uint64_t result_1 = result
    int64_t var_128_1 = r8_2
    int32_t arg_20 = r9_2
    ...
    while (r9_2 s< rcx_1)
        ...
        while (rbx_1 s< rcx_1)
            void* rdx_1 = *(arg1 + 8)
            int64_t r14_1 = r8_2 + r13_1
            int64_t rsi_2 = r14_1 * 5
            int64_t rbp_1 = *(rdx_1 + 0xde8)
            float zmm1[0x4] = *(rbp_1 + (rsi_2 << 3))
            zmm8.d = (*(rbp_1 + (rsi_2 << 3) + 4)).d f- var_138:4.d
            zmm1[0] = zmm1[0] f- var_138.d
            uint128_t zmm0
            zmm0.d = (*(rbp_1 + (rsi_2 << 3) + 8)).d f- rax_1
            zmm7 = *(rbp_1 + (rsi_2 << 3) + 0x24)
            ...
            result = *(arg1 + 0x10)
            zmm6 = *(rbp_1 + (rsi_2 << 3) + 0x1c)
            
            if ((*(*result + 0x2c) & 0x40000) != 0)
                int64_t* rcx_4 = *(*(*(rdx_1 + 0xdb8) + (r14_1 << 3)) + 8)
            ...
            if (r9_3 != 0)
                ...
                void* r8_3 = r9_3 + 0x40
                int32_t rax_5 = rbx_1
                int32_t rdx_2 = 1 << (rbx_1.b & 0x1f)
                
                if (rbx_1 s< 0)
                    rax_5 = rbx_1 + 0x1f
                
                result = zx.q(rax_5 s>> 5)
            ...
            zmm0.d = zmm7.d f+ zmm10[0]
            zmm0.d = zmm0.d f* zmm0.d
            
            if (zmm8.d f> zmm0.d || zmm8.d f< zmm6.d)
                rdx = arg_10
            else
                zmm0 = *(rbp_1 + (rsi_2 << 3) + 8)
                zmm12 = *(rbp_1 + (rsi_2 << 3))
                float zmm3[0x4] = *(rbp_1 + (rsi_2 << 3) + 0xc)
                zmm14 = *(rcx + 0x40)
                zmm15 = *(rcx + 0x50)
                float temp0_1[0x4] = _mm_unpacklo_ps(*(rbp_1 + (rsi_2 << 3) + 4), 0)
                float temp0_2[0x4] = _mm_unpacklo_ps(zmm12, zmm0.q)
                float temp0_3[0x4] = _mm_unpacklo_ps(zmm3, (*(rbp_1 + (rsi_2 << 3) + 0x14)).q)
                float temp0_4[0x4] = _mm_unpacklo_ps(temp0_2, temp0_1[0].q)
                float temp0_6[0x4] = _mm_unpacklo_ps(temp0_3, 
                    _mm_unpacklo_ps(*(rbp_1 + (rsi_2 << 3) + 0x10), 0)[0].q)
                ...
                float temp0_12[0x4] = _mm_mul_ps(_mm_and_ps(*(rcx + 0x10), zmm9), zmm0)
                zmm0 = _mm_mul_ps(_mm_and_ps(*rcx, zmm9), temp0_8)
                zmm1 = _mm_and_ps(*(rcx + 0x20), zmm9)
                ...
                if (result.d != 0)
                    ...
                    zmm1 = *(rcx + 0x60)
                    float temp0_31[0x4] = __mulps_xmmps_memps(_mm_and_ps(zmm15, zmm9), var_108_1)
                    float temp0_32[0x4] = _mm_mul_ps(temp0_16, zmm15)
                    zmm0 = __mulps_xmmps_memps(_mm_and_ps(zmm14, zmm9), temp0_8)
                    float temp0_36[0x4] = __mulps_xmmps_memps(_mm_and_ps(zmm1, zmm9), temp0_10)
                    ...
                    if (result.d != 0)
                        ...
                        if (zmm8.d f<= zmm0.d)
                            ...
                            if (not(zmm8.d f<= zmm7.d))
                                int64_t* rcx_10 = *(*(*(*(arg1 + 8) + 0xdb8) + (r14_1 << 3)) + 8)
                                result = (*(*rcx_10 + 0xd8))(rcx_10)
                                goto label_141445718
                        else
                            int64_t* rcx_8 = *(*(*(*(arg1 + 8) + 0xdb8) + (r14_1 << 3)) + 8)
                            result = (*(*rcx_8 + 0xd8))(rcx_8)
                            zmm10 = arg_8
                        label_141445718:
        ...
        r8_2 += 0x20
        r9_2 = arg_20 + 0x20
        bool cond:3_1 = arg_18 + 1 s< rsi_1 + data_1439b6dd0
        arg_18 += 1
        rcx_1 = var_148
        arg_20 = r9_2
        var_128_1 = r8_2
