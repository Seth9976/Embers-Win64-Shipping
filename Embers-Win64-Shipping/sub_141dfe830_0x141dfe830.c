...
int64_t rdx = sx.q(*(rax_2 + (sx.q(*(r10 + 0x30) * arg3) << 2)))

if (rdx.d == 0xffffffff)
    *(arg1 + 0x20) = _mm_unpacklo_ps(_mm_unpacklo_ps(data_143dbb1f8, data_143dbb200.q), 
        _mm_unpacklo_ps(data_143dbb1fc, 0).q)
    return rax_2

int32_t* rax_3 = *(r10 + 0x38)
int32_t rcx = *(rax_3 + rdx)
uint32_t r12 = 1
uint32_t r8_1 = 1
void* r14_1 = &rax_3[1] + rdx
int32_t rsi_1 = rcx s>> 0x18
uint64_t rcx_2 = zx.q(rcx s>> 0x1c) & 0xf
uint64_t r15 = zx.q(rcx_2.d)
uint64_t r11_1 = zx.q(rcx) & 0xffffff
uint32_t rax_6 = zx.d(*((zx.q((rcx_2 << 3).d) | (zx.q(rsi_1) & 7)) + 0x143240fb8))
    ...
    if ((rsi_1.b & 8) != 0)
        ...
        if (r11_1.d u< 2)
            ...
            if (zmm0.d f<= 0f)
                ...
                int32_t rax_16 = int.d(zmm2.d)
                
                if (rax_16 s< 0)
                    rdx_3 = 0
                else if (rax_16 s< rdx_3)
                    rdx_3 = rax_16
...
int32_t rax_15 = i_8 * r8_2
uint64_t r12_1 = zx.q(rdx_2.d)
void* rcx_14 = sx.q(rax_15) + r12_1 + r14_1
uint64_t var_c8
int32_t var_c0
uint128_t zmm1
uint128_t zmm4
...
if (r15.d != 1)
    if (r15.d == 3)
        ...
        rax_15 = (rcx_15 u>> 0xa & 0x7ff) - 0x3ff
        ...
        zmm0.d = _mm_cvtepi32_ps(zx.o(rax_15)).d f* 0.000977517106f
        ...
        if ((rsi_1.b & 1) == 0)
            ...
            rax_15 = zx.d(*rcx_14) - 0xff
            rcx_14 += 2
            zmm9 = _mm_cvtepi32_ps(zx.o(rax_15))
            var_c8.d = zmm9.d
        ...
        if ((rsi_1.b & 2) == 0)
            ...
            rax_15 = zx.d(*rcx_14) - 0xff
            rcx_14 += 2
            zmm7 = _mm_cvtepi32_ps(zx.o(rax_15))
            var_c8:4.d = zmm7.d
        ...
        if ((rsi_1.b & 4) == 0)
            ...
            rax_15 = zx.d(*rcx_14) - 0xff
            zmm8 = _mm_cvtepi32_ps(zx.o(rax_15))
            var_c0 = zmm8.d
else if ((rsi_1.b & 7) != 0)
    if ((rsi_1.b & 1) == 0)
        var_c8.d = 0
    ...
    if (r15.d != 1)
        if (r15.d == 3)
            ...
            if ((rsi_1.b & 1) == 0)
                ...
                rax_15 = zx.d(*rcx_20) - 0xff
                rcx_20 += 2
                zmm2 = _mm_cvtepi32_ps(zx.o(rax_15))
            ...
            if ((rsi_1.b & 4) == 0)
                ...
                rax_15 = zx.d(*rcx_20) - 0xff
                zmm4 = _mm_cvtepi32_ps(zx.o(rax_15))
    else if ((rsi_1.b & 7) != 0)
        if ((rsi_1.b & 1) == 0)
            zmm2 = zx.o(0)
        else
...
*(r13 + 0x20) = _mm_unpacklo_ps(zmm3, _mm_unpacklo_ps(zmm2, 0).q)
return rax_15
