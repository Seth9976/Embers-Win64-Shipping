...
if (r12_3 != 0)
    ...
    do
        ...
        uint64_t rcx_6 = zx.q(*(r8_2 + (r9_1 << 1))) * 3
        uint64_t rax_10 = zx.q(*(r8_2 + (r9_1 << 1) + 2))
        zmm1_1[0] = zmm1_1[0] f* *(r10_1 + (rcx_6 << 2) + 8)
        zmm7[0] = zmm7[0] f* *(r10_1 + (rcx_6 << 2))
        zmm4_1.d = zmm4_1.d f* *(r10_1 + (rcx_6 << 2) + 4)
        uint64_t rcx_7 = rax_10 * 3
        uint64_t rax_11 = zx.q(*(r8_2 + (r9_1 << 1) + 4))
