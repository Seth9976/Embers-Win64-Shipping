...
while (*(result + 0x58) != 0)
    ...
    if (rbp_2 + 2 u<= *(r11_2 + 0x60))
        ...
        int32_t rax_46
        rax_46.b = r9_16 == 0
        uint64_t rax_47 = zx.q(rax_46 + r9_16 * r14)
        uint64_t rax_49 =
            ((zx.q(*(r8_8 + (rax_47 << 1))) << 8) + zx.q(*(r8_8 + (rax_47 << 1) + 1))) * 3
        
        if (zx.w(*(rdx_15 + (rax_49 << 1) + 4)) * 0x100 + zx.w(*(rdx_15 + (rax_49 << 1) + 5))
                != 0xffff && 2 u>= 2)
            sub_142bf5c70(r11_2, rbp_2, rbp_2 + 2)
    
    sub_142c35680(arg2, arg1, rdi_1)
    void* r8_11 = arg1[1]
    r14 = (zx.d(*rdi_1) << 8) + zx.d(*(rdi_1 + 1))
    result = zx.q(*(r8_11 + 0x60))
    
    if (*(r8_11 + 0x5c) == result.d)
        break
    ...
    if ((0x4000 & (zx.w(*(rdi_1 + 2)) * 0x100 + zx.w(*(rdi_1 + 3)))) == 0 || rcx_31 s<= 0)
        void* rbx_3 = arg1[1]
        ...
        if (*(rbx_3 + 0x59) == 0)
            *(rbx_3 + 0x5c) += 1
            ...
            if (sub_142bf50b0(rbx_3, 1, 1) != 0)
                ...
                int64_t rax_61 = *(rbx_3 + 0x78)
                *(rax_61 + (rcx_33 << 2)) = *(rdx_21 + (r9_20 << 2))
                *(rax_61 + (rcx_33 << 2) + 0x10) = *(rdx_21 + (r9_20 << 2) + 0x10)
                *(rbx_3 + 0x64) += 1
                *(rbx_3 + 0x5c) += 1
        else
            *(rbx_3 + 0x64) += 1
