...
if (r11 != 0)
    ...
    label_14096e288:
        ...
        while (true)
            ...
            if (rdx_3 != 0)
                goto label_14096e288
        
        var_64.d = r11

void* var_10 = arg1 + 0xf0
int128_t zmm0 = var_78.o
int128_t var_20 = 0xffffffff
int16_t var_40 = 0
void* result = zmm0.q
var_68.o = zmm0
var_78.o = (arg1 + 0xf0).o
...
if (0 s< *(result + 0x18))
    ...
    do
        int64_t rbx_1 = sx.q(i) * 0x118
        int64_t rdi_1 = *var_78.q
        void* rcx_2 = *(rbx_1 + rdi_1 + 0x38)
        
        if (rcx_2 != 0 && sub_141c5d640(rcx_2) != 0)
            int64_t* rax_14 = sub_141c5d640(*(rbx_1 + rdi_1 + 0x38))
            int64_t rdx_5 = *rax_14
            (*(rdx_5 + 0x530))(rax_14, rdx_5)
