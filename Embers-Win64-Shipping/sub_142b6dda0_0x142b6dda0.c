...
if (rbp.d - rdi.d s>= 4)
    ...
    while (i s<= 0)
        ...
        int32_t rax_7 = sub_142b6dcd0(rsi_2, arg2, *(arg1 + 0x3f0), rbp.d)
        ...
        if (sub_142aea6a0(arg2) s< rbp.d && rdi_1 s< 3)
            if (sub_142b6dcd0(&var_278 + zx.q(result_1 u% 3) * 0xb4, arg2, *(arg1 + 0x3f0), rbp.d)
                ...
                for (int32_t j = rbp.d - r12_2 - rax_4 - r14_1; j s> 0; j -= rax_51)
        ...
        if (j_3 s< rbp.d)
            ...
            do
                char rax_55
                int512_t zmm0_5
                rax_55, zmm0_5 = sub_142a9f280(arg1 + 0x328, zx.q(sub_142aea4f0(arg2, zmm0_4)))
        ...
        if (r14_1 s> 0)
            ...
            if (rdx_25 + 1 s< 0 || *(r12 + 0xc) s< rdx_25 + 1)
                rax_58 = sub_142ae7df0(r12, rdx_25 + 1, &i)
            
            if ((rdx_25 + 1 s>= 0 && *(r12 + 0xc) s>= rdx_25 + 1) || rax_58 != 0)
