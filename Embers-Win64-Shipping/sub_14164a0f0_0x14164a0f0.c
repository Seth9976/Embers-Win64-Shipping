...
uint128_t zmm10_1
uint128_t zmm15
rax_6, zmm9, zmm10_1, zmm15 = sub_14170c1c0(&var_240, &var_308, &var_328)
...
if (rdi.b == 0)
    while (true)
        ...
        if (rax_7 s>= 0x20)
            ...
            zmm3_1 = *(rcx_4 + 0x1c)
            zmm0_2[0].d = zmm0_2[0].d f* zmm5.d
            zmm5 = *(rcx_4 + 0x24)
            zmm4_1.d = zmm4_1.d f+ zmm0_2[0].d
            zmm0_2 = *(rax_8 + 0x28)
            zmm2_1 = zmm0_2
            ...
            int32_t var_1bc
            int32_t* rax_14
            rax_14, zmm6, zmm7, zmm8, zmm9, zmm10_1, zmm11, zmm12, zmm13, zmm14, zmm15 =
                sub_14170c1c0(&var_240, &var_1bc, &var_2b0)
            zmm5 = var_314_2
            zmm1_2 = zx.o(*rax_14)
            ...
            *(&var_100 + (rcx_10 << 2)) = *rax_14
            ...
            label_14164a95a:
                ...
                zmm0_2 = zmm14
                zmm0_2[0].d = zmm0_2[0].d f- zmm15.d
                zmm15 = 0x7f7fffff
                var_344 = 0x7f7fffff
            ...
            if (rdi.b != 0)
                ...
                var_344 = zmm2_1.d
                zmm1_2 = zmm2_1
                rdx_11.b = zmm2_1.d f>= zmm15.d
                var_340 = rdx_11.b
                
                if (result.b != 0)
                    if (rdi.b == 0)
                        goto label_14164adb2
                    
                    if (zmm6.d f!= zmm9.d)
                    label_14164adaa:
                        zmm1_2 = zmm2_1
                        goto label_14164adad
                    
                    zmm1_2 = 0x3eb0c6f7a0b5ed8d
                    
                    if (_mm_cvtps_pd(zmm2_1.q)[0] f<= zmm1_2.q)
                        goto label_14164adaa
    ...
    if (zmm10_1.d f<= zmm9.d || temp0_23[0] <= 9.9999999999999995e-07 || zmm1_2.d f>= zmm2_1.d)
        ...
        label_14164b361:
            *arg8 = zmm0_3.q
            ...
            int32_t rax_44
            int128_t zmm15_1
            rax_44, zmm10_1, zmm15_1 = sub_141593f60(&var_338, &var_170, &var_288, &var_240, 
                &var_310, &var_328, &var_270, &var_258)
            rcx_33 = arg7
            rax_45 = var_320
            ...
            if (rax_44 == 2)
                *rdi_3 = (zmm10_1 ^ zmm15_1).d
                ...
                goto label_14164b361
            
            *arg8 = var_328.q
            arg8[1].d = rax_45
            result = result_1
            zmm0_3.d = (var_310 ^ zmm15_1).d f- zmm10_1.d
            *rdi_3 = zmm0_3.d
            zmm0_3 = zx.o(var_270)
        *rcx_33 = zmm0_3.q
        rcx_33[1].d = result
        ...
        *arg8 = zmm0_2.q
        ...
        int64_t* rcx_25 = arg7
        zmm1_2.d = var_338[0].d.d f+ zmm11.d
        zmm0_2 = zmm9
        zmm0_2[0].d = zmm0_2[0].d f* *arg8
        zmm2_1.d = var_338[0]:4.d.d f+ zmm12.d
        zmm1_2.d = zmm1_2.d f+ zmm0_2[0].d
        zmm0_2 = zmm9
        zmm0_2[0].d = zmm0_2[0].d f* *(arg8 + 4)
        zmm2_1.d = zmm2_1.d f+ zmm0_2[0].d
        zmm0_2 = zmm9
        zmm0_2[0].d = zmm0_2[0].d f* arg8[1].d
        zmm14.d = zmm14.d f+ zmm0_2[0].d
        *rcx_25 = (_mm_unpacklo_ps(zmm1_2, zmm2_1.q)).q
        rcx_25[1].d = zmm14.d
        *rdi_3 = (zmm9 ^ zmm15).d
