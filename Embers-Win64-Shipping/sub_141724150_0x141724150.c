...
float zmm7[0x4] = zmm3 ^ 0x80000000
float zmm9[0x4] = *arg2
...
void* rcx = **arg1
uint128_t zmm4 = *(rcx + 0x28)
uint128_t zmm2 = *(rcx + 0x2c)
uint128_t zmm5 = *(rcx + 0x30)
float zmm1[0x4] = zmm2
void* rax_1 = *(rcx + 0x10)
zmm1[0] = zmm1[0] * zmm3[0]
zmm3 = zmm5
uint128_t zmm0
zmm0.d = zmm4.d f* zmm9[0]
...
zmm0.d = zmm5.d f* zmm1[0]
zmm3 = zmm5
zmm14.d = zmm14.d f* zmm2.d
zmm1 = zmm2
int32_t var_108 = zmm0.d
zmm0.d = zmm4.d f* zmm6[0]
int32_t var_110 = zmm15.d
int32_t var_10c = zmm14.d
...
zmm4 = zx.o(*(r8 + 0x10))
int128_t* rax_3 = *(rcx_1 + 0x10)
zmm5 = _mm_unpacklo_ps(zmm4, (*(r8 + 0x18))[0].q)
zmm0 = _mm_shuffle_ps(zmm4, zmm4, 0x55)
float zmm12[0x4] = *rax_3
zmm7 = rax_3[1]
int32_t rax_4 = *(r8 + 0x18)
float temp0_2[0x4] = _mm_shuffle_ps(zmm12, zmm12, 0xd2)
int32_t arg_8 = zmm2.d
int32_t var_fc = zmm2.d
float temp0_3[0x4] = _mm_shuffle_ps(zmm12, zmm12, 0xc9)
...
float temp0_10[0x4] = _mm_mul_ps(temp0_8, temp0_3)
float arg_18 = zmm6[0]
float var_100 = zmm6[0]
uint64_t var_e0 = zmm4.q
float temp0_11[0x4] = _mm_sub_ps(temp0_10, zmm0)
uint64_t var_f0 = zmm4.q
...
zmm0 = _mm_shuffle_ps(zmm5, zmm5, 0xc9)
float temp0_26[0x4] = _mm_add_ps(temp0_22, zmm7)
zmm0 = _mm_mul_ps(zmm0, temp0_2)
...
zmm3 = arg_8
zmm14.d = zmm14.d f- temp0_30[0]
int64_t* rbx = arg1[2]
zmm15.d = zmm15.d f- temp0_26[0]
zmm4.d = var_108.d f- temp0_31[0]
zmm14.d = zmm14.d f* *(arg2 + 4)
int64_t rdi = sx.q(rbx[1].d)
zmm2 = _mm_shuffle_ps(temp0_33, temp0_33, 0xd2)
int32_t rax_5 = (rdi + 1).d
float temp0_37[0x4] = _mm_mul_ps(temp0_33, temp0_6)
zmm2 = _mm_mul_ps(zmm2, temp0_3)
float temp0_39[0x4] = _mm_add_ps(temp0_37, zmm5)
zmm2 = _mm_add_ps(_mm_add_ps(_mm_sub_ps(zmm2, zmm0), temp0_39), zmm7)
var_f0.d = zmm2.d
...
zmm3[0] = zmm3[0] f+ zmm0.d
zmm0.d = var_118.d f- temp0_44[0]
zmm1 = *(arg2 + 8)
zmm1[0] = zmm1[0] f* zmm4.d
zmm0.d = zmm0.d f* var_114
zmm3[0] = zmm3[0] f+ zmm0.d
zmm0.d = (*arg2).d f* zmm15.d
rbx[1].d = rax_5
...
if (zmm3[0] f< zmm14.d)
    ...
    int64_t rcx_6 = *rbx
    int64_t rdx_4 = rdi * 3
    *(rcx_6 + (rdx_4 << 2)) = var_110.q
    *(rcx_6 + (rdx_4 << 2) + 8) = var_108
    rbx_1 = arg1[3]
    ...
    int64_t rcx_3 = *rbx
    int64_t rdx_1 = rdi * 3
    *(rcx_3 + (rdx_1 << 2)) = var_100.q
    *(rcx_3 + (rdx_1 << 2) + 8) = var_f8
    rbx_1 = arg1[3]
    rdi_1 = sx.q(rbx_1[1].d)
