...
if (data_143e8ac50 s> *rdi_1)
    _Init_thread_header(&data_143e8ac50)
    
    if (data_143e8ac50 == 0xffffffff)
        ...
        data_143e8ac48 = rax_9
        _Init_thread_footer(&data_143e8ac50)

if (data_143e8ac60 s> *rdi_1)
    _Init_thread_header(&data_143e8ac60)
    
    if (data_143e8ac60 == 0xffffffff)
        ...
        data_143e8ac58 = rax_12
        _Init_thread_footer(&data_143e8ac60)

if (data_143e8ac70 s> *rdi_1)
    _Init_thread_header(&data_143e8ac70)
    
    if (data_143e8ac70 == 0xffffffff)
        ...
        data_143e8ac68 = rax_15
        _Init_thread_footer(&data_143e8ac70)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ac48
int64_t rcx
...
label_1412a42a3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412a429e
        
        rbx.b = 1
        goto label_1412a42a3
