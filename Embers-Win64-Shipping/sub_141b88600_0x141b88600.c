...
sub_141b9bb20(*arg1, arg3)
char* (* rbx_2)(void* arg1, char* arg2, int512_t arg3 @ zmm1) = *arg1
char rax_30

if ((*(rbx_2 + 0x28) & 0x20) == 0)
    rax_30 = (*(*rbx_2 + 0x220))(rbx_2)

if ((*(rbx_2 + 0x28) & 0x20) != 0 || rax_30 != 0)
    rax_30 = 0x40
