...
if (data_143e2d370 s> *rsi_1)
    _Init_thread_header(&data_143e2d370)
    
    if (data_143e2d370 == 0xffffffff)
        ...
        data_143e2d368 = rax_6
        _Init_thread_footer(&data_143e2d370)

uint32_t rax_2

if (data_143e2d380 s> *rsi_1)
    int64_t r8_2
    rax_2, r8_2 = _Init_thread_header(&data_143e2d380)
    
    if (data_143e2d380 == 0xffffffff)
        ...
        data_143e2d378 = rax_9
        _Init_thread_footer(&data_143e2d380)

int64_t rbp = data_143e2d378
uint16_t rsi_2
...
label_1410b9440:
    ...
    if (sub_1405fba70(*arg1, 3) != 0 && sub_1410be730(arg1) != 0)
        return 1
else
    char rax_3
