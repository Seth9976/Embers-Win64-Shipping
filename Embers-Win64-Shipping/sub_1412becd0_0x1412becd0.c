...
if (data_143e8b918 s> *rdi_1)
    _Init_thread_header(&data_143e8b918)
    
    if (data_143e8b918 == 0xffffffff)
        ...
        data_143e8b910 = rax_12
        _Init_thread_footer(&data_143e8b918)

if (data_143e8b938 s> *rdi_1)
    _Init_thread_header(&data_143e8b938)
    
    if (data_143e8b938 == 0xffffffff)
        ...
        data_143e8b930 = rax_15
        _Init_thread_footer(&data_143e8b938)

if (data_143e8b958 s> *rdi_1)
    _Init_thread_header(&data_143e8b958)
    
    if (data_143e8b958 == 0xffffffff)
        ...
        data_143e8b950 = rax_18
        _Init_thread_footer(&data_143e8b958)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b910
int64_t rcx
...
label_1412bedc8:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412bedc3
    
    rbx.b = 1
    goto label_1412bedc8
