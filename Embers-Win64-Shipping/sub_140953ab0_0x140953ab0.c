...
if (0 s< *(result + 0x18))
    ...
    do
        int64_t* rdx_5 = sx.q(i) * 0x118 + *var_78.q + 0x38
        
        if (*rdx_5 != 0)
            (*(*arg2 + 0x38))(arg2, rdx_5, 0, 0, var_78)
    ...
    if (var_40.b != 0 && var_40:1.b != 0)
        return sub_1409562a0(rdi_1, *(rdi_1 + 8) - *(rdi_1 + 0x34), 1)
