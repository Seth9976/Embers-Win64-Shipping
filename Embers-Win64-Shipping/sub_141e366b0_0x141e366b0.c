...
int64_t var_320_1 = arg1 + (sx.q(arg2) << 1) - 2
...
while (true)
    ...
    label_141e36879:
            ...
            do
                ...
                if (rdi_1 s< i)
                    ...
                    do
                        ...
                        if ((rdx_3 + 1).d s< i)
                            if (r8_1[sx.q(r10_1) + 2] u< r8_1[sx.q(rdx_3.d)])
                                rdx_3 = zx.q(r10_1)
                        ...
                        int16_t r10_2 = r8_1[rax_22]
                        int16_t r11_3 = r8_1[rcx_9]
                ...
                *r8_1 = r8_1[i_1]
                ...
                if (j s> 1)
                    ...
                    do
                        ...
                        if ((rdx_4 + 1).d s< j)
                            if (r8_1[sx.q(r9_9) + 2] u< r8_1[sx.q(rdx_4.d)])
                                rdx_4 = zx.q(r9_9)
                        ...
                        int16_t r9_10 = r8_1[rax_28]
                        int16_t r10_4 = r8_1[rcx_12]
        ...
        while (true)
            if (i s<= 8)
                for (; i_2 u> r8_1; i_2 -= 2)
                    int16_t* r9_11 = r8_1
                    void* rdx_5 = &r8_1[1]
                    
                    if (&r8_1[1] u<= i_2)
                        do
                            int16_t* rcx_15 = rdx_5
            ...
            *r9_5 = rax_8
            ...
            if (((r9_5 - r8_1 - 2) & 0xfffffffffffffffe) s< ((i_2 - rdx_1) & 0xfffffffffffffffe))
                if (i_2 u> rdx_1)
                    *rsi_1 = rdx_1
                    rsi_1[1] = i_2
                    rsi_1[2].d = r11_1
