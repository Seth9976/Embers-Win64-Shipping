...
if (data_143e8c4a0 s> *rdi_1)
    _Init_thread_header(&data_143e8c4a0)
    
    if (data_143e8c4a0 == 0xffffffff)
        ...
        data_143e8c498 = rax_9
        _Init_thread_footer(&data_143e8c4a0)

if (data_143e8c4c0 s> *rdi_1)
    _Init_thread_header(&data_143e8c4c0)
    
    if (data_143e8c4c0 == 0xffffffff)
        ...
        data_143e8c4b8 = rax_12
        _Init_thread_footer(&data_143e8c4c0)

if (data_143e8c4e0 s> *rdi_1)
    _Init_thread_header(&data_143e8c4e0)
    
    if (data_143e8c4e0 == 0xffffffff)
        ...
        data_143e8c4d8 = rax_15
        _Init_thread_footer(&data_143e8c4e0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c498
int64_t rcx
...
label_1412b26c3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412b26be
        
        rbx.b = 1
        goto label_1412b26c3
