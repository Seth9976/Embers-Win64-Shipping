    ...
    if (*i_1 != 0)
        ...
        if (i s> 0)
            do
                ...
                i_1 = sub_140b5d160((sx.q(rax_3) << 4) + 8 + r15_1, &i_3)
        ...
        if (rsi_1 s< i)
            ...
            int128_t zmm6_1
            i_1, zmm6_1 = sub_140b5d160(&i_3, *(arg1 + 0x60) + 8 + rdi_2)
            ...
            if (i_1.d s>= 0 && rsi_1 != 0xffffffff)
                ...
                if (rcx_9 s< r8)
                    i_1 = i_3
                    int64_t* rdx_7 = *(arg1 + 0x60) + 0x18 + rdi_2
                ...
                if (rbx_2 s<= rsi_2)
                    int64_t i_5 = rsi_2 - rbx_2 + 1
                    int64_t i_2
                    
                    do
                        int64_t rbx_3 = *(arg1 + 0x60)
                        sub_140b5b8a0(*(rdi_2 + rbx_3 + 8), 0)
                        i_1 = sx.q(*(rdi_2 + rbx_3 + 4))
                        rdi_2 += 0x10
                        int128_t zmm0
                        zmm0.d = (*(arg3 + (i_1 << 2) + 4)).d f/ *(rdi_2 + rbx_3 - 0x10)
                        zmm6_1 = _mm_max_ss(zmm0.d, zmm6_1.d)
                        i_2 = i_5
                        i_5 -= 1
                    while (i_2 != 1)
