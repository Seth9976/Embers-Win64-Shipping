...
if (data_143e8e2d0 s> *rdi_1)
    _Init_thread_header(&data_143e8e2d0)
    
    if (data_143e8e2d0 == 0xffffffff)
        ...
        data_143e8e2c8 = rax_12
        _Init_thread_footer(&data_143e8e2d0)

if (data_143e8e2e0 s> *rdi_1)
    _Init_thread_header(&data_143e8e2e0)
    
    if (data_143e8e2e0 == 0xffffffff)
        ...
        data_143e8e2d8 = rax_15
        _Init_thread_footer(&data_143e8e2e0)

if (data_143e8e2f0 s> *rdi_1)
    _Init_thread_header(&data_143e8e2f0)
    
    if (data_143e8e2f0 == 0xffffffff)
        ...
        data_143e8e2e8 = rax_18
        _Init_thread_footer(&data_143e8e2f0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e2c8
int64_t rcx
...
label_1412ab0c8:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412ab0c3
    
    rbx.b = 1
    goto label_1412ab0c8
