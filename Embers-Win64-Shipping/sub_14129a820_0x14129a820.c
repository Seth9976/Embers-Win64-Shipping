...
if (data_143e8d008 s> *rdi_1)
    _Init_thread_header(&data_143e8d008)
    
    if (data_143e8d008 == 0xffffffff)
        ...
        data_143e8d000 = rax_9
        _Init_thread_footer(&data_143e8d008)

if (data_143e8d028 s> *rdi_1)
    _Init_thread_header(&data_143e8d028)
    
    if (data_143e8d028 == 0xffffffff)
        ...
        data_143e8d020 = rax_12
        _Init_thread_footer(&data_143e8d028)

if (data_143e8d048 s> *rdi_1)
    _Init_thread_header(&data_143e8d048)
    
    if (data_143e8d048 == 0xffffffff)
        ...
        data_143e8d040 = rax_15
        _Init_thread_footer(&data_143e8d048)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d000
int64_t rcx
...
label_14129a923:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_14129a91e
        
        rbx.b = 1
        goto label_14129a923
