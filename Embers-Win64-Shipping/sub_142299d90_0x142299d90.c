...
int64_t var_380 = 0
void var_210
sub_141fd6cc0(&var_210, *(arg1[1] + 0x1548), 1, 0, 0, nullptr)
int64_t r12 = sx.q(arg15)
int32_t r15 = (r12 + 1).d
int32_t var_34c = r15
int32_t i_6 = r15 * (arg14 + 1)
...
if (r15 s> 0)
    ...
    do
        arg5 = _mm_cvtepi32_ps(zx.o(r14))
        rsi_1[-2] = 0
        arg5.d = arg5.d f* arg6.d
        zmm1.d = arg5.d f* arg7[0]
        float zmm0_2[0x4]
        int128_t zmm14_1
        zmm0_2, zmm14_1 = __libm_sse2_sincosf_(zmm1)
        rsi_1[-1] = zmm0_2[0]
        float temp0_3[0x4] = _mm_shuffle_ps(zmm0_2, zmm0_2, 1)
        *rsi_1 = temp0_3[0]
        float var_2e8_1 = zmm0_2[0]
        float var_2ec_1 = (temp0_3 ^ zmm14_1)[0]
        arg5, arg6, arg7, zmm14 = sub_142252cf0(&rsi_1[-2], &var_2e0, &var_2f0, &rsi_1[-2])
        r14 += 1
        rsi_1[2] = arg5.d
        rsi_1[1] = 0
        rsi_1 = &rsi_1[0x16]
...
if (arg14 + 1 s> 0)
    ...
    zmm0_1 = _mm_cvtepi32_ps(zx.o(arg14))
    var_2f0.q = i_7
    int32_t var_350_1 = 0
    ...
    do
        var_33c = 0
        arg8.d = float.s(rax_5)
        zmm1.d = arg8.d f* 360f
        zmm1.d = zmm1.d f* zmm3[0]
        zmm3 = data_143f52940
        float temp0_19[0x4] = __mulps_xmmps_memps(
            _mm_unpacklo_ps(zmm2, _mm_unpacklo_ps(zmm1, zx.o(0).q).q), data_143f52990)
        ...
        float temp0_32[0x4] = _mm_mul_ps(arg6, zmm1)
        arg6 = _mm_mul_ps(var_1c8_1, zmm1)
        float temp0_34[0x4] = _mm_add_ps(temp0_32, arg5)
        arg6 = _mm_add_ps(arg6, arg13)
        float temp0_36[0x4] = _mm_mul_ps(temp0_34, zmm1)
        arg6 = _mm_mul_ps(arg6, zmm1)
        ...
        zmm0_1.d = zmm3.d f* arg8.d
        var_328 = (zmm1 ^ zmm14).d
        int32_t var_2f8_1 = zmm0_1.d
        int32_t var_324_1 = arg5.d
        int32_t var_320_1 = zmm4_1.d
        int32_t var_314_1 = data_143dbb1fc.d
        ...
        if (i_7 s<= 0)
            ...
            do
                ...
                zmm1 = _mm_shuffle_ps(temp0_61, temp0_61, 0x55)
                zmm0_1 = _mm_mul_ps(zmm0_1, zmm4_1)
                int64_t var_308_1 = 0
                zmm1 = _mm_mul_ps(zmm1, zmm5_1)
                int32_t var_300_1 = 0
                ...
                zmm1 = _mm_add_ps(zmm1, temp0_68)
                float temp0_72[0x4] = _mm_add_ps(_mm_add_ps(temp0_69, zmm0_1), zmm1)
                int32_t var_2d8_2 = _mm_shuffle_ps(temp0_72, temp0_72, 0xaa).d
                *(rbx_1 + rdi) =
                    (_mm_unpacklo_ps(temp0_72, _mm_shuffle_ps(temp0_72, temp0_72, 0x55).q)).q
                *(rbx_1 + rdi + 8) = var_2d8_2
                zmm1 = _mm_unpacklo_epi16(_mm_unpacklo_epi8(zx.o(*(r14_1 + 0x48)), arg8.q), arg8.q)
                ...
                zmm1 = _mm_shuffle_ps(temp0_80, temp0_80, 0xaa)
                ...
                zmm1 = _mm_mul_ps(_mm_shuffle_ps(temp0_85, temp0_85, 0x55), zmm5_1)
                float temp0_90[0x4] = _mm_mul_ps(temp0_86, arg5)
                zmm0_1 = _mm_mul_ps(zmm0_1, zmm4_1)
                float temp0_93[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_85, temp0_85, 0), arg6)
                float temp0_96[0x4] =
                    _mm_add_ps(_mm_add_ps(temp0_90, zmm0_1), _mm_add_ps(zmm1, temp0_93))
                zmm1 = _mm_unpacklo_epi16(_mm_unpacklo_epi8(zx.o(*(r14_1 + 0x44)), arg8.q), arg8.q)
                ...
                zmm1 = __mulps_xmmps_memps(_mm_shuffle_ps(temp0_110, temp0_110, 0x55), var_338.o)
                ...
                float temp0_122[0x4] = _mm_add_ps(temp0_119, _mm_add_ps(zmm1, temp0_118))
                zmm1 = _mm_shuffle_ps(arg6, arg6, 0xaa)
                ...
                zmm1.d = var_308_2:4.d.d f* arg10[0]
                *(rbx_1 + rdi + 0x4c) = rax_8
                zmm1.d = zmm1.d f+ zmm1.d
                zmm1.d = zmm1.d f+ arg9[0]
                ...
                *(rbx_1 + rdi + 0x4d) = rax_9
                ...
                zmm1.d = var_2c8_1.d.d f* arg11[0]
                ...
                *(rbx_1 + rdi + 0x4f) = 0x7f
                ...
                zmm1.d = var_2c8_1:4.d.d f* arg11[0]
                *(rbx_1 + rdi + 0x50) = rax_11
                ...
                zmm1.d = var_2c0_1.d f* arg11[0]
                *(rbx_1 + rdi + 0x51) = rax_12
                zmm1.d = zmm1.d f+ arg9[0]
                int32_t r8_3 = int.d(zmm1.d) s>> 1
                char rax_13
                ...
                *(rbx_1 + rdi + 0x53) = 0x7f
                ...
                zmm1.d = var_2b8_1.d.d f* arg10[0]
                zmm1.d = zmm1.d f+ zmm1.d
                zmm1.d = zmm1.d f+ arg9[0]
                int32_t rdx_5 = int.d(zmm1.d) s>> 1
                char var_364_1
                ...
                zmm1.d = var_2b8_1:4.d.d f* arg10[0]
                zmm1.d = zmm1.d f+ zmm1.d
                zmm1.d = zmm1.d f+ arg9[0]
                int32_t rdx_7 = int.d(zmm1.d) s>> 1
                ...
                zmm1.d = var_2b0_1.d f* arg10[0]
                zmm1.d = zmm1.d f+ zmm1.d
                zmm1.d = zmm1.d f+ arg9[0]
                int32_t rdx_9 = int.d(zmm1.d) s>> 1
                ...
                zmm1 = _mm_unpacklo_epi16(_mm_unpacklo_epi8(zx.o(var_368_1.d), arg8.q), arg8.q)
                var_298[3] = 0
                int128_t var_288
                var_288:0xc.d = 0
                int128_t var_278
                ...
                zmm1 = _mm_unpacklo_epi16(_mm_unpacklo_epi8(zx.o(var_364_1.d), arg8.q), arg8.q)
                zmm4_1 = _mm_mul_ps(zmm4_1, arg12)
                float temp0_146[0x4] =
                    _mm_cvtepi32_ps((_mm_cmpgt_epi32(zmm1, zmm14) & arg13) | zmm1)
                zmm1 = _mm_unpacklo_epi8(zx.o(var_360_1.d), arg8.q)
                float temp0_148[0x4] = _mm_mul_ps(temp0_146, arg12)
                zmm1 = _mm_unpacklo_epi16(zmm1, arg8.q)
                var_278.d = zmm4_1.d
...
float zmm7[0x4]
float zmm8[0x4]
rax_30, zmm6, zmm7, zmm8 = sub_14077e760(&var_128, arg3)
...
zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10, zmm11, zmm12, zmm13, zmm15 =
    sub_141fdea20(&var_210, arg1, &var_298, arg16, arg17, 0, 1)
zmm6_1.o = var_58
zmm7_1.o = var_68
zmm8_1.o = var_78
zmm9_1.o = var_88
