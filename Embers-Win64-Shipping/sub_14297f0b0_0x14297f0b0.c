...
int64_t var_18 = -2
struct Imf_2_3::Attribute::Imf_2_3::TypedAttribute<class Imath_2_3::Vec3<double> >::VTable** 
    result_1 = j_sub_140a82f30(0x20)
struct Imf_2_3::Attribute::Imf_2_3::TypedAttribute<class Imath_2_3::Vec3<double> >::VTable** 
    result = result_1
struct Imf_2_3::Attribute::Imf_2_3::TypedAttribute<class Imath_2_3::Vec3<double> >::VTable** 
    result_2 = result_1
...
if (result_1 == 0)
    ...
    std::_Func_base<void,class Concurrency::message<uint64_t>* __ptr64,struct std::_Nil,struct std::_Nil,struct std::_Nil,struct std::_Nil,struct std::_Nil,struct std::_Nil>::_Func_base<void,class Concurrency::message<uint64_t>* __ptr64,struct std::_Nil,struct std::_Nil,struct std::_Nil,struct std::_Nil,struct std::_Nil,struct std::_Nil>(
        result_1)
    *result = &
        Imf_2_3::TypedAttribute<class Imath_2_3::Vec3<double> >::`vftable'{for `Imf_2_3::Attribute'}

struct Imf_2_3::Attribute::Imf_2_3::TypedAttribute<class Imath_2_3::Vec3<double> >::VTable* r8 =
    *result
