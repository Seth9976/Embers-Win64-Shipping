...
float var_b8 = zmm1.d
int64_t (* var_b0)(int64_t* arg1, int32_t* arg2)
...
if (arg4[1].d s> 0)
    ...
    do
        ...
        if (r8.b != 0 && r12_1 != 0 && r15_1 != 0)
            ...
            *(*(i_23 + 0x10) + (r14_2 << 2)) = *(rdi_3 + var_b0)
        ...
        if (rdx_11 != 0 && rax_22 != 0 && r15_1 != 0)
            ...
            *(*(i_23 + 0x20) + (r14_3 << 2)) = *(rdi_3 + var_b0)
            rax_22 = rax_12
