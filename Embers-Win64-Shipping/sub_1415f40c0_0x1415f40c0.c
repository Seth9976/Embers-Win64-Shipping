...
if (zmm15[0] <= zmm8[0])
    ...
    uint128_t zmm9_1
    uint128_t zmm14_1
    rax_33, zmm8_1, zmm9_1, zmm14_1 = sub_1415903a0(&var_260, &var_280, &var_220, &var_218, 
        &var_2a8, &var_270, &var_250, &var_2a0)
    uint128_t zmm0_2
    uint128_t zmm1_1
    uint128_t zmm2_1
    uint128_t zmm3_1
    ...
    if (rax_33 == 2)
        ...
        *arg7 = var_270
        ...
        zmm14_1.d = zmm14_1.d f* arg7[1].d
        zmm0_2.d = zmm0_2.d f+ zmm5_1
        zmm1_1.d = zmm1_1.d f+ zmm6_1
        zmm14_1.d = zmm14_1.d f+ zmm7[0]
        ...
        *arg7 = var_270
        arg7[1].d = var_268
        zmm0_2.d = var_2a8.d f+ zmm14_1.d
        ...
        *arg5 = (_mm_unpacklo_ps(zmm0_2, zmm1_1.q)).q
        ...
        zmm3_1.d = zmm3_1.d f- zmm0_2.d
        zmm2_1.d = var_29c.d f- zmm1_1.d
        zmm0_2.d = var_298.d f- zmm4_1.d
    ...
    temp0_35[0] = temp0_35[0] + temp0_35[0]
    zmm9[0] = zmm9[0] * temp0_35[0]
    zmm9[0] = zmm9[0] * temp0_35[0]
    zmm9[0] = zmm9[0] * temp0_35[0]
    float temp0_36[0x4] = _mm_unpacklo_ps(zmm9, zmm9[0].q)
    *arg7 = temp0_36.q
