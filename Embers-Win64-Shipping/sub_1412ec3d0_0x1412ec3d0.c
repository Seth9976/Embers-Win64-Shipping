...
if (rax == 0)
    ...
    if (data_143eb8c78
        ...
        _Init_thread_header(&data_143eb8c78)
        
        if (data_143eb8c78 == 0xffffffff)
            int64_t (* i)(int64_t arg1, int64_t* arg2) = sub_14132a2b0
            var_48 = nullptr
            int32_t var_40_2 = 0
            ...
            sub_1419c2220(&data_143eb8be0, 0, FFFTPassParameters", FFFTPassParameters", 0, nullptr)
            int128_t* rcx_7 = var_48
            
            if (rcx_7 != 0)
                sub_140a74f90(rcx_7)
            
            atexit(sub_142cdbc70)
            _Init_thread_footer(&data_143eb8c78)
    
    var_48 = arg3
    void* var_40_1 = &data_143eb8c10
    var_48.o = var_48.o
