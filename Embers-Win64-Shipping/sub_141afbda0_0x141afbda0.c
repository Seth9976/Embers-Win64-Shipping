...
*arg1 = &data_1430585a0
arg1[0x1c] = &data_143058528
__builtin_memset(&arg1[0x1d], 0, 0x31)
...
arg1[0xa].b = 1
*(arg1 + 0x51) = rax_1.b
void*** rax_2 = sub_141af33e0(&arg1[0x1c])
...
if (&arg1[0x1a] != &var_18)
    ...
    if (rax_2 == rdi_1)
        goto label_141afbf65
    
    arg1[0x1b] = rax_2
    
    if (rdi_1 == 0)
        goto label_141afbf8c
