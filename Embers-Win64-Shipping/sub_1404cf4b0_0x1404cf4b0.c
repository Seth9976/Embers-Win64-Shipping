...
data_143ef9648 = (*(*rcx_2 + 0x78))(rcx_2, u"vr.bEnableStereo", rbx_1, &var_38, 0)
data_143ef9640 = &data_142d3ff10
int64_t* var_20
...
label_1404cf61b:
    ...
    if (rcx_5 != 0)
        ...
        int32_t var_30_1 = 0
        goto label_1404cf61b
return atexit(sub_142ceb6e0) __tailcall
