...
if (data_143e8ae30 s> *rdi_1)
    _Init_thread_header(&data_143e8ae30)
    
    if (data_143e8ae30 == 0xffffffff)
        ...
        data_143e8ae28 = rax_9
        _Init_thread_footer(&data_143e8ae30)

if (data_143e8ae40 s> *rdi_1)
    _Init_thread_header(&data_143e8ae40)
    
    if (data_143e8ae40 == 0xffffffff)
        ...
        data_143e8ae38 = rax_12
        _Init_thread_footer(&data_143e8ae40)

if (data_143e8ae50 s> *rdi_1)
    _Init_thread_header(&data_143e8ae50)
    
    if (data_143e8ae50 == 0xffffffff)
        ...
        data_143e8ae48 = rax_15
        _Init_thread_footer(&data_143e8ae50)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ae28
int64_t rcx
