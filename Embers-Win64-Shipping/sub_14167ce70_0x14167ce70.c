...
float* rax_4
float zmm9_1[0x4]
rax_4, zmm9_1 = sub_14170eae0(&var_228, &var_2e0, &var_320)
    ...
    *rdi_3 = zmm8[0]
    ...
    if (not(cond:0_1))
        *arg8 = var_2a0
        ...
        zmm8[0] = zmm8[0] f* *(arg4 + 4)
        zmm8[0] = zmm8[0] f* *(arg4 + 8)
        zmm0_2.d = zmm0_2.d f+ zmm15[0]
        zmm8[0] = zmm8[0] + var_308[1]
        zmm8[0] = zmm8[0] + var_308[2]
        zmm0_2.d = zmm0_2.d f+ zmm9_1[0]
        zmm8[0] = zmm8[0] + zmm9_1[0]
        zmm8[0] = zmm8[0] + zmm9_1[0]
        *arg7 = (_mm_unpacklo_ps(zmm0_2, zmm8[0].q)).q
        arg7[1].d = zmm8[0]
    else if (result.b != 0)
        var_170[0].q = 0
        var_170[2].q = 0
        ...
        label_14167dc88:
            ...
            *arg7 = (_mm_unpacklo_ps(zmm1_2, zmm2_1.q)).q
            ...
            int32_t rax_30
            int128_t zmm10_3
            rax_30, zmm10_3 = sub_141565bb0(&var_170, &var_308, &var_240, &var_228, zmm14, zmm15, 
                &var_2f4, &var_320, &var_278, &var_238)
            zmm0_4 = zx.o(var_320.q)
            rax_31 = var_318
            
            if (rax_30 == 2)
                goto label_14167dc88
    ...
    while (true)
        ...
        if (rcx_3 s>= 0x20)
            ...
            float* rax_6
            float zmm10_1[0x4]
            rax_6, zmm6, zmm7, zmm8, zmm9_1, zmm10_1, zmm11, zmm12, zmm13 =
                sub_14170eae0(&var_228, &var_1bc, &var_210)
            zmm1_2 = zx.o(*rax_6)
            int32_t rcx_7 = rax_6[2]
            zmm2_1.d = zmm7.d f- zmm1_2[0]
            zmm0_2 = zmm1_2
            zmm5.d = zmm6.d f- _mm_shuffle_ps(zmm0_2, zmm0_2, 0x55).d
            int32_t var_250
            ...
            *(&var_100 + (rcx_8 << 2)) = zmm1_2.q
            ...
            label_14167d5f6:
                ...
                if (rbx_1 == 0)
                    ...
                    if (not(zmm12[0] < zmm9_1[0]))
                        zmm12[0] = zmm12[0] * zmm12[0]
                        zmm12[0] = zmm12[0] + 9.99999997e-07f
                        rdi.b = zmm12[0] >= zmm10_1[0]
            else
                zmm3_1 = *(arg4 + 4)
                zmm5 = *arg4
                zmm6 = *(arg4 + 8)
                zmm2_1.d = zmm5.d f* temp0_8[0]
                zmm1_2 = zmm6
                zmm0_2.d = zmm3_1.d f* temp0_8[0]
                zmm1_2[0] = zmm1_2[0] * zmm10_1[0]
                zmm2_1.d = zmm2_1.d f+ zmm0_2.d
                ...
                zmm0_2.d = zmm12.d f/ zmm2_1.d
                zmm8[0] = zmm8[0] f- zmm0_2.d
                
                if (zmm8[0] <= zmm8[0])
                    goto label_14167d5f6
                ...
                var_188 = r12.d
                zmm11[0] = zmm11[0] + var_308[0]
                zmm13.d = zmm6.d f* zmm8[0]
                var_328 = 0
                ...
                zmm0_2.d = var_160.d.d f+ zmm11[0]
                result_2 = zmm13.d
                var_2a0.d = temp0_8[0]
                zmm1_2[0] = zmm1_2[0] + zmm12[0]
                var_2a0:4.d = temp0_8[0]
                var_2f8 = 0x7f7fffff
                var_160.d = zmm0_2.d
                ...
                zmm0_2.d = var_150_1.d.d f+ zmm12[0]
                ...
                zmm11[0] = zmm11[0] f- var_280_1
                zmm2_1.d = zmm12.d f- var_27c_1
                var_140_1 = zmm0_2.d
                zmm0_2.d = zmm13.d f- var_2f4
                *(&var_160 + (rcx_8 << 2)) = (_mm_unpacklo_ps(zmm11, zmm2_1.q)).q
                *(&var_160:8 + (rcx_8 << 2)) = zmm0_2.d
                zmm14 = 0x358637bd
            
            if (rdi.b != 0)
                int64_t* rax_20
                rax_20, zmm8, zmm9_1, zmm11, zmm12, zmm13, zmm14 =
                ...
                if (rcx_9 == 1)
                    ...
                    uint64_t var_1a4
                    uint64_t* rax_14
                    rax_14, zmm8, zmm9_1, zmm10_1, zmm11, zmm12, zmm13, zmm14 =
                    ...
                    uint64_t var_1b0
                    uint64_t* rax_13
                    rax_13, zmm8, zmm9_1, zmm10_1, zmm11, zmm12, zmm13, zmm14 =
