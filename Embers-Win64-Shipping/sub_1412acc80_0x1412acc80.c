...
if (data_143e8db10 s> *rdi_1)
    _Init_thread_header(&data_143e8db10)
    
    if (data_143e8db10 == 0xffffffff)
        ...
        data_143e8db08 = rax_9
        _Init_thread_footer(&data_143e8db10)

if (data_143e8db30 s> *rdi_1)
    _Init_thread_header(&data_143e8db30)
    
    if (data_143e8db30 == 0xffffffff)
        ...
        data_143e8db28 = rax_12
        _Init_thread_footer(&data_143e8db30)

if (data_143e8db50 s> *rdi_1)
    _Init_thread_header(&data_143e8db50)
    
    if (data_143e8db50 == 0xffffffff)
        ...
        data_143e8db48 = rax_15
        _Init_thread_footer(&data_143e8db50)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8db08
int64_t rcx
