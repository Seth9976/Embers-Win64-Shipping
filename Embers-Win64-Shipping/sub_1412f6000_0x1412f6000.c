...
if ((rbx_6.b & 1) != 0)
    rbx_6 = (rbx_6 s>> 1) + &rax[2]

void* r15_1 = rbx_6 + (sx.q(rax[3].d) << 2)

while (rbx_6 != r15_1)
    uint32_t r14_1 = zx.d(*rbx_6)
    void*** rcx_12 = (*(arg1 + 0x30) + 7) & 0xfffffffffffffff8
    int64_t rbp_2 = *(zx.q(*(rbx_6 + 2)) + r13)
...
if ((rbx_8.b & 1) != 0)
    rbx_8 = (rbx_8 s>> 1) + &rax[4]

void* r15_2 = rbx_8 + (sx.q(rax[5].d) << 2)

while (rbx_8 != r15_2)
    uint32_t r14_2 = zx.d(*rbx_8)
    void*** rcx_18 = (*(arg1 + 0x30) + 7) & 0xfffffffffffffff8
    int64_t rbp_3 = *(zx.q(*(rbx_8 + 2)) + r13)
...
if ((rbx_11.b & 1) != 0)
    rbx_11 = (rbx_11 s>> 1) + &rax[0xa]

void* r15_4 = rbx_11 + (sx.q(rax[0xb].d) << 2)

while (rbx_11 != r15_4)
    uint32_t r14_4 = zx.d(*rbx_11)
    int64_t rbp_5 = *(*(zx.q(*(rbx_11 + 2)) + r13) + 0x10)
...
if ((rbx_13.b & 1) != 0)
    rbx_13 = (rbx_13 s>> 1) + &rax[0xc]

void* r15_5 = rbx_13 + (sx.q(rax[0xd].d) << 2)

while (rbx_13 != r15_5)
    uint32_t r14_5 = zx.d(*rbx_13)
    int64_t rbp_6 = *(*(zx.q(*(rbx_13 + 2)) + r13) + 0x10)
    void*** rcx_39 = (*(arg1 + 0x30) + 7) & 0xfffffffffffffff8
    void* rax_43 = &rcx_39[5]
    ...
    *(arg1 + 8) = &rcx_39[1]
    rcx_39[1] = 0
    *rcx_39 = &data_142d5ebf8
    rcx_39[2] = r12
    rcx_39[3].d = r14_5
    rcx_39[4] = rbp_6

void* rbx_15 = *(rax + 0x80)

if ((rbx_15.b & 1) != 0)
    rbx_15 = (rbx_15 s>> 1) + rax + 0x80

int64_t result = sx.q(rax[0x11].d)
void* r15_6 = rbx_15 + (result << 2)

while (rbx_15 != r15_6)
    uint32_t r14_6 = zx.d(*rbx_15)
    void*** rcx_45 = (*(arg1 + 0x30) + 7) & 0xfffffffffffffff8
    int64_t rbp_7 = *(zx.q(*(rbx_15 + 2)) + r13)
    void* rax_49 = &rcx_45[5]
