...
if (rdx.b == 0)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            ...
            r10_4 = &r10_4[1]
            rcx_6 += 0x10
            *rax = _mm_sub_ps(zmm2, _mm_cvtepi32_ps(_mm_cvttps_epi32(zmm2)))
            i = i_3
            i_3 -= 1
        while (i != 1)
else if (rax.d == 1)
    ...
    *(arg1 + 0x10) = &rax_8[3]
    ...
    zmm2 = *(sx.q(rcx_1) + *(*(arg1 + 0x18) + (sx.q(r8_1) << 3)))
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        float temp0_4[0x4] = _mm_sub_ps(temp0_1, _mm_cvtepi32_ps(_mm_cvttps_epi32(temp0_1)))
        float (* rax_6)[0x4]
        uint64_t i_1
