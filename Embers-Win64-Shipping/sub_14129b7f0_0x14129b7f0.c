...
if (data_143e8d108 s> *rdi_1)
    _Init_thread_header(&data_143e8d108)
    
    if (data_143e8d108 == 0xffffffff)
        ...
        data_143e8d100 = rax_12
        _Init_thread_footer(&data_143e8d108)

if (data_143e8d128 s> *rdi_1)
    _Init_thread_header(&data_143e8d128)
    
    if (data_143e8d128 == 0xffffffff)
        ...
        data_143e8d120 = rax_15
        _Init_thread_footer(&data_143e8d128)

if (data_143e8d148 s> *rdi_1)
    _Init_thread_header(&data_143e8d148)
    
    if (data_143e8d148 == 0xffffffff)
        ...
        data_143e8d140 = rax_18
        _Init_thread_footer(&data_143e8d148)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d100
int64_t rcx
...
label_14129b8e8:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_14129b8e3
    
    rbx.b = 1
    goto label_14129b8e8
