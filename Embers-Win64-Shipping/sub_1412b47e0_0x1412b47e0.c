...
if (data_143e8ccf0 s> *rdi_1)
    _Init_thread_header(&data_143e8ccf0)
    
    if (data_143e8ccf0 == 0xffffffff)
        ...
        data_143e8cce8 = rax_9
        _Init_thread_footer(&data_143e8ccf0)

if (data_143e8cd00 s> *rdi_1)
    _Init_thread_header(&data_143e8cd00)
    
    if (data_143e8cd00 == 0xffffffff)
        ...
        data_143e8ccf8 = rax_12
        _Init_thread_footer(&data_143e8cd00)

if (data_143e8cd18 s> *rdi_1)
    _Init_thread_header(&data_143e8cd18)
    
    if (data_143e8cd18 == 0xffffffff)
        ...
        data_143e8cd08 = rax_15
        _Init_thread_footer(&data_143e8cd18)
