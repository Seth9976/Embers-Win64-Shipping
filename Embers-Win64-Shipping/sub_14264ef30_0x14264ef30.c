...
if (((*(arg1 + 0x140) u>> 2).b & 1) == 0)
    return sub_14264fae0(arg1, arg2, arg3, rbx.d, arg5, arg6) __tailcall

int32_t rax_2 = *(arg1 + 0x30)
int64_t r12
r12.b = 0

if (rax_2 s> 1 && arg4 s>= 0 && rbx.d s< rax_2)
    float rax_3 = arg3[1].d
    ...
    do
        ...
        int64_t var_e8 = *(rax_4 + rdi_2)
        zmm8 = var_e8.d
        zmm9 = var_e8:4.d
        int32_t rax_5 = *(rax_4 + rdi_2 + 8)
        int64_t zmm3
        ...
        if (not(zmm4 * zmm4 f+ zmm0.d + zmm5 * zmm5 f<= zmm11.d))
            ...
            if (arg6 == 0)
                ...
                char rax_7
                rax_7, zmm6, zmm7, zmm8, zmm9 =
                    sub_1409cb460(arg2, &var_d8, &var_e8, &var_b8, &var_c8)
                
                if (rax_7 != 0)
                    goto label_14264f16d
            else
                uint64_t var_a8[0x2]
                void var_98
                int32_t arg_8
                char rax_6
                rax_6, zmm6, zmm7, zmm11 =
