...
if (arg1 != arg2)
    ...
    if (rdx_4 != r14_1)
        ...
        int32_t rdx_8 = r14_2[sx.q(r8_4)] & r12_1
    ...
    while (true)
        ...
        sub_1408464b0(rax_20 * 0x38 + 0x20 + *r10_1)
