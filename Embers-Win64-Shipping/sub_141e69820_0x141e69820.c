...
if (r9_1 s>= rbx)
    ...
    int64_t r8_2 = r9_1 * 0x90
    int64_t i_1 = r9_1 - rbx + 1
    int64_t i
    
    do
        if (rax_1 != 0)
            *(*arg1 + sx.q(arg1[6].d) * 0x90) = rdx_1
...
uint64_t rcx_5 = zx.q((*(rbx_1 + 0x1c) + 0x1f) u>> 5)
...
if (rsi_2 u<= rcx_5.d)
    ...
    if (rcx_5.d u> 8)
        memset(rbx_1, 0, zx.q(rcx_5.d) << 2)
    else if (rcx_5.d != 0)
        __builtin_memset(rbx_1, 0, rcx_5 << 2)
else
