...
while (true)
    int64_t* rsi_3 = (sx.q(r12_1) << 6) + *rbx
    int64_t rbx_1 = *rsi_3
    int32_t rdi = sub_140b5ead0(rbx_1.d) + (rbx_1 u>> 0x20).d
    int64_t rbx_3 = rsi_3[1]
    int32_t rax_13 = sub_140b5ead0(rbx_3.d)
    int32_t rcx_8 = (*r15 - 1) & ((rax_13 + (rbx_3 u>> 0x20).d) ^ rdi)
    ...
    *(rsi_3 + 0x3c) = rcx_8
    ...
    rsi_3[7].d = *(rax_16 + (((sx.q(*r15) - 1) & r8_7) << 2))
    ...
    *(rax_18 + (((sx.q(*r15) - 1) & r8_7) << 2)) = r12_1
