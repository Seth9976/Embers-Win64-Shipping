...
if (r11 != 0)
    ...
    label_14213f678:
        ...
        while (true)
            ...
            if (rdx_3 != 0)
                goto label_14213f678
        
        var_64.d = r11

void* var_10 = arg1 + 0x1468
int128_t zmm0 = var_78.o
int128_t var_20 = 0xffffffff
int16_t var_40 = 0
void* result = zmm0.q
var_68.o = zmm0
var_78.o = (arg1 + 0x1468).o
...
if (0 s< *(result + 0x18))
    ...
    do
        int64_t arg_8 = *(*((sx.q(i) << 5) + *var_78.q + 8) + 0xd8)
    ...
    if (var_40.b != 0 && var_40:1.b != 0)
        return sub_1405b6520(arg1 + 0x1468, *(arg1 + 0x1470) - *(arg1 + 0x149c), 1)
