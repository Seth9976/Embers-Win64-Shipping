...
double zmm3 = 1.1574074074074074e-12
...
if (not(zmm2[0] f>= float.d(-0x8000000000000000) f* zmm3))
    ...
    int32_t rax_2 = var_180_1 + 0xa
    var_180_1 = rax_2
    
    if (rax_2 s> 0)
        sub_140594770(&var_188)
    
    UnDecorator::getReferenceType(var_188, u"DaysValue", 0x14)
    ...
    *arg1 = int.q(zmm2[0])
    ...
    int64_t var_178 = 0
    int32_t var_170_1 = 0
    sub_1405947f0(&var_178, 0xa)
    int32_t rax_6 = var_170_1 + 0xa
    var_170_1 = rax_6
    
    if (rax_6 s> 0)
        sub_140594770(&var_178)
    
    UnDecorator::getReferenceType(var_178, u"DaysValue", 0x14)
