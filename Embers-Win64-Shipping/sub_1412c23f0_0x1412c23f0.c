...
if (data_143e8b338 s> *rdi_1)
    _Init_thread_header(&data_143e8b338)
    
    if (data_143e8b338 == 0xffffffff)
        ...
        data_143e8b330 = rax_9
        _Init_thread_footer(&data_143e8b338)

if (data_143e8b348 s> *rdi_1)
    _Init_thread_header(&data_143e8b348)
    
    if (data_143e8b348 == 0xffffffff)
        ...
        data_143e8b340 = rax_12
        _Init_thread_footer(&data_143e8b348)

if (data_143e8b358 s> *rdi_1)
    _Init_thread_header(&data_143e8b358)
    
    if (data_143e8b358 == 0xffffffff)
        ...
        data_143e8b350 = rax_15
        _Init_thread_footer(&data_143e8b358)
