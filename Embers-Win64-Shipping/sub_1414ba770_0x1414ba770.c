...
if (*(arg1 + 0x22) u> 0)
    ...
    if ((*(*r15 + 8))(r15) == 0)
        ...
        *(arg2 + 8) = &rcx_3[1]
        rcx_3[1] = 0
        *rcx_3 = &data_142d5a080
        rcx_3[2] = rax
        rcx_3[3].d = r13_1
        rcx_3[4] = r15

if (*(arg1 + 0x24) != 0xffff)
    zmm6 = sub_141083500(arg2, arg3, arg1 + 0x24, *(arg4 + 0x5078))
...
if (*(arg1 + 0x2a) u> 0)
    ...
    *(arg4 + 0x4b4)
    *(arg4 + 0x498)
    float var_158_1[0x4] = *(arg4 + 0x484)
    *(arg4 + 0x4a8)
    float var_148_1[0x4] = *(arg4 + 0x488)
    zmm0 = *(arg4 + 0x48c)
    *(arg4 + 0x4b8)
    *(arg4 + 0x49c)
    float var_168_1[0x4] = *(arg4 + 0x480)
    *(arg4 + 0x4a0)
    ...
    rax_7, zmm6_1, zmm7, zmm8, zmm9, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm14_1, zmm15_1 =
        sub_1414c53c0(arg4 + 0x280, &var_118)
    zmm2 = *rax_7
    float zmm4_1[0x4] = *(rax_7 + 0x10)
    float zmm5_1[0x4] = *(rax_7 + 0x20)
    float var_128_1[0x4] = *(rax_7 + 0x30)
    float temp0_1[0x4] = _mm_shuffle_ps(var_168_1, var_168_1, 0xe1)
    temp0_1[0] = zmm6_1[0]
    float temp0_2[0x4] = _mm_shuffle_ps(zmm2, zmm2, 0)
    float temp0_3[0x4] = _mm_shuffle_ps(temp0_1, temp0_1, 0xc6)
    temp0_3[0] = zmm7[0]
    float temp0_4[0x4] = _mm_shuffle_ps(var_158_1, var_158_1, 0xe1)
    temp0_4[0] = zmm9[0]
    float temp0_5[0x4] = _mm_shuffle_ps(temp0_3, temp0_3, 0x27)
    temp0_5[0] = zmm8[0]
    float temp0_6[0x4] = _mm_shuffle_ps(temp0_5, temp0_5, 0x39)
    float temp0_7[0x4] = _mm_mul_ps(temp0_2, temp0_6)
    float temp0_8[0x4] = _mm_shuffle_ps(var_148_1, var_148_1, 0xe1)
    temp0_8[0] = zmm12_1
    var_168 = temp0_6
    var_1a8 = temp0_6
    float temp0_9[0x4] = _mm_shuffle_ps(zmm0, zmm0, 0xe1)
    float temp0_10[0x4] = _mm_shuffle_ps(temp0_4, temp0_4, 0xc6)
    temp0_9[0] = zmm15_1
    ...
    float temp0_14[0x4] = _mm_shuffle_ps(temp0_10, temp0_10, 0x27)
    float temp0_15[0x4] = _mm_shuffle_ps(temp0_11, temp0_11, 0x27)
    temp0_14[0] = zmm11_1
    float temp0_16[0x4] = _mm_shuffle_ps(temp0_14, temp0_14, 0x39)
    temp0_15[0] = zmm14_1
    float temp0_17[0x4] = _mm_mul_ps(temp0_12, temp0_16)
    float temp0_18[0x4] = _mm_shuffle_ps(temp0_15, temp0_15, 0x39)
    float temp0_20[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm2, zmm2, 0xaa), temp0_18)
    float temp0_21[0x4] = _mm_add_ps(temp0_7, temp0_17)
    float var_198_1[0x4] = temp0_16
    temp0_13[0] = (*(arg4 + 0x4ac))[0]
    float var_188_1[0x4] = temp0_18
    float zmm0_1[0x4] = *(arg4 + 0x4bc)
    float temp0_22[0x4] = _mm_shuffle_ps(temp0_13, temp0_13, 0x27)
    float temp0_23[0x4] = _mm_add_ps(temp0_21, temp0_20)
    float temp0_24[0x4] = _mm_shuffle_ps(zmm2, zmm2, 0xff)
    temp0_22[0] = zmm0_1[0]
    float temp0_25[0x4] = _mm_shuffle_ps(temp0_22, temp0_22, 0x39)
    float temp0_26[0x4] = _mm_mul_ps(temp0_24, temp0_25)
    float temp0_27[0x4] = _mm_shuffle_ps(zmm4_1, zmm4_1, 0)
    float temp0_28[0x4] = _mm_shuffle_ps(zmm4_1, zmm4_1, 0xaa)
    float temp0_29[0x4] = _mm_mul_ps(temp0_27, var_168)
    float temp0_30[0x4] = _mm_add_ps(temp0_23, temp0_26)
    float temp0_31[0x4] = _mm_mul_ps(temp0_28, temp0_18)
    float var_178_1[0x4] = temp0_25
    float temp0_33[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm4_1, zmm4_1, 0x55), temp0_16)
    var_1a8 = temp0_30
    float temp0_35[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm5_1, zmm5_1, 0), var_168)
    float temp0_36[0x4] = _mm_add_ps(temp0_33, temp0_29)
    float temp0_38[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm4_1, zmm4_1, 0xff), temp0_25)
    float temp0_40[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm5_1, zmm5_1, 0x55), temp0_16)
    float temp0_41[0x4] = _mm_add_ps(temp0_36, temp0_31)
    float temp0_43[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm5_1, zmm5_1, 0xaa), temp0_18)
    ...
    float var_198_2[0x4] = temp0_46
    float var_188_2[0x4] = _mm_add_ps(_mm_add_ps(temp0_44, temp0_43), temp0_47)
    float temp0_50[0x4] = _mm_shuffle_ps(var_128_1, var_128_1, 0)
    float temp0_51[0x4] = _mm_shuffle_ps(var_128_1, var_128_1, 0x55)
    float temp0_52[0x4] = _mm_mul_ps(temp0_50, var_168)
    float temp0_53[0x4] = _mm_shuffle_ps(var_128_1, var_128_1, 0xaa)
    float temp0_54[0x4] = _mm_mul_ps(temp0_51, temp0_16)
    float temp0_55[0x4] = _mm_mul_ps(temp0_53, temp0_18)
    float temp0_56[0x4] = _mm_shuffle_ps(var_128_1, var_128_1, 0xff)
    float temp0_57[0x4] = _mm_add_ps(temp0_52, temp0_54)
    float temp0_58[0x4] = _mm_mul_ps(temp0_56, temp0_25)
    float var_178_2[0x4] = _mm_add_ps(_mm_add_ps(temp0_57, temp0_55), temp0_58)
    sub_1405eb5d0(arg2, arg3, arg1 + 0x26, &var_1a8, 0)
...
if (*(arg1 + 0x30) u> 0)
    ...
    float var_188_5[0x4] = temp0_95
    float var_178_3[0x4] = _mm_add_ps(_mm_add_ps(temp0_103, temp0_101), temp0_104)
    sub_1405eb5d0(arg2, arg3, arg1 + 0x2c, &var_1a8, 0)

void* arg_28
void* rcx_11 = arg_28

if (*(arg1 + 0x36) u> 0)
    uint32_t count = zx.d(*(arg1 + 0x36))
    void* r13_2 = rcx_11 + 0x10
    void* rax_8 = *(r13_2 + 0x100)
    
    if (rax_8 != 0)
        r13_2 = rax_8
    
    int32_t count_1 = *(rcx_11 + 0x120) << 4
    
    if (count_1 s<= count)
        count = count_1
    
    if (count s> 0)
        uint32_t rax_10 = zx.d(*(arg1 + 0x34))
        int64_t rdi_3 = (*(arg2 + 0x30) + 0xf) & 0xfffffffffffffff0
        int64_t arg_8
        arg_8.d = zx.d(*(arg1 + 0x32))
        var_168[0].q = *arg3
        int64_t rax_14 = sx.q(count) + rdi_3
        
        if (rax_14 u> *(arg2 + 0x38))
            sub_140b0e3d0(arg2 + 0x30, count + 0x10)
            rdi_3 = (*(arg2 + 0x30) + 0xf) & 0xfffffffffffffff0
            rax_14 = sx.q(count) + rdi_3
        
        *(arg2 + 0x30) = rax_14
        memcpy(rdi_3, r13_2, count)
        void*** rcx_16 = (*(arg2 + 0x30) + 7) & 0xfffffffffffffff8
        void* rax_16 = &rcx_16[6]
...
arg_28.d = zmm0[0]
sub_1405eb490(arg2, arg3, arg1 + 0x38, &arg_28, 0)
int32_t rcx_21 = data_1439b7080
int32_t rax_22
...
arg_28.d = rax_22
return sub_1405eb490(arg2, arg3, arg1 + 0x3e, &arg_28, 0)
