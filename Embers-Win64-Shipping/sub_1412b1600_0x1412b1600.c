...
if (data_143e8d218 s> *rdi_1)
    _Init_thread_header(&data_143e8d218)
    
    if (data_143e8d218 == 0xffffffff)
        ...
        data_143e8d210 = rax_12
        _Init_thread_footer(&data_143e8d218)

if (data_143e8d238 s> *rdi_1)
    _Init_thread_header(&data_143e8d238)
    
    if (data_143e8d238 == 0xffffffff)
        ...
        data_143e8d230 = rax_15
        _Init_thread_footer(&data_143e8d238)

if (data_143e8d258 s> *rdi_1)
    _Init_thread_header(&data_143e8d258)
    
    if (data_143e8d258 == 0xffffffff)
        ...
        data_143e8d250 = rax_18
        _Init_thread_footer(&data_143e8d258)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d210
int64_t rcx
...
label_1412b16f8:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412b16f3
    
    rbx.b = 1
    goto label_1412b16f8
