...
uint64_t var_a8 = 0
float i_2 = 0f
sub_141cd1460(arg1, arg3, &var_a8)
void* arg_8
sub_14090aa40(arg1 + 0x150, &arg_8, data_143f35cc8)
uint64_t rdx_2 = var_a8
uint128_t zmm0_1
uint128_t zmm3
uint128_t zmm4_1
uint128_t zmm5_1
...
if (i_2 s> 0)
    ...
    int64_t r9_1 = **(arg_8 + 0x18)
    int64_t rcx_3 = sx.q(i_2 - 1) << 2
    uint64_t i
    
    do
        int64_t rcx_4 = sx.q(*(rcx_3 + rdx_2)) * 3
        float rax_4 = *(r9_1 + (rcx_4 << 2) + 8)
        zmm5_1 = zx.o(*(r9_1 + (rcx_4 << 2)))
        int64_t rax_5 = sx.q(*(rsi + rdx_2))
        zmm4_1 = _mm_shuffle_ps(zmm5_1, zmm5_1, 0x55)
        var_a8 = zmm5_1.q
        int64_t rcx_5 = rax_5 * 3
        zmm7 = zx.o(*(r9_1 + (rcx_5 << 2)))
        ...
        float zmm1 = zmm3.d + rax_4
        zmm3.d = zmm3.d f- rax_4
        zmm1 = zmm1 f* zmm0_1.d
        zmm0_1.d = zmm7.d f+ var_a8.d
        zmm7.d = zmm7.d f- var_a8.d
