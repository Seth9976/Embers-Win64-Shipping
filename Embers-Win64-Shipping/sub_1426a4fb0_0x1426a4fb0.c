...
if (rbp == 0)
    ...
    if (rbx_1 == 0)
        result.b = 0
    else if (*(rbx_1 + 0x10) != sub_14272e650())
        result.b = 0
    else
        void* r9_1 = rbp[1]
        ...
        if (rdx_3 == neg.q(r14_1))
            ...
            if (sub_1426bf320(r9_1, rdx_3 + r14_1, arg3).b != 0)
                        ...
                        while (true)
                            ...
                            if (rax_13 != 0 && sub_1426bf730(arg1, rax_13) != 0)
                                ...
                                if (rax_16 != 0xff)
                                    ...
                                    sub_1426bf320(r9_3, rdx_14 + r14_1, arg3)
