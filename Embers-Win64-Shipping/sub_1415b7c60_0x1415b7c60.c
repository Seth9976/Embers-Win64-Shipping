...
rax_3, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13 =
    sub_1416db250(arg1, arg2, arg3, arg4, var_278)
int32_t rsi_1
...
if (rax_3 != 0)
    ...
    label_1415b87c0:
        zmm6_2, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm15 =
            sub_14154a2a0(*arg1, *arg2, &var_128, arg6, arg7, var_1a8, arg9)
        rsi_1 = 1
    else
        arg5 = 0x322bcc77
        ...
        while (true)
            ...
            if (rdx_5 s< 0x80)
                ...
                label_1415b8770:
                    ...
                    zmm8 = rdi_5[4] ^ zmm1_1
                    void* rcx_13 = *r14
                    float zmm5_1[0x4] = rdi_5[3] ^ zmm1_1
                    void* rax_21 = *arg3
                    int32_t r13_2 = *(rax_21 + 0x18)
                    zmm13 = zx.o(*(rax_21 + 0x10))
                    int128_t* rax_22 = r14[2]
                    zmm9 = *(rax_22 + 4)
                    zmm10 = *(rax_22 + 8)
                    zmm11 = *rax_22
                    float zmm2_1[0x4] = *(rax_22 + 0xc)
                    ...
                    zmm11[0] = zmm11[0] + zmm11[0]
                    zmm10[0] = zmm10[0] + zmm10[0]
                    float var_130_1 = zmm11[0]
                    int64_t var_158 = (_mm_unpacklo_ps(zmm9, zmm10[0].q)).q
                    float var_150_1 = var_130_1
                    float var_190
                    sub_141758e70(rcx_13, &var_190, &var_158, zx.o(0))
                    int128_t* rax_24 = r14[1]
                    float zmm6_1[0x4] = var_190
                    float zmm5_2[0x4] = *rax_24
                    int32_t var_18c
                    float temp0_6[0x4] = _mm_unpacklo_ps(var_18c, 0)
                    int32_t var_188
                    float temp0_7[0x4] = _mm_unpacklo_ps(zmm6_1, var_188.q)
                    float temp0_8[0x4] = _mm_shuffle_ps(zmm5_2, zmm5_2, 0xc9)
                    float temp0_9[0x4] = _mm_shuffle_ps(zmm5_2, zmm5_2, 0xd2)
                    float temp0_10[0x4] = _mm_unpacklo_ps(temp0_7, temp0_6[0].q)
                    zmm12 = rdi_5[6]
                    uint128_t zmm0_2 = _mm_mul_ps(_mm_shuffle_ps(temp0_10, temp0_10, 0xc9), temp0_9)
                    float temp0_14[0x4] =
                        _mm_mul_ps(_mm_shuffle_ps(temp0_10, temp0_10, 0xd2), temp0_8)
                    ...
                    zmm0_2 = _mm_shuffle_ps(temp0_17, temp0_17, 0xc9)
                    float temp0_20[0x4] = _mm_shuffle_ps(temp0_17, temp0_17, 0xd2)
                    float zmm2_2[0x4] = zmm13
                    zmm0_2 = _mm_mul_ps(zmm0_2, temp0_9)
                    float temp0_22[0x4] = _mm_mul_ps(temp0_20, temp0_8)
                    float temp0_23[0x4] = _mm_add_ps(temp0_18, temp0_10)
                    float temp0_26[0x4] = __addps_xmmps_memps(
                        _mm_add_ps(_mm_sub_ps(temp0_22, zmm0_2), temp0_23), rax_24[1])
                    ...
                    if (not(zmm14[0] f< zmm12.d))
                        ...
                        *(rax_37 + (r14_3 << 2)) = zmm13.q
                        *(rax_37 + (r14_3 << 2) + 8) = r13_2
                        ...
                        var_250_1.d = 0
                        *(rcx_16 + (rdx_13 << 2)) = var_1c8_1.q
                        *(rcx_16 + (rdx_13 << 2) + 8) = var_1c0_1
                        int32_t rax_40 = var_250_1:4.d
                        rdi_5[0xd].b = 1
                        
                        if (rax_40 s< 0 && rax_40 != 0)
                            sub_1405c5570(&var_258, 0)
                        
                        sub_1415c5980(&var_240, var_248_1, &var_180, &var_258)
                        int32_t r8_11 = var_238.d
                        int64_t r13_4 = sx.q(var_250_1.d)
                        int32_t var_248_2 = r8_11
                        int32_t rax_41 = r8_11 + r13_4.d
                        var_238.d = rax_41
                        ...
                        if (r13_4.d s>= 3)
                            ...
                            if (r13_4.d s> 0)
                                ...
                                do
                                    ...
                                    int64_t rax_43 = sx.q(rdx_16[rdi_6].d)
                                    int64_t rsi_3 = sx.q(*(&rdx_16[rdi_6] + 4))
                                    int32_t* r9_5 = r12_1 + rcx_20
                                    float var_1d4_1 = rax_43.d
                                    int64_t r10_8 = rax_43 * 0x38 + rcx_20
                                    ...
                                    zmm6 = *(rdx_19 + (r14_3 << 2) + 4)
                                    zmm6[0] = zmm6[0] f- *(r8_12 + (r14_3 << 2) + 4)
                                    zmm1_1 = *(rdx_19 + (r14_3 << 2) + 8)
                                    zmm1_1[0] = zmm1_1[0] f- *(r8_12 + (r14_3 << 2) + 8)
                                    int64_t rax_51 =
                                        sx.q(*(r10_8 + (sx.q((rsi_3 + 1).d s% 3) << 2)))
                                    zmm3_1 = *(rdx_19 + (r14_3 << 2))
                                    zmm3_1[0] = zmm3_1[0] f- *(r8_12 + (r14_3 << 2))
                                    int32_t var_1dc_1 = rax_51.d
                                    int64_t rcx_23 = rax_51 * 3
                                    zmm10 = *(rdx_19 + (rcx_23 << 2))
                                    zmm10[0] = zmm10[0] f- *(r8_12 + (rcx_23 << 2))
                                    zmm7 = *(rdx_19 + (rcx_23 << 2) + 4)
                                    zmm7[0] = zmm7[0] f- *(r8_12 + (rcx_23 << 2) + 4)
                                    zmm11 = *(rdx_19 + (rcx_23 << 2) + 8)
                                    zmm11[0] = zmm11[0] f- *(r8_12 + (rcx_23 << 2) + 8)
                                    int64_t rcx_24 = sx.q(rax_49) * 3
                                    zmm2_1 = *(rdx_19 + (rcx_24 << 2) + 8)
                                    ...
                                    *(r10_8 + (rsi_3 << 2) + 0x28) = 0
                                    ...
                                    r11_7 = var_1d0_1
                                    rdi_6 += 1
                                while (rdi_6 s< var_160_1)
                                
                                rsi_2 = var_200:8.q
                                rbx_1 = var_200.q
                                r12 = arg1
                            
                            goto label_1415b8770
            
        label_1415b8789:
            rdi_1 = var_258
            goto label_1415b87c0
