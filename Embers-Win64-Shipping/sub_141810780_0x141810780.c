...
int32_t rax_4 = var_60.d + 7
var_60.d = rax_4

if (rax_4 s> 0)
    sub_140594770(&var_68)

UnDecorator::getReferenceType(var_68, u"ItemId", 0xe)
int64_t var_58
...
int64_t rsi = var_68
UnDecorator::getReferenceType(rsi, u"ItemQuantity", 0x1a)
...
rcx_17[5].b = 0
*(rcx_17 + 0x2c) = 1
sub_1405947f0(&var_78, 0xe)
int32_t rax_12 = var_70 + 0xe
var_70 = rax_12

if (rax_12 s> 0)
    sub_140594770(&var_78)

UnDecorator::getReferenceType(var_78, u"Item Purchase", 0x1c)
