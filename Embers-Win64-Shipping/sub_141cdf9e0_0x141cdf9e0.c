...
while (true)
    ...
    if (result.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x10 && rdx_7 == arg1)
        return result
    
    int64_t* rcx_9 = *(*rdx_7 + result * 0x18 + 8)
    (*(*rcx_9 + 0x20))(rcx_9, zx.q(arg2))
    int32_t var_5c
