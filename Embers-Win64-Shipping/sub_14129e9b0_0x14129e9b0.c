...
if (data_143e8da20 s> *rdi_1)
    _Init_thread_header(&data_143e8da20)
    
    if (data_143e8da20 == 0xffffffff)
        ...
        data_143e8da18 = rax_9
        _Init_thread_footer(&data_143e8da20)

if (data_143e8da30 s> *rdi_1)
    _Init_thread_header(&data_143e8da30)
    
    if (data_143e8da30 == 0xffffffff)
        ...
        data_143e8da28 = rax_12
        _Init_thread_footer(&data_143e8da30)

if (data_143e8da40 s> *rdi_1)
    _Init_thread_header(&data_143e8da40)
    
    if (data_143e8da40 == 0xffffffff)
        ...
        data_143e8da38 = rax_15
        _Init_thread_footer(&data_143e8da40)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8da18
int64_t rcx
...
label_14129eab0:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_14129eaae
        
        rbx.b = 1
        goto label_14129eab0
