...
label_1405a7e7b:
    ...
    if (sub_1405b6520(arg1, r10_3, 0) == 0)
        void* r9_1 = &arg1[7]
        int32_t rax_33 = (arg1[9].d - 1) & rbp_8
        *(r15_2 + 0x1c) = rax_33
        void* rdx_21 = *(r9_1 + 8)
        int64_t r8_3 = sx.q(rax_33)
        void* rax_34 = r9_1
        
        if (rdx_21 != 0)
            rax_34 = rdx_21
        
        r15_2[3].d = *(rax_34 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2))
        void* rax_36 = *(r9_1 + 8)
    ...
    label_1405a7e38:
        ...
        while (true)
            int64_t rax_29 = sx.q(rbx_1) << 5
            
            if (*(rax_29 + rcx_15) == rcx_6)
                break
            
            rbx_1 = *(rax_29 + rcx_15 + 0x18)
            
            if (rbx_1 == 0xffffffff)
                goto label_1405a7e38
    
    r13.b = rbx_1 != 0xffffffff
    
    if (rbx_1 == 0xffffffff)
        goto label_1405a7e7b
