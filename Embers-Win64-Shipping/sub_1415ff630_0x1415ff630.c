...
while (true)
    ...
    float var_26c_1 = zmm0[0]
    zmm4[0] = zmm4[0] * zmm6[0]
    zmm12[0] = zmm12[0] * zmm8[0]
    float var_270_1 = zmm4[0]
    zmm13[0] = zmm13[0] * zmm7[0]
    var_2ac = zmm5[0]
    float var_1f0_1 = zmm5[0]
    zmm5 = (*r8)[2]
    zmm13[0] = zmm13[0] * zmm5[0]
    ...
    zmm2[0] = zmm2[0] + zmm3[0]
    int64_t var_218 = (_mm_unpacklo_ps(zmm13, zmm12[0].q)).q
    float var_210_1 = zmm2[0]
    zmm11 = sub_141758e70(r10, &var_280, &var_218, zmm11)
    ...
    float temp0_15[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xc9)
    float temp0_16[0x4] = _mm_shuffle_ps(temp0_11, temp0_11, 0xd2)
    zmm7 = var_2ac
    float temp0_17[0x4] = _mm_mul_ps(temp0_16, temp0_15)
    float temp0_18[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xff)
    float temp0_19[0x4] = _mm_sub_ps(temp0_17, temp0_14)
    float temp0_20[0x4] = _mm_add_ps(temp0_19, temp0_19)
    float temp0_21[0x4] = _mm_mul_ps(temp0_18, temp0_20)
    float temp0_23[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_20, temp0_20, 0xc9), temp0_12)
    zmm1 = var_26c_1
    float temp0_24[0x4] = _mm_add_ps(temp0_21, temp0_11)
    zmm5 = var_270_1
    float temp0_29[0x4] = __addps_xmmps_memps(
        _mm_add_ps(
            _mm_sub_ps(_mm_mul_ps(_mm_shuffle_ps(temp0_20, temp0_20, 0xd2), temp0_15), temp0_23), 
            temp0_24), 
        arg3[1])
    *(&var_1a8:4 + (sx.q(i_6) << 2)) = i_6
    ...
    i_6 = r13.d + 1
    float temp0_32[0x4] = _mm_unpacklo_ps(zmm5, zmm1[0].q)
    ...
    *(&var_118 + (rcx_2 << 2)) = (_mm_unpacklo_ps(zmm5, zmm1[0].q)).q
    ...
    if (i_6 == 1)
        ...
        uint64_t* rax_16 = sub_1416e69d0(&var_2a8, &var_118, &var_1a8:4, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_16)
        rax_13 = rax_16[1].d
    else if (i_6 == 3)
        uint64_t* rax_15
        rax_15, zmm11, zmm14, zmm15 = sub_1416fa750(&var_298, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_15)
        rax_13 = rax_15[1].d
    else if (i_6 == 4)
...
if (zmm15[0] <= zmm9[0])
    ...
    if (i_6 s> 0)
        ...
        do
            int64_t var_290_1
            int64_t rdi_2 = sx.q(var_290_1.d)
            int32_t rax_24 = (rdi_2 + 1).d
            var_290_1.d = rax_24
            
            if (rax_24 s> var_290_1:4.d)
            ...
            *(rcx_18 + (rdx_11 << 2) + 8) = rax_25
            int64_t rdi_3 = sx.q(var_2a0.d)
            int32_t rax_26 = (rdi_3 + 1).d
            var_2a0.d = rax_26
            
            if (rax_26 s> var_2a0:4.d)
                sub_14083a7e0(&var_2a8)
            
            uint64_t rcx_20 = var_2a8
    ...
    float zmm9_1
    float zmm11_1[0x4]
    rax_28, zmm9_1, zmm11_1 = sub_14159bbb0(&var_298, &var_2a8, &var_238, &var_230, &var_2ac, 
        &var_2c8, &var_280, &var_248)
    float zmm2_1[0x4]
    float zmm3_1[0x4]
