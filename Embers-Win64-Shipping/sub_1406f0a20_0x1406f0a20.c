...
if (arg3[0x86].b == 0)
    ...
    if (rax_14 != 0)
        rax_14[1] = arg1
        *rax_14 = &data_142da4ba8
        rax_14[3] = sub_140a387b0()
        *rax_14 = &data_142da4c00
    
    rax_11 = &var_18
    
    if (&var_18 == arg4)
        goto label_1406f0c02
    ...
    if (rbx_1 == 0)
        if (rax_6 != 0)
            rax_6[1] = arg1
            *rax_6 = &data_142da4af8
            rax_6[3] = sub_140a387b0()
            *rax_6 = &data_142da4b50
    else if (rax_6 != 0)
        rax_6[1] = arg1
        *rax_6 = &data_142da4a48
        rax_6[3] = sub_140a387b0()
        *rax_6 = &data_142da4aa0
    
    rax_11 = &var_18
    
    if (&var_18 == arg4)
        goto label_1406f0b3c
