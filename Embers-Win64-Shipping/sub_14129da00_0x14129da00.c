...
if (data_143e8cf88 s> *rdi_1)
    _Init_thread_header(&data_143e8cf88)
    
    if (data_143e8cf88 == 0xffffffff)
        ...
        data_143e8cf80 = rax_12
        _Init_thread_footer(&data_143e8cf88)

if (data_143e8cfa8 s> *rdi_1)
    _Init_thread_header(&data_143e8cfa8)
    
    if (data_143e8cfa8 == 0xffffffff)
        ...
        data_143e8cfa0 = rax_15
        _Init_thread_footer(&data_143e8cfa8)

if (data_143e8cfc8 s> *rdi_1)
    _Init_thread_header(&data_143e8cfc8)
    
    if (data_143e8cfc8 == 0xffffffff)
        ...
        data_143e8cfc0 = rax_18
        _Init_thread_footer(&data_143e8cfc8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8cf80
int64_t rcx
...
label_14129daf8:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_14129daf3
    
    rbx.b = 1
    goto label_14129daf8
