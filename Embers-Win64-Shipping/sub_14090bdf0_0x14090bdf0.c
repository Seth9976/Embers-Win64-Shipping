...
if (rdx_5 != rbx)
    ...
    int32_t rdx_9 = r10_1[sx.q(r8_3)] & r15
    int32_t var_74_5
...
while (true)
    ...
    if (result.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x10 && rdx_10 == arg1)
        return result
    
    int64_t* rcx_8 = *(*rdx_10 + result * 0x18 + 8)
    (*(*rcx_8 + 0x10))(rcx_8, zx.q(arg2))
    int32_t var_5c
