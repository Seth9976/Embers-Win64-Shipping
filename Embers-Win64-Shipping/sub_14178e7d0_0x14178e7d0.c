...
void** var_f8
sub_141703820(&var_f8, *(arg2 + 0x10), &var_168, (zx.o(0)).d)
...
if (cond:0)
    rax_5 = sub_141783bc0(rcx_1, arg1 + 0x60)
else
    rax_5 = sub_141788440(rcx_1, arg1 + 0x50)

var_f8 = &data_142fc4f68
int64_t* var_d8
