...
rdi.b = rax_5 != 0
*(arg2 + 0x20) = rdi + rax_5
int64_t result = sub_1406d2110(rsi, rdx_4)
...
if (i_1 != 0)
    ...
    do
        ...
        int64_t rcx_7 = *(rbx_2 - 0x78)
        
        if (rcx_7 != 0)
            result = sub_140a74f90(rcx_7)
        
        int64_t rcx_8 = *(rbx_2 - 0xa8)
        
        if (rcx_8 != 0)
            result = sub_140a74f90(rcx_8)
        
        int64_t rcx_9 = *(rbx_2 - 0xb8)
        
        if (rcx_9 != 0)
            result = sub_140a74f90(rcx_9)
        
        int64_t rcx_10 = *(rbx_2 - 0xc8)
