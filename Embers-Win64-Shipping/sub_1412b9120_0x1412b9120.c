...
if (data_143e8bc28 s> *rdi_1)
    _Init_thread_header(&data_143e8bc28)
    
    if (data_143e8bc28 == 0xffffffff)
        ...
        data_143e8bc20 = rax_12
        _Init_thread_footer(&data_143e8bc28)

if (data_143e8bc48 s> *rdi_1)
    _Init_thread_header(&data_143e8bc48)
    
    if (data_143e8bc48 == 0xffffffff)
        ...
        data_143e8bc40 = rax_15
        _Init_thread_footer(&data_143e8bc48)

if (data_143e8bc68 s> *rdi_1)
    _Init_thread_header(&data_143e8bc68)
    
    if (data_143e8bc68 == 0xffffffff)
        ...
        data_143e8bc60 = rax_18
        _Init_thread_footer(&data_143e8bc68)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8bc20
int64_t rcx
...
label_1412b9218:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412b9213
    
    rbx.b = 1
    goto label_1412b9218
