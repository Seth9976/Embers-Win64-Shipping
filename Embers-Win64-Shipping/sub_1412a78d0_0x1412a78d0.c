...
if (data_143e8e5f0 s> *rdi_1)
    _Init_thread_header(&data_143e8e5f0)
    
    if (data_143e8e5f0 == 0xffffffff)
        ...
        data_143e8e5e8 = rax_12
        _Init_thread_footer(&data_143e8e5f0)

if (data_143e8e600 s> *rdi_1)
    _Init_thread_header(&data_143e8e600)
    
    if (data_143e8e600 == 0xffffffff)
        ...
        data_143e8e5f8 = rax_15
        _Init_thread_footer(&data_143e8e600)

if (data_143e8e610 s> *rdi_1)
    _Init_thread_header(&data_143e8e610)
    
    if (data_143e8e610 == 0xffffffff)
        ...
        data_143e8e608 = rax_18
        _Init_thread_footer(&data_143e8e610)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e5e8
int64_t rcx
...
label_1412a79c8:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412a79c3
    
    rbx.b = 1
    goto label_1412a79c8
