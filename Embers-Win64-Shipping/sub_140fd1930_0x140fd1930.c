...
int32_t var_198_1 = arg10 & 0xffbfffff
int64_t var_b0
...
if (var_158.b != 0)
    ...
    if (rsi_2 != 0)
        int32_t rax_38 = var_198_1 & 0x800000
...
if (result_1 == 0)
    ...
    *result = &data_142ef29f8
    var_1c8.d = arg4
    sub_140fd9330(&result[0xe], r14, r8_14, r9_13, var_1c8.d, var_1a5, &var_168, &var_70)
    *(result + 0xfc) &= 0xfffffffe
    int32_t rcx_57 = zx.d(arg6) | *(result + 0xfc)
    *result = &data_142ef6a98
    result[0x1f].d = var_198_1
    result[0xe] = &data_142ef6af0
    *(result + 0xfc) = (rcx_57 & 0xfffffffd) | (zx.d(var_144) * 2)
...
if (sub_1419767f0() != 0 && test_bit(var_198_1, 0x1d))
