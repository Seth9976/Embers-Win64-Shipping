...
int64_t rcx = sx.q(*(arg1 + 0x3c)) * 5
uint32_t r8 = *((rcx << 3) + 0x1439c85e8)
uint32_t r13 = r8
uint32_t r9 = *((rcx << 3) + &data_1439c85ec)
int32_t r12 = (&data_1439c85f4)[rcx * 2]
char rcx_1 = arg2.b
int32_t rsi_2 = *(arg1 + 0x34) * arg3 + arg2
uint32_t rax_4 = *(arg1 + 0x60) u>> rcx_1

if (rax_4 u>= r8)
    r13 = rax_4

uint32_t rax_6 = *(arg1 + 0x64) u>> rcx_1
uint32_t rcx_2 = r9

if (rax_6 u>= r9)
    rcx_2 = rax_6

uint32_t var_b0 = rcx_2
...
if (arg4 != 1)
    ...
    uint32_t var_78
    (*(*rcx_7 + 0x50))(rcx_7, &var_78, 0, r9)
    uint32_t var_74_1 = var_b0
    void* rax_23 = *(arg1 + 0x80)
    var_78 = r13
    int32_t var_70_1 = 1
    int32_t var_6c_1 = 1
    int32_t var_5c_1 = 3
    ...
    result_1 = nullptr
    int64_t* rcx_8 = *(rax_23 + 0x168)
    int32_t rax_25 = (*(*rcx_8 + 0x28))(rcx_8, &var_78, 0, &result_1)
    int32_t var_120
    int32_t var_118
    int32_t var_110
    int32_t var_108
    ...
    if (rax_25 s< 0)
        ...
        var_120 = 1
        char var_68
        sub_140ffeb30(rax_25, *(arg1 + 0x3c), 
        ...
        "GetInitReference())", 
            ...
            0x663, *(arg1 + 0x60), *(arg1 + 0x64), 0, var_68, var_120, var_118.b, var_110, var_108, 
    ...
    char var_128
    var_128.q = 0
    int64_t* rcx_15 = *(*(arg1 + 0x80) + 0x150)
    int32_t var_138
    var_138.q = *(arg1 + 0xa0)
    (*(*rcx_15 + 0x170))(rcx_15, result_4, 0, 0, 0, 0, var_138, rsi_2, var_128, var_120, var_118, 
        var_110, var_108, var_100, var_f8, var_f0, var_e8, var_e0, var_d8, var_d0)
    int32_t var_140_2
    var_140_2.q = &result_2
    int64_t* rcx_16 = *(*(arg1 + 0x80) + 0x150)
    int32_t rax_38 = (*(*rcx_16 + 0x70))(rcx_16, result_1, 0, 1, 0, var_140_2)
    
    if (rax_38 s< 0)
        int32_t var_148_4
        var_148_4.q = *(*(arg1 + 0x80) + 0x168)
        sub_140fff020(rax_38, 
    ...
    *arg5 = var_80
    ...
    goto label_140feb9f9

if (arg6 == 0 && (*(arg1 + 0xf0) & 0x20) != 0)
    int32_t var_140
    var_140.q = &result_1
    int64_t* rcx_3 = *(*(arg1 + 0x80) + 0x150)
    int32_t rax_17 = (*(*rcx_3 + 0x70))(rcx_3, *(arg1 + 0xa0), zx.q(rsi_2), 2, 0, var_140)
    
    if (rax_17 s< 0)
        int32_t var_148_1
        var_148_1.q = *(*(arg1 + 0x80) + 0x168)
    ...
    *arg5 = var_b8
    ...
    goto label_140feba05

int32_t rdi_1 = temp0 * r12
result = sub_140a82f30(zx.q(divu.dp.d(0:(r9 - 1 + rcx_2), r9) * temp0 * r12), 0x10)
var_90 = 0x101
*arg5 = rdi_1
var_a0_1 = rdi_1
label_140feb9f9:
...
if (arg6 != 0)
    ...
    *(rcx_25 + 0x2c) = var_9c
    rcx_25[6] = result
    rcx_25[7].b = var_90.b
    *(rcx_25 + 0x39) = var_90:1.b
else
label_140feba05:
    void* rdi_2 = *(arg1 + 0x80)
    result_2 = *(arg1 + 0xa0)
...
if (result_6 != 0)
    int64_t rdx_10 = *result_6
    (*(rdx_10 + 0x10))(result_6, rdx_10)
