...
if (data_143e18dd0 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e18dd0)
    
    if (data_143e18dd0 == 0xffffffff)
        atexit(sub_142cc0d20)
        _Init_thread_footer(&data_143e18dd0)

int32_t rcx_15 = data_143e18dc8

if (rcx_15 == 0 || rcx_15 == 1)
    PWSTR arg_8
    
    if (SHGetKnownFolderPath(&data_1434cb170, 0, nullptr, &arg_8) s>= 0)
        PWSTR rdi_1 = arg_8
        int64_t var_38 = 0
        int32_t rdx_1 = 0
        int32_t var_30_1 = 0
        ...
        *rax_5 = 0
        ...
        data_143e18dc0 = rbx_3
        data_143e18dc8 = r9_2
        data_143e18dcc = rcx_8
    ...
    rcx_15 = data_143e18dc8

if (rcx_15 != 0)
    return data_143e18dc0
