...
label_14122461f:
    ...
    if (r8_3 s> 0 && (rax_8 == 0 || rax_8 s< rbp))
        ...
        arg4[0xe] = *(rax_12 + (((sx.q(arg1[9].d) - 1) & r8_4) << 2))
        void* rax_14 = *(r9_1 + 8)
    ...
    label_1412245ca:
        ...
        while (true)
            int32_t* rcx_3 = (sx.q(rbx_1) << 6) + *arg1
            
            if (*rcx_3 == *arg4 && rcx_3[1] == arg4[1] && rcx_3[2] == arg4[2])
                break
            
            rbx_1 = rcx_3[0xe]
            
            if (rbx_1 == 0xffffffff)
                goto label_1412245ca
