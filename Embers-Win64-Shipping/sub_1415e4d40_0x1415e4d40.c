...
if (rdx_1 == 0)
    ...
    if (rax_6 == 0)
        ...
        if (rdi != 0 && sub_1417afd80(arg4, rdi, &var_b8, arg6, &var_e8, &var_d8, &var_f8) != 0)
            arg1[3].d = var_f8[0]
            zmm5_2 = *arg5
            ...
            goto label_1415e5165
    else
        int64_t rdx_2 = *(rax_6 + 0x10)
        
        if (rdx_2 != 0 && sub_1417afd80(arg4, rdx_2, &var_b8, arg6, &var_e8, &var_d8, &var_f8) != 0)
            arg1[3].d = var_f8[0]
            zmm5_2 = *arg5
    ...
    if (sub_1417afef0(arg4, rdx_1, &var_b8, arg6[0], var_118_1, var_110_1, var_108_1, var_100_1)
            != 0)
        arg1[3].d = var_f8[0]
