...
if (r8 == 0)
    *arg3 = 0
    ...
    int32_t r10_1 = *arg2
    int32_t rcx_3 = not.d(r10_1 << 0xf) + r10_1
    ...
    int32_t i = *(arg1[4] + (r9 << 2))
    bool cond:0_1 = i != 0xffffffff
    
    if (i != 0xffffffff)
        do
            if (*(arg1[2] + zx.q(i) * 0x10) == r10_1)
                break
...
if (*(arg1 + 0x3c) == arg1[5].d)
    ...
    if (rdx u> rax_16)
        sub_142809d10(arg1, rdx)
    
    int32_t rcx_9 = *arg2
    int32_t rcx_10 = rcx_9 + not.d(rcx_9 << 0xf)
    ...
    r9 = (zx.q(rcx_13 u>> 0x10) ^ zx.q(rcx_13)) & zx.q(*(arg1 + 0x2c) - 1)
