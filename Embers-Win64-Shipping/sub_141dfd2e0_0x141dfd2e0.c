...
int32_t rbx = *(*(r10 + 0x20) + (sx.q(*(r10 + 0x30) * arg4) << 2) + 4)
int32_t rbx_1
int32_t rdi
float zmm2[0x4]
uint128_t zmm9
...
sub_140af98a0("Unknown", 0x294, u"%i: unknown or unsupported animation compression format", 5)
...
*(arg2 + 0x20) = _mm_unpacklo_ps(_mm_unpacklo_ps(zmm3, zmm0_1), temp0_6[0].q)
return result
