...
while (true)
    ...
    label_142719c31:
        ...
        while (true)
            ...
            if (rax_8 s<= 8)
                for (; i u> r10_1; i -= 8)
                    uint64_t* rdx_2 = r10_1
                    uint64_t* rcx_11 = &r10_1[1]
                    ...
                    if (&r10_1[1] u<= i)
                        do
                            ...
                            if (r8_2 == *rcx_11)
                                r8_2 = *(rdx_2 + 4) s> *(rcx_11 + 4)
                            
                            uint64_t* rax_23 = rcx_11
            ...
            while (true)
                ...
                if (rdx u<= i)
                    uint32_t rax_11 = zx.d(*r10_1)
                    
                    if (rax_11.b == *rdx)
                        rax_11.b = *(r10_1 + 4) s> *(rdx + 4)
