...
float temp0_1[0x4] = __mulps_xmmps_memps(*(arg1 + 0x20), data_143ef7590)
...
float temp0_11[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm8, zmm8, 0xc9), temp0_5)
float temp0_12[0x4] = _mm_mul_ps(temp0_9, temp0_8)
float temp0_13[0x4] = _mm_shuffle_ps(temp0_1, temp0_1, 0xff)
float temp0_14[0x4] = _mm_sub_ps(temp0_12, temp0_11)
...
float result[0x4] = _mm_unpacklo_ps(temp0_35, _mm_shuffle_ps(temp0_35, temp0_35, 0x55)[0].q)
int64_t result_1 = result.q
float var_50 = var_40
(*(*rcx + 0x20))(rcx, &result_1)
float temp0_41[0x4] = __mulps_xmmps_memps(
    _mm_unpacklo_ps(_mm_unpacklo_ps(*arg3, arg3[1].d[0].q), _mm_unpacklo_ps(*(arg3 + 4), 0)[0].q), 
    *(arg1 + 0x40))
float zmm5_1[0x4] = *(arg1 + 0x20)
float temp0_42[0x4] = _mm_shuffle_ps(zmm5_1, zmm5_1, 0xd2)
float temp0_44[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_41, temp0_41, 0xc9), temp0_42)
float temp0_45[0x4] = _mm_shuffle_ps(zmm5_1, zmm5_1, 0xc9)
float temp0_47[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_41, temp0_41, 0xd2), temp0_45)
float temp0_48[0x4] = _mm_shuffle_ps(zmm5_1, zmm5_1, 0xff)
float temp0_49[0x4] = _mm_sub_ps(temp0_47, temp0_44)
float temp0_50[0x4] = _mm_add_ps(temp0_49, temp0_49)
float temp0_51[0x4] = _mm_mul_ps(temp0_48, temp0_50)
float temp0_53[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_50, temp0_50, 0xc9), temp0_42)
float temp0_54[0x4] = _mm_shuffle_ps(temp0_50, temp0_50, 0xd2)
float temp0_55[0x4] = _mm_add_ps(temp0_51, temp0_41)
float temp0_58[0x4] = _mm_add_ps(_mm_sub_ps(_mm_mul_ps(temp0_54, temp0_45), temp0_53), temp0_55)
float var_40_1 = _mm_shuffle_ps(temp0_58, temp0_58, 0xaa)[0]
*arg3 = (_mm_unpacklo_ps(temp0_58, _mm_shuffle_ps(temp0_58, temp0_58, 0x55)[0].q)).q
arg3[1].d = var_40_1
return result
