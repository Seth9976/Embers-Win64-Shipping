...
if (data_143e8cf18 s> *rdi_1)
    _Init_thread_header(&data_143e8cf18)
    
    if (data_143e8cf18 == 0xffffffff)
        ...
        data_143e8cf10 = rax_9
        _Init_thread_footer(&data_143e8cf18)

if (data_143e8cf38 s> *rdi_1)
    _Init_thread_header(&data_143e8cf38)
    
    if (data_143e8cf38 == 0xffffffff)
        ...
        data_143e8cf30 = rax_12
        _Init_thread_footer(&data_143e8cf38)

if (data_143e8cf58 s> *rdi_1)
    _Init_thread_header(&data_143e8cf58)
    
    if (data_143e8cf58 == 0xffffffff)
        ...
        data_143e8cf50 = rax_15
        _Init_thread_footer(&data_143e8cf58)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8cf10
int64_t rcx
