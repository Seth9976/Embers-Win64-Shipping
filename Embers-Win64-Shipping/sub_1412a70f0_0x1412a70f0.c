...
if (data_143e8a670 s> *rdi_1)
    _Init_thread_header(&data_143e8a670)
    
    if (data_143e8a670 == 0xffffffff)
        ...
        data_143e8a668 = rax_12
        _Init_thread_footer(&data_143e8a670)

if (data_143e8a680 s> *rdi_1)
    _Init_thread_header(&data_143e8a680)
    
    if (data_143e8a680 == 0xffffffff)
        ...
        data_143e8a678 = rax_15
        _Init_thread_footer(&data_143e8a680)

if (data_143e8a690 s> *rdi_1)
    _Init_thread_header(&data_143e8a690)
    
    if (data_143e8a690 == 0xffffffff)
        ...
        data_143e8a688 = rax_18
        _Init_thread_footer(&data_143e8a690)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8a668
int64_t rcx
...
label_1412a71e8:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412a71e3
    
    rbx.b = 1
    goto label_1412a71e8
