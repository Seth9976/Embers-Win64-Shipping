...
while (true)
    int16_t* r9_4 = sx.q(r10_2) * 0x1c + *rbx
    int32_t rcx_7 = (*rsi - 1) & sx.d(*r9_4)
    void* rax_13 = arg1 + 0x38
    *(r9_4 + 0x18) = rcx_7
    void* rdx_9 = *(arg1 + 0x40)
    int64_t r8_3 = sx.q(rcx_7)
    
    if (rdx_9 != 0)
        rax_13 = rdx_9
    
    *(r9_4 + 0x14) = *(rax_13 + (((sx.q(*rsi) - 1) & r8_3) << 2))
    ...
    *(rax_15 + (((sx.q(*rsi) - 1) & r8_3) << 2)) = r10_2
