...
if (*(arg1 + 0xa) u> 0)
    int64_t rbp
    int64_t var_30_1 = rbp
    
    do
        uint32_t* r15_1 = *(rdi + (r10 << 3))
        int32_t r12_1 = 0
                ...
                if (rcx_1 != 0)
                    ...
                    do
                        ...
                        if ((r12_1 & 1) == 0)
                            ...
                            rsi.b u>>= 2
                            rcx_3 &= 3
                            *(rbx_3 - 4) = zx.w(rsi.b) & 3
                            rsi.b u>>= 2
                        else
                            rcx_3 = *(rbx_3 - 4)
                        
                        if (rcx_3 == 0)
                            int32_t rcx_5 = sub_141c79cd0(r8, arg1 + 0x60) + r14.d
                            r14 = zx.q(rcx_5 - rax_2)
                        ...
                        uint64_t rax_13 = sub_141c79cd0(arg2, arg1 + 0xb0)
                        
                        if (rbp.b != 0)
                            int16_t* r8_1 = *(arg1 + 0x120) + (zx.q((rax_13 * 3).d) << 1)
                            *r15_1 = zx.d(*(*(arg1 + 0x108) + (r14 << 1))) | zx.d(*r8_1) << 0x10
                            r15_1[1] = zx.d(r8_1[2]) << 0x10 | zx.d(r8_1[1])
