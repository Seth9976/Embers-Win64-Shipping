...
if (data_143e8a8d0 s> *rdi_1)
    _Init_thread_header(&data_143e8a8d0)
    
    if (data_143e8a8d0 == 0xffffffff)
        ...
        data_143e8a8c8 = rax_12
        _Init_thread_footer(&data_143e8a8d0)

if (data_143e8a8e0 s> *rdi_1)
    _Init_thread_header(&data_143e8a8e0)
    
    if (data_143e8a8e0 == 0xffffffff)
        ...
        data_143e8a8d8 = rax_15
        _Init_thread_footer(&data_143e8a8e0)

if (data_143e8a8f0 s> *rdi_1)
    _Init_thread_header(&data_143e8a8f0)
    
    if (data_143e8a8f0 == 0xffffffff)
        ...
        data_143e8a8e8 = rax_18
        _Init_thread_footer(&data_143e8a8f0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8a8c8
int64_t rcx
