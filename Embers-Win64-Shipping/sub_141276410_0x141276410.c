...
if (data_143e8d89c s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8d89c)
    
    if (data_143e8d89c == 0xffffffff)
        ...
        data_143e8d890 = rax_6
        _Init_thread_footer(&data_143e8d89c)

int64_t rbx = data_143e8d890
int64_t rcx
