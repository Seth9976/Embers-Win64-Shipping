...
if (data_143e8a730 s> *rdi_1)
    _Init_thread_header(&data_143e8a730)
    
    if (data_143e8a730 == 0xffffffff)
        ...
        data_143e8a728 = rax_9
        _Init_thread_footer(&data_143e8a730)

if (data_143e8a740 s> *rdi_1)
    _Init_thread_header(&data_143e8a740)
    
    if (data_143e8a740 == 0xffffffff)
        ...
        data_143e8a738 = rax_12
        _Init_thread_footer(&data_143e8a740)

if (data_143e8a750 s> *rdi_1)
    _Init_thread_header(&data_143e8a750)
    
    if (data_143e8a750 == 0xffffffff)
        ...
        data_143e8a748 = rax_15
        _Init_thread_footer(&data_143e8a750)
