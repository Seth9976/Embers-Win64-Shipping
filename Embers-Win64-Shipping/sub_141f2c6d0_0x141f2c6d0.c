...
while (true)
    ...
    if (r12_1 == 0)
    label_141f2c8c9:
        sub_141f2c4b0(r14_1, rax_8, zx.q(arg3), arg4)
    else
        while (true)
            uint128_t zmm1
            ...
            if (rax_8 s<= 8)
                for (; i u> r14_1; i -= 8)
                    uint64_t* rsi_2 = r14_1
                    int32_t* rbp_2 = &r14_1[1]
                    
                    if (&r14_1[1] u<= i)
                        do
                            if (sub_141f2f970(arg4, rsi_2, rbp_2) != 0)
                                rsi_2 = rbp_2
            ...
            while (true)
                ...
                if (rsi_1 u<= i && sub_141f2f970(arg4, r14_1, rsi_1) == 0)
                    continue
                ...
                do
                    ...
                    i_1 = sub_141f2f970(arg4, rbp_1, r14_1)
                while (i_1 == 0)
