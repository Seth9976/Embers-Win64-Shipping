...
int32_t r10 = (data_1439b4a18).d
void* r9 = &data_1439b4a00
int32_t rcx = 0
void* var_a0 = &data_1439b4a00
int32_t var_a8 = 0
int32_t var_a4 = 1
int32_t r8 = 0
...
if (r10 != 0)
    ...
    label_140fe5998:
        ...
        while (true)
            ...
            if (rdx_3 != 0)
                goto label_140fe5998

int16_t var_50 = 0
int128_t zmm0 = var_a8.o
int64_t* var_20 = &data_1439b49f0
int128_t var_30 = 0xffffffff
int64_t* var_58 = &data_1439b49f0
void* rax_11 = zmm0.q
int128_t var_78 = zmm0
int128_t var_88 = (&data_1439b49f0).o
...
if (0 s< *(rax_11 + 0x18))
    ...
    do
        int64_t* rbx_2 = *(*var_88.q + sx.q(i) * 0x18 + 8)
        rbx_2[1].d -= 1
    ...
    if (var_50.b != 0 && var_50:1.b != 0)
        sub_1405b6470(var_58, var_58[1].d - *(var_58 + 0x34), 1)

return sub_140865470(&data_1439b49f0, 0) __tailcall
