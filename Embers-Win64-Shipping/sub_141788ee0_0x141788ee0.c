...
uint64_t var_1b8 = *(rdx_1 + 0x60)
int32_t var_1b0 = *(rdx_1 + 0x68)
uint64_t var_1ac = *(rdx_1 + 0x6c)
int32_t var_1a4 = *(rdx_1 + 0x74)
int32_t var_188
...
__builtin_memcpy(&var_1b8, 
    ...
    0x18)
sub_141799070(rbx + 0xb0, &var_170, &var_158, &var_198, var_1c8)
