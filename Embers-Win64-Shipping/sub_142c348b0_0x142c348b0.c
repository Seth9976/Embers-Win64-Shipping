...
char rax = sub_142c29600(arg1, arg2)

if (rax == 0)
    return rax

uint32_t rcx_1 = zx.d(sub_142c330c0(arg1))
int32_t rsi = 0
...
label_142c34aab:
    ...
    while (true)
        ...
        if (r8_2 u<= r10_1 && r10_1 u<= *(arg2 + 0x10) && arg2[4] - r10_1.d u>= 4)
            rcx_12 = arg2[6]
            arg2[6] = rcx_12 - 1
        
        char r11_1
        
        if (r8_2 u> r10_1 || r10_1 u> *(arg2 + 0x10) || arg2[4] - r10_1.d u< 4 || rcx_12 s<= 0)
            r11_1 = 0
        else
            r11_1 = 1
