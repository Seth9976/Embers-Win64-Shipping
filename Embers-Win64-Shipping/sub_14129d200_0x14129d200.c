...
if (data_143e8cae0 s> *rdi_1)
    _Init_thread_header(&data_143e8cae0)
    
    if (data_143e8cae0 == 0xffffffff)
        ...
        data_143e8cad8 = rax_9
        _Init_thread_footer(&data_143e8cae0)

if (data_143e8caf0 s> *rdi_1)
    _Init_thread_header(&data_143e8caf0)
    
    if (data_143e8caf0 == 0xffffffff)
        ...
        data_143e8cae8 = rax_12
        _Init_thread_footer(&data_143e8caf0)

if (data_143e8cb00 s> *rdi_1)
    _Init_thread_header(&data_143e8cb00)
    
    if (data_143e8cb00 == 0xffffffff)
        ...
        data_143e8caf8 = rax_15
        _Init_thread_footer(&data_143e8cb00)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8cad8
int64_t rcx
