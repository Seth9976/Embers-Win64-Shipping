...
if (rax_2 == 0 || rdi_1 == 0)
    ...
    if (result.b == 0 || rdx_8 == 0)
        ...
        if (sub_140cc1670(&var_48, &data_143e1b820).b == 0 || var_48 == 0)
            ...
            uint64_t r14_2 = zx.q(sub_1408e52c0(rax_9))
            void var_38
            ...
            int64_t rbx_9 = rdi_1[1]
            sub_140d2df10()
            
            if (rbx_9 != &data_143e1d7f0)
                result.b = 0
            else
                if (r14_2.d == 0xffffffff)
                    r14_2 = 0
                
                if (*(rdi_1 + 0x3c) != 0x18 || r14_2.d s>= rdi_1[7].d)
                    result.b = 0
                else
                    int64_t rbx_10 = sx.q((r14_2 * 3).d << 3)
    ...
    if (rbx_5 != &data_143e1d7f0 || *(rdi_1 + 0x3c) != 0x18)
        result.b = 0
    else
    ...
    int64_t* r14_1 = sx.q(*(rdi_1 + 0x4c)) + arg1
    ...
    if (rax_1 s< 0 || rax_1 s>= r14_1[1].d)
        ...
        if (rbx_2 != &data_143e1d7f0 || *(rdi_1[0xf] + 0x3c) != 0x18 || r14_1[1].d == 0)
            result.b = 0
        else
            result = *r14_1
