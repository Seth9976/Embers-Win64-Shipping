...
float* rax_2
int512_t zmm15
rax_2, zmm15 = sub_1417092b0(rcx_1, &var_98, &var_a8)
zmm15.o = zx.o(*rax_2)
int32_t rbp = rax_2[2]
float* rax_3
float zmm6_1
...
rax_3, zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm15_1 =
    sub_1417092b0(rcx_1, &var_a8, arg2)
int64_t* rbx = arg1[2]
float zmm2 = zmm10_1
...
bool cond:0 = (zmm2 f- zmm3.d) * zmm6_1 + zmm1 f+ zmm0.d
    < (zmm11_1 f- _mm_shuffle_ps(zmm15_1, zmm15_1, 0x55).d) f* *(arg2 + 4) + zmm10_1 f+ zmm9_1.d
rbx[1].d = rax_4
int64_t result
