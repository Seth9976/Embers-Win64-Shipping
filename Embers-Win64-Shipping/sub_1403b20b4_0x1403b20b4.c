...
do
    ...
    int64_t zmm1 = (*(rsi + result)).q
    char zmm2[0x10] = zmm0
    zmm0 = _mm_unpacklo_epi8(zmm0, zmm1)
    zmm2 = _mm_unpackhi_epi8(zmm2, zmm1)
    zmm0 = _mm_maddubs_epi16(zmm0, zmm7)
    char temp0_8[0x10] = _mm_maddubs_epi16(zmm2, zmm7)
    *rdi = _mm_packus_epi16(_mm_mulhrs_epi16(zmm0, zmm6), _mm_mulhrs_epi16(temp0_8, zmm6))
    rsi += result
    rdi += sx.q(arg4)
    i = i_1
    i_1 -= 1
