        ...
        while (true)
            ...
            if (rdx_3 s<= 8)
                for (; i u> r11_1; i -= 0x1c)
                    ...
                    if (r11_1 + 0x1c u<= i)
                        do
                            if ((*(rax_29 + 0x18)).d f< *(rdx_14 + 0x18))
                                rdx_14 = rax_29
            ...
            while (true)
                ...
                if (r9_1 u<= i && (*(r9_1 + 0x18)).d f>= *(r11_1 + 0x18))
                    continue
                ...
                do
                    ...
                    if (r10_1 u<= r11_1)
                        break
                while ((*(r11_1 + 0x18)).d f>= *(r10_1 + 0x18))
