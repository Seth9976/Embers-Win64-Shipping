...
if (*arg2 == 0)
    ...
    void var_168
    sub_14058b120(&var_168, "Image channel name cannot be an empty string.")
...
if (rbx != r10)
    ...
    do
        rdx_2 = zx.d(*result)
        i_1 = zx.d(*(result + rbx + 0x1c - &_Destination))
...
if (rbx == r10 || rdx_2 - i_1 s< 0)
    ...
    int64_t* rax_3 = sub_14297ae40(arg1, &data_143551fbd, &var_190)
    result = sub_14297b460(arg1, &var_190, rbx, rax_3 + 0x1c, rax_3)
    rbx = var_190
