...
while (true)
    ...
    if (result.d == (var_88_1.q u>> 0x20).d && var_68.q == arg2 + 0x10 && rdx_12 == arg2)
        return result
    
    int64_t rax_25 = *rdx_12 + result * 0x14
    var_98.q = rax_25
    int64_t var_90_1 = rax_25 + 8
    int32_t arg_8
    sub_1405a8200(arg1, &arg_8, &var_98, nullptr)
