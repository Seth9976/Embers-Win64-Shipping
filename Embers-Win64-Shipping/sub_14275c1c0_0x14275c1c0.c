...
if (rdx.b == 0)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            int32_t zmm0[0x4] = *r11_4
            r11_4 = &r11_4[1]
            rax = rcx_6
            rcx_6 += 0x10
            *rax = ((_mm_cmpgt_epi32(data_143f87810, zmm0) ^ zmm3)
                & (data_143f87840 ^ data_143f87830)) ^ data_143f87830
            i = i_3
            i_3 -= 1
        while (i != 1)
else if (rax.d == 1)
    ...
    *(arg1 + 0x10) = &rax_8[3]
    ...
    uint128_t zmm4 = zx.o(*(sx.q(rcx_1) + *(*(arg1 + 0x18) + (sx.q(r8_1) << 3))))
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            rax_6 = rdx_5
            rdx_5 = &rdx_5[1]
            *rax_6 = ((_mm_cmpgt_epi32(data_143f87810, zmm4) ^ zmm3)
                & (data_143f87840 ^ data_143f87830)) ^ data_143f87830
            i_1 = i_2
            i_2 -= 1
        while (i_1 != 1)
