...
if (*arg1 == 0)
    ...
    while (i s>= 0)
        ...
        int16_t var_270_1 = arg4[1].w
        char var_26e_1 = *(arg4 + 0xa)
        int32_t rax_6 = *(arg4 + 0xc)
        int64_t var_268_1 = arg4[2]
        void** const var_278 = &data_142d7f6a8
        int64_t var_260_1 = arg4[3]
        int64_t var_258_1 = arg4[4]
        int64_t* rax_10 = arg4[5]
        ...
        int128_t zmm0_1 = arg4[7].d
        int32_t var_248_1 = arg4[6].d
        int32_t rax_12 = *(arg4 + 0x34)
        var_278 = &data_142ecfd58
        char* rbx_1 = &rcx_2[0x32]
        int32_t var_240_1 = zmm0_1.d
        int32_t var_244_1 = rax_12
        ...
        if (*rbx_1 == 0)
            ...
            void var_118
            (*(*rcx_2 + 0x50))(rcx_2, &var_118, &var_178, &var_278, var_288, var_280)
        ...
        var_280 = rax_6
        var_288 = nullptr
        MRECmpImpl::FPushFile(arg2, r12, arg1, r12, var_288, var_280)
        ...
        if (rax_10 != 0)
            ...
            if (rax_10[1].d == 1)
                (**rax_10)(rax_10)
                int32_t temp18_1 = *(rax_10 + 0xc)
                *(rax_10 + 0xc) -= 1
                
                if (temp18_1 == 1)
                    (*(*rax_10 + 8))(rax_10, 1)
        
        var_278 = &data_142d7f690
        int64_t* var_128
