...
if (r10_1 s>= rbx)
    rax = zx.q(arg1[0x4b])
    int64_t r9_2 = r10_1 << 6
    int64_t i_1 = r10_1 - rbx + 1
    int64_t i
    
    do
        if (rax.d != 0)
            int32_t* rax_1 = *(arg1 + 0x100)
            int32_t* rcx = arg1
            
            if (rax_1 != 0)
                rcx = rax_1
            
            rcx[sx.q(arg1[0x4a]) * 0x10] = r8_1
