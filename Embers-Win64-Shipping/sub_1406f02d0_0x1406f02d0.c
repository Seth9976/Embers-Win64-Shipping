...
if (arg3[0x86].b == 0)
    ...
    if (rax_14 != 0)
        rax_14[1] = arg1
        *rax_14 = &data_142da51d8
        rax_14[3] = sub_140a387b0()
        *rax_14 = &data_142da5230
    
    rax_11 = &var_18
    
    if (&var_18 == arg4)
        goto label_1406f04b2
    ...
    if (rbx_1 == 0)
        if (rax_6 != 0)
            rax_6[1] = arg1
            *rax_6 = &data_142da5128
            rax_6[3] = sub_140a387b0()
            *rax_6 = &data_142da5180
    else if (rax_6 != 0)
        rax_6[1] = arg1
        *rax_6 = &data_142da5078
        rax_6[3] = sub_140a387b0()
        *rax_6 = &data_142da50d0
    
    rax_11 = &var_18
    
    if (&var_18 == arg4)
        goto label_1406f03ec
