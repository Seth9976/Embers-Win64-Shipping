...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_1[4]
    sub_140d30490(arg2, &var_f0, r8_1)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_11[4]
    sub_140d30490(arg2, &var_d8, r8_11)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_15[4]
    sub_140d30490(arg2, &var_e8, r8_15)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_17[4]
    sub_140d30490(arg2, &var_f8, r8_17)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_23[4]
    sub_140d30490(arg2, &var_f4, r8_23)
else
...
int32_t var_b0
int32_t var_90 = var_b0
uint64_t var_88 = var_a8
int32_t var_100 = var_f4.d
uint128_t* var_108 = &var_58
int128_t var_48
int128_t* var_110 = &var_48
int64_t* rcx_12 = var_f0
char var_118 = r12.b
int32_t var_a0
int32_t var_80 = var_a0
uint32_t rax_19 = zx.d(arg_10)
*(arg2 + 0x20) = rdi + rax_16
var_48 = zmm1
char result = sub_1420cb610(rcx_12, &var_88, &var_98, r15, r13.b, r14, rax_19, rsi)
*arg3 = result
