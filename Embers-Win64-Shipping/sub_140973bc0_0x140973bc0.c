...
while (true)
    void* rsi_2 = sx.q(r12_1) * 0x118 + *rbx
    int64_t* rcx_5 = *(rsi_2 + 8)
    char rax_14
    ...
    if (rcx_5 == 0 || rax_14 == 0)
        ...
        int64_t* rdi = *(rsi_2 + 8)
        int32_t rax_16 = (*(*rdi + 0x20))(rdi)
        int64_t rdx_9 = *rdi
        rcx_9 = sub_140a6af60((*(rdx_9 + 0x18))(rdi, rdx_9), rax_16)
    ...
    *(rsi_2 + 0x110) = *(rax_22 + (((sx.q(*r15) - 1) & r8_3) << 2))
