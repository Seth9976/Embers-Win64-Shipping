...
void* rsi = arg2
int32_t result_1 = *(arg2 + 0x38) & zx.d(*(arg1 + 0x43ba))
...
do
    ...
    if (rdx_4.d != 0)
        ...
        do
            ...
            var_a0 = 0
            var_a8 = rsi_1[0xb]
            sub_140fd5230(arg1, *(rax_9 + 0x30), *(rax_9 + 0x40), rbx_3)
            rbx_2 = *r14_2
            r14_2 = &r14_2[1]
    ...
    if (rax_12.d != 0)
        ...
        do
            ...
            var_a0 = 0
            var_a8 = 0
            sub_140fd5230(arg1, *(rbp_1 + 0x20), *(rbp_1 + 0x18), rdi_4)
            rdi_3 = *r14_4
            r14_4 = &r14_4[1]
    ...
    if (rax_18.d != 0)
        ...
        do
            ...
            if (*(arg1 + (rdx_9 << 3) + 0x2040) != rax_20)
                *(arg1 + (rdx_9 << 3) + 0x2040) = rax_20
                int64_t* rcx_20 = *(arg1 + 0x188)
                (*(*rcx_20 + 0x230))(rcx_20, rdx_9, 1, &var_80, var_a8, var_a0)
