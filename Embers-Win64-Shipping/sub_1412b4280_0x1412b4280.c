...
if (data_143e8c720 s> *rdi_1)
    _Init_thread_header(&data_143e8c720)
    
    if (data_143e8c720 == 0xffffffff)
        ...
        data_143e8c718 = rax_9
        _Init_thread_footer(&data_143e8c720)

if (data_143e8c740 s> *rdi_1)
    _Init_thread_header(&data_143e8c740)
    
    if (data_143e8c740 == 0xffffffff)
        ...
        data_143e8c738 = rax_12
        _Init_thread_footer(&data_143e8c740)

if (data_143e8c760 s> *rdi_1)
    _Init_thread_header(&data_143e8c760)
    
    if (data_143e8c760 == 0xffffffff)
        ...
        data_143e8c758 = rax_15
        _Init_thread_footer(&data_143e8c760)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c718
int64_t rcx
...
label_1412b4383:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412b437e
        
        rbx.b = 1
        goto label_1412b4383
