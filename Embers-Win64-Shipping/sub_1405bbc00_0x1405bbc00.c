...
sub_1405c2450(arg1, nullptr, 0)
int32_t rcx = 0
int32_t var_84 = 1
int32_t var_88 = 0
int32_t rbx = *(arg1 + 0x40)
void* var_80 = arg1 + 0x28
int32_t r8 = 0
...
while (true)
    ...
    if (rax_20.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x28 && rcx_7 == arg1 + 0x18)
        return sub_1405b87f0(arg1 + 0x18, 0) __tailcall
    
    sub_1420d0a40(*((rax_20 << 5) + *rcx_7 + 0x10))
    int32_t var_5c
