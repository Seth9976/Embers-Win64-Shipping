...
float temp0_8[0x4] = _mm_shuffle_ps(zmm5, zmm5, 0xc9)
zmm3 = _mm_mul_ps(_mm_shuffle_ps(temp0_4, temp0_4, 0xd2), temp0_8)
float temp0_11[0x4] = _mm_shuffle_ps(zmm5, zmm5, 0xff)
zmm3 = _mm_sub_ps(zmm3, temp0_7)
zmm3 = _mm_add_ps(zmm3, zmm3)
float temp0_14[0x4] = _mm_mul_ps(temp0_11, zmm3)
float temp0_15[0x4] = _mm_shuffle_ps(zmm3, zmm3, 0xd2)
float temp0_17[0x4] = _mm_mul_ps(_mm_shuffle_ps(zmm3, zmm3, 0xc9), temp0_6)
float temp0_18[0x4] = _mm_mul_ps(temp0_15, temp0_8)
float temp0_19[0x4] = _mm_add_ps(temp0_14, temp0_4)
float temp0_21[0x4] = _mm_add_ps(_mm_sub_ps(temp0_18, temp0_17), temp0_19)
float result = _mm_shuffle_ps(temp0_21, temp0_21, 0xaa)[0]
*arg3 = (_mm_unpacklo_ps(temp0_21, _mm_shuffle_ps(temp0_21, temp0_21, 0x55)[0].q)).q
arg3[1].d = result
