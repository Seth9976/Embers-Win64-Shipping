...
while (true)
    void* r9_5 = (sx.q(r10_2) << 6) + *rbx
    int32_t r8_7 = ((sx.d((int.d(fconvert.t(*(r9_5 + 4)))).w) << 0x10
        | sx.d((int.d(fconvert.t(*(r9_5 + 8)))).w)) ^ int.d(fconvert.t(*(r9_5 + 0xc)))) & (*rsi - 1)
    void* rax_17 = arg1 + 0x38
    *(r9_5 + 0x3c) = r8_7
    void* rdx_9 = *(arg1 + 0x40)
    int64_t r8_8 = sx.q(r8_7)
    
    if (rdx_9 != 0)
        rax_17 = rdx_9
    
    *(r9_5 + 0x38) = *(rax_17 + (((sx.q(*rsi) - 1) & r8_8) << 2))
    ...
    *(rax_19 + (((sx.q(*rsi) - 1) & r8_8) << 2)) = r10_2
