...
void* rax_3 = __RTDynamicCast(arg2, 0, &class Imf_2_3::Attribute `RTTI Type Descriptor', 
    &class Imf_2_3::TypedAttribute<class Imath_2_3::Matrix44<float> > `RTTI Type Descriptor', 0)
...
*(arg1 + 0x24) = *(rax_3 + 0x24)
*(arg1 + 0x28) = *(rax_3 + 0x28)
*(arg1 + 0x2c) = *(rax_3 + 0x2c)
*(arg1 + 0x30) = *(rax_3 + 0x30)
*(arg1 + 0x34) = *(rax_3 + 0x34)
*(arg1 + 0x38) = *(rax_3 + 0x38)
*(arg1 + 0x3c) = *(rax_3 + 0x3c)
*(arg1 + 0x40) = *(rax_3 + 0x40)
int32_t result = *(rax_3 + 0x44)
*(arg1 + 0x44) = result
