...
if (result.d s> 0)
    ...
    float temp0_1[0x4] = _mm_cmpeq_ps(data_143f87750, temp0, 1)
    float temp0_2[0x4] = _mm_rsqrt_ps(temp0)
    uint64_t i
    
    do
        result = result_1
        result_1 += 0x10
        *result = _mm_and_ps(temp0_2 ^ data_143f87690, temp0_1) ^ data_143f87690
        i = i_1
        i_1 -= 1
    while (i != 1)
