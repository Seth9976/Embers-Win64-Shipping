...
if (arg3 != 0)
    int32_t* rsi_1 = arg5
    void*** rdi_1 = arg1 + 0x2b00
    uint64_t i_1 = zx.q(arg3)
    uint64_t i
    
    do
        void* rbx_1 = *(arg4 - (arg1 + 0x2670) - 0x490 + rdi_1)
        *(arg1 + 0x2670 + (zx.q(rbp) << 3) + 0x190) = rbx_1
        result = zx.q(*(arg1 + 0x2676)) | zx.q(1 << (rbp u% 0x20))
        *(arg1 + 0x2676) = result.w
