...
if (data_143e8d088 s> *rdi_1)
    _Init_thread_header(&data_143e8d088)
    
    if (data_143e8d088 == 0xffffffff)
        ...
        data_143e8d080 = rax_9
        _Init_thread_footer(&data_143e8d088)

if (data_143e8d0a8 s> *rdi_1)
    _Init_thread_header(&data_143e8d0a8)
    
    if (data_143e8d0a8 == 0xffffffff)
        ...
        data_143e8d0a0 = rax_12
        _Init_thread_footer(&data_143e8d0a8)

if (data_143e8d0c8 s> *rdi_1)
    _Init_thread_header(&data_143e8d0c8)
    
    if (data_143e8d0c8 == 0xffffffff)
        ...
        data_143e8d0c0 = rax_15
        _Init_thread_footer(&data_143e8d0c8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d080
int64_t rcx
...
label_14129c893:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_14129c88e
        
        rbx.b = 1
        goto label_14129c893
