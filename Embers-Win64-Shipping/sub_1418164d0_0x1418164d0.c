...
*(rax_2 + 0x18) = zmm1
void*** var_78 = rax_2
char* (* var_88)(char* arg1, int64_t* arg2)
char* (* rax_3)(char* arg1, int64_t* arg2) = var_88

if (rax_2 != -8)
    rax_3 = sub_14182a710

char* (* var_88_1)(char* arg1, int64_t* arg2) = rax_3
void*** rax_4 = sub_14181ce00(r14)
void* r15 = &rax_4[2]
void* var_148 = r15
void*** var_140 = rax_4
...
if (arg2 s>= 0)
    ...
    if (arg2 s<= 1)
        ...
        *(r14_2 + 0x30) = zmm0_1
        ...
        int64_t var_d0_1 = 0
        *(r14_2 + 0x40) = var_58
        char* (* rax_48)(char* arg1, int64_t* arg2) = var_88_1
        ...
        if (rax_20 == 0)
            ...
            void var_98
            *(r15 + 0x80) = *var_88_1(&var_98, (*rcx_21)[1](rcx_21))
            ...
            if (rax_21 == 0)
                ...
                *r14_1 = &data_142fe5c90
                r14_1[2] = var_88_1
                r14_1[4] = var_78
                int128_t zmm0_4 = var_68
                var_78 = nullptr
                ...
                *(r14_1 + 0x30) = zmm0_4
                ...
                int64_t var_e0_1 = 0
                *(r14_1 + 0x40) = var_58
                char* (* rax_24)(char* arg1, int64_t* arg2) = var_88_1
        ...
        if (rax_9 == 0)
            ...
            *(rdi_1 + 0x30) = var_68
            int64_t var_f0_1 = 0
            *(rdi_1 + 0x40) = var_58
            char* (* rax_12)(char* arg1, int64_t* arg2) = var_88_1
