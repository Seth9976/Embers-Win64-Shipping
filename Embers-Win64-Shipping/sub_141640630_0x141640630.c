...
int32_t var_2b8 = _mm_cvtpd_ps(temp0_3)[0].d
...
uint32_t var_298 = zmm1[0]
int64_t var_130 = (_mm_unpacklo_ps(zmm8, zmm11.q)).q
uint32_t var_31c = zmm1[0]
int32_t var_2f8 = (zmm4 ^ 0x80000000)[0].d
float var_2f4 = (zmm5 ^ 0x80000000)[0]
float var_2f0 = (zmm6 ^ 0x80000000)[0]
uint32_t var_128 = var_298
float var_2e4
float* rax_7
uint128_t zmm8_1
uint128_t zmm9
...
uint128_t zmm11_1
uint128_t zmm12
rax_7, zmm8_1, zmm9, zmm10_1, zmm11_1, zmm12 = sub_1417119b0(&var_228, &var_2e4, &var_2f8)
...
if (rdi.b == 0)
    while (true)
        ...
        if (rax_8 s>= 0x20)
            ...
            var_2e8 = zmm4_1.d
            zmm4_1 = *(rax_9 + 0x2c)
            zmm2_1.d = zmm12.d f* zmm11_1.d
            zmm1_1.d = zmm4_1.d f* zmm8_1.d
            ...
            zmm13_1.d = zmm13_1.d f* zmm4_1.d
            int32_t var_2cc_1 = zmm0_1.d
            int32_t var_298_1 = zmm12.d
            int32_t var_210 = (zmm7_1 ^ 0x80000000).d
            int32_t var_20c_1 = (zmm8_1 ^ 0x80000000).d
            int32_t var_208_1 = (zmm11_1 ^ 0x80000000).d
            float var_1bc
            float* rax_10
            rax_10, zmm6_1, zmm7_1, zmm8_1, zmm9, zmm10_1, zmm11_1, zmm12, zmm13_1, zmm14, zmm15 =
                sub_1417119b0(&var_228, &var_1bc, &var_210)
            zmm5_1 = var_2cc_1
            zmm1_1 = zx.o(*rax_10)
            int32_t rcx_5 = rax_10[2]
            zmm2_1.d = zmm5_1.d f- zmm1_1.d
            zmm3_1.d = zmm13_1.d f- _mm_shuffle_ps(zmm1_1, zmm1_1, 0x55).d
            zmm12.d = zmm12.d f- rcx_5
            (&var_184)[sx.q(r13.d)] = r13.d
            r13 = sx.q(var_188)
            zmm4_1.d = zmm14.d f- zmm2_1.d
            zmm0_1 = _mm_unpacklo_ps(zmm5_1, zmm13_1.q)
            int32_t var_2cc_2 = zmm2_1.d
            zmm2_1.d = zmm15.d f- zmm3_1.d
            var_2e8 = zmm3_1.d
            uint64_t rcx_7 = r13 * 3
            var_2f8 = zmm4_1.d
            zmm3_1.d = var_318.d f- zmm12.d
            ...
            *(&var_100 + (rcx_7 << 2)) = zmm1_1.q
            ...
            zmm1_1.d = zmm11_1.d f* zmm3_1.d
            (&var_f8)[rcx_7] = rax_10[2]
            ...
            label_141640e6d:
                ...
                if (r14.b != 0 && not(zmm5_1.d f< zmm9.d))
                    zmm5_1.d = zmm5_1.d f* zmm5_1.d
                    zmm5_1.d = zmm5_1.d f+ 9.99999997e-07f
                    rdi.b = zmm5_1.d f>= zmm12.d
            else
                zmm3_1 = *(rsi + 4)
                zmm4_1 = *rsi
                zmm2_1.d = zmm4_1.d f* zmm7_1.d
                zmm0_1.d = zmm3_1.d f* zmm8_1.d
                zmm1_1.d = (*(rsi + 8)).d f* zmm11_1.d
                zmm2_1.d = zmm2_1.d f+ zmm0_1.d
                zmm2_1.d = zmm2_1.d f+ zmm1_1.d
                
                if (zmm2_1.d f>= zmm9.d)
                    result.b = 0
                    goto label_141641924
                
                zmm1_1 = zmm6_1
                zmm0_1.d = zmm5_1.d f- zmm10_1.d
                zmm0_1.d = zmm0_1.d f/ zmm2_1.d
                zmm6_1.d = zmm6_1.d f- zmm0_1.d
                
                if (zmm6_1.d f<= zmm1_1.d)
                    goto label_141640e6d
                ...
                var_260 = zmm1_1.q
                zmm13_1.d = zmm6_1.d f* *(rsi + 8)
                r13 = zx.q(r13.d + 1)
                result_1 = result_2
                zmm14.d = zmm6_1.d f* zmm4_1.d
                var_188 = r13.d
                zmm13_1.d = zmm13_1.d f+ var_308[1].d
                zmm15.d = zmm6_1.d f* zmm3_1.d
                var_328 = 0
                zmm14.d = zmm14.d f+ var_308[0].d
                var_2c8.d = zmm7_1.d
                zmm15.d = zmm15.d f+ var_308[0]:4.d
                var_318 = zmm13_1.d
                zmm2_1.d = zmm13_1.d f- result_1
                var_290 = zmm14.d
            ...
            if (rdi.b != 0)
                int64_t* rax_24
                rax_24, zmm6_1, zmm9, zmm10_1, zmm13_1, zmm14, zmm15 =
                ...
                if (rcx_8 == 1)
                    ...
                    *(&var_170 + (rax_20 << 2)) = 0x3f800000
                    ...
                    uint64_t var_1a4
                    uint64_t* rax_18
                    rax_18, zmm6_1, zmm9, zmm10_1, zmm12, zmm13_1, zmm14, zmm15 =
                    ...
                    uint64_t var_1b0
                    uint64_t* rax_17
                    rax_17, zmm6_1, zmm9, zmm10_1, zmm12, zmm13_1, zmm14, zmm15 =
...
if (not(zmm6_1.d f<= zmm9.d))
    ...
    *arg8 = var_2c8
    ...
    if (r13.d s> 0)
        ...
        do
            zmm2_1 = *rcx_20
            rcx_20 += 4
            zmm0_1.d = zmm2_1.d f* rax_27[-2]
            zmm1_1.d = zmm2_1.d f* rax_27[-1]
    ...
    *arg7 = (_mm_unpacklo_ps(zmm9, zmm4_1.q)).q
    ...
    if (zmm10_1.d f<= zmm9.d || zmm0_1.q f<= 9.9999999999999995e-07 || zmm1_1.d f>= zmm2_1.d)
        var_170[0] = 0
        var_170[1] = 0
        var_308[0] = 0
        var_308[1] = 0
            ...
            *arg7 = (_mm_unpacklo_ps(zmm1_1, zmm2_1.q)).q
            ...
            if (r13.d s> 0)
                ...
                do
                    ...
                    *(rcx_24 i+ (rdx_11 << 2) + 8) = rax_35
                    int64_t rdi_5 = sx.q(var_308[1].d)
                    int32_t var_2f4_2 = zmm1_1.d
                    var_2f8 = zmm0_2.d
                    zmm0_2.d = zmm13_1.d f+ *(&var_f8 + r12)
                    int32_t rax_36 = (rdi_5 + 1).d
                    var_308[1].d = rax_36
                    var_2f0 = zmm0_2.d
                    
                    if (rax_36 s> var_308[1]:4.d)
            ...
            int32_t rax_40
            rax_40, zmm10_1, zmm12 = sub_1415b88e0(&var_170, &var_308, &var_240, &var_228, 
                &var_2e8, &var_2f8, &var_260, &var_238)
            zmm0_2 = zx.o(var_2f8.q)
            rax_41 = var_2f0
            
            if (rax_40 == 2)
                goto label_1416418bc
            
            *arg8 = zmm0_2.q
            arg8[1].d = rax_41
            result = result_1
            zmm0_2.d = (var_2e8 ^ zmm12).d f- zmm10_1.d
            *rdi_3 = zmm0_2.d
            *arg7 = var_260
        ...
        *arg8 = var_2c8
        ...
        zmm14 = var_308[0].d
        zmm6_1.d = var_308[1].d.d f+ zmm11_1.d
        zmm15 = var_308[0]:4.d
        ...
        *arg8 = zmm0_1.q
        ...
        zmm1_1.d = zmm10_1.d f- __sqrtss_xmmss_memss(zmm0_1.d, var_324).d
        arg8[1].d = var_2dc_3
        ...
        zmm1_1.d = zmm2_1.d f* zmm10_1.d
        zmm12.d = zmm12.d f+ zmm14.d
        zmm13_1.d = zmm13_1.d f- zmm1_1.d
        zmm1_1.d = zmm3_1.d f* zmm10_1.d
        zmm12.d = zmm12.d f+ zmm0_1.d
        zmm0_1.d = zmm9.d f* zmm2_1.d
        zmm11_1.d = zmm11_1.d f- zmm1_1.d
        zmm13_1.d = zmm13_1.d f+ zmm15.d
        zmm11_1.d = zmm11_1.d f+ var_308[1].d
        zmm13_1.d = zmm13_1.d f+ zmm0_1.d
        zmm0_1 = zmm9
        zmm9 ^= data_142d3f780
        zmm0_1.d = zmm0_1.d f* zmm3_1.d
        zmm11_1.d = zmm11_1.d f+ zmm0_1.d
        *arg7 = (_mm_unpacklo_ps(zmm12, zmm13_1.q)).q
        arg7[1].d = zmm11_1.d
        *rdi_3 = zmm9.d
