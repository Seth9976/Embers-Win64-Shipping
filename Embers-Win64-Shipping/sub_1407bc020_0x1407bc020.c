...
uint32_t rax_16 = zx.d(rax[5])
*(arg2 + 0x10) = &rax[6]

if ((not.b((rax_16 u>> 0xf).b) & 1) != 0)
    int32_t* r9_6 = *(arg2 + 0x20)
    int32_t rcx_11 = rax_16 & 0x7fff
    int32_t rax_18 = *r9_6
...
if (*(arg2 + 0x40) s> 0)
    while (true)
        r10_9 += 1
        int32_t* var_28_1 = &rdx_9[sx.q(r9_7)]
        *rdx_9 = 0
