...
if (r11_7 != 0)
    do
        ...
        rax_4 = &(*rax_4)[1]
        rcx_1 += 1
        zmm7 = _mm_max_ss(zmm0[0], zmm7[0])
    while (rcx_1 != r11_7)

void* rax_5 = &(*r10)[rax]
float zmm5[0x4] = 0xff7fffff
int64_t rcx_2 = 0
...
if (r11_15 != 0)
    do
        zmm2 = __minss_xmmss_memss(zmm2, *r9)
        rcx_3 += 1
        r9 = &(*r9)[1]
    while (rcx_3 != r11_15)
...
if (*(arg1 + 0x130) != 0 && *(arg1 + 0x138) != 0)
    float (* rcx_6)[0x4] = *(arg1 + 0x168)
    zmm1 = 0xff7fffff
    void* rax_10 = &(*rcx_6)[rax]
    uint64_t r8_8 = (rax_10 - rcx_6 + 3) u>> 2
...
float temp0_10[0x4] = _mm_unpacklo_ps(zmm5, zmm7[0].q)
arg2[1].d = zmm2
*(arg2 + 0xc) = temp0_10.q
*(arg2 + 0x14) = var_54
return arg2
