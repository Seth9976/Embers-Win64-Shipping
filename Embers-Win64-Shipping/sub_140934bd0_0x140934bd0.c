...
if (rdx_9 != r10)
    ...
    label_140934dc3:
        ...
        while (true)
            ...
            if (rdx_13 != 0)
                goto label_140934dc3
        
        var_74_5 = r10

while (true)
    int64_t rcx_13 = sx.q(var_58:0xc.d)
    int64_t rax_21 = var_68.q
    
    if (rcx_13.d == (var_78_1.q u>> 0x20).d && var_58.q == arg3 + 0x10 && rax_21 == arg3)
