...
float var_138 = zmm2
*(arg1 + 0x34)
float var_1f4 = *(arg1 + 0x9c) - zmm2
float zmm1 = zmm2 f+ *(arg1 + 0xa8)
...
if (rax != 0)
    ...
    *(rax_31 + r15_2) |= 1 << ((rax_28.b & 7) - rdx_12.b)
    uint128_t zmm1_2 = *arg3
            ...
            if (not(cond:2_1))
                ...
                if (arg_20 == 0)
                    ...
                    label_141682dff:
                        ...
                        zmm0_2.d = var_178.d f- *arg_10
                        zmm1_4.d = var_174.d f- arg_10[1]
                        int32_t var_d8 = zmm0_2.d
                        zmm0_2.d = var_170.d f- arg_10[2]
                        int32_t var_d4_1 = zmm1_4.d
                        zmm1_4.d = var_188.d f- *arg_10
                        int32_t var_d0_1 = zmm0_2.d
                        zmm0_2.d = var_184.d f- arg_10[1]
                        var_1a0.d = zmm1_4.d
                        zmm1_4.d = var_180.d f- arg_10[2]
                        rax_49 = 0
                    ...
                    if (not(zmm7_1 f>= zmm6_3.d))
                        ...
                        if (r9_5 s> 0)
                            ...
                            do
                                ...
                                if ((*(r8_13 + var_160) u>> rax_69.b & 1) == 0)
                                    int64_t r15_3 = sx.q(r13_2)
                                    *(r8_13 + var_160) |= (1 << (rax_69 u% 0x20)).b
                                    r13_2 = (r15_3 + 1).d
                                    int32_t var_c0_1 = 0
                                    var_1f0 = r13_2
                        ...
                        if (r9_5 s> 0)
                            ...
                            do
                                ...
                                if ((*(r8_14 + var_160) u>> rax_82.b & 1) == 0)
                                    int64_t r14_5 = sx.q(r10_3)
                                    *(r8_14 + var_160) |= (1 << (rax_82 u% 0x20)).b
                                    r10_3 = (r14_5 + 1).d
                                    int32_t var_b4_1 = 0
                                    var_1f0 = r10_3
                        ...
                        if (rdx_39 != r10_1 || rcx_44 != r9_1)
                            ...
                            if ((*(r8_17 + r15_2) u>> rax_92.b & 1) == 0)
                                int64_t rbx_8 = sx.q(r10_3)
                                int64_t rax_93 = var_1e8.q
                                *(r8_17 + r15_2) |= (1 << (rax_92 u% 0x20)).b
                    ...
                    if (data_143ef7710 s> *(0x14
                            + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
                        _Init_thread_header(&data_143ef7710)
                        
                        if (data_143ef7710 == 0xffffffff)
                            __builtin_memcpy(&data_143ef76d0, 
                            ...
                            "00\x00\x00\x01\x00\x00\x00\x01\x00\x00\x00", 
                                0x40)
                            atexit(sub_142ce9b50)
                            _Init_thread_footer(&data_143ef7710)
                    
                    int128_t* i_2 = &data_143ef76d0
                    ...
                    do
                        ...
                        if (rax_40 != 0)
                            ...
                            if ((*(sx.q(rax_41 s>> 3) + var_160) u>> rcx_19.b & 1) == 0)
                                float* rcx_20 = &arg5
                                float zmm3_1 = zmm6_2
                                zmm0_2.d = var_178.d f- *arg_10
                                float zmm1_3 = var_174 f- arg_10[1]
                                int32_t var_f8 = zmm0_2.d
                                zmm0_2.d = var_170.d f- arg_10[2]
                                float var_f4_1 = zmm1_3
                                int32_t var_f0_1 = zmm0_2.d
                                zmm0_2.d = var_184.d f- arg_10[1]
                                float var_120 = var_188 f- *arg_10
                                int64_t rax_45 = 0
                                int32_t var_11c_1 = zmm0_2.d
                                int32_t rdx_20 = 0
                                zmm0_2 = zmm8_2
                                float var_118_1 = var_180 f- arg_10[2]
                                ...
                                while (true)
                                    ...
                                    if (rdx_20 s>= 3)
                                        if (not(zmm3_1 > arg4) && not(zmm0_2.d f< zmm6_2))
                                            ...
                                            r13_2 = (rbx_4 + 1).d
                                            *(rcx_21 + var_160) |= (1 << (rdx_22 u% 0x20)).b
                                            var_1f0 = r13_2
