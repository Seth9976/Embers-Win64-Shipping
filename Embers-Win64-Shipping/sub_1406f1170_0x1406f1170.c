...
if (arg3[0x86].b == 0)
    ...
    if (rax_14 != 0)
        rax_14[1] = arg1
        *rax_14 = &data_142da4db8
        rax_14[3] = sub_140a387b0()
        *rax_14 = &data_142da4e10
    
    rax_11 = &var_18
    
    if (&var_18 == arg4)
        goto label_1406f1352
    ...
    if (rbx_1 == 0)
        if (rax_6 != 0)
            rax_6[1] = arg1
            *rax_6 = &data_142da4d08
            rax_6[3] = sub_140a387b0()
            *rax_6 = &data_142da4d60
    else if (rax_6 != 0)
        rax_6[1] = arg1
        *rax_6 = &data_142da4c58
        rax_6[3] = sub_140a387b0()
        *rax_6 = &data_142da4cb0
    
    rax_11 = &var_18
    
    if (&var_18 == arg4)
        goto label_1406f128c
