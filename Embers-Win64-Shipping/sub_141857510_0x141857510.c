...
int64_t* (* var_88)(int64_t* arg1, int64_t* arg2) = sub_14187b0e0
int64_t* r13 = arg4
void*** var_78 = nullptr
void*** rax_2 = sub_14185e4e0(arg4)
void* r14 = &rax_2[2]
void* var_138 = r14
void*** var_130 = rax_2
...
if (arg2 s>= 0)
    if (arg2 s<= 1)
        ...
        *(rsi_3 + 0x30) = zmm0_1
        int64_t var_c8_1 = 0
        *(rsi_3 + 0x40) = zmm0
        int64_t* (* rax_41)(int64_t* arg1, int64_t* arg2) = var_88
        ...
        if (sub_140a54810() == 0)
            sub_14185e9d0(&var_138, &var_88, arg5, arg6)
        else
            ...
            if (rax_19 == 0)
                ...
                *(rsi_2 + 0x30) = zmm0_3
                *(rsi_2 + 0x40) = zmm0
                int64_t* (* rax_22)(int64_t* arg1, int64_t* arg2) = var_88
        ...
        if (rax_7 == 0)
            ...
            *(rsi_1 + 0x30) = zmm0_2
            *(rsi_1 + 0x40) = zmm0
            int64_t* (* rax_10)(int64_t* arg1, int64_t* arg2) = var_88
