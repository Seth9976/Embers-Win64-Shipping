    ...
    if (var_1b8 != 0)
        ...
        if (var_1b8[1].d == 1)
            ...
            *(var_1b8 + 0xc) -= 1
            ...
            if (rsi_1 == 1)
                (*(*var_1b8 + 8))(var_1b8, zx.q(rsi_1))

void* rbx_2 = *arg1
*(rbx_2 + 0x2d0) = *(arg3 + 0x1a0)
*(rbx_2 + 0x2d4) = *(arg3 + 0x1a4)
sub_140692f90(rbx_2 + 0x2d8, arg3 + 0x1a8)
*(rbx_2 + 0x2e8) = *(arg3 + 0x1b8)
*(rbx_2 + 0x2ec) = *(arg3 + 0x1bc)
sub_140692f90(rbx_2 + 0x2f0, arg3 + 0x1c0)
*(rbx_2 + 0x300) = *(arg3 + 0x1d0)
*(rbx_2 + 0x304) = *(arg3 + 0x1d4)
sub_1407473e0(rbx_2 + 0x308, arg3 + 0x1d8)
*(rbx_2 + 0x328) = *(arg3 + 0x1e8)
*(rbx_2 + 0x329) = *(arg3 + 0x1e9)
sub_1407473e0(rbx_2 + 0x330, arg3 + 0x1f0)
*(rbx_2 + 0x340) = *(arg3 + 0x200)
int64_t* rbx_3 = *arg1
int32_t rax_26

if ((rbx_3[5].b & 0x20) == 0)
    rax_26 = (*(*rbx_3 + 0x220))(rbx_3)

if ((rbx_3[5].b & 0x20) != 0 || rax_26.b != 0)
    rax_26.b = 0x40
