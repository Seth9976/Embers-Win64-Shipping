...
if (rax_2 == 0 || rdi_1 == 0)
    ...
    if (result.b == 0 || rdx_8 == 0)
        ...
        if (sub_140cc1670(&var_48, &data_143e1b820).b == 0 || var_48 == 0)
            ...
            void* rax_11 = sub_141b46500(arg2)
            uint64_t rbp_2 = zx.q(sub_1408e52c0(rax_11))
            void var_38
            int128_t* rax_13 = sub_141b464f0(rax_11, &var_38)
            ...
            int64_t* rbx_10 = rdi_1
            
            if (rdi_1 != 0 && (*(rdi_1[1] + 0x16) & 1) != 0)
                rbx_10 = rdi_1[0xf]
            
            int64_t rbx_11 = rbx_10[1]
            sub_140d11680()
            
            if (rbx_11 != &data_143e1be30)
                result.b = 0
            else
                ...
                if (*(rdi_1 + 0x3c) != 4 || rbp_2.d s>= rdi_1[7].d)
                    ...
                    int64_t rbx_12 = sx.q((rbp_2 << 2).d)
                    result = arg1 + sx.q(*(rdi_1 + 0x4c))
                    rbx_8 = rbx_12 + result
                    
                    if (rbx_12 == neg.q(result))
                        result.b = 0
                    else
