...
while (true)
    ...
    *arg1 = 0
    ...
    if (rdi_1 u<= r8_4 && r8_4.d - rdi_1.d u>= 5)
        rcx_3 = arg1[6]
        arg1[6] = rcx_3 - 1
    
    char r10
    
    if (rdi_1 u> r8_4 || r8_4.d - rdi_1.d u< 5 || rcx_3 s<= 0)
        r10 = 0
    else
        r10 = 1
    ...
    if (r10 != 0 && *rdi_1 == 2)
        ...
        if (arg1[8] != 0)
            ...
            if (sub_142bf7510(arg1, rdi_1, 5) == 0 || *rdi_1 != 2)
                rax_8 = 0
            else
                rax_8 = 1
    ...
    int64_t rax_7 = sub_142c09bf0(arg2, nullptr)
    *(arg1 + 8) = rax_7
    *(arg1 + 0x10) = zx.q(arg2[6]) + rax_7
