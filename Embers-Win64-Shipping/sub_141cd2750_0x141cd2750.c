...
sub_141cd5910(arg1, &var_98, arg3)
int32_t var_70
int32_t r11 = var_70
int64_t var_88
...
while (true)
    ...
    int64_t rcx_5 = var_108.q
    
    if (rax_16.d == r11 && var_f8.q == &var_88 && rcx_5 == &var_98)
        int32_t var_50_1 = 0
    ...
    sub_14099cb60(arg2, *rsi_3, 0, &var_dc, 0)
    int64_t rbx_1 = *rsi_3
    void* const rcx_10
    ...
    *(r15_1 + 0x10) = rsi_3[3].d
    ...
    if (r15_1 + 0x18 != &rsi_3[4])
        ...
        sub_141ccfd60(r15_1 + 0x18, rsi_3[4], rsi_3[5].d, *(r15_1 + 0x24), 0)
