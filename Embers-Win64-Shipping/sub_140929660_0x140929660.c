...
if ((r12.b & sub_140b5b8a0(rbx, 0x122)) == 0)
    if ((r12.b & sub_140b5b8a0(rbx, 0x121)) != 0)
        ...
        if (rbp != 0)
            ...
            if (rcx_4 != 0)
                char rax_7
                int64_t r8_1
                rax_7, r8_1 = (*(*rcx_4 + 0x90))(rcx_4)
                
                if (rax_7 != 0)
                    int64_t* rcx_5 = *(rbp + 8)
                    r8_1.b = 1
                    int64_t var_38
                    int64_t* rax_9 = (*(*rcx_5 + 0x78))(rcx_5, &var_38, r8_1)
                    int16_t* const r8_2
    ...
    rsi = zx.q(sub_140928980(&var_48, arg3, sub_14093f8f0(rax_1 + 0x28)))
