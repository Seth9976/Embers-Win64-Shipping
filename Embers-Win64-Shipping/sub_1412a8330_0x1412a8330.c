...
if (data_143e8e7b0 s> *rdi_1)
    _Init_thread_header(&data_143e8e7b0)
    
    if (data_143e8e7b0 == 0xffffffff)
        ...
        data_143e8e7a8 = rax_9
        _Init_thread_footer(&data_143e8e7b0)

if (data_143e8e7c0 s> *rdi_1)
    _Init_thread_header(&data_143e8e7c0)
    
    if (data_143e8e7c0 == 0xffffffff)
        ...
        data_143e8e7b8 = rax_12
        _Init_thread_footer(&data_143e8e7c0)

if (data_143e8e7d0 s> *rdi_1)
    _Init_thread_header(&data_143e8e7d0)
    
    if (data_143e8e7d0 == 0xffffffff)
        ...
        data_143e8e7c8 = rax_15
        _Init_thread_footer(&data_143e8e7d0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8e7a8
int64_t rcx
...
label_1412a8433:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412a842e
        
        rbx.b = 1
        goto label_1412a8433
