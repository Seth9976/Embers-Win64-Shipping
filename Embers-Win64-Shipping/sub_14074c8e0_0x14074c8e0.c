...
while (true)
    ...
    if (rax_20.d == (var_70:8.q u>> 0x20).d && var_40.q == r14 && rdx_10 == r15)
        return sub_140754590(r15, 0) __tailcall
    
    int64_t rcx_7 = rax_20 * 9
    int64_t rax_21 = *rdx_10
    int64_t* i = *(rax_21 + (rcx_7 << 3) + 8)
    void* r15_1 = rax_21 + (rcx_7 << 3)
    ...
    if (rsi_2 != 0)
        do
            ...
            if (rcx_9 != 0)
                int64_t rax_26 = *rcx_9
                *(rcx_9 + 0x554) = 0
                (*(rax_26 + 0x3a0))(rcx_9, 0)
    ...
    if (rsi_4 != 0)
        do
            ...
            if (rcx_10 != 0)
                int64_t rax_29 = *rcx_10
                *(rcx_10 + 0x554) = 0
                (*(rax_29 + 0x3a0))(rcx_10, 0)
