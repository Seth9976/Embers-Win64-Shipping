...
if (data_143e6e178 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e6e178)
    
    if (data_143e6e178 == 0xffffffff)
        int64_t (* i)(int64_t arg1, int64_t* arg2) = sub_1411b1190
        ...
        sub_1419c2220(&data_143e6e0e0, 0, FShaderDrawDebugParameters", FShaderDrawDebugParameters", 
            0, nullptr)
        ...
        atexit(sub_142cd50b0)
        _Init_thread_footer(&data_143e6e178)

int64_t rbx_1 = sx.q(arg2[1].d)
wchar16 const* const var_40 = u"ShaderDrawParameters"
wchar16 const* const var_38 = u"ShaderDrawDebug::FShaderDrawDebugParameters"
int32_t var_30 = 0
