...
*r8_2 |= 1 << (rdi.b & 0x1f)
int128_t* rsi_1 = sx.q(rdi.d) * 0x38 + *arg1
int64_t* r15 = arg3[1]
*rsi_1 = **arg3
int64_t* rcx_7 = *r15
rsi_1[1].q = rcx_7
...
*(rsi_1 + 0x28) = r15[3].b
*(rsi_1 + 0x29) = *(r15 + 0x19)
rsi_1[3].d = 0xffffffff
uint32_t rcx_9 = (*rsi_1 u>> 4).d
...
sub_140fe5620(arg1, arg2, (r8_8 - rdx_12 - rcx_15) ^ rdx_12 u>> 0xf, rsi_1, rdi.d, arg4)
return arg2
