...
if (data_143e8a910 s> *rdi_1)
    _Init_thread_header(&data_143e8a910)
    
    if (data_143e8a910 == 0xffffffff)
        ...
        data_143e8a908 = rax_9
        _Init_thread_footer(&data_143e8a910)

if (data_143e8a920 s> *rdi_1)
    _Init_thread_header(&data_143e8a920)
    
    if (data_143e8a920 == 0xffffffff)
        ...
        data_143e8a918 = rax_12
        _Init_thread_footer(&data_143e8a920)

if (data_143e8a930 s> *rdi_1)
    _Init_thread_header(&data_143e8a930)
    
    if (data_143e8a930 == 0xffffffff)
        ...
        data_143e8a928 = rax_15
        _Init_thread_footer(&data_143e8a930)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8a908
int64_t rcx
...
label_1412a2b43:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412a2b3e
        
        rbx.b = 1
        goto label_1412a2b43
