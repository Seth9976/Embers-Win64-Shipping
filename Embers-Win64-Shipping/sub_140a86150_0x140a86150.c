...
while (true)
    int64_t rcx_4 = sx.q(r15_1) * 5
    int64_t rax_14 = *rbx
    int64_t rbx_1 = *(rax_14 + (rcx_4 << 2))
    void* rdi_1 = rax_14 + (rcx_4 << 2)
    int32_t rax_15 = sub_140b5ead0(rbx_1.d)
    int32_t rcx_8 = (*r14 - 1) & (rax_15 + (rbx_1 u>> 0x20).d)
    void* rax_17 = &arg1[7]
    *(rdi_1 + 0x10) = rcx_8
    void* rdx_7 = arg1[8]
    ...
    *(rdi_1 + 0xc) = *(rax_17 + (((sx.q(*r14) - 1) & r8_7) << 2))
    void* rax_19 = &arg1[7]
    void* rcx_12 = arg1[8]
