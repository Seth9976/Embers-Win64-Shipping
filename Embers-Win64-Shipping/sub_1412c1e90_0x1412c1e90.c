...
if (data_143e8b030 s> *rdi_1)
    _Init_thread_header(&data_143e8b030)
    
    if (data_143e8b030 == 0xffffffff)
        ...
        data_143e8b028 = rax_9
        _Init_thread_footer(&data_143e8b030)

if (data_143e8b040 s> *rdi_1)
    _Init_thread_header(&data_143e8b040)
    
    if (data_143e8b040 == 0xffffffff)
        ...
        data_143e8b038 = rax_12
        _Init_thread_footer(&data_143e8b040)

if (data_143e8b050 s> *rdi_1)
    _Init_thread_header(&data_143e8b050)
    
    if (data_143e8b050 == 0xffffffff)
        ...
        data_143e8b048 = rax_15
        _Init_thread_footer(&data_143e8b050)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b028
int64_t rcx
...
label_1412c1f93:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412c1f8e
        
        rbx.b = 1
        goto label_1412c1f93
