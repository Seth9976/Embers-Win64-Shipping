...
if (data_143e2cb40 s> *rsi_1)
    _Init_thread_header(&data_143e2cb40)
    
    if (data_143e2cb40 == 0xffffffff)
        ...
        data_143e2cb38 = rax_6
        _Init_thread_footer(&data_143e2cb40)

uint32_t rax_2

if (data_143e2cb50 s> *rsi_1)
    int64_t r8_2
    rax_2, r8_2 = _Init_thread_header(&data_143e2cb50)
    
    if (data_143e2cb50 == 0xffffffff)
        ...
        data_143e2cb48 = rax_9
        _Init_thread_footer(&data_143e2cb50)

int64_t rbp = data_143e2cb48
uint16_t rsi_2
...
label_1410ba760:
    ...
    if (sub_1405fba70(*arg1, 3) != 0 && sub_1410bea20(arg1) != 0)
        return 1
else
    char rax_3
