...
if ((*(arg3 + 0x20) & 6) == 0 && (*(arg3 + 0x168) & 2) == 0)
    void* i = arg3
    
    do
        if (sub_1410363e0(arg2) == 0)
            arg4 = sub_14105bf30(rbx, *(i + 0x80), *(i + 0xc0) + *(arg3 + 0x160), *(arg3 + 0x108), 
                *(arg3 + 0x148), *(arg3 + 0x164))
        else if (data_1439c7a34 != 1)
            int64_t var_98
            sub_14103f450(&var_98, *(arg3 + 0xf8))
            int512_t zmm0 = sub_141059540(var_98, &var_98, arg3 + 0xf8, arg4)
            ...
            *rax_7 = r14_3
            *(arg2 + 8) = &r14_3[1]
            int32_t rdi_1 = *(arg3 + 0x164)
            int32_t rsi_2 = *(arg3 + 0x160)
            r14_3[1] = 0
            ...
            *rax_3 = rbx_3
            *(arg2 + 8) = &rbx_3[1]
            int32_t rsi_1 = *(arg3 + 0x164)
            int32_t rbp_1 = *(arg3 + 0x160)
            rbx_3[1] = 0
            *rbx_3 = &data_142efec68
            ...
            rbx_3[0xf] = i + 0x70
            *(rbx_3 + 0x84) = rbp_1
            arg4 = sub_14105b290(&rbx_3[2], arg3 + 0xf8, arg4)
            rbx = arg1
        
        i = *(i + 0xe0)
    while (i != 0)

sub_141044ca0(arg3 + 0xf8, arg4)
*(arg3 + 0x168) &= 0xfffffffc
*(arg3 + 0x160) = 0
return 0
