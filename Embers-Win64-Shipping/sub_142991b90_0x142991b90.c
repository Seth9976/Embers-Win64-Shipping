...
int64_t var_48 = -2
int64_t r9 = *arg1
int64_t rsi_2 = (arg2 - r9) s>> 2
int64_t rax_2 = (arg1[1] - r9) s>> 2

if (rax_2 == 0x3fffffffffffffff)
    sub_1427c7670()
    noreturn

int64_t rcx_2 = (arg1[2] - r9) s>> 2
...
if (rax_4 u<= 0x3fffffffffffffff)
    if (rdx_2 u>= 0x1000)
        goto label_142991c45
