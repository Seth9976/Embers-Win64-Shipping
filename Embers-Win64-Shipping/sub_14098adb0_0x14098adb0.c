...
if (arg3 == 0 || rax_2 == 0)
    void*** rax_15 =
        sub_14098b830(ConvertToJPEG only supports UAppleImageInterface derived textures")
    *arg2 = &rax_15[2]
    arg2[1] = rax_15
    ...
    if ((*(rdx_1 + 0x10))(rax_2, rdx_1) - 1 u<= 2)
        void*** rax_12 = sub_14098b830(u"ConvertToJPEG requires iOS 10.0+ or macOS 10.12+")
        *arg2 = &rax_12[2]
        arg2[1] = rax_12
        ...
        if (rax_12 != 0)
            rax_12[1].d += 1
            rdi_3 = rax_12
            goto label_14098affe
    else
        int64_t rdx_2 = *rax_2
        int64_t var_18
        sub_140a2e390(&var_18, ConvertToJPEG texture type (%d) was not supported", 
