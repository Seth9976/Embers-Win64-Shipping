...
if (data_143e8bca8 s> *rdi_1)
    _Init_thread_header(&data_143e8bca8)
    
    if (data_143e8bca8 == 0xffffffff)
        ...
        data_143e8bca0 = rax_9
        _Init_thread_footer(&data_143e8bca8)

if (data_143e8bcc8 s> *rdi_1)
    _Init_thread_header(&data_143e8bcc8)
    
    if (data_143e8bcc8 == 0xffffffff)
        ...
        data_143e8bcc0 = rax_12
        _Init_thread_footer(&data_143e8bcc8)

if (data_143e8bce8 s> *rdi_1)
    _Init_thread_header(&data_143e8bce8)
    
    if (data_143e8bce8 == 0xffffffff)
        ...
        data_143e8bce0 = rax_15
        _Init_thread_footer(&data_143e8bce8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8bca0
int64_t rcx
...
label_1412b6043:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412b603e
        
        rbx.b = 1
        goto label_1412b6043
