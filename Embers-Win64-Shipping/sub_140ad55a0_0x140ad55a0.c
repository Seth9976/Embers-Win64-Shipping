...
label_140ad5713:
    ...
    int32_t rax_8 = *(r8 + (((sx.q(*(arg1 + 0x98)) - 1) & sx.q(rax_6)) << 2))
    ...
    label_140ad5713_1:
        ...
        while (true)
            r8_3 = (sx.q(rax_8) << 7) + *(arg1 + 0x50)
            
            if (((r8_3[1] ^ var_160:4.d) | (r8_3[2] ^ var_160:8.d) | (r8_3[3] ^ var_160:0xc.d)
                    | (*r8_3 ^ var_160.d)) == 0 && ((r8_3[5] ^ zmm0:4.d) | (r8_3[6] ^ zmm0:8.d)
                    | (r8_3[7] ^ zmm0:0xc.d) | (zmm0.d ^ r8_3[4])) == 0 && ((r8_3[0xb] ^ var_138:4.d)
                    | (r8_3[0xa] ^ var_138.d) | (r8_3[9] ^ var_140:4.d) | (var_140.d ^ r8_3[8])) == 0)
                break
            
            rax_8 = r8_3[0x1c]
            
            if (rax_8 == 0xffffffff)
                goto label_140ad5713_2
    ...
    *(rcx_47 + 0x18) = rbx_11
    ...
    var_168 = sub_140aac8f0(&var_f0, 
        sub_140a96390(&var_c0, 
            _vfprintf_p_l(&var_d8, Post-unary operator {0} cannot operate on {1}", 
