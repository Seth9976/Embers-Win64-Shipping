...
*arg1 = &data_143059158
arg1[0x1c] = &data_142d9acb8
__builtin_memset(&arg1[0x1d], 0, 0x15)
...
*(arg1 + 0xc9) = 0x101
arg1[0x19].b = 1
void*** rax_2 = sub_141af30e0(&arg1[0x1c])
...
if (&arg1[0x1a] != &var_18)
    ...
    if (rax_2 == rsi_1)
        goto label_141afaeb3
    
    arg1[0x1b] = rax_2
    
    if (rsi_1 == 0)
        goto label_141afaeda
