...
if (data_143e2cf90 s> *rdi_1)
    _Init_thread_header(&data_143e2cf90)
    
    if (data_143e2cf90 == 0xffffffff)
        ...
        data_143e2cf88 = rax_8
        _Init_thread_footer(&data_143e2cf90)

if (data_143e2cfa0 s> *rdi_1)
    _Init_thread_header(&data_143e2cfa0)
    
    if (data_143e2cfa0 == 0xffffffff)
        ...
        data_143e2cf98 = rax_11
        _Init_thread_footer(&data_143e2cfa0)

int64_t rdi_2 = data_143e2cf98
int64_t rcx
