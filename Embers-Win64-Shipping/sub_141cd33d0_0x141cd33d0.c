...
if (rax_6 != 0)
    ...
    if ((arg1[5].b & 1) != 0)
        ...
        do
            ...
            if (rdx_7 == neg.q(*arg2))
                ...
                *rdx_8 = data_143a1c6b0
                rdx_8[1] = data_143a1c6b0
                rdx_8[2] = data_143a1c6b0
                rdx_8[3] = data_143a1c6b0
                *rdx_8 = data_143a1c6b8
                rdx_8[1] = data_143a1c6b8
                rdx_8[2] = data_143a1c6b8
            
            arg3 = sub_141cd3270(arg1, rdx_8, arg3)
            r14 += 1
        while (r14 s< arg_8)
    ...
    if (rax_6 s> 0)
        do
            arg3 = sub_141cd3270(arg1, (sx.q(i) << 4) + *arg2, arg3)
            i += 1
        while (i s< arg2[1].d)
