...
rax_2, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13 =
    sub_1416b74c0(r12, arg2, arg3, arg4, &var_278)
int32_t rsi_1
        ...
        while (true)
            if (rdx_5 s< 0x80)
                ...
                label_14158d050:
                    ...
                    float var_1a8
                    zmm10, zmm11 = sub_141758e70(arg4[1], &var_1a8, &var_240, zx.o(0))
                    ...
                    if (not(zmm13[0] < zmm12[0]))
                        ...
                        *(rcx_22 + (rdx_15 << 2) + 8) = var_1e0_1
                        ...
                        if (r13_3.d s>= 3)
                            ...
                            if (rax_46.b == 0)
                                goto label_14158d050
            
            rdi_1 = var_290
            goto label_14158d0cf
