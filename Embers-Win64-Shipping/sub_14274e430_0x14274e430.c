...
int32_t r8_1 = 0
*(arg1 + 0x10) = &rax[2]
int128_t* rbx_2 = zx.q(rbx * rdi) + *(arg1 + 0x70)
int32_t rcx = *r10
...
if (result s> 0)
    ...
    do
        ...
        int32_t r8_3 = _mm_bsrli_si128(zmm2, 4).d
        uint128_t temp0_2 = _mm_bsrli_si128(zmm4, 4)
        r11_3 = &r11_3[1]
        int32_t rax_4 = _mm_bsrli_si128(zmm2, 0xc)[0]
        int32_t rdx_3 = _mm_bsrli_si128(zmm2, 8).d
        char rcx_5 = _mm_bsrli_si128(zmm4, 8).b
        result = rax_4 << _mm_bsrli_si128(zmm4, 0xc).b
        *r10_1 = _mm_unpacklo_epi32(_mm_unpacklo_epi32(zx.o(r9_1 << zmm4.b), zx.q(rdx_3 << rcx_5)), 
            _mm_unpacklo_epi32(zx.o(r8_3 << temp0_2.b), zx.q(result))[0].q)
        i = rdi_1
        rdi_1 -= 1
    while (i != 1)
