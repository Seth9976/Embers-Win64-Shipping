...
if (arg2[1].d != 0)
    int512_t zmm3
    zmm3.o = arg5
    int32_t var_98_1 = (arg1 + 0x28).d
    sub_141549b50(*(arg1 + 0x10), arg2, zx.q(arg4))
    var_98_1.b = arg3
    uint64_t var_78
    int32_t arg_8
    sub_14154ac80(&var_78, *(arg1 + 0x10), arg2, arg1 + 0x28, var_98_1.b, &arg_8)
    ...
    *(arg1 + 0x98) = rax
    ...
    int32_t rbx_5 = arg_8
    int64_t* rcx_7 = rbx_4 * 0x38 + *(arg1 + 0x90)
    *rcx_7 = var_78
    int32_t var_70
    rcx_7[1].d = var_70
    uint64_t var_6c
    ...
    *(rcx_7 + 0x14) = var_64
    ...
    if (arg2[1].d s<= 5)
        ...
        *(result + 0xc) = r14_1
        ...
        int32_t* var_90_1
        var_90_1.d = 1
        int32_t rax_4 = sub_14173c830(arg1, &var_78, &var_6c, arg2, rbx_5)
        int32_t i_1 = 2
