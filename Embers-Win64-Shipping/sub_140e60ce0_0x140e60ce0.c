...
label_140e60dc8:
    ...
    if (r8_2 s> 0 && (rax_8 == 0 || rax_8 s< rbp))
        ...
        arg4[0x14] = *(rax_12 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2))
        void* rax_14 = *(r9_2 + 8)
    ...
    if (rbx_1 == 0xffffffff)
        ...
        sub_140e539c0(rdi_1 + 8)
        memmove(rdi_1, arg4, 0x50)
        sub_140869170(arg1, arg5, 1)
        rdi_2 = rbx_1
    
    if (rbx_1 == 0xffffffff)
        goto label_140e60dc8
