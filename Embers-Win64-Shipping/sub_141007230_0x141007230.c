...
if (r8.d u> 0x10)
    goto label_14100737f

int16_t r15_1 = *(arg3 + 6)
var_1a8.d = r8.d

if (r8.d != 0)
    void* rcx = &var_1a8:4
    uint64_t i_3 = zx.q(r8.d)
    void* rax_2 = arg3 + 0x190
    uint64_t i
...
label_14100737f:
    ...
    *(arg3 + 6) &= 0xffff << r8.b
    ...
    if (rax_7 != var_1a8.d)
        goto label_141007375
    
    if (memcmp(&rdi_4[8], &var_1a8:4, zx.q(rax_7) * 2) != 0 || rdi_4 == -0x28)
        goto label_141007375
    
    rdi_6 = *(rdi_4 + 0x28)
    *(arg3 + 6) = r15_1 & 0xffff << r8.b

int64_t* rcx_18 = *(*(arg1[3] + 0x1c8) + 0x30)
int64_t result = (*(*rcx_18 + 0x100))(rcx_18, zx.q(*(arg2 + 0x13)), rdi_6)
*(arg3 + 6) |= 0xffff << arg4.b
