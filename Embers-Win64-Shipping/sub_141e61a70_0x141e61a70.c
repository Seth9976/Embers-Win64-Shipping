...
if (result != 0)
    int32_t rcx_2 = 0
    void* r14_2 = *result + 0x88
    int32_t var_98_1 = 0
    int32_t r10_1 = *(r14_2 + 0x28)
    int32_t var_94_1 = 1
    void* var_90_1 = r14_2 + 0x10
    int32_t var_88_1 = 0xffffffff
    int32_t var_84_1 = 0
    int32_t var_80_1 = 0
    
    if (r10_1 != 0)
        void* rax_5 = *(r14_2 + 0x20)
        void* r8_2 = r14_2 + 0x10
        ...
        label_141e61ba7:
            ...
            int32_t var_84_2 = rcx_2 - rax_13 + 0x1f
    ...
    int32_t var_84_4 = rdx_11
    int128_t var_78 = r14_2.o
    int96_t var_68_1 = var_48_1:8.12
    
    if (rdx_11 != r10_1)
        void* rax_15 = *(r14_2 + 0x20)
        void* r10_2 = r14_2 + 0x10
    ...
    while (true)
        ...
        void** rdx_16 = var_78.q
        
        if (result.d == (var_88_3.q u>> 0x20).d && var_68_1.q == r14_2 + 0x10 && rdx_16 == r14_2)
            break
        
        int64_t* rdx_19 = *rdx_16 + 0x20 + result * 0x90
        
        if (*rdx_19 != 0)
            sub_141c8ef70(arg3, rdx_19)
