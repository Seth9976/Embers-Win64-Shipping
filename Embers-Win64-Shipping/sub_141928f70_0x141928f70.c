...
*rcx_1 = 0
int32_t rcx_2 = 1
int32_t rdx_2 = (arg1[0x1d].d & 0xfffffffe) | zx.d(arg12)
int32_t rax_13 = arg1[0xd].d
arg1[0x1d].d = rdx_2
...
int32_t rax_17 = r14_1.d + rdi_2
arg1[0x18].d = rax_17

if (rax_17 s> *(arg1 + 0xc4))
