...
if (data_143e8c920 s> *rdi_1)
    _Init_thread_header(&data_143e8c920)
    
    if (data_143e8c920 == 0xffffffff)
        ...
        data_143e8c918 = rax_9
        _Init_thread_footer(&data_143e8c920)

if (data_143e8c940 s> *rdi_1)
    _Init_thread_header(&data_143e8c940)
    
    if (data_143e8c940 == 0xffffffff)
        ...
        data_143e8c938 = rax_12
        _Init_thread_footer(&data_143e8c940)

if (data_143e8c960 s> *rdi_1)
    _Init_thread_header(&data_143e8c960)
    
    if (data_143e8c960 == 0xffffffff)
        ...
        data_143e8c958 = rax_15
        _Init_thread_footer(&data_143e8c960)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c918
int64_t rcx
...
label_1412b40d3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412b40ce
        
        rbx.b = 1
        goto label_1412b40d3
