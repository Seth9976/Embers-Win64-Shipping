...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        ...
        (*(*arg1 + 0x140))(arg1, rbx_3 + 8)
        sub_141d18f80(arg1, rbx_3 + 0x10, zmm1_1)
        int32_t var_4c
...
do
    ...
    *r8_7 |= 1 << (rdi_1.b & 0x1f)
    void* r14_3 = sx.q(rdi_1.d) * 0x30 + *arg2
    __builtin_memset(r14_3, 0, 0x11)
    int512_t zmm1 = sub_140b58170(r14_3 + 0x14, &data_1437020ab, 1)
    *(r14_3 + 0x1c) = 1
    *(r14_3 + 0x20) = 0
    *(r14_3 + 0x28) = 0xffffffff
    (*(*arg1 + 0x140))(arg1, r14_3)
    (*(*arg1 + 0x140))(arg1, r14_3 + 8)
    sub_141d18f80(arg1, r14_3 + 0x10, zmm1)
    r12 += 1
while (r12 s< arg_8)
