...
while (true)
    ...
    var_258 = zmm3[0]
    zmm11 = sub_141758e70(rcx, &var_250, &var_260, zmm11)
    zmm3 = var_250
    ...
    *(&var_1a8:4 + (sx.q(i_6) << 2)) = i_6
    ...
    i_6 = r13.d + 1
    float temp0_31[0x4] = _mm_unpacklo_ps(zmm7, zmm5[0].q)
    ...
    *(&var_118 + (rcx_2 << 2)) = (_mm_unpacklo_ps(zmm7, zmm5[0].q)).q
    ...
    if (i_6 == 1)
        ...
        uint64_t* rax_13
        rax_13, zmm11, zmm14, zmm15 = sub_1416fa750(&var_280, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_13)
        rax_11 = rax_13[1].d
    else if (i_6 == 4)
        ...
        uint64_t* rax_12
        rax_12, zmm11, zmm14, zmm15 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
        i_6 = var_1a8.d
        zmm0 = zx.o(*rax_12)
        rax_11 = rax_12[1].d
    else
...
if (zmm15[0] <= zmm9[0])
    ...
    float zmm9_1
    float zmm11_1[0x4]
    rax_26, zmm9_1, zmm11_1 = sub_141579dd0(&var_280, &var_290, &var_220, &var_218, &var_2b8, 
        &var_2b0, &var_250, &var_260)
    float zmm2_1[0x4]
    float zmm3_1[0x4]
    ...
    if (rax_26 == 2)
        ...
        *arg4 = zmm0_2[0]
        ...
        zmm2_1[0] = zmm2_1[0] f* arg7[1]
        zmm2_1[0] = zmm2_1[0] f* arg7[2]
        zmm2_1[0] = zmm2_1[0] f+ var_250
        zmm2_1[0] = zmm2_1[0] f+ var_24c
        zmm2_1[0] = zmm2_1[0] f+ var_248
        *arg5 = (_mm_unpacklo_ps(zmm2_1, zmm2_1[0].q)).q
