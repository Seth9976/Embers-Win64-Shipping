...
if (data_143e8ba18 s> *rdi_1)
    _Init_thread_header(&data_143e8ba18)
    
    if (data_143e8ba18 == 0xffffffff)
        ...
        data_143e8ba10 = rax_9
        _Init_thread_footer(&data_143e8ba18)

if (data_143e8ba38 s> *rdi_1)
    _Init_thread_header(&data_143e8ba38)
    
    if (data_143e8ba38 == 0xffffffff)
        ...
        data_143e8ba30 = rax_12
        _Init_thread_footer(&data_143e8ba38)

if (data_143e8ba58 s> *rdi_1)
    _Init_thread_header(&data_143e8ba58)
    
    if (data_143e8ba58 == 0xffffffff)
        ...
        data_143e8ba50 = rax_15
        _Init_thread_footer(&data_143e8ba58)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ba10
int64_t rcx
...
label_1412bdb53:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412bdb4e
        
        rbx.b = 1
        goto label_1412bdb53
