...
*rdx_8 |= 1 << (rbp.b & 0x1f)
int32_t* r11_1 = sx.q(rbp.d) * 0x88 + *arg1
sub_1409925c0(&arg_8, r11_1)
r11_1[0x20] = 0xffffffff
sub_1409b8010(arg1, &arg_8, arg2, r11_1, rbp.d, nullptr)
return *arg1 + sx.q(arg_8.d) * 0x88 + 4
