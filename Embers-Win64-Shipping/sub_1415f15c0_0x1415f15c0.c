...
while (true)
    ...
    if (zmm14[0] > -0f)
        ...
        zmm2[0] = zmm2[0] f+ *(rax_7 + 0x10)
        zmm2[0] = zmm2[0] * zmm5[0]
        zmm2[0] = zmm2[0] f+ *(rax_7 + 0x14)
        zmm2[0] = zmm2[0] f+ *(rax_7 + 0x18)
        var_280 = zmm2[0]
        var_27c = zmm2[0]
        var_278 = zmm2[0]
    ...
    if (zmm12[0] < zmm11[0])
        ...
        zmm2 = *(rax_12 + 0x28)
        rcx_4 = 0x40
        zmm2[0] = zmm2[0] f* *(rax_12 + 0x20)
        zmm2[0] = zmm2[0] * zmm5[0]
        zmm2[0] = zmm2[0] f+ *(rax_12 + 0x14)
        zmm2[0] = zmm2[0] * zmm4[0]
        zmm2[0] = zmm2[0] f+ *(rax_12 + 0x10)
        zmm2[0] = zmm2[0] f+ *(rax_12 + 0x18)
        var_26c = zmm2[0]
        rax_13 = &var_270
        var_270 = zmm2[0]
        var_268 = zmm2[0]
    
    int32_t rdx_2 = rdx_1 | rcx_4
    r13 = rdx_2 & 0xffffff7f
    int64_t var_240_1 = *rax_13
    ...
    zmm4 = *arg3
    float temp0_8[0x4] = _mm_unpacklo_ps(var_240_1.d, rax_13[2][0].q)
    float temp0_9[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xc9)
    float temp0_10[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xd2)
    float temp0_12[0x4] = _mm_unpacklo_ps(temp0_8, _mm_unpacklo_ps(var_240_1:4.d, zmm11[0].q)[0].q)
    ...
    *(&var_118 + (rcx_5 << 2)) = (_mm_unpacklo_ps(zmm3, zmm2[0].q)).q
    ...
    if (rdx_3.d == 0)
        int64_t rax_26 = sx.q(var_1a8:4.d)
        int64_t rcx_13 = rax_26 * 3
        var_188[rax_26] = 0x3f800000
        ...
        if (rdx_3.d == 1)
            rax_23 = sub_1416e69d0(&var_2b0, &var_118, &var_1a8:4, &var_1a8, &var_188)
        label_1415f1b82:
            zmm0 = zx.o(*rax_23)
            var_2b8_1 = rax_23[1].d
            i_7 = var_1a8.d
        else
            if (rdx_3.d == 2)
                rax_23, zmm11, zmm15 = sub_1416fa750(&var_290, &var_118, &var_1a8, &var_188)
                goto label_1415f1b82
            
            if (rdx_3.d == 3)
                uint64_t var_1b8[0x2]
                rax_23, zmm11, zmm15 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
                goto label_1415f1b82
    ...
    int32_t var_ec_1 = rax_27
    int32_t rax_28 = (&var_170)[rdi]
    ...
    int32_t var_14c_1 = rax_28
    int32_t rax_29 = (&var_140)[rdi]
...
if (zmm1[0] <= zmm9[0])
    ...
    if (i_6 s> 0)
        ...
        do
            ...
            int32_t rax_34 = *(&var_170 + rbx)
            *(rcx_20 + (rdx_13 << 2)) = *(&var_178 + rbx)
            *(rcx_20 + (rdx_13 << 2) + 8) = rax_34
            int64_t rsi_3 = sx.q(var_2a8_1.d)
            int32_t rax_35 = (rsi_3 + 1).d
            var_2a8_1.d = rax_35
            ...
            int32_t rax_36 = *(&var_140 + rbx)
            rbx += 0xc
            *(rcx_22 + (rdx_15 << 2)) = zmm0_1
            *(rcx_22 + (rdx_15 << 2) + 8) = rax_36
            i = i_5
            i_5 -= 1
        while (i != 1)
    ...
    float zmm11_1[0x4]
    float zmm15_1[0x4]
    rax_37, zmm9_1, zmm11_1, zmm15_1 = sub_1415b03d0(&var_290, &var_2b0, &var_230, &var_228, 
    ...
    if (rax_37 == 2)
        ...
        *arg4 = zmm0_2[0]
        ...
        zmm15_1[0] = zmm15_1[0] f* arg7[1]
        zmm15_1[0] = zmm15_1[0] f* arg7[2]
        zmm15_1[0] = zmm15_1[0] + var_270
        zmm15_1[0] = zmm15_1[0] + var_26c
        zmm15_1[0] = zmm15_1[0] + var_268
        *arg5 = (_mm_unpacklo_ps(zmm15_1, zmm15_1[0].q)).q
        arg5[1].d = zmm15_1[0]
        zmm8[0] = zmm8[0] f* *arg7
        zmm8[0] = zmm8[0] f* arg7[1]
    ...
    *arg7 = temp0_36.q
    ...
    float temp0_37[0x4] = __sqrtss_xmmss_memss(temp0_36[0], var_2c4)
    float var_2c8_2 = temp0_35[0]
    zmm2[0] = zmm2[0] - temp0_37[0]
    arg7[2] = var_2c8_2
    *arg4 = zmm2[0]
