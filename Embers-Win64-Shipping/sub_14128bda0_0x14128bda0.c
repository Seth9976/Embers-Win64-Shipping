...
if (data_143e8bdf8 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8bdf8)
    
    if (data_143e8bdf8 == 0xffffffff)
        ...
        data_143e8bdf0 = rax_4
        _Init_thread_footer(&data_143e8bdf8)

if (data_143e8bdf0 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()

sub_1410b3fe0(arg2, u"MAX_NUM_LIGHTMAP_COEF", 2)
sub_1412723f0(arg1, arg2)
