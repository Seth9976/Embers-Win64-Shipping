...
label_140e61870:
    ...
    if (r8_6 u>= 4)
        ...
        r15 = 1 << ((not.d(rcx_9 << 0x1a s>> 0x1f)).b & (0x20 - r9_2))
    ...
    if (r8_6 s> 0 && (rax_16 == 0 || rax_16 s< r15))
        ...
        *(arg4 + 0x3c) = rax_19
        ...
        arg4[7].d = *(rax_20 + (((sx.q(arg1[9].d) - 1) & r8_7) << 2))
        void* rax_22 = *(r9_3 + 8)
    ...
    label_140e6177b:
        ...
        while (true)
            ...
            if (*rcx_3 == *arg4 && rcx_3[1] == arg4[1] && rcx_3[2].b == arg4[2].b)
                break
            
            rbx_1 = rcx_3[7].d
            
            if (rbx_1 == 0xffffffff)
                goto label_140e6177b
