...
*(&arg1[7] + (r12 << 2) + 8) = 0x3f800000
*(arg1 + 0x244) = __minss_xmmss_memss((*(arg1 + 0x244))[0], 0x3f800000)[0]
uint64_t result
...
label_14261b4c3:
    ...
    label_14261b5ce:
        ...
        while (true)
            if (*(r9_1 - 0x4c) == r12.b)
                ...
                float zmm1 = *(r9_1 - 0x6c) f- *arg2
                float zmm0[0x4] = *(r9_1 - 0x64)
                ...
                if (not(arg3.d f> zmm7.d))
                    ...
                    if (not(_mm_and_ps(zmm0, 0x7fffffff)[0] >= 50f) && *(r9_1 - 0x2c) != *r9_1)
                        void* r8_2 = *(r9_1 + 0xc)
                        void* rax_8 = r9_1 + 4
        ...
        label_14261b5bc:
            ...
            if (result_1 s>= r10_2)
                goto label_14261b5ce
    
    if (sub_14261e750(arg1, result_1, arg5, &arg1[7]) == 0)
        if (result_1 s>= 0)
            *(sx.q(result_1) * 0x88 + *arg1 + 0x10) = 0
        
        int32_t zmm1_1 = arg2[1]
        int32_t var_f8 = *arg2
        int32_t var_f0_1 = arg2[2]
        ...
        int32_t var_78_1 = 0
        char var_d8_1 = r12.b
        sub_14261e0d0(arg1, &var_f8, arg4, arg5, &arg1[7])
        int32_t var_78_2 = 0
    ...
    *(&arg1[7] + (zx.q(r12.b) << 2) + 8) = 0x7f7fffff
    *(arg1 + 0x244) = __minss_xmmss_memss(*(arg1 + 0x244), 0x7f7fffff)
    *(sx.q(result_1) * 0x88 + *arg1 + 0x10) = arg1[0x4b].d
    result = zx.q(result_1)
else
    if (sub_142612750(arg5, arg4, &arg1[7]) != 0)
        goto label_14261b4c3
