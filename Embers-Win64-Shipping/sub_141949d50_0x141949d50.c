...
while (true)
    char* rbx_2 = (sx.q(r15_1) << 5) + *rdi
    int32_t rax_12 = sub_140b21160(rbx_2, 0xa, 0)
    int32_t rcx_7 = (*r14 - 1) & rax_12
    ...
    *(rbx_2 + 0x18) = *(rax_13 + (((sx.q(*r14) - 1) & r8_7) << 2))
    ...
    *(rax_15 + (((sx.q(*r14) - 1) & r8_7) << 2)) = r15_1
