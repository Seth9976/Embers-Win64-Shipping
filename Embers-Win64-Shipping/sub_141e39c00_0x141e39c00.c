...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        void* rdi_1 = *var_58 + sx.q(i) * 0x14
        (*(*arg1 + 0x140))(arg1, rdi_1)
        int64_t* rcx_22 = arg1[1]
        int32_t* r8_8 = *rcx_22
        
        if (&r8_8[1] u<= rcx_22[1])
            *(rdi_1 + 8) = *r8_8
...
do
    ...
    *(rdx_15 + (rcx_14 << 2)) = 0
    void* rdx_16 = rdx_15 + (rcx_14 << 2)
    *(rdx_16 + 8) = 0
    *(rdx_16 + 0xc) = 0xffffffff
    (*(*arg1 + 0x140))(arg1)
    ...
    if (&rdx_17[1] u<= rcx_16[1])
        ...
        *rax_21 += 4
        ...
        sub_140b54070(arg1, rdx_16 + 8, arg3)
    else
        (*(*arg1 + 0x150))(arg1, rdx_16 + 8, 4)
