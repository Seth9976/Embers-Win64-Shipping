...
rax_2, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13, zmm14, zmm15 =
    sub_141693730(r13, arg2, arg3, arg4, var_268)
int32_t rsi_1
        ...
        while (true)
            ...
            if (rdx_5 s< 0x80)
                ...
                label_141561059:
                    ...
                    float temp0_19[0x4] =
                        _mm_mul_ps(_mm_shuffle_ps(temp0_16, temp0_16, 0xd2), temp0_8)
                    ...
                    if (not(zmm13[0] f< zmm12.d))
                        ...
                        *(rcx_17 + (r15_3 << 2)) = var_1b0_1.q
                        *(rcx_17 + (r15_3 << 2) + 8) = var_1a8_1
                        ...
                        *(rcx_19 + (rdx_12 << 2) + 8) = var_198_1
                        ...
                        if (r11_7 s>= 3)
                            ...
                            if (r11_7 s> 0)
                                ...
                                do
                                    ...
                                    zmm7.d = (*(rdx_19 + (rcx_26 << 2) + 4)).d f-
                                        *(r8_12 + (rcx_26 << 2) + 4)
                                    zmm11 = *(rdx_19 + (rcx_26 << 2) + 8)
                                    zmm11[0] = zmm11[0] f- *(r8_12 + (rcx_26 << 2) + 8)
                            ...
                            goto label_141561059
            
        label_141561070:
            rbx_1 = var_248
            goto label_1415610a6
