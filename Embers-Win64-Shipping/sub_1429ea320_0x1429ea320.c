...
if (arg3 == 0)
    result = sub_14038b967(arg1 - sx.q(arg2 * 2), arg2, arg5, arg6, 8, rdi * 0x60 + &data_14427ead0)
else
    int64_t rax_2 = sx.q(arg3)
    
    if (arg4 == 0)
        result = sub_14038b6c1(arg1, arg2, arg5, arg6, 8, rax_2 * 0x60 + &data_14427ead0)
    else
        void* var_238_1 = rax_2 * 0x60 + &data_14427ead0
        int32_t (* var_240)[0x4]
        var_240.d = 0x10
        int32_t var_228[0x2][0x4]
        sub_14038b210(arg1 - sx.q(arg2 * 2), &var_228, arg2, 1, 0xd, var_240)
