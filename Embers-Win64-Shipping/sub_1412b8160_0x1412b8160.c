...
if (data_143e8bb28 s> *rdi_1)
    _Init_thread_header(&data_143e8bb28)
    
    if (data_143e8bb28 == 0xffffffff)
        ...
        data_143e8bb20 = rax_9
        _Init_thread_footer(&data_143e8bb28)

if (data_143e8bb48 s> *rdi_1)
    _Init_thread_header(&data_143e8bb48)
    
    if (data_143e8bb48 == 0xffffffff)
        ...
        data_143e8bb40 = rax_12
        _Init_thread_footer(&data_143e8bb48)

if (data_143e8bb68 s> *rdi_1)
    _Init_thread_header(&data_143e8bb68)
    
    if (data_143e8bb68 == 0xffffffff)
        ...
        data_143e8bb60 = rax_15
        _Init_thread_footer(&data_143e8bb68)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8bb20
int64_t rcx
...
label_1412b8263:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412b825e
        
        rbx.b = 1
        goto label_1412b8263
