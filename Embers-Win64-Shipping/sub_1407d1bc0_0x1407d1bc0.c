...
int128_t zmm7 = *(sx.q(rcx_6) + *(r11 + (sx.q(r9_2) << 3)))
int32_t rcx_9 = zx.d(rax[3]) & 0x7fff
*(arg2 + 0x10) = &rax[4]
int32_t var_50 = rcx_9
int32_t rax_11
rax_11.b = rcx_9 != 0x7fff
int32_t* var_40
void var_48
