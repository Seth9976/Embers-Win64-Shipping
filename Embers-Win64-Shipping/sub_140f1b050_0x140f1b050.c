...
if ((*arg3 & rbx_2) != 0)
    ...
    label_140f1b208:
        ...
        zmm0.d = zmm11.d f* *sub_140e13cf0(*(arg4 + 0x10), &var_130)
    ...
    int32_t rdi_4 = *(arg4 + 0x24)
    zmm6.d = zmm9.d f- zmm0.d
    
    if (rdi_4 == 0)
        zmm6.d = zmm6.d f* zmm12.d
    else
        zmm0.d = zmm12.d f* *(sub_140e13cf0(*(arg4 + 0x10), &var_130) + 4)
    ...
    int128_t* rcx_11 = *(arg4 + 0x10) + 0x1c8
    var_154.d = zmm10.d
    var_154:4.d = zmm6.d
    ...
    if (data_143e20cf4 != 0)
        ...
        if (rcx_12 == 0)
            goto label_140f1b485
        
        uint64_t var_c8_2 = var_100
        var_d8 = zmm1_1
        goto label_140f1b3c2
    ...
    label_140f1b3c2:
        uint64_t* rdi_8 = *(arg4 + 0x10) + 0x1f8
        char var_c0_1 = 1
