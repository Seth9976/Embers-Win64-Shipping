...
if (data_143e2d3f0 s> *rsi_1)
    _Init_thread_header(&data_143e2d3f0)
    
    if (data_143e2d3f0 == 0xffffffff)
        ...
        data_143e2d3e8 = rax_6
        _Init_thread_footer(&data_143e2d3f0)

uint32_t rax_2

if (data_143e2d400 s> *rsi_1)
    int64_t r8_2
    rax_2, r8_2 = _Init_thread_header(&data_143e2d400)
    
    if (data_143e2d400 == 0xffffffff)
        ...
        data_143e2d3f8 = rax_9
        _Init_thread_footer(&data_143e2d400)

int64_t rbp = data_143e2d3f8
uint16_t rsi_2
...
label_1410b9220:
    ...
    if (sub_1405fba70(*arg1, 3) != 0 && sub_1410be850(arg1) != 0)
        return 1
else
    char rax_3
