...
double zmm12_1[0x2]
uint128_t zmm13
rax_10, zmm6_1, zmm9, zmm12_1, zmm13 = sub_14170eae0(&var_238, &var_324, &var_360)
float zmm1_1[0x4] = var_338[0].d
float zmm5_1[0x4] = var_338[1].d
...
float var_2d8 = zmm1_1[0]
float zmm11[0x4] = zmm5_1
int64_t var_100 = zmm2_1.q
zmm1_1 = zmm6_1
float temp0_9[0x4] = _mm_shuffle_ps(zmm1_1, zmm1_1, 0x55)
...
temp0_9[0] = temp0_9[0] f- zmm0_1[0].d
float var_350 = zmm5_1[0]
zmm0_1 = rax_6
uint128_t zmm7_1 = zmm5_1
zmm0_1[0].d = zmm0_1[0].d f- rcx_3
float result_2 = zmm5_1[0]
int32_t var_348 = zmm3_1[0].d
uint128_t zmm10_1
zmm10_1.d = zmm4_1.d f- temp0_9[0]
int32_t var_f8 = rcx_3
int64_t var_2f8 = 0
zmm11[0] = zmm11[0] f- zmm0_1[0].d
float var_2f0 = 1f
...
if (rdi.b == 0)
    while (true)
        ...
        if (rax_11 s>= 0x20)
            ...
            zmm1_1 = zmm3_1
            zmm1_1[0] = zmm1_1[0] f* zmm0_1[0].d
            zmm0_1 = zmm4_1
            ...
            zmm3_1[0].d = zmm3_1[0].d f* zmm1_1[0]
            zmm5_1[0] = 0.5f f- zmm3_1[0].d
            zmm3_1 = *(rax_12 + 0x1c)
            ...
            if (zmm2_1.d f< zmm9[0].d)
                ...
                zmm5_1[0] = zmm5_1[0] f* zmm0_1[0].d
                zmm4_1.d = zmm4_1.d f+ *(rax_12 + 0x14)
                zmm5_1[0] = zmm5_1[0] f+ *(rax_12 + 0x18)
                int32_t var_220 = zmm3_1[0].d
                rax_13 = &var_220
                int32_t var_21c_1 = zmm4_1.d
                float var_218_1 = zmm5_1[0]
            ...
            float var_2c4_1 = (zmm10_1 ^ 0x80000000)[0]
            var_344 = rdx_3
            int32_t var_2c0_1 = (zmm11 ^ 0x80000000)[0].d
            float var_1bc
            float* rax_18
            rax_18, zmm6_1, zmm7_1, zmm8_1, zmm9, zmm10_1, zmm11, zmm12_1, zmm13 =
                sub_14170eae0(&var_238, &var_1bc, &var_2c8)
            zmm5_1 = rax_15
            zmm1_1 = zx.o(*rax_18)
            zmm2_1.d = zmm7_1.d f- zmm1_1[0]
            zmm0_1 = zmm1_1
            zmm5_1[0] = zmm5_1[0] - rax_18[2]
            zmm0_1 = _mm_shuffle_ps(zmm0_1, zmm0_1, 0x55)
            ...
            zmm3_1[0].d = zmm3_1[0].d f- zmm2_1.d
            zmm2_1.d = var_350.d f- zmm5_1[0]
            uint64_t rcx_11 = r13 * 3
            int32_t var_35c_3 = zmm4_1.d
            zmm4_1.d = zmm4_1.d f* zmm10_1.d
            var_360 = zmm3_1[0].d
            zmm3_1[0].d = zmm3_1[0].d f* zmm13.d
            var_358_2 = zmm2_1.d
            zmm2_1.d = zmm2_1.d f* zmm11[0]
            zmm4_1.d = zmm4_1.d f+ zmm3_1[0].d
            ...
            *(&var_100 + (rcx_11 << 2)) = zmm1_1.q
            ...
            label_141639b48:
                ...
                if (zmm8_1.d f<= zmm1_1[0])
                    goto label_141639b48
                ...
                zmm1_1[0] = zmm1_1[0] f+ zmm3_1[0].d
            ...
            if (rdi.b != 0)
                ...
                var_170[0]:4.d = (*(&var_170 + (r10_1 << 2)))[0]
                ...
                if (result.b == 0)
                    goto label_141639f9c
                
                if (rdi.b == 0)
                    goto label_141639fa1
                
                if (not(zmm8_1.d f!= zmm9[0].d))
                    zmm1_1 = 0x3eb0c6f7a0b5ed8d
                    
                    if (not(_mm_cvtps_pd(zmm2_1.q)[0] f<= zmm1_1[0].q)
                            && not(_mm_cvtps_pd(zmm4_1.q)[0] f<= zmm1_1[0].q) && r13.d s< 4)
                        r15.b = 1
                        rdi.b = 0
                        var_368 = 1
                        goto label_141639fa7
    ...
    *arg8 = var_2f8
    ...
    if (r13.d s> 0)
        ...
        do
            ...
            zmm1_1[0] = zmm1_1[0] f* rax_35[-1]
            zmm2_1.d = zmm2_1.d f* *rax_35
            rax_35 = &rax_35[3]
            zmm9[0].d = zmm9[0].d f+ zmm0_1[0].d
            zmm9[0].d = zmm9[0].d f+ zmm1_1[0]
            zmm4_1.d = zmm4_1.d f+ zmm2_1.d
            i = i_4
            i_4 -= 1
        while (i != 1)
    ...
    zmm1_1[0] = zmm1_1[0] f+ var_338[0]:4.d
    zmm8_1.d = zmm8_1.d f+ zmm5_1[0]
    zmm0_1[0].d = zmm0_1[0].d f+ zmm9[0].d
    zmm1_1[0] = zmm1_1[0] f+ zmm9[0].d
    zmm8_1.d = zmm8_1.d f+ zmm4_1.d
    uint32_t var_31c_2 = zmm8_1.d
    *arg7 = (_mm_unpacklo_ps(zmm0_1, zmm1_1[0].q)).q
    arg7[1].d = var_31c_2
else if (result.b != 0)
    double temp0_21[0x2]
    ...
    if (zmm12_1[0].d f<= zmm9[0].d || temp0_21[0] <= 9.9999999999999995e-07
        ...
        label_14163a553:
            *arg8 = zmm0_2.q
            ...
            zmm12_1[0].d = zmm12_1[0].d f* arg8[2]
            zmm1_1[0] = zmm1_1[0] f* arg8[1]
            zmm12_1[0].d = zmm12_1[0].d f+ var_128
            zmm0_2.d = zmm0_2.d f+ var_130.d
            zmm1_1[0] = zmm1_1[0] f+ var_130:4.d
            result = zmm12_1[0].d
            zmm0_2 = _mm_unpacklo_ps(zmm0_2, zmm1_1[0].q)
        else
            if (r13.d s> 0)
            ...
            int32_t rax_48
            int128_t zmm13_1
            rax_48, zmm12_1, zmm13_1 = sub_141583d70(&var_170, &var_338, &var_258, &var_238, zmm14, 
            ...
            if (rax_48 == 2)
                *rdi_3 = (zmm12_1 ^ zmm13_1).d
                ...
                goto label_14163a553
            
            *arg8 = var_360.q
            zmm0_2 = var_344 ^ zmm13_1
            arg8[2] = rax_49
            result = result_1
            zmm0_2.d = zmm0_2.d f- zmm12_1[0].d
            *rdi_3 = zmm0_2.d
            zmm0_2 = zx.o(var_2a8)
        *rcx_34 = zmm0_2.q
        rcx_34[1].d = result
        ...
        *arg8 = var_2f8
        ...
        if (rcx_4 == 0)
            ...
            do
                ...
                zmm10_1.d = zmm10_1.d f+ zmm1_1[0]
                r12 += 0xc
                zmm11[0] = zmm11[0] f+ zmm0_1[0].d
        ...
        zmm0_1 = _mm_unpacklo_ps(zmm0_1, zmm1_1[0].q)
        *arg8 = zmm0_1.q
        ...
        zmm9[0].d = zmm9[0].d f* arg8[1]
        zmm1_1[0] = zmm1_1[0] f+ zmm9[0].d
        zmm0_1 = zmm9
        zmm0_1[0].d = zmm0_1[0].d f* arg8[2]
        zmm9 ^= data_142d3f780
        zmm14[0] = zmm14[0] f+ zmm0_1[0].d
        *arg7 = (_mm_unpacklo_ps(zmm15, zmm1_1[0].q)).q
        arg7[1].d = zmm14[0]
        *rdi_3 = zmm9[0].d
