...
if (data_143e8e250 s> *rdi_1)
    _Init_thread_header(&data_143e8e250)
    
    if (data_143e8e250 == 0xffffffff)
        ...
        data_143e8e248 = rax_9
        _Init_thread_footer(&data_143e8e250)

if (data_143e8e260 s> *rdi_1)
    _Init_thread_header(&data_143e8e260)
    
    if (data_143e8e260 == 0xffffffff)
        ...
        data_143e8e258 = rax_12
        _Init_thread_footer(&data_143e8e260)

if (data_143e8e270 s> *rdi_1)
    _Init_thread_header(&data_143e8e270)
    
    if (data_143e8e270 == 0xffffffff)
        ...
        data_143e8e268 = rax_15
        _Init_thread_footer(&data_143e8e270)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8e248
int64_t rcx
...
label_1412aa0f3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412aa0ee
        
        rbx.b = 1
        goto label_1412aa0f3
