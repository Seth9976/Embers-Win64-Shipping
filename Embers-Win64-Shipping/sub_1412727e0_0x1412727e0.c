...
sub_1410b3e70(arg2, u"MOVABLE_DIRECTIONAL_LIGHT", &(*U"RGBXYZF10|")[7])
...
if (data_143e2cdc0 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    ...
    if (data_143e2cdc0 == 0xffffffff)
        ...
        int64_t r8_3
        r8_3.b = 1
        int64_t* rax_5 = (*(*rcx_7 + 0xb0))(rcx_7, u"r.Shadow.CSM.MaxMobileCascades", r8_3)
        int64_t rax_6
...
return sub_1410b3fe0(arg2, u"MAX_MOBILE_SHADOWCASCADES", zx.q(rbx)) __tailcall
