...
label_1405b8054:
    ...
    label_1405b7fe6:
        ...
        while (true)
            ...
            if (*(r8_1 + (rcx_1 << 3)) == *arg4 && *(rdx_3 + 0x14) == arg4[5])
                int32_t rcx_6 = (*(rdx_3 + 0x10) ^ arg4[4]) | (*(rdx_3 + 0xc) ^ arg4[3])
                    | (*(rdx_3 + 8) ^ arg4[2]) | (*(rdx_3 + 4) ^ arg4[1])
    ...
    if (rbx_1 == 0xffffffff)
        ...
        int64_t rax_11 = *arg1
        int64_t* rcx_8 = *(rax_11 + (rcx_7 << 3) + 0x18)
        
        if (rcx_8 != 0)
            (**rcx_8)(rcx_8, 1)
        
        memmove(rax_11 + (rcx_7 << 3), arg4, 0x20)
        sub_1405c3590(arg1, arg5, 1)
        r10 = zx.q(arg3)
        rdi_1 = rbx_1
    
    if (rbx_1 == 0xffffffff)
        goto label_1405b8054
