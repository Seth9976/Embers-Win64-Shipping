...
while (true)
    ...
    *(&var_178 + (rcx_3 << 2)) = *(rdx_2 + 0x10)
    (&var_170)[rcx_3] = rax_10
...
if (zmm15[0] <= zmm8[0])
    ...
    uint128_t zmm9_1
    uint128_t zmm14_1
    rax_28, zmm8_1, zmm9_1, zmm14_1 = sub_1415b6ff0(&var_250, &var_270, &var_210, &var_208, 
    ...
    if (rax_28 == 2)
        ...
        *arg4 = zmm0_2.d
        ...
        zmm1_1.d = zmm14_1.d f* arg7[1]
        zmm14_1.d = zmm14_1.d f* arg7[2]
        zmm0_2.d = zmm0_2.d f+ var_290
        zmm1_1.d = zmm1_1.d f+ var_28c
        zmm14_1.d = zmm14_1.d f+ var_288
        *arg5 = (_mm_unpacklo_ps(zmm0_2, zmm1_1.q)).q
        arg5[1].d = zmm14_1.d
