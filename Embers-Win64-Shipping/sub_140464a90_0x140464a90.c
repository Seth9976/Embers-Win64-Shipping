...
int64_t var_18 = -0x7ffffffebd0fb4e8
int32_t var_10 = sub_140b61230(u"MaterialShaderQualitySettings", 0x1d)
char var_c = 1
...
if (rax_1 != 0)
    *rax_1 = &TBaseRawMethodDelegateInstance<0, class FStaticallyLinkedModuleRegistrant<class FDefaultModuleImpl>, class IModuleInterface * __cdecl(void)>::`vftable'{for `IBaseDelegateInstance<class IModuleInterface* __ptr64 __cdecl ()>'}
    rax_1[1] = &data_143e2caa0
    rax_1[2] = sub_14059c5f0
...
if (&var_18 == rdx_3)
    goto label_140464b81

if (rax_1 != 0)
    result = (*rax_1)->__offset(0x40).q(rax_1)
label_140464b81:
    
    if (rax_1 != 0)
        (*rax_1)->__offset(0x38).q(rax_1, 0)
