...
float* rax_5
int512_t zmm8
rax_5, zmm8 = sub_14170a5e0(arg1[1], &var_a0, &var_c0)
zmm8.o = zx.o(*rax_5)
int32_t r12 = rax_5[2]
float* rax_6
float zmm6_1[0x4]
...
if ((temp0 ^ zmm7)[0] < zmm1_1 f+ zmm0_1.d)
    ...
    *(rcx_8 + (rdx_6 << 2)) = var_d8
    *(rcx_8 + (rdx_6 << 2) + 8) = var_d0
    ...
    *(result + (rcx_10 << 2) + 8) = r12
    ...
    int64_t rcx_4 = *rbx
    int64_t rdx_3 = rdi * 3
    *(rcx_4 + (rdx_3 << 2)) = var_cc
    *(rcx_4 + (rdx_3 << 2) + 8) = var_c4
