...
if (data_143e8b728 s> *rdi_1)
    _Init_thread_header(&data_143e8b728)
    
    if (data_143e8b728 == 0xffffffff)
        ...
        data_143e8b720 = rax_9
        _Init_thread_footer(&data_143e8b728)

if (data_143e8b748 s> *rdi_1)
    _Init_thread_header(&data_143e8b748)
    
    if (data_143e8b748 == 0xffffffff)
        ...
        data_143e8b740 = rax_12
        _Init_thread_footer(&data_143e8b748)

if (data_143e8b768 s> *rdi_1)
    _Init_thread_header(&data_143e8b768)
    
    if (data_143e8b768 == 0xffffffff)
        ...
        data_143e8b760 = rax_15
        _Init_thread_footer(&data_143e8b768)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b720
int64_t rcx
