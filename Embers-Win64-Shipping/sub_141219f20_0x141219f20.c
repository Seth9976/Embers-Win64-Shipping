...
if (sub_1413e99c0() == 2 || data_143e51020 != 0)
    rax_9 = data_14395da00
else
    rax_9 = data_1439b54a0
    
    if (arg1[4].b != 0)
        rax_9 = data_1439b57b8
...
if (rax_10 != 0)
    int64_t rdx_3 = sx.q(*(rax_10 + 0x10c))
...
sub_1412177d0(arg2, &arg1[2], rdi, *arg1)
