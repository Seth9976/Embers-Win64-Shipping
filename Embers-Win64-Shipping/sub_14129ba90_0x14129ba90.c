...
if (data_143e8cf08 s> *rdi_1)
    _Init_thread_header(&data_143e8cf08)
    
    if (data_143e8cf08 == 0xffffffff)
        ...
        data_143e8cf00 = rax_12
        _Init_thread_footer(&data_143e8cf08)

if (data_143e8cf28 s> *rdi_1)
    _Init_thread_header(&data_143e8cf28)
    
    if (data_143e8cf28 == 0xffffffff)
        ...
        data_143e8cf20 = rax_15
        _Init_thread_footer(&data_143e8cf28)

if (data_143e8cf48 s> *rdi_1)
    _Init_thread_header(&data_143e8cf48)
    
    if (data_143e8cf48 == 0xffffffff)
        ...
        data_143e8cf40 = rax_18
        _Init_thread_footer(&data_143e8cf48)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8cf00
int64_t rcx
...
label_14129bb88:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_14129bb83
    
    rbx.b = 1
    goto label_14129bb88
