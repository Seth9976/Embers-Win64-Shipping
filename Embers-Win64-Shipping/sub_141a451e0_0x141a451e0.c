...
label_141a45381:
    ...
    if (r8_6 s> 0 && (rax_18 == 0 || rax_18 s< rbp))
        ...
        *(arg4 + 0x3c) = rax_21
        ...
        arg4[7].d = *(rax_22 + (((sx.q(arg1[9].d) - 1) & r8_7) << 2))
        void* rax_24 = *(r9_3 + 8)
    ...
    label_141a45283:
        ...
        while (true)
            int64_t rax_4 = sx.q(rbx_1) << 6
            void* rcx_1 = rax_4 + rdx_3
            
            if (*(rax_4 + rdx_3) == *arg4 && *(rcx_1 + 8) == arg4[1])
                break
            
            rbx_1 = *(rcx_1 + 0x38)
            
            if (rbx_1 == 0xffffffff)
                goto label_141a45283
    ...
    if (rbx_1 == 0xffffffff)
        ...
        char rax_6 = *(rdi_2 + 0x30)
        
        if ((1 & rax_6) != 0)
            void* rcx_2 = rdi_2 + 0x10
            
            if ((rax_6 & 2) == 0)
                rcx_2 = *(rdi_2 + 0x10)
            
            *(rdi_2 + 0x30) = rax_6 & 0xfe
            (**rcx_2)(rcx_2, 0)
