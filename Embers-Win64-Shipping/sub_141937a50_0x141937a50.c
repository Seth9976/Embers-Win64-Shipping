...
label_141937bbc:
    ...
    if (sub_141934870(arg1, arg1[1].d - *(arg1 + 0x34), 0) == 0)
        void* r9_2 = &arg1[7]
        ...
        *(arg4 + 0x28) = *(rax_19 + (((sx.q(arg1[9].d) - 1) & r8_2) << 2))
        void* rax_21 = *(r9_2 + 8)
    ...
    label_141937af8:
        ...
        while (true)
            ...
            if (memcmp(buffer1, arg4, count) == 0)
                break
            
            rbx_1 = *(buffer1 + 0x28)
            
            if (rbx_1 == 0xffffffff)
                goto label_141937af8
