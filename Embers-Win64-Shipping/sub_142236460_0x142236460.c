...
arg1[0x29].b = 1
arg1[0x45].b = 1
int64_t r14 = sx.q(arg1[5].d)
int32_t rax_2 = (r14 + 1).d
int128_t* var_168 = arg3
arg1[5].d = rax_2

if (rax_2 s> *(arg1 + 0x2c))
    sub_1405a4df0(&arg1[4])

int64_t* r12 = arg1[4] + r14 * 0x18
...
int32_t rdi_1 = arg1[5].d - 1
int128_t* rax_4
float zmm0[0x4]
rax_4, zmm0 = j_sub_140a82f30(0x40)
int128_t* r14_1 = rax_4
...
int64_t rdi_5 = rdi_3 * 0x60
void* const rdi_6 = rdi_5 + arg1[0xa]

if (rdi_5 == neg.q(arg1[0xa]))
    rdi_6 = nullptr
else
    zmm0 = memset(rdi_6, 0, 0x60)
...
if (arg2 == 0)
    ...
    int128_t* rax_12 = (*(*arg2 + 0x120))(arg2, &var_188)
    rcx_11 = rax_12
    zmm0 = *rax_12
...
if (arg2 == 0)
    ...
    rax_18 = sub_1417cbc40(&var_158, (*(*arg2 + 0xf0))(arg2, &var_118))
float zmm12[0x4] = *rax_18
int128_t* rcx_15 = var_168
*r14_1 = zmm12
float zmm2[0x4] = rax_18[1]
r14_1[1] = zmm2
float zmm15[0x4] = rax_18[2]
r14_1[2] = zmm15
float zmm5[0x4] = *rcx_15
float zmm13[0x4] = rcx_15[2]
zmm0 = _mm_min_ps(zmm15, zmm13)
var_188.o = zmm2
int32_t var_198
float zmm3[0x4]
float zmm4[0x4]

if (_mm_movemask_ps(__cmpps_xmmps_memps_immb(zmm0, data_143f519a0, 1)) == 0)
    zmm0 = _mm_shuffle_ps(zmm5, zmm5, 0)
    zmm13 = _mm_mul_ps(zmm13, zmm2)
    zmm6 = _mm_mul_ps(_mm_shuffle_ps(zmm12, zmm12, 0x1b), zmm0)
    zmm1 = _mm_shuffle_ps(zmm5, zmm5, 0x55)
    zmm2 = _mm_shuffle_ps(zmm13, zmm13, 0xd2)
    zmm3 = _mm_shuffle_ps(zmm5, zmm5, 0xff)
    zmm6 = _mm_add_ps(__mulps_xmmps_memps(zmm6, data_143f51580), _mm_mul_ps(zmm3, zmm12))
    ...
    zmm4 =
        __addps_xmmps_memps(_mm_add_ps(_mm_sub_ps(zmm4, zmm0), _mm_add_ps(zmm2, zmm13)), rcx_15[1])
else
    zmm0 = _mm_shuffle_ps(zmm5, zmm5, 4)
    zmm2 = _mm_add_ps(zmm5, zmm5)
    float zmm8[0x4] = rcx_15[1]
    ...
    zmm1 = __andps_xmmxud_memxud(_mm_mul_ps(_mm_sub_ps(zmm11, zmm0), zmm13), data_143f515c0)
    ...
    zmm1 = __andps_xmmxud_memxud(_mm_mul_ps(zmm1, zmm15), data_143f515c0)
    ...
    zmm5 = _mm_shuffle_ps(zmm5, _mm_shuffle_ps(zmm6, zmm1, 0x31), 0x88)
    ...
    zmm11[0].q = zmm4 u>> 0x40
    zmm4 = _mm_shuffle_ps(zmm4, zmm11, 0xc4)
    ...
    int96_t var_128_1 = _mm_add_ps(_mm_add_ps(zmm3, zmm1), zmm4)[0].12
    int128_t zmm11_1
    float zmm13_1[0x4]
    float zmm15_1[0x4]
    zmm11_1, zmm13_1, zmm14, zmm15_1 = sub_1407740e0(&var_158, 0x322bcc77)
    float zmm2_1[0x4] = var_158[0]
    float zmm4_1[0x4] = _mm_and_ps(_mm_cmpeq_ps(data_143f519a0, _mm_mul_ps(zmm13_1, zmm15_1), 2), 
...
*(rdi_6 + 0x30) = zmm6[0]
*(rdi_6 + 0x34) = zmm0[0]
*(rdi_6 + 0x38) = _mm_shuffle_ps(zmm6, zmm6, 0xaa)[0]
*(rdi_6 + 0x3c) = _mm_shuffle_ps(zmm6, zmm6, 0xff)[0]
zmm0 = _mm_shuffle_ps(zmm4, zmm4, 0x55)
*(rdi_6 + 0x40) = zmm4[0]
*(rdi_6 + 0x48) = _mm_shuffle_ps(zmm4, zmm4, 0xaa)[0]
*(rdi_6 + 0x44) = zmm0[0]
...
*(rdi_6 + 0x50) = zmm14[0]
*(rdi_6 + 0x54) = 0x7f7fffff
sub_1422404a0(&arg1[0x10], 1)
float zmm0_2[0x4] = sub_140820230(&arg1[0xe], 1)

if (arg2 == 0)
    *(rdi_6 + 0x58) = 0x7f7fffff
else
    (*(*arg2 + 0x1e8))(arg2)
    int64_t rax_23 = *arg2
    zmm0_2[0] = zmm0_2[0] * zmm0_2[0]
    *(rdi_6 + 0x58) = zmm0_2[0]
    (*(rax_23 + 0x258))(arg2, &var_198, &var_168)
    int32_t rcx_24 = arg1[0x2f].d
    
    if (var_198 s>= rcx_24)
        rcx_24 = var_198
    
    arg1[0x2f].d = rcx_24
    int32_t rcx_25 = *(arg1 + 0x17c)
    
    if (var_168.d s>= rcx_25)
        rcx_25 = var_168.d
...
zmm2 = *r14_1
zmm3 = r14_1[1]
var_188:4.d = _mm_shuffle_ps(zmm2, zmm2, 0x55)[0]
...
float var_170 = zmm3[0]
float var_180_2 = zmm1[0]
float var_17c = zmm2[0]
float var_174 = zmm0_2[0]
sub_1422436a0(r12, arg2, &var_188)
int32_t rcx_27 = arg1[0x2d].d

if (rcx_27 s< rdi_1)
    sub_142253f80(arg1, rcx_27, rdi_1)
    rcx_27 = arg1[0x2d].d

arg1[0x2d].d = rcx_27 + 1
uint64_t result = zx.q(*(r14_1 + 0x38))
