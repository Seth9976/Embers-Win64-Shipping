...
if (data_143e8b778 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8b778)
    
    if (data_143e8b778 == 0xffffffff)
        ...
        data_143e8b770 = rax_6
        _Init_thread_footer(&data_143e8b778)

int64_t rbx = data_143e8b770
int64_t rcx
