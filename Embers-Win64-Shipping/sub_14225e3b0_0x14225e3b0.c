...
if (rdi != 0)
    ...
    if (rbx_1 != 0)
        ...
        label_14225e579:
            ...
            int32_t var_48_1 = arg3[1].d.d
            return (*(r10_1 + 0x148))(rbx_1, &var_50, zx.q(sbb.d(r8, r8, arg5 != 0)) & 3, 1)
        
        void* rcx_2 = *(arg1 + 0x50)
        
        if (rcx_2 == 0)
            goto label_14225e579
        ...
        if (result.b != 0)
            ...
            void* rax_20 = sub_142258e30(zx.q(not(z_1)) * 0x50 + rbx_2, 
                (rdx_5 - r8_8 - rcx_11) ^ r8_8 u>> 0xf, &var_58)
            int64_t rdi_1 = sx.q(*(rax_20 + 8))
            int32_t rcx_15 = (rdi_1 + 1).d
            *(rax_20 + 8) = rcx_15
            
            if (rcx_15 s> *(rax_20 + 0xc))
                sub_1405c50f0(rax_20)
            
            int64_t rcx_17 = *rax_20
            result = zx.q(var_28_1.d)
            int128_t* rdx_10 = rdi_1 * 0x1c
            *(rdx_10 + rcx_17) = zmm0.o
            int64_t var_30
            *(rdx_10 + rcx_17 + 0x10) = var_30
