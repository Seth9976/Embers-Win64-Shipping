    ...
    do
        ...
        if ((*(r15_1 + rdx + 4) & rdi) != 0)
            ...
            if (result.b != 0)
                ...
                int64_t* rax_8 = *arg1
                void* rcx_7 = *rax_8
                void* r10_1 = *(rcx_7 + 0x40)
                
                if ((rax_8[1].d & 0xfffffffe) != 4)
                    int64_t var_138_2 = *(r10_1 + 0x70)
                    result = (*(r10_1 + 0x180))()
                else
                    result = (*(r10_1 + 0x178))(rcx_7, *(rcx_7 + 0x48), zx.q(*(r15_1 + var_120)), 
                        zx.q(*(var_120 + result_3 * 0x14)), *(r10_1 + 0x68))
                
                int32_t rdx_6 = result.d
                
                if (result.d != 0)
                    if (rax_2 != 4)
                        if (arg5 != 0)
                            rdx_6 = sub_142bfd700(arg2, rdx_6.w)
                        
                        if (arg1[1].b == 0)
                            int32_t rax_20 = rdx_6 s>> 1
                            *(r15_1 + r14 + 4) += rax_20
                            int32_t rdx_8 = rdx_6 - rax_20
                            uint64_t rax_22 = result_3 * 5
                            *(r14 + (rax_22 << 2) + 4) += rdx_8
                            *(r14 + (rax_22 << 2) + 0xc) += rdx_8
                        else
                            *(r14 + result_3 * 0x14 + 8) = rdx_6
                            *(arg3 + 0x28) |= 8
                    else
                        if (arg5 != 0)
                            rdx_6 = sub_142c1db90(arg2, rdx_6.w)
                        
                        if (arg1[1].b == 0)
                            int32_t rax_13 = rdx_6 s>> 1
                            *(r15_1 + r14) += rax_13
                            int32_t rdx_7 = rdx_6 - rax_13
                            uint64_t rax_15 = result_3 * 5
                            *(r14 + (rax_15 << 2)) += rdx_7
                            *(r14 + (rax_15 << 2) + 8) += rdx_7
                        else
                            *(r14 + result_3 * 0x14 + 0xc) = rdx_6
                            *(arg3 + 0x28) |= 8
