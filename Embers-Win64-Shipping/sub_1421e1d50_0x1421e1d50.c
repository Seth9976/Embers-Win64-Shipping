...
if (data_143f50b30 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143f50b30)
    
    if (data_143f50b30 == 0xffffffff)
        data_143f50b28 = j_sub_140d2ee50(sub_140bdf730(), -ffffffffffffffff, u"ETickingGroup", 0)
        _Init_thread_footer(&data_143f50b30)

int64_t var_28
int64_t* rax_2 = sub_140bded20(data_143f50b28, &var_28, zx.d(*(arg1 + 8)))
int32_t rdx_1 = 0
void* var_38 = nullptr
void* rsi = nullptr
int32_t var_30 = 0
