...
while (true)
    ...
    if (rcx_8.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0xb0 && result == arg1 + 0xa0)
        if (arg1 == -0xf0)
            return result
    ...
    r8_3.b = 1
    int64_t* rcx_10 = *((rcx_8 << 6) + *result + 8)
    (*(*rcx_10 + 0x58))(rcx_10, arg2, r8_3)
