...
int128_t zmm3 = _mm_shufflelo_epi16(temp0, 0xff)
...
int128_t var_b8 = _mm_unpacklo_epi64(zmm3, zmm3.q)
int32_t zmm12[0x4] = *u"@@@@@@@@"
int32_t i_1 = arg5 - 1
uint16_t zmm2[0x8]
int32_t i
...
if (i == 2)
    ...
    zmm1 = _mm_srai_epi16(
        _mm_adds_epi16(_mm_adds_epi16(_mm_adds_epi16(zmm1, zmm3), _mm_adds_epi16(zmm4, zmm2)), 
            zmm12), 
        7)
    *arg3 = _mm_packus_epi16(zmm1, zmm1)[0].q
