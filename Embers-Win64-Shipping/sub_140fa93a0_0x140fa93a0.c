...
if (arg2 u<= 1)
    zmm0 = *arg3
    char rax_35 = arg3[1].b
    var_498 = 0
    int32_t var_490_1 = 0
    sub_140692f90(&var_498, arg3 + 0x18)
    void* rbx_11 = arg1 + 0x2b0
    void* rdi_2 = arg1 + 0x2b0
    
    if (arg1 == -0x2c0)
        rbx_11 = -0xfffffffffffffff0
    ...
    *(rbx_11 + 0x48) = rax_35
    *(rbx_11 + 0x38) = zmm0
    sub_140692f90(rbx_11 + 0x50, &var_498)
    sub_140745b20(&var_498)
    sub_140de1b90(rbx_11 + 0x10, arg4)
    result = rdi_2 + 0x10
    ...
    *(rax_20 + 0x20) = 3
    ...
    if (rax_22 == 0)
        ...
        rax_22[1].d = 1
        *(rax_22 + 0xc) = 1
        *rbx_6 = &data_142d8c590
        
        if (rbx_6 != -0x10)
            sub_14068e500(&rbx_6[2])
    
    void*** var_450_1 = rbx_6
    void* var_458 = &rbx_6[2]
    sub_14065fa30(&var_458, &rbx_6[2])
    void var_4c8
    void* var_448_1 = &var_4c8
    int64_t var_4d8_2 = 0x2d8
    sub_140e23ed0(var_458, "SHorizontalBox")
    void var_1f8
    int64_t* rax_23
    int128_t zmm1_2
    rax_23, zmm1_2 = sub_14068d420(&var_1f8)
    void* var_408
    void** rax_26 = sub_140696920(&var_458, &var_408, 
    ...
    sub_140669d70(&var_458)
    sub_140f9acc0(&var_1f8)
    int64_t* var_3f0
