...
int32_t arg_30
int32_t* var_a0 = &arg_30
int32_t arg_28

if (data_143f01c92 == 0)
    sub_141944fc0(arg1, arg2, arg4, arg_28, arg_30, rdi)
else if (sub_140a80f10() != 0)
    sub_141944fc0(arg1, arg2, arg_20, arg_28, arg_30, rdi)
else
    ...
    *(rax_4 + 8) = (&arg_38).o
    *(rax_4 + 0x18) = arg1.o
    *(rax_4 + 0x28) = _mm_unpacklo_pd((&arg_28).o, rdi)
    void**** (* var_58)(int64_t* arg1)
    void**** (* rax_5)(int64_t* arg1) = var_58
    
    if (rax_4 != -8)
        rax_5 = j_sub_141908340
