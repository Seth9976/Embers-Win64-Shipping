    ...
    do
        ...
        if (rsi_1 s< arg2)
            do
                ...
                if ((r8_1 + 1).d s< arg2)
                    if (*(arg1 + (sx.q(r11_1) + 2) * 0x18) u< *(arg1 + sx.q(r8_1.d) * 0x18))
                        r8_1 = zx.q(r11_1)
                    
                    r8_1 = zx.q(r8_1.d + 1)
                
                int16_t* rdx_2 = arg1 + sx.q(r8_1.d) * 0x18
                int64_t rcx_2 = sx.q(r10_1) * 3
                result = zx.q(*rdx_2)
                int128_t* r10_2 = arg1 + (rcx_2 << 3)
                
                if (*(arg1 + (rcx_2 << 3)) u>= result.w)
                    break
