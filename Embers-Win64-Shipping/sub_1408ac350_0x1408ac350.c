...
if (r10 == 0)
    ...
    uint32_t zmm0_2[0x4]
    zmm0_2, zmm6, zmm7 = sub_1408af2f0(&arg6, &var_b8)
    zmm9 = zmm0_2
    zmm10 = 0x3f800000
    zmm11 = 0x3f800000
    result = zx.q(*arg5)
    ...
    if (result.d s> 1)
        ...
        do
            ...
            zmm0_2, result, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13 =
                sub_1408af2f0(&arg6, &var_b8)
    ...
    uint32_t zmm0_1[0x4]
    int32_t zmm14_1
    zmm0_1, zmm8, zmm9, zmm14_1 = sub_1408af2f0(&arg6, &var_b8)
    ...
    if (result.d s> 1)
        ...
        do
            ...
            int32_t zmm14_2
            int32_t zmm15_1
            zmm0_1, result, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13, zmm14_2, zmm15_1 =
                sub_1408af2f0(&arg6, &var_b8)
            zmm0_1 = __andps_xmmxud_memxud(zmm0_1, data_142d3f770)
            zmm11.d = zmm11.d f+ zmm7[0]
            zmm0_1[0] = zmm0_1[0] f* zmm14_2
            zmm7[0] = zmm7[0] f* zmm12[0]
            zmm0_1[0] = zmm0_1[0] f- zmm15_1
    ...
    return sub_1408b0a60(rcx, arg3, arg4, arg5, (_mm_unpacklo_ps(zmm1, zmm1[0].q)).d)
return result
