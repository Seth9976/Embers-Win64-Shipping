...
while (true)
    ...
    if (r15_1 != 0)
        ...
        while (true)
            ...
            int64_t rdi_1 = sx.q(arg3[0x11].d)
            int64_t rsi_2 = *(*result + rcx_8 * 0x10)
            int32_t rax_25 = (rdi_1 + 1).d
            arg3[0x11].d = rax_25
            
            if (rax_25 s> *(arg3 + 0x8c))
                sub_1407c3c00(arg3, rdi_1.d)
            
            int64_t* rax_26 = arg3[0x10]
            int64_t* rcx_11 = arg3
    ...
    if (r12_1 s>= arg3[0x11].d)
        break
    
    int64_t* rax_29 = arg3[0x10]
    int64_t* rcx_13 = arg3
