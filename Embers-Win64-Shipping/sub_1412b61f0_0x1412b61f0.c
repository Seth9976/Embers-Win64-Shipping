...
if (data_143e8baa8 s> *rdi_1)
    _Init_thread_header(&data_143e8baa8)
    
    if (data_143e8baa8 == 0xffffffff)
        ...
        data_143e8baa0 = rax_9
        _Init_thread_footer(&data_143e8baa8)

if (data_143e8bac8 s> *rdi_1)
    _Init_thread_header(&data_143e8bac8)
    
    if (data_143e8bac8 == 0xffffffff)
        ...
        data_143e8bac0 = rax_12
        _Init_thread_footer(&data_143e8bac8)

if (data_143e8bae8 s> *rdi_1)
    _Init_thread_header(&data_143e8bae8)
    
    if (data_143e8bae8 == 0xffffffff)
        ...
        data_143e8bae0 = rax_15
        _Init_thread_footer(&data_143e8bae8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8baa0
int64_t rcx
...
label_1412b62f3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412b62ee
        
        rbx.b = 1
        goto label_1412b62f3
