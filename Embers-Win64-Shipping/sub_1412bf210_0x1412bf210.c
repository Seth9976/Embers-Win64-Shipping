...
if (data_143e8b5d8 s> *rdi_1)
    _Init_thread_header(&data_143e8b5d8)
    
    if (data_143e8b5d8 == 0xffffffff)
        ...
        data_143e8b5d0 = rax_12
        _Init_thread_footer(&data_143e8b5d8)

if (data_143e8b5e8 s> *rdi_1)
    _Init_thread_header(&data_143e8b5e8)
    
    if (data_143e8b5e8 == 0xffffffff)
        ...
        data_143e8b5e0 = rax_15
        _Init_thread_footer(&data_143e8b5e8)

if (data_143e8b5f8 s> *rdi_1)
    _Init_thread_header(&data_143e8b5f8)
    
    if (data_143e8b5f8 == 0xffffffff)
        ...
        data_143e8b5f0 = rax_18
        _Init_thread_footer(&data_143e8b5f8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b5d0
int64_t rcx
...
label_1412bf308:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412bf303
    
    rbx.b = 1
    goto label_1412bf308
