    ...
    do
        ...
        if (r15_1 s< arg2)
            do
                ...
                if (rbx_1 s< arg2)
                    int64_t r8 = *(*arg4 + 0x18)
                    
                    if (*(r8 + (sx.q(arg1[sx.q(rbx_1)]) << 3)) f>
                            *(r8 + (sx.q(arg1[sx.q(r11_1.d)]) << 3)))
                        rbx_1 = r11_1.d
                ...
                int64_t rdx_2 = *(result + 0x18)
                int64_t rbx_2 = sx.q(arg1[r8_1])
                int64_t rbp_1 = sx.q(arg1[rdi_2])
                
                if (*(rdx_2 + (rbp_1 << 3)) f>= *(rdx_2 + (rbx_2 << 3)))
                    break
        ...
        *arg1 = result.d
        ...
        if (j s> 1)
            do
                ...
                if (rbx_3 s< j)
                    int64_t r8_2 = *(*arg4 + 0x18)
                    
                    if (*(r8_2 + (sx.q(arg1[sx.q(rbx_3)]) << 3)) f>
                            *(r8_2 + (sx.q(arg1[sx.q(r11_2.d)]) << 3)))
                        rbx_3 = r11_2.d
                ...
                int64_t rdx_4 = *(result + 0x18)
                int64_t rbx_4 = sx.q(arg1[r8_3])
                int64_t rbp_2 = sx.q(arg1[rsi_2])
                
                if (*(rdx_4 + (rbp_2 << 3)) f>= *(rdx_4 + (rbx_4 << 3)))
                    break
