...
while (true)
    ...
    if (rcx_8.d == (var_88_2.q u>> 0x20).d && var_68.q == arg2 + 0x10 && result == arg2)
        return result
    
    (*(*arg1 + 0x38))(arg1, *result + (rcx_8 << 5) + 0x10, arg3, arg4, var_98, arg2 + 0x10, 
        var_88_2)
