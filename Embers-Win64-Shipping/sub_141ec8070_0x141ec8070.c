...
if ((arg2[5].b & 2) != 0)
    ...
    int32_t var_30 = rax
    *arg4 = sub_141eb4cc0(&var_38, arg2)
    return 1

int64_t rax_2 = *arg2
int32_t arg_10 = 0
(*(rax_2 + 0x160))(arg2, &arg_10, 0x14)
char rax_3 = arg_10.b
int32_t arg_20 = 0
int32_t var_48 = 0
int32_t var_44 = 0
...
*rbp = _mm_cvtepi32_ps(zx.o(arg_20 - rdi)).d
int32_t rax_11 = var_44
rbp[1] = _mm_cvtepi32_ps(zx.o(rax_9 - rdi)).d
int32_t result
result.b = 1
rbp[2] = _mm_cvtepi32_ps(zx.o(rax_11 - rdi)).d
*arg4 = 1
return result
