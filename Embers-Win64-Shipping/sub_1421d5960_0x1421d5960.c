    ...
    do
        ...
        if (rdi_1 s< arg2)
            do
                ...
                if (r9_1 s< arg2)
                    if ((*(&arg1[sx.q(r9_1)] + 4)).d f> *(&arg1[sx.q(rdx_1.d)] + 4))
                        r9_1 = rdx_1.d
                ...
                result = sx.q(r10_1.d)
                int64_t* r9_2 = &arg1[result]
                
                if ((*(&arg1[result] + 4)).d f<= *(rcx_1 + 4))
                    break
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if (r9_3 s< i)
                    if ((*(&arg1[sx.q(r9_3)] + 4)).d f> *(&arg1[sx.q(rdx_2.d)] + 4))
                        r9_3 = rdx_2.d
                    
                    rdx_2 = zx.q(r9_3)
                
                void* rcx_3 = &arg1[sx.q(rdx_2.d)]
                result = sx.q(r11_1.d)
                void* r9_4 = &arg1[result]
                
                if ((*(&arg1[result] + 4)).d f<= *(rcx_3 + 4))
                    break
