...
int64_t* rbx_1 = *(rdi + 0xd0)
void* rdi_1 = &rbx_1[sx.q(*(rdi + 0xd8)) * 5]

if (rbx_1 == rdi_1)
label_14152015f:
    int64_t* rax_8 =
        sub_140af5690(data_143ddb400, /Script/Engine.WorldSettings", 0, 1, &data_143de5830)
    ...
    if (rax_8 == 0)
        *arg1 = 0
        ...
        int32_t var_30_1 = 0
        void arg_18
        sub_140ae6000(rax_8, *sub_140b58260(&arg_18, u"DefaultMapPrefixes", 1), &var_38, 0)
        ...
        label_141520286:
            ...
            *arg1 = 0
            ...
            while (true)
                ...
                if (sub_140b2acc0(rcx_7, u"Prefix=", &var_38, 1) != 0)
                    int16_t* rcx_9
                    ...
                    if (sub_140b2acc0(rcx_9, GameMode=", &var_48, 1) != 0
                            && sub_140a32a50(arg2, &var_38, 1) != 0)
                ...
                if (rbx_3 == r14_3)
                    goto label_141520286
else
    while (true)
        int32_t rax_5 = rbx_1[1].d
        
        if (rax_5 != 0 && rax_5 - 1 s> 0 && sub_140a32a50(arg2, rbx_1, 1) != 0)
