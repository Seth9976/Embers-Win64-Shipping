...
if (data_143e8ad10 s> *rdi_1)
    _Init_thread_header(&data_143e8ad10)
    
    if (data_143e8ad10 == 0xffffffff)
        ...
        data_143e8ad08 = rax_9
        _Init_thread_footer(&data_143e8ad10)

if (data_143e8ad20 s> *rdi_1)
    _Init_thread_header(&data_143e8ad20)
    
    if (data_143e8ad20 == 0xffffffff)
        ...
        data_143e8ad18 = rax_12
        _Init_thread_footer(&data_143e8ad20)

if (data_143e8ad30 s> *rdi_1)
    _Init_thread_header(&data_143e8ad30)
    
    if (data_143e8ad30 == 0xffffffff)
        ...
        data_143e8ad28 = rax_15
        _Init_thread_footer(&data_143e8ad30)
