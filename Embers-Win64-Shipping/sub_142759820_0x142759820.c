...
int32_t r10_1 = 0
uint128_t zmm3 = zx.o(*(sx.q(r8) + *(rdi + (sx.q(r10) << 3))))
...
int32_t zmm1[0x4] = zx.o(*(sx.q(rcx_2) + *(rdi + (sx.q(r10_1) << 3))))
...
uint128_t zmm2 = zx.o(*(sx.q(rcx_4) + *(rdi + (sx.q(r9) << 3))))
...
if (result.d s> 0)
    ...
    int32_t zmm0[0x4] = ((zmm3 ^ zmm1) & _mm_cmpgt_epi32(zmm3, zmm1)) ^ zmm1
    zmm1 = (_mm_cmpgt_epi32(zmm2, zmm0) & (zmm0 ^ zmm2)) ^ zmm2
    uint64_t i
