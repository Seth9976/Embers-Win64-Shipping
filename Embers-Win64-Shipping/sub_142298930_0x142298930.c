...
if (arg7 s> 0)
    do
        ...
        float zmm4_1 = zmm0.d f* arg4[2]
        float zmm2_1 = zmm3_1.d * *rbx f+ zmm1.d
        zmm1.d = zmm0.d f* arg4[1]
        zmm0.d = zmm3_1.d f* rbx[1]
        zmm3_1.d = zmm3_1.d f* rbx[2]
        ...
        result = (*(rax + 0x30))(arg1, &var_78, &var_88, arg5, arg8, zmm9_1, zmm8_1, arg11, var_88, 
            zmm4_1)
        var_78 = var_88.d
