...
if (*(rax + 0xf8) == 0)
    sub_140af2b60()
    sub_140b2acc0(&data_143dbb3f0, u"UserDir=", rax + 0x38, 1)
    bool cond:0_1 = *(rax + 0x40) s<= 1
    *(rax + 0xf8) = 1
    ...
    if (not(cond:0_1))
        ...
        if (sub_140b1d530(rax + 0x38) == 0)
            int32_t rcx_16 = sub_140b214e0(rax + 0x38)
            int32_t rdi_3 = *(rax + 0x40)
            int64_t rbx_3 = *(rax + 0x38)
            var_48 = nullptr
