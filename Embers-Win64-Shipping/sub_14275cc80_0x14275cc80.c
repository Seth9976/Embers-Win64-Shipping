...
if (rdx.b == 0)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    uint32_t (* r10_4)[0x4] = zx.q(r10_2 * r8_2) + *(arg1 + 0x70)
    ...
    if (rax.d s> 0)
        ...
        do
            uint32_t zmm1[0x4] = *r10_4
            r10_4 = &r10_4[1]
            rax = rcx_6
            rcx_6 += 0x10
            *rax = _mm_and_ps(data_143f87770 ^ data_143f87690, zmm1) ^ data_143f87690
            i = i_3
            i_3 -= 1
        while (i != 1)
else if (rax.d == 1)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            rax_6 = rdx_5
            rdx_5 = &rdx_5[1]
            *rax_6 = _mm_and_ps(data_143f87770 ^ data_143f87690, temp0_1) ^ data_143f87690
            i_1 = i_2
            i_2 -= 1
        while (i_1 != 1)
        return rax_6
