...
if (data_143e8c9f0 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8c9f0)
    
    if (data_143e8c9f0 == 0xffffffff)
        ...
        data_143e8c9e8 = rax_4
        _Init_thread_footer(&data_143e8c9f0)

if (data_143e8c9e8 != 0 && data_143de5480 != 0)
    GetCurrentThreadId()

sub_1410b3fe0(arg2, u"MAX_NUM_LIGHTMAP_COEF", 2)
sub_1412713f0(arg1, arg2)
