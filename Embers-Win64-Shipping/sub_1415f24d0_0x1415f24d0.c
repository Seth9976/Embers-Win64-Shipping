...
while (true)
    ...
    zmm7 = (*r8)[2]
    zmm3 = *r8
    int32_t rcx_3 = rdx_1 & 0xffffffdf
    zmm2 = (*r8)[3]
    ...
    int32_t rdx_3 = rcx_3 & 0xffffffef
    ...
    *(&var_1a8:4 + (sx.q(i_6) << 2)) = i_6
    ...
    int64_t rdx_4 = sx.q(var_1a8.d)
    int32_t rax_14 = r9_1[2]
    ...
    float var_1dc_1 = temp0_29[0]
    zmm2[0] = zmm2[0] - temp0_30[0]
    int32_t i_7 = rdx_4.d + 1
    var_1a8.d = rdx_4.d + 1
    float var_1d0_1 = zmm0[0]
    *(&var_178 + (rcx_4 << 2)) = *r9_1
    (&var_170)[rcx_4] = rax_14
    *(&var_148 + (rcx_4 << 2)) = (_mm_unpacklo_ps(temp0_28, temp0_30[0].q)).q
    (&var_140)[rcx_4] = var_1dc_1
    int64_t var_118
    *(&var_118 + (rcx_4 << 2)) = (_mm_unpacklo_ps(zmm3, zmm2[0].q)).q
    int32_t var_110
    (&var_110)[rcx_4] = var_1d0_1
    
    if (rdx_4.d == 0)
        int64_t rax_21 = sx.q(var_1a8:4.d)
        int64_t rcx_12 = rax_21 * 3
        var_188[rax_21] = 0x3f800000
        ...
        if (rdx_4.d == 1)
            rax_18, zmm9 = sub_1416e69d0(&var_280, &var_118, &var_1a8:4, &var_1a8, &var_188)
        label_1415f29eb:
            zmm0 = zx.o(*rax_18)
            r13 = var_210
            var_298 = rax_18[1].d
            ...
            if (rdx_4.d == 2)
                rax_18, zmm9, zmm14, zmm15 = sub_1416fa750(&var_260, &var_118, &var_1a8, &var_188)
                goto label_1415f29eb
            
            if (rdx_4.d == 3)
                uint64_t var_1b8[0x2]
                rax_18, zmm9, zmm14, zmm15 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
                goto label_1415f29eb
    ...
    int32_t var_ec_1 = rax_22
    int32_t rax_23 = (&var_170)[rdi]
    ...
    int32_t var_14c_1 = rax_23
    int32_t rax_24 = (&var_140)[rdi]
...
if (zmm15[0] <= zmm8[0])
    ...
    if (i_6 s> 0)
        ...
        do
            ...
            if (rax_28 s> var_258_1:4.d)
                sub_14083a7e0(&var_260)
            
            uint64_t rcx_19 = var_260
            int64_t rdx_14 = rsi_2 * 3
            int32_t rax_29 = *(&var_170 + rbx)
            *(rcx_19 + (rdx_14 << 2)) = *(&var_178 + rbx)
            *(rcx_19 + (rdx_14 << 2) + 8) = rax_29
            ...
            int64_t rdx_16 = rsi_3 * 3
            int64_t zmm0_1 = *(&var_148 + rbx)
            int32_t rax_31 = *(&var_140 + rbx)
            rbx += 0xc
            *(rcx_21 + (rdx_16 << 2)) = zmm0_1
            *(rcx_21 + (rdx_16 << 2) + 8) = rax_31
            i = i_5
            i_5 -= 1
        while (i != 1)
    ...
    float zmm9_1[0x4]
    float zmm14_1[0x4]
    rax_32, zmm8_1, zmm9_1, zmm14_1 = sub_141570760(&var_260, &var_280, &var_218, &var_210, zmm14, 
        zmm15, &var_2a4, &var_270, &var_248, &var_2a0)
    float zmm2_1[0x4]
    ...
    if (rax_32 == 2)
        ...
        *arg4 = zmm0_2[0]
        ...
        zmm14_1[0] = zmm14_1[0] + var_244
        zmm14_1[0] = zmm14_1[0] + var_240
        *arg5 = (_mm_unpacklo_ps(zmm14_1, zmm14_1[0].q)).q
        arg5[1].d = zmm14_1[0]
