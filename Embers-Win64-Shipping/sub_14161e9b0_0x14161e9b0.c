...
if (zmm15[0] <= zmm10[0])
    ...
    if (i_6 s> 0)
        ...
        do
            ...
            uint64_t rcx_18 = var_250
            int64_t rdx_10 = rdi_2 * 3
            int32_t rax_25 = *(&var_170 + rbx)
            *(rcx_18 + (rdx_10 << 2)) = *(&var_178 + rbx)
            *(rcx_18 + (rdx_10 << 2) + 8) = rax_25
            ...
            rbx += 0xc
            *(rcx_20 + (rdx_12 << 2)) = zmm0_1
            *(rcx_20 + (rdx_12 << 2) + 8) = rax_27
            i = i_5
            i_5 -= 1
        while (i != 1)
    ...
    int32_t rax_28
    uint128_t zmm9_1
    rax_28, zmm9_1, zmm10 = sub_1415a3690(&var_250, &var_260, &var_210, &var_208, &var_298, 
        &var_270, &var_240, &var_290)
    uint128_t zmm0_2
    uint128_t zmm1_1
    uint128_t zmm2_1
    uint128_t zmm3_1
