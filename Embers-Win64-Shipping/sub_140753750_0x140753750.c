...
label_1407538d2:
    ...
    if (r8_5 s> 0 && (rax_19 == 0 || rax_19 s< rbp))
        ...
        *(arg4 + 0x54) = rax_22
        ...
        arg4[0xa].d = *(rax_23 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_25 = *(r9_2 + 8)
    ...
    label_1407537fd:
        ...
        while (true)
            int64_t* rcx_1 = sx.q(rbx_1) * 0x58
            
            if (*(rcx_1 + rdx_3) == *arg4 && *(rcx_1 + rdx_3 + 8) == arg4[1]
                    && *(rcx_1 + rdx_3 + 0x10) == arg4[2].w)
                break
            
            rbx_1 = *(rcx_1 + rdx_3 + 0x50)
            
            if (rbx_1 == 0xffffffff)
                goto label_1407537fd
    ...
    if (rbx_1 == 0xffffffff)
        ...
        void* rdi_1 = sx.q(rbx_1) * 0x58 + *arg1
        ...
        memmove(rdi_1, arg4, 0x50)
        int64_t rcx_5 = sx.q(arg5)
        void* r10_1 = &arg1[2]
        
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0x58 + *arg1) = rcx_5.d
        
        int32_t* rax_9 = rcx_5 * 0x58 + *arg1
        *rax_9 = 0xffffffff
