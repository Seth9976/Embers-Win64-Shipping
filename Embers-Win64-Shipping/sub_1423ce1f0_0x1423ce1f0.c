...
label_1423ce24d:
    ...
    void* rax_5 = sub_140d2f240(sub_142560320(), 0, rbp_1, 0, 0, 0)
    ...
    *arg2 = rax_5
    ...
    label_1423ce2d4:
        ...
        void* rax_11 = sub_140d2f240(sub_142560320(), 0, rdi_1, 0, 0, 0)
        ...
        *arg2 = rax_11
        ...
        void* rax_6 = sub_142560320()
        
        if (rax_6 == 0)
            goto label_1423ce2d4
    ...
    if (*arg2 == 0)
        result = sub_142560320()
        *arg2 = result
    else
        void* rax_12 = sub_142560320()
    ...
    void* rax_1 = sub_142560320()
    
    if (rax_1 == 0)
        goto label_1423ce24d
