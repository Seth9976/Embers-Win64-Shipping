...
bool result = sub_141a46740(arg1 + 0x48, rdx, &var_148)

if (result != 0)
    char var_f8
    bool result_1 = var_f8 | 3
    bool var_130_1 = var_148 == 0
    void** const var_138 = &data_14305a020
    void var_f0
    int128_t* rax_3 = sub_1405ab790(&var_f0, &arg4[0x22], arg4 + 0x124, &arg4[0x27], &var_138)
