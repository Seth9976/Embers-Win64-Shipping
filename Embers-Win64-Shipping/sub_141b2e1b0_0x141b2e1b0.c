...
while (true)
    int64_t r9_3 = *rbx
    int64_t r10_2 = sx.q(r11_1) * 5
    int64_t rax_13 = *(r9_3 + (r10_2 << 2))
    int32_t rcx_8 = ((rax_13 u>> 0x20).d ^ rax_13.d) & (*rsi - 1)
    void* rax_16 = &arg1[7]
    *(r9_3 + (r10_2 << 2) + 0x10) = rcx_8
    void* rdx_9 = arg1[8]
    ...
    *(r9_3 + (r10_2 << 2) + 0xc) = *(rax_16 + (((sx.q(*rsi) - 1) & r8_3) << 2))
    void* rax_18 = &arg1[7]
    void* rcx_12 = arg1[8]
    ...
    *(rax_18 + (((sx.q(*rsi) - 1) & r8_3) << 2)) = r11_1
