...
while (true)
    ...
    zmm4 = *arg3
    zmm7 = var_258_1
    float temp0_9[0x4] = _mm_unpacklo_ps(var_288.d, var_280[0].q)
    ...
    *(&var_118 + (rcx_5 << 2)) = (_mm_unpacklo_ps(zmm5, zmm7[0].q)).q
    ...
    if (rdx_1.d == 0)
        ...
        var_2b0 = (&var_110)[rcx_13]
    else
        uint64_t* rax_20
        
        if (rdx_1.d == 1)
            rax_20 = sub_1416e69d0(&var_298, &var_118, &var_1a8:4, &var_1a8, &var_188)
        label_141609ae9:
            zmm0 = zx.o(*rax_20)
            var_2b0 = rax_20[1].d
            i_7 = var_1a8.d
            ...
            if (rdx_1.d == 2)
                rax_20, zmm11, zmm14, zmm15 = sub_1416fa750(&var_278, &var_118, &var_1a8, &var_188)
                goto label_141609ae9
            
            if (rdx_1.d == 3)
                uint64_t var_1b8[0x2]
                rax_20, zmm11, zmm14, zmm15 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
                goto label_141609ae9
...
if (zmm1[0] <= zmm8[0])
    ...
    float zmm14_1[0x4]
    float zmm15_1[0x4]
    rax_34, zmm8_1, zmm11_1, zmm14_1, zmm15_1 = sub_141580c20(&var_278, &var_298, &var_230, 
    ...
    if (rax_34 == 2)
        ...
        *arg4 = zmm0_2[0]
        ...
        zmm14_1[0] = zmm14_1[0] f* arg7[1]
        zmm14_1[0] = zmm14_1[0] f* arg7[2]
        zmm14_1[0] = zmm14_1[0] + var_268
        zmm14_1[0] = zmm14_1[0] + var_264
        zmm14_1[0] = zmm14_1[0] + var_260
        *arg5 = (_mm_unpacklo_ps(zmm14_1, zmm14_1[0].q)).q
        arg5[1].d = zmm14_1[0]
        zmm15_1[0] = zmm15_1[0] f* *arg7
        zmm15_1[0] = zmm15_1[0] f* arg7[1]
        ...
        *arg6 = (_mm_unpacklo_ps(zmm3_1, zmm2_1[0].q)).q
        arg6[1].d = zmm0_2[0]
        uint64_t rcx_25 = var_298
        
        if (rcx_25 != 0)
            sub_140a74f90(rcx_25)
        
        uint64_t rcx_26 = var_278
    ...
    *arg7 = temp0_38.q
    float temp0_39[0x4] = __sqrtss_xmmss_memss(temp0_38[0], var_29c)
    float var_2a0_2 = zmm11[0]
    zmm15[0] = zmm15[0] - temp0_39[0]
    arg7[2] = var_2a0_2
    zmm0 = zmm14
    *arg4 = zmm15[0]
    zmm1 = zmm14
