...
if (temp0[0] <= 1.17549435e-38f)
    ...
    void** var_108
    sub_141703630(&var_108, arg2, arg1 + 0x34, zx.o(0))
    ...
    int32_t var_168
    char rax_3
    rax_3, zmm7, zmm8 = sub_1417b5f70(rcx_1, &var_108, &var_a8, &var_188, temp0[0], &var_18c, 
