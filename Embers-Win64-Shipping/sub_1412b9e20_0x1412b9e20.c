...
if (data_143e8c410 s> *rdi_1)
    _Init_thread_header(&data_143e8c410)
    
    if (data_143e8c410 == 0xffffffff)
        ...
        data_143e8c408 = rax_9
        _Init_thread_footer(&data_143e8c410)

if (data_143e8c430 s> *rdi_1)
    _Init_thread_header(&data_143e8c430)
    
    if (data_143e8c430 == 0xffffffff)
        ...
        data_143e8c428 = rax_12
        _Init_thread_footer(&data_143e8c430)

if (data_143e8c450 s> *rdi_1)
    _Init_thread_header(&data_143e8c450)
    
    if (data_143e8c450 == 0xffffffff)
        ...
        data_143e8c448 = rax_15
        _Init_thread_footer(&data_143e8c450)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c408
int64_t rcx
...
label_1412b9f23:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412b9f1e
        
        rbx.b = 1
        goto label_1412b9f23
