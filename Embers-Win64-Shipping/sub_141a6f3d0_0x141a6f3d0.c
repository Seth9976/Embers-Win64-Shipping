...
do
    ...
    rbx_1[-6] = *(rdx_5 + rbx_1 - 0x18)
    
    if (cond:0_1)
        rbx_1[-5] = *(rdx_5 + rbx_1 - 0x14)
    else
        rbx_1[-4] = *(rdx_5 + rbx_1 - 0x10)
        *(rbx_1 - 8) = 0
        int64_t r14 = sx.q(*(rdx_5 + rbx_1))
        int64_t rax_11 = *(rdx_5 + rbx_1 - 8)
        *rbx_1 = r14.d
        
        if (r14.d != 0)
            sub_1405c4a90(&rbx_1[-2], r14.d, 0)
            memcpy(*(rbx_1 - 8), rax_11, (r14 << 2).d)
            rdx_5 = arg_10
