...
if (data_143e8b278 s> *rdi_1)
    _Init_thread_header(&data_143e8b278)
    
    if (data_143e8b278 == 0xffffffff)
        ...
        data_143e8b270 = rax_9
        _Init_thread_footer(&data_143e8b278)

if (data_143e8b288 s> *rdi_1)
    _Init_thread_header(&data_143e8b288)
    
    if (data_143e8b288 == 0xffffffff)
        ...
        data_143e8b280 = rax_12
        _Init_thread_footer(&data_143e8b288)

if (data_143e8b298 s> *rdi_1)
    _Init_thread_header(&data_143e8b298)
    
    if (data_143e8b298 == 0xffffffff)
        ...
        data_143e8b290 = rax_15
        _Init_thread_footer(&data_143e8b298)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b270
int64_t rcx
...
label_1412c39a3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412c399e
        
        rbx.b = 1
        goto label_1412c39a3
