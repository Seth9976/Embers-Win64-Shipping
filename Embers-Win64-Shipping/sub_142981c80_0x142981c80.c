...
int64_t var_18 = -2
struct Imf_2_3::Attribute::Imf_2_3::TypedAttribute<enum Imf_2_3::Envmap>::VTable** result =
    j_sub_140a82f30(0x10)
struct Imf_2_3::Attribute::Imf_2_3::TypedAttribute<enum Imf_2_3::Envmap>::VTable** result_1 = result
