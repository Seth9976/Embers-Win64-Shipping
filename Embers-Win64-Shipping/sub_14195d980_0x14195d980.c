        ...
        if (rdi_1 s< arg2)
            do
                ...
                if ((result + 1).d s< arg2)
                    if (*(sx.q(result_2) * 0xb8 + arg1 + 0x198)
                            s> *(sx.q(result.d) * 0xb8 + arg1 + 0x28))
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if ((rdx_2 + 1).d s< i)
                    if (*(sx.q(r9_3) * 0xb8 + arg1 + 0x198)
                            s> *(sx.q(rdx_2.d) * 0xb8 + arg1 + 0x28))
                        rdx_2 = zx.q(r9_3)
