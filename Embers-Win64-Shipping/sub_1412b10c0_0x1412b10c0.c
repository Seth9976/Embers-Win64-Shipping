...
if (data_143e8d618 s> *rdi_1)
    _Init_thread_header(&data_143e8d618)
    
    if (data_143e8d618 == 0xffffffff)
        ...
        data_143e8d610 = rax_12
        _Init_thread_footer(&data_143e8d618)

if (data_143e8d628 s> *rdi_1)
    _Init_thread_header(&data_143e8d628)
    
    if (data_143e8d628 == 0xffffffff)
        ...
        data_143e8d620 = rax_15
        _Init_thread_footer(&data_143e8d628)

if (data_143e8d640 s> *rdi_1)
    _Init_thread_header(&data_143e8d640)
    
    if (data_143e8d640 == 0xffffffff)
        ...
        data_143e8d630 = rax_18
        _Init_thread_footer(&data_143e8d640)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d610
int64_t rcx
...
label_1412b11b8:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412b11b3
    
    rbx.b = 1
    goto label_1412b11b8
