...
if (*(arg1 + 0x28) == 0)
    int32_t rcx = data_143f0f008
    
    if (rcx != 0x400)
        if (rcx != 0x800 || data_14399e5c8 != 0)
            rax = data_143f0f00c | rcx
        else
            rax = data_143f0f010
    ...
    int32_t r10_1 = data_143f0f038
    
    if (r10_1 != 0x400)
        if (r10_1 != 0x800 || data_14399e5c8 != 0)
            rax = data_143f0f03c | r10_1
        else
            rax = data_143f0f040
    else if (data_143cf0848 == 0)
        if (data_14399e5cc != 0)
            ...
            rax = data_143f0f040
    else if (data_143f0f044 == 1 || data_14399e5cc == 0)
        rax = data_143f0f040
    else
        rax = data_143f0f03c | r10_1
