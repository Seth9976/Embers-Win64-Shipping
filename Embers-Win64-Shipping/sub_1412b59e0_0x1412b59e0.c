...
if (data_143e8c420 s> *rdi_1)
    _Init_thread_header(&data_143e8c420)
    
    if (data_143e8c420 == 0xffffffff)
        ...
        data_143e8c418 = rax_12
        _Init_thread_footer(&data_143e8c420)

if (data_143e8c440 s> *rdi_1)
    _Init_thread_header(&data_143e8c440)
    
    if (data_143e8c440 == 0xffffffff)
        ...
        data_143e8c438 = rax_15
        _Init_thread_footer(&data_143e8c440)

if (data_143e8c460 s> *rdi_1)
    _Init_thread_header(&data_143e8c460)
    
    if (data_143e8c460 == 0xffffffff)
        ...
        data_143e8c458 = rax_18
        _Init_thread_footer(&data_143e8c460)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c418
int64_t rcx
