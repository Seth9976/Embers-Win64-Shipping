            ...
            do
                ...
                if (rsi_1 s< i)
                    ...
                    do
                        ...
                        if ((r9_2 + 1).d s< i)
                            if (*(r8_1[sx.q(r11_1) + 2] + 8) s> *(r8_1[sx.q(r9_2.d)] + 8))
                                r9_2 = zx.q(r11_1)
                ...
                *r8_1 = r8_1[i_1]
                ...
                if (j s> 1)
                    ...
                    do
                        ...
                        if ((r9_3 + 1).d s< j)
                            if (*(r8_1[sx.q(r10_9) + 2] + 8) s> *(r8_1[sx.q(r9_3.d)] + 8))
                                r9_3 = zx.q(r10_9)
        ...
        while (true)
            ...
            *r8_1 = rcx_3
            ...
            while (true)
                ...
                if (rdx_1 u<= i_2 && *(*r8_1 + 8) s<= *(*rdx_1 + 8))
                    continue
