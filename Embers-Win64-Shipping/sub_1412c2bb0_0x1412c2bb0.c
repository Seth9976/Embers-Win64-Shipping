...
if (data_143e8b1b8 s> *rdi_1)
    _Init_thread_header(&data_143e8b1b8)
    
    if (data_143e8b1b8 == 0xffffffff)
        ...
        data_143e8b1b0 = rax_12
        _Init_thread_footer(&data_143e8b1b8)

if (data_143e8b1c8 s> *rdi_1)
    _Init_thread_header(&data_143e8b1c8)
    
    if (data_143e8b1c8 == 0xffffffff)
        ...
        data_143e8b1c0 = rax_15
        _Init_thread_footer(&data_143e8b1c8)

if (data_143e8b1d8 s> *rdi_1)
    _Init_thread_header(&data_143e8b1d8)
    
    if (data_143e8b1d8 == 0xffffffff)
        ...
        data_143e8b1d0 = rax_18
        _Init_thread_footer(&data_143e8b1d8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b1b0
int64_t rcx
...
label_1412c2ca8:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412c2ca3
    
    rbx.b = 1
    goto label_1412c2ca8
