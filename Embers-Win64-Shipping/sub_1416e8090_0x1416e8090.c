...
uint128_t zmm7 = *(arg1 + 0x34)
int128_t zmm8 = *(arg1 + 0x38)
uint128_t zmm3
zmm3.d = zmm7.d f* *arg4
float zmm4 = zmm8.d f* arg4[1]
int128_t zmm9 = *(arg1 + 0x3c)
float zmm5 = zmm9.d f* arg4[2]
...
if (temp0[0] <= 1.17549435e-38f)
    ...
    void** var_118
    sub_141703c00(&var_118, rdx, &var_1a8, zx.o(0))
    ...
    char rax_3
    uint128_t zmm7_1
    rax_3, zmm7_1, zmm10 = sub_1417b65d0(rcx_1, &var_118, &var_b8, &var_198, temp0[0], &var_1ac, 
        &var_188, &var_178, arg9, zmm0_1.d, arg11, var_1c0_1)
    uint128_t zmm0_2
