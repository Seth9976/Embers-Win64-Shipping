...
if (data_143e2d090 s> *rdi_1)
    _Init_thread_header(&data_143e2d090)
    
    if (data_143e2d090 == 0xffffffff)
        ...
        data_143e2d088 = rax_8
        _Init_thread_footer(&data_143e2d090)

if (data_143e2d0a0 s> *rdi_1)
    _Init_thread_header(&data_143e2d0a0)
    
    if (data_143e2d0a0 == 0xffffffff)
        ...
        data_143e2d098 = rax_11
        _Init_thread_footer(&data_143e2d0a0)

int64_t rdi_2 = data_143e2d098
int64_t rcx
