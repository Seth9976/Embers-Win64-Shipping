...
label_141a45f40:
    ...
    if (r8_3 s> 0 && (rax_8 == 0 || rax_8 s< rbp))
        ...
        arg4[0x40] = *(rax_12 + (((sx.q(arg1[9].d) - 1) & r8_4) << 2))
        void* rax_14 = *(r9_1 + 8)
    ...
    label_141a45edc:
        ...
        while (true)
            int32_t* rcx_1 = sx.q(rbx_1) * 0x108
            
            if (*(rcx_1 + rdx_3) == *arg4)
                break
            
            rbx_1 = *(rcx_1 + rdx_3 + 0x100)
            
            if (rbx_1 == 0xffffffff)
                goto label_141a45edc
    ...
    if (rbx_1 == 0xffffffff)
        ...
        void* rdi_1 = sx.q(rbx_1) * 0x108 + *arg1
        sub_140914e00(rdi_1 + 8)
        memmove(rdi_1, arg4, 0x100)
        sub_141a61d90(arg1, arg5, 1)
        rdi_2 = rbx_1
    
    if (rbx_1 == 0xffffffff)
        goto label_141a45f40
