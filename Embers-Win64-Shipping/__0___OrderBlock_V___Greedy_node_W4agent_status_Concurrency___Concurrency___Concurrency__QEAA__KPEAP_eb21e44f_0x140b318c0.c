// 函数: ??0?$_OrderBlock@V?$_Greedy_node@W4agent_status@Concurrency@@@Concurrency@@@Concurrency@@QEAA@_KPEAPEAVagent@1@PEAV?$ITarget@_K@1@@Z
// 地址: 0x140b318c0
...
bool rax_15 = (*(*arg5 + 8))(arg5, &var_88, rbp, 0, *(rbp + 0x20))
bool rbx_1 = rax_15
