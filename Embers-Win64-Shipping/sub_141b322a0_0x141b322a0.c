        ...
        label_141b3230f:
            ...
            if (rax != 0)
                ...
                return (*(*(rax + 0x268) + 0x28))(rax + 0x268, arg7, 
                    zx.q((rbx_1 u>> 0x20).d * 0x17 + rbx_1.d), zmm3, var_a8_1, var_a0_1, arg12)
            ...
            if (result_1 != 0)
                ...
                sub_140d3a3a0(&var_70, 
                    sub_141e31130(arg5, result_1, &arg_20, arg7, var_a8, zmm2[0], var_98, 0))
                result = sub_140d3e110(&var_70)
                
                if (result.b != 0)
                    int32_t r9_5 = (arg_30 - arg6) ^ arg6 u>> 0xd
                    int32_t r8_8 = (0x9e3779b9 - arg6 - r9_5) ^ r9_5 << 8
                    int32_t rdx_11 = (arg6 - r8_8 - r9_5) ^ r8_8 u>> 0xd
                    int32_t r9_8 = (r9_5 - r8_8 - rdx_11) ^ rdx_11 u>> 0xc
                    int32_t r8_11 = (r8_8 - r9_8 - rdx_11) ^ r9_8 << 0x10
                    int32_t rdx_14 = (rdx_11 - r8_11 - r9_8) ^ r8_11 u>> 5
                    int32_t r9_11 = (r9_8 - r8_11 - rdx_14) ^ rdx_14 u>> 3
                    int32_t r8_14 = (r8_11 - r9_11 - rdx_14) ^ r9_11 << 0xa
                    void* rax_28 = sub_141aefef0(arg1 + 0x58, 
                        (rdx_14 - r8_14 - r9_11) ^ r8_14 u>> 0xf, &arg_30)
                    *rax_28 = var_70
                    *(rax_28 + 8) = arg_20.d
                    sub_141b21360(arg1 + 0x30, &var_68, &arg_30)
                    sub_140d3a3a0(&var_78, result_1)
                    void** const var_48 = &data_143059ad8
                    int64_t var_40_1 = var_78.q
                    int32_t var_38_1 = arg_20.d
                    void* rax_31 = sub_140d3c6e0(&var_70)
                    int64_t var_50
                    var_50.d = *(arg3 + 0x2d8)
                    var_58 = *(arg3 + 0x2d0)
                    sub_1405c5900(arg3 + 0xf8, var_68, &var_48, rax_31, *(arg3 + 0x2dc), &var_58)
