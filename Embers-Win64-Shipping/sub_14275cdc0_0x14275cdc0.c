...
if (rdx.b == 0)
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    int128_t* r10_4 = zx.q(r10_2 * r8_2) + *(arg1 + 0x70)
    ...
    if (rax.d s> 0)
        ...
        do
            ...
            rax = rcx_6
            rcx_6 += 0x10
            *rax = ((data_143f87840 ^ data_143f87810) & zmm1) ^ data_143f87810
            i = i_3
            i_3 -= 1
        while (i != 1)
else if (rax.d == 1)
    ...
    *(arg1 + 0x10) = &rax_8[3]
    ...
    uint128_t zmm2 = zx.o(*(sx.q(rcx_1) + *(*(arg1 + 0x18) + (sx.q(r8_1) << 3))))
    ...
    *(arg1 + 0x10) = &rax_8[5]
    ...
    if (rax.d s> 0)
        ...
        do
            rax_6 = rdx_5
            rdx_5 = &rdx_5[1]
            *rax_6 = ((data_143f87840 ^ data_143f87810) & zmm2) ^ data_143f87810
            i_1 = i_2
            i_2 -= 1
        while (i_1 != 1)
        return rax_6
