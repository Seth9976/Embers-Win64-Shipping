...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        void* rbx_1 = *var_58 + sx.q(i) * 0x14
        (*(*arg1 + 0x140))(arg1, rbx_1)
        sub_141d18ec0(arg1, rbx_1 + 8, zmm1)
        int32_t var_4c
...
do
    ...
    if (rdx_10 == 0)
        ...
        *rdx_13 &= not.d(1 << (rbp_1.b & 0x1f))
        ...
        rdi_1 = sx.q(arg2[6].d)
        int64_t r9_2 = *arg2
        int64_t r8_6 = sx.q(*(r9_2 + rdi_1 * 0x14 + 4))
        arg2[6].d = r8_6.d
        *(arg2 + 0x34) = rdx_10 - 1
    ...
    *r8_7 |= 1 << (rdi_1.b & 0x1f)
    int64_t rdx_15 = *arg2
    int64_t rcx_14 = sx.q(rdi_1.d) * 5
    *(rdx_15 + (rcx_14 << 2)) = 0
    void* rdx_16 = rdx_15 + (rcx_14 << 2)
    *(rdx_16 + 8) = 0
    *(rdx_16 + 0xc) = 0xffffffff
    (*(*arg1 + 0x140))(arg1)
    sub_141d18ec0(arg1, rdx_16 + 8, arg3)
    r15 += 1
while (r15 s< arg_8)
