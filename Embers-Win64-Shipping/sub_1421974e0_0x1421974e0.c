...
if ((*(arg1 + 8) & 0x410) == 0)
    ...
    if (sub_141fe97f0(arg1 + 0x40) == 0)
        void* rax_2 =
            sub_1421805d0(arg1, *sub_140b58260(&arg_8, DistributionTarget", 1), 0, 0, 0, 0)
    ...
    if (sub_141fe97f0(arg1 + 0x90) == 0)
        void* rax_5 =
            sub_1421805d0(arg1, *sub_140b58260(&arg_8, DistributionTargetTangent", 1), 0, 0, 0, 0)
        int32_t var_10_2 = 0
    ...
    if (result.b == 0)
        result =
            sub_142180490(arg1, *sub_140b58260(&arg_8, DistributionTargetStrength", 1), 0, 0, 0, 0)
