...
if (rdi != 0)
    ...
    if (rax_1 == 0)
        var_18.q = rdi
        return sub_14292c820(nullptr, arg1, arg2, rax_1 + 1, var_18, 0)
    
    int32_t rax_2 = sub_1428ea5d0(rbx, "URI")
    
    if (rax_2 == 0)
        var_18.q = rdi
        return sub_14292c820(nullptr, arg1, arg2, rax_2 + 6, var_18, 0)
    
    int32_t rax_3 = sub_1428ea5d0(rbx, "DNS")
    
    if (rax_3 == 0)
        var_18.q = rdi
        return sub_14292c820(nullptr, arg1, arg2, rax_3 + 2, var_18, 0)
    
    int32_t rax_4 = sub_1428ea5d0(rbx, "RID")
    
    if (rax_4 == 0)
        var_18.q = rdi
        return sub_14292c820(nullptr, arg1, arg2, rax_4 + 8, var_18, 0)
    
    int32_t rax_5 = sub_1428ea5d0(rbx, "IP")
    
    if (rax_5 == 0)
        var_18.q = rdi
        return sub_14292c820(nullptr, arg1, arg2, rax_5 + 7, var_18, 0)
    
    int32_t rax_6 = sub_1428ea5d0(rbx, "dirName")
    
    if (rax_6 == 0)
        var_18.q = rdi
        return sub_14292c820(nullptr, arg1, arg2, rax_6 + 4, var_18, 0)
    
    if (sub_1428ea5d0(rbx, "otherName") == 0)
        var_18.q = rdi
        return sub_14292c820(nullptr, arg1, arg2, 0, var_18, 0)
