...
if (0 s< r10)
    ...
    while (true)
        int64_t rcx_4 = sx.q(rcx_3) * 9
        int64_t rax_12 = *rdx_2
        void* rbx_1 = rax_12 + (rcx_4 << 3)
        int64_t rcx_5 = *(rax_12 + (rcx_4 << 3) + 0x28)
        
        if (rcx_5 != 0)
            sub_140a74f90(rcx_5)
        
        int64_t rcx_6 = *(rbx_1 + 0x18)
