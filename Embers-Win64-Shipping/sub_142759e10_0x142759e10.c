...
float (* rdx_3)[0x4] = zx.q(zx.d(rax[1]) * *(arg1 + 0x80)) + *(arg1 + 0x70)
...
float zmm2[0x4] = *(sx.q(rcx_3) + *(rdi + (sx.q(r9) << 3)))
...
if (result.d s> 0)
    ...
    do
        float zmm0[0x4] = *rdx_3
        rdx_3 = &rdx_3[1]
        result = result_1
        result_1 += 0x10
        *result = _mm_min_ps(_mm_max_ps(temp0, zmm0), temp0_1)
        i = i_1
        i_1 -= 1
    while (i != 1)
