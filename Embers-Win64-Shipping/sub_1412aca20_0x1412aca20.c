...
if (data_143e8e390 s> *rdi_1)
    _Init_thread_header(&data_143e8e390)
    
    if (data_143e8e390 == 0xffffffff)
        ...
        data_143e8e388 = rax_9
        _Init_thread_footer(&data_143e8e390)

if (data_143e8e3a0 s> *rdi_1)
    _Init_thread_header(&data_143e8e3a0)
    
    if (data_143e8e3a0 == 0xffffffff)
        ...
        data_143e8e398 = rax_12
        _Init_thread_footer(&data_143e8e3a0)

if (data_143e8e3b0 s> *rdi_1)
    _Init_thread_header(&data_143e8e3b0)
    
    if (data_143e8e3b0 == 0xffffffff)
        ...
        data_143e8e3a8 = rax_15
        _Init_thread_footer(&data_143e8e3b0)
...
if ((rbx_1 != 0 || (*(rdi_2 + (rbx << 2)) & 0xfffffffd) == 0) && sub_1412c5810(arg1).b != 0)
