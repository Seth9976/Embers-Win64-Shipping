...
if (data_143e8bba8 s> *rdi_1)
    _Init_thread_header(&data_143e8bba8)
    
    if (data_143e8bba8 == 0xffffffff)
        ...
        data_143e8bba0 = rax_12
        _Init_thread_footer(&data_143e8bba8)

if (data_143e8bbc8 s> *rdi_1)
    _Init_thread_header(&data_143e8bbc8)
    
    if (data_143e8bbc8 == 0xffffffff)
        ...
        data_143e8bbc0 = rax_15
        _Init_thread_footer(&data_143e8bbc8)

if (data_143e8bbe8 s> *rdi_1)
    _Init_thread_header(&data_143e8bbe8)
    
    if (data_143e8bbe8 == 0xffffffff)
        ...
        data_143e8bbe0 = rax_18
        _Init_thread_footer(&data_143e8bbe8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8bba0
int64_t rcx
...
label_1412b72a8:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412b72a3
    
    rbx.b = 1
    goto label_1412b72a8
