...
if (0 s< r13)
    ...
    while (true)
        ...
        int32_t* r12_1 = *r15_1
        int64_t r8_2 = sx.q(r12_1[sx.q(rcx_2) * 6])
        ...
        label_1406f7dae:
            ...
            *(*arg2 + (rbx_1 << 2)) = r12_1[sx.q(rcx_2) * 6]
            void var_c0
            sub_1406f3d50(&var_88, &var_c0, *r15_1 + sx.q(rcx_2) * 0x18, nullptr)
        else
            void var_50
            void* rax_14 = &var_50
