...
while (true)
    int64_t rcx_4 = sx.q(r14) * 5
    int64_t rax_14 = *rbx
    int64_t* rbx_1 = rax_14 + (rcx_4 << 3)
    int16_t* rcx_5
    
    if (*(rax_14 + (rcx_4 << 3) + 8) == 0)
        rcx_5 = &data_142d40450
    else
        rcx_5 = *rbx_1
    
    int32_t rax_16 = sub_140a5ff80(rcx_5, 0) & (*rsi_1 - 1)
    *(rbx_1 + 0x24) = rax_16
    void* rdx_7 = arg1[8]
    ...
    rbx_1[4].d = *(rax_17 + (((sx.q(*rsi_1) - 1) & r8_7) << 2))
    void* rax_19 = &arg1[7]
    void* rcx_11 = arg1[8]
    ...
    *(rax_19 + (((sx.q(*rsi_1) - 1) & r8_7) << 2)) = r14
