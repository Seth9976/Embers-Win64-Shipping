...
if (data_143e8aff0 s> *rdi_1)
    _Init_thread_header(&data_143e8aff0)
    
    if (data_143e8aff0 == 0xffffffff)
        ...
        data_143e8afe8 = rax_12
        _Init_thread_footer(&data_143e8aff0)

if (data_143e8b000 s> *rdi_1)
    _Init_thread_header(&data_143e8b000)
    
    if (data_143e8b000 == 0xffffffff)
        ...
        data_143e8aff8 = rax_15
        _Init_thread_footer(&data_143e8b000)

if (data_143e8b010 s> *rdi_1)
    _Init_thread_header(&data_143e8b010)
    
    if (data_143e8b010 == 0xffffffff)
        ...
        data_143e8b008 = rax_18
        _Init_thread_footer(&data_143e8b010)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8afe8
int64_t rcx
...
label_1412c5158:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412c5153
    
    rbx.b = 1
    goto label_1412c5158
