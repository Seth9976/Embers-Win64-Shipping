...
if (lpCriticalSection == 0)
    ...
    if ((*(arg2[1] + 0x10))(&arg2[1]) == 0)
        ...
        if (rax_6 != 0)
            *rax_6 = 0
            rax_6[1] = arg2
            void** rcx_5 = lpCriticalSection->__offset(0x40).q
            lpCriticalSection->__offset(0x40).q = rax_6
            *rcx_5 = rax_6
            rbx = var_20
        ...
        if (rax_4 s> lpCriticalSection->__offset(0x34).d)
            sub_140638870(&lpCriticalSection[1])
...
(**var_20)(var_20)
int32_t rdi = *(var_20 + 0xc)
*(var_20 + 0xc) -= 1

if (rdi == 1)
    (*(*var_20 + 8))(var_20, zx.q(rdi))
