...
if (data_143e8c080 s> *rdi_1)
    _Init_thread_header(&data_143e8c080)
    
    if (data_143e8c080 == 0xffffffff)
        ...
        data_143e8c078 = rax_9
        _Init_thread_footer(&data_143e8c080)

if (data_143e8c090 s> *rdi_1)
    _Init_thread_header(&data_143e8c090)
    
    if (data_143e8c090 == 0xffffffff)
        ...
        data_143e8c088 = rax_12
        _Init_thread_footer(&data_143e8c090)

if (data_143e8c0a8 s> *rdi_1)
    _Init_thread_header(&data_143e8c0a8)
    
    if (data_143e8c0a8 == 0xffffffff)
        ...
        data_143e8c098 = rax_15
        _Init_thread_footer(&data_143e8c0a8)
