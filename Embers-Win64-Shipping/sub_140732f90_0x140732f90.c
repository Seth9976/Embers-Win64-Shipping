...
if (rcx_8 != 0)
    rsi = *(**(rcx_8 + 0x58) + (sx.q(rbx[0x1a]) << 3))
...
int32_t rax_29 = (*(*r12_2 + 0x58))(r12_2)
...
if (*(arg2 + 0x40) s> 0)
    ...
    uint64_t r9_5 = zx.q(r13_1) << 2
    int32_t var_494
    arg_20 = var_494.d
    uint64_t r10_2 = r10_1 << 2
    float zmm12[0x4]
    float var_a8_1[0x4] = zmm12
    uint128_t zmm14
    uint128_t var_c8_1 = zmm14
    int32_t var_47c
    int32_t var_4a8_1 = var_47c.d
    int32_t var_464
    float var_4ac_1 = var_464[0]
    uint64_t var_3e8_1 = rdx_27
    uint64_t var_3e0_1 = r8_2
    ...
    do
        ...
        int32_t* rdx_28 = var_428
        var_440 = rcx_16 + rdx_27
        int128_t* rcx_18 = var_438
        int32_t var_300_1 = (*rcx_16).d
        var_438 = rcx_18 + r8_2
        uint128_t* rcx_20 = var_430
        var_430 = rcx_20 + r9_5
        var_428 = rdx_28 + r10_2
        uint64_t rdx_30 = zx.q(*rdx_28)
        uint64_t var_414_1 = (_mm_unpacklo_ps(*rcx_20, (*rcx_18)[0].q)).q
        ...
        uint32_t rbx_1 = (rdx_30 * 3).d
        int32_t rax_37 = (*(*r12_2 + 0x68))(r12_2, zx.q(rbx_1))
        int64_t r8_3 = *r12_2
        uint64_t rdi_2 = zx.q(rax_37)
        int32_t rax_38 = (*(r8_3 + 0x68))(r12_2, zx.q(rbx_1 + 1), r8_3)
        int64_t r8_4 = *r12_2
        result = (*(r8_4 + 0x68))(r12_2, zx.q(rbx_1 + 2), r8_4)
        ...
        if (arg_10 != 0)
            void var_168
            int64_t* rax_39 = sub_142316040(&var_168, rcx_8, rsi, var_458, rdi_2.d)
            zmm7 = zx.o(*rax_39)
            var_490 = rax_39[1].d
            void var_15c
            int64_t* rax_40
            int512_t zmm6_1
            rax_40, zmm6_1 = sub_142316040(&var_15c, rcx_8, rsi, var_458, rax_38)
            zmm6_1.o = zx.o(*rax_40)
            var_478 = rax_40[1].d
            void var_12c
            int64_t* rax_42
            rax_42, zmm6 = sub_142316040(&var_12c, rcx_8, rsi, var_458, rbx_2)
            zmm0 = zmm7
            var_498 = zmm7.d
            ...
            var_4a8_1 = _mm_shuffle_ps(zmm0, zmm0, 0x55).d
            zmm0 = zmm1
            var_4ac_1 = _mm_shuffle_ps(zmm0, zmm0, 0x55).d
            var_460 = result.d
            var_480 = zmm6.d
            var_468 = zmm1.d
        ...
        if (arg_18 == 0)
            ...
            void var_150
            int64_t* rax_43 = sub_142316040(&var_150, rcx_8, rsi, var_458, rdi_2.d)
            zmm8 = zx.o(*rax_43)
            int32_t rax_44 = rax_43[1].d
            void var_144
            int64_t* rax_45
            int512_t zmm6_2
            rax_45, zmm6_2 = sub_142316040(&var_144, rcx_8, rsi, var_458, rax_38)
            zmm6_2.o = zx.o(*rax_45)
            int32_t rax_46 = rax_45[1].d
            void var_138
            int64_t* rax_47
            rax_47, zmm6 = sub_142316040(&var_138, rcx_8, rsi, var_458, rbx_2)
            zmm3 = zmm10
            zmm12 = zmm9
            zmm4_1 = zmm10
            ...
            zmm1 = zx.o(*rax_47)
            zmm15 = zmm11
            zmm15[0] = zmm15[0] f* rax_44
            zmm0 = zmm1
            result = zx.q(rax_47[1].d)
            zmm2.d = zmm10.d f* rax_46
        ...
        if (var_170 != 0 || result_6 != 0)
            ...
            zmm0 = zmm10
            zmm1 = zmm10
            zmm10.d = zmm10.d f* var_480
            zmm8 = var_468
            zmm1[0] = zmm1[0] f* var_4a8_1
            int32_t var_2d4
            var_2c8 = &rdx_40[sx.q(var_2d4)]
            zmm7 = var_4ac_1
            zmm11[0] = zmm11[0] f* var_490
            zmm11[0] = zmm11[0] f* arg_20
            zmm11[0] = zmm11[0] f* var_498
            zmm0.d = zmm0.d f* var_478
        ...
        if (var_16e != 0)
            ...
            float var_2e8_1 = var_3f0_1
            uint64_t var_2f0_1 = (_mm_unpacklo_ps(zmm6, zmm8.q)).q
            int32_t var_244
            var_238 = &rdx_46[sx.q(var_244)]
            *rdx_46 = zmm6[0]
            void* var_220
            int32_t* rdx_47 = var_220
            int32_t var_22c
        ...
        if (var_16d != 0 || var_16c != 0)
            ...
            int16_t* r14_5 = rdi_2 * (zx.q(rsi[0x15].d) << 2) + rsi[0x13]
            ...
            if ((0x7c00 & rbx_3.w) == 0)
                ...
                if (rbx_4 != 0)
                    if (data_143cda914
                            s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (r13_3 << 3))))
                    ...
                    var_49c_1 = (rbx_4 << ((0xa - int.d(zmm0.d)).b + 0xd) & 0x7fffff)
                        | ((0x71 - (0xa - int.d(zmm0.d))) << 0x17 & 0x7f800000) | rdi_5
                else
                    var_49c_1 = rdi_5
            else if ((rbx_3.w & 0x7c00) != 0x7c00)
                var_49c_1 = ((rbx_3 u>> 0xa & 0x1f) + 0x70) << 0x17 | (rbx_3 & 0x3ff) << 0xd | rdi_5
            else
                var_49c_1 = rdi_5 | 0x477fe000
            ...
            if ((0x7c00 & rbx_11.w) == 0)
                ...
                if (rbx_12 != 0)
                    ...
                    zmm0.d = logf(zmm0.d).d f* data_143cda910
                    var_4a0_1 = (rbx_12 << ((0xa - int.d(zmm0.d)).b + 0xd) & 0x7fffff)
                ...
                var_4a0_1 = rdi_9 | 0x477fe000
            
            int16_t* r14_8 = zx.q(rax_38) * (zx.q(rsi[0x15].d) << 2) + rsi[0x13]
            uint32_t rbx_19 = zx.d(r14_8[1])
            ...
            int16_t* r14_11 = zx.q(var_4b4_1) * (zx.q(rsi[0x15].d) << 2) + rsi[0x13]
            uint32_t rbx_35 = zx.d(r14_11[1])
            ...
            if ((0x7c00 & rbx_43.w) == 0)
                ...
                if (rbx_44 != 0)
                    ...
                    zmm0.d = logf(zmm0.d).d f* data_143cda910
                    var_4a4_1 = (rbx_44 << ((0xa - int.d(zmm0.d)).b + 0xd) & 0x7fffff)
            ...
            uint128_t var_318_1 = data_142d3f660
        ...
        zmm2 = 0x3f800000
        cond:6_1 = var_488 + 1 s< *(arg2 + 0x40)
        rdx_27 = var_3e8_1
        r9_5 = var_3d0_1
        r10_2 = var_3d8_1
        r11_5 = var_444
