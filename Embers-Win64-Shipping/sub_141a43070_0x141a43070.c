...
if (*(arg1 + 0x10) s> 0)
    ...
    if (sub_141a47350(arg1, (arg_20.q).d, &arg_8) != 0)
        uint64_t rcx = *(arg1 + 8)
        ...
        if (r14_1.d s< 0 || r14_1.d s>= r12_1 || rax_5 s> 0 || r14_1.d == 0xffffffff)
            ...
            *(arg1 + 0x28) = r12_2 + 1
            ...
            int64_t rdx_4 = *(arg1 + 0x20) + (r14_1 << 2)
            memmove(rdx_4 + 4, rdx_4, (r12_2 - r14_1.d) << 2)
            rdi_1 = arg1 + 0x30
            *(*(arg1 + 0x20) + (r14_1 << 2)) = arg_8.d
        else
            *(*(arg1 + 0x20) + (r14_1 << 2)) = arg_8.d
...
if (i_2 s> 0)
    ...
    do
        int32_t rax_17 = *(r14_2 - r13_1 + rdi_2)
        
        if (rcx_9 == 0)
            if (rax_17 s> arg2)
            label_141a43272:
                int64_t r14_3 = sx.q(rdx_8)
                rdx_8 = (r14_3 + 1).d
                var_88.d = rdx_8
                ...
                rcx_9 = arg3
                *(rsi + (r14_3 << 2)) = *rdi_2
        else if (rax_17 s< arg2)
            goto label_141a43272
...
var_68 = rsi
var_68.o = var_68.o
int64_t result = sub_141a423a0(&var_58, &var_68)
