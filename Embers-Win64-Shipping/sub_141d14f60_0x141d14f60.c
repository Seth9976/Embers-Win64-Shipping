...
if (rax s<= 0)
    ...
    sub_141cf6b80()
    int64_t var_38
    sub_140a2e390(&var_38, u"TSparseArray<%s>", data_143f36ab0)
    void arg_18
    ...
    if (arg_10 s> 0)
        do
            ...
            void* rdi_3 = sx.q(rbx_1) * 0x50 + rax_2
            int32_t rax_3 = sub_140b56010(&arg_18, 8)
            void* rcx_5 = arg2[2]
            
            if ((rcx_5.b & 1) != 0)
                rcx_5 = (rcx_5 s>> 1) + &arg2[2]
            ...
            if (not(test_bit(*(rcx_5 + (sx.q(rax_4 s>> 5) << 2)), rbx_1 & 0x1f)))
                sub_140b518f0(rcx_8, rdi_3, 4)
                sub_140b518f0(&arg_18, rdi_3 + 4, 4)
            else
                sub_140b565a0(rcx_8, rdi_3, &data_143f36aa8)
            
            sub_140b567d0(&arg_18, rax_3 + 0x50)
            rbx_1 += 1
