...
if (data_143e8b498 s> *rdi_1)
    _Init_thread_header(&data_143e8b498)
    
    if (data_143e8b498 == 0xffffffff)
        ...
        data_143e8b490 = rax_9
        _Init_thread_footer(&data_143e8b498)

if (data_143e8b4a8 s> *rdi_1)
    _Init_thread_header(&data_143e8b4a8)
    
    if (data_143e8b4a8 == 0xffffffff)
        ...
        data_143e8b4a0 = rax_12
        _Init_thread_footer(&data_143e8b4a8)

if (data_143e8b4b8 s> *rdi_1)
    _Init_thread_header(&data_143e8b4b8)
    
    if (data_143e8b4b8 == 0xffffffff)
        ...
        data_143e8b4b0 = rax_15
        _Init_thread_footer(&data_143e8b4b8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b490
int64_t rcx
