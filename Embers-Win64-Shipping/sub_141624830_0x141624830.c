...
while (true)
    ...
    label_1416250a7:
        ...
        if (not(zmm13.d f<= zmm10[0]))
            ...
            zmm12[0] = zmm12[0] * temp0_35[0]
            zmm10[0] = zmm10[0] * temp0_35[0]
            *arg7 = (_mm_unpacklo_ps(zmm11, zmm12[0].q)).q
        ...
        if (i_6 s> 0)
            ...
            do
                ...
                *(rcx_7 + (rdx_11 << 2)) = *(&var_178 + rdi_2)
                *(rcx_7 + (rdx_11 << 2) + 8) = rax_22
                ...
                rdi_2 += 0xc
                *(rcx_9 + (rdx_13 << 2)) = zmm0_1
                *(rcx_9 + (rdx_13 << 2) + 8) = rax_24
                i_1 = i_5
                i_5 -= 1
            while (i_1 != 1)
        ...
        int32_t rax_25
        float zmm9_1[0x4]
        rax_25, zmm9_1, zmm10 = sub_141577800(&var_240, &var_260, &var_218, &var_1f0, &var_284, 
            &var_250, &var_228, &var_270)
        float zmm0_2[0x4]
        float zmm2_1[0x4]
        float zmm13_1[0x4]
    ...
    zmm0[0] = zmm0[0] f* *(rax_6 + 0x30)
    zmm3[0] = zmm3[0] * zmm2[0]
    zmm2 = var_298_1
    zmm5 = *arg3
    zmm2[0] = zmm2[0] * zmm1[0]
    float temp0_10[0x4] = _mm_unpacklo_ps(zmm3, zmm0[0].q)
    float temp0_11[0x4] = _mm_shuffle_ps(zmm5, zmm5, 0xc9)
    float temp0_12[0x4] = _mm_shuffle_ps(zmm5, zmm5, 0xd2)
    float temp0_14[0x4] = _mm_unpacklo_ps(temp0_10, _mm_unpacklo_ps(zmm2, zmm9[0].q)[0].q)
    float temp0_15[0x4] = _mm_shuffle_ps(zmm5, zmm5, 0xff)
    float temp0_17[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_14, temp0_14, 0xc9), temp0_12)
    float temp0_20[0x4] =
        _mm_sub_ps(_mm_mul_ps(_mm_shuffle_ps(temp0_14, temp0_14, 0xd2), temp0_11), temp0_17)
    float temp0_21[0x4] = _mm_add_ps(temp0_20, temp0_20)
    float temp0_22[0x4] = _mm_mul_ps(temp0_15, temp0_21)
    float temp0_24[0x4] = _mm_mul_ps(_mm_shuffle_ps(temp0_21, temp0_21, 0xc9), temp0_12)
    float temp0_25[0x4] = _mm_shuffle_ps(temp0_21, temp0_21, 0xd2)
    float temp0_26[0x4] = _mm_add_ps(temp0_22, temp0_14)
    float temp0_27[0x4] = _mm_mul_ps(temp0_25, temp0_11)
    zmm3 = var_270.d
    float temp0_28[0x4] = _mm_sub_ps(temp0_27, temp0_24)
    zmm0 = var_270:4.d
    float temp0_30[0x4] = __addps_xmmps_memps(_mm_add_ps(temp0_28, temp0_26), arg3[1])
    ...
    *(&var_1a8:4 + (sx.q(i_6) << 2)) = i_6
    ...
    int64_t rdx_2 = r8_2 * 3
    *(&var_148 + (rdx_2 << 2)) = zmm0.q
    zmm0 = zx.o(var_250)
    (&var_140)[rdx_2] = var_220
    int32_t i_7 = r8_2.d + 1
    var_1a8.d = r8_2.d + 1
    int64_t var_118
    *(&var_118 + (rdx_2 << 2)) = zmm0.q
    *(&var_178 + (rdx_2 << 2)) = zmm13.q
    int32_t var_110
    (&var_110)[rdx_2] = var_248
    (&var_170)[rdx_2] = r9_1
    int32_t var_278_1
    
    if (r8_2.d == 0)
        int64_t rax_14 = sx.q(var_1a8:4.d)
        int64_t rdx_6 = rax_14 * 3
        var_188[rax_14] = 0x3f800000
        zmm0 = zx.o(*(&var_118 + (rdx_6 << 2)))
        var_278_1 = (&var_110)[rdx_6]
    else
        uint64_t* rax_11
        ...
        label_141624dba:
            ...
            if (r8_2.d == 2)
                rax_11, zmm9 = sub_1416fa750(&var_240, &var_118, &var_1a8, &var_188)
                goto label_141624dba
            
            if (r8_2.d == 3)
                uint64_t var_1b8[0x2]
                rax_11, zmm9 = sub_1416f9c90(&var_1b8, &var_118, &var_1a8, &var_188)
                goto label_141624dba
