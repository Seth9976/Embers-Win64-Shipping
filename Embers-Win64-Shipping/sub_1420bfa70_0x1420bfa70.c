...
double zmm3 = 2.7777777777777777e-11
double zmm2[0x2] = zx.o(0)
zmm2[0] = fconvert.d(arg2)

if (not(zmm2[0] f>= float.d(-0x8000000000000000) f* zmm3))
    ...
    int32_t rax_2 = var_180_1 + 0xb
    var_180_1 = rax_2
    
    if (rax_2 s> 0)
        sub_140594770(&var_188)
    
    UnDecorator::getReferenceType(var_188, u"HoursValue", 0x16)
...
else if (zmm2[0] f<= float.d(0x7fffffffffffffff) f* zmm3)
    zmm2[0] = zmm2[0] * 36000000000.0
    zmm2[0] = zmm2[0] + 0.5
    int64_t rcx_18 = int.q(zmm2[0])
    
    if (rcx_18 != -0x8000000000000000 && not(float.d(rcx_18) f== zmm2[0]))
        uint32_t temp0_6 = _mm_movemask_pd(_mm_unpacklo_pd(zmm2, zmm2[0]))
        zmm2 = zx.o(0)
        zmm2[0] = float.d(rcx_18 - (zx.q(temp0_6) & 1))
    ...
    *arg1 = int.q(zmm2[0])
    ...
    int64_t var_178 = 0
    int32_t var_170_1 = 0
    sub_1405947f0(&var_178, 0xb)
    int32_t rax_6 = var_170_1 + 0xb
    var_170_1 = rax_6
    
    if (rax_6 s> 0)
        sub_140594770(&var_178)
    
    UnDecorator::getReferenceType(var_178, u"HoursValue", 0x16)
