...
while (true)
    ...
    if (rcx_7.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x1b0 && result == arg1 + 0x1a0)
        return result
    
    void* rbx_1 = *(*result + rcx_7 * 0x10)
    
    if (rbx_1 != 0)
        void* rax_22 = sub_140d21950(rbx_1, sub_14254cd20())
        
        if (rax_22 != 0)
            int64_t rdx_11 = *rax_22
            (*(rdx_11 + 0x40))(rax_22, rdx_11)
