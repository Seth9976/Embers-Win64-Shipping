...
label_141dffe9d:
    ...
    if (rsi != 1)
        ...
        zmm5.d = zmm5.d f- result_2.d
        zmm5.d = zmm5.d f/ _mm_cvtepi32_ps(zx.o(rax_20)).d
    else
        zmm5 = zx.o(0)
    ...
    result_1 = result
    result_1[0] = result_1[0] f- rax_25
...
*(arg2 + 0x10) = _mm_unpacklo_ps(result_3, _mm_unpacklo_ps(result_1, 0)[0].q)
return result
