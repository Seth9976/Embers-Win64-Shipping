...
void* rbx_2 = *arg1
*(rbx_2 + 0x2e8) = *(arg3 + 0x1a0)
sub_1407473e0(rbx_2 + 0x2f0, arg3 + 0x1a8)
*(rbx_2 + 0x308) = *(arg3 + 0x1b8)
*(rbx_2 + 0x310) = *(arg3 + 0x1c0)
int64_t* rbx_3 = *arg1
int64_t rax_20

if ((rbx_3[5].b & 0x20) == 0)
    rax_20 = (*(*rbx_3 + 0x220))(rbx_3)

if ((rbx_3[5].b & 0x20) != 0 || rax_20.b != 0)
    rax_20.b = 0x40
