...
if (data_143e8c5a0 s> *rdi_1)
    _Init_thread_header(&data_143e8c5a0)
    
    if (data_143e8c5a0 == 0xffffffff)
        ...
        data_143e8c598 = rax_12
        _Init_thread_footer(&data_143e8c5a0)

if (data_143e8c5c0 s> *rdi_1)
    _Init_thread_header(&data_143e8c5c0)
    
    if (data_143e8c5c0 == 0xffffffff)
        ...
        data_143e8c5b8 = rax_15
        _Init_thread_footer(&data_143e8c5c0)

if (data_143e8c5e0 s> *rdi_1)
    _Init_thread_header(&data_143e8c5e0)
    
    if (data_143e8c5e0 == 0xffffffff)
        ...
        data_143e8c5d8 = rax_18
        _Init_thread_footer(&data_143e8c5e0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c598
int64_t rcx
...
label_1412b3668:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412b3663
    
    rbx.b = 1
    goto label_1412b3668
