...
if (rbx_1 != r15_1)
    do
        ...
        int64_t* rax_4 = sub_140994e80(&var_28, &rbx_1[6])
        int16_t* const r14_1
        ...
        int64_t var_38
        int64_t* rax_5 = sub_140994920(&var_38, &rbx_1[2])
        ...
        sub_140a2e390(&var_58, 
            PolygonID:%s, PerimeterVertexIndicesAndInstanceIDs:%s, "
        "VertexIndicesAndInstanceIDsForEachHole:%s", r8_1)
