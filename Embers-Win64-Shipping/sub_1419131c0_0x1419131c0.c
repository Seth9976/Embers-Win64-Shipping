...
void* arg_20 = arg4
int64_t* var_a0 = &arg_20
char var_b8_1
char arg_30

if (data_143f01c92 == 0)
    var_b8_1 = arg_30
    sub_141959580(arg1, arg2, arg4)
else if (sub_140a80f10() != 0)
    var_b8_1 = arg_30
    sub_141959580(arg1, arg2, arg_20)
else
    ...
    *(arg3 + 8) = &rdi_3[1]
    ...
    char arg_28
    int128_t var_30_1 = (&arg_28).o
    void*** rax_4 = sub_140a82f30(0x30, 8)
    *rax_4 = &data_142ff5cc8
    *(rax_4 + 8) = var_48_1.o
    *(rax_4 + 0x18) = arg1.o
    rax_4[5] = zx.q(&arg_30)
    void**** (* var_88)(int64_t* arg1)
    void**** (* rax_5)(int64_t* arg1) = var_88
    
    if (rax_4 != -8)
        rax_5 = j_sub_141908b40
