...
if (rdx_1 == 0)
    ...
    if (rax_10 == 0)
        ...
        if (rdi != 0 && sub_1415d18f0(arg4, rdi, &var_178, arg6, &var_210, &var_200, &var_218) != 0)
            arg1[3].d = var_218[0]
        ...
        if (rdx_5 != 0
                && sub_1415d18f0(arg4, rdx_5, &var_178, arg6, &var_210, &var_200, &var_218) != 0)
            arg1[3].d = var_218[0]
    ...
    void** var_118
    sub_141703c00(&var_118, rdx_2, &var_1f0, zx.o(0))
    uint128_t zmm3_2
    ...
    var_1d8 = *(arg4 + 0x28)
    char rax_5 =
        sub_1417affb0(rcx_3, &var_118, &var_b8, zmm3_2, var_238_1, var_230_1, var_228_1, var_220_1)
