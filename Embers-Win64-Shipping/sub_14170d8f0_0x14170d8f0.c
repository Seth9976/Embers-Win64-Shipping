...
float var_a0
float* rax_5 = sub_14170d700(rcx_1, &var_a0, &var_c0)
uint128_t zmm8 = zx.o(*rax_5)
int32_t r15 = rax_5[2]
float* rax_6
float zmm6_1[0x4]
int128_t zmm7
int32_t zmm9_1
int32_t zmm11_1
rax_6, zmm6_1, zmm7, zmm9_1, zmm11_1 = sub_14170d700(rcx_1, &var_c0, arg2)
int64_t* rbx = arg1[2]
...
temp0[0] = temp0[0] f* zmm10.d
zmm0_1.d = zmm0_1.d f* zmm11_1
temp0[0] = temp0[0] + zmm6_1[0]
temp0[0] = temp0[0] f+ zmm0_1.d
zmm0_1.d = var_d8.d.d f- zmm8.d
zmm0_1.d = zmm0_1.d f* zmm9_1
float zmm1_1 = (var_d8:4.d f- _mm_shuffle_ps(zmm8, zmm8, 0x55).d) f* zmm10.d f+ zmm0_1.d
