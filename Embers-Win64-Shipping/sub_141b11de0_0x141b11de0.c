...
label_141b11f3c:
    ...
    if (r8_5 s> 0 && (rax_23 == 0 || rax_23 s< rbp))
        ...
        arg4[5] = *(rax_27 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_29 = *(r9_3 + 8)
    ...
    label_141b11e99:
        ...
        while (true)
            void* rdx_4 = sx.q(rbx_1) * 0x1c + *arg1
            
            if (*(rdx_4 + 0x10) == arg4[4] && ((*(rdx_4 + 0xc) ^ arg4[3]) | (*(rdx_4 + 8) ^ arg4[2])
                    | (*(rdx_4 + 4) ^ arg4[1]) | (*arg4 ^ *rdx_4)) == 0)
                break
            
            rbx_1 = *(rdx_4 + 0x14)
            
            if (rbx_1 == 0xffffffff)
                goto label_141b11e99
    ...
    if (rbx_1 == 0xffffffff)
        ...
        if (*(arg1 + 0x34) != 0)
            *(sx.q(arg1[6].d) * 0x1c + *arg1) = rcx_8.d
        
        int32_t* rax_13 = rcx_8 * 0x1c + *arg1
        *rax_13 = 0xffffffff
