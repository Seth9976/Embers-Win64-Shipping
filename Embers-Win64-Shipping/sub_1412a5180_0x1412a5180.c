...
if (data_143e8acd0 s> *rdi_1)
    _Init_thread_header(&data_143e8acd0)
    
    if (data_143e8acd0 == 0xffffffff)
        ...
        data_143e8acc8 = rax_12
        _Init_thread_footer(&data_143e8acd0)

if (data_143e8ace0 s> *rdi_1)
    _Init_thread_header(&data_143e8ace0)
    
    if (data_143e8ace0 == 0xffffffff)
        ...
        data_143e8acd8 = rax_15
        _Init_thread_footer(&data_143e8ace0)

if (data_143e8acf0 s> *rdi_1)
    _Init_thread_header(&data_143e8acf0)
    
    if (data_143e8acf0 == 0xffffffff)
        ...
        data_143e8ace8 = rax_18
        _Init_thread_footer(&data_143e8acf0)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8acc8
int64_t rcx
...
label_1412a5278:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412a5273
    
    rbx.b = 1
    goto label_1412a5278
