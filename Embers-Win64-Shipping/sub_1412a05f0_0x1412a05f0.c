...
if (data_143e8dc80 s> *rdi_1)
    _Init_thread_header(&data_143e8dc80)
    
    if (data_143e8dc80 == 0xffffffff)
        ...
        data_143e8dc78 = rax_9
        _Init_thread_footer(&data_143e8dc80)

if (data_143e8dca0 s> *rdi_1)
    _Init_thread_header(&data_143e8dca0)
    
    if (data_143e8dca0 == 0xffffffff)
        ...
        data_143e8dc98 = rax_12
        _Init_thread_footer(&data_143e8dca0)

if (data_143e8dcc0 s> *rdi_1)
    _Init_thread_header(&data_143e8dcc0)
    
    if (data_143e8dcc0 == 0xffffffff)
        ...
        data_143e8dcb8 = rax_15
        _Init_thread_footer(&data_143e8dcc0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8dc78
int64_t rcx
...
label_1412a06f0:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412a06ee
        
        rbx.b = 1
        goto label_1412a06f0
