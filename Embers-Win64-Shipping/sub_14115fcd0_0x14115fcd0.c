...
void*** rax = sub_14081d830(0x48, *(arg1 + 8), 1, 0)
void*** rsi = rax
...
if (rax == 0)
    ...
    if (data_143e744c8
        ...
        _Init_thread_header(&data_143e744c8)
        
        if (data_143e744c8 == 0xffffffff)
            int64_t (* i)(int64_t arg1, int64_t* arg2) = sub_1411b14c0
            var_48 = nullptr
            int32_t var_40_2 = 0
            ...
            sub_1419c2220(&data_143e74430, 0, FUploadParameters", FUploadParameters", 0, nullptr)
            int128_t* rcx_7 = var_48
            
            if (rcx_7 != 0)
                sub_140a74f90(rcx_7)
            
            atexit(sub_142cd50d0)
            _Init_thread_footer(&data_143e744c8)
    
    var_48 = arg3
    void* var_40_1 = &data_143e74460
    var_48.o = var_48.o
