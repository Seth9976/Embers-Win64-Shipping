...
label_140aa7bf6:
    ...
    if (r8_5 s> 0 && (rax_18 == 0 || rax_18 s< rbp))
        ...
        *(arg4 + 0x44) = rax_21
        ...
        arg4[8].d = *(rax_22 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2))
        void* rax_24 = *(r9_1 + 8)
        
        if (rax_24 != 0)
            r9_1 = rax_24
        
        *(r9_1 + (((sx.q(arg1[9].d) - 1) & r8_6) << 2)) = rdi_3
else
    int32_t r12_1 = -1
    int32_t rbx_1
    ...
    label_140aa7b1d:
        ...
        while (true)
            ...
            int64_t _MaxCount = sx.q(*(rdi_1 + rdx_3 + 8))
            
            if (_MaxCount.d == arg4[1].d && wcsncmp(*(rdi_1 + rdx_3), *arg4, _MaxCount) == 0)
                break
    ...
    if (rbx_1 == 0xffffffff)
        ...
        int64_t rcx_4 = sx.q(rbx_1) * 9
        int64_t rax_5 = *arg1
        void* rdi_2 = rax_5 + (rcx_4 << 3)
