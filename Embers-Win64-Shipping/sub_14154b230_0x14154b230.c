...
if (rsi != 0 && rdi != 0)
    ...
    float temp0_6[0x4] = _mm_unpacklo_ps(_mm_unpacklo_ps(data_14399f668, zmm0.q), 
    ...
    int96_t var_1c8_1 = _mm_unpacklo_ps(temp0_7, temp0_8[0].q)[0].12
    ...
    void* var_148_1 = arg1
    var_208.q = &data_142fc4870
    temp0_3[0].q = *(rsi + 0x10)
    uint128_t zmm0_2 = zx.o(*(rsi + 0x1c))
    temp0_3[2] = *(rsi + 0x18)
    float var_230_1 = arg7.d
    temp0_6[1] = *(rsi + 0x24)
    ...
    void* var_140_1 = arg2
    var_208:8.d = 0x1010101
    var_208:0xc.b = 1
    temp0_3[3].q = zmm0_2.q
    int128_t zmm6_3 = sub_1415e30d0(&var_1d8, &var_208, arg5, rdi, arg6, var_230_1)
    int128_t zmm1_3 = var_1c8_1:8.d
    
    if (not(zmm1_3.d f>= 3.40282347e+38f))
        int64_t var_124_2 = var_1d8[0].q
        float var_11c_2 = var_1d8[2]
        var_118_1.q = var_1d8[3].q
        var_118_1:0xc.d = zmm1_3.d
        var_118_1:8.d = var_1c8_1:4.d
    
    result = sub_1417599c0(arg8, zmm6_3, &var_1a8)
