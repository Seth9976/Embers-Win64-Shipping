...
if (data_143e8b718 s> *rdi_1)
    _Init_thread_header(&data_143e8b718)
    
    if (data_143e8b718 == 0xffffffff)
        ...
        data_143e8b710 = rax_12
        _Init_thread_footer(&data_143e8b718)

if (data_143e8b738 s> *rdi_1)
    _Init_thread_header(&data_143e8b738)
    
    if (data_143e8b738 == 0xffffffff)
        ...
        data_143e8b730 = rax_15
        _Init_thread_footer(&data_143e8b738)

if (data_143e8b758 s> *rdi_1)
    _Init_thread_header(&data_143e8b758)
    
    if (data_143e8b758 == 0xffffffff)
        ...
        data_143e8b750 = rax_18
        _Init_thread_footer(&data_143e8b758)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b710
int64_t rcx
...
label_1412bf068:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412bf063
    
    rbx.b = 1
    goto label_1412bf068
