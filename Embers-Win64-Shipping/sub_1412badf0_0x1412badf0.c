...
if (data_143e8c510 s> *rdi_1)
    _Init_thread_header(&data_143e8c510)
    
    if (data_143e8c510 == 0xffffffff)
        ...
        data_143e8c508 = rax_12
        _Init_thread_footer(&data_143e8c510)

if (data_143e8c530 s> *rdi_1)
    _Init_thread_header(&data_143e8c530)
    
    if (data_143e8c530 == 0xffffffff)
        ...
        data_143e8c528 = rax_15
        _Init_thread_footer(&data_143e8c530)

if (data_143e8c550 s> *rdi_1)
    _Init_thread_header(&data_143e8c550)
    
    if (data_143e8c550 == 0xffffffff)
        ...
        data_143e8c548 = rax_18
        _Init_thread_footer(&data_143e8c550)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c508
int64_t rcx
...
label_1412baee8:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412baee3
    
    rbx.b = 1
    goto label_1412baee8
