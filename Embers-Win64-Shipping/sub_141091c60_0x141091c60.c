...
arg2[9].b = 1
*(arg2 + 0x2c) = 2
int32_t r9 = *(arg1 + 0x154)
*(arg2 + 0x14) = divs.dp.d(sx.q(r9 - 1 + rcx_8.d), r9)
arg2[3].d = divs.dp.d(sx.q(r9 - 1 + (rcx_8 u>> 0x20).d), r9)
*arg2 = data_143f02308
arg2[2].d = data_143f02318
*(arg2 + 0x34) = (*(arg2 + 0x34) & 0xfffffffb) | 0x10009
arg2[8] = u"GTAOHorizonSearch"
return arg2
