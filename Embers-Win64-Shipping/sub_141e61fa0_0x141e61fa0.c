...
int32_t var_84 = 1
int32_t rdi = *(arg1 + 0x400)
int32_t rcx = 0
void* var_80 = arg1 + 0x3e8
int32_t var_88 = 0
...
if (rdi != 0)
    ...
    label_141e62048:
        ...
        while (true)
            ...
            if (rdx_2 != 0)
                goto label_141e62048
        
        var_74.d = rdi

int32_t rdx_4 = *(arg1 + 0x400)
...
var_74.d = rdx_4
int128_t var_68 = (arg1 + 0x3d8).o
int128_t var_58 = var_38

if (rdx_4 != rdi)
    void* rax_11 = *(arg1 + 0x3f8)
    void* r10_1 = arg1 + 0x3e8
...
while (true)
    ...
    if (rcx_7.d == (var_78_2.q u>> 0x20).d && var_58.q == arg1 + 0x3e8 && result == arg1 + 0x3d8)
        return result
    
    int64_t rdi_1 = sx.q(arg2[1].d)
    int64_t* r14_1 = *((rcx_7 << 5) + *result + 8)
    ...
    sub_141e4f730(rdi_1 * 0x88 + *arg2, r14_1)
    int32_t var_5c
