...
label_1428d2245:
    ...
    if (r14_2.d == 0)
        goto label_1428d22c3
    
    while (i != 0)
        i -= 1
        char rcx_3 = *(r14_2 + arg1 + 0x10) ^ *r12
        r12 += 1
        *r15 = rcx_3
        r15 += 1
        ...
        var_58_1 = r14_2.d
        *(rax_5 + arg1 + 0x188) = rcx_3
        
        if (r14_2.d == 0)
            goto label_1428d22a4
    ...
    label_1428d22c3:
        ...
        if (i != 0)
            ...
            *(arg1 + 0xe) = ((r13_7 + 1) u>> 8).b
            ...
            do
                char* rax_29 = zx.q(r14_2.d)
                r14_2 = zx.q(r14_2.d + 1)
                char rcx_10 = rax_29[r12] ^ *(rax_29 + arg1 + 0x10)
                *(rax_29 + r15) = rcx_10
