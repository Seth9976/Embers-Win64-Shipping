...
int32_t r10 = (data_1439cc058).d
int32_t rcx = 0
int32_t var_74 = 1
int32_t var_78 = 0
void* var_70 = &data_1439cc040
int32_t r8 = 0
...
while (true)
    ...
    if (result.d == ((0xffffffff << (r10.b & 0x1f)).q u>> 0x20).d && var_48.q == &data_1439cc040
            && rcx_4 == &data_1439cc030)
        return result
    
    sub_141a09810(*(*rcx_4 + result * 0x28 + 0x18))
