...
int64_t result = *(arg1 + 0x1e0)

if (result == 0)
    int32_t var_108 = result.d
    int64_t* rax_2 = sub_142a588d0(arg1 + 8, &var_108)
    ...
    EnterCriticalSection(arg1 + 0x1f0)
    ...
    if (*(arg1 + 0x1e0) == 0)
        ...
        if (arg1 + 0x1e0 != &var_100)
            *(arg1 + 0x1e0) = rbp_1
            var_100 = nullptr
            sub_1405aeff0(arg1 + 0x1e8, &var_f8)
            rdi_2 = var_f8
    ...
    if (arg1 != -0x1f0)
        LeaveCriticalSection(arg1 + 0x1f0)
    
    int64_t result_1 = *(arg1 + 0x1e0)
