...
int32_t result = *(arg1 + 0x264)
int32_t result_1 = 0x3c23d70a

if (not(result f< 0.00999999978f))
    result = __minss_xmmss_memss(result, 0x3f800000)
    result_1 = result
...
if (i_5.d s> 0)
    ...
    void var_48
    int64_t* rax_7 = sub_141a07bd0(&var_48, nullptr, 0xff)
    *(*rax_7 + 0x10) = rax_2.o
    void* rcx_9 = *rax_7
