...
int32_t* rsi_3 = sx.q(rbp.d) * 0x30 + *arg1
*rsi_3 = **arg3
*(rsi_3 + 8) = 0
rsi_3[4] = 0
sub_1407473e0(&rsi_3[2], rdi_3)
*(rsi_3 + 0x18) = 0
rsi_3[8] = 0
sub_1407473e0(&rsi_3[6], &rdi_3[2])
rsi_3[0xa] = 0xffffffff
sub_14187d470(arg1, arg2, *rsi_3, rsi_3, rbp.d, arg4)
return arg2
