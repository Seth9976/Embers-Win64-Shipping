    ...
    do
        ...
        if (rsi_1 s< arg2)
            do
                ...
                zmm2 = *(arg4 + 8)
                result = sx.q(r10_1.d)
                void* r8_2 = sx.q(r8.d) * 0x2c + arg1
                zmm4.d = zmm6.d f- *(r8_2 + 4)
                zmm1.d = zmm3.d f- *r8_2
                ...
                if (r8_2 != rdx_3)
                    int32_t rcx_2 = *(r8_2 + 0x28)
                    zmm3 = *r8_2
                    zmm4 = *(r8_2 + 0x10)
                    zmm2 = zx.o(*(r8_2 + 0x20))
                    *r8_2 = *rdx_3
                    *(r8_2 + 0x10) = *(rdx_3 + 0x10)
                    *(r8_2 + 0x20) = *(rdx_3 + 0x20)
                    *(r8_2 + 0x28) = *(rdx_3 + 0x28)
                    *rdx_3 = zmm3
                    *(rdx_3 + 0x10) = zmm4
                    *(rdx_3 + 0x20) = zmm2.q
                    *(rdx_3 + 0x28) = rcx_2
        ...
        if (i s> 1)
            do
                ...
                if (rdx_4 s< i)
                    zmm4 = *arg4
                    zmm3 = *(arg4 + 8)
                    int32_t* rcx_4 = sx.q(rdx_4) * 0x2c
                    zmm5 = zmm6.d f- *(rcx_4 + arg1 + 4)
                    zmm2.d = zmm4.d f- *(rcx_4 + arg1)
                    zmm0.d = zmm3.d f- *(rcx_4 + arg1 + 8)
                    int32_t* rcx_5 = sx.q(r10_2.d) * 0x2c
                    zmm2.d = zmm2.d f* zmm2.d
                    zmm0.d = zmm0.d f* zmm0.d
                    zmm1.d = zmm6.d f- *(rcx_5 + arg1 + 4)
                ...
                zmm2 = *(arg4 + 8)
                result = sx.q(r10_2.d)
                uint128_t* r8_5 = sx.q(r8_3.d) * 0x2c + arg1
                zmm4.d = zmm6.d f- *(r8_5 + 4)
                zmm1.d = zmm3.d f- *r8_5
                zmm0.d = zmm2.d f- *(r8_5 + 8)
                int128_t* rdx_6 = result * 0x2c + arg1
                zmm4.d = zmm4.d f* zmm4.d
                zmm1.d = zmm1.d f* zmm1.d
