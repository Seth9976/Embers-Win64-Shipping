...
if (data_143e8bf90 s> *rdi_1)
    _Init_thread_header(&data_143e8bf90)
    
    if (data_143e8bf90 == 0xffffffff)
        ...
        data_143e8bf88 = rax_12
        _Init_thread_footer(&data_143e8bf90)

if (data_143e8bfa0 s> *rdi_1)
    _Init_thread_header(&data_143e8bfa0)
    
    if (data_143e8bfa0 == 0xffffffff)
        ...
        data_143e8bf98 = rax_15
        _Init_thread_footer(&data_143e8bfa0)

if (data_143e8bfb8 s> *rdi_1)
    _Init_thread_header(&data_143e8bfb8)
    
    if (data_143e8bfb8 == 0xffffffff)
        ...
        data_143e8bfa8 = rax_18
        _Init_thread_footer(&data_143e8bfb8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8bf88
int64_t rcx
...
label_1412b6d68:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412b6d63
    
    rbx.b = 1
    goto label_1412b6d68
