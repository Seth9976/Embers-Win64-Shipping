...
if (result s> 0)
    ...
    do
        ...
        uint128_t temp0_2 = _mm_bsrli_si128(zmm5, 4)
        rbx_4 = &rbx_4[1]
        char rcx_6 = _mm_bsrli_si128(zmm4, 4).b
        uint128_t temp0_4 = _mm_bsrli_si128(zmm4, 8)
        int32_t rdx_4 = _mm_bsrli_si128(zmm5, 8).d
        uint128_t temp0_6 = _mm_bsrli_si128(zmm4, 0xc)
        result = _mm_bsrli_si128(zmm5, 0xc).d s>> temp0_6.b
        *r10_1 = _mm_unpacklo_epi32(
            _mm_unpacklo_epi32(zx.o(zmm5.d s>> zmm4.b), zx.q(rdx_4 s>> temp0_4.b)), 
            _mm_unpacklo_epi32(zx.o(temp0_2.d s>> rcx_6), zx.q(result))[0].q)
        i = r11_1
        r11_1 -= 1
    while (i != 1)
