...
data_143ef95d8 = (*(*rcx_2 + 0x78))(rcx_2, u"vr.SpectatorScreenMode", rbx_1, &var_38, 0)
data_143ef95d0 = &data_142d3ff10
int64_t* var_20
...
label_1404d010b:
    ...
    if (rcx_5 != 0)
        ...
        int32_t var_30_1 = 0
        goto label_1404d010b
return atexit(sub_142ceb910) __tailcall
