    ...
    do
        ...
        if (rbp_1 s< arg2)
            do
                ...
                if ((rdx_1 + 1).d s< arg2)
                    void* r11_1 = arg1 + (sx.q(r8_1) + 2) * 0x18
                    int64_t rcx = sx.q(rdx_1.d) * 3
                    int32_t rax_8 = *(r11_1 + 0xc)
                    int32_t temp4_1 = *(arg1 + (rcx << 3) + 0xc)
                    
                    if (rax_8 s< temp4_1)
                        rax_8.b = 1
                    else if (rax_8 s> temp4_1 || *(r11_1 + 0x10) s>= *(arg1 + (rcx << 3) + 0x10))
                        rax_8.b = 0
                    else
                        rax_8.b = 1
                ...
                int128_t* r9_2 = arg1 + sx.q(r9_1) * 0x18
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if ((result + 1).d s< i)
                    void* rbx_2 = arg1 + (sx.q(result_1) + 2) * 0x18
                    int64_t rdx_2 = sx.q(result.d) * 3
                    int32_t rcx_9 = *(rbx_2 + 0xc)
                    int32_t temp6_1 = *(arg1 + (rdx_2 << 3) + 0xc)
                    
                    if (rcx_9 s< temp6_1)
                        rcx_9.b = 1
                    else if (rcx_9 s> temp6_1 || *(rbx_2 + 0x10) s>= *(arg1 + (rdx_2 << 3) + 0x10))
                        rcx_9.b = 0
                    else
                        rcx_9.b = 1
                ...
                int32_t temp5_1 = *(arg1 + (rdx_4 << 3) + 0xc)
