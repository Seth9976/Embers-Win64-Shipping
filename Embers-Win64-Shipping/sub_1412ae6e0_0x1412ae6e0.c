...
if (data_143e8d098 s> *rdi_1)
    _Init_thread_header(&data_143e8d098)
    
    if (data_143e8d098 == 0xffffffff)
        ...
        data_143e8d090 = rax_9
        _Init_thread_footer(&data_143e8d098)

if (data_143e8d0b8 s> *rdi_1)
    _Init_thread_header(&data_143e8d0b8)
    
    if (data_143e8d0b8 == 0xffffffff)
        ...
        data_143e8d0b0 = rax_12
        _Init_thread_footer(&data_143e8d0b8)

if (data_143e8d0d8 s> *rdi_1)
    _Init_thread_header(&data_143e8d0d8)
    
    if (data_143e8d0d8 == 0xffffffff)
        ...
        data_143e8d0d0 = rax_15
        _Init_thread_footer(&data_143e8d0d8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d090
int64_t rcx
...
label_1412ae7e3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412ae7de
        
        rbx.b = 1
        goto label_1412ae7e3
