...
int32_t* rax_2 = sub_14282b41c(arg1)
*(arg1 + 0x83) = 0
...
if (rax_2.b == 0)
    ...
    if (rax_2 == 0)
        if (*(arg1 + 0x82) == rax_2.b)
            void var_48
            sub_14058a5c0(&var_48, "illegal map value")
            void var_b8
...
if (rcx_3 != 0)
    int128_t var_68
    sub_140688f70(rcx_3, var_68.q)
    int64_t* rcx_4 = var_70
    result = sub_14058ba50(rcx_4, (var_68:8.q - rcx_4) & 0xffffffffffffffe0)
    int64_t var_70_1
