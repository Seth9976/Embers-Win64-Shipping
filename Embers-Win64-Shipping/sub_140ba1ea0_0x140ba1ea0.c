...
label_140ba1fa0:
    ...
    if (r8_2 s> 0 && (rax_8 == 0 || rax_8 s< rbp))
        ...
        *(arg4 + 0x15c) = rax_11
        ...
        arg4[0x2b].d = *(rax_12 + (((sx.q(arg1[9].d) - 1) & r8_3) << 2))
        void* rax_14 = *(r9_2 + 8)
    ...
    label_140ba1f3c:
        ...
        while (true)
            int64_t* rcx_1 = sx.q(rbx_1) * 0x160
            
            if (*(rcx_1 + rdx_3) == *arg4)
                break
            
            rbx_1 = *(rcx_1 + rdx_3 + 0x158)
            
            if (rbx_1 == 0xffffffff)
                goto label_140ba1f3c
    ...
    if (rbx_1 == 0xffffffff)
        ...
        void* rdi_1 = sx.q(rbx_1) * 0x160 + *arg1
        sub_140d16260(rdi_1 + 8)
        memmove(rdi_1, arg4, 0x158)
        sub_140bb6a00(arg1, arg5, 1)
        rdi_2 = rbx_1
    
    if (rbx_1 == 0xffffffff)
        goto label_140ba1fa0
