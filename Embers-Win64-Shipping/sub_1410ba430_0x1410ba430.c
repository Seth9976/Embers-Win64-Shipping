...
if (data_143e2cc40 s> *rsi_1)
    _Init_thread_header(&data_143e2cc40)
    
    if (data_143e2cc40 == 0xffffffff)
        ...
        data_143e2cc38 = rax_6
        _Init_thread_footer(&data_143e2cc40)

uint32_t rax_2

if (data_143e2cc50 s> *rsi_1)
    int64_t r8_2
    rax_2, r8_2 = _Init_thread_header(&data_143e2cc50)
    
    if (data_143e2cc50 == 0xffffffff)
        ...
        data_143e2cc48 = rax_9
        _Init_thread_footer(&data_143e2cc50)

int64_t rbp = data_143e2cc48
uint16_t rsi_2
...
label_1410ba529:
    ...
    if (sub_1405fba70(rbx_1, 3) != 0 && (not.b(arg1[3].b) & 1) != 0 && arg1[4] u> 1
            && sub_1405fba70(rbx_1, 3) != 0)
        return 1
else
    char rax_3
