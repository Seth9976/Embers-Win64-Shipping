...
while (true)
    int64_t* r10_4 = sx.q(r11_1) * 0x90 + *rbx
    int64_t rcx_4 = *r10_4
    int32_t r8_9 = ((rcx_4 u>> 0x20).d * 0x17 + rcx_4.d) & (*rsi - 1)
    ...
    *(r10_4 + 0x8c) = r8_9
    ...
    r10_4[0x11].d = *(rax_17 + (((sx.q(*rsi) - 1) & r9_3) << 2))
    ...
    *(rax_19 + (((sx.q(*rsi) - 1) & r9_3) << 2)) = r11_1
