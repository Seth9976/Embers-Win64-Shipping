...
if (arg1 != arg2)
    ...
    if (rdx_5 != r11_1)
        ...
        int32_t rdx_9 = *(r11_2 + (sx.q(r9_3) << 2)) & r12_1
        int32_t var_64_6
        ...
        label_141fa7312:
            ...
            int32_t var_64_5 = r10_2 - rbx_1 + 0x1f
            
            if (r10_2 - rbx_1 + 0x1f s> r11_1)
                var_64_6 = r11_1
        else
            while (true)
