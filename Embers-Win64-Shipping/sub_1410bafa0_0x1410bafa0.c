...
if (data_143e2d310 s> *rdi_1)
    _Init_thread_header(&data_143e2d310)
    
    if (data_143e2d310 == 0xffffffff)
        ...
        data_143e2d308 = rax_8
        _Init_thread_footer(&data_143e2d310)

if (data_143e2d320 s> *rdi_1)
    _Init_thread_header(&data_143e2d320)
    
    if (data_143e2d320 == 0xffffffff)
        ...
        data_143e2d318 = rax_11
        _Init_thread_footer(&data_143e2d320)

int64_t rdi_2 = data_143e2d318
int64_t rcx
