...
if (data_143e8d870 s> *rdi_1)
    _Init_thread_header(&data_143e8d870)
    
    if (data_143e8d870 == 0xffffffff)
        ...
        data_143e8d868 = rax_9
        _Init_thread_footer(&data_143e8d870)

if (data_143e8d880 s> *rdi_1)
    _Init_thread_header(&data_143e8d880)
    
    if (data_143e8d880 == 0xffffffff)
        ...
        data_143e8d878 = rax_12
        _Init_thread_footer(&data_143e8d880)

if (data_143e8d898 s> *rdi_1)
    _Init_thread_header(&data_143e8d898)
    
    if (data_143e8d898 == 0xffffffff)
        ...
        data_143e8d888 = rax_15
        _Init_thread_footer(&data_143e8d898)
...
if ((rbx_1 != 0 || (*(rdi_2 + (rbx << 2)) & 0xfffffffd) == 0) && sub_1412c5c30(arg1).b != 0)
