...
if (data_143e8ba28 s> *rdi_1)
    _Init_thread_header(&data_143e8ba28)
    
    if (data_143e8ba28 == 0xffffffff)
        ...
        data_143e8ba20 = rax_12
        _Init_thread_footer(&data_143e8ba28)

if (data_143e8ba48 s> *rdi_1)
    _Init_thread_header(&data_143e8ba48)
    
    if (data_143e8ba48 == 0xffffffff)
        ...
        data_143e8ba40 = rax_15
        _Init_thread_footer(&data_143e8ba48)

if (data_143e8ba68 s> *rdi_1)
    _Init_thread_header(&data_143e8ba68)
    
    if (data_143e8ba68 == 0xffffffff)
        ...
        data_143e8ba60 = rax_18
        _Init_thread_footer(&data_143e8ba68)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8ba20
int64_t rcx
...
label_1412b94b8:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412b94b3
    
    rbx.b = 1
    goto label_1412b94b8
