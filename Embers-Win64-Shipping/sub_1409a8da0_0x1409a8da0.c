    ...
    do
        ...
        if ((0x800 & r9_1.w) == 0 && r8.d != 0 && *(r14 + 0xc) == 0)
            if ((not.b(*(sx.q(*rsi_2) + r14[0x15])) & 1) != 0)
                ...
                int32_t i_3 = i
                sub_1409965c0(&var_210, &var_1a0, &var_1c8, r9_1 u>> 7 & 0xf)
                ...
                *(arg3 + rdi_2 + 0x10) = zx.o(0)
                ...
                if (var_1a8_1 s> 0)
                    ...
                    if (j_8 s> 0)
                        ...
                        do
                            ...
                            zmm1.d = rcx_20[1].d f* zmm4.d
                            zmm0.d = zmm0.d f+ arg3[sx.q(*rsi_2) * 4].d
                            zmm1.d = zmm1.d f+ *(&arg3[sx.q(*rsi_2) * 4] + 4)
                            arg3[sx.q(*rsi_2) * 4].d = zmm0.d
                            *(&arg3[sx.q(*rsi_2) * 4] + 4) = zmm1.d
                ...
                zmm1.d = (*(rdi_2 + rax_29 + 4)).d f* zmm4.d
                zmm0.d = zmm0.d f+ arg3[sx.q(*rsi_2) * 4].d
                zmm1.d = zmm1.d f+ *(&arg3[sx.q(*rsi_2) * 4] + 4)
                arg3[sx.q(*rsi_2) * 4].d = zmm0.d
                *(&arg3[sx.q(*rsi_2) * 4] + 4) = zmm1.d
                ...
                *(&arg3[sx.q(*rsi_2) * 4] + 0xc) =
                ...
                zmm0.d = zmm0.d f+ arg3[sx.q(*rsi_2) * 4 + 2].d
                zmm1.d = (*(rdi_2 + rax_29 + 0x14)).d f* zmm4.d
                ...
                do
                    ...
                    *(arg3 + rdi_4 + 0x10) = zx.o(0)
                    ...
                    if ((*(rcx_27 + r14[0x15]) & 8) != 0)
                        ...
                        zmm0.d = (*rax_35).d f* 0.166666672f
                        zmm1.d = (*(rax_35 + 4)).d f* 0.166666672f
                        zmm0.d = zmm0.d f+ arg3[rcx_27 * 4].d
                        zmm1.d = zmm1.d f+ *(&arg3[rcx_27 * 4] + 4)
                        arg3[rcx_27 * 4].d = zmm0.d
                        *(&arg3[rcx_27 * 4] + 4) = zmm1.d
                        zmm0.d = rax_35[1].d.d f* 0.166666672f
                        zmm0.d = zmm0.d f+ arg3[rcx_27 * 4 + 1].d
                        arg3[rcx_27 * 4 + 1].d = zmm0.d
                        *(&arg3[rcx_27 * 4] + 0xc) =
                            *(rax_35 + 0xc) * 0.166666672f f+ *(&arg3[rcx_27 * 4] + 0xc)
                        zmm0.d = rax_35[2].d.d f* 0.166666672f
                        int32_t var_1f4
                        int64_t* rax_38 = (sx.q(var_1f4) << 5) + *arg2
                        zmm1.d = (*(rax_35 + 0x14)).d f* 0.166666672f
                        zmm0.d = zmm0.d f+ arg3[rcx_27 * 4 + 2].d
                        zmm2 = rax_35[3].d f* 0.166666672f
                        zmm3 = *(rax_35 + 0x1c) * 0.166666672f
                        arg3[rcx_27 * 4 + 2].d = zmm0.d
                        zmm1.d = zmm1.d f+ *(&arg3[rcx_27 * 4] + 0x14)
                        *(&arg3[rcx_27 * 4] + 0x14) = zmm1.d
                        arg3[rcx_27 * 4 + 3].d = zmm2 f+ arg3[rcx_27 * 4 + 3].d
                        *(&arg3[rcx_27 * 4] + 0x1c) = zmm3 f+ *(&arg3[rcx_27 * 4] + 0x1c)
                        zmm0.d = (*rax_38).d f* 0.166666672f
                        zmm1.d = (*(rax_38 + 4)).d f* 0.166666672f
                        zmm0.d = zmm0.d f+ arg3[rcx_27 * 4].d
                        zmm1.d = zmm1.d f+ *(&arg3[rcx_27 * 4] + 4)
                        arg3[rcx_27 * 4].d = zmm0.d
                        *(&arg3[rcx_27 * 4] + 4) = zmm1.d
                        zmm0.d = rax_38[1].d.d f* 0.166666672f
                        zmm0.d = zmm0.d f+ arg3[rcx_27 * 4 + 1].d
                        arg3[rcx_27 * 4 + 1].d = zmm0.d
                        *(&arg3[rcx_27 * 4] + 0xc) =
                            *(rax_38 + 0xc) * 0.166666672f f+ *(&arg3[rcx_27 * 4] + 0xc)
                        int64_t rax_39 = *arg2
                        zmm0.d = rax_38[2].d.d f* 0.166666672f
                        zmm1.d = (*(rax_38 + 0x14)).d f* 0.166666672f
                        zmm0.d = zmm0.d f+ arg3[rcx_27 * 4 + 2].d
                        zmm2 = rax_38[3].d f* 0.166666672f
                        zmm3 = *(rax_38 + 0x1c) * 0.166666672f
                        arg3[rcx_27 * 4 + 2].d = zmm0.d
                        zmm1.d = zmm1.d f+ *(&arg3[rcx_27 * 4] + 0x14)
                        *(&arg3[rcx_27 * 4] + 0x14) = zmm1.d
                        arg3[rcx_27 * 4 + 3].d = zmm2 f+ arg3[rcx_27 * 4 + 3].d
                        *(&arg3[rcx_27 * 4] + 0x1c) = zmm3 f+ *(&arg3[rcx_27 * 4] + 0x1c)
                        zmm0.d = (*(rdi_4 + rax_39)).d f* 0.666666687f
                        zmm0.d = zmm0.d f+ arg3[rcx_27 * 4].d
                        arg3[rcx_27 * 4].d = zmm0.d
                        i = i_1
                        zmm1.d = (*(rdi_4 + rax_39 + 4)).d f* 0.666666687f
                        zmm1.d = zmm1.d f+ *(&arg3[rcx_27 * 4] + 4)
                        *(&arg3[rcx_27 * 4] + 4) = zmm1.d
                        zmm0.d = (*(rdi_4 + rax_39 + 8)).d f* 0.666666687f
                        zmm0.d = zmm0.d f+ arg3[rcx_27 * 4 + 1].d
                        arg3[rcx_27 * 4 + 1].d = zmm0.d
                        *(&arg3[rcx_27 * 4] + 0xc) =
                            *(rdi_4 + rax_39 + 0xc) * 0.666666687f f+ *(&arg3[rcx_27 * 4] + 0xc)
                        zmm0.d = (*(rdi_4 + rax_39 + 0x10)).d f* 0.666666687f
                        zmm3 = *(rdi_4 + rax_39 + 0x1c) * 0.666666687f
                        zmm0.d = zmm0.d f+ arg3[rcx_27 * 4 + 2].d
                        zmm1.d = (*(rdi_4 + rax_39 + 0x14)).d f* 0.666666687f
                        zmm2 = *(rdi_4 + rax_39 + 0x18) * 0.666666687f
                    else
                        int64_t rax_32 = *arg2
                        zmm0.d = (*(rdi_4 + rax_32)).d f+ arg3[rcx_27 * 4].d
                        zmm1.d = (*(rdi_4 + rax_32 + 4)).d f+ *(&arg3[rcx_27 * 4] + 4)
                        arg3[rcx_27 * 4].d = zmm0.d
                        *(&arg3[rcx_27 * 4] + 4) = zmm1.d
            ...
            do
                ...
                rsi_2 = &rsi_2[1]
                int32_t* rcx_30 = rcx_29 << 5
                void* rax_42 = &arg3[rcx_29 * 4]
                *(rax_42 + 8) = 0
                *rax_42 = *(rax_42 + 8)
                *(rax_42 + 0x10) = zx.o(0)
                int64_t rax_43 = *arg2
                zmm0.d = (*(rcx_30 + rax_43)).d f+ *(rcx_30 + arg3)
                zmm1.d = (*(rcx_30 + rax_43 + 4)).d f+ *(rcx_30 + arg3 + 4)
                *(rcx_30 + arg3) = zmm0.d
                *(rcx_30 + arg3 + 4) = zmm1.d
                zmm0.d = (*(rcx_30 + arg3 + 8)).d f+ *(rcx_30 + rax_43 + 8)
                zmm2 = *(rcx_30 + rax_43 + 0xc) f+ *(rcx_30 + arg3 + 0xc)
                *(rcx_30 + arg3 + 8) = zmm0.d
                *(rcx_30 + arg3 + 0xc) = zmm2
                zmm1 = *(rcx_30 + rax_43 + 0x14)
                zmm2 = *(rcx_30 + rax_43 + 0x18)
                zmm3 = *(rcx_30 + rax_43 + 0x1c)
                zmm0.d = (*(rcx_30 + rax_43 + 0x10)).d f+ *(rcx_30 + arg3 + 0x10)
                *(rcx_30 + arg3 + 0x10) = zmm0.d
                zmm1.d = zmm1.d f+ *(rcx_30 + arg3 + 0x14)
                *(rcx_30 + arg3 + 0x14) = zmm1.d
                *(rcx_30 + arg3 + 0x18) = zmm2 f+ *(rcx_30 + arg3 + 0x18)
                *(rcx_30 + arg3 + 0x1c) = zmm3 f+ *(rcx_30 + arg3 + 0x1c)
                j_3 = j_5
                j_5 -= 1
            while (j_3 != 1)
        i += 1
