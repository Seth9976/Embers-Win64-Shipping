...
if (data_143ed9060 s> *rdi_1)
    _Init_thread_header(&data_143ed9060)
    
    if (data_143ed9060 == 0xffffffff)
        ...
        data_143ed9058 = rax_4
        _Init_thread_footer(&data_143ed9060)

if (data_143ed9058 == 0)
    goto label_1414a516b
...
if (data_143ed9070 s> *rdi_1)
    int64_t r8_2
    result, r8_2 = _Init_thread_header(&data_143ed9070)
    
    if (data_143ed9070 == 0xffffffff)
        ...
        data_143ed9068 = rax_7
        _Init_thread_footer(&data_143ed9070)

int64_t rdi_2 = data_143ed9068
