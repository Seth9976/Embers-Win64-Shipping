...
if (r9_2 s> 0)
    zmm10 = 0x7fffffffffffffff
    zmm11 = 0x3ddb7cdfd9d7bdbb
    ...
    do
        ...
        if (rax_19 s> 0)
            ...
            if (not(_mm_and_ps(zmm0, zmm10).q f<= zmm11.q))
        ...
        zmm6, zmm7, zmm8, zmm9, zmm10, zmm11 =
            sub_141c293f0(rbx, int.d(zmm1.q), int.d(zmm0.q), zmm3, rax_20 + (rcx_2 << 2))
