...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_7[4]
    sub_140d30490(arg2, &var_17c, r8_7)
else
    sub_140d30460(arg2, *(arg2 + 0x18), &var_17c)
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_9[4]
    sub_140d30490(arg2, &var_180, r8_9)
else
    sub_140d30460(arg2, *(arg2 + 0x18), &var_180)
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_11[4]
    sub_140d30490(arg2, &var_160, r8_11)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_15[4]
    sub_140d30490(arg2, &var_170, r8_15)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_21[4]
    sub_140d30490(arg2, &var_188, r8_21)
else
...
if (*(arg2 + 0x20) == 0)
    ...
    *(arg2 + 0x80) = r8_27[4]
    r9 = sub_140d30490(arg2, &var_184, r8_27)
else
    r9 = sub_140d30460(arg2, *(arg2 + 0x18), &var_184)
...
uint64_t var_128 = var_150
uint64_t var_118 = var_140
int32_t var_190 = var_184.d
int128_t* var_198 = &var_e8
int128_t var_d8
int128_t* var_1a0 = &var_d8
int64_t* rcx_15 = var_178
char var_1a8 = r12.b
void* var_1b0 = rsi
int32_t var_148
int32_t var_120 = var_148
int32_t var_138
int32_t var_110 = var_138
char rax_21 = arg_10
int32_t var_1d8 = var_180.d
*(arg2 + 0x20) = rdi + rax_18
var_d8 = zmm1
char result = sub_1420b5d70(rcx_15, &var_118, &var_128, r9, var_1d8, r15, r13.b, r14, rax_21)
*arg3 = result
int64_t rcx_17 = var_170

if (rcx_17 != 0)
    result = sub_140a74f90(rcx_17)

int64_t rcx_18 = var_160
