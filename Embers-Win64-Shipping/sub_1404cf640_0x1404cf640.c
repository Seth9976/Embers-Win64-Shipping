...
data_143ef9628 = (*(*rcx_2 + 0x78))(rcx_2, u"vr.HeadTracking.bEnforced", rbx_1, &var_38, 0)
data_143ef9620 = &data_142d3ff10
int64_t* var_20
...
label_1404cf7ab:
    ...
    if (rcx_5 != 0)
        ...
        int32_t var_30_1 = 0
        goto label_1404cf7ab
return atexit(sub_142ceb730) __tailcall
