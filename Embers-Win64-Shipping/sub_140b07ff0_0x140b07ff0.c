...
if (_String1 u>= rcx && _String1 u<= arg2[3] - 2 && *_String1 == 0x73)
    int32_t var_98_1 = 0
    int32_t var_94_1 = ((_String1 - rcx) s>> 1).d
    
    if (wcsncmp(_String1, &data_142d8c8c8, 1) == 0)
        void* var_a0_1 = &_String1[1]
        char var_78_1 = 1
        int64_t var_80_1 = var_98_1.q
        int128_t var_90 = _String1.o
        sub_140b1b710()
        int128_t zmm0_1 = data_143de69e0.o
        void** const var_58 = &data_142e769a8
