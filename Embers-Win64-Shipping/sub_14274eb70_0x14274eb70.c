...
if (result s> 0)
    ...
    do
        ...
        rsi_2 = &rsi_2[1]
        char rcx_1 = _mm_bsrli_si128(zmm3, 4).b
        uint128_t zmm1 = zmm3
        zmm3 = _mm_bsrli_si128(zmm3, 0xc)
        int32_t rax_2 = _mm_bsrli_si128(zmm2, 0xc)[0]
        char rcx_2 = _mm_bsrli_si128(zmm1, 8).b
        int32_t rdx_2 = _mm_bsrli_si128(zmm2, 8).d s>> rcx_2
        result = rax_2 s>> zmm3[0].b
        *r10_1 = _mm_unpacklo_epi32(_mm_unpacklo_epi32(zx.o(r9_1 s>> rcx), zx.q(rdx_2)), 
            _mm_unpacklo_epi32(zx.o(temp0_1.d s>> rcx_1), zx.q(result))[0].q)
        i = r11_1
        r11_1 -= 1
    while (i != 1)
