...
if (rbx.d != 1)
    ...
    if (rbx.d s< 2 || zmm0[0] <= 0f)
        result = sub_141df20c0(&var_88, sx.q((0 << 2).d) + rdi_1)
        *arg2 = *result
    else if (zmm0[0] < 1f)
        int32_t rdx = r9 - 2
        ...
        if (i_8.d == r10_1.d)
            result = sub_141df20c0(&var_88, sx.q((i_8 << 2).d) + rdi_1)
            *arg2 = *result
        else
            float zmm8[0x4] = *sub_141df20c0(&var_88, sx.q((i_8 << 2).d) + rdi_1)
            int32_t zmm6_1
            result, zmm6_1 = sub_141df20c0(&var_88, sx.q((r10_1 << 2).d) + rdi_1)
        ...
        result = sub_141df20c0(&var_88, sx.q(r10_1.d << 2) + rdi_1)
        *arg2 = *result
else
