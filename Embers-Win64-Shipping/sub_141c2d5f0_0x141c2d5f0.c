    ...
    do
        ...
        if (r12_1 s< arg2)
            do
                ...
                if ((rbx_1 + 1).d s< arg2)
                    if (sub_141c32870(arg4, arg1[sx.q(rsi_1) + 2], arg1[sx.q(rbx_1.d)]) != 0)
                        rbx_1 = zx.q(rsi_1)
                ...
                result = sub_141c32870(arg4, arg1[rax_8], arg1[rax_7])
        ...
        *arg1 = result
        ...
        if (j s> 1)
            ...
            do
                ...
                if ((rbx_2 + 1).d s< j)
                    if (sub_141c32870(arg4, arg1[sx.q(rsi_3) + 2], arg1[sx.q(rbx_2.d)]) != 0)
                        rbx_2 = zx.q(rsi_3)
                ...
                result = sub_141c32870(arg4, arg1[rax_15], arg1[rax_14])
