...
while (i != 0xffffffff)
    int64_t* rbx_1 = *arg1 + sx.q(i) * 0x18
    int16_t* rdx_1
    ...
    if (sub_140a54510(rcx_4, rdx_1) == 0)
        ...
        if (arg1[1].d != *(arg1 + 0x34))
            void* rdx_2 = *(r15 + 8)
            int64_t r8_1 = *arg1
            void* r9_1 = r8_1 + rbx_2 * 0x18
            int64_t rcx_7 = sx.q(arg1[9].d - 1) & sx.q(*(r9_1 + 0x14))
            ...
            while (j != 0xffffffff)
                ...
                int64_t j_1 = sx.q(j)
                int64_t rdx_5 = j_1 + ((j_1 + 1) << 1)
                j = *(r8_1 + (rdx_5 << 3))
                rdx_3 = r8_1 + (rdx_5 << 3)
        
        int64_t rcx_9 = *(*arg1 + rbx_2 * 0x18)
