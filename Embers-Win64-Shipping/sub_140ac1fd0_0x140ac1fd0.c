...
if (rsi[8].d s>= 0x1a6)
    arg3 = sub_140a1d9d0(*(*arg2 + 8), arg1 + 0x20, arg3)
...
if ((result.b & 2) != 0)
    ...
    *rcx_9 = 0
    ...
    result = sub_140a1d9d0(*(*arg2 + 8), &var_58, arg3)
    rcx_16 = var_58
label_140ac2263:
    ...
    uint64_t var_68 = 0
    int32_t var_60_1 = 0
    result = sub_140a1d9d0(*(rcx_17 + 8), &var_68, arg3)
