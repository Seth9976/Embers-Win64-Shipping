...
if (i_1 != 0)
    ...
    do
        void*** result_1 = sub_141041840(&var_158, *(r11 + (zx.q(r15_1) << 3) + 0x9d8))
...
if (rdi_3 != 0)
    ...
    int32_t var_238_1 = 1
    sub_14104ce20(&result[0xe], arg2, rax_33, rax_32, arg_18, arg_20)
    int64_t* rcx_23 = *arg7
