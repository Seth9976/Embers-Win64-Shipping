...
if (arg1 != arg2)
    ...
    if (rdx_5 != rbx_1)
        ...
        int32_t rdx_9 = *(rbx_2 + (sx.q(r9_3) << 2)) & r12_1
        int32_t var_64_6
    ...
    while (true)
        ...
        void* rdi_2 = rax_20 * 0x38 + *r8_2
        char rax_22 = *(rdi_2 + 0x28)
