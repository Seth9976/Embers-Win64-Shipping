...
int64_t var_360_1 = arg1 - 0x2c + sx.q(arg2) * 0x2c
...
while (true)
    ...
    if (rbp_1 == 0)
    label_142785763:
        sub_1427822f0(r11_1, rdx_3, zx.q(arg3), arg4)
    else
        while (true)
            uint128_t zmm0_2
            uint128_t zmm1
            ...
            if ((r9 - r11_1 - 0x2c) s/ 0x2c s< (i - r10_1) s/ 0x2c)
                if (i u> r10_1)
                    *r14_1 = r10_1
                    r14_1[1] = i
                    r14_1[2].d = rbp_1
