...
while (true)
    ...
    int32_t r8_7 = rdi_2[1].d
    int32_t rdx_8 = (rax_12 + (rbx_1 u>> 0x20).d - r8_7) ^ r8_7 u>> 0xd
    ...
    int32_t r8_17 = ((r8_13 - rcx_13 - rdx_14) ^ rcx_13 u>> 0xf) & (*r14 - 1)
    ...
    *(rdi_2 + 0x1c) = r8_17
    ...
    rdi_2[3].d = *(rax_31 + (((sx.q(*r14) - 1) & r8_18) << 2))
    void* rax_33 = arg1 + 0x38
    void* rcx_18 = *(arg1 + 0x40)
    
    if (rcx_18 != 0)
        rax_33 = rcx_18
    
    *(rax_33 + (((sx.q(*r14) - 1) & r8_18) << 2)) = r15_1
