...
if (rax_6 != 0)
    ...
    if ((arg1[5].b & 1) != 0)
        int512_t zmm1 = sub_14095c9f0(arg2, rax_6)
        int32_t r14 = 0
        ...
        do
            ...
            if (rdx_8 == neg.q(*arg2))
                ...
                __builtin_memset(rdx_9, 0, 0x30)
            
            sub_141e13300(arg1, rdx_9, zmm1)
            r14 += 1
        while (r14 s< arg_8)
    ...
    if (rax_6 s> 0)
        do
            sub_141e13300(arg1, sx.q(i) * 0x30 + *arg2, arg3)
            i += 1
        while (i s< arg2[1].d)
else if ((arg1[5].b & 1) != 0)
    sub_14095c9f0(arg2, 0)
