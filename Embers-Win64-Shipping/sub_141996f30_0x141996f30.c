...
CRITICAL_SECTION* lpCriticalSection = *(arg1 + 0x10) + 0x18
...
int32_t rax_1 = (*(*rcx_1 + 0x1e8))(rcx_1, 0xd)
...
rdi_1[5].d = r9_4
void var_58
int128_t* rax_21 = sub_141961e20(&var_58, rdx_3, 0xd, r9_4)
