...
float zmm15[0x4] = *(arg1 + 0x230)
uint32_t result =
    _mm_movemask_ps(__cmpps_xmmps_memps_immb(_mm_min_ps(zmm15, zmm8), data_143f3a220, 1))
float zmm6[0x4]
float zmm7[0x4]
float zmm14[0x4]
float zmm3[0x4]
...
if (result == 0)
    ...
    float temp0_137[0x4] = __mulps_xmmps_memps(temp0_134, data_143f3a1f0)
    ...
    float temp0_147[0x4] = __mulps_xmmps_memps(temp0_143, data_143f3a1e0)
    float temp0_148[0x4] = _mm_shuffle_ps(zmm4, zmm4, 0xd2)
    float temp0_149[0x4] = __mulps_xmmps_memps(temp0_146, data_143f3a1d0)
    ...
    float zmm11[0x4] = data_143f3a0a0
    ...
    float zmm1[0x4] = __andps_xmmxud_memxud(temp0_19, data_143f3a0b0)
    ...
    zmm1 = __andps_xmmxud_memxud(_mm_mul_ps(temp0_46, zmm15), data_143f3a0b0)
    ...
    uint32_t zmm0_1[0x4] = data_143f3a0c0
    float temp0_104[0x4] = _mm_cmpeq_ps(data_143f3a220, zmm14, 2)
    float zmm2[0x4] = var_e8[0]
    float zmm1_1 = var_e8[1]
    float zmm4_1[0x4] = _mm_and_ps(temp0_104, zmm0_1 ^ zmm11_1) ^ data_143f3a0c0
    zmm0_1 = var_e8[2]
    ...
    zmm6 = _mm_and_ps(_mm_mul_ps(temp0_126, zmm5_1) ^ data_143f3a200, zmm0_2) ^ data_143f3a200
    zmm7 = _mm_unpacklo_ps(_mm_unpacklo_ps(var_b8_1.d, var_b8_1:8.d[0].q), temp0_127[0].q)
*(arg1 + 0x210) = zmm6
*(arg1 + 0x220) = zmm7
*(arg1 + 0x230) = zmm14
zmm13[0] = zmm13[0] f+ *(arg1 + 0x244)
*(arg1 + 0x244) = zmm13[0]
return result
