...
if (data_143e8b2f8 s> *rdi_1)
    _Init_thread_header(&data_143e8b2f8)
    
    if (data_143e8b2f8 == 0xffffffff)
        ...
        data_143e8b2f0 = rax_12
        _Init_thread_footer(&data_143e8b2f8)

if (data_143e8b308 s> *rdi_1)
    _Init_thread_header(&data_143e8b308)
    
    if (data_143e8b308 == 0xffffffff)
        ...
        data_143e8b300 = rax_15
        _Init_thread_footer(&data_143e8b308)

if (data_143e8b318 s> *rdi_1)
    _Init_thread_header(&data_143e8b318)
    
    if (data_143e8b318 == 0xffffffff)
        ...
        data_143e8b310 = rax_18
        _Init_thread_footer(&data_143e8b318)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b2f0
int64_t rcx
...
label_1412c4978:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412c4973
    
    rbx.b = 1
    goto label_1412c4978
