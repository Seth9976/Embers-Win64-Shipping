...
if (data_143e8ce88 s> *rdi_1)
    _Init_thread_header(&data_143e8ce88)
    
    if (data_143e8ce88 == 0xffffffff)
        ...
        data_143e8ce80 = rax_9
        _Init_thread_footer(&data_143e8ce88)

if (data_143e8cea8 s> *rdi_1)
    _Init_thread_header(&data_143e8cea8)
    
    if (data_143e8cea8 == 0xffffffff)
        ...
        data_143e8cea0 = rax_12
        _Init_thread_footer(&data_143e8cea8)

if (data_143e8cec8 s> *rdi_1)
    _Init_thread_header(&data_143e8cec8)
    
    if (data_143e8cec8 == 0xffffffff)
        ...
        data_143e8cec0 = rax_15
        _Init_thread_footer(&data_143e8cec8)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8ce80
int64_t rcx
...
label_14129cb43:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_14129cb3e
        
        rbx.b = 1
        goto label_14129cb43
