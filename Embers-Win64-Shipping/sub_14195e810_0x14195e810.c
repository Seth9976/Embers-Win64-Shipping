        ...
        while (true)
            ...
            if (rdx_3 s<= 8)
                for (; i u> r11_1; i -= 0x28)
                    void* r8_5 = r11_1
                    void* rdx_12 = r11_1 + 0x28
                    
                    if (r11_1 + 0x28 u<= i)
                        do
                            void* rcx_16 = rdx_12
                            
                            if (*(r8_5 + 0x10) s<= *(rdx_12 + 0x10))
                                rcx_16 = r8_5
            ...
            while (true)
                ...
                if (r9_1 u<= i && r11_1[1].q s<= r9_1[1].q)
                    continue
