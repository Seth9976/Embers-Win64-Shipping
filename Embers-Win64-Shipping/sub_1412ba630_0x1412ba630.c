...
if (data_143e8c810 s> *rdi_1)
    _Init_thread_header(&data_143e8c810)
    
    if (data_143e8c810 == 0xffffffff)
        ...
        data_143e8c808 = rax_9
        _Init_thread_footer(&data_143e8c810)

if (data_143e8c830 s> *rdi_1)
    _Init_thread_header(&data_143e8c830)
    
    if (data_143e8c830 == 0xffffffff)
        ...
        data_143e8c828 = rax_12
        _Init_thread_footer(&data_143e8c830)

if (data_143e8c850 s> *rdi_1)
    _Init_thread_header(&data_143e8c850)
    
    if (data_143e8c850 == 0xffffffff)
        ...
        data_143e8c848 = rax_15
        _Init_thread_footer(&data_143e8c850)
...
if ((rbx_1 != 0 || (*(rdi_2 + (rbx << 2)) & 0xfffffffd) == 0) && sub_1412c5920(arg1).b != 0)
