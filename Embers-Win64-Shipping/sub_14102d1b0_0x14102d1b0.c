...
void var_588
uint64_t result = __security_cookie ^ &var_588
...
if (r14 != 0)
    uint64_t rflags_1
    int32_t temp0_1
    temp0_1, rflags_1 = _bit_scan_forward(r14)
    ...
    if (r14 != 0)
        do
            ...
            void* rbx_2 = r12_1 + 0x98 + rax_4 * 0x1b8
            
            if (*(rbx_2 + 0x60) != 0)
                sub_141018b50(rbx_2, rdx)
            
            sub_141037e50(r15, rsi_1)
            int64_t r15_1 = *(*(rbx_2 + 0x68) + 0xb0)
            int64_t var_b8
            memset(&var_b8, 0, 0x68)
            int64_t var_b0_1 = 0x40
            var_b8 = zx.q(*(rbx_2 + 0x18)) + r15_1
            int64_t var_a8_1 = zx.q(*(rbx_2 + 0x1c)) + r15_1
            uint64_t var_98_1 = zx.q(*(rbx_2 + 0x3c))
            uint64_t var_a0_1 = zx.q(*(rbx_2 + 0x10) * *(rbx_2 + 0x3c))
            
            if (*(rbx_2 + 0xc) != 0)
                int64_t var_78_1 = zx.q(*(rbx_2 + 0x28)) + r15_1
                uint64_t var_68_1 = zx.q(*(rbx_2 + 0x3c))
                uint64_t var_70_1 = zx.q(*(rbx_2 + 0xc) * *(rbx_2 + 0x3c))
            
            int64_t var_80_1 = 0
            int64_t var_90_1 = zx.q(*(rbx_2 + 0x20)) + r15_1
            ...
            r15 = arg2
            int64_t var_438_1 = *(r15 + 0x18)
            int64_t r8
            int64_t var_430_1 = r8
            int64_t r9
            int64_t var_138_1 = r9
            int64_t var_130_1 = r9
            sub_141037ee0(rbx_2, rsi_1)
            int64_t* var_560_1 = &var_b8
            sub_14101cf50(rsi_1, &var_538, r12_1, 0, 0)
            int32_t rax_24 = 1 << rdi_1.b
            rdi_1 = 0x20
            result = zx.q(not.d(rax_24)) & zx.q(r14)
            r14 = result.d
...
__security_check_cookie(result_1 ^ &var_588)
return result
