...
while (true)
    int64_t rcx_4 = sx.q(r12_1) * 3
    int64_t rax_13 = *rbx
    int64_t rbx_1 = *(rax_13 + (rcx_4 << 3))
    void* rsi_1 = rax_13 + (rcx_4 << 3)
    ...
    int32_t rcx_11 = (0x9e3779b9 - rdi_2 - r8_7) ^ rdi_2 << 8
    int32_t r8_10 = (r8_7 - rcx_11 - rdi_2) ^ rcx_11 u>> 0xd
    int32_t rdi_5 = (rdi_2 - rcx_11 - r8_10) ^ r8_10 u>> 0xc
    int32_t rcx_14 = (rcx_11 - rdi_5 - r8_10) ^ rdi_5 << 0x10
    int32_t r8_13 = (r8_10 - rcx_14 - rdi_5) ^ rcx_14 u>> 5
    int32_t rdi_8 = (rdi_5 - rcx_14 - r8_13) ^ r8_13 u>> 3
    int32_t rcx_17 = (rcx_14 - rdi_8 - r8_13) ^ rdi_8 << 0xa
    int32_t r8_17 = ((r8_13 - rcx_17 - rdi_8) ^ rcx_17 u>> 0xf) & (*r15 - 1)
    void* rax_32 = &arg1[7]
    *(rsi_1 + 0x14) = r8_17
    void* rdx_6 = arg1[8]
    ...
    *(rsi_1 + 0x10) = *(rax_32 + (((sx.q(*r15) - 1) & r8_18) << 2))
    void* rax_34 = &arg1[7]
    void* rcx_22 = arg1[8]
    ...
    *(rax_34 + (((sx.q(*r15) - 1) & r8_18) << 2)) = r12_1
