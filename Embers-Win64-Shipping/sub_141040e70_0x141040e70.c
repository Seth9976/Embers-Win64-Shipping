...
int64_t* r15 = arg1
void* rdi = arg2
void*** rax = j_sub_140a82f30(0x210)
...
if (rax == 0)
    ...
    int64_t var_140_1 = 0
    rdi = arg2
    void*** result_2 = sub_14103dfd0(rax, rdi, **r15, *r15[1], *r15[2], *r15[3], *r15[4], 
        (*r15[5]).b, *r15[6], *r15[7], r15[8] + 0x10)
    result = result_2
    result_1 = result_2

int64_t* r10_2 = r15[8]
void* rsi_2 = &result[0x16]
void* var_108 = rsi_2
int32_t r11_3
...
if (*r15[0xd] != 0)
    ...
    zmm6 = sub_14105aad0(&result[0xd], rdx_6)
    int32_t i = 0
    int32_t i_5 = 0
    ...
    if (**var_128 u> 0)
        do
            if (arg_18 == 0)
                ...
                if (r13_1 u< result[0x2e].d)
                    void* rcx_23 = &result[0x2c]
                ...
                int32_t j = 0
                int32_t j_1 = 0
                *(result + 0x17c) = zx.d(*(r15[0xa] + 0x1c))
                result[0x2f].b = 1
...
if (*r15[0x12] != 0)
    ...
    for (int32_t i_1 = 0; i_1 u< 4; i_1 += 1)
        ...
        if (i_1 u< 4)
            zmm6 = sub_1410407f0(&result[zx.q(i_1) + 0x30], rsi_4)
            rcx_25 = result[0x34].d
            
            if (i_1 + 1 u>= rcx_25)
                rcx_25 = i_1 + 1
            
            result[0x34].d = rcx_25
