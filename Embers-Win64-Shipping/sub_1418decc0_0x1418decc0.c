...
int32_t var_94 = 1
int32_t var_98 = 0
int32_t rdi = *(arg1 + 0x208)
void* var_90 = arg1 + 0x1f0
int32_t rcx_1 = 0
...
if (rdi != 0)
    void* rax_1 = *(arg1 + 0x200)
    void* r9_1 = arg1 + 0x1f0
    ...
    label_1418ded88:
        ...
        while (true)
            ...
            if (rdx_3 != 0)
                goto label_1418ded88
        
        var_84_2 = rdi

int32_t rdx_6 = *(arg1 + 0x208)
...
int128_t var_78 = (arg1 + 0x1e0).o
int96_t var_68 = var_48:8.12

if (rdx_6 != rdi)
    void* rax_11 = *(arg1 + 0x200)
    void* r10_1 = arg1 + 0x1f0
    ...
    label_1418dee52:
        ...
        while (true)
            ...
            if (rdx_10 != 0)
                goto label_1418dee52
        
        var_84_5 = rdi

int32_t i

while (i != (var_88_2.q u>> 0x20).d || var_68.q != arg1 + 0x1f0 || var_78.q != arg1 + 0x1e0)
    var_68:8.d &= not.d(var_78:0xc.d)
    sub_14059bdd0(&var_78:8)

sub_1409d9c00(arg1 + 0x288)
uint64_t result = sub_1408d84f0(arg1 + 0x48)

if (arg1 == -0x1b8)
    return result

return LeaveCriticalSection(arg1 + 0x1b8)
