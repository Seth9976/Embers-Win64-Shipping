...
if (data_143e8c0f8 s> *rdi_1)
    _Init_thread_header(&data_143e8c0f8)
    
    if (data_143e8c0f8 == 0xffffffff)
        ...
        data_143e8c0f0 = rax_9
        _Init_thread_footer(&data_143e8c0f8)

if (data_143e8c108 s> *rdi_1)
    _Init_thread_header(&data_143e8c108)
    
    if (data_143e8c108 == 0xffffffff)
        ...
        data_143e8c100 = rax_12
        _Init_thread_footer(&data_143e8c108)

if (data_143e8c120 s> *rdi_1)
    _Init_thread_header(&data_143e8c120)
    
    if (data_143e8c120 == 0xffffffff)
        ...
        data_143e8c110 = rax_15
        _Init_thread_footer(&data_143e8c120)
