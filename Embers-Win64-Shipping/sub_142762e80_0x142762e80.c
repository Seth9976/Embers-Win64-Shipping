...
if (result.d s> 0)
    ...
    do
        ...
        result_1 += 0x10
        float temp0_1[0x4] = _mm_mul_ps(data_143f877b0, zmm0)
        zmm0 = data_143f87690
        ...
        float temp0_12[0x4] = __mulps_xmmps_memps(
            _mm_mul_ps(_mm_sub_ps(zmm5, _mm_and_ps(zmm6, temp0_8)), temp0_8), data_143f87790)
        *result =
            _mm_mul_ps(__addps_xmmps_memps(_mm_and_ps(zmm6, temp0_12), data_143f87780), temp0_12)
        i = i_1
        i_1 -= 1
    while (i != 1)
