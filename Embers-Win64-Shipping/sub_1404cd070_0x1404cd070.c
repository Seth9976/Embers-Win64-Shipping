...
int32_t rdi = (data_143ef86b8.q).d
int64_t var_38 = 0
sub_1405a4c70(&var_38, sbb.d(arg1, arg1, rdi != 0) + 7 + rdi, 0)
memcpy(var_38, data_143ef86b0, rdi * 2)
...
if (rdi s> 1)
    ...
    data_143ef86f0 = var_28
    data_143ef86f8 = rdi
    data_143ef86fc = var_2c
    rcx_4 = var_18
else
    int32_t rbx_1 = (data_143ef86e8.q).d
    int64_t rdi_1 = data_143ef86e0
    data_143ef86f0 = 0
    data_143ef86f8 = rbx_1
    
    if (rbx_1 != 0)
        sub_1405a4c70(&data_143ef86f0, rbx_1, 0)
        memcpy(data_143ef86f0, rdi_1, rbx_1 * 2)
        rcx_4 = rcx_4
    else
        data_143ef86fc = 0
...
return atexit(sub_142ceb430) __tailcall
