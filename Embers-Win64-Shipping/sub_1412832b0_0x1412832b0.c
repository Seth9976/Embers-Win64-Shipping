...
if (data_143e8b908 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8b908)
    
    if (data_143e8b908 == 0xffffffff)
        ...
        data_143e8b900 = rax_6
        _Init_thread_footer(&data_143e8b908)

int64_t rbx = data_143e8b900
int64_t rcx
