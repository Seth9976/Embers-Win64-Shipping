...
if (r11 != 0)
    ...
    label_140f00f38:
        ...
        while (true)
            ...
            if (rdx_2 != 0)
                goto label_140f00f38
        
        var_84.d = r11

int32_t rdx_4 = *(arg1 + 0xd0)
...
while (true)
    ...
    if (rcx_7.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0xb8 && rax_20 == arg1 + 0xa8)
        *arg2 = 0
        return arg2
    
    int64_t* r8_6 = (rcx_7 << 5) + *rax_20
    int64_t* rax_21 = r8_6[1]
    void* rdx_9 = &rax_21[sx.q(r8_6[2].d)]
