...
rax_3, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13, zmm15 =
    sub_1416ce910(arg1, arg2, arg3, arg4, var_258)
int32_t rdi_1
...
if (rax_3 != 0)
    ...
    if (rcx_7 == 0)
    label_1415a9539:
        zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm14, zmm15_1 =
            sub_14154a2a0(*arg1, *arg2, &var_128, var_160, arg7, var_170, arg9)
        rdi_1 = 1
    else
        while (true)
            zmm1_1 = 0x80000000
            ...
            if (rdx_5 s< 0x80)
                ...
                label_1415a94e9:
                    ...
                    zmm7 = rsi_5[5] ^ zmm1_1
                    zmm11 = rsi_5[3] ^ zmm1_1
                    void* rcx_13 = *arg3
                    void* rax_23 = *(rcx_13 + 0x10)
                    arg5.d = (*(rcx_13 + 0x28)).d f* *(rax_23 + 0x10)
                    zmm13 = *(rax_23 + 0x14)
                    zmm15 = *(rax_23 + 0x18)
                    int128_t* rax_24 = r12[2]
                    zmm13[0] = zmm13[0] f* *(rcx_13 + 0x2c)
                    zmm15.d = zmm15.d f* *(rcx_13 + 0x30)
                    zmm8 = *(rax_24 + 4)
                    zmm9 = *(rax_24 + 8)
                    float zmm3_1[0x4] = *rax_24
                    float zmm2_1[0x4] = *(rax_24 + 0xc)
                    void* rax_25 = *r12
                    ...
                    int32_t var_1a0_1 = arg5.d
                    float var_19c_1 = zmm13[0]
                    zmm7[0] = zmm7[0] * zmm3_1[0]
                    int32_t var_198_1 = zmm15.d
                    ...
                    float var_1ec_1 = zmm13[0]
                    zmm13[0] = zmm13[0] f* rsi_5[4]
                    zmm0_1 = __andps_xmmxud_memxud(zmm12, data_142d3f770)
                    int32_t var_1f0 = arg5.d
                    arg5.d = arg5.d f* rsi_5[3]
                    int32_t var_1e8_3 = zmm15.d
                    zmm15.d = zmm15.d f* rsi_5[5]
                    zmm13[0] = zmm13[0] f+ arg5.d
                    zmm13[0] = zmm13[0] f+ zmm15.d
                    zmm13 = __minss_xmmss_memss(zmm13[0], var_1f8)
                    var_1f8 = zmm13[0]
                    ...
                    if (__andps_xmmxud_memxud(zmm13, data_142d3f770)[0] <= zmm0_1[0])
                        zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm13_1, zmm14, 
                            zmm15_1 = sub_14154a2a0(*r14, *r15, rsi_5, var_160, arg7, var_170, arg9)
                        rsi_1 = var_230
                        rdi_1 = 0
                        break
                    ...
                    if (not(zmm13[0] < zmm12[0]))
                        ...
                        *(rcx_15 + (rdx_10 << 2)) = var_1a0_1.q
                        *(rcx_15 + (rdx_10 << 2) + 8) = var_198_1
                        ...
                        var_228_1.d = 0
                        *(rcx_17 + (rdx_12 << 2)) = var_190_1.q
                        *(rcx_17 + (rdx_12 << 2) + 8) = var_188_1
                        rsi_5[0xd].b = 1
                        ...
                        if (r8_10 s>= 3)
                            ...
                            if (r8_10 s<= 0)
                                ...
                                do
                                    ...
                                    int64_t r10_8 = r12_3 * 0x38 + rcx_21
                                    ...
                                    int64_t rcx_24 = rax_51 * 3
                                    zmm10 = *(rdx_20 + (rcx_24 << 2))
                                    zmm10[0] = zmm10[0] f- *(r8_11 + (rcx_24 << 2))
                                    zmm6 = *(rdx_20 + (rcx_24 << 2) + 4)
                                    zmm6[0] = zmm6[0] f- *(r8_11 + (rcx_24 << 2) + 4)
                                    zmm11 = *(rdx_20 + (rcx_24 << 2) + 8)
                                    zmm11[0] = zmm11[0] f- *(r8_11 + (rcx_24 << 2) + 8)
                                    int64_t rcx_25 = sx.q(rax_49) * 3
                                    ...
                                    zmm4_1 = *(rdx_20 + (rcx_25 << 2) + 4)
                                    zmm7[0] = zmm7[0] - zmm6[0]
                                    zmm5_1[0] = zmm5_1[0] f- *(r8_11 + (rcx_25 << 2))
                                    zmm4_1[0] = zmm4_1[0] f- *(r8_11 + (rcx_25 << 2) + 4)
                                    ...
                                    *(r10_8 + (r14_2 << 2) + 0x28) = 0
                                    ...
                                    if (not(zmm0_1[0] < zmm12[0]) && not(zmm0_1[0] > zmm13[0]))
                                        char rax_58
                                        rax_58, zmm12, zmm13 = sub_141743d50(r9_5, *r14, *r15)
                            ...
                            r13 = var_228_1:4.d
                            goto label_1415a94e9
            
        label_1415a9502:
            rsi_1 = var_230
            goto label_1415a9539
