...
if (data_143e8cb58 s> *rdi_1)
    _Init_thread_header(&data_143e8cb58)
    
    if (data_143e8cb58 == 0xffffffff)
        ...
        data_143e8cb50 = rax_12
        _Init_thread_footer(&data_143e8cb58)

if (data_143e8cb68 s> *rdi_1)
    _Init_thread_header(&data_143e8cb68)
    
    if (data_143e8cb68 == 0xffffffff)
        ...
        data_143e8cb60 = rax_15
        _Init_thread_footer(&data_143e8cb68)

if (data_143e8cb78 s> *rdi_1)
    _Init_thread_header(&data_143e8cb78)
    
    if (data_143e8cb78 == 0xffffffff)
        ...
        data_143e8cb70 = rax_18
        _Init_thread_footer(&data_143e8cb78)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8cb50
int64_t rcx
