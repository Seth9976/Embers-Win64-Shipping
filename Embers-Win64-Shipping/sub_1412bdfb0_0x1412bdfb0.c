...
if (data_143e8b658 s> *rdi_1)
    _Init_thread_header(&data_143e8b658)
    
    if (data_143e8b658 == 0xffffffff)
        ...
        data_143e8b650 = rax_9
        _Init_thread_footer(&data_143e8b658)

if (data_143e8b668 s> *rdi_1)
    _Init_thread_header(&data_143e8b668)
    
    if (data_143e8b668 == 0xffffffff)
        ...
        data_143e8b660 = rax_12
        _Init_thread_footer(&data_143e8b668)

if (data_143e8b678 s> *rdi_1)
    _Init_thread_header(&data_143e8b678)
    
    if (data_143e8b678 == 0xffffffff)
        ...
        data_143e8b670 = rax_15
        _Init_thread_footer(&data_143e8b678)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b650
int64_t rcx
...
label_1412be0b3:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412be0ae
        
        rbx.b = 1
        goto label_1412be0b3
