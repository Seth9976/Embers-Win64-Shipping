...
if (data_143e8e6f0 s> *rdi_1)
    _Init_thread_header(&data_143e8e6f0)
    
    if (data_143e8e6f0 == 0xffffffff)
        ...
        data_143e8e6e8 = rax_12
        _Init_thread_footer(&data_143e8e6f0)

if (data_143e8e700 s> *rdi_1)
    _Init_thread_header(&data_143e8e700)
    
    if (data_143e8e700 == 0xffffffff)
        ...
        data_143e8e6f8 = rax_15
        _Init_thread_footer(&data_143e8e700)

if (data_143e8e710 s> *rdi_1)
    _Init_thread_header(&data_143e8e710)
    
    if (data_143e8e710 == 0xffffffff)
        ...
        data_143e8e708 = rax_18
        _Init_thread_footer(&data_143e8e710)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e6e8
int64_t rcx
...
label_1412a7728:
    ...
    if (rdi_4 s< 3 || rsi == 1)
        goto label_1412a7723
    
    rbx.b = 1
    goto label_1412a7728
