...
int64_t arg_58
int64_t rdi = arg_58
int32_t* var_f0 = &arg_20
int32_t arg_30
int32_t* var_e0 = &arg_30
int32_t arg_40
int32_t* var_d0 = &arg_40
int32_t arg_50
int32_t* var_c0 = &arg_50
int64_t var_100_1
int32_t arg_28
char arg_38
int32_t arg_48
...
if (data_143f01c92 == 0)
    var_100_1 = rdi
    sub_1419451a0(arg1, arg2, arg4, arg_28, arg_30, arg_38, arg_40, arg_48, arg_50)
else if (sub_140a80f10() != 0)
    var_100_1 = rdi
    sub_1419451a0(arg1, arg2, arg_20, arg_28, arg_30, arg_38, arg_40, arg_48, arg_50)
else
    ...
    *(arg3 + 8) = &rdi_3[1]
    ...
    int64_t* var_68_1 = &arg_58
    int128_t var_30_1 = (&arg_48).o
    void*** rax_4 = sub_140a82f30(0x58, 8)
    *rax_4 = &data_142ff5c88
    *(rax_4 + 8) = var_68_1.o
    *(rax_4 + 0x18) = var_60_1
    double var_48[0x2]
    *(rax_4 + 0x28) = var_48
    *(rax_4 + 0x38) = (&arg_38).o
    *(rax_4 + 0x48) = __unpcklpd_xmmpd_memdq(var_30_1, rdi.o)
    void**** (* var_a8)(int64_t* arg1)
    void**** (* rax_5)(int64_t* arg1) = var_a8
    
    if (rax_4 != -8)
        rax_5 = j_sub_1419087e0
