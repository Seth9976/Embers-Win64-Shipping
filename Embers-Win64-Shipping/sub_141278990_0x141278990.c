...
if (data_143e8a840 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8a840)
    
    if (data_143e8a840 == 0xffffffff)
        ...
        data_143e8a838 = rax_6
        _Init_thread_footer(&data_143e8a840)

int64_t rbx = data_143e8a838
int64_t rcx
