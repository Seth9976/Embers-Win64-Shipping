...
if (rdi.b == 0)
    ...
    if (arg3 != 0)
        ...
        char** rax_11 = sub_140a96390(&var_e8, 
            _vfprintf_p_l(&var_110, The URI scheme '{0}' is not supported", FAvfMediaFactoryModule"))
        ...
        *(rax_38 + (rdx_9 << 3) + 0x10) = r13_1
        ...
        if (rdi_2 != 0)
            goto label_1408fcbfd
else if (arg3 != 0)
    void var_170
    int64_t* rax_4 = _vfprintf_p_l(&var_170, u"No URI scheme found", u"FAvfMediaFactoryModule")
