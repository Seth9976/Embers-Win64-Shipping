...
if (data_143f308f8 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143f308f8)
    
    if (data_143f308f8 == 0xffffffff)
        ...
        data_143f308f0 = rax_36
        _Init_thread_footer(&data_143f308f8)
