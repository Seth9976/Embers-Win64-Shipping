                ...
                if ((rcx_13 == 0 || r8_7 u< divu.dp.d(0:0xffffffff, rcx_13))
                    ...
                    if (arg2[6] s> 0 && r14_2 u<= r15_1)
                        ...
                        label_142c26ab4:
                            ...
                            if (rbx_1.d u< 0x1fffffff
                                    && sub_142bf7510(arg2, rdx_8, (rbx_1 << 3).d).b != 0)
                                uint64_t rcx_18 = zx.q(var_48_1)
                                arg2[6] += rcx_18.d - rbx_1.d
                                
                                if (arg2[6] s> 0)
                                    for (void* i_1 = rdx_8 + (rcx_18 << 3); 
                                            i_1 u< rdx_8 + (zx.q(rbx_1.d) << 3); i_1 += 8)
                                        uint32_t rcx_20 = zx.d(*(i_1 + 1)) + (zx.d(*i_1) << 8)
