...
*rdx_8 |= 1 << (rbp.b & 0x1f)
char* rbx_2 = arg3[1]
int64_t* rdi_5 = sx.q(rbp.d) * 0x60 + *arg1
sub_140596d10(rdi_5, *arg3)
sub_140ae6310(&rdi_5[2], rbx_2)
rdi_5[0xb].d = 0xffffffff
...
int32_t rcx_12 = rax_15 - 1

if (rax_15 == 0)
    rcx_12 = 0

sub_140aee460(arg1, arg2, sub_1405969c0(rcx_12, rdx_11), rdi_5, rbp.d, arg4)
return arg2
