...
if (data_143e8e310 s> *rdi_1)
    _Init_thread_header(&data_143e8e310)
    
    if (data_143e8e310 == 0xffffffff)
        ...
        data_143e8e308 = rax_12
        _Init_thread_footer(&data_143e8e310)

if (data_143e8e320 s> *rdi_1)
    _Init_thread_header(&data_143e8e320)
    
    if (data_143e8e320 == 0xffffffff)
        ...
        data_143e8e318 = rax_15
        _Init_thread_footer(&data_143e8e320)

if (data_143e8e330 s> *rdi_1)
    _Init_thread_header(&data_143e8e330)
    
    if (data_143e8e330 == 0xffffffff)
        ...
        data_143e8e328 = rax_18
        _Init_thread_footer(&data_143e8e330)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e308
int64_t rcx
...
label_1412ad038:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412ad033
    
    rbx.b = 1
    goto label_1412ad038
