...
if (data_143e8a850 s> *rdi_1)
    _Init_thread_header(&data_143e8a850)
    
    if (data_143e8a850 == 0xffffffff)
        ...
        data_143e8a848 = rax_9
        _Init_thread_footer(&data_143e8a850)

if (data_143e8a860 s> *rdi_1)
    _Init_thread_header(&data_143e8a860)
    
    if (data_143e8a860 == 0xffffffff)
        ...
        data_143e8a858 = rax_12
        _Init_thread_footer(&data_143e8a860)

if (data_143e8a870 s> *rdi_1)
    _Init_thread_header(&data_143e8a870)
    
    if (data_143e8a870 == 0xffffffff)
        ...
        data_143e8a868 = rax_15
        _Init_thread_footer(&data_143e8a870)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8a848
int64_t rcx
