...
int64_t result = (*(*rcx_16 + 0x100))(rcx_16, zx.q(*(arg2 + 0x18)), 
    zx.q(*(rcx_15 + 0x38) * r15) + *(rcx_15 + 0x48))
*(arg3 + 0x20) |= not.q((1 << arg4.b) - 1)
