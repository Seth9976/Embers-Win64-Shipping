...
if (data_143e8af30 s> *rdi_1)
    _Init_thread_header(&data_143e8af30)
    
    if (data_143e8af30 == 0xffffffff)
        ...
        data_143e8af28 = rax_9
        _Init_thread_footer(&data_143e8af30)

if (data_143e8af40 s> *rdi_1)
    _Init_thread_header(&data_143e8af40)
    
    if (data_143e8af40 == 0xffffffff)
        ...
        data_143e8af38 = rax_12
        _Init_thread_footer(&data_143e8af40)

if (data_143e8af50 s> *rdi_1)
    _Init_thread_header(&data_143e8af50)
    
    if (data_143e8af50 == 0xffffffff)
        ...
        data_143e8af48 = rax_15
        _Init_thread_footer(&data_143e8af50)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8af28
int64_t rcx
...
label_1412c2243:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412c223e
        
        rbx.b = 1
        goto label_1412c2243
