...
if ((result.b & 1) != 0)
    ...
    if (sub_140834b00(&i_2) != 0)
        ...
        if (r8_3 != rcx_13)
            while (*rax_12 != i_3 || rax_12[1].w != var_10_1)
                rax_12 = &rax_12[2]
                
                if (rax_12 == rcx_13)
                    goto label_1407ba857
    ...
    void* rcx_18 = &r8_4[rbx_4 * 2]
    i_2 = i_1
    int16_t result_1 = 3
    int16_t var_c_2 = 0xffff
    
    if (r8_4 != rcx_18)
        while (*rax_17 != i_1 || rax_17[1].w != 3)
            rax_17 = &rax_17[2]
            
            if (rax_17 == rcx_18)
                goto label_1407ba8f9
    
    if (r8_4 == rcx_18 || ((rax_17 - r8_4) s>> 4).d == 0xffffffff)
    label_1407ba8f9:
    ...
    if (result.b != 0)
        int64_t* r8_6 = data_143ce3ae0
        int64_t rbx_6 = sx.q(data_143ce3ae8)
        int64_t* rax_27 = r8_6
        int64_t i_4 = i_2
        void* rcx_29 = &r8_6[rbx_6 * 2]
        
        if (r8_6 != rcx_29)
            while (*rax_27 != i_4 || rax_27[1].w != result_1)
                rax_27 = &rax_27[2]
                
                if (rax_27 == rcx_29)
                    goto label_1407baa35
            
            result = ((rax_27 - r8_6) s>> 4).d
        
        if (r8_6 == rcx_29 || result == 0xffffffff)
        label_1407baa35:
            int32_t rax_29 = (rbx_6 + 1).d
            bool cond:5_1 = rax_29 s<= data_143ce3aec
            data_143ce3ae8 = rax_29
            ...
            int64_t rcx_31 = rbx_6 * 2
            r8_6[rcx_31] = i_4
            result = zx.d(result_1)
            r8_6[rcx_31 + 1].w = result.w
            *(&r8_6[rcx_31] + 0xa) = 0xffffffff
