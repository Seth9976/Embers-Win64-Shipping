...
if (data_143e8c610 s> *rdi_1)
    _Init_thread_header(&data_143e8c610)
    
    if (data_143e8c610 == 0xffffffff)
        ...
        data_143e8c608 = rax_9
        _Init_thread_footer(&data_143e8c610)

if (data_143e8c630 s> *rdi_1)
    _Init_thread_header(&data_143e8c630)
    
    if (data_143e8c630 == 0xffffffff)
        ...
        data_143e8c628 = rax_12
        _Init_thread_footer(&data_143e8c630)

if (data_143e8c650 s> *rdi_1)
    _Init_thread_header(&data_143e8c650)
    
    if (data_143e8c650 == 0xffffffff)
        ...
        data_143e8c648 = rax_15
        _Init_thread_footer(&data_143e8c650)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c608
int64_t rcx
...
label_1412b9c73:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412b9c6e
        
        rbx.b = 1
        goto label_1412b9c73
