...
if (data_143e8b9a8 s> *rdi_1)
    _Init_thread_header(&data_143e8b9a8)
    
    if (data_143e8b9a8 == 0xffffffff)
        ...
        data_143e8b9a0 = rax_12
        _Init_thread_footer(&data_143e8b9a8)

if (data_143e8b9c8 s> *rdi_1)
    _Init_thread_header(&data_143e8b9c8)
    
    if (data_143e8b9c8 == 0xffffffff)
        ...
        data_143e8b9c0 = rax_15
        _Init_thread_footer(&data_143e8b9c8)

if (data_143e8b9e8 s> *rdi_1)
    _Init_thread_header(&data_143e8b9e8)
    
    if (data_143e8b9e8 == 0xffffffff)
        ...
        data_143e8b9e0 = rax_18
        _Init_thread_footer(&data_143e8b9e8)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b9a0
int64_t rcx
...
label_1412b7548:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412b7543
    
    rbx.b = 1
    goto label_1412b7548
