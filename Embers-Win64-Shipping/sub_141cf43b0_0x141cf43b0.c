        ...
        while (true)
            ...
            if (rax_10 s<= 8)
                for (; i u> r10_1; i -= 0x10)
                    ...
                    if (&r10_1[1] u<= i)
                        do
                            uint128_t* rdx_3 = r8_2
                            
                            if (*(*(r9_2 + 8) + 0x130) s<= *(*(r8_2 + 8) + 0x130))
                                rdx_3 = r9_2
            ...
            while (true)
                ...
                if (r8 u<= i && *(*(r10_1 + 8) + 0x130) s<= *(*(r8 + 8) + 0x130))
                    continue
                ...
                do
                    ...
                    if (r9 u<= r10_1)
                        break
                while (*(*(r9 + 8) + 0x130) s<= *(*(r10_1 + 8) + 0x130))
