    ...
    do
        ...
        if (r13_1 s< arg2)
            do
                ...
                if (rax_3 s< arg2)
                    if (sub_141fd8eb0(arg4, &arg1[sx.q(rax_3)], &arg1[sx.q(rbx_1.d)]) != 0)
                        rbx_1 = zx.q(rsi_1)
                    
                    rbx_1 = zx.q(rbx_1.d + 1)
                
                int32_t* rsi_4 = &arg1[sx.q(rbx_1.d)]
                int128_t* rbp_3 = &arg1[sx.q(r14_1)]
                result = sub_141fd8eb0(arg4, rbp_3, rsi_4)
    ...
    do
        ...
        if (i s> 1)
            ...
            do
                ...
                if (rax_5 s< i)
                    if (sub_141fd8eb0(arg4, &arg1[sx.q(rax_5)], &arg1[sx.q(rbx_2.d)]) != 0)
                        rbx_2 = zx.q(rsi_5)
                    
                    rbx_2 = zx.q(rbx_2.d + 1)
                
                int32_t* rsi_8 = &arg1[sx.q(rbx_2.d)]
                int32_t* rbp_6 = &arg1[sx.q(r15_1)]
                result = sub_141fd8eb0(arg4, rbp_6, rsi_8)
