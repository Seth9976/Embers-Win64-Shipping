...
*r8_2 |= 1 << (rdi.b & 0x1f)
int64_t* rbp = *arg1 + sx.q(rdi.d) * 0x18
int64_t rcx_8 = **arg4
*rbp = rcx_8
rbp[1].b = 0
rbp[2].d = 0xffffffff
...
label_142258d9d:
    ...
    if (sub_1405b6470(arg1, r10_1, 0) == 0)
        ...
        *(rbp + 0x14) = r8_6
        ...
        rbp[2].d = *(rax_21 + (((sx.q(arg1[9].d) - 1) & sx.q(r8_6)) << 2))
        void* rcx_16 = *(r9_2 + 8)
    ...
    if (r10_1 != 0)
        ...
        rbx_2 = *(r8_3 + (((sx.q(arg1[9].d) - 1) & r13) << 2))
    ...
    label_142258d56:
        ...
        while (true)
            ...
            if (*(rdx_13 + (rcx_10 << 3)) == rcx_8)
                break
            
            rbx_2 = *(rdx_13 + (rcx_10 << 3) + 0x10)
            
            if (rbx_2 == 0xffffffff)
                goto label_142258d56
    
    rsi.b = rbx_2 != 0xffffffff
    
    if (rbx_2 == 0xffffffff)
        goto label_142258d9d
    
    memmove(*arg1 + sx.q(rbx_2) * 0x18, rbp, 0x10)
