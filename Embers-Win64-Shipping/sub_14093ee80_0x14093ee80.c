...
if (rbx != 0)
    ...
    label_14093ef28:
        ...
        while (true)
            ...
            if (rdx_2 != 0)
                goto label_14093ef28
        
        var_84.d = rbx

int32_t rdx_4 = *(arg1 + 0xe0)
...
var_84.d = rdx_4
int128_t var_78 = (arg1 + 0xb8).o
int96_t var_68 = var_48:8.12

if (rdx_4 != rbx)
    void* rax_11 = *(arg1 + 0xd8)
...
while (true)
    ...
    if (rcx_7.d == (var_88_2.q u>> 0x20).d && var_68.q == arg1 + 0xc8 && result == arg1 + 0xb8)
        return result
    
    int64_t rdx_9 = *((rcx_7 << 5) + *result + 8)
    
    if (rdx_9 != 0)
        void* rax_21 = *(arg2 + 0x10)
        ...
        (*arg2)((*(*rcx_9 + 8))(rcx_9, rdx_9), &arg_8)
