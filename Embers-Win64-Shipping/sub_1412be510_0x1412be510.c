...
if (data_143e8bc18 s> *rdi_1)
    _Init_thread_header(&data_143e8bc18)
    
    if (data_143e8bc18 == 0xffffffff)
        ...
        data_143e8bc10 = rax_9
        _Init_thread_footer(&data_143e8bc18)

if (data_143e8bc38 s> *rdi_1)
    _Init_thread_header(&data_143e8bc38)
    
    if (data_143e8bc38 == 0xffffffff)
        ...
        data_143e8bc30 = rax_12
        _Init_thread_footer(&data_143e8bc38)

if (data_143e8bc58 s> *rdi_1)
    _Init_thread_header(&data_143e8bc58)
    
    if (data_143e8bc58 == 0xffffffff)
        ...
        data_143e8bc50 = rax_15
        _Init_thread_footer(&data_143e8bc58)
