...
if (data_143e8d118 s> *rdi_1)
    _Init_thread_header(&data_143e8d118)
    
    if (data_143e8d118 == 0xffffffff)
        ...
        data_143e8d110 = rax_9
        _Init_thread_footer(&data_143e8d118)

if (data_143e8d138 s> *rdi_1)
    _Init_thread_header(&data_143e8d138)
    
    if (data_143e8d138 == 0xffffffff)
        ...
        data_143e8d130 = rax_12
        _Init_thread_footer(&data_143e8d138)

if (data_143e8d158 s> *rdi_1)
    _Init_thread_header(&data_143e8d158)
    
    if (data_143e8d158 == 0xffffffff)
        ...
        data_143e8d150 = rax_15
        _Init_thread_footer(&data_143e8d158)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8d110
int64_t rcx
...
label_1412b0753:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 4 || rbp == 1)
            goto label_1412b074e
        
        rbx.b = 1
        goto label_1412b0753
