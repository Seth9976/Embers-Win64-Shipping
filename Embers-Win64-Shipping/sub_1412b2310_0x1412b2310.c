...
if (data_143e8c6a0 s> *rdi_1)
    _Init_thread_header(&data_143e8c6a0)
    
    if (data_143e8c6a0 == 0xffffffff)
        ...
        data_143e8c698 = rax_9
        _Init_thread_footer(&data_143e8c6a0)

if (data_143e8c6c0 s> *rdi_1)
    _Init_thread_header(&data_143e8c6c0)
    
    if (data_143e8c6c0 == 0xffffffff)
        ...
        data_143e8c6b8 = rax_12
        _Init_thread_footer(&data_143e8c6c0)

if (data_143e8c6e0 s> *rdi_1)
    _Init_thread_header(&data_143e8c6e0)
    
    if (data_143e8c6e0 == 0xffffffff)
        ...
        data_143e8c6d8 = rax_15
        _Init_thread_footer(&data_143e8c6e0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c698
int64_t rcx
...
label_1412b2413:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 3 || rbp == 1)
            goto label_1412b240e
        
        rbx.b = 1
        goto label_1412b2413
