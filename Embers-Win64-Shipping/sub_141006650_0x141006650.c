...
int64_t result = (*(*rcx_16 + 0xf8))(rcx_16, zx.q(*(arg2 + 0x24)), 
    zx.q(*(rcx_15 + 0x38) * r15) + *(rcx_15 + 0x48))
*(arg3 + 0x28) |= not.q((1 << arg4.b) - 1)
