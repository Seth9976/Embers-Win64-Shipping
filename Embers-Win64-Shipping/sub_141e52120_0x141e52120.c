...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        ...
        zmm1_1 = sub_141e518f0(arg1, rbx_3 + 8, zmm1_1)
        int32_t var_4c
...
int512_t zmm1 = sub_141e5bde0(arg2, arg_8)
int32_t r15 = 0
...
do
    ...
    *r8_7 |= 1 << (rdi_1.b & 0x1f)
    int64_t* rdx_16 = sx.q(rdi_1.d) * 0x30 + *arg2
    *rdx_16 = 0
    rdx_16[1].w = 0
    rdx_16[2] = 0
    rdx_16[3] = 0
    rdx_16[4].b = 0xff
    rdx_16[5].d = 0xffffffff
    (*(*arg1 + 0x140))(arg1)
    zmm1 = sub_141e518f0(arg1, &rdx_16[1], zmm1)
    r15 += 1
while (r15 s< arg_8)
