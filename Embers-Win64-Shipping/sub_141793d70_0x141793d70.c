...
if (arg3 != 0)
    ...
    while (i != 0)
        sub_141793f40(*arg2, *arg2[1], &i, arg2[2], arg2[3], arg2[4], arg2[5])
        ...
        if (rdx_3 != 0)
            ...
            if (rax_5 s>= rdx_3[1].d)
                ...
                int64_t (** rdx_4)(int64_t* arg1, int32_t* arg2) = *(*rdx_3 + (sx.q(rax_5) << 3))
                int64_t (* rcx_7)(int64_t* arg1, int32_t* arg2) = *rdx_4
        ...
        do
            ...
            if (rbx_1 != 0)
                ...
                if (rcx == 0)
                    ...
                    rdx_2 = &var_68
                    var_68 = sub_1417a8da0
                    int64_t** var_60_1 = &var_58
                else
                    rbx_1 = *(rcx + 8)
                    rdx_2 = &var_78
                    void* var_50 = rcx
                    var_78 = sub_1417a8f10
                    int32_t var_70
                    var_70.q = &var_58
