...
if (data_143e8b1f8 s> *rdi_1)
    _Init_thread_header(&data_143e8b1f8)
    
    if (data_143e8b1f8 == 0xffffffff)
        ...
        data_143e8b1f0 = rax_12
        _Init_thread_footer(&data_143e8b1f8)

if (data_143e8b208 s> *rdi_1)
    _Init_thread_header(&data_143e8b208)
    
    if (data_143e8b208 == 0xffffffff)
        ...
        data_143e8b200 = rax_15
        _Init_thread_footer(&data_143e8b208)

if (data_143e8b218 s> *rdi_1)
    _Init_thread_header(&data_143e8b218)
    
    if (data_143e8b218 == 0xffffffff)
        ...
        data_143e8b210 = rax_18
        _Init_thread_footer(&data_143e8b218)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8b1f0
int64_t rcx
...
label_1412c4c18:
    ...
    if (rdi_4 s< 2 || rsi == 1)
        goto label_1412c4c13
    
    rbx.b = 1
    goto label_1412c4c18
