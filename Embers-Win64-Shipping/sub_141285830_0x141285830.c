...
if (data_143e8becc s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e8becc)
    
    if (data_143e8becc == 0xffffffff)
        ...
        data_143e8bec0 = rax_6
        _Init_thread_footer(&data_143e8becc)

int64_t rbx = data_143e8bec0
int64_t rcx
