...
while (true)
    int16_t* r9_5 = (sx.q(r10_2) << 5) + *rbx
    uint64_t r8_9 = (zx.q(r9_5[1]) ^ zx.q(*r9_5)) & zx.q(*rsi - 1)
    ...
    *(r9_5 + 0x18) = *(rax_15 + (((sx.q(*rsi) - 1) & r8_9) << 2))
    ...
    *(rax_17 + (((sx.q(*rsi) - 1) & r8_9) << 2)) = r10_2
