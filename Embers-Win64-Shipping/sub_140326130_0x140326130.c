...
float zmm14[0x4]
float var_18[0x4] = zmm14
float zmm13[0x4]
float var_28[0x4] = zmm13
...
float temp0_3[0x4] = __vbroadcastss_xmmf32_maskmskw_memf32_avx512(arg5, nanf)
float zmm3[0x8]
zmm3[0].o = __vdivps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm1[0].o)
int32_t zmm4[0x8]
zmm4[0].o = _mm_mask_and_ps(arg5, zmm3[0].o, temp0_3)
float zmm5[0x8]
...
zmm4[0].o = _mm_mask_and_ps(arg5, zmm1[0].o, temp0_3)
...
zmm8[0].o = arg12
float zmm16[0x8]
zmm16[0].o = _mm_mask_load_ss(k0, arg11)
...
int32_t* result = arg9
float temp0_34[0x4] = __vbroadcastss_xmmf32_maskmskw_memf32_avx512(k0, 1f)
zmm4[0].o = _mm_mask3_fmadd_ps(zmm4[0].o, k0, zmm3[0].o, temp0_34)
zmm5[0].o = _mm_broadcast_ss(-2.60516146e-07f)
zmm5[0].o = __vfmadd213ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm5[0].o, k0, zmm3[0].o, 0x37cfb4c2)
zmm5[0].o = __vfmadd213ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm5[0].o, k0, zmm3[0].o, 0xbab609aa)
zmm5[0].o = __vfmadd213ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm5[0].o, k0, zmm3[0].o, 0x3d2aaaa3)
zmm1[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm1[0].o, zmm4[0].o)
zmm5[0].o = __vfmadd213ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm5[0].o, k0, zmm3[0].o, 0xbf000000)
zmm5[0].o = _mm_mask3_fmadd_ps(zmm5[0].o, k0, zmm3[0].o, temp0_34)
...
float zmm10[0x8]
zmm10[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm3[0].o, zmm1[0].o)
zmm1[0].o = arg2[2]
zmm4[0].o = __vxorps_xmmdq_xmmdq_xmmdq(zmm4[0].o, zmm4[0].o)
int64_t k0_1 = _mm256_cmp_ps_mask(k0, zmm1, zmm4, 1)
...
if (&var_180 == 0)
    ...
    zmm5[0].o = _mm_mask_broadcastss_ps(k0_1, temp0_270)
    zmm7[0].o = *arg2
    zmm18[0].o = _mm_mask_load_ss(k0_1, *(arg2 + 4))
    ...
    float temp0_278[0x4] = _mm_mask_broadcastss_ps(k0_1, zmm18[0].o)
    zmm6[0].o = _mm_permute_pd(zmm0[0].o, 1)
    zmm6[0].o = _mm_mask_mul_ps(k0_1, zmm6[0].o, temp0_278)
    zmm6[0].o = __vfmadd132ps_xmmdq_xmmdq_memdq(zmm6[0].o, zmm4[0].o, data_142d3f7d0)
    zmm3[0].o = *(arg2 + 8)
    ...
    zmm4[0].o = __vfmadd132ps_xmmdq_xmmdq_memdq(zmm4[0].o, zmm6[0].o, data_142d3f7b0)
    zmm0[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm1[0].o, zmm10[0].o)
    zmm6[0].o = __vmovsd_xmmdq_memq(*(arg2 + 4))
    zmm6[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm6[0].o, zmm7[0].o, 0x20)
    float temp0_289[0x4] = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm6[0].o, temp0_270, 0x30)
    zmm6[0].o = _mm_permute_ps(zmm0[0].o, 0xd2)
    zmm3[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm3[0].o, zmm7[0].o, 0x10)
    zmm3[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm3[0].o, zmm18[0].o, 0x20)
    zmm3[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm3[0].o, temp0_270, 0x30)
    zmm7[0].o = _mm_permute_ps(zmm0[0].o, 0xc9)
    zmm7[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm7[0].o, zmm3[0].o)
    zmm6[0].o = _mm_mask3_fmsub_ps(zmm6[0].o, k0_1, temp0_289, zmm7[0].o)
    zmm7[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm6[0].o, zmm6[0].o)
    ...
    zmm3[0].o = _mm_mask3_fmsub_ps(zmm3[0].o, k0_1, temp0_289, zmm0[0].o)
    zmm0[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm5[0].o, zmm3[0].o)
    zmm18[0].o = __vaddps_xmmf32_maskmskw_xmmf32_memf32_avx512(k0_1, zmm0[0].o, arg2[1])
    zmm22 = __vmulps_xmmf32_maskmskw_xmmf32_memf32_avx512(k0_1, zmm1[0].o, data_142e6da00)
else
    zmm5[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm0[0].o)
    zmm4[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm5[0].o)
    zmm7[0].o = _mm_permute_ps(zmm4[0].o, 1)
    zmm4[0].o = _mm_permute_ps(zmm4[0].o, 0x1a)
    zmm4[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm7[0].o, zmm4[0].o)
    float temp0_69[0x4] = _mm_mask_load_ss(k0_1, 1f)
    float temp0_70[0x4] = _mm_mask_broadcastss_ps(k0_1, temp0_69)
    zmm7[0].o = _mm_mask_sub_ps(k0_1, temp0_70, zmm4[0].o)
    zmm18[0].o = _mm_mask_load_ps(k0_1, data_142e6da00)
    float temp0_73[0x4] = _mm_mask_mul_ps(k0_1, zmm7[0].o, zmm18[0].o)
    ...
    zmm0[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm5[0].o)
    zmm5[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm4[0].o, zmm0[0].o)
    float temp0_81[0x4] = _mm_mask_mul_ps(k0_1, zmm5[0].o, zmm18[0].o)
    zmm0[0].o = __vsubps_xmmdq_xmmdq_xmmdq(zmm4[0].o, zmm0[0].o)
    float temp0_83[0x4] = _mm_mask_mul_ps(k0_1, zmm0[0].o, zmm18[0].o)
    zmm4[0].o = _mm_mask_permute_pd(k0_1, temp0_81, 1)
    int32_t temp0_85[0x4] = __vxorps_xmmdq_xmmdq_xmmdq(arg8, arg8)
    arg7[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(temp0_85, temp0_73, 1)
    arg6 = data_143443080
    zmm0[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(arg7[0].o, temp0_81, 0x10)
    zmm0[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm0[0].o, temp0_83, 4)
    zmm0 = _mm256_blend_ps(arg7, zmm0, 0xf)
    zmm3[0].o = _mm256_extractf128_ps(arg7[0].o, 1)
    zmm3[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm3[0].o, temp0_83, 1)
    zmm3[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm3[0].o, temp0_73, 2)
    zmm3[0].o = __vinsertps_xmmf32_xmmf32_xmmf32_imm8_avx512(zmm3[0].o, temp0_81, 0x60)
    zmm0 = _mm256_insertf128_ps(zmm0, zmm3[0].o, 1)
    zmm3 = _mm256_blend_ps(arg6, zmm4, 1)
    zmm4[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm3[0].o, temp0_83, 2)
    zmm4[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm4[0].o, temp0_73, 4)
    zmm3[0].o = _mm256_extractf128_ps(zmm3[0].o, 1)
    zmm3[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm10[0].o, zmm3[0].o, 8)
    ...
    zmm7[0].o = _mm_permute_ps(zmm4[0].o, 0xc1)
    zmm4[0].o = _mm_permute_ps(zmm4[0].o, 0xda)
    zmm4[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm7[0].o, zmm4[0].o)
    zmm4[0].o = _mm_mask_sub_ps(k0_1, temp0_70, zmm4[0].o)
    ...
    zmm3[0].o = __vmulps_xmmf32_maskmskw_xmmf32_memf32_avx512(k0_1, zmm3[0].o, *(arg2 + 0xc))
    zmm7[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm3[0].o)
    zmm6[0].o = *(arg2 + 0x24)
    zmm5[0].o = _mm_broadcastss_ps(zmm1[0].o)
    zmm5[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm5[0].o, zmm6[0].o, 1)
    zmm5[0].o = __vinsertps_xmmdq_xmmdq_memd_immb(zmm5[0].o, *(arg2 + 0x28), 0x10)
    zmm1[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm1[0].o, zmm7[0].o)
    zmm0[0].o = __vsubps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm3[0].o)
    zmm3[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm5[0].o)
    zmm5[0].o = arg2[1].d
    zmm6[0].o = _mm_permute_pd(zmm1[0].o, 1)
    zmm7[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(temp0_85, zmm4[0].o, 1)
    zmm0[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm7[0].o, zmm1[0].o, 0x10)
    ...
    zmm7[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm7[0].o, zmm4[0].o, 2)
    zmm1[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm7[0].o, zmm1[0].o, 0x60)
    zmm6 = _mm256_blend_ps(arg6, zmm6, 1)
    zmm3[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm6[0].o, zmm3[0].o, 2)
    ...
    zmm22 = __vmulps_xmmf32_maskmskw_xmmf32_memf32_avx512(k0_1, zmm18[0].o, arg2[2])
    ...
    zmm18[0].o = _mm_mask_broadcastss_ps(k0_1, temp0_81)
    zmm18[0].o = _mm_mask3_fmadd_ps(zmm18[0].o, k0_1, zmm1[0].o, zmm7[0].o)
    int32_t var_f4
    zmm18[0].o =
        __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm18[0].o, k0_1, zmm4[0].o, var_f4)
    int32_t var_e8
    zmm5[0].o = __vmulps_xmmf32_maskmskw_xmmf32_memf32_avx512(k0_1, zmm3[0].o, var_e8)
    int32_t var_f0
    zmm5[0].o =
        __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm5[0].o, k0_1, zmm0[0].o, var_f0)
    int32_t var_ec
    zmm5[0].o =
    ...
    zmm6[0].o = __vmulps_xmmf32_maskmskw_xmmf32_memf32_avx512(k0_1, zmm3[0].o, zmm3[2])
    zmm6[0].o =
        __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm6[0].o, k0_1, zmm0[0].o, zmm3[0])
    zmm6[0].o =
        __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm6[0].o, k0_1, zmm1[0].o, zmm3[1])
    zmm6[0].o =
        __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm6[0].o, k0_1, zmm4[0].o, zmm3[3])
    zmm3[0].o = __vmulps_xmmf32_maskmskw_xmmf32_memf32_avx512(k0_1, zmm3[0].o, zmm3[6])
    zmm3[0].o =
        __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm3[0].o, k0_1, zmm0[0].o, zmm3[4])
    zmm3[0].o =
        __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm3[0].o, k0_1, zmm1[0].o, zmm3[5])
    zmm3[0].o =
        __vfmadd231ps_xmmf32_maskmskw_xmmf32_memf32_avx512(zmm3[0].o, k0_1, zmm4[0].o, zmm3[7])
    zmm0[0].o = _mm_mask_movehdup_ps(k0_1, zmm18[0].o)
    double temp0_157[0x2] = _mm_mask_permute_pd(k0_1, zmm18[0].o, 1)
    zmm4[0].o = zx.o(__vextractps_gpr32_xmmdq_immb(zmm5[0].o, 0))
    float temp0_159[0x4] = _mm_mask_movehdup_ps(k0_1, zmm5[0].o)
    float zmm23[0x4] = _mm_mask_permute_pd(k0_1, zmm5[0].o, 1)
    result = zx.q(__vextractps_gpr32_xmmdq_immb(zmm6[0].o, 0))
    zmm1[0].o = zx.o(result.d)
    zmm5[0].o = _mm_blend_epi32(zmm5[0].o, zmm4[0].o, 1)
    zmm5 = _mm256_insertf32x4(k0_1, zmm18, zmm5[0].o, 1)
    zmm7[0].o = __vmovshdup_xmmdq_xmmdq(zmm6[0].o)
    double temp0_165[0x2] = _mm_mask_permute_pd(k0_1, zmm6[0].o, 1)
    zmm6[0].o = _mm_blend_epi32(zmm6[0].o, zmm1[0].o, 1)
    zmm3 = _mm256_inserti128_si256(zmm6, zmm3[0].o, 1)
    var_180 = zmm5
    int224_t var_160_1 = zmm3[0].28
    zmm3[0].o = zmm0[0].o f* zmm0[0]
    zmm3[0].o = _mm_mask3_fmadd_round_ss(zmm3[0].o, k0_1, zmm18[0].o, zmm18[0].o)
    zmm3[0].o = _mm_mask3_fmadd_round_ss(zmm3[0].o, k0_1, temp0_157, temp0_157)
    zmm5[0].o = _mm_mask_mul_round_ss(k0_1, temp0_159, temp0_159)
    zmm5[0].o = _mm_fmadd_ss(zmm5[0].o, zmm4[0], zmm4[0])
    zmm5[0].o = _mm_mask3_fmadd_round_ss(zmm5[0].o, k0_1, zmm23, zmm23)
    ...
    zmm7[0].o = _mm_add_round_ss(k0_1, zmm3[0].o, temp0_175)
    float temp0_177[0x4] = _mm_mask_load_ss(k0_1, 0.5f)
    zmm6[0].o = __vrsqrtss_xmmdq_xmmdq_xmmd(zmm3[0].o, zmm3[0])
    zmm3[0].o = _mm_mask_mul_round_ss(k0_1, zmm3[0].o, temp0_177)
    zmm4[0].o = zmm6[0].o f* zmm6[0]
    zmm4[0].o = _mm_fnmadd_round_ss(zmm4[0].o, k0_1, zmm3[0].o, temp0_177)
    zmm4[0].o = _mm_fmadd_ss(zmm4[0].o, zmm6[0], zmm6[0])
    zmm6[0].o = zmm4[0].o f* zmm4[0]
    zmm6[0].o = _mm_fnmadd_round_ss(zmm6[0].o, k0_1, zmm3[0].o, temp0_177)
    zmm6[0].o = _mm_fmadd_ss(zmm6[0].o, zmm4[0], zmm4[0])
    zmm3[0].o = __vxorps_xmmdq_xmmdq_xmmdq(zmm3[0].o, zmm3[0].o)
    int64_t k1_1 = _mm_cmp_round_ss_mask(k0_1, zmm3[0].o, zmm7[0].o, 2)
    zmm4[0].o = _mm_mask_mov_ps(k0_1, temp0_69)
    zmm4[0].o = _mm_mask_move_ss(k1_1, zmm0[0].o, zmm6[0].o)
    zmm7[0].o = _mm_add_round_ss(k0_1, zmm5[0].o, temp0_175)
    zmm6[0].o = __vrsqrtss_xmmdq_xmmdq_xmmd(zmm5[0].o, zmm5[0])
    zmm5[0].o = _mm_mask_mul_round_ss(k0_1, zmm5[0].o, temp0_177)
    zmm1[0].o = zmm6[0].o f* zmm6[0]
    zmm1[0].o = _mm_fnmadd_round_ss(zmm1[0].o, k0_1, zmm5[0].o, temp0_177)
    zmm1[0].o = _mm_fmadd_ss(zmm1[0].o, zmm6[0], zmm6[0])
    zmm6[0].o = zmm1[0].o f* zmm1[0]
    zmm6[0].o = _mm_fnmadd_round_ss(zmm6[0].o, k0_1, zmm5[0].o, temp0_177)
    zmm6[0].o = _mm_fmadd_ss(zmm6[0].o, zmm1[0], zmm1[0])
    int64_t k1_2 = _mm_cmp_round_ss_mask(k0_1, zmm3[0].o, zmm7[0].o, 2)
    zmm1[0].o = _mm_mask_mov_ps(k0_1, temp0_69)
    zmm1[0].o = _mm_mask_move_ss(k1_2, zmm0[0].o, zmm6[0].o)
    ...
    zmm6[0].o = _mm_fnmadd_round_ss(zmm6[0].o, k0_1, zmm0[0].o, temp0_177)
    zmm6[0].o = _mm_fmadd_ss(zmm6[0].o, zmm7[0].d, zmm7[0].d)
    int64_t k1_3 = _mm_cmp_round_ss_mask(k0_1, zmm3[0].o, zmm5[0].o, 2)
    zmm0[0].o = _mm_mask_mov_ps(k0_1, temp0_69)
    zmm0[0].o = _mm_mask_move_ss(k1_3, zmm0[0].o, zmm6[0].o)
    zmm3[0].o = _mm_mask_mul_round_ss(k0_1, zmm4[0].o, zmm18[0].o)
    ...
    int32_t var_170
    zmm4[0].o = zmm1[0].o f* var_170
    int32_t var_16c
    zmm5[0].o = zmm1[0].o f* var_16c
    ...
    int64_t k1_4 = _mm_cmp_ps_mask(k0_1, zmm0[0].o, zmm22, 2)
    __vbroadcastss_ymmf32_maskmskw_memf32_avx512(k0_1, -1f)
    double zmm24[0x2] = _mm256_mask_load_ps(k1_4, data_1434430a0)
    zmm0 = _mm256_mask_broadcastss_ps(k0_1, zmm24)
    zmm5 = _mm256_mul_ps(zmm0, zmm3)
    zmm18[0].o = _mm_mask_movehdup_ps(k0_1, zmm5[0].o)
    zmm23 = _mm_mask_permute_pd(k0_1, zmm5[0].o, 1)
    var_180[0] = zmm5[0]
    var_180[1] = _mm_mask_store_ss(k0_1, zmm18[0].o)
    float var_178_1 = _mm_mask_store_ss(k0_1, zmm23)
    zmm0[0].o = _mm_mask_movehdup_ps(k0_1, zmm24)
    zmm0 = _mm256_broadcastsd_pd(zmm0[0].o)
    zmm6 = _mm256_mul_ps(zmm0, zmm1)
    zmm0[0].o = __vmovshdup_xmmdq_xmmdq(zmm6[0].o)
    float var_170_1 = zmm6[0]
    zmm1[0].o = _mm_permute_pd(zmm6[0].o, 1)
    int32_t var_16c_1 = zmm0[0]
    float var_168_1 = zmm1[0]
    zmm3[0].o = _mm_mask_permute_ps(k0_1, zmm24, 0xea)
    zmm3 = _mm256_broadcastsd_pd(zmm3[0].o)
    arg6 = _mm256_mul_ps(zmm3, zmm4)
    zmm7[0].o = __vmovshdup_xmmdq_xmmdq(arg6[0].o)
    zmm3[0].o = _mm_permute_pd(arg6[0].o, 1)
    var_160_1.d = arg6[0]
    var_160_1:4.d = zmm7[0].d
    var_160_1:8.d = zmm3[0]
    zmm10 = _mm256_broadcast_ss(1.17549435e-38f)
    zmm4 = __vandps_ymmu32_maskmskw_ymmu32_memu32_avx512(k0_1, _mm256_blend_ps(zmm10, zmm5, 7), 
        0x7fffffff)
    k0_1 = __vcmpps_maskmskw_maskmskw_ymmf32_memf32_imm8_avx512(k0_1, zmm4, 0x38d1b717, 2)
    _kortest_mask8_u8(k0_1, k0_1)
    
    if (&var_180 u< 0)
        zmm0[0].o = data_142d3f660
    else
        zmm4 = __vandps_ymmu32_maskmskw_ymmu32_memu32_avx512(k0_1, _mm256_blend_ps(zmm10, zmm6, 7), 
            0x7fffffff)
        k0_1 = __vcmpps_maskmskw_maskmskw_ymmf32_memf32_imm8_avx512(k0_1, zmm4, 0x38d1b717, 2)
        _kortest_mask8_u8(k0_1, k0_1)
        ...
        if (&var_180 u< 0)
            ...
            zmm4 = __vandps_ymmu32_maskmskw_ymmu32_memu32_avx512(k0_1, 
                _mm256_blend_ps(zmm10, arg6, 7), 0x7fffffff)
            k0_1 = __vcmpps_maskmskw_maskmskw_ymmf32_memf32_imm8_avx512(k0_1, zmm4, 0x38d1b717, 2)
            _kortest_mask8_u8(k0_1, k0_1)
            ...
            if (&var_180 u< 0)
                ...
                zmm4[0].o = zmm5[0].o f+ zmm0[0]
                zmm24 = _mm_add_round_ss(k0_1, zmm3[0].o, zmm4[0].o)
                zmm4[0].o = __vxorps_xmmdq_xmmdq_xmmdq(zmm4[0].o, zmm4[0].o)
                
                if (zmm24 f<= zmm4[0].o)
                    zmm0[0].o f- zmm5[0]
                    int32_t rax_1
                    rax_1.b = zmm0[0].o f> zmm5[0]
                    int64_t rdx = 0x14
                    
                    if (zmm0[0].o f<= zmm5[0])
                        rdx = 0
                    ...
                    *(&var_110 + (r8_1 << 2)) = zmm1[0]
                    ...
                    zmm0[0].o = _mm_add_round_ss(k0_1, zmm24, temp0_69)
                    zmm0[0].o = __vsqrtss_xmmdq_xmmdq_xmmd(zmm0[0].o, zmm0[0])
                    zmm0[0].o = _mm_div_round_ss(k0_1, temp0_69, zmm0[0].o)
                    zmm3[0].o = _mm_mask_mul_round_ss(k0_1, zmm0[0].o, temp0_177)
                    zmm1[0].o = zmm1[0].o f- zmm7[0].d
                    zmm1[0].o = zmm1[0].o f* zmm3[0]
                    zmm4[0].o = _mm_mask_sub_round_ss(k0_1, arg6[0].o, zmm23)
                    zmm4[0].o = zmm4[0].o f* zmm3[0]
                    zmm1[0].o = __vinsertps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm4[0].o, 0x10)
                    zmm4[0].o = _mm_mask_sub_round_ss(k0_1, zmm18[0].o, zmm6[0].o)
    ...
    zmm18[0].o = zmm1[0].q | zmm0[0].q << 0x40

zmm0[0].o = arg3[0].o f* 0.5f
zmm1[0].o = __vxorps_xmmdq_xmmdq_xmmdq(zmm1[0].o, zmm1[0].o)
arg3[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm8[0].o, 1)
zmm5[0].o = _mm_mask_unpacklo_ps(k0_1, temp0_26, zmm16[0].o)
arg3[0].o = zmm5[0].q | arg3[0] << 0x40
...
zmm5[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm4[0].o, arg3[0].o)
...
zmm5[0].o = _mm_mask_sub_ps(k0_1, temp0_34, zmm5[0].o)
zmm5[0].o = _mm_mask_mul_ps(k0_1, zmm22, zmm5[0].o)
...
zmm4[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm7[0].o, arg3[0].o)
zmm4[0].o = _mm_mask_mul_ps(k0_1, zmm22, zmm4[0].o)
zmm6[0].o = _mm_mask_permute_ps(k0_1, zmm22, 0xc9)
arg3[0].o = __vsubps_xmmdq_xmmdq_xmmdq(zmm7[0].o, arg3[0].o)
arg3[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm6[0].o, arg3[0].o)
zmm1[0].o = __vblendps_xmmdq_xmmdq_xmmdq_immb(zmm1[0].o, zmm5[0].o, 3)
zmm6 = data_143443080
zmm1 = _mm256_shuffle_ps(zmm4, zmm1, 0)
zmm16[0].o = _mm_mask_xor_ps(k0_1, zmm16[0].o, zmm16[0].o)
zmm7 = data_1434430c0
zmm1 = _mm256_mask_shuffle_ps(k0_1, zmm1, zmm16, 0x42)
zmm7 = _mm256_blend_ps(_mm256_mask2_permutex2var_pd(zmm7, k0_1, arg3, zmm1), 
    _mm256_insertf128_ps(zmm0, zmm5[0].o, 1), 0x20)
zmm3[0].o = _mm_permute_ps(zmm4[0].o, 0xd4)
zmm3 = _mm256_blend_ps(zmm7, _mm256_insertf128_ps(zmm0, zmm3[0].o, 1), 0x40)
zmm4 = _mm256_blend_ps(_mm256_blend_ps(_mm256_unpackhi_pd(zmm4, zmm6), arg3, 2), zmm5, 4)
zmm5 = _mm256_blend_ps(_mm256_insertf32x4(k0_1, zmm0, zmm18[0].o, 1), zmm6, 0x80)
zmm7[0].o = __vsubps_xmmdq_xmmdq_xmmdq(zmm0[0].o, zmm0[0].o)
zmm6[0].o = data_142e6d9f0
zmm7[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm7[0].o, zmm6[0].o)
...
zmm6[0].o = _mm_permute_ps(zmm7[0].o, 0x55)
zmm6[0].o = __vmulps_xmmdq_xmmdq_xmmdq(zmm6[0].o, arg3[0].o)
zmm5[0].o = _mm_fmadd_ps(zmm5[0].o, zmm1[0].o, zmm6[0].o)
...
zmm1[0].o = _mm_mask_and_ps(k0_1, zmm1[0].o, temp0_3)
arg3[0].o = _mm_mask_and_ps(k0_1, arg3[0].o, temp0_3)
zmm1[0].o = __vaddps_xmmdq_xmmdq_xmmdq(zmm1[0].o, arg3[0].o)
zmm0[0].o = _mm_mask_and_ps(k0_1, zmm0[0].o, temp0_3)
