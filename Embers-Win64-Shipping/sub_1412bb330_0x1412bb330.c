...
if (data_143e8c140 s> *rdi_1)
    _Init_thread_header(&data_143e8c140)
    
    if (data_143e8c140 == 0xffffffff)
        ...
        data_143e8c138 = rax_12
        _Init_thread_footer(&data_143e8c140)

if (data_143e8c150 s> *rdi_1)
    _Init_thread_header(&data_143e8c150)
    
    if (data_143e8c150 == 0xffffffff)
        ...
        data_143e8c148 = rax_15
        _Init_thread_footer(&data_143e8c150)

if (data_143e8c160 s> *rdi_1)
    _Init_thread_header(&data_143e8c160)
    
    if (data_143e8c160 == 0xffffffff)
        ...
        data_143e8c158 = rax_18
        _Init_thread_footer(&data_143e8c160)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8c138
int64_t rcx
...
label_1412bb428:
    ...
    if (rdi_4 s< 4 || rsi == 1)
        goto label_1412bb423
    
    rbx.b = 1
    goto label_1412bb428
