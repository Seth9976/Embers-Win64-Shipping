...
int32_t rcx_4
rcx_4.b = sub_140b5b8a0(data_143cdf5f0.d, 0).b == 0
int64_t result
result.b = data_143cdf5f0:4.d != 0
result.b |= rcx_4.b

if (result.b != 0)
    result = sub_140d3c6e0(&data_143cdf5e8)
    
    if (result != 0)
        result = sub_140d1fd20(result, data_143cdf5f0)
        ...
        if (result != 0)
            ...
            int64_t* rax_4 = sub_140d3c6e0(&data_143cdf5e8)
            int64_t rax_5 = sub_140d1fd30(rax_4, data_143cdf5f0)
            int64_t r9_1 = *rax_4
