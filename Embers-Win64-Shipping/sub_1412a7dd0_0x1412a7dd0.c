...
if (data_143e8e4f0 s> *rdi_1)
    _Init_thread_header(&data_143e8e4f0)
    
    if (data_143e8e4f0 == 0xffffffff)
        ...
        data_143e8e4e8 = rax_12
        _Init_thread_footer(&data_143e8e4f0)

if (data_143e8e500 s> *rdi_1)
    _Init_thread_header(&data_143e8e500)
    
    if (data_143e8e500 == 0xffffffff)
        ...
        data_143e8e4f8 = rax_15
        _Init_thread_footer(&data_143e8e500)

if (data_143e8e510 s> *rdi_1)
    _Init_thread_header(&data_143e8e510)
    
    if (data_143e8e510 == 0xffffffff)
        ...
        data_143e8e508 = rax_18
        _Init_thread_footer(&data_143e8e510)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8e4e8
int64_t rcx
