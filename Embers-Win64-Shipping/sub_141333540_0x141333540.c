...
int32_t var_40 = 0
wchar16 const* const var_48 = u"AverageLuminanceVertexBuffer"
int128_t var_64 = data_143dbb1e0
int64_t* var_90
(*(*rcx_1 + 0x498))(rcx_1, &var_90, &data_143f02b98, 8, 0x209, &var_78)
...
label_141333653:
    ...
    *(arg1 + 0x10) = var_90
    ...
    if (rbx_1 != 0)
        ...
        goto label_141333653

int64_t* rcx_4 = data_143f0f180
int128_t* var_a0
var_a0.b = 0x1c
int64_t* var_88
(*(*rcx_4 + 0x4b8))(rcx_4, &var_88, &data_143f02b98, *(arg1 + 0x10), 4, var_a0)
...
label_14133373f:
    ...
    *(arg1 + 0x18) = var_88
    ...
    if (rbx_3 != 0)
        ...
        goto label_14133373f

int64_t* rcx_8 = data_143f0f180
int32_t var_a8_1
var_a8_1.b = 0x1c
int64_t* result_1
(*(*rcx_8 + 0x590))(rcx_8, &result_1, &data_143f02b98, *(arg1 + 0x10), var_a8_1)
