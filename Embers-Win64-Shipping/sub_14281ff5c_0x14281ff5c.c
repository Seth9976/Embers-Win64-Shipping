...
if (data_143f897d8 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143f897d8)
    
    if (data_143f897d8 == 0xffffffff)
        void var_28
        ...
        void var_68
        sub_142826468(&data_143f897b8, sub_142826388(&var_68, 0x3a), rax_4)
        void* var_60
        ...
        atexit(sub_142d1413c)
        _Init_thread_footer(&data_143f897d8)

return &data_143f897b8
