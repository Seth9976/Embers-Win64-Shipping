    ...
    do
        ...
        if (rsi_1 s< arg2)
            do
                ...
                if ((r8_1 + 1).d s< arg2)
                    if (*(arg1 + sx.q(r11_1) * 0xc + 0x20) s> *(arg1 + sx.q(r8_1.d) * 0xc + 8))
                        r8_1 = zx.q(r11_1)
                    
                    r8_1 = zx.q(r8_1.d + 1)
                
                int64_t* rdx_2 = arg1 + sx.q(r8_1.d) * 0xc
                int64_t rcx_2 = sx.q(r10_1) * 3
                result = zx.q(rdx_2[1].d)
    ...
    do
        ...
        if (i s> 1)
            do
                ...
                if ((result + 1).d s< i)
                    if (*(arg1 + sx.q(result_1) * 0xc + 0x20) s> *(arg1 + sx.q(result.d) * 0xc + 8))
