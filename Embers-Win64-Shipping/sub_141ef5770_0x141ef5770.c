...
if ((sub_140b5b8a0(arg2.d, 0).b == 0 | result.b) != 0)
    ...
    label_141ef57f3:
        ...
        *(rcx_6 + *(arg1 + 0x1f8)) = arg2
        result = *(arg1 + 0x1f8)
        *(rcx_6 + result + 8) = zmm6.d
    else
        while (*result != arg2)
            result += 0x20
            
            if (result == rcx_3)
                goto label_141ef57f3
    ...
    if ((*(arg1 + 0x8a) & 1) != 0)
        ...
        if (rcx_7 != 0)
            if (*(arg1 + 0x214) == 0xffffffff)
                ...
                if (rax_3 == 0)
                    result, zmm6 = sub_1423ddb40(data_143f5b298)
                else
                    result, zmm6 = sub_142435f50(rax_3)
                
                goto label_141ef58b7
            ...
            label_141ef58b7:
                ...
                if (result != 0)
                    ...
                    float zmm1[0x4] = arg2.o
                    *rax_5 = &data_142ec17e8
                    float temp0_1[0x4] = _mm_shuffle_ps(zmm1, zmm1, 0xd2)
                    *(rax_5 + 8) = result.o
                    temp0_1[0] = zmm6.d
                    *(rax_5 + 0x18) = _mm_shuffle_ps(temp0_1, temp0_1, 0xc9)
                    void*** var_48_1 = rax_5
