...
if (data_143e8d7f8 s> *rdi_1)
    _Init_thread_header(&data_143e8d7f8)
    
    if (data_143e8d7f8 == 0xffffffff)
        ...
        data_143e8d7f0 = rax_12
        _Init_thread_footer(&data_143e8d7f8)

if (data_143e8d808 s> *rdi_1)
    _Init_thread_header(&data_143e8d808)
    
    if (data_143e8d808 == 0xffffffff)
        ...
        data_143e8d800 = rax_15
        _Init_thread_footer(&data_143e8d808)

if (data_143e8d820 s> *rdi_1)
    _Init_thread_header(&data_143e8d820)
    
    if (data_143e8d820 == 0xffffffff)
        ...
        data_143e8d810 = rax_18
        _Init_thread_footer(&data_143e8d820)

char rax_5 = data_143de5480
int64_t rdi_2 = data_143e8d7f0
int64_t rcx
...
label_1412b0f18:
    ...
    if (rdi_4 s< 1 || rsi == 1)
        goto label_1412b0f13
    
    rbx.b = 1
    goto label_1412b0f18
