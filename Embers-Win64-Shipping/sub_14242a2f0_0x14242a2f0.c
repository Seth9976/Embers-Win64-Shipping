...
if (rax_6 != 0)
    ...
    if ((*(arg1 + 0x2b) & 8) != 0 && rax_6 s> 0x80000)
        *(arg1 + 0x29) = rcx_3 | 1
        return arg1
    ...
    if ((arg1[5].b & 1) != 0)
        ...
        do
            ...
            int64_t rdx_7 = rbp_1 << 5
            int16_t* rdx_8 = rdx_7 + *arg2
    ...
    if (rax_6 s> 0)
        do
            sub_142429fb0(arg1, (sx.q(i) << 5) + *arg2, arg3)
            i += 1
        while (i s< arg2[1].d)
