...
if (data_143e724a8 s> *(0x14 + *(gsbase->ThreadLocalStoragePointer + (zx.q(data_14401b1a0) << 3))))
    _Init_thread_header(&data_143e724a8)
    
    if (data_143e724a8 == 0xffffffff)
        int64_t (* i)(int64_t arg1, int64_t* arg2) = sub_1411b1600
        ...
        sub_1419c2220(&data_143e72410, 0, u"FWriteParameters", u"FWriteParameters", 0, nullptr)
        int128_t* rcx_6 = var_50
        
        if (rcx_6 != 0)
            sub_140a74f90(rcx_6)
        
        atexit(sub_142cd50e0)
        _Init_thread_footer(&data_143e724a8)

int64_t rbx_1 = sx.q(arg2[1].d)
wchar16 const* const var_40 = u"DebugData"
wchar16 const* const var_38 = u"FHairStrandsDebugData::FWriteParameters"
int32_t var_30 = 0x170
int32_t rax_2 = (rbx_1 + 1).d
char var_2c = 0x12
int32_t var_28 = 0
int32_t var_24 = 1
int64_t var_20 = 1
void* var_18 = &data_143e72410
arg2[1].d = rax_2
