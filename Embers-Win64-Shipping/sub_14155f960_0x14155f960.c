...
rax_3, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm13_1, zmm14 =
    sub_141692d20(arg1, arg2, arg3, arg4, var_258)
int32_t rsi_1
...
if (rax_3 != 0)
    ...
    label_1415603db:
        zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm14_1, zmm15 =
            sub_14154a2a0(*arg1, *arg2, &var_130, arg6, arg7, var_178, arg9)
        rsi_1 = 1
    else
        zmm11 = 0x7fffffff
        arg5 = zx.o(0)
        ...
        while (true)
            if (rdx_5 s< 0x80)
                ...
                label_14156038c:
                    ...
                    float temp0_6[0x4] = _mm_unpacklo_ps(zmm2_1, arg5.q)
                    ...
                    if (_mm_and_ps(temp0_29, zmm11)[0] <= zmm0_1[0])
                        zmm6_1, zmm7_1, zmm8_1, zmm9_1, zmm10_1, zmm11_1, zmm12_1, zmm14_1, zmm15 =
                            sub_14154a2a0(*r14, *r15, rdi_5, arg6, arg7, var_178, arg9)
                        rdi_1 = var_230
                        rsi_1 = 0
                        break
                    ...
                    if (not(zmm13_1 < zmm12[0]))
                        ...
                        *(rcx_15 + (rdx_12 << 2)) = var_1a8_1.q
                        *(rcx_15 + (rdx_12 << 2) + 8) = var_1a0_1
                        ...
                        var_228_1.d = 0
                        *(rcx_17 + (rdx_15 << 2)) = var_198_1.q
                        *(rcx_17 + (rdx_15 << 2) + 8) = var_190_1
                        rdi_5[0xd].b = 1
                        ...
                        if (r8_10 s>= 3)
                            ...
                            if (r8_10 s> 0)
                                ...
                                do
                                    ...
                                    float zmm4_1[0x4] = *(rdx_22 + (rcx_25 << 2) + 4)
                                    ...
                                    *(r10_8 + (rsi_3 << 2) + 0x28) = 0
                                    ...
                                    if (not(zmm0_1[0] < zmm12[0]) && not(zmm0_1[0] > zmm13_1))
                                        char rax_58
                                        rax_58, zmm12, zmm13_1, zmm14, arg5 =
                            ...
                            r12 = var_228_1:4.d
                            goto label_14156038c
            
        label_1415603a5:
            rdi_1 = var_230
            goto label_1415603db
