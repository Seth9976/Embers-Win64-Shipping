...
do
    ...
    result = zx.o(0)
    int64_t j_2 = 8
    double result_1[0x2] = _mm_cvtps_pd(result_2[0])
    result_2 = *(arg1 + 0x18)
    result_1[0] = result_1[0] f+ zmm5
    result_2 = _mm_cvtps_pd(result_2[0])
    result_1[0] = result_1[0] * result_2[0]
    zmm6 = _mm_cvtpd_ps(result_1)
    double result_3[0x2]
    int64_t j
    ...
    do
        ...
        result_3 = *(rax_1 + (rcx << 2))
        result[0].d = result[0].d f+ result_3[0].d
        result_3[0].d = result_3[0].d f* *(rdx + 4)
        result_3[0].d = result_3[0].d f+ result_2[0].d
        *(rdx - 4) = result_3[0].d
        result_3[0].d = result_3[0].d f* *(rdx - 8)
        result_3[0].d = result_3[0].d f+ zmm6.d
        *(rax_1 + (rcx << 2)) = result_3[0].d
        *(rdx + 0x14) += 1
        ...
        *(rdx + 0x14) = rcx_1
        ...
        result_3 = *(rax_3 + (rcx_2 << 2))
        result_4[0].d = result_4[0].d f+ result_3[0].d
        result_3[0].d = result_3[0].d f* *(rdx + 0x104)
        result_3[0].d = result_3[0].d f+ result_2[0].d
        *(rdx + 0xfc) = result_3[0].d
        result_3[0].d = result_3[0].d f* *(rdx + 0xf8)
        result_3[0].d = result_3[0].d f+ zmm6.d
        *(rax_3 + (rcx_2 << 2)) = result_3[0].d
        *(rdx + 0x114) += 1
    ...
    do
        ...
        *(rdx_1 + 0x60) = rcx_7
        ...
        j_3 -= 1
    while (j_1 != 1)
    result_2 = _mm_cvtps_pd(result_1[0])
    result_1 = _mm_cvtps_pd(result_3[0])
    result_2[0] = result_2[0] f- zmm5
    result_1[0] = result_1[0] f- zmm5
    result = _mm_cvtpd_ps(result_2)
    result_4 = _mm_cvtpd_ps(result_1)
