...
rax_2, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm14, zmm15 =
    sub_1416ab590(arg1, arg2, arg3, arg4, var_278)
int32_t rsi_1
    ...
    if (var_238.d s> 0)
        do
            ...
            rax_4, zmm6, zmm7, zmm8, zmm9, zmm10, zmm11, zmm12, zmm14, zmm15 =
                sub_141743d50(sx.q(i) * 0x38 + var_240, *arg1, *r12)
            ...
            if (rax_4 != 0)
                ...
                if (var_1d8 == rsi_2)
                    sub_141701fc0(&var_1e8, rsi_2, &var_258)
                    rsi_2 = var_1e8:8.q
                    rbx_1 = var_1e8.q
                else
                    *rsi_2 = var_258.o
        ...
        while (true)
            if (rdx_5 s< 0x80)
                ...
                label_14157e708:
                    ...
                    zmm8 = rdi_5[3]
                    zmm9 = rdi_5[5]
                    zmm8[0] = zmm8[0] f* *rax_19
                    zmm9[0] = zmm9[0] f* rax_19[2]
                    zmm7[0] = zmm7[0] f* rax_19[1]
                    uint32_t zmm4_1 = zmm7[0]
                    zmm7[0] = zmm7[0] f* rax_19[4]
                    zmm4_1 = zmm4_1 f* rax_19[7]
                    zmm7[0] = zmm7[0] f+ zmm8[0]
                    zmm8[0] = zmm8[0] f* rax_19[3]
                    zmm7[0] = zmm7[0] f+ zmm9[0]
                    zmm9[0] = zmm9[0] f* rax_19[5]
                    zmm7[0] = zmm7[0] f+ zmm8[0]
                    zmm8[0] = zmm8[0] f* rax_19[6]
                    zmm7[0] = zmm7[0] f+ zmm9[0]
                    zmm9[0] = zmm9[0] f* rax_19[8]
                    ...
                    if (not(zmm7[0] f< zmm7[0]) && not(zmm7[0] f< zmm4_1))
                        ...
                        zmm6 = zx.o(*(rax_19 + 0x18))
                        r14_2 = rax_19[8]
                    else
                        zmm6 = zx.o(*(rax_19 + 0xc))
                        r14_2 = rax_19[5]
                    ...
                    if (_mm_and_ps(temp0_6, zmm11_1)[0] f<= zmm0_2.d)
                        zmm6_2, zmm7_1, zmm8_1, zmm9_1, zmm10_2, zmm11_2, zmm12_2, zmm14_2, 
                            zmm15_2 = sub_14154a2a0(*arg1, *r12, rdi_5, arg5, arg6, var_1a8, arg8)
                        rdi_1 = var_258
                        rsi_1 = 0
                        break
                    ...
                    if (not(zmm13_1 f< zmm12_1.d))
                        ...
                        int32_t rcx_16 = arg1[1].d
                        int32_t var_220_1 = rcx_16
                        arg1[1].d = rcx_16 + 1
                        
                        if (rcx_16 + 1 s> *(arg1 + 0xc))
                            sub_14083a7e0(arg1)
                            rcx_16 = var_220_1
                        
                        int64_t rcx_18 = sx.q(rcx_16) * 3
                        int64_t rax_34 = *arg1
                        *(rax_34 + (rcx_18 << 2)) = zmm6_1
                        *(rax_34 + (rcx_18 << 2) + 8) = r14_2
                        ...
                        var_250_1.d = 0
                        *(rax_36 + (rcx_20 << 2)) = zmm10_1.q
                        *(rax_36 + (rcx_20 << 2) + 8) = rax_21
                        rdi_5[0xd].b = 1
                        
                        if (r15_1 s< 0 && r15_1 != 0)
                            sub_1405c5570(&var_258, 0)
                        
                        sub_1415c5980(&var_240, var_230_1, &var_180, &var_258)
                        int64_t r13_4 = sx.q(var_238.d)
                        int32_t r8_11 = var_250_1.d
                        int32_t rax_37 = r8_11 + r13_4.d
                        var_238.d = rax_37
                        
                        if (rax_37 s> var_238:4.d)
                        ...
                        if (r8_11 s>= 3)
                            ...
                            if (r8_11 s> 0)
                                ...
                                do
                                    ...
                                    if (rbx_2 s<= r13_4.d)
                                        rax_43 = r8_11 + r13_4.d
                                    
                                    int64_t rdx_19 = *arg1
                                    int32_t rax_46 = *(r10_8 + (r14_4 << 2))
                                    int64_t rax_48 =
                                        sx.q(*(r10_8 + (sx.q((r14_4 + 1).d s% 3) << 2)))
                                    int32_t var_230_2 = rax_48.d
                                    ...
                                    *(r10_8 + (r14_4 << 2) + 0x28) = 0
                                    ...
                                    if (not(zmm0_1[0] f< zmm12_1.d) && not(zmm0_1[0] > zmm13_1))
                                        char rax_56
                                        rax_56, zmm12_1, zmm13_1, zmm14_1, zmm15_1 =
                            ...
                            zmm5_1 = 0x80000000
                            r15_1 = var_250_1:4.d
                            goto label_14157e708
            
        label_14157e721:
            rdi_1 = var_258
            goto label_14157e757
