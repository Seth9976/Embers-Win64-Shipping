...
int64_t r11 = sx.q(*(rax_1 + (rcx << 2) + 4))
int32_t r10_1 = *(r10 + 8)
int32_t i_9 = (r11 - 1).d
int64_t rdx_2 =
    (sx.q((r11 * 3).d << 2) + sx.q(*(rax_1 + (rcx << 2))) + 3 + *(r10 + 0x38)) & 0xfffffffffffffffc
uint128_t zmm0
...
if (r11.d s< 2 || zmm0.d f<= 0f)
    ...
    int32_t rax_5 = int.d(zmm9.d)
    
    if (rax_5 s< 0)
        rcx_1 = 0
    else if (rax_5 s< rcx_1)
        rcx_1 = rax_5
    ...
    if (rsi != 1)
        ...
        zmm9.d = zmm9.d f- zmm0.d
        zmm9.d = zmm9.d f/ _mm_cvtepi32_ps(zx.o(rax_16)).d
    else
        zmm9 = zx.o(0)
else
    i_8 = zx.q(i_9)
...
sub_140af98a0("Unknown", 0x26f, u"%i: unknown or unsupported animation compression format", 4)
...
*(arg2 + 0x10) = _mm_unpacklo_ps(_mm_unpacklo_ps(zmm3, zmm0_1), temp0_5[0].q)
return result
