...
int128_t zmm10
int128_t zmm11
zmm0_2, zmm7, zmm9, zmm10, zmm11 = sub_1408af2f0(&arg_8, &arg_28)
float zmm13 = *arg3
int128_t zmm1_1
...
if (rsi_1 s> 1)
    ...
    do
        ...
        float zmm13_1
        int32_t zmm14_1
        zmm0_3, zmm6_1, zmm7, zmm8_1, zmm9, zmm10, zmm11, zmm12_1, zmm13_1, zmm14_1 =
            sub_1408af2f0(&arg_8, &arg_28)
        float zmm1_2 = zmm7.d f- _mm_and_ps(zmm0_3, zmm12_1)[0]
