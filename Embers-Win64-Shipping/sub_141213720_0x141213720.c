...
*rdx_8 |= 1 << (rbp.b & 0x1f)
uint64_t* rbx_4 = (sx.q(rbp.d) << 6) + *arg1
*rbx_4 = *arg2
rbx_4[1].d = arg2[1].d
*(rbx_4 + 0xc) = *arg3
*(rbx_4 + 0x1c) = arg3[1]
*(rbx_4 + 0x2c) = arg3[2].q
*(rbx_4 + 0x34) = *(arg3 + 0x28)
rbx_4[7].d = 0xffffffff
int32_t arg_8
sub_141224530(arg1, &arg_8, sub_140b212b0(rbx_4, 0xc, 0), rbx_4, rbp.d, nullptr)
return *arg1 + (sx.q(arg_8) << 6) + 0xc
