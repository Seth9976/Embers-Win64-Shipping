...
if ((arg1[5].b & 1) == 0)
    ...
    for (int32_t i = i_1; i s< *(var_48 + 0x18); i = i_1)
        ...
        int32_t* rdi_3 = (sx.q(i) << 4) + *var_58
        int32_t* rdx_23 = *rcx_19
        
        if (&rdx_23[1] u<= rcx_19[1])
            *rdi_3 = *rdx_23
        ...
        if (&r8_9[1] u<= rcx_21[1])
            rdi_3[1] = *r8_9
            int64_t* rax_42 = arg1[1]
            *rax_42 += 4
        else if ((*(arg1 + 0x29) & 0x20) != 0)
            sub_140b54070(arg1, &rdi_3[1], zmm1)
        else
            (*(*arg1 + 0x150))(arg1, &rdi_3[1], 4)
...
do
    ...
    *(rdx_17 + 8) = 0xffffffff
    ...
    int32_t* rdx_18 = *rcx_15
    
    if (&rdx_18[1] u<= rcx_15[1])
        *(rdx_17 + 4) = *rdx_18
        int64_t* rax_26 = arg1[1]
        *rax_26 += 4
    else if ((*(arg1 + 0x29) & 0x20) != 0)
        sub_140b54070(arg1, rdx_17 + 4, arg3)
    else
        (*(*arg1 + 0x150))(arg1, rdx_17 + 4, 4)
