...
if (*(result + 4) s> 0)
    ...
    do
        ...
        int32_t* rbx_2 = *(r12 + 0xc0) + r9_1
        
        if (*rbx_2 != 0xffffffff || rbx_2[1] != 0xffffffff)
            void* r8_1 = *(r12 + 8)
            int32_t j = 0
            int32_t* rdx_2 = *(r8_1 + 0x90)
            int32_t k_2 = *(rdx_2 + r10_1)
            int32_t k_3 = k_2
            int32_t* r14_1 = *(r8_1 + 0xa8) + (sx.q(*(rdx_2 + r10_1 + 4)) << 2)
            int32_t* var_70_1 = r14_1
            int16_t* rsi_1 = *(r8_1 + 0xc0) + (sx.q(*(rdx_2 + r10_1 + 4)) << 1)
            int32_t* rcx_3 = *(r8_1 + 0x78) + r9_1
            int16_t* var_68_1 = rsi_1
            void* rbx_3 = rbx_2 - rcx_3
            void* var_58_1 = rbx_3
            int32_t* r10_2 = rcx_3
            int32_t* var_88_1 = rcx_3
            
            do
                int32_t rcx_4 = *(rbx_3 + r10_2)
                ...
                if (rcx_4 != 0xffffffff)
                    ...
                    *(r8_2 + 0x10) = k_4
                    ...
                    int16_t* rdi_1 = *(r8_3 + 0xc0) + (sx.q(*(*(r8_3 + 0x90) + (rcx_5 << 2))) << 1)
                    ...
                    if (k_2 s> 0)
                        ...
                        do
                            ...
                            int64_t r8_5 = sx.q(r9_3) << 2
                            int32_t r9_4 = *(r8_5 + rdx_6)
                            ...
                            int32_t rcx_14 = j_1 + r11_1.d
                            
                            if (rcx_14 == *(r8_5 + rdx_7))
                                rcx_14 = 0
                            
                            int64_t rcx_15 = sx.q(rcx_14)
                            int32_t rdx_8 = *(*(arg1 + 0x78) + (sx.q(*((rcx_8 << 2) + rdx_7)) << 2)
                                + (rcx_15 << 2))
                            ...
                            if (rdx_8 != 0xffffffff)
                                *rbx_4 = rdx_8
                                ...
                                if (r9_4 != 4)
                                    r11_1 = zx.q(sbb.d(rcx_15.d, rcx_15.d, j_1 != 0)) & 3
