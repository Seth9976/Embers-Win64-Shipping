...
if (result == 0)
    if (rcx_19 s> 0)
        ...
        do
            ...
            float zmm1[0x4] = *(rsi + 0x20)
            i += 1
            float temp0_22[0x4] = _mm_mul_ps(*(rsi + 0x40), temp0_19)
            int64_t var_a8_2 = 0
            float temp0_23[0x4] = _mm_mul_ps(zmm1, temp0_18)
            int32_t var_a0_2 = 0
            float temp0_28[0x4] = _mm_add_ps(_mm_add_ps(_mm_mul_ps(zmm7, temp0_20), temp0_22), 
                _mm_add_ps(temp0_23, __mulps_xmmps_memps(temp0_21, *(rsi + 0x10))))
    ...
    do
        ...
        float var_118
        zmm8 = sub_141f65270(result_2, &var_118, zmm0_1, 0)
        float var_98[0x4]
        var_98[0] = var_118[0]
        ...
        float temp0_7[0x4] = __mulps_xmmps_memps(_mm_shuffle_ps(temp0_3, temp0_3, 0), *(rsi + 0x10))
        float temp0_9[0x4] =
