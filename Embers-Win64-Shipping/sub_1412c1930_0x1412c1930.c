...
if (data_143e8b238 s> *rdi_1)
    _Init_thread_header(&data_143e8b238)
    
    if (data_143e8b238 == 0xffffffff)
        ...
        data_143e8b230 = rax_9
        _Init_thread_footer(&data_143e8b238)

if (data_143e8b248 s> *rdi_1)
    _Init_thread_header(&data_143e8b248)
    
    if (data_143e8b248 == 0xffffffff)
        ...
        data_143e8b240 = rax_12
        _Init_thread_footer(&data_143e8b248)

if (data_143e8b258 s> *rdi_1)
    _Init_thread_header(&data_143e8b258)
    
    if (data_143e8b258 == 0xffffffff)
        ...
        data_143e8b250 = rax_15
        _Init_thread_footer(&data_143e8b258)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b230
int64_t rcx
...
label_1412c1a33:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 1 || rbp == 1)
            goto label_1412c1a2e
        
        rbx.b = 1
        goto label_1412c1a33
