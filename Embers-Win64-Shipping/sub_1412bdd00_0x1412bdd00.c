...
if (data_143e8b818 s> *rdi_1)
    _Init_thread_header(&data_143e8b818)
    
    if (data_143e8b818 == 0xffffffff)
        ...
        data_143e8b810 = rax_9
        _Init_thread_footer(&data_143e8b818)

if (data_143e8b838 s> *rdi_1)
    _Init_thread_header(&data_143e8b838)
    
    if (data_143e8b838 == 0xffffffff)
        ...
        data_143e8b830 = rax_12
        _Init_thread_footer(&data_143e8b838)

if (data_143e8b858 s> *rdi_1)
    _Init_thread_header(&data_143e8b858)
    
    if (data_143e8b858 == 0xffffffff)
        ...
        data_143e8b850 = rax_15
        _Init_thread_footer(&data_143e8b858)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8b810
int64_t rcx
...
label_1412bde03:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412bddfe
        
        rbx.b = 1
        goto label_1412bde03
