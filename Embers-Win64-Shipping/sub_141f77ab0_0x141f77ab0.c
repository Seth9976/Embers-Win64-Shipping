...
if (rdx == 0)
    ...
    *(rbx_1 + (rdx_5 << 2)) &= not.d(1 << (rsi_1.b & 0x1f))
    ...
    rdi = sx.q(arg1[6].d)
    int64_t r9 = *arg1
    int64_t r8 = sx.q(*(r9 + rdi * 0xc + 4))
    arg1[6].d = r8.d
    *(arg1 + 0x34) = rdx - 1
    
    if (rdx != 1)
        *(r9 + r8 * 0xc) = 0xffffffff
...
label_141f77c4e:
    ...
    if (sub_14084bc50(arg1, r9_2, 0) == 0)
        void* r9_3 = &arg1[7]
        ...
        r13[1] = *(rax_21 + (((sx.q(arg1[9].d) - 1) & sx.q(r8_6)) << 2))
        void* rcx_15 = *(r9_3 + 8)
    ...
    label_141f77c07:
        ...
        while (true)
            ...
            if (*(rdx_13 + (rcx_9 << 2)) == rsi_3.d)
                break
            
            rbx_2 = *(rdx_13 + (rcx_9 << 2) + 4)
            
            if (rbx_2 == 0xffffffff)
                goto label_141f77c07
    
    rbp.b = rbx_2 != 0xffffffff
    
    if (rbx_2 == 0xffffffff)
        goto label_141f77c4e
    
    memmove(*arg1 + sx.q(rbx_2) * 0xc, r13, 4)
