...
int32_t r11 = 0
uint32_t r10_1 = zx.d(*(arg1 + 8)) << 8
int32_t rax_1 = zx.d(*(arg1 + 9)) - 1
...
label_142c1f0aa:
    ...
    while (true)
        ...
        void* rbx_1 = arg1 + 0x10 + (rax_4 << 1)
        uint32_t rcx = zx.d(zx.w(*(arg1 + 0x10 + (rax_4 << 1))) * 0x100
            + zx.w(*(arg1 + 0x10 + (rax_4 << 1) + 1)))
        int32_t rax_6
        bool cond:1_1
