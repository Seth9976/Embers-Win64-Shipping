    ...
    if (rsi[0x86].b == 0)
        ...
        if (result == 0)
            ...
            if (rbp_2.d s> 0 && rbp_2.d u>= 8)
                ...
                do
                    int64_t rax_14 = sx.q(*(r15_1 + r10_1 + 4))
                    r10_1 += 0x20
                    i_4 += 8
                    i_1 += 8
                    uint128_t zmm0 = zx.o(*(sx.q(*(r15_1 + r10_1 - 0x20)) * 0x78 + r11_1 + 8))
                    int64_t rcx_16 = sx.q(*(r15_1 + r10_1 - 0x28)) * 0x78
                    int32_t temp0_1[0x4] = _mm_unpacklo_epi32(
                        zx.o(*(sx.q(*(r15_1 + r10_1 - 0x24)) * 0x78 + r11_1 + 8)), 
                        zx.q(*(rax_14 * 0x78 + r11_1 + 8)))
                    int64_t r9_3 = sx.q(*(r15_1 + r10_1 - 0xc)) * 0x78
                    zmm4 = _mm_add_epi32(
                        _mm_unpacklo_epi32(_mm_unpacklo_epi32(zx.o(*(rcx_16 + r11_1 + 8)), zmm0.q), 
                            temp0_1[0].q), 
                        zmm4)
                    zmm0 = zx.o(*(sx.q(*(r15_1 + r10_1 - 0x10)) * 0x78 + r11_1 + 8))
                    result = sx.q(*(r15_1 + r10_1 - 0x18))
                    int32_t temp0_5[0x4] = _mm_unpacklo_epi32(
                        zx.o(*(sx.q(*(r15_1 + r10_1 - 0x14)) * 0x78 + r11_1 + 8)), 
                        zx.q(*(r9_3 + r11_1 + 8)))
                    temp0_8 = _mm_add_epi32(
                        _mm_unpacklo_epi32(
                            _mm_unpacklo_epi32(zx.o(*(result * 0x78 + r11_1 + 8)), zmm0.q), 
                            temp0_5[0].q), 
                        zmm5)
                    zmm5 = temp0_8
                while (i_1 s< sx.q(rbp_2.d - rcx_13))
            ...
            if (i_2 s< rbp_2)
                if (rbp_2 - i_2 s>= 2)
                    ...
                    do
                        int64_t rcx_18 = sx.q(*(r14_2 + (i_2 << 2))) * 0x78
                        int64_t rax_25 = sx.q(*(r14_2 + (i_2 << 2) + 4))
                        i_2 += 2
                        r10_2 += *(rcx_18 + r8_2 + 8)
                        r11_2 += *(rax_25 * 0x78 + r8_2 + 8)
                    while (i_2 s< rbp_2 - 1)
                
                if (i_2 s< rbp_2)
                    r9_1 +=
                        *(sx.q(*(*(rsi + 0x80) + (i_2 << 2))) * 0x78 + *(*(rsi + 0x58) + 0x328) + 8)
