...
if (data_143e8c8a0 s> *rdi_1)
    _Init_thread_header(&data_143e8c8a0)
    
    if (data_143e8c8a0 == 0xffffffff)
        ...
        data_143e8c898 = rax_9
        _Init_thread_footer(&data_143e8c8a0)

if (data_143e8c8c0 s> *rdi_1)
    _Init_thread_header(&data_143e8c8c0)
    
    if (data_143e8c8c0 == 0xffffffff)
        ...
        data_143e8c8b8 = rax_12
        _Init_thread_footer(&data_143e8c8c0)

if (data_143e8c8e0 s> *rdi_1)
    _Init_thread_header(&data_143e8c8e0)
    
    if (data_143e8c8e0 == 0xffffffff)
        ...
        data_143e8c8d8 = rax_15
        _Init_thread_footer(&data_143e8c8e0)

uint32_t result = zx.d(data_143de5480)
int64_t rdi_2 = data_143e8c898
int64_t rcx
...
label_1412b2163:
    ...
    if ((*(r14 + (rbx << 2)) & 0xfffffffd) == 0)
        if (rsi s< 2 || rbp == 1)
            goto label_1412b215e
        
        rbx.b = 1
        goto label_1412b2163
