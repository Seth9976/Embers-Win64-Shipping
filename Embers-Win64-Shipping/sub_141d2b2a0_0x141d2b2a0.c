...
if (rbp.d == 0xffffff)
    ...
    if (rbp.d == rax_8)
        int64_t rax_10 = sub_140a84c80(*(arg1 + 0x38), zx.q(rax_8 + 4) * 0x30, 8)
        arg1[0x11] += 4
        rbp = zx.q(arg1[0x10])
        *(arg1 + 0x38) = rax_10
...
int64_t rax_18 = *(arg1 + 0x38)
int64_t rdx_10 = sx.q(rbp.d)
uint64_t rcx_8 = rdx_10 * 0x30
*(rcx_8 + rax_18) = *arg3
*(rcx_8 + rax_18 + 0x10) = arg3[1]
*(rcx_8 + rax_18 + 0x20) = arg3[2]
arg1[0x12] += 1

if (rbp.d s>= 0 && rbp.d s< arg1[4])
    rcx_8 = zx.q(*(*r14 + (rdx_10 << 2) + 3))

int32_t rax_23

if (rbp.d s< 0 || rbp.d s>= arg1[4] || rcx_8.b == 0)
    rcx_8.b = 0
    rax_23 = 0
else
