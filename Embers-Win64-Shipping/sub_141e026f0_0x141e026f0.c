...
if (rcx_3 == 0)
    ...
    if (arg2 s< 0)
        ...
        if (arg2 s>= rcx_4)
            ...
            int64_t rbx_1 = sx.q(*(*(*rax_8 + (sx.q(rcx_4 - arg2) << 3) - 8) + 0x4c))
            void* rbx_2 = rbx_1 + *(rdi_1 + 0xa0)
            
            if (rbx_1 == neg.q(*(rdi_1 + 0xa0)))
                result.o = zx.o(0)
            else if (sub_141e2afc0(rbx_2, arg3) == 0)
                result.o = zx.o(0)
            else
                result.o = *(sub_141e24e60(rbx_2, arg3) + 0x10)
