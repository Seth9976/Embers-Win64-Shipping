...
if ((*(arg2 + 0x14) | arg2[1].d | *(arg2 + 0xc) | *(arg2 + 8)) != 0)
    ...
    result = sub_141a63a50(rcx_22, &var_88)
    ...
    void*** var_98
    void var_50
    void**** rax_5 = sub_140b9e470(&var_98, arg1, sub_140a96170(&var_50))
    void*** var_c8 = *rax_5
    ...
    void var_a8
    void var_38
    sub_140aced10(*sub_140ae44d0(sub_140accdf0(&var_38, &arg_18), &var_a8, rax_6), &var_b8, &var_c8)
    int64_t* var_b0
